...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2
{
    ...
    private void createLayoutManager(final Context context, String trim, final AttributeSet set, final int i, final int j) {
        if (trim != null) {
            ...
            if (!((String)trim).isEmpty()) {
                ...
                try {
                    ...
                    try {
                        ...
                        trim = new Object[] { context, set, i, j };
    ...
    private boolean isPreferredNextFocusAbsolute(final View view, final View view2, final int i) {
        ...
        boolean b4 = true;
        if (i == 17) {
            return (this.mTempRect.right > this.mTempRect2.right || this.mTempRect.left >= this.mTempRect2.right) && this.mTempRect.left > this.mTempRect2.left && b3;
        }
        if (i == 33) {
            return (this.mTempRect.bottom > this.mTempRect2.bottom || this.mTempRect.top >= this.mTempRect2.bottom) && this.mTempRect.top > this.mTempRect2.top && b2;
        }
        if (i == 66) {
            return (this.mTempRect.left < this.mTempRect2.left || this.mTempRect.right <= this.mTempRect2.left) && this.mTempRect.right < this.mTempRect2.right && b;
        }
        if (i != 130) {
            final StringBuilder sb = new StringBuilder();
    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        final boolean mAutoMeasure = this.mLayout.mAutoMeasure;
        final int n3 = 0;
        if (mAutoMeasure) {
    ...
    boolean scrollByInternal(final int n, final int n2, final MotionEvent motionEvent) {
        ...
        if (this.dispatchNestedScroll(n5, n6, n3, n7, this.mScrollOffset, 0)) {
            ...
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                this.pullGlows(motionEvent.getX(), (float)n3, motionEvent.getY(), (float)n7);
            }
    ...
    public final class Recycler
    {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(final int n, final boolean b, final long n2) {
            if (n >= 0 && n < RecyclerView.this.mState.getItemCount()) {
                ...
                Label_0771: {
                    if (scrapOrHiddenOrCachedHolderForPosition == null) {
                        ...
                        if (viewHolder6 == null) {
                            ...
                            viewHolder7 = RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, itemViewType);
                            if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                ...
                if (n6 != 0 && !RecyclerView.this.mState.isPreLayout() && viewHolder7.hasAnyOfTheFlags(8192)) {
                    viewHolder7.setFlags(0, 8192);
                    if (RecyclerView.this.mState.mRunSimpleAnimations) {
                        RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(viewHolder7, RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, viewHolder7, ItemAnimator.buildAdapterChangeFlagsForAnimations(viewHolder7) | 0x1000, viewHolder7.getUnmodifiedPayloads()));
                    }
                }
                boolean tryBindViewHolderByDeadline = false;
                Label_0954: {
                    if (RecyclerView.this.mState.isPreLayout() && viewHolder7.isBound()) {
                        viewHolder7.mPreLayoutPosition = n;
                    }
                    else if (!viewHolder7.isBound() || viewHolder7.needsUpdate() || viewHolder7.isInvalid()) {
                        tryBindViewHolderByDeadline = this.tryBindViewHolderByDeadline(viewHolder7, RecyclerView.this.mAdapterHelper.findPositionOffset(n), n, n2);
                        break Label_0954;
                    }
        ...
        public void run() {
            ...
            if (mScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    int n5;
                    if (n3 != 0) {
                        scrollHorizontallyBy = RecyclerView.this.mLayout.scrollHorizontallyBy(n3, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        n5 = n3 - scrollHorizontallyBy;
                    }
                    else {
                        scrollHorizontallyBy = (n5 = 0);
                    }
                    int scrollVerticallyBy;
                    int n6;
                    if (n4 != 0) {
                        scrollVerticallyBy = RecyclerView.this.mLayout.scrollVerticallyBy(n4, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        n6 = n4 - scrollVerticallyBy;
                    }
                    else {
                        scrollVerticallyBy = (n6 = 0);
                    }
                    TraceCompat.endSection();
                        ...
                        if (!mSmoothScroller.isPendingInitialRun()) {
                            ...
                            if (mSmoothScroller.isRunning()) {
                                ...
                                if (itemCount == 0) {
                                    ...
                                    mSmoothScroller.onAnimation(n3 - n5, n4 - n6);
                                    n7 = scrollHorizontallyBy;
                                    n8 = n5;
                                    n9 = scrollVerticallyBy;
                                    n10 = n6;
                ...
                if (!RecyclerView.this.dispatchNestedScroll(n7, n9, n8, n10, null, 1) && (n8 != 0 || n10 != 0)) {
                    int n12 = (int)mScroller.getCurrVelocity();
                    int n13 = 0;
                    Label_0634: {
                        if (n8 != currX) {
                            if (n8 < 0) {
                    ...
                    if (RecyclerView.this.getOverScrollMode() != 2) {
                        RecyclerView.this.absorbGlows(n13, n12);
                    }
                    if ((n13 != 0 || n8 == currX || mScroller.getFinalX() == 0) && (n12 != 0 || n10 == currY || mScroller.getFinalY() == 0)) {
                        mScroller.abortAnimation();
                    }
                }
                if (n7 != 0 || n9 != 0) {
                    RecyclerView.this.dispatchOnScrolled(n7, n9);
                }
                if (!RecyclerView.access$700(RecyclerView.this)) {
                    RecyclerView.this.invalidate();
                }
                final boolean b = n4 != 0 && RecyclerView.this.mLayout.canScrollVertically() && n9 == n4;
                final boolean b2 = n3 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && n7 == n3;
