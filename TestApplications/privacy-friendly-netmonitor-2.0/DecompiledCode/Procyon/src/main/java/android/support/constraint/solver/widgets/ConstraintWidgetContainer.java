...
public class ConstraintWidgetContainer extends WidgetContainer
{
    ...
    public void findWrapSize(final ArrayList<ConstraintWidget> list, final boolean[] array) {
        ...
        for (int i = n; i < size; ++i) {
            ...
            if (!constraintWidget.isRoot()) {
                ...
                max = Math.max(max, constraintWidget.mDistToBottom);
        ...
        this.mWrapHeight = Math.max(this.mMinHeight, Math.max(Math.max(max3, max), max2));
    ...
    public int layoutFindGroups() {
        ...
        int n10 = 0;
        int n15;
        for (int index = n; index < size; ++index, n10 = n15) {
    ...
    public void layoutWithGroup(int height) {
        final int mx = this.mX;
        final int my = this.mY;
