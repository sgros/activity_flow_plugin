    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        for (int i = 0; i < size3; ++i) {
            ...
            if (view.getVisibility() != 8) {
                ...
                final Behavior behavior = layoutParams.getBehavior();
                if (behavior == null || !behavior.onMeasureChild(this, view, n7, n5, n8, 0)) {
                    this.onMeasureChild(view, n7, n5, n8, 0);
                }
            ...
            if (child.getVisibility() == 8) {
                ...
                if (!layoutParams.isNestedScrollAccepted(n3)) {
                    ...
                    if (behavior != null) {
                        ...
                        int n10;
                        if (n > 0) {
                            n10 = Math.max(n7, this.mTempIntPair[0]);
                        }
                        else {
                            n10 = Math.min(n7, this.mTempIntPair[0]);
                        }
                        int n11;
                        if (n2 > 0) {
                            n11 = Math.max(n6, this.mTempIntPair[1]);
                        }
                        else {
                            n11 = Math.min(n6, this.mTempIntPair[1]);
                        }
                        final int n12 = n10;
                        n9 = n11;
                        n4 = 1;
