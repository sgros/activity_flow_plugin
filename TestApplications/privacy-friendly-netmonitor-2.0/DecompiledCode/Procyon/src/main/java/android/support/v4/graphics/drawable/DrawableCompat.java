...
public final class DrawableCompat
{
    ...
    static class DrawableCompatApi21Impl extends DrawableCompatApi19Impl
    {
        ...
        @Override
        public void clearColorFilter(Drawable child) {
            child.clearColorFilter();
            if (child instanceof InsetDrawable) {
                this.clearColorFilter(((InsetDrawable)child).getDrawable());
            }
            else if (child instanceof DrawableWrapper) {
                this.clearColorFilter(((DrawableWrapper)child).getWrappedDrawable());
            }
