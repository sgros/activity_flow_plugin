...
public class FontsContractCompat
{
    ...
    @RestrictTo({ RestrictTo.Scope.LIBRARY_GROUP })
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final TextView referent, int n, final int n2, final int i) {
        ...
        final Callable<Typeface> callable = new Callable<Typeface>() {
            ...
            public Typeface call() throws Exception {
                final Typeface access$000 = getFontInternal(context, fontRequest, i);
                if (access$000 != null) {
        ...
        final SelfDestructiveThread.ReplyCallback<Typeface> replyCallback = new SelfDestructiveThread.ReplyCallback<Typeface>() {
            final /* synthetic */ WeakReference val$textViewWeak = new WeakReference((T)referent);
            
            public void onReply(final Typeface typeface) {
                if (this.val$textViewWeak.get() != null) {
                    referent.setTypeface(typeface, i);
                }
            }
        };
