...
class CircleImageView extends ImageView
{
    ...
    private class OvalShadow extends OvalShape
    {
        ...
        private void updateRadialGradient(final int n) {
            ...
            this.mRadialGradient = new RadialGradient(n2, n2, (float)CircleImageView.this.mShadowRadius, new int[] { 1023410176, 0 }, (float[])null, Shader$TileMode.CLAMP);
        ...
        public void draw(final Canvas canvas, final Paint paint) {
            ...
            canvas.drawCircle(n2, n3, (float)(n - CircleImageView.this.mShadowRadius), paint);
        }
