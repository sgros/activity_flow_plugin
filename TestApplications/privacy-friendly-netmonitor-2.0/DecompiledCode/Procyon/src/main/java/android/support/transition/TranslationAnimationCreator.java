...
{
    static Animator createAnimation(final View view, final TransitionValues transitionValues, final int n, final int n2, float translationY, final float n3, final float n4, final float n5, final TimeInterpolator interpolator) {
