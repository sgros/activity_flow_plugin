...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl
{
    ...
    @Override
    public Typeface createFromFontInfo(Context t, final CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] openFileDescriptor, final int n) {
