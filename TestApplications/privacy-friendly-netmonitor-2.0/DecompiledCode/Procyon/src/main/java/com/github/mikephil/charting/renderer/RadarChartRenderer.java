...
public class RadarChartRenderer extends LineRadarRenderer
{
    ...
    public void drawValues(final Canvas canvas) {
        ...
        MPPointF mpPointF5;
        float n6;
        for (int i = 0; i < this.mChart.getData().getDataSetCount(); ++i, mpPointF5 = mpPointF2, n6 = n3, instance = mpPointF3, instance2 = mpPointF5, phaseX = n2, sliceAngle = n6) {
            final IRadarDataSet set = this.mChart.getData().getDataSetByIndex(i);
            if (!this.shouldDrawValues(set)) {
                final float n = sliceAngle;
