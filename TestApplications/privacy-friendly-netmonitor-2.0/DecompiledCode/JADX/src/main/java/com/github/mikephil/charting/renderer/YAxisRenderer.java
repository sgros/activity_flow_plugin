...
public class YAxisRenderer extends AxisRenderer {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            if (axisDependency == AxisDependency.LEFT) {
                if (labelPosition == YAxisLabelPosition.OUTSIDE_CHART) {
                    ...
                    offsetLeft = this.mViewPortHandler.offsetLeft() - xOffset;
                } else {
                ...
                this.mAxisLabelPaint.setTextAlign(Align.LEFT);
                offsetLeft = this.mViewPortHandler.contentRight() + xOffset;
            } else {
                this.mAxisLabelPaint.setTextAlign(Align.RIGHT);
                offsetLeft = this.mViewPortHandler.contentRight() - xOffset;
            }
    ...
    public void drawYLabels(Canvas canvas, float f, float[] fArr, float f2) {
        ...
        while (isDrawBottomYLabelEntryEnabled < i) {
            canvas.drawText(this.mYAxis.getFormattedLabel(isDrawBottomYLabelEntryEnabled), f, fArr[(isDrawBottomYLabelEntryEnabled * 2) + 1] + f2, this.mAxisLabelPaint);
    ...
    public Path linePath(Path path, int i, float[] fArr) {
        i++;
        path.moveTo(this.mViewPortHandler.offsetLeft(), fArr[i]);
        path.lineTo(this.mViewPortHandler.contentRight(), fArr[i]);
        return path;
    }
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(this.mViewPortHandler.contentLeft(), (float) pixelForValues.f487y);
        path.lineTo(this.mViewPortHandler.contentRight(), (float) pixelForValues.f487y);
