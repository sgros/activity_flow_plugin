...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02772 extends Animation {
        C02772() {
        }
    ...
    class C02783 extends Animation {
        C02783() {
        }
    ...
    class C02805 implements AnimationListener {
        public void onAnimationRepeat(Animation animation) {
        }
    ...
    class C02816 extends Animation {
        C02816() {
        }
    ...
    class C02827 extends Animation {
        C02827() {
        }
    ...
    class C02838 extends Animation {
        C02838() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C02761();
        this.mAnimateToCorrectPosition = new C02816();
        this.mAnimateToStartPosition = new C02827();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C02772();
    ...
    public void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C02783();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        C02794 c02794 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c02794.setDuration(300);
        this.mCircleView.setAnimationListener(null);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c02794);
        return c02794;
    }
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C02838();
