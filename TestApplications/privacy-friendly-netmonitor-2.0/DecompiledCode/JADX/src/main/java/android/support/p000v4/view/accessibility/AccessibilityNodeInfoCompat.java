...
public class AccessibilityNodeInfoCompat {
    ...
    public AccessibilityNodeInfoCompat getChild(int i) {
        return AccessibilityNodeInfoCompat.wrapNonNullInstance(this.mInfo.getChild(i));
    }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String str) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(AccessibilityNodeInfoCompat.wrap((AccessibilityNodeInfo) findAccessibilityNodeInfosByText.get(i)));
        }
        return arrayList;
    }
