...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C02981();
    ...
    class C02995 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03001());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0305R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0305R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0305R.style.Theme_AppCompat_CompactMenu, true);
            }
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0305R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0305R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0305R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0305R.layout.abc_list_menu_item_layout);
    ...
    class C05222 implements OnApplyWindowInsetsListener {
        C05222() {
        }
    ...
    class C05233 implements OnFitSystemWindowsListener {
        C05233() {
        }
    ...
    class C05244 implements OnAttachListener {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C05251 extends ViewPropertyAnimatorListenerAdapter {
            C05251() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C05251());
            }
    ...
    class C05676 extends ViewPropertyAnimatorListenerAdapter {
        C05676() {
        }
    ...
    private ViewGroup createSubDecor() {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0305R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0305R.styleable.AppCompatTheme_windowActionBar)) {
            ViewGroup viewGroup;
            if (obtainStyledAttributes.getBoolean(C0305R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0305R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(108);
            }
            if (obtainStyledAttributes.getBoolean(C0305R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(109);
            }
            if (obtainStyledAttributes.getBoolean(C0305R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0305R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0305R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0305R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(viewGroup, new C05222());
                } else {
                    ((FitWindowsViewGroup) viewGroup).setOnFitSystemWindowsListener(new C05233());
                }
            } else if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0305R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context contextThemeWrapper;
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0305R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    contextThemeWrapper = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0305R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0305R.C0304id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) viewGroup.findViewById(C0305R.C0304id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
            ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0305R.C0304id.action_bar_activity_content);
            ...
            contentFrameLayout.setAttachListener(new C05244());
            return viewGroup;
        }
        obtainStyledAttributes.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0305R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0305R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0305R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0305R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0305R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0305R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0305R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0305R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0305R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0305R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0305R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    L_0x0007:
        ...
        r0.finish();
    L_0x000c:
        r0 = r8 instanceof android.support.p003v7.app.AppCompatDelegateImplV9.ActionModeCallbackWrapperV9;
    ...
    L_0x0039:
        ...
        r4 = r7.mContext;
        r4 = r4.getTheme();
        r5 = android.support.p003v7.appcompat.C0305R.attr.actionBarTheme;
    ...
    L_0x0070:
        ...
        r6 = android.support.p003v7.appcompat.C0305R.attr.actionModePopupWindowStyle;
        r5.<init>(r4, r1, r6);
        ...
        r5.setWidth(r6);
        r5 = r4.getTheme();
        r6 = android.support.p003v7.appcompat.C0305R.attr.actionBarSize;
    ...
    L_0x00bd:
        r0 = r7.mSubDecor;
        r4 = android.support.p003v7.appcompat.C0305R.C0304id.action_mode_bar_stub;
        r0 = r0.findViewById(r4);
        r0 = (android.support.p003v7.widget.ViewStubCompat) r0;
        if (r0 == 0) goto L_0x00dc;
    L_0x00c9:
        ...
        r0 = r0.inflate();
        r0 = (android.support.p003v7.widget.ActionBarContextView) r0;
    ...
    L_0x0117:
        ...
        r8.setAlpha(r1);
        r8 = r7.mActionModeView;
        r8 = android.support.p000v4.view.ViewCompat.animate(r8);
        r8 = r8.alpha(r0);
        r7.mFadeAnim = r8;
        r8 = r7.mFadeAnim;
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    ...
                    if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                        ...
                        if (layoutParams2 != null && layoutParams2.width == -1) {
                            ...
                            layoutParams = new WindowManager.LayoutParams(i, -2, panelFeatureState.f28x, panelFeatureState.f29y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0305R.attr.actionBarTheme, typedValue, true);
            Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0305R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0305R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0305R.color.abc_input_method_navigation_guard));
