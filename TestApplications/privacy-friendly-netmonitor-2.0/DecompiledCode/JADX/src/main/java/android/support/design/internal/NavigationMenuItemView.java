...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C05021 extends AccessibilityDelegateCompat {
        C05021() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAccessibilityDelegate = new C05021();
        setOrientation(0);
        ...
        this.mTextView = (CheckedTextView) findViewById(C0023R.C0022id.design_menu_item_text);
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0023R.C0022id.design_menu_item_action_area_stub)).inflate();
            }
            this.mActionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0305R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), C0023R.C0021drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
