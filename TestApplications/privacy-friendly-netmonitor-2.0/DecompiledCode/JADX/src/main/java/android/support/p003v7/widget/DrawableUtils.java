...
public class DrawableUtils {
    ...
    L_0x0004:
        r10 = android.support.p000v4.graphics.drawable.DrawableCompat.unwrap(r10);	 Catch:{ Exception -> 0x0098 }
        ...
        if (drawable instanceof DrawableContainer) {
            ...
            if (constantState instanceof DrawableContainerState) {
                for (Drawable canSafelyMutateDrawable : ((DrawableContainerState) constantState).getChildren()) {
                    if (!DrawableUtils.canSafelyMutateDrawable(canSafelyMutateDrawable)) {
                        return false;
                    }
                }
            }
            ...
            if (drawable instanceof android.support.p003v7.graphics.drawable.DrawableWrapper) {
                return DrawableUtils.canSafelyMutateDrawable(((android.support.p003v7.graphics.drawable.DrawableWrapper) drawable).getWrappedDrawable());
            }
