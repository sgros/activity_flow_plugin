...
import android.support.p000v4.media.AudioAttributesCompatApi21.Wrapper;
...
public class AudioAttributesCompat {
    ...
    static int toVolumeStreamType(boolean z, AudioAttributesCompat audioAttributesCompat) {
        return AudioAttributesCompat.toVolumeStreamType(z, audioAttributesCompat.getFlags(), audioAttributesCompat.getUsage());
    }
