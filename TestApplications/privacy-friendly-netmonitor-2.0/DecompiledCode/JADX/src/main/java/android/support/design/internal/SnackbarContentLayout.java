...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mMaxWidth = obtainStyledAttributes.getDimensionPixelSize(C0023R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C0023R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0023R.C0022id.snackbar_text);
        this.mActionView = (Button) findViewById(C0023R.C0022id.snackbar_action);
    }
    ...
    L_0x001a:
        r0 = r7.getResources();
        r1 = android.support.design.C0023R.dimen.design_snackbar_padding_vertical_2lines;
        r0 = r0.getDimensionPixelSize(r1);
        r1 = r7.getResources();
        r2 = android.support.design.C0023R.dimen.design_snackbar_padding_vertical;
