...
public class SimpleArrayMap<K, V> {
    ...
    public int indexOf(Object obj, int i) {
        ...
        int binarySearchHashes = SimpleArrayMap.binarySearchHashes(this.mHashes, i2, i);
    ...
    public int indexOfNull() {
        ...
        int binarySearchHashes = SimpleArrayMap.binarySearchHashes(this.mHashes, i, 0);
    ...
    public void ensureCapacity(int i) {
        ...
        if (this.mHashes.length < i) {
            ...
            SimpleArrayMap.freeArrays(iArr, objArr, i2);
        }
        if (this.mSize != i2) {
            throw new ConcurrentModificationException();
        }
    ...
    public V removeAt(int i) {
        ...
        int i4 = 0;
        if (i3 <= 1) {
            SimpleArrayMap.freeArrays(this.mHashes, this.mArray, i3);
            this.mHashes = ContainerHelpers.EMPTY_INTS;
            this.mArray = ContainerHelpers.EMPTY_OBJECTS;
        } else {
            int i5 = i3 - 1;
