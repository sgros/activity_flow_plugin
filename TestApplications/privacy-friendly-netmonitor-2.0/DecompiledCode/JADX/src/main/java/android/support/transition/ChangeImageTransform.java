...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00981();
    ...
    static class C00981 implements TypeEvaluator<Matrix> {
     ...
     */
        ...
        L_0x001f:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.transition.ChangeImageTransform$C01003.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C01003.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
