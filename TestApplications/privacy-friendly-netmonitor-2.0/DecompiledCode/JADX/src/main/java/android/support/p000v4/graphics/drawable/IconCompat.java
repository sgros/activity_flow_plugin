...
public class IconCompat {
    ...
    public Icon toIcon() {
        switch (this.mType) {
            ...
            case 5:
                ...
                return Icon.createWithBitmap(IconCompat.createLegacyIconFromAdaptiveIcon((Bitmap) this.mObj1));
            default:
    ...
    public void addToShortcutIntent(Intent intent) {
        ...
        intent.putExtra("android.intent.extra.shortcut.ICON", IconCompat.createLegacyIconFromAdaptiveIcon((Bitmap) this.mObj1));
    }
