...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null && "android.intent.action.MEDIA_BUTTON".equals(intent.getAction()) && intent.hasExtra("android.intent.extra.KEY_EVENT")) {
            ComponentName serviceComponentByAction = MediaButtonReceiver.getServiceComponentByAction(context, "android.intent.action.MEDIA_BUTTON");
            if (serviceComponentByAction != null) {
                intent.setComponent(serviceComponentByAction);
                MediaButtonReceiver.startForegroundService(context, intent);
                return;
            }
            serviceComponentByAction = MediaButtonReceiver.getServiceComponentByAction(context, MediaBrowserServiceCompat.SERVICE_INTERFACE);
            if (serviceComponentByAction != null) {
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, long j) {
        ...
        if (mediaButtonReceiverComponent != null) {
            return MediaButtonReceiver.buildMediaButtonPendingIntent(context, mediaButtonReceiverComponent, j);
        }
