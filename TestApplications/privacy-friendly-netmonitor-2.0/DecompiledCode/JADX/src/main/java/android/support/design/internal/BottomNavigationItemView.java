...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        i = resources.getDimensionPixelSize(C0023R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize = resources.getDimensionPixelSize(C0023R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(C0023R.dimen.design_bottom_navigation_margin);
        ...
        setBackgroundResource(C0023R.C0021drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0023R.C0022id.icon);
        this.mSmallLabel = (TextView) findViewById(C0023R.C0022id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0023R.C0022id.largeLabel);
    }
