...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    class C00772 extends AnimatorListenerAdapter {
        C00772() {
        }
    ...
    L_0x0006:
        ...
        r1 = r4.getResources();
        r4 = r4.getTheme();
        r4 = android.support.p000v4.content.res.ResourcesCompat.getDrawable(r1, r5, r4);
        ...
        if (this.mDelegateDrawable != null) {
            ...
            if (!this.mAnimationCallbacks.contains(animationCallback)) {
                ...
                if (this.mAnimatorListener == null) {
                    this.mAnimatorListener = new C00772();
                }
