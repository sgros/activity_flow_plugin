...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C01791();
        ...
        static class C01791 implements Creator<MediaItem> {
            C01791() {
            }
        ...
        public static MediaItem fromMediaItem(Object obj) {
            ...
            return new MediaItem(MediaDescriptionCompat.fromMediaDescription(android.support.p000v4.media.MediaBrowserCompatApi21.MediaItem.getDescription(obj)), android.support.p000v4.media.MediaBrowserCompatApi21.MediaItem.getFlags(obj));
        }
        ...
        public static List<MediaItem> fromMediaItemList(List<?> list) {
            ...
            for (Object fromMediaItem : list) {
                arrayList.add(MediaItem.fromMediaItem(fromMediaItem));
            }
            return arrayList;
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            ...
            stringBuilder2.append(MediaBrowserImplBase.getStateLabel(this.mState));
