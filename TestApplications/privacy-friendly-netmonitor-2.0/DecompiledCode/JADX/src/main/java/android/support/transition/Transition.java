...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C01131();
    ...
    class C01123 extends AnimatorListenerAdapter {
        C01123() {
        }
    ...
    static class C01131 extends PathMotion {
        C01131() {
        }
    ...
    L_0x0046:
        r1 = android.support.p000v4.view.ViewCompat.getTransitionName(r6);
        if (r1 == 0) goto L_0x0059;
    L_0x004c:
        r1 = r5.mTargetNameExcludes;
        r3 = android.support.p000v4.view.ViewCompat.getTransitionName(r6);
        r1 = r1.contains(r3);
        if (r1 == 0) goto L_0x0059;
    L_0x0058:
        return r2;
        ...
        for (size--; size >= 0; size--) {
            ...
            if (animator != null) {
                ...
                if (!(animationInfo == null || animationInfo.mView == null || !windowId.equals(animationInfo.mWindowId))) {
                    ...
                    int i = (!(transitionValues2 == null && matchedTransitionValues == null) && animationInfo.mTransition.isTransitionRequired(transitionValues, matchedTransitionValues)) ? 1 : 0;
                    if (i != 0) {
    ...
    public void animate(Animator animator) {
        ...
        animator.addListener(new C01123());
        animator.start();
    }
