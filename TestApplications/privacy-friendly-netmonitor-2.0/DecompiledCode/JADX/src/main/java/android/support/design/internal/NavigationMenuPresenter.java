...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final OnClickListener mOnClickListener = new C00261();
    ...
    private class NavigationMenuAdapter extends C0359Adapter<ViewHolder> {
    ...
    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, OnClickListener onClickListener) {
            super(layoutInflater.inflate(C0023R.layout.design_navigation_item, viewGroup, false));
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0023R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0023R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.mMenuView == null) {
            this.mMenuView = (NavigationMenuView) this.mLayoutInflater.inflate(C0023R.layout.design_navigation_menu, viewGroup, false);
