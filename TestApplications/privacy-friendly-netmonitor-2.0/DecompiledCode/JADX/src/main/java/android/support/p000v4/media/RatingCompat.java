...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C02021();
    ...
    static class C02021 implements Creator<RatingCompat> {
        C02021() {
        }
    ...
    public static RatingCompat fromRating(Object obj) {
        ...
        if (RatingCompatKitkat.isRated(obj)) {
            switch (ratingStyle) {
                case 1:
                    newHeartRating = RatingCompat.newHeartRating(RatingCompatKitkat.hasHeart(obj));
                    break;
                case 2:
                    newHeartRating = RatingCompat.newThumbRating(RatingCompatKitkat.isThumbUp(obj));
                    break;
                case 3:
                case 4:
                case 5:
                    newHeartRating = RatingCompat.newStarRating(ratingStyle, RatingCompatKitkat.getStarRating(obj));
                    break;
                case 6:
                    newHeartRating = RatingCompat.newPercentageRating(RatingCompatKitkat.getPercentRating(obj));
                    break;
                default:
                    return null;
            }
        }
        newHeartRating = RatingCompat.newUnratedRating(ratingStyle);
