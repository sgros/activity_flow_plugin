...
class ResourcesFlusher {
    ...
    static boolean flush(@NonNull Resources resources) {
        ...
        return VERSION.SDK_INT >= 21 ? ResourcesFlusher.flushLollipops(resources) : false;
    }
    ...
    L_0x003a:
        r4 = android.support.p003v7.app.ResourcesFlusher.flushThemedResourcesCache(r4);
        if (r4 == 0) goto L_0x0041;
    L_0x0040:
        r0 = r1;
    L_0x0041:
    ...
    private static boolean flushNougats(@NonNull Resources resources) {
        ...
        if (sDrawableCacheField != null) {
            ...
            if (obj == null || !ResourcesFlusher.flushThemedResourcesCache(obj)) {
                z = false;
            }
            return z;
        }
