...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C05281();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C05292();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05273();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C05273 implements ViewPropertyAnimatorUpdateListener {
        C05273() {
        }
    ...
    class C05281 extends ViewPropertyAnimatorListenerAdapter {
        C05281() {
        }
    ...
    class C05292 extends ViewPropertyAnimatorListenerAdapter {
        C05292() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0305R.C0304id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0305R.C0304id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0305R.C0304id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0305R.C0304id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0305R.styleable.ActionBar, C0305R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0305R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0305R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0305R.attr.actionBarWidgetTheme, typedValue, true);
