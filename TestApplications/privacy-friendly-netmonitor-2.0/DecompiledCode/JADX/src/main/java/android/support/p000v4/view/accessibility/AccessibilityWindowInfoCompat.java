...
public class AccessibilityWindowInfoCompat {
    ...
    public AccessibilityWindowInfoCompat getParent() {
        return VERSION.SDK_INT >= 21 ? AccessibilityWindowInfoCompat.wrapNonNullInstance(((AccessibilityWindowInfo) this.mInfo).getParent()) : null;
    }
    ...
    public AccessibilityWindowInfoCompat getChild(int i) {
        return VERSION.SDK_INT >= 21 ? AccessibilityWindowInfoCompat.wrapNonNullInstance(((AccessibilityWindowInfo) this.mInfo).getChild(i)) : null;
    }
    ...
    public static AccessibilityWindowInfoCompat obtain() {
        return VERSION.SDK_INT >= 21 ? AccessibilityWindowInfoCompat.wrapNonNullInstance(AccessibilityWindowInfo.obtain()) : null;
    }
    ...
    public static AccessibilityWindowInfoCompat obtain(AccessibilityWindowInfoCompat accessibilityWindowInfoCompat) {
        ...
        if (accessibilityWindowInfoCompat != null) {
            accessibilityWindowInfoCompat2 = AccessibilityWindowInfoCompat.wrapNonNullInstance(AccessibilityWindowInfo.obtain((AccessibilityWindowInfo) accessibilityWindowInfoCompat.mInfo));
        }
    ...
    public String toString() {
        ...
        stringBuilder.append(AccessibilityWindowInfoCompat.typeToString(getType()));
