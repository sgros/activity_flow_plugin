...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C02071();
        ...
        static class C02071 implements Creator<QueueItem> {
            C02071() {
            }
        ...
        public static QueueItem fromQueueItem(Object obj) {
            return (obj == null || VERSION.SDK_INT < 21) ? null : new QueueItem(obj, MediaDescriptionCompat.fromMediaDescription(android.support.p000v4.media.session.MediaSessionCompatApi21.QueueItem.getDescription(obj)), android.support.p000v4.media.session.MediaSessionCompatApi21.QueueItem.getQueueId(obj));
        }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C02081();
        private ResultReceiver mResultReceiver;

        /* renamed from: android.support.v4.media.session.MediaSessionCompat$ResultReceiverWrapper$1 */
        static class C02081 implements Creator<ResultReceiverWrapper> {
            C02081() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromToken(Object obj) {
            return Token.fromToken(obj, null);
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private Callback mVolumeCallback = new C02121();
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C02051 implements OnPlaybackPositionUpdateListener {
            C02051() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C02051());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C02061 implements OnMetadataUpdateListener {
            C02061() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C02061());
        }
