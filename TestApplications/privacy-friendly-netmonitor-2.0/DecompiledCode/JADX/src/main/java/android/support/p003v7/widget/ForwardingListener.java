...
public abstract class ForwardingListener implements OnTouchListener, OnAttachStateChangeListener {
    ...
    private boolean onTouchObserved(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case 2:
                ...
                if (findPointerIndex >= 0 && !ForwardingListener.pointInView(view, motionEvent.getX(findPointerIndex), motionEvent.getY(findPointerIndex), this.mScaledTouchSlop)) {
                    clearCallbacks();
    ...
    L_0x0037:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.ForwardingListener.onLongPress():void");
    }
