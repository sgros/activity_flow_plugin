...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new C03461();
    @VisibleForTesting
    ...
    private final OnScrollListener mOnScrollListener = new C05392();
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        /* synthetic */ AnimatorListener(FastScroller fastScroller, C03461 c03461) {
            this();
        }
    ...
    private class AnimatorUpdater implements AnimatorUpdateListener {
        ...
        /* synthetic */ AnimatorUpdater(FastScroller fastScroller, C03461 c03461) {
            this();
        }
    ...
    class C05392 extends OnScrollListener {
        C05392() {
        }
