...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0305R.attr.actionBarSize, 16842841};
    ...
    class C03251 extends AnimatorListenerAdapter {
        C03251() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C03251();
        this.mRemoveActionBarHideOffset = new C03262();
        this.mAddActionBarHideOffset = new C03273();
        init(context);
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0305R.C0304id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0305R.C0304id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0305R.C0304id.action_bar));
        }
    }
