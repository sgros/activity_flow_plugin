...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0305R.C0304id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0305R.C0304id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (childViewCache.mText1 != null) {
            setViewText(childViewCache.mText1, SuggestionsAdapter.getStringOrNull(cursor, this.mText1Col));
        }
        if (childViewCache.mText2 != null) {
            CharSequence formatUrl;
            String stringOrNull = SuggestionsAdapter.getStringOrNull(cursor, this.mText2UrlCol);
            if (stringOrNull != null) {
                formatUrl = formatUrl(stringOrNull);
            } else {
                formatUrl = SuggestionsAdapter.getStringOrNull(cursor, this.mText2Col);
            }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0305R.attr.textColorSearchUrl, typedValue, true);
    ...
    public CharSequence convertToString(Cursor cursor) {
        ...
        String columnString = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query");
        ...
        if (this.mSearchable.shouldRewriteQueryFromText()) {
            String columnString2 = SuggestionsAdapter.getColumnString(cursor, "suggest_text_1");
    ...
    public static String getColumnString(Cursor cursor, String str) {
        return SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex(str));
    }
