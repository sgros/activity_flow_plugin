...
class WhereCollector<T> {
    ...
    public void addCondition(StringBuilder stringBuilder, List<Object> list, WhereCondition whereCondition) {
        checkCondition(whereCondition);
    ...
    /* Access modifiers changed, original: 0000 */
    public void appendWhereClause(StringBuilder stringBuilder, String str, List<Object> list) {
