...
public class RxDao<T, K> extends RxBase {
    ...
    /* renamed from: org.greenrobot.greendao.rx.RxDao$18 */
    class C045618 implements Callable<Void> {
        C045618() {
        }
    ...
    /* renamed from: org.greenrobot.greendao.rx.RxDao$1 */
    class C04581 implements Callable<List<T>> {
        C04581() {
        }
    ...
    /* renamed from: org.greenrobot.greendao.rx.RxDao$23 */
    class C046223 implements Callable<Long> {
        C046223() {
        }
    ...
    public Observable<List<T>> loadAll() {
        return wrap((Callable) new C04581());
    }
    ...
    public Observable<Void> deleteAll() {
        return wrap((Callable) new C045618());
    }
    ...
    public Observable<Long> count() {
        return wrap((Callable) new C046223());
    }
