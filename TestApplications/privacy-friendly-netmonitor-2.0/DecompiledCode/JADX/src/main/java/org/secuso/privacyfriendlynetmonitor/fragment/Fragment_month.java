...
public class Fragment_month extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        instance.add(5, -29);
        dateBefore1month = instance.getTime();
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            public void onValueSelected(Entry entry, Highlight highlight) {
                ...
                if (entry.getY() != 0.0f) {
                    for (ReportEntity reportEntity : Fragment_month.filtered_Entities) {
                        if (((float) Fragment_month.this.getDaysBetween(Fragment_month.dateBefore1month, Fragment_month.this.getEntityDate(reportEntity))) == entry.getX()) {
                    ...
                    Fragment_month.this.fillRecyclerList(inflate, arrayList);
                }
            }
    ...
    private void fillChart(View view, BarChart barChart) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            ...
            if (i2 == strArr.length - 1) {
                ...
                stringBuilder = new StringBuilder();
                stringBuilder.append("- ");
                stringBuilder.append(Integer.toString(29 - i2));
                stringBuilder.append(getResources().getString(C0501R.string.f81d));
                strArr[i2] = stringBuilder.toString();
            }
        }
        C05572 c05572 = new IAxisValueFormatter() {
        ...
        xAxis.setValueFormatter(c05572);
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                if (reportEntity.getAppName().equals(str)) {
                    ...
                    if (obj == null) {
                        try {
                            if (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").parse(reportEntity.getTimeStamp()).after(dateBefore1month)) {
