...
public abstract class AbstractDaoSessionTest<T extends AbstractDaoMaster, S extends AbstractDaoSession> extends DbTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        try {
            this.daoMaster = (AbstractDaoMaster) this.daoMasterClass.getConstructor(new Class[]{Database.class}).newInstance(new Object[]{this.f76db});
            this.daoMasterClass.getMethod("createAllTables", new Class[]{Database.class, Boolean.TYPE}).invoke(null, new Object[]{this.f76db, Boolean.valueOf(false)});
