...
public class ExpandableReportAdapter extends BaseExpandableListAdapter {
   ...
   public View getChildView(int var1, int var2, boolean var3, View var4, ViewGroup var5) {
      ...
      TextView var14 = (TextView)var8.findViewById(2131296452);
      var14.setText(var11);
      SharedPreferences var9 = PreferenceManager.getDefaultSharedPreferences(this.context);
      var14.setTextColor(this.context.getResources().getColor(this.getWarningColor(var11)));
      if (!var9.getBoolean("IS_HIGHLIGHTED", true)) {
         var14.setTextColor(2131099756);
      }
   ...
   public View getGroupView(int var1, boolean var2, View var3, ViewGroup var4) {
      ...
      TextView var8 = (TextView)var9.findViewById(2131296441);
      var8.setTypeface((Typeface)null, 1);
      TextView var5 = (TextView)var9.findViewById(2131296439);
      ...
      var5.setText(Collector.getPackage(var1));
