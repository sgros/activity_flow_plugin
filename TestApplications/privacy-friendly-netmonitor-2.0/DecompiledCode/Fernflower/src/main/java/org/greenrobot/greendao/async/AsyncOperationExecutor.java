      ...
      while(true) {
         label675: {
               ...
               label676: {
                  ...
                  label677: {
                     ...
                     if (var8 != var2) {
                        label640:
                        try {
                           DaoException var68 = new DaoException("Internal error: peeked op did not match removed op");
                           throw var68;
            ...
            try {
               ...
               var66.append("Async transaction could not be ended, success so far was: ");
               var66.append(var7);
               DaoLog.i(var66.toString(), var58);
               var7 = var4;
            }

            if (var7) {
               var5 = var3.size();
               Iterator var67 = var3.iterator();

               while(var67.hasNext()) {
                  var2 = (AsyncOperation)var67.next();
               ...
               Iterator var71 = var3.iterator();

               while(var71.hasNext()) {
                  var1 = (AsyncOperation)var71.next();
                  var1.reset();
                  this.executeOperationAndPostCompleted(var1);
               }
            }
