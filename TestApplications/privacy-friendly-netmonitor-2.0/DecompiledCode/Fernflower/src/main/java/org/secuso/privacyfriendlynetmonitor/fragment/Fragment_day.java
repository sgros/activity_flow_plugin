   ...
   private void fillChart(View var1, BarChart var2) {
      ...
      while(true) {
         ...
         if (!var8) {
            ...
            int[] var27 = new int[24];
            int[] var25 = new int[24];

            for(var11 = 0; var11 < var16.length; ++var11) {
               int var26 = (var11 + (23 - var4)) % 24;
               var12[var26] = var16[var11];
               var27[var26] = var18[var11];
               var25[var26] = var6[var11];
            }

            for(var11 = 0; var11 < var12.length; ++var11) {
               var5.add(new BarEntry((float)var11, new float[]{(float)var25[var11], (float)var12[var11], (float)var27[var11]}));
            }
            ...
            for(var11 = 0; var11 < var17.length; ++var11) {
               ...
               if (var11 == var17.length - 1) {
                  ...
                  var17[var11] = var23.toString();
               } else {
                  var23 = new StringBuilder();
                  var23.append("- ");
                  var23.append(Integer.toString(23 - var11));
   ...
   private void loadFilteredList(String var1) {
      ...
      while(true) {
         ...
         if (!var3) {
            ...
            try {
               Date var10 = new Date();
               Date var12 = var7.parse(var7.format(var10));
               Calendar var11 = Calendar.getInstance();
               var11.setTime(var12);
               var11.add(5, -1);
               var10 = var11.getTime();
               String var8 = var4.getTimeStamp();
               var7 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
               if (var7.parse(var8).after(var10)) {
   ...
   public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
      ...
      var10.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
         ...
         public void onValueSelected(Entry var1, Highlight var2) {
            ...
            try {
               var4 = new Date();
               var4 = var3.parse(var3.format(var4));
            } catch (ParseException var7) {
               var7.printStackTrace();
               var4 = null;
            }

            int var5 = var4.getHours();
            ArrayList var6 = new ArrayList();
            if (var1.getY() != 0.0F) {
               Iterator var8x = Fragment_day.filtered_Entities.iterator();

               while(var8x.hasNext()) {
                  ReportEntity var9 = (ReportEntity)var8x.next();
                  if ((float)((Fragment_day.this.getEntityHour(var9) + (23 - var5)) % 24) == var1.getX()) {
                     if (var2.getStackIndex() == 0 && var9.getConnectionInfo().contains("Unknown")) {
                        var6.add(var9);
                     }

                     if (var2.getStackIndex() == 1 && var9.getConnectionInfo().contains("Encrypted")) {
                        var6.add(var9);
                     }

                     if (var2.getStackIndex() == 2 && var9.getConnectionInfo().contains("Unencrypted")) {
                        var6.add(var9);
                     }
                  }
               }

               Fragment_day.this.fillRecyclerList(var8, var6);
            }
