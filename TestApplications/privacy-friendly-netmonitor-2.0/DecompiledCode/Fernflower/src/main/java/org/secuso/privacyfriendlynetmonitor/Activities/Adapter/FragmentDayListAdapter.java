   ...
   public void onBindViewHolder(FragmentDayListAdapter.ViewHolder var1, int var2) {
      ...
      var1.relativeLayout.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            List var3x = FragmentDayListAdapter.this.prepareData(var3);
            Intent var2 = new Intent(FragmentDayListAdapter.this.context, HistoryDetailActivity.class);
            var2.putExtra("Details", (ArrayList)var3x);
            FragmentDayListAdapter.this.context.startActivity(var2);
         }
      });
   }
