...
public final class BulkCursorToCursorAdaptor extends AbstractWindowedCursor {
   ...
   public boolean requery() {
      try {
         ...
         IContentObserver var6 = this.getObserver();
         CursorWindow var4 = new CursorWindow(false);
         this.mCount = var2.requery(var6, var4);
         if (this.mCount != -1) {
            this.mPos = -1;
            this.mWindow = null;
            super.requery();
         ...
         var3.append("Unable to requery because the remote process exception ");
         var3.append(var5.getMessage());
         Log.e("BulkCursor", var3.toString());
         this.deactivate();
         return false;
      }
   }
