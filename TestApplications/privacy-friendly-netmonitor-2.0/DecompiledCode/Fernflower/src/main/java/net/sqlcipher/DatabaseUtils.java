   ...
   public static class InsertHelper {
      ...
      private void buildSQL() throws SQLException {
         ...
         try {
            ...
            var4.append(")");
            var80 = var3.rawQuery(var4.toString(), (String[])null);
         } finally {
            ;
         }
         ...
         label760: {
            ...
            label761: {
               boolean var10001;
               try {
                  HashMap var81 = new HashMap(var80.getCount());
                  this.mColumns = var81;
               ...
               while(true) {
                  ...
                  try {
                     ...
                     var82 = var80.getString(1);
                     var6 = var80.getString(4);
                     this.mColumns.put(var82, var5);
                     var1.append("'");
                     var1.append(var82);
                     var1.append("'");
      ...
      public long execute() {
         if (this.mPreparedStatement == null) {
            ...
            try {
               ...
               StringBuilder var3 = new StringBuilder();
               var3.append("Error executing InsertHelper with table ");
               var3.append(this.mTableName);
               Log.e("DatabaseUtils", var3.toString(), var7);
            } finally {
