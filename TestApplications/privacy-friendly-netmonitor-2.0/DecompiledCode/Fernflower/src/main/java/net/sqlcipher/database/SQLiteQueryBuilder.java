      ...
      if (var1 != null && var1.length > 0) {
         if (this.mProjectionMap == null) {
            ...
            for(int var7 = var1.length; var3 < var7; ++var3) {
               ...
               String var11 = (String)this.mProjectionMap.get(var9);
               if (var11 != null) {
                  var4[var3] = var11;
               } else {
                  if (this.mStrictProjectionMap || !var9.contains(" AS ") && !var9.contains(" as ")) {
                     StringBuilder var10 = new StringBuilder();
                     var10.append("Invalid column ");
                     var10.append(var1[var3]);
         ...
         Set var5 = this.mProjectionMap.entrySet();
         var1 = new String[var5.size()];
         Iterator var8 = var5.iterator();
         var3 = var2;

         while(var8.hasNext()) {
            Entry var6 = (Entry)var8.next();
            if (!((String)var6.getKey()).equals("_count")) {
               var1[var3] = (String)var6.getValue();
               ++var3;
            }
         }
