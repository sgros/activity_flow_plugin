...
public class BubbleChartRenderer extends BarLineScatterCandleBubbleRenderer {
   ...
   protected void drawDataSet(Canvas var1, IBubbleDataSet var2) {
      ...
      var6 = Math.min(Math.abs(this.mViewPortHandler.contentBottom() - this.mViewPortHandler.contentTop()), var6);

      for(int var7 = this.mXBounds.min; var7 <= this.mXBounds.range + this.mXBounds.min; ++var7) {
         BubbleEntry var8 = (BubbleEntry)var2.getEntryForIndex(var7);
         this.pointBuffer[0] = var8.getX();
         this.pointBuffer[1] = var8.getY() * var4;
         var3.pointValuesToPixel(this.pointBuffer);
         float var9 = this.getShapeSize(var8.getSize(), var2.getMaxSize(), var6, var5) / 2.0F;
         if (this.mViewPortHandler.isInBoundsTop(this.pointBuffer[1] + var9) && this.mViewPortHandler.isInBoundsBottom(this.pointBuffer[1] - var9) && this.mViewPortHandler.isInBoundsLeft(this.pointBuffer[0] + var9)) {
            if (!this.mViewPortHandler.isInBoundsRight(this.pointBuffer[0] - var9)) {
               break;
            }

            int var10 = var2.getColor((int)var8.getX());
            this.mRenderPaint.setColor(var10);
            var1.drawCircle(this.pointBuffer[0], this.pointBuffer[1], var9, this.mRenderPaint);
         }
      }
            ...
            for(int var5 = 0; var5 < var3.size(); ++var5) {
               ...
               if (this.shouldDrawValues(var6)) {
                  ...
                  for(int var10 = 0; var10 < var9.length; var10 += 2) {
                     ...
                     var12 = Color.argb(Math.round(255.0F * var7), Color.red(var12), Color.green(var12), Color.blue(var12));
                     float var13 = var9[var10];
                     var8 = var9[var10 + 1];
                     if (!this.mViewPortHandler.isInBoundsRight(var13)) {
                        break;
                     }

                     if (this.mViewPortHandler.isInBoundsLeft(var13) && this.mViewPortHandler.isInBoundsY(var8)) {
                        BubbleEntry var14 = (BubbleEntry)var6.getEntryForIndex(var11 + this.mXBounds.min);
                        if (var6.isDrawValuesEnabled()) {
                           this.drawValue(var1, var6.getValueFormatter(), var14.getSize(), var14, var5, var13, var8 + 0.5F * var4, var12);
                        }

                        if (var14.getIcon() != null && var6.isDrawIconsEnabled()) {
                           Drawable var17 = var14.getIcon();
                           Utils.drawImage(var1, var17, (int)(var13 + var16.x), (int)(var8 + var16.y), var17.getIntrinsicWidth(), var17.getIntrinsicHeight());
                        }
                     }
                  }
