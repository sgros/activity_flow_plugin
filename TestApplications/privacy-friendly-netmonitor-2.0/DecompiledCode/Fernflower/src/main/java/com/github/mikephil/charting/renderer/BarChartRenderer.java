...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
   ...
   protected void drawDataSet(Canvas var1, IBarDataSet var2, int var3) {
      ...
      var5 = this.mAnimator.getPhaseY();
      int var11;
      int var12;
      float var13;
      if (this.mChart.isDrawBarShadowEnabled()) {
         this.mShadowPaint.setColor(var2.getBarShadowColor());
         float var10 = this.mChart.getBarData().getBarWidth() / 2.0F;
      ...
      for(; var12 < var14.size(); var12 += 4) {
         ...
         int var20 = var12 + 2;
         if (var17.isInBoundsLeft(var15[var20])) {
            ...
            var9 = var14.buffer[var12];
            float[] var18 = var14.buffer;
            var11 = var12 + 1;
            var5 = var18[var11];
            var13 = var14.buffer[var20];
            var18 = var14.buffer;
            int var19 = var12 + 3;
            var1.drawRect(var9, var5, var13, var18[var19], this.mRenderPaint);
            if (var8) {
               var1.drawRect(var14.buffer[var12], var14.buffer[var11], var14.buffer[var20], var14.buffer[var19], this.mBarBorderPaint);
            }
         }
      }
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if (var7 != null && var7.isHighlightEnabled()) {
            ...
            if (this.isInBoundsX(var8, var7)) {
               ...
               label36: {
                  if (var10) {
                     if (!this.mChart.isHighlightFullBarEnabled()) {
                        Range var14 = var8.getRanges()[var6.getStackIndex()];
                        var12 = var14.from;
                        var11 = var14.to;
                        break label36;
                     }
               ...
               this.prepareBarHighlight(var8.getX(), var12, var11, var3.getBarWidth() / 2.0F, var9);
            ...
            if (!this.shouldDrawValues(var6)) {
               ...
               if (!var6.isStacked()) {
                  ...
                  for(var32 = var16; (float)var17 < (float)var18.buffer.length * this.mAnimator.getPhaseX(); var17 += 4) {
                     ...
                     var20 = var17 + 1;
                     if (var19.isInBoundsY(var37[var20]) && this.mViewPortHandler.isInBoundsLeft(var12)) {
                        var21 = var17 / 4;
                  ...
                  while(true) {
                     ...
                     label216: {
                        ...
                        if (var34 == null) {
                           ...
                           var25 = var14.buffer;
                           var21 = var20 + 1;
                           if (!var19.isInBoundsY(var25[var21]) || !this.mViewPortHandler.isInBoundsLeft(var22)) {
                              var21 = var20;
                              break label216;
                           }

                           if (var6.isDrawValuesEnabled()) {
                              IValueFormatter var43 = var6.getValueFormatter();
                              var12 = var23.getY();
                              ...
                              this.drawValue(var1, var43, var12, var23, var5, var22, var10 + var11, var24);
                           }

                           if (var23.getIcon() != null && var6.isDrawIconsEnabled()) {
                              Drawable var44 = var23.getIcon();
                              ...
                              var10 = var40.x;
                              var26 = var40.y;
                              Utils.drawImage(var1, var44, (int)(var22 + var10), (int)(var12 + var11 + var26), var44.getIntrinsicWidth(), var44.getIntrinsicHeight());
                           }
                        } else {
                           var25 = var34;
                           float[] var42 = new float[var34.length * 2];
                           var11 = -var23.getNegativeSum();
                           var10 = 0.0F;
                           int var27 = 0;

                           float var29;
                           for(var21 = 0; var27 < var42.length; var11 = var29) {
                              label165: {
                              ...
                              var42[var27 + 1] = var12 * var15;
                              var27 += 2;
                              ++var21;
                              var10 = var26;
                           }

                           var33.pointValuesToPixel(var42);

                           for(var21 = 0; var21 < var42.length; var21 += 2) {
                              int var30 = var21 / 2;
                              var12 = var25[var30];
                              boolean var45;
