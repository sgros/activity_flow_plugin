   ...
   protected void calcMinMax() {
      if (this.mDataSets != null) {
         ...
         if (var3 != null) {
            ...
            while(var1.hasNext()) {
               IDataSet var2 = (IDataSet)var1.next();
         ...
         if (var3 != null) {
            ...
            Iterator var4 = this.mDataSets.iterator();

            while(var4.hasNext()) {
               var3 = (IDataSet)var4.next();
               if (var3.getAxisDependency() == YAxis.AxisDependency.RIGHT) {
                  if (var3.getYMin() < this.mRightAxisMin) {
                     this.mRightAxisMin = var3.getYMin();
                  }

                  if (var3.getYMax() > this.mRightAxisMax) {
                     this.mRightAxisMax = var3.getYMax();
                  }
               }
            }
