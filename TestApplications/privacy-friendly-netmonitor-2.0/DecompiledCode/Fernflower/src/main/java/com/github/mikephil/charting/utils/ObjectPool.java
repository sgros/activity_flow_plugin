      ...
      while(true) {
         ...
         label455: {
            ...
            while(true) {
               ...
               label446: {
                  IllegalArgumentException var48;
                  try {
                     ...
                     if (var4.currentOwnerId == this.poolId) {
                        var48 = new IllegalArgumentException("The object passed is already stored in this pool!");
                        throw var48;
                     }
                  ...
                  try {
                     ...
                     var5.append("The object to recycle already belongs to poolId ");
                     var5.append(var4.currentOwnerId);
                     var5.append(".  Object cannot belong to two different pool instances simultaneously!");
                     var48 = new IllegalArgumentException(var5.toString());
                     throw var48;
