   ...
   protected void drawDataSet(Canvas var1, IBarDataSet var2, int var3) {
      ...
      if (this.mChart.isDrawBarShadowEnabled()) {
         ...
         for(var12 = 0; var12 < var11; ++var12) {
            ...
            this.mBarShadowRectBuffer.top = var13 - var5;
            this.mBarShadowRectBuffer.bottom = var13 + var5;
      ...
      for(; var12 < var14.size(); var12 += 4) {
         ...
         ViewPortHandler var18 = this.mViewPortHandler;
         float[] var21 = var14.buffer;
         int var20 = var12 + 1;
         if (var18.isInBoundsBottom(var21[var20])) {
            if (!var16) {
               this.mRenderPaint.setColor(var2.getColor(var12 / 4));
            }

            var13 = var14.buffer[var12];
            var5 = var14.buffer[var20];
            var17 = var14.buffer;
            var11 = var12 + 2;
            var1.drawRect(var13, var5, var17[var11], var14.buffer[var19], this.mRenderPaint);
            if (var8) {
               var1.drawRect(var14.buffer[var12], var14.buffer[var20], var14.buffer[var11], var14.buffer[var19], this.mBarBorderPaint);
            }
         }
      }
               ...
               if (!var6.isStacked()) {
                     ...
                     if (this.mViewPortHandler.isInBoundsX(var18.buffer[var13]) && this.mViewPortHandler.isInBoundsBottom(var18.buffer[var19])) {
                        ...
                        if (var36.getIcon() != null) {
                           ...
                           if (var6.isDrawIconsEnabled()) {
                              ...
                              var25 = var34.x;
                              var24 = var34.y;
                              Utils.drawImage(var1, var42, (int)(var23 + var22 + var25), (int)(var20 + var24), var42.getIntrinsicWidth(), var42.getIntrinsicHeight());
                              var17 = var39;
                           }
                        }
                     }
                  ...
                  while(true) {
                     ...
                     while(true) {
                        ...
                        int var29;
                        if (var35 == null) {
                           ViewPortHandler var45 = this.mViewPortHandler;
                           var28 = var10.buffer;
                           var29 = var13 + 1;
                           if (!var45.isInBoundsTop(var28[var29])) {
                              var43 = var41;
                              var25 = var3;
                              var15 = var4;
                              var2 = var44;
                           ...
                           if (var40.getIcon() != null) {
                              ...
                              if (var6.isDrawIconsEnabled()) {
                                 ...
                                 var25 = var41.x;
                                 var24 = var41.y;
                                 Utils.drawImage(var1, var47, (int)(var23 + var22 + var25), (int)(var14 + var24), var47.getIntrinsicWidth(), var47.getIntrinsicHeight());
                                 var15 = var4;
                              }
                           }
                        } else {
                           var25 = var3;
                           var28 = var35;
                           float[] var48 = new float[var35.length * 2];
                           var22 = -var40.getNegativeSum();
                           var21 = 0.0F;
                           int var30 = 0;

                           for(var29 = 0; var30 < var48.length; var22 = var24) {
                              label201: {
                                 var20 = var28[var29];
                                 if (var20 == 0.0F) {
                                    var23 = var20;
                              ...
                              var48[var30] = var23 * var11;
                              var30 += 2;
                              ++var29;
                              var21 = var14;
                           }

                           var26.pointValuesToPixel(var48);
                           var29 = 0;

                           while(true) {
                              var15 = var4;
                              if (var29 >= var48.length) {
                                 break;
                              }

                              float var31 = var28[var29 / 2];
