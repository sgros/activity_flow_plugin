...
public class ViewPortHandler {
   ...
   public void limitTransAndScale(Matrix var1, RectF var2) {
      ...
      this.mTransX = Math.min(Math.max(var3, -var4 * (this.mScaleX - 1.0F) - this.mTransOffsetX), this.mTransOffsetX);
      this.mTransY = Math.max(Math.min(var5, var6 * (this.mScaleY - 1.0F) + this.mTransOffsetY), -this.mTransOffsetY);
