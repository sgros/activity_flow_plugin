...
public abstract class PieRadarChartBase extends Chart {
   ...
   public void calculateOffsets() {
      ...
      if (var1 != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
                  ...
                  label100: {
                     ...
                     case VERTICAL:
                        if (this.mLegend.getHorizontalAlignment() != Legend.LegendHorizontalAlignment.LEFT && this.mLegend.getHorizontalAlignment() != Legend.LegendHorizontalAlignment.RIGHT) {
                           ...
                           var6 = this.mLegend.mNeededHeight;
                           var2 = this.mLegend.mTextHeightMax;
                           MPPointF var11 = this.getCenter();
                           ...
                           var2 = var6 + var2 + 15.0F;
                           var6 = this.distanceToCenter(var4, var2);
                           MPPointF var7 = this.getPosition(var11, this.getRadius(), this.getAngleForPoint(var4, var2));
                           var8 = this.distanceToCenter(var7.x, var7.y);
                           var4 = Utils.convertDpToPixel(5.0F);
                           if (var2 >= var11.y && (float)this.getHeight() - var5 > (float)this.getWidth()) {
                              var4 = var5;
                           } else if (var6 < var8) {
                              var4 += var8 - var6;
                           } else {
         ...
         var4 += this.getRequiredBaseOffset();
         var6 += this.getRequiredBaseOffset();
         var2 = var5 + this.getRequiredBaseOffset();
         var5 = var4;
         var4 = var2;
      } else {
         var5 = 0.0F;
