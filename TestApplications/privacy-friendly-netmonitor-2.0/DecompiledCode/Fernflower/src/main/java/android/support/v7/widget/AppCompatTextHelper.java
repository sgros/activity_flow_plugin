...
class AppCompatTextHelper {
   ...
   void loadFromAttributes(AttributeSet var1, int var2) {
      ...
      if (var6 != -1) {
         ...
         if (VERSION.SDK_INT < 23) {
            if (var8.hasValue(R.styleable.TextAppearance_android_textColor)) {
               var19 = var8.getColorStateList(R.styleable.TextAppearance_android_textColor);
            } else {
               var19 = null;
            }

            if (var8.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
               var18 = var8.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
            } else {
               var18 = null;
            }
      ...
      ColorStateList var15 = var19;
      ColorStateList var16 = var9;
      ColorStateList var20 = var18;
      if (VERSION.SDK_INT < 23) {
         if (var12.hasValue(R.styleable.TextAppearance_android_textColor)) {
            var19 = var12.getColorStateList(R.styleable.TextAppearance_android_textColor);
         }

         if (var12.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
            var18 = var12.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
         }
