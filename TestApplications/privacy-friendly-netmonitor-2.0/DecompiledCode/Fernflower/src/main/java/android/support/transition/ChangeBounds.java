      ...
      if (var2 != null && var3 != null) {
         ...
         if (var33 != null && var6 != null) {
            ...
            if (this.parentMatches(var33, var6)) {
               ...
               Rect var35 = (Rect)var3.values.get("android:changeBounds:bounds");
               int var7 = var22.left;
               final int var8 = var35.left;
               var9 = var22.top;
               final int var10 = var35.top;
               var11 = var22.right;
               final int var12 = var35.right;
               int var13 = var22.bottom;
               final int var14 = var35.bottom;
               ...
               final Rect var39 = (Rect)var3.values.get("android:changeBounds:clip");
               ...
               label149: {
                  if (var27 == null || var27.equals(var39)) {
                     var19 = var20;
                     if (var27 != null) {
                        break label149;
                     }
               ...
               if (var19 > 0) {
                  ...
                  Object var25;
                  if (!this.mResizeClip) {
                     ViewUtils.setLeftTopRightBottom(var37, var7, var9, var11, var13);
                     Path var31;
                     if (var19 == 2) {
                        if (var15 == var17 && var16 == var18) {
                           var31 = this.getPathMotion().getPath((float)var7, (float)var9, (float)var8, (float)var10);
                           var25 = ObjectAnimatorUtils.ofPointF(var37, POSITION_PROPERTY, var31);
                        } else {
                           final ChangeBounds.ViewBounds var29 = new ChangeBounds.ViewBounds(var37);
                           ...
                           ObjectAnimator var36 = ObjectAnimatorUtils.ofPointF(var29, BOTTOM_RIGHT_PROPERTY, var23);
                           var25 = new AnimatorSet();
                           ((AnimatorSet)var25).playTogether(new Animator[]{var30, var36});
                        ...
                        var25 = ObjectAnimatorUtils.ofPointF(var37, BOTTOM_RIGHT_ONLY_PROPERTY, var31);
                     } else {
                        var31 = this.getPathMotion().getPath((float)var7, (float)var9, (float)var8, (float)var10);
                        var25 = ObjectAnimatorUtils.ofPointF(var37, TOP_LEFT_ONLY_PROPERTY, var31);
                     }
                  } else {
                     ViewUtils.setLeftTopRightBottom(var37, var7, var9, Math.max(var15, var17) + var7, Math.max(var16, var18) + var9);
                     ObjectAnimator var32;
                     if (var7 == var8 && var9 == var10) {
                        var32 = null;
                     } else {
                        var23 = this.getPathMotion().getPath((float)var7, (float)var9, (float)var8, (float)var10);
                        var32 = ObjectAnimatorUtils.ofPointF(var37, POSITION_PROPERTY, var23);
                     }
                     ...
                     if (!var27.equals(var34)) {
                        ViewCompat.setClipBounds(var37, var27);
                        var38 = ObjectAnimator.ofObject(var37, "clipBounds", sRectEvaluator, new Object[]{var27, var34});
                        var38.addListener(new AnimatorListenerAdapter() {
                           ...
                           public void onAnimationEnd(Animator var1) {
                              if (!this.mIsCanceled) {
                                 ViewCompat.setClipBounds(var37, var39);
                                 ViewUtils.setLeftTopRightBottom(var37, var8, var10, var12, var14);
                              }
                  ...
                  if (var37.getParent() instanceof ViewGroup) {
                     final ViewGroup var40 = (ViewGroup)var37.getParent();
                     ViewGroupUtils.suppressLayout(var40, true);
                     this.addListener(new TransitionListenerAdapter() {
                        boolean mCanceled = false;

                        public void onTransitionCancel(@NonNull Transition var1) {
                           ViewGroupUtils.suppressLayout(var40, false);
                           this.mCanceled = true;
                        }
               ...
               var9 = (Integer)var2.values.get("android:changeBounds:windowX");
               ...
               if (var9 != var20 || var19 != var11) {
                  var1.getLocationInWindow(this.mTempLocation);
                  Bitmap var24 = Bitmap.createBitmap(var37.getWidth(), var37.getHeight(), Config.ARGB_8888);
                  var37.draw(new Canvas(var24));
                  final BitmapDrawable var26 = new BitmapDrawable(var24);
                  final float var21 = ViewUtils.getTransitionAlpha(var37);
                  ViewUtils.setTransitionAlpha(var37, 0.0F);
                  ViewUtils.getOverlay(var1).add(var26);
                  Path var28 = this.getPathMotion().getPath((float)(var9 - this.mTempLocation[0]), (float)(var19 - this.mTempLocation[1]), (float)(var20 - this.mTempLocation[0]), (float)(var11 - this.mTempLocation[1]));
                  ...
                  var30.addListener(new AnimatorListenerAdapter() {
                     public void onAnimationEnd(Animator var1x) {
                        ...
                        ViewUtils.setTransitionAlpha(var37, var21);
                     }
                  });
                  return var30;
               }
