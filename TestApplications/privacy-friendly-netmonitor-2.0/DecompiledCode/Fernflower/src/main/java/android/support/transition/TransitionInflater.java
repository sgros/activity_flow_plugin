...
public class TransitionInflater {
                  ...
                  if (var7 != null) {
                     ...
                     if (var7 != null) {
                        ...
                        label83: {
                           ...
                           label60: {
                              var7 = TypedArrayUtils.getNamedString(var6, var1, "excludeClass", 3);
   ...
   public Transition inflateTransition(int var1) {
      ...
      try {
         ...
         try {
            ...
            var3 = new InflateException(var5.toString(), var10);
            throw var3;
         }
      } finally {
         var2.close();
   ...
   public TransitionManager inflateTransitionManager(int var1, ViewGroup var2) {
      ...
      TransitionManager var14;
      try {
         var14 = this.createTransitionManagerFromXml(var3, Xml.asAttributeSet(var3), var2);
      } catch (XmlPullParserException var9) {
         InflateException var13 = new InflateException(var9.getMessage());
         var13.initCause(var9);
         throw var13;
      } catch (IOException var10) {
         ...
         InflateException var5 = new InflateException(var12.toString());
