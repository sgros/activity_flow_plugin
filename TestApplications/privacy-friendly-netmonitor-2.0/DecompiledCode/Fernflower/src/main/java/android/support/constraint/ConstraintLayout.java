...
public class ConstraintLayout extends ViewGroup {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         if (var7.getVisibility() != 8) {
            ...
            if (!var8.isGuideline) {
               ...
               if (var14) {
                  if (var10 != 0 && var10 != -1) {
                     var15 = getChildMeasureSpec(var1, var4, var10);
                     var14 = false;
                  } else {
                     var15 = getChildMeasureSpec(var1, var4, -2);
                     var14 = true;
                  }
                  ...
                  var7.measure(var15, var11);
                  var11 = var7.getMeasuredWidth();
               ...
               var9.setWidth(var11);
               var9.setHeight(var15);
               if (var14) {
                  var9.setWrapWidth(var11);
               }

               if (var13) {
                  var9.setWrapHeight(var15);
               }

               if (var8.needsBaseline) {
                  int var16 = var7.getBaseline();
                  if (var16 != -1) {
                     var9.setBaselineDistance(var16);
                  }
               }
            }
         }
         ...
         if (var4 != null) {
            ...
            if (var5.isGuideline) {
               ...
               if (android.os.Build.VERSION.SDK_INT < 17) {
                  var9 = var5.leftToLeft;
                  var8 = var5.leftToRight;
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      var3 = this.mLayoutWidget.getWidth() + var9;
      var4 = this.mLayoutWidget.getHeight() + var8;
      if (android.os.Build.VERSION.SDK_INT >= 11) {
         var1 = resolveSizeAndState(var3, var1, var15);
         var2 = resolveSizeAndState(var4, var2, var15 << 16);
         var1 = Math.min(this.mMaxWidth, var1);
         var3 = Math.min(this.mMaxHeight, var2);
         var2 = var1 & 16777215;
         var3 &= 16777215;
         var1 = var2;
            ...
            if (var5 == R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf) {
               ...
               if (this.dimensionRatio != null) {
                  ...
                  if (var7 >= 0 && var7 < var6 - 1) {
                     var16 = this.dimensionRatio.substring(var5, var7);
                     String var8 = this.dimensionRatio.substring(var7 + 1);
                     if (var16.length() > 0 && var8.length() > 0) {
                        float var9;
                        float var10;
                        try {
                           var9 = Float.parseFloat(var16);
