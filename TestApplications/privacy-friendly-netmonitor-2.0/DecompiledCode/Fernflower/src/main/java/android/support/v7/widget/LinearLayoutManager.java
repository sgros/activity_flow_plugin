...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
   ...
   private void updateLayoutState(int var1, int var2, boolean var3, RecyclerView.State var4) {
      ...
      if (var1 == 1) {
         ...
         View var6 = this.getChildClosestToEnd();
         var7 = this.mLayoutState;
         if (!this.mShouldReverseLayout) {
            var5 = 1;
         }

         var7.mItemDirection = var5;
         this.mLayoutState.mCurrentPosition = this.getPosition(var6) + this.mLayoutState.mItemDirection;
         this.mLayoutState.mOffset = this.mOrientationHelper.getDecoratedEnd(var6);
         var1 = this.mOrientationHelper.getDecoratedEnd(var6) - this.mOrientationHelper.getEndAfterPadding();
      } else {
      ...
      if ((var3 != null || this.mPendingScrollPosition != -1) && var2.getItemCount() == 0) {
         ...
         if (this.getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
               var7 = this.fixLayoutEndGap(var6, var1, var2, true);
               var11 = var5 + var7;
               var5 = this.fixLayoutStartGap(var11, var1, var2, false);
               var11 += var5;
               var7 = var6 + var7 + var5;
            } else {
               var11 = this.fixLayoutStartGap(var5, var1, var2, true);
               var7 = var6 + var11;
               var6 = this.fixLayoutEndGap(var7, var1, var2, false);
               var11 = var5 + var11 + var6;
               var7 += var6;
            }
         }

         this.layoutForPredictiveAnimations(var1, var2, var11, var7);
         if (!var2.isPreLayout()) {
         ...
         if (var2 >= 0) {
            ...
            if (this.mLayoutFromEnd) {
               ...
               if (var3 > 0) {
                  ...
                  var5 = this.mCoordinate;
                  var6 = LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
                  var4 = var5 - var4 - (var6 + Math.min(LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(var1) - var6, 0));
                  if (var4 < 0) {
                     this.mCoordinate += Math.min(var3, -var4);
                  }
               }
            } else {
               var5 = LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(var1);
               var3 = var5 - LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
               this.mCoordinate = var5;
               if (var3 > 0) {
                  var6 = LinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(var1);
                  int var7 = LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding();
                  var4 = LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(var1);
                  var4 = LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - Math.min(0, var7 - var2 - var4) - (var5 + var6);
                  if (var4 < 0) {
                     this.mCoordinate -= Math.min(var3, -var4);
                  }
               }
