...
public class ToolbarWidgetWrapper implements DecorToolbar {
   ...
   public ToolbarWidgetWrapper(Toolbar var1, boolean var2, int var3, int var4) {
      ...
      if (var2) {
         ...
         int var7 = var8.getDimensionPixelOffset(R.styleable.ActionBar_contentInsetStart, -1);
         var4 = var8.getDimensionPixelOffset(R.styleable.ActionBar_contentInsetEnd, -1);
         if (var7 >= 0 || var4 >= 0) {
            this.mToolbar.setContentInsetsRelative(Math.max(var7, 0), Math.max(var4, 0));
         }
   ...
   public void setNavigationMode(int var1) {
      ...
      if (var1 != var2) {
         ...
         default:
            ...
            var4.append("Invalid navigation mode ");
            var4.append(var1);
