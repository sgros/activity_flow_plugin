...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
   ...
   public void buildMenuView() {
      ...
      if (this.mButtons != null) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            BottomNavigationItemView var4 = var1[var3];
            this.mItemPool.release(var4);
         }
      }
      ...
      if (this.mMenu.size() == 0) {
         ...
         this.mShiftingMode = var5;

         for(var3 = 0; var3 < this.mMenu.size(); ++var3) {
            this.mPresenter.setUpdateSuspended(true);
            this.mMenu.getItem(var3).setCheckable(true);
            this.mPresenter.setUpdateSuspended(false);
            BottomNavigationItemView var6 = this.getNewItem();
            this.mButtons[var3] = var6;
            ...
            var6.initialize((MenuItemImpl)this.mMenu.getItem(var3), 0);
            var6.setItemPosition(var3);
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      int var4 = MeasureSpec.makeMeasureSpec(this.mItemHeight, 1073741824);
      int var10002;
      int var5;
      int[] var7;
      int var8;
      if (this.mShiftingMode) {
         var1 = var3 - 1;
         var5 = Math.min(var2 - this.mInactiveItemMinWidth * var1, this.mActiveItemMaxWidth);
         var2 -= var5;
         int var6 = Math.min(var2 / var1, this.mInactiveItemMaxWidth);
         var2 -= var1 * var6;

         for(var1 = 0; var1 < var3; var2 = var8) {
            var7 = this.mTempChildWidths;
         ...
         var5 = Math.min(var2 / var1, this.mActiveItemMaxWidth);
         var2 -= var5 * var3;

         for(var1 = 0; var1 < var3; var2 = var8) {
            this.mTempChildWidths[var1] = var5;
            var8 = var2;
            if (var2 > 0) {
               var7 = this.mTempChildWidths;
               var10002 = var7[var1]++;
      ...
      for(var2 = var1; var1 < var3; ++var1) {
         View var9 = this.getChildAt(var1);
         if (var9.getVisibility() != 8) {
            var9.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[var1], 1073741824), var4);
            var9.getLayoutParams().width = var9.getMeasuredWidth();
            var2 += var9.getMeasuredWidth();
         }
      }

      this.setMeasuredDimension(View.resolveSizeAndState(var2, MeasureSpec.makeMeasureSpec(var2, 1073741824), 0), View.resolveSizeAndState(this.mItemHeight, var4, 0));
   }
   ...
   void tryRestoreSelectedItemId(int var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         MenuItem var4 = this.mMenu.getItem(var3);
         if (var1 == var4.getItemId()) {
            this.mSelectedItemId = var1;
            this.mSelectedItemPosition = var3;
   ...
   public void updateMenuView() {
      int var1 = this.mMenu.size();
      if (var1 != this.mButtons.length) {
         this.buildMenuView();
      } else {
         int var2 = this.mSelectedItemId;
         ...
         if (var2 != this.mSelectedItemId) {
            TransitionManager.beginDelayedTransition(this, this.mSet);
         }

         for(var3 = 0; var3 < var1; ++var3) {
            this.mPresenter.setUpdateSuspended(true);
            this.mButtons[var3].initialize((MenuItemImpl)this.mMenu.getItem(var3), 0);
            this.mPresenter.setUpdateSuspended(false);
         }
