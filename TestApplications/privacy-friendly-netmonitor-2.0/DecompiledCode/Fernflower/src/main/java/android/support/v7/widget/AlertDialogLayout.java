...
public class AlertDialogLayout extends LinearLayoutCompat {
   ...
   private boolean tryOnMeasure(int var1, int var2) {
      ...
      for(var13 = 0; var15 < var3; var13 = var11) {
         var5 = this.getChildAt(var15);
         var11 = var13;
         if (var5.getVisibility() != 8) {
            var11 = Math.max(var13, var5.getMeasuredWidth());
         }
      ...
      for(var5 = 0; var5 < var10; var2 = var3) {
         ...
         if (var17 != null) {
            ...
            if (var17.getVisibility() != 8) {
               ...
               LinearLayoutCompat.LayoutParams var15 = (LinearLayoutCompat.LayoutParams)var17.getLayoutParams();
               int var16 = var15.gravity;
               var3 = var16;
               if (var16 < 0) {
                  var3 = var11 & 8388615;
               }
               ...
               var2 = var16 + var15.topMargin;
               this.setChildFrame(var17, var3, var2, var13, var14);
               var3 = var2 + var14 + var15.bottomMargin;
            }
         }
