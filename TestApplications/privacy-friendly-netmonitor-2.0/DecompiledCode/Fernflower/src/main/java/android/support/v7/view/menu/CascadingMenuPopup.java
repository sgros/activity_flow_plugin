...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
   ...
   private void showMenu(@NonNull MenuBuilder var1) {
      ...
      MenuAdapter var3 = new MenuAdapter(var1, var2, this.mOverflowOnly);
      ...
      if (var13 == null && this.mShowTitle && var1.getHeaderTitle() != null) {
         FrameLayout var14 = (FrameLayout)var2.inflate(R.layout.abc_popup_menu_header_item_layout, var16, false);
         TextView var12 = (TextView)var14.findViewById(16908310);
