...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
   ...
   private Intent createVoiceAppSearchIntent(Intent var1, SearchableInfo var2) {
      ...
      String var13;
      if (var10 != 0) {
         var13 = var9.getString(var2.getVoicePromptTextId());
      } else {
         var13 = null;
      }
      ...
      if (var2.getVoiceLanguageId() != 0) {
         var14 = var9.getString(var2.getVoiceLanguageId());
      } else {
         var14 = null;
      }
      ...
      var7.putExtra("android.speech.extra.PROMPT", var13);
      var7.putExtra("android.speech.extra.LANGUAGE", var14);
   ...
   private boolean hasVoiceSearch() {
      ...
      boolean var2 = false;
      if (var1 != null && this.mSearchable.getVoiceSearchEnabled()) {
         Intent var3 = null;
   ...
   void adjustDropDownSizeAndPosition() {
      if (this.mDropDownAnchor.getWidth() > 1) {
         ...
         var6 = this.mDropDownAnchor.getWidth();
         int var7 = var3.left;
         int var8 = var3.right;
         this.mSearchSrcTextView.setDropDownWidth(var6 + var7 + var8 + var5 - var2);
      }
         ...
         if (var3 != Integer.MIN_VALUE) {
            if (var3 != 0) {
               if (var3 != 1073741824) {
                  ...
                  var1 = var4;
                  if (this.mMaxWidth > 0) {
                     var1 = Math.min(this.mMaxWidth, var4);
                  }
               }
   ...
   private static class UpdatableTouchDelegate extends TouchDelegate {
      ...
      public boolean onTouchEvent(MotionEvent var1) {
         ...
         switch(var4) {
         case 0:
            if (this.mTargetBounds.contains(var2, var3)) {
         ...
         if (var7) {
            if (var9 && !this.mActualBounds.contains(var2, var3)) {
