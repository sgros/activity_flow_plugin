...
public class Toolbar extends ViewGroup {
   ...
   public Toolbar(Context var1, @Nullable AttributeSet var2, int var3) {
      ...
      int var5 = var7.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
      var3 = var7.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
      var4 = var7.getDimensionPixelSize(R.styleable.Toolbar_contentInsetLeft, 0);
      int var6 = var7.getDimensionPixelSize(R.styleable.Toolbar_contentInsetRight, 0);
      this.ensureContentInsets();
      this.mContentInsets.setAbsolute(var4, var6);
      if (var5 != Integer.MIN_VALUE || var3 != Integer.MIN_VALUE) {
         this.mContentInsets.setRelative(var5, var3);
      }
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.shouldLayout(this.mExpandedActionView)) {
         if (var6) {
            var2 = this.layoutChildRight(this.mExpandedActionView, var4, var14, var5);
            var15 = var3;
         } else {
            var15 = this.layoutChildLeft(this.mExpandedActionView, var3, var14, var5);
            var2 = var4;
         }
      }
      ...
      if (this.shouldLayout(this.mLogoView)) {
         if (var6) {
            var3 = this.layoutChildRight(this.mLogoView, var2, var14, var5);
            var4 = var15;
         } else {
            var4 = this.layoutChildLeft(this.mLogoView, var15, var14, var5);
            var3 = var2;
         }
      }
      ...
      label199: {
         if (!var1 && !var16) {
            ...
            if (var13 != 48) {
               if (var13 != 80) {
                  ...
                  if (var13 < var17.topMargin + this.mTitleMarginTop) {
                     ...
                     var12 = var8 - var12 - var2 - var13 - var11;
                     var2 = var13;
                     if (var12 < var17.bottomMargin + this.mTitleMarginBottom) {
                        var2 = Math.max(0, var13 - (var23.bottomMargin + this.mTitleMarginBottom - var12));
                     }
                  }

                  var2 += var11;
               } else {
                  var2 = var8 - var12 - var23.bottomMargin - this.mTitleMarginBottom - var2;
               }
            } else {
            ...
            if (var16) {
               var17 = (Toolbar.LayoutParams)this.mSubtitleTextView.getLayoutParams();
               var13 = var19 + var17.topMargin;
               var11 = this.mSubtitleTextView.getMeasuredWidth();
               var19 = this.mSubtitleTextView.getMeasuredHeight();
               this.mSubtitleTextView.layout(var3 - var11, var13, var3, var19 + var13);
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      var6 = var8;
      if (this.shouldLayout(this.mLogoView)) {
         var14 = var15 + this.measureChildCollapseMargins(this.mLogoView, var1, var15, var2, 0, var3);
         var10 = Math.max(var7, this.mLogoView.getMeasuredHeight() + this.getVerticalMargins(this.mLogoView));
      ...
      for(var15 = var10; var8 < var11; var15 = var10) {
      ...
      if (this.shouldLayout(this.mTitleTextView)) {
         ...
         var8 = this.getHorizontalMargins(this.mTitleTextView);
      ...
      if (this.shouldLayout(this.mSubtitleTextView)) {
         var8 = Math.max(var8, this.measureChildCollapseMargins(this.mSubtitleTextView, var1, var7 + var9, var2, var10 + var14, var3));
      ...
      var8 = View.resolveSizeAndState(Math.max(var7 + var8 + var11 + var9, this.getSuggestedMinimumWidth()), var1, -16777216 & var6);
