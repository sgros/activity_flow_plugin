...
public abstract class AutoScrollHelper implements OnTouchListener {
   ...
   public AutoScrollHelper(View var1) {
      ...
      int var2 = (int)(1575.0F * var5.density + 0.5F);
      int var3 = (int)(315.0F * var5.density + 0.5F);
   ...
   private float computeTargetVelocity(int var1, float var2, float var3, float var4) {
      ...
      if (var3 == 0.0F) {
         ...
         float var6 = this.mMaximumVelocity[var1];
         var4 = var5 * var4;
         return var3 > 0.0F ? constrain(var3 * var4, var2, var6) : -constrain(-var3 * var4, var2, var6);
      }
   }
