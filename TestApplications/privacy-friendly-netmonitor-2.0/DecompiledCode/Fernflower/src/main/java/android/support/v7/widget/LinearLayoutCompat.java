...
public class LinearLayoutCompat extends ViewGroup {
   ...
   void measureHorizontal(int var1, int var2) {
      ...
      for(var21 = Integer.MIN_VALUE; var12 < var3; var10 = var23) {
         label322: {
            var22 = this.getVirtualChildAt(var12);
            if (var22 == null) {
      ...
      if (var9 && (var4 == Integer.MIN_VALUE || var4 == 0)) {
         ...
         for(var12 = 0; var12 < var3; ++var12) {
            ...
            if (var22 == null) {
               ...
               var24 = (LinearLayoutCompat.LayoutParams)var22.getLayoutParams();
               if (var11) {
                  this.mTotalLength += var24.leftMargin + var21 + var24.rightMargin + this.getNextLocationOffset(var22);
               } else {
                  var10 = this.mTotalLength;
                  this.mTotalLength = Math.max(var10, var10 + var21 + var24.leftMargin + var24.rightMargin + this.getNextLocationOffset(var22));
               }
            }
         }
      }
      ...
      if (var14 != 0 || var23 != 0 && var20 > 0.0F) {
         ...
         for(var16 = var23; var14 < var4; ++var14) {
            View var38 = this.getVirtualChildAt(var14);
            if (var38 != null && var38.getVisibility() != 8) {
               LinearLayoutCompat.LayoutParams var37 = (LinearLayoutCompat.LayoutParams)var38.getLayoutParams();
      ...
      this.setMeasuredDimension(var28 | -16777216 & var17, View.resolveSizeAndState(Math.max(var21 + this.getPaddingTop() + this.getPaddingBottom(), this.getSuggestedMinimumHeight()), var2, var17 << 16));
      if (var18 != 0) {
         this.forceUniformHeight(var16, var1);
      }
   ...
   void measureVertical(int var1, int var2) {
         ...
         label243: {
            ...
            if (var18 == null) {
               ...
               if (var18.getVisibility() != 8) {
                  ...
                  var26 = View.combineMeasuredStates(var3, var18.getMeasuredState());
                  boolean var29;
                  ...
                  if (var21.weight > 0.0F) {
                     ...
                     var3 = Math.max(var14, var20);
                     var31 = var10;
                  }

                  var14 = this.getChildrenSkipCount(var18, var11);
                  var33 = var29;
                  var9 = var25;
                  var11 = var17;
                  var20 = var14 + var24;
      ...
      if (var8 && (var6 == Integer.MIN_VALUE || var6 == 0)) {
         ...
         for(var14 = 0; var14 < var4; ++var14) {
            ...
            if (var34 == null) {
               ...
               var14 += this.getChildrenSkipCount(var34, var14);
            } else {
               LinearLayoutCompat.LayoutParams var32 = (LinearLayoutCompat.LayoutParams)var34.getLayoutParams();
               var19 = this.mTotalLength;
               this.mTotalLength = Math.max(var19, var19 + var17 + var32.topMargin + var32.bottomMargin + this.getNextLocationOffset(var34));
            }
         }
      }
      ...
      var6 = (16777215 & var20) - this.mTotalLength;
      if (var12 == 0 && (var6 == 0 || var15 <= 0.0F)) {
         var14 = Math.max(var14, var10);
         if (var8 && var19 != 1073741824) {
         ...
         for(var17 = var11; var14 < var4; ++var14) {
            var18 = this.getVirtualChildAt(var14);
            if (var18.getVisibility() != 8) {
               var21 = (LinearLayoutCompat.LayoutParams)var18.getLayoutParams();
               float var27 = var21.weight;
               if (var27 > 0.0F) {
                  var10 = (int)((float)var3 * var27 / var15);
                  var12 = this.getPaddingLeft();
                  var24 = this.getPaddingRight();
                  var11 = var3 - var10;
                  var26 = var21.leftMargin;
                  var3 = var21.rightMargin;
                  var25 = var21.width;
                  var15 -= var27;
                  var12 = getChildMeasureSpec(var1, var12 + var24 + var26 + var3, var25);
                  if (var21.height == 0 && var19 == 1073741824) {
                     if (var10 > 0) {
                        var3 = var10;
                     } else {
                        var3 = 0;
                     ...
                     var18.measure(var12, MeasureSpec.makeMeasureSpec(var3, 1073741824));
                  } else {
                     var10 += var18.getMeasuredHeight();
                     var3 = var10;
                     if (var10 < 0) {
                        var3 = 0;
                     }
                  ...
                  var9 = View.combineMeasuredStates(var9, var18.getMeasuredState() & -256);
                  var3 = var11;
               }

               var12 = var21.leftMargin + var21.rightMargin;
               var11 = var18.getMeasuredWidth() + var12;
               ...
               this.mTotalLength = Math.max(var31, var31 + var18.getMeasuredHeight() + var21.topMargin + var21.bottomMargin + this.getNextLocationOffset(var18));
               var16 = var28;
               var6 = var10;
            }
         }
