...
public class ConstraintSet {
   ...
   private void createHorizontalChain(int var1, int var2, int var3, int var4, int[] var5, float[] var6, int var7, int var8, int var9) {
      ...
      } else if (var6 != null && var6.length != var5.length) {
         throw new IllegalArgumentException("must have 2 or more widgets in a chain");
      } else {
         if (var6 != null) {
   ...
   void applyToInternal(ConstraintLayout var1) {
      ...
      for(int var4 = 0; var4 < var2; ++var4) {
         ...
         if (this.mConstraints.containsKey(var6)) {
            ...
            ConstraintLayout.LayoutParams var8 = (ConstraintLayout.LayoutParams)var5.getLayoutParams();
            var7.applyTo(var8);
      ...
      while(var9.hasNext()) {
         Integer var11 = (Integer)var9.next();
         ConstraintSet.Constraint var13 = (ConstraintSet.Constraint)this.mConstraints.get(var11);
         if (var13.mIsGuideline) {
            Guideline var10 = new Guideline(var1.getContext());
            var10.setId(var11);
            ConstraintLayout.LayoutParams var12 = var1.generateDefaultLayoutParams();
            var13.applyTo(var12);
            var1.addView(var10, var12);
         }
      }
   ...
   public void clone(ConstraintLayout var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         var7.visibility = var4.getVisibility();
         if (VERSION.SDK_INT >= 17) {
            var7.alpha = var4.getAlpha();
            var7.rotationX = var4.getRotationX();
            var7.rotationY = var4.getRotationY();
            var7.scaleX = var4.getScaleX();
            var7.scaleY = var4.getScaleY();
            var7.transformPivotX = var4.getPivotX();
            var7.transformPivotY = var4.getPivotY();
            var7.translationX = var4.getTranslationX();
            var7.translationY = var4.getTranslationY();
            if (VERSION.SDK_INT >= 21) {
               var7.translationZ = var4.getTranslationZ();
               if (var7.applyElevation) {
                  var7.elevation = var4.getElevation();
               }
            }
         }
      }
   ...
   public void removeFromHorizontalChain(int var1) {
      if (this.mConstraints.containsKey(var1)) {
         ...
         int var3 = var2.leftToRight;
         int var4 = var2.rightToLeft;
         if (var3 == -1 && var4 == -1) {
            int var5 = var2.startToEnd;
            var4 = var2.endToStart;
            if (var5 != -1 || var4 != -1) {
               if (var5 != -1 && var4 != -1) {
                  ...
                  if (var2.rightToRight != -1) {
                     this.connect(var3, 7, var2.rightToRight, 7, 0);
                  } else if (var2.leftToLeft != -1) {
                     this.connect(var4, 6, var2.leftToLeft, 6, 0);
                  }
               }
            }
            ...
            if (var3 != -1 && var4 != -1) {
               ...
               if (var2.rightToRight != -1) {
                  this.connect(var3, 2, var2.rightToRight, 2, 0);
               } else if (var2.leftToLeft != -1) {
                  this.connect(var4, 1, var2.leftToLeft, 1, 0);
               }
            }
   ...
   public void removeFromVerticalChain(int var1) {
      if (this.mConstraints.containsKey(var1)) {
         ConstraintSet.Constraint var2 = (ConstraintSet.Constraint)this.mConstraints.get(var1);
         int var3 = var2.topToBottom;
         int var4 = var2.bottomToTop;
         if (var3 != -1 || var4 != -1) {
            if (var3 != -1 && var4 != -1) {
               ...
               if (var2.bottomToBottom != -1) {
                  this.connect(var3, 4, var2.bottomToBottom, 4, 0);
               } else if (var2.topToTop != -1) {
                  this.connect(var4, 3, var2.topToTop, 3, 0);
               }
            }
         }
      }
