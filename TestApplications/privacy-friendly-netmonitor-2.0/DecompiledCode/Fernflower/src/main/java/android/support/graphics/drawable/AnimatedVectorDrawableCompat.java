      ...
      if (VERSION.SDK_INT >= 24) {
         ...
         label67: {
            ...
            label53: {
               ...
               boolean var10001;
               try {
                  var3 = var2.getXml(var1);
                  var15 = Xml.asAttributeSet(var3);
               ...
               while(true) {
                  ...
                  if (var1 == 2 || var1 == 1) {
                     if (var1 != 2) {
                        ...
                        try {
                           AnimatedVectorDrawableCompat var14 = createFromXmlInner(var0, var0.getResources(), var3, var15, var0.getTheme());
                           return var14;
         ...
         for(int var6 = var2.getDepth(); var5 != 1 && (var2.getDepth() >= var6 + 1 || var5 != 3); var5 = var2.next()) {
            if (var5 == 2) {
               ...
               if ("animated-vector".equals(var7)) {
                  ...
                  TypedArray var10 = var1.obtainAttributes(var3, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET);
                  ...
                  if (var5 != 0) {
                     ...
                     this.setupAnimatorsForTarget(var11, AnimatorInflaterCompat.loadAnimator(this.mContext, var5));
                  }
