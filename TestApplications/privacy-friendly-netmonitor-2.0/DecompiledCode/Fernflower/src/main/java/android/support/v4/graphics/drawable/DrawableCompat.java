...
public final class DrawableCompat {
   ...
   static class DrawableCompatApi17Impl extends DrawableCompat.DrawableCompatBaseImpl {
      ...
      public int getLayoutDirection(Drawable var1) {
         ...
         if (sGetLayoutDirectionMethod != null) {
            try {
               int var3 = (Integer)sGetLayoutDirectionMethod.invoke(var1);
               return var3;
      ...
      public boolean setLayoutDirection(Drawable var1, int var2) {
         ...
         if (sSetLayoutDirectionMethod != null) {
            try {
               sSetLayoutDirectionMethod.invoke(var1, var2);
               return true;
            } catch (Exception var5) {
   ...
   static class DrawableCompatApi21Impl extends DrawableCompat.DrawableCompatApi19Impl {
      ...
      public void clearColorFilter(Drawable var1) {
         ...
         } else if (var1 instanceof DrawableContainer) {
            DrawableContainerState var2 = (DrawableContainerState)((DrawableContainer)var1).getConstantState();
            if (var2 != null) {
               int var3 = 0;

               for(int var4 = var2.getChildCount(); var3 < var4; ++var3) {
                  var1 = var2.getChild(var3);
                  if (var1 != null) {
                     this.clearColorFilter(var1);
                  }
               }
            }
         }
