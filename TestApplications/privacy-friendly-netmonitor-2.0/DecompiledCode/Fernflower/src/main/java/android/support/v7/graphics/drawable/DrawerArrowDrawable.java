...
public class DrawerArrowDrawable extends Drawable {
   ...
   public void draw(Canvas var1) {
      ...
      var12 = (float)Math.round(var13 * Math.cos(var15));
      var11 = (float)Math.round(var13 * Math.sin(var15));
      this.mPath.rewind();
      var8 = lerp(this.mBarGap + this.mPaint.getStrokeWidth(), -this.mMaxCutForBarSize, this.mProgress);
      float var17 = -var9 / 2.0F;
      this.mPath.moveTo(var17 + var10, 0.0F);
      this.mPath.rLineTo(var9 - var10 * 2.0F, 0.0F);
      this.mPath.moveTo(var17, var8);
      this.mPath.rLineTo(var12, var11);
      this.mPath.moveTo(var17, -var8);
      this.mPath.rLineTo(var12, -var11);
      this.mPath.close();
      var1.save();
      var12 = this.mPaint.getStrokeWidth();
      var9 = (float)((int)((float)var2.height() - 3.0F * var12 - this.mBarGap * 2.0F) / 4 * 2);
      var10 = this.mBarGap;
      var1.translate((float)var2.centerX(), var9 + var12 * 1.5F + var10);
      if (this.mSpin) {
