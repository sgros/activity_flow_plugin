...
public class SwitchCompat extends CompoundButton {
   ...
   private boolean hitThumb(float var1, float var2) {
      ...
      if (var3 == null) {
         ...
         if (var1 > (float)var8) {
            var14 = var4;
            if (var1 < (float)(var5 + var8 + var9 + var10 + var11)) {
               var14 = var4;
   ...
   public void draw(Canvas var1) {
      ...
      if (this.mTrackDrawable != null) {
         ...
         label38: {
            ...
            if (var8 != null) {
               ...
               if (var8.left > var2.left) {
                  var9 = var3 + (var8.left - var2.left);
               }

               if (var8.top > var2.top) {
                  var7 = var8.top - var2.top + var4;
               } else {
                  var7 = var4;
               }
               ...
               if (var8.bottom > var2.bottom) {
                  var3 = var6 - (var8.bottom - var2.bottom);
                  var5 = var11;
                  var11 = var3;
                  break label38;
               }
         ...
         this.mTrackDrawable.setBounds(var9, var7, var5, var11);
         var9 = var10;
      }
   ...
   protected void onDraw(Canvas var1) {
      ...
      if (var15 != null) {
         ...
         var10 /= 2;
         int var12 = var15.getWidth() / 2;
         var4 = (var4 + var6 + (var5 - var7)) / 2;
         var6 = var15.getHeight() / 2;
         var1.translate((float)(var10 - var12), (float)(var4 - var6));
         var15.draw(var1);
      }
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (var6 != null) {
         ...
         if (this.mTrackDrawable != null) {
            this.mTrackDrawable.getPadding(var8);
         } else {
            var8.setEmpty();
         }
      ...
      if (ViewUtils.isLayoutRtl(this)) {
         ...
         var5 = this.mSwitchWidth + var4 - var3 - var2;
      } else {
         var5 = this.getWidth() - this.getPaddingRight() - var2;
         var4 = var5 - this.mSwitchWidth + var3 + var2;
      }
   ...
   public void setSwitchTextAppearance(Context var1, int var2) {
      ...
      ColorStateList var5 = var3.getColorStateList(R.styleable.TextAppearance_android_textColor);
      if (var5 != null) {
