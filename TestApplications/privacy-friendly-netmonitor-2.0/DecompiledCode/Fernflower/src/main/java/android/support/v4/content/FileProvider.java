...
public class FileProvider extends ContentProvider {
   ...
   private static File buildPath(File var0, String... var1) {
      ...
      File var5;
      for(int var3 = var1.length; var2 < var3; var0 = var5) {
      ...
      if (var3 == null) {
         ...
         while(true) {
            ...
            if (var4 == 2) {
               ...
               Object var6 = null;
               String var7 = var3.getAttributeValue((String)null, "name");
               String var8 = var3.getAttributeValue((String)null, "path");
               File var9;
               ...
               } else if ("external-path".equals(var5)) {
                  var9 = Environment.getExternalStorageDirectory();
               } else {
                  File[] var10;
                  if ("external-files-path".equals(var5)) {
                     ...
                     var9 = (File)var6;
                     if ("external-cache-path".equals(var5)) {
               ...
               if (var9 != null) {
                  var2.addRoot(var7, buildPath(var9, var8));
               }
            }
         }
      }
   ...
   public Cursor query(Uri var1, String[] var2, String var3, String[] var4, String var5) {
      ...
      int var8;
      int var9;
      for(var8 = 0; var6 < var7; var8 = var9) {
         label22: {
            var5 = var10[var6];
            ...
            do {
               do {
                  if (!var3.hasNext()) {
                     ...
                     var10.append(Uri.encode((String)var7.getKey()));
                     var10.append('/');
                     var10.append(Uri.encode(var12, "/"));
