...
public class VectorDrawableCompat extends VectorDrawableCommon {
   ...
   public static VectorDrawableCompat create(@NonNull Resources var0, @DrawableRes int var1, @Nullable Theme var2) {
      if (VERSION.SDK_INT >= 24) {
         VectorDrawableCompat var16 = new VectorDrawableCompat();
         var16.mDelegateDrawable = ResourcesCompat.getDrawable(var0, var1, var2);
         var16.mCachedConstantStateDelegate = new VectorDrawableCompat.VectorDrawableDelegateState(var16.mDelegateDrawable.getConstantState());
         return var16;
      } else {
               ...
               while(true) {
                  ...
                  if (var1 == 2 || var1 == 1) {
                     if (var1 != 2) {
                        ...
                        try {
                           VectorDrawableCompat var15 = createFromXmlInner(var0, var3, var4, var2);
                           return var15;
      ...
      for(var10 = true; var8 != 1 && (var2.getDepth() >= var9 + 1 || var8 != 3); var10 = var13) {
         if (var8 == 2) {
            ...
            if ("path".equals(var11)) {
               ...
               var13 = false;
               int var16 = var5.mChangingConfigurations;
               var5.mChangingConfigurations = var17.mChangingConfigurations | var16;
            } else {
               int var20;
               if ("clip-path".equals(var11)) {
                  VectorDrawableCompat.VClipPath var18 = new VectorDrawableCompat.VClipPath();
                  var18.inflate(var1, var3, var4, var2);
                  var12.mChildren.add(var18);
                  if (var18.getPathName() != null) {
                     var6.mVGTargetsMap.put(var18.getPathName(), var18);
                  }

                  var20 = var5.mChangingConfigurations;
                  var5.mChangingConfigurations = var18.mChangingConfigurations | var20;
                  var13 = var10;
               } else {
                  var13 = var10;
                  if ("group".equals(var11)) {
                     VectorDrawableCompat.VGroup var19 = new VectorDrawableCompat.VGroup();
                     var19.inflate(var1, var3, var4, var2);
                     var12.mChildren.add(var19);
                     var7.push(var19);
                     if (var19.getGroupName() != null) {
                        var6.mVGTargetsMap.put(var19.getGroupName(), var19);
                     }

                     var20 = var5.mChangingConfigurations;
                     var5.mChangingConfigurations = var19.mChangingConfigurations | var20;
                     var13 = var10;
                  }
               }
            }
   ...
   private void printGroupTree(VectorDrawableCompat.VGroup var1, int var2) {
      ...
      for(var5 = var3; var5 < var1.mChildren.size(); ++var5) {
         Object var7 = var1.mChildren.get(var5);
      ...
      if (this.mDelegateDrawable != null) {
         ...
         if (this.mTmpBounds.width() > 0 && this.mTmpBounds.height() > 0) {
            ...
            if (var7 > 0 && var9 > 0) {
               ...
               this.mVectorState.createCachedBitmapIfNeeded(var7, var9);
               if (!this.mAllowCaching) {
                  this.mVectorState.updateCachedBitmap(var7, var9);
   ...
   private static class VPathRenderer {
      ...
      private void drawPath(VectorDrawableCompat.VGroup var1, VectorDrawableCompat.VPath var2, Canvas var3, int var4, int var5, ColorFilter var6) {
         ...
         var7 = this.getMatrixScale(var16);
         if (var7 != 0.0F) {
            ...
            if (var2.isClipPath()) {
               ...
               if (var19.mTrimPathStart != 0.0F || var19.mTrimPathEnd != 1.0F) {
                  ...
                  var12 = (var12 + var13) % 1.0F * var8;
                  var17.reset();
                  if (var10 > var12) {
                     this.mPathMeasure.getSegment(var10, var8, var17, true);
                     this.mPathMeasure.getSegment(0.0F, var12, var17, true);
                  } else {
                     this.mPathMeasure.getSegment(var10, var12, var17, true);
                  }
               ...
               if (var19.mStrokeColor != 0) {
                  ...
                  var20.setStrokeWidth(var19.mStrokeWidth * var9 * var7);
