...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
   ...
   public int[] onCreateDrawableState(int var1) {
      return this.mChecked ? mergeDrawableStates(super.onCreateDrawableState(var1 + DRAWABLE_STATE_CHECKED.length), DRAWABLE_STATE_CHECKED) : super.onCreateDrawableState(var1);
   }
