...
public class ConstraintAnchor {
   ...
   private boolean isConnectionToMe(ConstraintWidget var1, HashSet var2) {
      if (var2.contains(var1)) {
         ...
         if (var1 == this.getOwner()) {
            ...
            ArrayList var3 = var1.getAnchors();
            int var4 = var3.size();

            for(int var5 = 0; var5 < var4; ++var5) {
               ConstraintAnchor var6 = (ConstraintAnchor)var3.get(var5);
               if (var6.isSimilarDimensionConnection(this) && var6.isConnected() && this.isConnectionToMe(var6.getTarget().getOwner(), var2)) {
                  return true;
               }
            }
   ...
   public boolean isSimilarDimensionConnection(ConstraintAnchor var1) {
      ConstraintAnchor.Type var2 = var1.getType();
      ...
      if (var2 == var6) {
         ...
         switch(this.mType) {
         case CENTER:
            if (var2 == ConstraintAnchor.Type.BASELINE) {
               var4 = false;
            }
         ...
         case CENTER_X:
            var4 = var3;
            if (var2 != ConstraintAnchor.Type.LEFT) {
               var4 = var3;
               if (var2 != ConstraintAnchor.Type.RIGHT) {
                  if (var2 == ConstraintAnchor.Type.CENTER_X) {
                     var4 = var3;
                  } else {
                     var4 = false;
                  }
         ...
         case BASELINE:
            var4 = var5;
            if (var2 != ConstraintAnchor.Type.TOP) {
               var4 = var5;
               if (var2 != ConstraintAnchor.Type.BOTTOM) {
                  var4 = var5;
                  if (var2 != ConstraintAnchor.Type.CENTER_Y) {
                     if (var2 == ConstraintAnchor.Type.BASELINE) {
                        var4 = var5;
                     } else {
                        var4 = false;
      ...
      if (var1 == null) {
         ...
         if (var3 == this.mType) {
            ...
            case BOTTOM:
               ...
               var4 = var2;
               if (var1.getOwner() instanceof Guideline) {
                  if (!var2 && var3 != ConstraintAnchor.Type.CENTER_Y) {
                     var4 = false;
                  } else {
                     var4 = true;
                  }
