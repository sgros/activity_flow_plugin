...
public class CircularProgressDrawable extends Drawable implements Animatable {
   ...
   private void applyTransformation(float var1, CircularProgressDrawable.Ring var2, boolean var3) {
      if (this.mFinishing) {
         ...
         if (var1 < 0.5F) {
            ...
            var7 = MATERIAL_INTERPOLATOR.getInterpolation(var5);
            var5 = var6;
            var6 += 0.79F * var7 + 0.01F;
         } else {
            var5 = (var1 - 0.5F) / 0.5F;
            var6 = var2.getStartingStartTrim() + 0.79F;
            var5 = var6 - (0.79F * (1.0F - MATERIAL_INTERPOLATOR.getInterpolation(var5)) + 0.01F);
         }

         var7 = this.mRotationCount;
         var2.setStartTrim(var5);
         var2.setEndTrim(var6);
         var2.setRotation(var4 + 0.20999998F * var1);
         this.setRotation(216.0F * (var1 + var7));
      }
   ...
   private static class Ring {
      ...
      void draw(Canvas var1, Rect var2) {
         ...
         float var4 = this.mRingCenterRadius + this.mStrokeWidth / 2.0F;
         if (this.mRingCenterRadius <= 0.0F) {
            var4 = (float)Math.min(var2.width(), var2.height()) / 2.0F - Math.max((float)this.mArrowWidth * this.mArrowScale / 2.0F, this.mStrokeWidth / 2.0F);
         }

         var3.set((float)var2.centerX() - var4, (float)var2.centerY() - var4, (float)var2.centerX() + var4, (float)var2.centerY() + var4);
         float var5 = (this.mStartTrim + this.mRotation) * 360.0F;
         var4 = (this.mEndTrim + this.mRotation) * 360.0F - var5;
      ...
      void drawTriangle(Canvas var1, float var2, float var3, RectF var4) {
         if (this.mShowArrow) {
            ...
            this.mArrow.offset(var5 + var4.centerX() - var6, var4.centerY() + this.mStrokeWidth / 2.0F);
            this.mArrow.close();
