      ...
      protected void onMeasure(int var1, int var2) {
         ...
         if (MeasureSpec.getMode(var1) == 1073741824) {
            ...
            if (var3 == 1 && TabLayout.this.mTabGravity == 1) {
               ...
               int var8;
               for(var8 = var7; var7 < var5; var8 = var3) {
                  View var9 = this.getChildAt(var7);
                  var3 = var8;
                  if (var9.getVisibility() == 0) {
                     var3 = Math.max(var8, var9.getMeasuredWidth());
                  }
               ...
               boolean var10;
               if (var8 * var5 > this.getMeasuredWidth() - var3 * 2) {
                  ...
                  for(var7 = var6; var7 < var5; ++var7) {
                     android.widget.LinearLayout.LayoutParams var11 = (android.widget.LinearLayout.LayoutParams)this.getChildAt(var7).getLayoutParams();
                     if (var11.width != var8 || var11.weight != 0.0F) {
                        var11.width = var8;
                        var11.weight = 0.0F;
                        var10 = true;
                     }
   ...
   class TabView extends LinearLayout {
      ...
      public void onMeasure(int var1, int var2) {
         ...
         if (this.mTextView != null) {
            ...
            var5 = this.mTextView.getLineCount();
            var4 = TextViewCompat.getMaxLines(this.mTextView);
            if (var9 != var7 || var4 >= 0 && var1 != var4) {
               boolean var11 = var10;
