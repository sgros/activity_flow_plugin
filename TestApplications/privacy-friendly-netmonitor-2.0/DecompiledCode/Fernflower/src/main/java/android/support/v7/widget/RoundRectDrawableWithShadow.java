...
class RoundRectDrawableWithShadow extends Drawable {
   ...
   private void buildShadowCorners() {
      ...
      var10.setShader(new RadialGradient(0.0F, 0.0F, var4 + var5, new int[]{var6, var7, var8}, new float[]{0.0F, var3, 1.0F}, var12));
      Paint var13 = this.mEdgeShadowPaint;
      ...
      var13.setShader(new LinearGradient(0.0F, var9 + var5, 0.0F, var4 - var3, new int[]{var6, var8, var7}, new float[]{0.0F, 0.5F, 1.0F}, var11));
      this.mEdgeShadowPaint.setAntiAlias(false);
   }
