...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
   ...
   private boolean tryShow() {
      if (this.isShowing()) {
         ...
         View var1 = this.mShownAnchorView;
         boolean var2;
         ...
         if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout var5 = (FrameLayout)LayoutInflater.from(this.mContext).inflate(R.layout.abc_popup_menu_header_item_layout, var3, false);
            ...
            var3.addHeaderView(var5, (Object)null, false);
         }
