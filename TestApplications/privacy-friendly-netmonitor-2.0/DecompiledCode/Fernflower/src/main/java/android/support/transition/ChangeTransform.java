...
public class ChangeTransform extends Transition {
   ...
   private void captureValues(TransitionValues var1) {
      ...
      if (var2.getVisibility() != 8) {
         ...
         if (this.mReparent) {
            ...
            ViewGroup var6 = (ViewGroup)var2.getParent();
   ...
   private static class Transforms {
      ...
      public int hashCode() {
         ...
         int var3;
         if (var1 != 0.0F) {
            var3 = Float.floatToIntBits(this.mTranslationX);
         } else {
            var3 = 0;
         }
         ...
         if (this.mTranslationY != 0.0F) {
            var4 = Float.floatToIntBits(this.mTranslationY);
         } else {
            var4 = 0;
         }
         ...
         if (this.mTranslationZ != 0.0F) {
            var5 = Float.floatToIntBits(this.mTranslationZ);
         } else {
            var5 = 0;
         }
         ...
         if (this.mScaleX != 0.0F) {
            var6 = Float.floatToIntBits(this.mScaleX);
         } else {
            var6 = 0;
         }
         ...
         if (this.mScaleY != 0.0F) {
            var7 = Float.floatToIntBits(this.mScaleY);
         } else {
            var7 = 0;
         }
         ...
         if (this.mRotationX != 0.0F) {
            var8 = Float.floatToIntBits(this.mRotationX);
         } else {
            var8 = 0;
         }
         ...
         if (this.mRotationY != 0.0F) {
            var9 = Float.floatToIntBits(this.mRotationY);
         } else {
            var9 = 0;
         }

         if (this.mRotationZ != 0.0F) {
            var2 = Float.floatToIntBits(this.mRotationZ);
         }

         return 31 * ((((((var3 * 31 + var4) * 31 + var5) * 31 + var6) * 31 + var7) * 31 + var8) * 31 + var9) + var2;
      }
