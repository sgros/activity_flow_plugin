...
public class MenuBuilder implements SupportMenu {
   ...
   private void dispatchRestoreInstanceState(Bundle var1) {
      ...
      if (var6 != null && !this.mPresenters.isEmpty()) {
         Iterator var2 = this.mPresenters.iterator();
         ...
         while(var2.hasNext()) {
            ...
            if (var4 == null) {
               ...
               int var5 = var4.getId();
               if (var5 > 0) {
                  Parcelable var7 = (Parcelable)var6.get(var5);
                  if (var7 != null) {
                     var4.onRestoreInstanceState(var7);
                  }
               }
            }
         }
   ...
   public void flagActionItems() {
      ...
      if (this.mIsActionItemsStale) {
         ...
         if (var3) {
            ...
            for(int var8 = 0; var8 < var6; ++var8) {
               MenuItemImpl var7 = (MenuItemImpl)var1.get(var8);
