...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
      ...
      if (!var2 && !this.mIgnoreMotionEventTillDown) {
         if (this.dispatchOnItemTouch(var1)) {
            ...
            case 2:
               ...
               if (this.mScrollState != 1) {
                  boolean var20;
                  if (var2 && Math.abs(var6) > this.mTouchSlop) {
                     if (var6 > 0) {
               ...
               if (this.mScrollState == 1) {
                  ...
                  if (this.mGapWorker != null) {
                     ...
                     this.mGapWorker.postFromTraversal(this, var11, var12);
                     var19 = var3;
                  }
               }
               break;
   ...
   public abstract static class LayoutManager {
      ...
      private int[] getChildRectangleOnScreenScrollAmount(RecyclerView var1, View var2, Rect var3, boolean var4) {
         ...
         var8 = var13 + var11 - (var7 - var8);
         var7 = Math.max(0, var8);
      ...
      RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int var1, boolean var2, long var3) {
         ...
         if (var1 >= 0 && var1 < RecyclerView.this.mState.getItemCount()) {
            ...
            label137: {
               ...
               boolean var12 = var10;
               if (var18 == null) {
                  int var23 = RecyclerView.this.mAdapterHelper.findPositionOffset(var1);
                  if (var23 < 0 || var23 >= RecyclerView.this.mAdapter.getItemCount()) {
                  ...
                  int var13 = RecyclerView.this.mAdapter.getItemViewType(var23);
                  var8 = var18;
                  var9 = var10;
                  if (RecyclerView.this.mAdapter.hasStableIds()) {
                     var18 = this.getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(var23), var13, var2);
                     var8 = var18;
                     var9 = var10;
                     if (var18 != null) {
                        var18.mPosition = var23;
                        var9 = true;
                        var8 = var18;
                     }
                  }
                  ...
                  if (var8 == null) {
                     ...
                     if (this.mViewCacheExtension != null) {
                        ...
                        var18 = var8;
                        if (var19 != null) {
                           var8 = RecyclerView.this.getChildViewHolder(var19);
                           if (var8 == null) {
                              var7 = new StringBuilder();
                  ...
                  if (var8 == null) {
                     ...
                     var8 = RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, var13);
                     if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
            ...
            android.view.ViewGroup.LayoutParams var24 = var8.itemView.getLayoutParams();
