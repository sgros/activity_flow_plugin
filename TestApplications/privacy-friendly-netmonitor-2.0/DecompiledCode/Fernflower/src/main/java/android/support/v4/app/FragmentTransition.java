...
class FragmentTransition {
   ...
   private static void callSharedElementStartEnd(Fragment var0, Fragment var1, boolean var2, ArrayMap var3, boolean var4) {
      ...
      if (var8 != null) {
         ...
         while(var6 < var7) {
            var9.add(var3.keyAt(var6));
            var5.add(var3.valueAt(var6));
            ++var6;
         }
   ...
   private static void configureTransitionsOrdered(FragmentManagerImpl var0, int var1, FragmentTransition.FragmentContainerTransition var2, View var3, ArrayMap var4) {
      ...
      if (var14 != null) {
         ...
         if (var9 != null || var13 != null || var10 != null) {
            ArrayList var17 = configureEnteringExitingViews(var10, var6, var11, var3);
            if (var17 == null || var17.isEmpty()) {
               var10 = null;
            }

            FragmentTransitionCompat21.addTarget(var9, var3);
            Object var15 = mergeTransitions(var9, var10, var13, var5, var2.lastInIsPop);
            if (var15 != null) {
               ArrayList var16 = new ArrayList();
               FragmentTransitionCompat21.scheduleRemoveTargets(var15, var9, var16, var10, var17, var13, var12);
               scheduleTargetChange(var14, var5, var3, var12, var9, var16, var10, var17);
               FragmentTransitionCompat21.setNameOverridesOrdered(var14, var12, var4);
               FragmentTransitionCompat21.beginDelayedTransition(var14, var15);
         ...
         if (VERSION.SDK_INT >= 21) {
            ...
            if (var6.size() != 0) {
               ...
               for(var7 = 0; var7 < var10; ++var7) {
                  ...
                  if (var5) {
                     configureTransitionsReordered(var0, var11, var12, var9, var13);
                  } else {
                     configureTransitionsOrdered(var0, var11, var12, var9, var13);
                  }
               }
            }
         }
