...
public class ViewDragHelper {
   ...
   public void processTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         this.tryCaptureViewForDrag(var11, var5);
      ...
      case 2:
         if (this.mDragState == 1) {
            if (this.isValidPointerForActionMove(this.mActivePointerId)) {
               ...
               var6 = var1.getX(var5);
               var7 = var1.getY(var5);
               var12 = (int)(var6 - this.mLastMotionX[this.mActivePointerId]);
               var5 = (int)(var7 - this.mLastMotionY[this.mActivePointerId]);
               this.dragTo(this.mCapturedView.getLeft() + var12, this.mCapturedView.getTop() + var5, var12, var5);
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         if ((this.mTrackingEdges & var2) != 0) {
            this.mCallback.onEdgeTouched(var2 & this.mTrackingEdges, var3);
         }
         break;
      case 1:
      case 3:
      ...
      case 2:
         if (this.mInitialMotionX != null && this.mInitialMotionY != null) {
            ...
            for(var3 = 0; var3 < var6; ++var3) {
               int var7 = var1.getPointerId(var3);
               if (this.isValidPointerForActionMove(var7)) {
                  var5 = var1.getX(var3);
                  float var8 = var1.getY(var3);
                  var4 = var5 - this.mInitialMotionX[var7];
                  float var9 = var8 - this.mInitialMotionY[var7];
