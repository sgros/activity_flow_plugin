   ...
   public boolean add(Object var1) {
      ...
      if (var2 >= 0) {
         ...
         if (var2 < this.mSize) {
            ...
            var6 = this.mHashes;
            var4 = var2 + 1;
            System.arraycopy(var8, var2, var6, var4, this.mSize - var2);
            System.arraycopy(this.mArray, var2, this.mArray, var4, this.mSize - var2);
         }
      ...
      if (this.mSize <= 1) {
         ...
         if (var3.length > 8 && this.mSize < this.mHashes.length / 3) {
            ...
            if (var1 < this.mSize) {
               ...
               System.arraycopy(var5, var4, this.mArray, var1, this.mSize - var1);
            }
         } else {
            --this.mSize;
            if (var1 < this.mSize) {
