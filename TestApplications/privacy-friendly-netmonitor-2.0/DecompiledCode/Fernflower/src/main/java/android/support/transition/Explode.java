...
public class Explode extends Visibility {
   ...
   private void calculateOut(View var1, Rect var2, int[] var3) {
      ...
      var12 = calculateDistance(var13, var14);
      var13 /= var12;
      var14 /= var12;
      var12 = calculateMaxDistance(var1, var7 - var4, var8 - var5);
      var3[0] = Math.round(var13 * var12);
      var3[1] = Math.round(var12 * var14);
   }
   ...
   public Animator onDisappear(ViewGroup var1, View var2, TransitionValues var3, TransitionValues var4) {
      if (var3 == null) {
         ...
         int[] var12 = (int[])var3.view.getTag(R.id.transition_position);
         float var10;
         float var11;
         if (var12 != null) {
            var10 = (float)(var12[0] - var5.left) + var8;
            var11 = (float)(var12[1] - var5.top) + var9;
            var5.offsetTo(var12[0], var12[1]);
         } else {
            var10 = var8;
            var11 = var9;
         }
         ...
         return TranslationAnimationCreator.createAnimation(var2, var3, var6, var7, var8, var9, var10 + (float)this.mTempLoc[0], var11 + (float)this.mTempLoc[1], sAccelerate);
      }
   }
}
