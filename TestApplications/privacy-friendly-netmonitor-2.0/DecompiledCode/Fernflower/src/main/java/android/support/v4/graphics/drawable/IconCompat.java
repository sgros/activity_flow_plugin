...
public class IconCompat {
   ...
   static Bitmap createLegacyIconFromAdaptiveIcon(Bitmap var0) {
      int var1 = (int)(0.6666667F * (float)Math.min(var0.getWidth(), var0.getHeight()));
      Bitmap var2 = Bitmap.createBitmap(var1, var1, Config.ARGB_8888);
      Canvas var3 = new Canvas(var2);
      Paint var4 = new Paint(3);
      float var5 = (float)var1;
      float var6 = 0.5F * var5;
      float var7 = 0.9166667F * var6;
      float var8 = 0.010416667F * var5;
      var4.setColor(0);
      var4.setShadowLayer(var8, 0.0F, 0.020833334F * var5, 1023410176);
      var3.drawCircle(var6, var6, var7, var4);
      var4.setShadowLayer(var8, 0.0F, 0.0F, 503316480);
      var3.drawCircle(var6, var6, var7, var4);
      var4.clearShadowLayer();
      var4.setColor(-16777216);
      BitmapShader var9 = new BitmapShader(var0, TileMode.CLAMP, TileMode.CLAMP);
      Matrix var10 = new Matrix();
      var10.setTranslate((float)(-(var0.getWidth() - var1) / 2), (float)(-(var0.getHeight() - var1) / 2));
