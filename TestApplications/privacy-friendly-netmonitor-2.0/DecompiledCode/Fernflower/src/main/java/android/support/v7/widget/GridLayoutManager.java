      ...
      if (var11 == 0) {
         ...
         for(var9 = 0; var9 < var11; ++var9) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(var14) != var10) {
               var21 = (GridLayoutManager.LayoutParams)var14.getLayoutParams();
               Rect var20 = var21.mDecorInsets;
               var7 = var20.top + var20.bottom + var21.topMargin + var21.bottomMargin;
               var22 = var20.left + var20.right + var21.leftMargin + var21.rightMargin;
               var13 = this.getSpaceForSpanRange(var21.mSpanIndex, var21.mSpanSize);
               if (this.mOrientation == 1) {
                  var22 = getChildMeasureSpec(var13, 1073741824, var22, var21.width, false);
                  var7 = MeasureSpec.makeMeasureSpec(var10 - var7, 1073741824);
               } else {
                  var22 = MeasureSpec.makeMeasureSpec(var10 - var22, 1073741824);
                  var7 = getChildMeasureSpec(var13, 1073741824, var7, var21.height, false);
               }

               this.measureChildWithDecorationsAndMargin(var14, var22, var7, true);
            }
         }
         ...
         while(var13 < var11) {
            label114: {
               ...
               if (this.mOrientation == 1) {
                  ...
                  var22 = this.getPaddingLeft() + this.mCachedBorders[var21.mSpanIndex];
                  var7 = this.mOrientationHelper.getDecoratedMeasurementInOther(var19) + var22;
               } else {
                  var10 = this.getPaddingTop() + this.mCachedBorders[var21.mSpanIndex];
                  var9 = this.mOrientationHelper.getDecoratedMeasurementInOther(var19) + var10;
               }
            ...
            this.layoutDecoratedWithMargins(var19, var7, var10, var22, var9);
