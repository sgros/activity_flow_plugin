...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
   ...
   private int checkVerticalSwipe(RecyclerView.ViewHolder var1, int var2) {
      if ((var2 & 3) != 0) {
         ...
         var6 = (float)this.mRecyclerView.getHeight();
         var3 = this.mCallback.getSwipeThreshold(var1);
         if ((var2 & var5) != 0 && Math.abs(this.mDy) > var6 * var3) {
            return var5;
         }
      }
   ...
   private List findSwapTargets(RecyclerView.ViewHolder var1) {
      ...
      for(var3 = 0; var3 < var12; ++var3) {
         View var2 = var11.getChildAt(var3);
         if (var2 != var1.itemView && var2.getBottom() >= var5 && var2.getTop() <= var8 && var2.getRight() >= var4 && var2.getLeft() <= var7) {
            ...
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var13)) {
               var6 = Math.abs(var9 - (var2.getLeft() + var2.getRight()) / 2);
               int var14 = Math.abs(var10 - (var2.getTop() + var2.getBottom()) / 2);
               int var15 = var6 * var6 + var14 * var14;
               int var16 = this.mSwapTargets.size();
               var14 = 0;

               for(var6 = 0; var6 < var16 && var15 > (Integer)this.mDistances.get(var6); ++var6) {
                  ++var14;
               }

               this.mSwapTargets.add(var14, var13);
   ...
   private RecyclerView.ViewHolder findSwipedView(MotionEvent var1) {
      ...
      if (this.mActivePointerId == -1) {
         ...
         if (var4 < (float)this.mSlop && var7 < (float)this.mSlop) {
            return null;
         } else if (var4 > var7 && var2.canScrollHorizontally()) {
            return null;
         } else if (var7 > var4 && var2.canScrollVertically()) {
            return null;
         } else {
         ...
         if (this.mRecyclerView.getScrollState() == 1) {
            ...
            if (var4 == null) {
               ...
               if (var1 == 0) {
                  ...
                  var6 = Math.abs(var7);
                  if (var8 < (float)this.mSlop && var6 < (float)this.mSlop) {
                     return false;
                  } else {
                     if (var8 > var6) {
   ...
   boolean scrollIfNecessary() {
      if (this.mSelected == null) {
         ...
         var7 = var6;
         if (var6 != 0) {
            var7 = this.mCallback.interpolateOutOfBoundsScroll(this.mRecyclerView, this.mSelected.itemView.getHeight(), var6, this.mRecyclerView.getHeight(), var3);
         }
         ...
         if (var8 == 0 && var7 == 0) {
            ...
            this.mRecyclerView.scrollBy(var8, var7);
            return true;
         }
      }
   }
   ...
   void select(RecyclerView.ViewHolder var1, int var2) {
      if (var1 != this.mSelected || var2 != this.mActionState) {
         ...
         if (this.mSelected != null) {
            ...
            if (var4.itemView.getParent() != null) {
               ...
               if (var5 != 4 && var5 != 8 && var5 != 16 && var5 != 32) {
                  ...
                  var6 = Math.signum(this.mDx);
                  var8 = (float)this.mRecyclerView.getWidth();
                  var7 = 0.0F;
                  var6 *= var8;
               }
               ...
               this.getSelectedDxDy(this.mTmpPosition);
               float var10 = this.mTmpPosition[0];
               var8 = this.mTmpPosition[1];
               ItemTouchHelper.RecoverAnimation var13 = new ItemTouchHelper.RecoverAnimation(var4, var14, var3, var10, var8, var6, var7) {
               ...
               var13.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, var14, var6 - var10, var7 - var8));
         ...
         if (var1 != null) {
            this.mSelectedFlags = (this.mCallback.getAbsoluteMovementFlags(this.mRecyclerView, var1) & (1 << 8 * var2 + 8) - 1) >> this.mActionState * 8;
