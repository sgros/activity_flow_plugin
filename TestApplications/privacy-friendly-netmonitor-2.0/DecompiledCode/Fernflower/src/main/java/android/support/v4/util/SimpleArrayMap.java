   ...
   public Object put(Object var1, Object var2) {
      ...
      if (var4 >= 0) {
         ...
         if (var6 < var3) {
            ...
            var4 = var6 + 1;
            System.arraycopy(var7, var6, var9, var4, var3 - var6);
      ...
      if (var4 <= 1) {
         ...
         if (var7.length > 8 && this.mSize < this.mHashes.length / 3) {
            ...
            if (var1 < var6) {
               ...
               int[] var9 = this.mHashes;
               var10 = var6 - var1;
               System.arraycopy(var7, var12, var9, var1, var10);
               System.arraycopy(var14, var12 << 1, this.mArray, var3, var10 << 1);
            }
         } else {
            if (var1 < var6) {
               ...
               var7 = this.mHashes;
               var12 = var6 - var1;
               System.arraycopy(var8, var10, var7, var1, var12);
               System.arraycopy(this.mArray, var10 << 1, this.mArray, var3, var12 << 1);
            }
