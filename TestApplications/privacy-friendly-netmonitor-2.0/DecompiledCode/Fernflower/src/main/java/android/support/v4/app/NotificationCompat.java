...
public class NotificationCompat {
   ...
   public static class DecoratedCustomViewStyle extends NotificationCompat.Style {
      ...
      private RemoteViews createRemoteViews(RemoteViews var1, boolean var2) {
            ...
            if (var2 && this.mBuilder.mActions != null) {
               ...
               if (var7 > 0) {
                  ...
                  while(true) {
                     ...
                     RemoteViews var9 = this.generateActionButton((NotificationCompat.Action)this.mBuilder.mActions.get(var3));
         ...
         var6.setViewVisibility(R.id.actions, var10);
         var6.setViewVisibility(R.id.action_divider, var10);
      ...
      public void apply(NotificationBuilderWithBuilderAccessor var1) {
         if (VERSION.SDK_INT >= 24) {
            ...
            if (this.mConversationTitle != null) {
               ...
               var1.getBuilder().setContentTitle(var11.getSender());
            }

            CharSequence var12;
            if (var11 != null) {
               android.app.Notification.Builder var13 = var1.getBuilder();
               if (this.mConversationTitle != null) {
               ...
               var13.setContentText(var12);
            }

            if (VERSION.SDK_INT >= 16) {
               SpannableStringBuilder var14 = new SpannableStringBuilder();
               boolean var9;
               ...
               for(int var10 = this.mMessages.size() - 1; var10 >= 0; --var10) {
                  ...
                  var14.insert(0, var12);
               }

               NotificationCompatJellybean.addBigTextStyle(var1, (CharSequence)null, false, (CharSequence)null, var14);
            }
         }
   ...
   public abstract static class Style {
      ...
      public RemoteViews applyStandardTemplate(boolean var1, int var2, boolean var3) {
         ...
         if (this.mBuilder.mLargeIcon != null) {
            ...
            var5.setViewVisibility(R.id.icon, 0);
            if (VERSION.SDK_INT >= 21) {
               var10 = var4.getDimensionPixelSize(R.dimen.notification_large_icon_width);
               var8 = var4.getDimensionPixelSize(R.dimen.notification_big_circle_margin);
               var2 = var4.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large);
               var9 = this.createIconWithBackground(this.mBuilder.mNotification.icon, var10 - var8, var2, this.mBuilder.getColor());
