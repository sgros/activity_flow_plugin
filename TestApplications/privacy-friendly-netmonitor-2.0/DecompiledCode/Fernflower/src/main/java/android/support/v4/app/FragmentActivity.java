...
public class FragmentActivity extends BaseFragmentActivityApi16 implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
   ...
   private static void markState(FragmentManager var0, Lifecycle.State var1) {
      Iterator var3 = var0.getFragments().iterator();

      while(var3.hasNext()) {
         Fragment var2 = (Fragment)var3.next();
         if (var2 != null) {
            var2.mLifecycleRegistry.markState(var1);
            markState(var2.getChildFragmentManager(), var1);
         }
      }
   ...
   protected void onCreate(@Nullable Bundle var1) {
      ...
      if (var4 != null) {
         this.mFragments.restoreLoaderNonConfig(var4.loaders);
      }
