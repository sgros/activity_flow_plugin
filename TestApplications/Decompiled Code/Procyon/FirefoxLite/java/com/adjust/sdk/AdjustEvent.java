...
public class AdjustEvent
{
    ...
    public void addCallbackParameter(final String s, final String s2) {
        if (!Util.isValidParameter(s, "key", "Callback")) {
            return;
        }
        if (!Util.isValidParameter(s2, "value", "Callback")) {
            return;
        }
    ...
    public void addPartnerParameter(final String s, final String s2) {
        if (!Util.isValidParameter(s, "key", "Partner")) {
            return;
        }
        if (!Util.isValidParameter(s2, "value", "Partner")) {
            return;
        }
