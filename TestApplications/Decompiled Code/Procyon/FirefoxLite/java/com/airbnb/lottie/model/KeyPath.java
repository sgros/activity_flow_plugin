...
public class KeyPath
{
    ...
    private boolean isContainer(final String s) {
        return s.equals("__container");
    }
    ...
    public boolean propagateToChildren(final String s, final int n) {
        final boolean equals = s.equals("__container");
