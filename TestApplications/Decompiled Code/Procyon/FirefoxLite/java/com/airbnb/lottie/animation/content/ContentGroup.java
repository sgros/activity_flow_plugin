...
public class ContentGroup implements DrawingContent, PathContent, AnimationListener, KeyPathElement
{
    ...
    ContentGroup(final LottieDrawable lottieDrawable, final BaseLayer baseLayer, final String name, final List<Content> contents, final AnimatableTransform animatableTransform) {
    ...
    public void draw(final Canvas canvas, final Matrix matrix, int i) {
        ...
        if (this.transformAnimation != null) {
            ...
            n = (int)(this.transformAnimation.getOpacity().getValue() / 100.0f * i / 255.0f * 255.0f);
        }
