...
public class PolystarShape implements ContentModel
{
    ...
    public PolystarShape(final String name, final Type type, final AnimatableFloatValue points, final AnimatableValue<PointF, PointF> position, final AnimatableFloatValue rotation, final AnimatableFloatValue innerRadius, final AnimatableFloatValue outerRadius, final AnimatableFloatValue innerRoundedness, final AnimatableFloatValue outerRoundedness) {
        this.name = name;
        this.type = type;
        this.points = points;
