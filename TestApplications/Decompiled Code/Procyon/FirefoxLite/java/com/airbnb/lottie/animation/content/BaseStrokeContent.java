...
public abstract class BaseStrokeContent implements DrawingContent, KeyPathElementContent, AnimationListener
{
    ...
    BaseStrokeContent(final LottieDrawable lottieDrawable, final BaseLayer layer, final Paint$Cap strokeCap, final Paint$Join strokeJoin, final float strokeMiter, final AnimatableIntegerValue animatableIntegerValue, final AnimatableFloatValue animatableFloatValue, final List<AnimatableFloatValue> list, final AnimatableFloatValue animatableFloatValue2) {
        ...
        if (this.dashPatternOffsetAnimation != null) {
            this.dashPatternOffsetAnimation.addUpdateListener((BaseKeyframeAnimation.AnimationListener)this);
        }
    }
    ...
    private void applyDashPatternIfNeeded(final Matrix matrix) {
        ...
        if (this.dashPatternOffsetAnimation == null) {
            ...
            floatValue = this.dashPatternOffsetAnimation.getValue();
        }
    ...
    public void draw(final Canvas canvas, final Matrix matrix, int i) {
        ...
        i = (int)(i / 255.0f * this.opacityAnimation.getValue() / 100.0f * 255.0f);
        final Paint paint = this.paint;
        final int n = 0;
        paint.setAlpha(MiscUtils.clamp(i, 0, 255));
        this.paint.setStrokeWidth(this.widthAnimation.getValue() * Utils.getScale(matrix));
    ...
    public void getBounds(final RectF rectF, final Matrix matrix) {
        ...
        final float floatValue = this.widthAnimation.getValue();
        final RectF rect = this.rect;
        final float left = this.rect.left;
        final float n = floatValue / 2.0f;
        rect.set(left - n, this.rect.top - n, this.rect.right + n, this.rect.bottom + n);
        rectF.set(this.rect);
