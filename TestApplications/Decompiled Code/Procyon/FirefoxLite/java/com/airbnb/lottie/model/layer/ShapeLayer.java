...
public class ShapeLayer extends BaseLayer
{
    ...
    ShapeLayer(final LottieDrawable lottieDrawable, final Layer layer) {
        ...
        (this.contentGroup = new ContentGroup(lottieDrawable, this, new ShapeGroup("__container", layer.getShapes()))).setContents(Collections.emptyList(), Collections.emptyList());
    }
