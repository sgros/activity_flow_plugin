        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            for (int size = this.mItems.size(), i = itemInfo.position; i < this.mItems.get(size - 1).position; ++i) {
                ...
                if (i == itemInfo.position) {
                    a = (itemInfo.offset + itemInfo.widthFactor) * n2;
                    offset = itemInfo.offset + itemInfo.widthFactor + n3;
                }
                else {
                    final float pageWidth = this.mAdapter.getPageWidth(i);
                    final float n4 = offset + (pageWidth + n3);
                    final float n5 = (offset + pageWidth) * n2;
                    offset = n4;
                    a = n5;
                }
