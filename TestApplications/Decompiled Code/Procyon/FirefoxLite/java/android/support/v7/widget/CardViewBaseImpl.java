        ...
        RoundRectDrawableWithShadow.sRoundRectHelper = (RoundRectDrawableWithShadow.RoundRectHelper)new RoundRectDrawableWithShadow.RoundRectHelper() {
            ...
            public void drawRoundRect(final Canvas canvas, final RectF rectF, final float n, final Paint paint) {
                ...
                if (n >= 1.0f) {
                    ...
                    final RectF mCornerRect = CardViewBaseImpl.this.mCornerRect;
                    final float n5 = -n4;
                    mCornerRect.set(n5, n5, n4, n4);
                    ...
                    canvas.drawRect(rectF.left + n4 - 1.0f, rectF.top, rectF.right - n4 + 1.0f, rectF.top + n4, paint);
                    canvas.drawRect(rectF.left + n4 - 1.0f, rectF.bottom - n4, rectF.right - n4 + 1.0f, rectF.bottom, paint);
                }
