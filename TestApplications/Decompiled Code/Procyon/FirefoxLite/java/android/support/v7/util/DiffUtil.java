...
public class DiffUtil
{
    ...
    private static Snake diffPartial(final Callback callback, final int n, int n2, final int n3, int fromIndex, final int[] a, final int[] a2, final int n4) {
        final int val = n2 - n;
        n2 = fromIndex - n3;
        if (val >= 1 && n2 >= 1) {
            final int n5 = val - n2;
            ...
            while (i <= n6) {
                ...
                for (n7 = (j = -i); j <= i; j += 2) {
                    ...
                    for (int n10 = n9 - j; n9 < fromIndex && n10 < n2 && callback.areItemsTheSame(n + n9, n3 + n10); ++n9, ++n10) {}
                    final int n11 = n4 + j;
                    a[n11] = n9;
