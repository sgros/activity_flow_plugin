...
public class FileUtils
{
    ...
    public static List<BarEntry> loadBarEntriesFromAssets(final AssetManager assetManager, String ex) {
            ...
            try {
                ...
                try {
                    for (String s = bufferedReader4.readLine(); s != null; s = bufferedReader4.readLine()) {
                        ...
                        ex = (IOException)new BarEntry(Float.parseFloat(split[1]), Float.parseFloat(split[0]));
