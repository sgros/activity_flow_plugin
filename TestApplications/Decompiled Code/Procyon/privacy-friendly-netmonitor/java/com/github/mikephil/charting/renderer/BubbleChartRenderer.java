        ...
        if (this.isDrawingValuesAllowed(this.mChart)) {
            ...
            for (int i = 0; i < dataSets.size(); ++i) {
                ...
                if (this.shouldDrawValues(set)) {
                    ...
                    final float max = Math.max(0.0f, Math.min(1.0f, this.mAnimator.getPhaseX()));
                    ...
                    for (int j = 0; j < generateTransformedValuesBubble.length; j += 2) {
                        ...
                        final int argb = Color.argb(Math.round(255.0f * phaseY), Color.red(valueTextColor), Color.green(valueTextColor), Color.blue(valueTextColor));
