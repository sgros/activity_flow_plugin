...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>> extends Chart<T>
{
    ...
    public void calculateOffsets() {
        ...
        if (mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            ...
            n13 = n8 + this.getRequiredBaseOffset();
            n14 = n11;
        }
        else {
            n14 = 0.0f;
        ...
        float n15;
        final float a = n15 = Utils.convertDpToPixel(this.mMinOffset);
        if (this instanceof RadarChart) {
            ...
            if (xAxis.isEnabled()) {
                ...
                if (xAxis.isDrawLabelsEnabled()) {
                    n15 = Math.max(a, (float)xAxis.mLabelRotatedWidth);
                }
            }
        }
        ...
        final float max = Math.max(n15, n10 + this.getExtraLeftOffset());
        final float max2 = Math.max(n15, n12 + extraTopOffset);
        final float max3 = Math.max(n15, n14 + extraRightOffset);
        final float max4 = Math.max(n15, Math.max(this.getRequiredBaseOffset(), n13 + extraBottomOffset));
