...
public class ConsoleUtilities
{
    ...
    public static String arrayValueMatchRegex(final String[] array, String matcher) {
        final Pattern compile = Pattern.compile(matcher);
        int n = 0;
    Label_0021_Outer:
        while (true) {
            Label_0044: {
                ...
                matcher = (String)compile.matcher(array[n]);
                while (true) {
                    Label_0038: {
