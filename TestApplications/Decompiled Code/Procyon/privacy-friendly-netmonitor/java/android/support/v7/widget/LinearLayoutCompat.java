...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    void measureHorizontal(final int n, final int n2) {
        ...
        this.setMeasuredDimension(resolveSizeAndState | (0xFF000000 & n6), View.resolveSizeAndState(Math.max(max7 + (this.getPaddingTop() + this.getPaddingBottom()), this.getSuggestedMinimumHeight()), n2, n6 << 16));
        if (n7 != 0) {
    ...
    void measureVertical(final int n, final int n2) {
            ...
            if (n19 == Integer.MIN_VALUE || n19 == 0) {
                ...
                for (int j = 0; j < virtualChildCount; ++j) {
                    ...
                    if (virtualChild2 == null) {
                        ...
                        final LayoutParams layoutParams3 = (LayoutParams)virtualChild2.getLayoutParams();
                        final int mTotalLength4 = this.mTotalLength;
                        this.mTotalLength = Math.max(mTotalLength4, mTotalLength4 + max2 + layoutParams3.topMargin + layoutParams3.bottomMargin + this.getNextLocationOffset(virtualChild2));
                    }
                }
            }
        }
        ...
        int n21 = (0xFFFFFF & resolveSizeAndState) - this.mTotalLength;
        int n22;
        if (n5 == 0 && (n21 == 0 || mWeightSum <= 0.0f)) {
            final int max5 = Math.max(a2, n4);
            if (mUseLargestChild && n20 != 1073741824) {
                for (int k = 0; k < virtualChildCount; ++k) {
                    final View virtualChild3 = this.getVirtualChildAt(k);
                    if (virtualChild3 != null) {
            ...
            for (int l = n23; l < virtualChildCount; ++l) {
                ...
                if (virtualChild4.getVisibility() != 8) {
                    ...
                    final float weight = layoutParams4.weight;
                    if (weight > 0.0f) {
                        final int n24 = (int)(n21 * weight / mWeightSum);
                        final int paddingLeft = this.getPaddingLeft();
                        final int paddingRight = this.getPaddingRight();
                        ...
                        if (layoutParams4.height == 0 && n20 == 1073741824) {
                            int n26;
                            if (n24 > 0) {
                                n26 = n24;
                            }
                            ...
                            virtualChild4.measure(childMeasureSpec, View$MeasureSpec.makeMeasureSpec(n26, 1073741824));
                        }
                        else {
                            int n27;
                            if ((n27 = virtualChild4.getMeasuredHeight() + n24) < 0) {
                                n27 = 0;
                            }
                            virtualChild4.measure(childMeasureSpec, View$MeasureSpec.makeMeasureSpec(n27, 1073741824));
                        }
                        combineMeasuredStates2 = View.combineMeasuredStates(combineMeasuredStates2, virtualChild4.getMeasuredState() & 0xFFFFFF00);
                        n21 = n25;
                    }
                    final int n28 = layoutParams4.leftMargin + layoutParams4.rightMargin;
                    int n29 = virtualChild4.getMeasuredWidth() + n28;
                    final int max7 = Math.max(a3, n29);
                    if (mode != 1073741824 && layoutParams4.width == -1) {
                        n29 = n28;
                    }
                    max6 = Math.max(max6, n29);
                    int n30;
        ...
        this.setMeasuredDimension(View.resolveSizeAndState(Math.max(n31 + (this.getPaddingLeft() + this.getPaddingRight()), this.getSuggestedMinimumWidth()), n, n3), resolveSizeAndState);
        if (n6 != 0) {
