...
class AppCompatProgressBarHelper
{
    ...
    private Drawable tileify(final Drawable drawable, final boolean b) {
        if (drawable instanceof DrawableWrapper) {
            final DrawableWrapper drawableWrapper = (DrawableWrapper)drawable;
            final Drawable wrappedDrawable = drawableWrapper.getWrappedDrawable();
            if (wrappedDrawable != null) {
                drawableWrapper.setWrappedDrawable(this.tileify(wrappedDrawable, b));
            }
        }
        else {
