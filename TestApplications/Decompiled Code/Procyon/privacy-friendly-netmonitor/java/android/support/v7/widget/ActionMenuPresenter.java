...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener
{
    ...
    public boolean flagActionItems() {
        ...
        final ViewGroup viewGroup = (ViewGroup)this.mMenuView;
        final boolean b;
        final int n2 = (b = false) ? 1 : 0;
        final int n4;
        int n3 = n4 = (b ? 1 : 0);
        boolean b2 = b;
        int n5 = n2;
        int n6;
        for (int i = n4; i < size; ++i, mMaxItems = n6) {
        ...
        int n7 = mMaxItems;
        if (this.mReserveOverflow && (b2 || n3 + n5 > (n7 = mMaxItems))) {
            n7 = mMaxItems - 1;
        }
        int n8 = n7 - n5;
        ...
        if (this.mStrictWidthLimit) {
            ...
            n10 = mActionItemWidthLimit % this.mMinCellSize / n9 + this.mMinCellSize;
        }
        else {
            n9 = (n10 = 0);
        }
        int n11 = 0;
        int n12 = mActionItemWidthLimit;
        int j = n11;
        final int n13 = size;
        ...
        while (j < n13) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (this.mStrictWidthLimit) {
                    n9 -= ActionMenuView.measureChildForCells(itemView, n10, n9, measureSpec, isActionButton);
                }
                else {
                ...
                boolean isActionButton2 = (n8 > 0 || value) && n12 > 0 && (!this.mStrictWidthLimit || n9 > 0);
                int n17;
                if (isActionButton2) {
                    ...
                    if (this.mStrictWidthLimit) {
                        final int measureChildForCells = ActionMenuView.measureChildForCells(itemView2, n10, n9, measureSpec, 0);
                        final int n16 = n9 -= measureChildForCells;
                    ...
                    if (this.mStrictWidthLimit) {
                        isActionButton2 &= (n12 >= 0);
                    }
                    else {
                        isActionButton2 &= (n12 + n17 > 0);
                    }
                }
                else {
                    n17 = n11;
