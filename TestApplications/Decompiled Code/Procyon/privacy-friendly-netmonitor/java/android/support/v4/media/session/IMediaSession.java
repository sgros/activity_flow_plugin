    ...
    public abstract static class Stub extends Binder implements IMediaSession
    {
        ...
        public boolean onTransact(int n, final Parcel parcel, final Parcel parcel2, final int n2) throws RemoteException {
            ...
            switch (n) {
                ...
                case 40: {
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    boolean shuffleModeEnabledDeprecated = b;
                    if (parcel.readInt() != 0) {
                        shuffleModeEnabledDeprecated = true;
                    }
                    this.setShuffleModeEnabledDeprecated(shuffleModeEnabledDeprecated);
                    parcel2.writeNoException();
                    return true;
                }
                case 39: {
                ...
                case 38: {
                    parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    n = (this.isShuffleModeEnabledDeprecated() ? 1 : 0);
                    parcel2.writeNoException();
                    parcel2.writeInt(n);
                    return true;
                }
