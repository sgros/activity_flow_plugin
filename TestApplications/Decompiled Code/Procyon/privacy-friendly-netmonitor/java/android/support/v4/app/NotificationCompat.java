    ...
    public static class Action extends NotificationCompatBase.Action
    {
        ...
        public static final class Builder
        {
            ...
            public Action build() {
                ...
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, array, array2, this.mAllowGeneratedReplies);
            }
        ...
        public RemoteViews applyStandardTemplate(final boolean b, int n, final boolean b2) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                ...
                if (Build$VERSION.SDK_INT >= 21) {
                    ...
                    remoteViews.setImageViewBitmap(R.id.icon, this.createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize2 - n, resources.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                }
                else {
            ...
            final boolean b3 = Build$VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            int n5 = 0;
            Label_0672: {
