    ...
    public static class PathDataNode
    {
                ...
                Label_2164: {
                    ...
                    Label_1752: {
                        while (true) {
                            ...
                            final float n105 = n32;
                            n10 = n33;
                            n9 = n105;
                            continue;
                        }
                    }
                    final float n106 = n77;
                    n9 = n76;
                    n10 = n106;
                    continue;
                }
        ...
        private static void arcToBezier(final Path path, final double n, final double n2, final double n3, double n4, double n5, double n6, double n7, double n8, double n9) {
            ...
            while (i < n10) {
                ...
                final double n23 = sin3 * n7 + cos3 * n8;
                final double a = n19 - n17;
                final double tan = Math.tan(a / 2.0);
                final double n24 = Math.sin(a) * (Math.sqrt(4.0 + 3.0 * tan * tan) - 1.0) / 3.0;
                path.rLineTo(0.0f, 0.0f);
                path.cubicTo((float)(n6 + n15 * n24), (float)(n16 + n9 * n24), (float)(n20 - n24 * n22), (float)(n21 - n24 * n23), (float)n20, (float)n21);
                ++i;
                n16 = n21;
                n6 = n20;
                n9 = n23;
