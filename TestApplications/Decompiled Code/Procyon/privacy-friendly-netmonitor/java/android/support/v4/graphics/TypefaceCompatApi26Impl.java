...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl
{
    ...
    static {
        ...
        try {
            ...
            final Method method5 = method6 = null;
            final Method method8;
            final Method method7 = method8 = method6;
            method4 = (method3 = method8);
            method2 = method8;
            method = method7;
    ...
    @Override
    public Typeface createFromFontInfo(Context t, @Nullable final CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] openFileDescriptor, int i) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            ...
            try {
                openFileDescriptor = (FontsContractCompat.FontInfo[])(Object)contentResolver.openFileDescriptor(bestInfo.getUri(), "r", cancellationSignal);
                try {
        ...
        final Map<Uri, ByteBuffer> prepareFontData = FontsContractCompat.prepareFontData((Context)t, openFileDescriptor, cancellationSignal);
        final Object family = newFamily();
        i = 0;
