...
public class SlidingPaneLayout extends ViewGroup
{
    ...
    boolean smoothSlideTo(final float n, int width) {
        if (!this.mCanSlide) {
            return false;
        }
        final boolean layoutRtlSupport = this.isLayoutRtlSupport();
        ...
        if (layoutRtlSupport) {
            ...
            width = this.mSlideableView.getWidth();
            width = (int)(this.getWidth() - (paddingRight + rightMargin + n * this.mSlideRange + width));
        }
        else {
            width = (int)(this.getPaddingLeft() + layoutParams.leftMargin + n * this.mSlideRange);
        }
