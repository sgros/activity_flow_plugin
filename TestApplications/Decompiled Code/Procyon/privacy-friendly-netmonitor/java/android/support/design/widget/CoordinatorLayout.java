...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2
{
    ...
    public CoordinatorLayout(final Context context, final AttributeSet set, int i) {
        ...
        final int coordinatorLayout_keylines = R.styleable.CoordinatorLayout_keylines;
        i = 0;
        final int resourceId = obtainStyledAttributes.getResourceId(coordinatorLayout_keylines, 0);
        if (resourceId != 0) {
            final Resources resources = context.getResources();
            this.mKeylines = resources.getIntArray(resourceId);
            final float density = resources.getDisplayMetrics().density;
            while (i < this.mKeylines.length) {
            ...
            if ((n6 || n5 != 0) && actionMasked != 0) {
                ...
                if (n6 == 0) {
                    ...
                    if (behavior != null) {
                        switch (n) {
                            case 1: {
                                n6 = (behavior.onTouchEvent(this, mBehaviorTouchView, motionEvent) ? 1 : 0);
                                break;
                            }
                            case 0: {
                                n6 = (behavior.onInterceptTouchEvent(this, mBehaviorTouchView, motionEvent) ? 1 : 0);
                                break;
                            }
                        }
                        b3 = (n6 != 0);
                ...
                final boolean b4 = blockingInteractionBelow && !didBlockInteraction;
                b2 = b3;
                n7 = (b4 ? 1 : 0);
                obtain = motionEvent2;
    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        for (int i = 0; i < size3; ++i) {
            ...
            if (view.getVisibility() != 8) {
                ...
                final Behavior behavior = layoutParams.getBehavior();
                if (behavior == null || !behavior.onMeasureChild(this, view, measureSpec, n5, measureSpec2, 0)) {
                    this.onMeasureChild(view, measureSpec, n5, measureSpec2, 0);
                }
            ...
            if (child.getVisibility() == 8) {
                ...
                if (!layoutParams.isNestedScrollAccepted(n3)) {
                    ...
                    if (behavior != null) {
                        ...
                        int n11;
                        if (n > 0) {
                            n11 = Math.max(n6, this.mTempIntPair[0]);
                        }
                        else {
                            n11 = Math.min(n6, this.mTempIntPair[0]);
                        }
                        int n12;
                        if (n2 > 0) {
                            n12 = Math.max(n7, this.mTempIntPair[1]);
                        }
                        else {
                            n12 = Math.min(n7, this.mTempIntPair[1]);
                        }
                        n9 = n11;
                        n10 = n12;
                        n8 = 1;
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        for (int i = 0; i < this.getChildCount(); ++i) {
            ...
            if (id != -1 && behavior != null) {
                parcelable = (Parcelable)behaviorStates.get(id);
                if (parcelable != null) {
                    behavior.onRestoreInstanceState(this, child, parcelable);
                }
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent obtain) {
        ...
        final View mBehaviorTouchView2 = this.mBehaviorTouchView;
        final MotionEvent motionEvent = null;
        boolean b2;
        if (mBehaviorTouchView2 == null) {
