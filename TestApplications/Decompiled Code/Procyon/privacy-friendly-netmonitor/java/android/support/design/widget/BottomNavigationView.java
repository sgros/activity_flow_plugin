    ...
    public BottomNavigationView(final Context context, final AttributeSet set, int resourceId) {
        ...
        this.mMenu.setCallback((MenuBuilder.Callback)new MenuBuilder.Callback() {
            ...
            public boolean onMenuItemSelected(final MenuBuilder menuBuilder, final MenuItem menuItem) {
                final OnNavigationItemReselectedListener access$000 = BottomNavigationView.this.mReselectedListener;
                boolean b = true;
                if (access$000 != null && menuItem.getItemId() == BottomNavigationView.this.getSelectedItemId()) {
