...
public class ConstraintLayout extends ViewGroup
{
    ...
    protected void onMeasure(int b, int min) {
        ...
        this.setSelfDimensionBehaviour(b, min);
        ...
        this.internalMeasureChildren(b, min);
        ...
        if (Build$VERSION.SDK_INT >= 11) {
            ...
            final int resolveSizeAndState = resolveSizeAndState(n12, min, n10 << 16);
            min = Math.min(this.mMaxWidth, b);
            b = Math.min(this.mMaxHeight, resolveSizeAndState);
            min &= 0xFFFFFF;
            final int n13 = b & 0xFFFFFF;
            b = min;
        ...
        Label_1792_Outer:
            while (true) {
                Label_1798: {
                    ...
                    String substring4;
                    Block_59_Outer:Block_63_Outer:Block_68_Outer:Block_66_Outer:Block_67_Outer:
                    while (true) {
                        Label_1483: {
