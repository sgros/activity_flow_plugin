...
public class DatabaseUtils
{
    ...
    public static long queryNumEntries(SQLiteDatabase query, final String s) {
        query = (SQLiteDatabase)query.query(s, DatabaseUtils.countProjection, null, null, null, null, null);
        try {
