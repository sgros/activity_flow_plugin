...
public final class Detector
{
    ...
    private static ResultPoint[] expandSquare(final ResultPoint[] array, float n, float n2) {
        ...
        final float n7 = array[1].getY() - array[3].getY();
        n2 = (array[1].getX() + array[3].getX()) / 2.0f;
        final float n8 = (array[1].getY() + array[3].getY()) / 2.0f;
        return new ResultPoint[] { resultPoint, new ResultPoint(n * n6 + n2, n * n7 + n8), resultPoint2, new ResultPoint(n2 - n * n6, n8 - n * n7) };
    }
    ...
    private Point getMatrixCenter() {
        ...
        //   142: fadd           
        //   143: aload_1        
        //   144: invokevirtual   com/google/zxing/ResultPoint.getX:()F
        //   147: fadd           
        //   148: aload           4
        ...
        //   168: fadd           
        //   169: aload_1        
        //   170: invokevirtual   com/google/zxing/ResultPoint.getY:()F
        //   173: fadd           
        //   174: aload           4
        ...
        //   385: astore_1       
        //   386: aload_0        
        //   387: new             Lcom/google/zxing/aztec/detector/Detector$Point;
        //   390: dup            
        //   391: iload           5
        //   393: bipush          7
        //   395: isub           
        ...
        //   398: bipush          7
        //   400: iadd           
        //   401: invokespecial   com/google/zxing/aztec/detector/Detector$Point.<init>:(II)V
        //   404: iconst_0       
        //   405: iconst_m1      
        //   406: iconst_1       
        //   407: invokespecial   com/google/zxing/aztec/detector/Detector.getFirstDifferent:(Lcom/google/zxing/aztec/detector/Detector$Point;ZII)Lcom/google/zxing/aztec/detector/Detector$Point;
        //   410: invokevirtual   com/google/zxing/aztec/detector/Detector$Point.toResultPoint:()Lcom/google/zxing/ResultPoint;
        //   413: astore          4
        //   415: aload_0        
