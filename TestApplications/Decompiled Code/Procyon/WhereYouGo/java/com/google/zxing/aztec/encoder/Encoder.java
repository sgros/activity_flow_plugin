...
public final class Encoder
{
    ...
    public static AztecCode encode(final byte[] array, int size, int i) {
        ...
        while (j < layers) {
            ...
            final int n12 = (layers - j << 2) + n11;
            for (int k = 0; k < n12; ++k) {
                final int n13 = k << 1;
                for (int l = 0; l < 2; ++l) {
                    if (generateCheckWords.get(i + n13 + l)) {
                        matrix.set(array2[(j << 1) + l], array2[(j << 1) + k]);
                    }
                    if (generateCheckWords.get((n12 << 1) + i + n13 + l)) {
                        matrix.set(array2[(j << 1) + k], array2[n6 - 1 - (j << 1) - l]);
                    }
                    if (generateCheckWords.get((n12 << 2) + i + n13 + l)) {
                        matrix.set(array2[n6 - 1 - (j << 1) - l], array2[n6 - 1 - (j << 1) - k]);
                    }
                    if (generateCheckWords.get(n12 * 6 + i + n13 + l)) {
                        matrix.set(array2[n6 - 1 - (j << 1) - k], array2[(j << 1) + l]);
                    }
                }
            }
            i += n12 << 3;
        ...
        if (compact) {
            ...
            int n14;
            int n15;
            for (n14 = 0, i = 0; n14 < n6 / 2 - 1; n14 += 15, i += 16) {
