            ...
            Block_25: {
                Block_20: {
                    Block_15: {
                        ...
                        for (int n20 = 1; blackPointOnSegment == null && n20 < n19; blackPointOnSegment = this.getBlackPointOnSegment((float)n8, (float)(n7 - n20), (float)(n8 + n20), (float)n7), ++n20) {}
                        if (blackPointOnSegment == null) {
                            throw NotFoundException.getNotFoundInstance();
                        }
                        ResultPoint blackPointOnSegment2 = null;
                        for (int n21 = 1; blackPointOnSegment2 == null && n21 < n19; blackPointOnSegment2 = this.getBlackPointOnSegment((float)n8, (float)(n11 + n21), (float)(n8 + n21), (float)n11), ++n21) {}
                        if (blackPointOnSegment2 == null) {
                            throw NotFoundException.getNotFoundInstance();
                        }
                        ResultPoint blackPointOnSegment3 = null;
                        for (int n22 = 1; blackPointOnSegment3 == null && n22 < n19; blackPointOnSegment3 = this.getBlackPointOnSegment((float)n9, (float)(n11 + n22), (float)(n9 - n22), (float)n11), ++n22) {}
                        if (blackPointOnSegment3 == null) {
                            throw NotFoundException.getNotFoundInstance();
                        }
                        ResultPoint blackPointOnSegment4 = null;
                        for (int n23 = 1; blackPointOnSegment4 == null && n23 < n19; blackPointOnSegment4 = this.getBlackPointOnSegment((float)n9, (float)(n7 - n23), (float)(n9 - n23), (float)n7), ++n23) {}
