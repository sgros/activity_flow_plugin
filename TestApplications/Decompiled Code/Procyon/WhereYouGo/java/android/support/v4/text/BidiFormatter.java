...
public final class BidiFormatter
{
    ...
    private String markAfter(final CharSequence charSequence, final TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        else if (this.mIsRtlContext && (!rtl || getExitDir(charSequence) == -1)) {
    ...
    private String markBefore(final CharSequence charSequence, final TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        else if (this.mIsRtlContext && (!rtl || getEntryDir(charSequence) == -1)) {
            s = BidiFormatter.RLM_STRING;
        }
        else {
            s = "";
    ...
    public String unicodeWrap(String string, final TextDirectionHeuristicCompat textDirectionHeuristicCompat, final boolean b) {
        if (string == null) {
            string = null;
        }
        else {
            string = this.unicodeWrap((CharSequence)string, textDirectionHeuristicCompat, b).toString();
        }
        return string;
    }
