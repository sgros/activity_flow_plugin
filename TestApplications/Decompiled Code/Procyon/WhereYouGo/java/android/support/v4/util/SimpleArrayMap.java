        ...
        if (this == key) {
            ...
            if (key instanceof SimpleArrayMap) {
                ...
                while (true) {
                    ...
                    try {
                        if (n < this.mSize) {
                            final K key2 = this.keyAt(n);
                            final V value = this.valueAt(n);
                            final Object value2 = simpleArrayMap.get(key2);
                            if (value == null) {
                                if (value2 != null || !simpleArrayMap.containsKey(key2)) {
                                    b2 = false;
                                    return b2;
                                }
                            }
            ...
            if (key instanceof Map) {
                ...
                while (true) {
                    ...
                    try {
                        if (n2 < this.mSize) {
                            key = this.keyAt(n2);
                            final V value3 = this.valueAt(n2);
                            final Object value4 = map.get(key);
                            if (value3 == null) {
                                if (value4 != null || !map.containsKey(key)) {
                                    b2 = false;
                                    return b2;
                                }
                            }
