...
public abstract class MediaBrowserServiceCompat extends Service
{
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy
    {
        ...
        public Bundle getBrowserRootHints() {
            ...
            if (MediaBrowserServiceCompat.this.mCurConnection != null) {
                if (MediaBrowserServiceCompat.this.mCurConnection.rootHints == null) {
                    browserRootHints = null;
                }
                else {
                    browserRootHints = new Bundle(MediaBrowserServiceCompat.this.mCurConnection.rootHints);
                }
            }
            else {
                browserRootHints = MediaBrowserServiceCompatApi24.getBrowserRootHints(this.mServiceObj);
            }
