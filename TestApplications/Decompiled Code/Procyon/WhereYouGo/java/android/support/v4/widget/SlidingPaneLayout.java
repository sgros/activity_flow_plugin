    ...
    private class DragHelperCallback extends Callback
    {
        ...
        public int clampViewPositionHorizontal(final View view, int n, int mSlideRange) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                mSlideRange = SlidingPaneLayout.this.getWidth() - (SlidingPaneLayout.this.getPaddingRight() + layoutParams.rightMargin + SlidingPaneLayout.this.mSlideableView.getWidth());
                n = Math.max(Math.min(n, mSlideRange), mSlideRange - SlidingPaneLayout.this.mSlideRange);
            }
            else {
                final int b = SlidingPaneLayout.this.getPaddingLeft() + layoutParams.leftMargin;
                mSlideRange = SlidingPaneLayout.this.mSlideRange;
                n = Math.min(Math.max(n, b), b + mSlideRange);
            }
            return n;
        }
