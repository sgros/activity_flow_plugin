...
public class FrameBuffer
{
    ...
    public boolean drawBitmap(final Tile tile, final Bitmap bitmap) {
        Object mapViewBitmap2 = this.mapView.getMapViewPosition().getMapPosition();
        // monitorenter(this)
        Label_0025: {
            if (bitmap != null) {
                break Label_0025;
        ...
        Block_7_Outer:
            while (true) {
                ...
                // monitorexit(this)
                // iftrue(Label_0049:, tile.zoomLevel == mapViewBitmap2.zoomLevel)
                finally {
                }
                // monitorexit(this)
                Label_0049: {
                    ...
                    // monitorexit(this)
                        ...
                        final GeoPoint geoPoint = ((MapPosition)mapViewBitmap2).geoPoint;
                        final double longitudeToPixelX = MercatorProjection.longitudeToPixelX(geoPoint.longitude, ((MapPosition)mapViewBitmap2).zoomLevel);
                        final double latitudeToPixelY = MercatorProjection.latitudeToPixelY(geoPoint.latitude, ((MapPosition)mapViewBitmap2).zoomLevel);
                        ...
                        // monitorexit(this)
                            ...
                            if (!this.matrix.isIdentity()) {
                                ...
                                this.matrix.reset();
                                mapViewBitmap2 = this.mapViewBitmap1;
                                this.mapViewBitmap1 = this.mapViewBitmap2;
                                this.mapViewBitmap2 = (Bitmap)mapViewBitmap2;
                            }
