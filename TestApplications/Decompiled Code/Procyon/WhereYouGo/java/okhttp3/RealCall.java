        ...
        protected void execute() {
            ...
            try {
                ...
                if (RealCall.this.retryAndFollowUpInterceptor.isCanceled()) {
                    ...
                    n = n2;
                    final RealCall this$0 = RealCall.this;
                    n = n2;
                    n = n2;
                    final IOException ex = new IOException("Canceled");
                    n = n2;
                    responseCallback.onFailure(this$0, ex);
                }
                else {
                    n = 1;
                ...
                if (n != 0) {
                    Platform.get().log(4, "Callback failure for " + RealCall.this.toLoggableString(), ex2);
                }
                else {
                    this.responseCallback.onFailure(RealCall.this, ex2);
                }
