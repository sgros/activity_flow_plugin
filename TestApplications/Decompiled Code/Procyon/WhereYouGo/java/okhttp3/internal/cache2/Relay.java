...
final class Relay
{
    ...
    class RelaySource implements Source
    {
        ...
        @Override
        public long read(Buffer buffer, long a) throws IOException {
            if (this.fileOperator == null) {
            ...
            while (true) {
                ...
                while (true) {
                    Label_0162: {
                        ...
                        final int n = 1;
                        if (n == 2) {
                            a = Math.min(a, upstreamPos - this.sourcePos);
                            this.fileOperator.read(32L + this.sourcePos, buffer2, a);
                            this.sourcePos += a;
                            return a;
                        }
                        try {
                            ...
                            a = Math.min(read, a);
                            Relay.this.upstreamBuffer.copyTo(buffer2, 0L, a);
                            this.sourcePos += a;
                            ...
                            try {
                                ...
                                final Relay relay4;
                                final Relay this$2 = relay4;
                            }
                            // monitorexit(buffer)
                        }
                        finally {
                            final Relay relay5;
                            final Relay this$2 = relay5;
                            buffer = (Buffer)Relay.this;
                            synchronized (buffer) {
                                Relay.this.upstreamReader = null;
                                Relay.this.notifyAll();
                    ...
                    n2 = upstreamPos - Relay.this.buffer.size();
                    if (this.sourcePos < n2) {
                        final int n = 2;
                        // monitorexit(relay)
                        continue;
                    }
                ...
                a = Math.min(a, upstreamPos - this.sourcePos);
                Relay.this.buffer.copyTo(buffer2, this.sourcePos - n2, a);
                this.sourcePos += a;
                // monitorexit(relay)
                return a;
            }
