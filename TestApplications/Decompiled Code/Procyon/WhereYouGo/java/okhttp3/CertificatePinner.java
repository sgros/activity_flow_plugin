...
public final class CertificatePinner
{
    ...
    public boolean equals(final Object o) {
        boolean b = true;
        if (o != this) {
            b = (o instanceof CertificatePinner && Util.equal(this.certificateChainCleaner, ((CertificatePinner)o).certificateChainCleaner) && this.pins.equals(((CertificatePinner)o).pins));
        }
        return b;
    }
    ...
    static final class Pin
    {
        ...
        boolean matches(final String s) {
            ...
            if (this.pattern.startsWith("*.")) {
                b = s.regionMatches(false, s.indexOf(46) + 1, this.canonicalHostname, 0, this.canonicalHostname.length());
            }
            else {
                b = s.equals(this.canonicalHostname);
            }
            return b;
        }
