            ...
            while (true) {
                ...
                Label_0191: {
                    synchronized (this.lock) {
                        ...
                        o = iterator.next();
                        if (!((MapPointPack)o).isPolygon()) {
                            break Label_0191;
                        }
                        final ArrayList<GeoPoint> list4 = new ArrayList<GeoPoint>();
                        o = ((MapPointPack)o).getPoints().iterator();
                        while (((Iterator)o).hasNext()) {
                            final MapPoint mapPoint = ((Iterator<MapPoint>)o).next();
                            list4.add(new GeoPoint(mapPoint.getLatitude(), mapPoint.getLongitude()));
                        }
                    }
                ...
                Object drawable;
                if (((MapPointPack)o).getIcon() == null) {
                    final Resources resources = this.getResources();
                    int resource;
                    if (((MapPointPack)o).getResource() != 0) {
                        resource = ((MapPointPack)o).getResource();
                    }
                    else {
                        resource = 2130837560;
                    }
                    ...
                    final Bitmap icon = ((MapPointPack)o).getIcon();
                    Bitmap bitmap;
                ...
                while (true) {
                    ...
                    final MapPoint mapPoint2 = ((Iterator<MapPoint>)o).next();
                    final GeoPoint target = new GeoPoint(mapPoint2.getLatitude(), mapPoint2.getLongitude());
                    final PointOverlay pointOverlay = new PointOverlay(target, boundCenterBottom, mapPoint2);
                    ...
                    if (mapPoint2.isTarget()) {
                        this.navigationOverlay.setTarget(target);
                    }
        ...
        if (n == 0) {
            ...
            switch (Preferences.FORMAT_COO_LATLON) {
                ...
                case 2: {
                    ...
                    final int j = (int)longitude;
                    n = (int)((longitude - j) * 60.0);
                    final double n4 = j;
                    final double n5 = n / 60;
                    ((EditText)dialog.findViewById(2131492911)).setText((CharSequence)Integer.toString(j));
                    ((EditText)dialog.findViewById(2131492912)).setText((CharSequence)Integer.toString(n));
