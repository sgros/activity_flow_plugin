...
public class CustomDialog
{
    ...
    private static void setCustomDialogTitleButton(final View view, final int n, final int imageResource, final OnClickListener onClickListener) {
        if (imageResource != Integer.MIN_VALUE && onClickListener != null) {
            ...
            if (n == 1) {
                final ImageView imageView = (ImageView)view.findViewById(2131492892);
                final ImageButton imageButton = (ImageButton)view.findViewById(2131492893);
                imageView2 = imageView;
                imageButton2 = imageButton;
            }
            else {
                final ImageView imageView3 = (ImageView)view.findViewById(2131492890);
                imageButton2 = (ImageButton)view.findViewById(2131492891);
