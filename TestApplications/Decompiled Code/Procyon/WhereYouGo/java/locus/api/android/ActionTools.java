...
public class ActionTools
{
    ...
    public static BitmapLoadResult getMapPreview(final Context context, LocusUtils.LocusVersion locusVersion, Location bytes, int i, int int1, final int j, final boolean b) throws RequiredVersionMissingException {
        Object o = getContentProviderData(locusVersion, LocusUtils.VersionCode.UPDATE_04, "mapPreview");
        if (o == null) {
            throw new RequiredVersionMissingException(LocusUtils.VersionCode.UPDATE_04);
        }
        locusVersion = (LocusUtils.LocusVersion)new StringBuilder();
        ((StringBuilder)locusVersion).append("lon=").append(bytes.getLongitude()).append(",");
        ((StringBuilder)locusVersion).append("lat=").append(bytes.getLatitude()).append(",");
        ((StringBuilder)locusVersion).append("zoom=").append(i).append(",");
        ((StringBuilder)locusVersion).append("width=").append(int1).append(",");
        ((StringBuilder)locusVersion).append("height=").append(j).append(",");
        bytes = (Location)((StringBuilder)locusVersion).append("tinyMode=");
        Label_0248: {
            if (!b) {
                break Label_0248;
            }
            ...
            while (true) {
                ...
                o = context.getContentResolver().query((Uri)o, (String[])null, ((StringBuilder)locusVersion).toString(), (String[])null, (String)null);
                Object o2 = null;
                int1 = 0;
                i = 0;
                try {
                    while (i < ((Cursor)o).getCount()) {
                        ((Cursor)o).moveToPosition(i);
                        final String s = new String(((Cursor)o).getBlob(0));
                        bytes = (Location)(Object)((Cursor)o).getBlob(1);
                        if (s.equals("mapPreview")) {
                            locusVersion = (LocusUtils.LocusVersion)bytes;
                        }
                        else {
                            locusVersion = (LocusUtils.LocusVersion)o2;
                            if (s.equals("mapPreviewMissingTiles")) {
                                locusVersion = (LocusUtils.LocusVersion)new String((byte[])(Object)bytes);
                                int1 = locus.api.utils.Utils.parseInt((String)locusVersion);
                                locusVersion = (LocusUtils.LocusVersion)o2;
                            }
                        }
                        ++i;
                    ...
                    return new BitmapLoadResult((byte[])o2, int1);
                    i = 0;
                    continue;
                }
                catch (Exception ex) {
