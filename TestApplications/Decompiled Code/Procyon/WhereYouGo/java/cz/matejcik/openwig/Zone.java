        ...
        if (this.active && this.points != null && this.points.length != 0 && zonePoint != null) {
            ...
            if (zonePoint.latitude > this.pbbBottom && zonePoint.latitude < this.pbbTop && zonePoint.longitude > this.pbbLeft && zonePoint.longitude < this.pbbRight) {
                ...
                if (zonePoint.latitude > this.bbBottom && zonePoint.latitude < this.bbTop && zonePoint.longitude > this.bbLeft && zonePoint.longitude < this.bbRight && this.points.length > 2) {
                    ...
                    int n = 0;
                    int n6;
                    for (int i = 0; i < this.points.length; ++i, n = n6) {
                            ...
                            if (n2 < latitude) {
                                ...
                                if (latitude <= n4) {
                                    if (longitude2 > longitude && longitude3 > longitude) {
                                        ...
                                        n6 = n;
                                        if ((longitude - n3) * (n4 - n2) < (n5 - n3) * (latitude - n2)) {
                                            if (n == 0) {
                                                n6 = 1;
                                            }
                                            else {
                ...
                if (this.ncontain != 2) {
                    ...
                    double n7 = Double.POSITIVE_INFINITY;
                    double n11;
                    for (int j = 0; j < this.points.length; ++j, n7 = n11) {
                        final double latitude6 = this.points[j].latitude;
                        final double longitude6 = this.points[j].longitude;
                        final double n8 = (zonePoint.latitude - latitude4) * (latitude6 - latitude4) + (zonePoint.longitude - longitude4) * (longitude6 - longitude4);
                        if (n8 > 0.0) {
                            final double n9 = (zonePoint.latitude - latitude6) * (latitude4 - latitude6) + (zonePoint.longitude - longitude6) * (longitude4 - longitude6);
                            if (n9 <= 0.0) {
                                latitude4 = latitude6;
                                longitude4 = longitude6;
                            }
                            else {
                                latitude4 += (latitude6 - latitude4) * n8 / (n8 + n9);
                                longitude4 += (longitude6 - longitude4) * n8 / (n8 + n9);
                            }
                        }
                        final double n10 = (latitude4 - zonePoint.latitude) * (latitude4 - zonePoint.latitude) + (longitude4 - zonePoint.longitude) * (longitude4 - zonePoint.longitude);
                        n11 = n7;
                        if (n10 < n7) {
                            n11 = n10;
