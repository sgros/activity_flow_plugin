   ...
   public static void setStatusbar(Activity var0) {
      try {
         ...
         if (Preferences.APPEARANCE_STATUSBAR) {
            ...
            PendingIntent var5 = PendingIntent.getActivity(var2, 0, var3, 0);
            NotificationCompat.Builder var6 = new NotificationCompat.Builder(var0);
            var1.notify(0, var6.setContentTitle(A.getAppName()).setSmallIcon(2130837551).setContentIntent(var5).setOngoing(true).build());
         } else {
            var1.cancel(0);
         }
