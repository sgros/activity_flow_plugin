...
public class MyLocationOverlay implements LocationListener, Overlay {
   ...
   public MyLocationOverlay(Context var1, MapView var2, Marker var3) {
      this(var1, var2, var3, getDefaultCircleFill(), getDefaultCircleStroke());
   }

   public MyLocationOverlay(Context var1, MapView var2, Marker var3, Paint var4, Paint var5) {
      this.mapView = var2;
   ...
   private boolean enableBestAvailableProvider() {
      ...
      label91: {
         ...
         try {
            this.lastLocation = this.locationManager.getLastKnownLocation(var9);
