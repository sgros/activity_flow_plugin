                  ...
                  label124: {
                     ...
                     while(true) {
                        ...
                        try {
                           ...
                           var7 = var11.getAzimuth();
                           var6 = (float)((double)this.r1 - Math.sin((double)(var11.getElevation() / 57.29578F)) * (double)this.r1) * 0.9F;
                           var5 = (float)((double)this.spX + (double)var6 * Math.sin((double)(var7 / 57.29578F)));
                           var6 = (float)((double)this.spY - (double)var6 * Math.cos((double)(var7 / 57.29578F)));
                           this.mPaintText.setColor(-16777216);
                           Bitmap var32 = this.getSatImage((float)var11.getSnr());
                           StringBuilder var33 = new StringBuilder();
                           var1.drawText(var33.append("").append(var11.getPrn()).toString(), var5, var6 - (float)(var32.getHeight() / 2) - 5.0F, this.mPaintText);
                           var1.drawBitmap(var32, var5 - (float)(var32.getWidth() / 2), var6 - (float)(var32.getHeight() / 2), this.mPaintBitmap);
