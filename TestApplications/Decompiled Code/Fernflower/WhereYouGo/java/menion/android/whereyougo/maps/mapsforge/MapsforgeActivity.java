...
public class MapsforgeActivity extends MapActivity implements IRefreshable {
   ...
   private static Polyline createPolyline(List var0) {
      PolygonalChain var2 = new PolygonalChain(var0);
      Paint var1 = new Paint(1);
      var1.setStyle(Style.STROKE);
      var1.setColor(-65281);
      var1.setStrokeWidth(4.0F);
      return new Polyline(var2, var1);
   }
         ...
         while(true) {
            ...
            while(true) {
               ...
               try {
                  ...
                  if (var8.isPolygon()) {
                     var1 = new ArrayList();
                     var324 = var8.getPoints().iterator();
                     break;
                  }
               ...
               while(true) {
                  ...
                  try {
                     ...
                     var325 = (MapPoint)var324.next();
                     GeoPoint var12 = new GeoPoint(var325.getLatitude(), var325.getLongitude());
                     PointOverlay var10 = new PointOverlay(var12, var322, var325);
                     var10.setMarkerVisible(this.showPins);
                     var10.setLabelVisible(this.showLabels);
                     var6.add(var10);
                     if (var325.isTarget()) {
                        this.navigationOverlay.setTarget(var12);
                     }
                  ...
                  try {
                     this.itemsLatitude += var325.getLatitude();
                     this.itemsLongitude += var325.getLongitude();
            ...
            while(true) {
               try {
                  ...
                  var325 = (MapPoint)var324.next();
                  GeoPoint var326 = new GeoPoint(var325.getLatitude(), var325.getLongitude());
                  var1.add(var326);
         ...
         case 1:
            ...
            var3.setPositiveButton(2131165422, new OnClickListener() {
               public void onClick(DialogInterface var1, int var2) {
                  ...
                  try {
                     GeoPoint var11 = new GeoPoint(var3 + var5x, var7 + var9);
                     SeekBar var14 = (SeekBar)var5.findViewById(2131492907);
                     MapPosition var12 = new MapPosition(var11, (byte)var14.getProgress());
         ...
         case 2:
            ...
            var3.setPositiveButton(2131165422, new OnClickListener() {
               public void onClick(DialogInterface var1, int var2) {
                  ...
                  double var11 = Double.parseDouble(((EditText)var5.findViewById(2131492911)).getText().toString());
                  var7 = Double.parseDouble(((EditText)var5.findViewById(2131492912)).getText().toString());
                  double var13 = Double.parseDouble(((EditText)var5.findViewById(2131492914)).getText().toString());
                  MapPosition var15 = new MapPosition(new GeoPoint(var5x + var3 + var9, var7 / 60.0D + var11 + var13 / 3600.0D), (byte)((SeekBar)var5.findViewById(2131492907)).getProgress());
   ...
   public boolean onCreateOptionsMenu(Menu var1) {
      ...
      this.menu = var1;
      SubMenu var2 = var1.findItem(2131493009).getSubMenu();
      String[] var3 = this.getResources().getStringArray(2131230723);
      String[] var4 = this.getResources().getStringArray(2131230720);

      for(int var5 = 0; var5 < var3.length; ++var5) {
         final MapGeneratorInternal var6 = MapGeneratorInternal.valueOf(var3[var5]);
         MenuItem var7 = var2.add(2131493010, 0, 0, var4[var5]);
         var7.setOnMenuItemClickListener(new OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem var1) {
               if (var6 == MapGeneratorInternal.DATABASE_RENDERER && MapsforgeActivity.this.mapView.getMapFile() == null) {
                  MapsforgeActivity.this.startMapFilePicker();
               } else {
                  MapsforgeActivity.this.setMapGenerator(var6);
         ...
         if (this.mapGeneratorInternal != null && this.mapGeneratorInternal.name().equals(var6.name())) {
            var7.setChecked(true);
         }
      }

      var2.setGroupCheckable(2131493010, true, true);
      return true;
   }
   ...
   protected void onPrepareDialog(int var1, Dialog var2) {
      if (var1 == 0) {
         ...
         case 1:
            ...
            ((EditText)var2.findViewById(2131492910)).setText(Double.toString((var5 - var10) * 60.0D));
            var1 = (int)var7;
            var5 = (double)var1;
         ...
         case 2:
            ...
            var9 = (int)var7;
            var1 = (int)((var7 - (double)var9) * 60.0D);
            var5 = (double)var9;
            var10 = (double)(var1 / 60);
            ((EditText)var2.findViewById(2131492911)).setText(Integer.toString(var9));
            ((EditText)var2.findViewById(2131492912)).setText(Integer.toString(var1));
            ((EditText)var2.findViewById(2131492914)).setText(Double.toString((var7 - var5 - var10) * 3600.0D));
            break;
         default:
         ...
         GeoPoint var22 = var16.startPosition;
         if (var22 == null) {
            var18.setText((CharSequence)null);
         } else {
            var18.setText(var22.latitude + ", " + var22.longitude);
         }

         var14 = (TextView)var2.findViewById(2131492922);
         Byte var21 = var16.startZoomLevel;
         if (var21 == null) {
            var14.setText((CharSequence)null);
         } else {
            var14.setText(var21.toString());
         }
