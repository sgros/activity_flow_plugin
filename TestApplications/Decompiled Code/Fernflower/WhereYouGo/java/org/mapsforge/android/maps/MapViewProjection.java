...
class MapViewProjection implements Projection {
   ...
   public GeoPoint fromPixels(int var1, int var2) {
      ...
      if (this.mapView.getWidth() > 0 && this.mapView.getHeight() > 0) {
         MapPosition var13 = this.mapView.getMapViewPosition().getMapPosition();
         GeoPoint var4 = var13.geoPoint;
         double var5 = MercatorProjection.longitudeToPixelX(var4.longitude, var13.zoomLevel);
         double var7 = MercatorProjection.latitudeToPixelY(var4.latitude, var13.zoomLevel);
         double var9 = (double)(this.mapView.getWidth() >> 1);
         double var11 = (double)(this.mapView.getHeight() >> 1);
         var3 = new GeoPoint(MercatorProjection.pixelYToLatitude((double)var2 + (var7 - var11), var13.zoomLevel), MercatorProjection.pixelXToLongitude((double)var1 + (var5 - var9), var13.zoomLevel));
      } else {
         var3 = null;
      }
