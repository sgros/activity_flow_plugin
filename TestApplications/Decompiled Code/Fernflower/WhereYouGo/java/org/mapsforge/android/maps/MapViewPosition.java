      ...
      label199: {
         ...
         label200: {
            ...
            try {
               ...
               var3 = Math.min(Math.max(0.0D, var3 - var5), (double)var11);
               var7 = MercatorProjection.pixelYToLatitude(Math.min(Math.max(0.0D, var7 - var9), (double)var11), this.zoomLevel);
               var9 = MercatorProjection.pixelXToLongitude(var3, this.zoomLevel);
               GeoPoint var34 = new GeoPoint(var7, var9);
