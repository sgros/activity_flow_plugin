...
final class TileScheduler {
   ...
   static double getPriority(Tile var0, MapView var1) {
      ...
      MapPosition var13 = var1.getMapViewPosition().getMapPosition();
      GeoPoint var12 = var13.geoPoint;
      var7 = var12.longitude - var7;
      var9 = var12.latitude - var9;
      var9 = Math.sqrt(var7 * var7 + var9 * var9);
      if (var13.zoomLevel != var2) {
         int var11 = Math.abs(var13.zoomLevel - var2);
