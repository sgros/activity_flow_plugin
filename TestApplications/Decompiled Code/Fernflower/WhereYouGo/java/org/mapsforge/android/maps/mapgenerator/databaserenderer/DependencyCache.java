...
class DependencyCache {
   ...
   private void fillDependencyLabels(List var1) {
      ...
      for(int var10 = 0; var10 < var1.size(); ++var10) {
         ...
         if (var11.symbol != null && var12 == null) {
            var13 = var12;
   ...
   private void fillDependencyOnTile2(List var1, List var2, List var3) {
      ...
      while(var12.hasNext()) {
         ...
         var2 = null;
         DependencyCache.DependencySymbol var14 = var2;
         DependencyCache.DependencySymbol var16;
         if (var13.point.y < 0.0D) {
            var14 = var2;
            if (!((DependencyCache.DependencyOnTile)this.dependencyTable.get(var6)).drawn) {
               DependencyCache.DependencyOnTile var15 = (DependencyCache.DependencyOnTile)this.dependencyTable.get(var6);
               var16 = new DependencyCache.DependencySymbol(var13.symbol, this.currentTile);
               this.currentDependencyOnTile.addSymbol(new DependencyCache.Dependency(var16, new Point(var13.point.x, var13.point.y)));
               var15.addSymbol(new DependencyCache.Dependency(var16, new Point(var13.point.x, var13.point.y + 256.0D)));
               var16.addTile(var6);
               if (var13.point.x < 0.0D && !((DependencyCache.DependencyOnTile)this.dependencyTable.get(var8)).drawn) {
                  ((DependencyCache.DependencyOnTile)this.dependencyTable.get(var8)).addSymbol(new DependencyCache.Dependency(var16, new Point(var13.point.x + 256.0D, var13.point.y + 256.0D)));
                  var16.addTile(var8);
               }
               ...
               if (var13.point.x + (double)var13.symbol.getWidth() > 256.0D) {
                  ...
                  if (!((DependencyCache.DependencyOnTile)this.dependencyTable.get(var10)).drawn) {
                     ((DependencyCache.DependencyOnTile)this.dependencyTable.get(var10)).addSymbol(new DependencyCache.Dependency(var16, new Point(var13.point.x - 256.0D, var13.point.y + 256.0D)));
                     var16.addTile(var10);
                     var14 = var16;
                  }
               }
         ...
         if (var13.point.y + (double)var13.symbol.getHeight() > 256.0D) {
            ...
            if (!((DependencyCache.DependencyOnTile)this.dependencyTable.get(var7)).drawn) {
               DependencyCache.DependencyOnTile var18 = (DependencyCache.DependencyOnTile)this.dependencyTable.get(var7);
               DependencyCache.DependencySymbol var17 = var14;
               if (var14 == null) {
                  var17 = new DependencyCache.DependencySymbol(var13.symbol, this.currentTile);
                  this.currentDependencyOnTile.addSymbol(new DependencyCache.Dependency(var17, new Point(var13.point.x, var13.point.y)));
               }

               var18.addSymbol(new DependencyCache.Dependency(var17, new Point(var13.point.x, var13.point.y - 256.0D)));
               var17.addTile(var7);
               if (var13.point.x < 0.0D && !((DependencyCache.DependencyOnTile)this.dependencyTable.get(var9)).drawn) {
                  ((DependencyCache.DependencyOnTile)this.dependencyTable.get(var9)).addSymbol(new DependencyCache.Dependency(var17, new Point(var13.point.x + 256.0D, var13.point.y - 256.0D)));
                  var17.addTile(var9);
               }
               ...
               if (var13.point.x + (double)var13.symbol.getWidth() > 256.0D) {
                  ...
                  if (!((DependencyCache.DependencyOnTile)this.dependencyTable.get(var11)).drawn) {
                     ((DependencyCache.DependencyOnTile)this.dependencyTable.get(var11)).addSymbol(new DependencyCache.Dependency(var17, new Point(var13.point.x - 256.0D, var13.point.y - 256.0D)));
                     var17.addTile(var11);
                     var16 = var17;
                  }
               }
         ...
         if (var13.point.x + (double)var13.symbol.getWidth() > 256.0D && !((DependencyCache.DependencyOnTile)this.dependencyTable.get(var5)).drawn) {
            ...
            var19.addSymbol(new DependencyCache.Dependency(var16, new Point(var13.point.x - 256.0D, var13.point.y)));
            var16.addTile(var5);
         }
      }
   ...
   private void removeOverlappingAreaLabelsWithDependencySymbols(List var1) {
      ...
      while(var2.hasNext()) {
         ...
         for(var8 = 0; var8 < var1.size(); var8 = var7 + 1) {
   ...
   private void removeOverlappingSymbolsWithDepencySymbols(List var1, int var2) {
      for(int var3 = 0; var3 < this.currentDependencyOnTile.symbols.size(); ++var3) {
         ...
         for(var5 = 0; var5 < var1.size(); var5 = var7 + 1) {
