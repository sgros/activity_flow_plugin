...
final class WayDecorator {
   ...
   static void renderSymbol(Bitmap var0, boolean var1, boolean var2, Point[][] var3, List var4) {
      ...
      for(int var10 = 1; var10 < var3[0].length; ++var10) {
         ...
         for(var6 = var15; var19 - (float)var5 > 30.0F; var5 = 200) {
            float var22 = (float)var5 / var19;
            var20 += (double)var22 * var6;
            var8 += (double)var22 * var17;
            var22 = (float)Math.toDegrees(Math.atan2(var13 - var8, var11 - var20));
            var4.add(new SymbolContainer(var0, new Point(var20, var8), var1, var22));
            if (!var2) {
               return;
            }
         ...
         int var23 = (int)((float)var5 - var19);
         var5 = var23;
         if (var23 < 30) {
            var5 = 30;
         }
