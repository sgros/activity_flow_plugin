...
public final class FormBody extends RequestBody {
   ...
   private long writeOrCountBytes(BufferedSink var1, boolean var2) {
      long var3 = 0L;
      Buffer var7;
      if (var2) {
         var7 = new Buffer();
      ...
      for(int var6 = this.encodedNames.size(); var5 < var6; ++var5) {
         if (var5 > 0) {
            var7.writeByte(38);
         }

         var7.writeUtf8((String)this.encodedNames.get(var5));
         var7.writeByte(61);
         var7.writeUtf8((String)this.encodedValues.get(var5));
      }
