...
public final class CipherSuite {
   ...
   public static CipherSuite forJavaName(String var0) {
      CipherSuite var1 = (CipherSuite)INSTANCES.get(var0);
      CipherSuite var2 = var1;
      if (var1 == null) {
         var2 = new CipherSuite(var0);
         CipherSuite var3 = (CipherSuite)INSTANCES.putIfAbsent(var0, var2);
         if (var3 != null) {
            var2 = var3;
         }
      }
