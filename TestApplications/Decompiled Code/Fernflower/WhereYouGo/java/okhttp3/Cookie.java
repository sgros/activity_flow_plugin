      ...
      if (var6 == var5) {
         ...
         if (!var7.isEmpty() && Util.indexOfControlOrNonAscii(var7) == -1) {
            ...
            if (Util.indexOfControlOrNonAscii(var8) != -1) {
               ...
               String var21;
               long var25;
               for(var6 = var5 + 1; var6 < var4; var11 = var25) {
                  int var19 = Util.delimiterOffset(var3, var6, var4, ';');
                  var5 = Util.delimiterOffset(var3, var6, var19, '=');
                  String var20 = Util.trimSubstring(var3, var6, var5);
                  if (var5 < var19) {
                     var21 = Util.trimSubstring(var3, var5 + 1, var19);
                  } else {
                     var21 = "";
                  }
               ...
               label68: {
                  ...
                  var6 = var34.lastIndexOf(47);
                  if (var6 != 0) {
                     var3 = var34.substring(0, var6);
                  } else {
                     var3 = "/";
                  }
               }
