      ...
      public Factory(long var1, Request var3, Response var4) {
         ...
         if (var4 != null) {
            ...
            for(int var6 = var9.size(); var5 < var6; ++var5) {
               String var7 = var9.name(var5);
               String var8 = var9.value(var5);
               if ("Date".equalsIgnoreCase(var7)) {
                  this.servedDate = HttpDate.parse(var8);
                  this.servedDateString = var8;
               } else if ("Expires".equalsIgnoreCase(var7)) {
                  this.expires = HttpDate.parse(var8);
               } else if ("Last-Modified".equalsIgnoreCase(var7)) {
                  this.lastModified = HttpDate.parse(var8);
                  this.lastModifiedString = var8;
               } else if ("ETag".equalsIgnoreCase(var7)) {
                  this.etag = var8;
               } else if ("Age".equalsIgnoreCase(var7)) {
                  this.ageSeconds = HttpHeaders.parseSeconds(var8, -1);
               }
            }
         }
