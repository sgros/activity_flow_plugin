...
class JdkWithJettyBootPlatform extends Platform {
   ...
   public void configureTlsExtensions(SSLSocket var1, String var2, List var3) {
      List var10 = alpnProtocolNames(var3);

      Object var9;
      try {
         ClassLoader var4 = Platform.class.getClassLoader();
         Class var5 = this.clientProviderClass;
         Class var6 = this.serverProviderClass;
         JdkWithJettyBootPlatform.JettyNegoProvider var12 = new JdkWithJettyBootPlatform.JettyNegoProvider(var10);
         Object var11 = Proxy.newProxyInstance(var4, new Class[]{var5, var6}, var12);
