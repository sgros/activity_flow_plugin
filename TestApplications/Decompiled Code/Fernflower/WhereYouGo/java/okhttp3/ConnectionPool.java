   ...
   private int pruneAndGetAllocationCount(RealConnection var1, long var2) {
      ...
      while(true) {
         if (var5 < var4.size()) {
            ...
            String var7 = "A connection to " + var1.route().address().url() + " was leaked. Did you forget to close a response body?";
            Platform.get().logCloseableLeak(var7, var8.callStackTrace);
            var4.remove(var5);
