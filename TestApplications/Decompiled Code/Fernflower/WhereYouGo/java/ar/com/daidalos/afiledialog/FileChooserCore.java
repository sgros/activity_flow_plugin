   ...
   public void loadFolder(File var1) {
      ...
      if (this.currentFolder.exists() && var2 != null) {
         ...
         if (!this.currentFolder.isDirectory()) {
            ...
            File[] var4 = this.currentFolder.listFiles();
            if (var4 != null) {
               ...
               for(var5 = 0; var5 < var4.length; ++var5) {
                  ...
                  if (!var4[var5].isDirectory()) {
                     if (this.folderMode || this.filter != null && !var4[var5].getName().matches(this.filter)) {
                        var6 = false;
                     } else {
                        var6 = true;
                     }
                  ...
                  if (var6 || !this.showOnlySelectable) {
                     FileItem var7 = new FileItem(this.chooser.getContext(), var4[var5]);
                     var7.setSelectable(var6);
                     var3.add(var7);
                  }
               }
            }
         ...
         for(var5 = 0; var5 < var3.size(); ++var5) {
            ((FileItem)var3.get(var5)).addListener(this.fileItemClickListener);
            var2.addView((View)var3.get(var5));
         }
