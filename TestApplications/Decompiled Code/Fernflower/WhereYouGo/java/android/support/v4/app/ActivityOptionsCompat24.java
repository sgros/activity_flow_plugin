...
class ActivityOptionsCompat24 {
   ...
   public static ActivityOptionsCompat24 makeSceneTransitionAnimation(Activity var0, View[] var1, String[] var2) {
      Pair[] var3 = null;
      if (var1 != null) {
         Pair[] var4 = new Pair[var1.length];
         int var5 = 0;
         ...
         while(true) {
            ...
            var4[var5] = Pair.create(var1[var5], var2[var5]);
            ++var5;
         }
      }

      return new ActivityOptionsCompat24(ActivityOptions.makeSceneTransitionAnimation(var0, var3));
   }
