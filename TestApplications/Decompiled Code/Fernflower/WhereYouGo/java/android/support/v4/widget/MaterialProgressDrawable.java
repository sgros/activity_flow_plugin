...
class MaterialProgressDrawable extends Drawable implements Animatable {
   ...
   private int evaluateColorChange(float var1, int var2, int var3) {
      ...
      return (int)((float)((var3 >> 24 & 255) - var2) * var1) + var2 << 24 | (int)((float)((var3 >> 16 & 255) - var5) * var1) + var5 << 16 | (int)((float)((var3 >> 8 & 255) - var6) * var1) + var6 << 8 | (int)((float)((var3 & 255) - var4) * var1) + var4;
   }
   ...
   private void setSizeParameters(double var1, double var3, double var5, double var7, float var9, float var10) {
      ...
      this.mWidth = (double)var12 * var1;
      this.mHeight = (double)var12 * var3;
      var11.setStrokeWidth((float)var7 * var12);
      var11.setCenterRadius((double)var12 * var5);
         ...
         public void applyTransformation(float var1x, Transformation var2) {
            if (MaterialProgressDrawable.this.mFinishing) {
               ...
               if (var1x <= 0.5F) {
                  ...
                  var1.setStartTrim(var5 + (0.8F - var3) * var7);
               }

               if (var1x > 0.5F) {
                  var5 = (var1x - 0.5F) / 0.5F;
                  var5 = MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(var5);
                  var1.setEndTrim(var4 + var5 * (0.8F - var3));
               }

               var1.setRotation(var6 + 0.25F * var1x);
   ...
   private static class Ring {
      ...
      public void draw(Canvas var1, Rect var2) {
         ...
         float var5 = (this.mEndTrim + this.mRotation) * 360.0F - var4;
