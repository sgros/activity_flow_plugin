...
public final class LinkifyCompat {
   ...
   public static final boolean addLinks(@NonNull Spannable var0, int var1) {
      ...
      if (var1 == 0) {
         ...
         if ((var1 & 1) != 0) {
            ...
            MatchFilter var7 = Linkify.sUrlMatchFilter;
            gatherLinks(var5, var0, var6, new String[]{"http://", "https://", "rtsp://"}, var7, (TransformFilter)null);
         }
   ...
   private static final void pruneOverlaps(ArrayList var0, Spannable var1) {
      ...
      while(true) {
         while(var6 < var5 - 1) {
            LinkifyCompat.LinkSpec var7 = (LinkifyCompat.LinkSpec)var0.get(var6);
            var4 = (LinkifyCompat.LinkSpec)var0.get(var6 + 1);
            var3 = -1;
            if (var7.start <= var4.start && var7.end > var4.start) {
               if (var4.end <= var7.end) {
                  var3 = var6 + 1;
               } else if (var7.end - var7.start > var4.end - var4.start) {
                  var3 = var6 + 1;
               } else if (var7.end - var7.start < var4.end - var4.start) {
                  var3 = var6;
               }
