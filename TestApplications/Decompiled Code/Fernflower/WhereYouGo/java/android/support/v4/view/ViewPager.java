      ...
      for(var4 = 0; var4 < var6; ++var4) {
         ...
         if (var13.getVisibility() != 8) {
            ...
            if (!var19.isDecor) {
               ...
               if (var20 != null) {
                  var9 = var3 + (int)((float)var16 * var20.offset);
                  if (var19.needsMeasure) {
                     var19.needsMeasure = false;
                     var13.measure(MeasureSpec.makeMeasureSpec((int)((float)var16 * var19.widthFactor), 1073741824), MeasureSpec.makeMeasureSpec(var8 - var2 - var5, 1073741824));
                  }

                  var13.layout(var9, var2, var13.getMeasuredWidth() + var9, var13.getMeasuredHeight() + var2);
               }
            }
         }
      }
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      for(int var4 = 0; var4 < var3; var1 = var7) {
         ...
         if (var5.getVisibility() != 8) {
            ViewPager.LayoutParams var8 = (ViewPager.LayoutParams)var5.getLayoutParams();
            var6 = var2;
            var7 = var1;
            if (var8 != null) {
               var6 = var2;
               ...
               if (var8.isDecor) {
                  ...
                  var5.measure(MeasureSpec.makeMeasureSpec(var13, var7), MeasureSpec.makeMeasureSpec(var12, var6));
                  if (var17) {
      ...
      if (this.mFakeDragging) {
         ...
         case 2:
            if (!this.mIsBeingDragged) {
               ...
               float var6 = var1.getX(var3);
               float var7 = Math.abs(var6 - this.mLastMotionX);
               float var8 = var1.getY(var3);
               var5 = Math.abs(var8 - this.mLastMotionY);
               if (var7 > (float)this.mTouchSlop && var7 > var5) {
                  this.mIsBeingDragged = true;
                  this.requestParentDisallowInterceptTouchEvent(true);
                  if (var6 - this.mInitialMotionX > 0.0F) {
                     var5 = this.mInitialMotionX + (float)this.mTouchSlop;
                  } else {
                     var5 = this.mInitialMotionX - (float)this.mTouchSlop;
                  }
      ...
      if (this.getChildCount() == 0) {
         ...
         if (var6 == 0 && var2 == 0) {
            ...
            if (var3 > 0) {
               ...
               var9 = (float)var1;
               var10 = this.mAdapter.getPageWidth(this.mCurItem);
               var1 = (int)((1.0F + (float)Math.abs(var6) / ((float)this.mPageMargin + var9 * var10)) * 100.0F);
            }
