   ...
   void dispatchOnFragmentSaveInstanceState(Fragment var1, Bundle var2, boolean var3) {
      ...
      if (this.mLifecycleCallbacks != null) {
         ...
         while(true) {
            ...
            ((FragmentManager.FragmentLifecycleCallbacks)var6.first).onFragmentSaveInstanceState(this, var1, var2);
         }
      }
   }
      ...
      if (this.mHost == null && var1 != 0) {
         ...
         if (var2 || var1 != this.mCurState) {
            ...
            if (this.mActive != null) {
               ...
               boolean var9;
               for(int var8 = 0; var8 < var4; var7 = var9) {
                  var6 = (Fragment)this.mActive.get(var8);
                  var9 = var7;
                  if (var6 != null) {
                     label78: {
                        if (!var6.mRemoving) {
                        ...
                        if (!var6.mIsNewlyAdded) {
                           ...
                           var9 = var7;
                           if (var6.mLoaderManager != null) {
                              var9 = var7 | var6.mLoaderManager.hasRunningLoaders();
                           }
                        }
                     }
                  }
      ...
      if (!"fragment".equals(var2)) {
         ...
         if (Fragment.isSupportFragmentClass(this.mHost.getContext(), var7)) {
            ...
            if (var12 == null) {
               var14 = var12;
               if (var9 != null) {
                  var14 = this.findFragmentByTag(var9);
               }
            }
            ...
            if (var14 == null) {
               var12 = var14;
               if (var10 != -1) {
                  var12 = this.findFragmentById(var10);
               }
            }

            if (DEBUG) {
               Log.v("FragmentManager", "onCreateView: id=0x" + Integer.toHexString(var8) + " fname=" + var7 + " existing=" + var12);
            }

            if (var12 == null) {
               var14 = Fragment.instantiate(var3, var7);
               ...
               var14.mFragmentId = var11;
               var14.mContainerId = var10;
               var14.mTag = var9;
         ...
         if (var3.mActive != null) {
            ...
            if (var3.mBackStack != null) {
               ...
               for(var6 = 0; var6 < var3.mBackStack.length; ++var6) {
                  BackStackRecord var12 = var3.mBackStack[var6].instantiate(this);
                  if (DEBUG) {
                     Log.v("FragmentManager", "restoreAllState: back stack #" + var6 + " (index " + var12.mIndex + "): " + var12);
                     PrintWriter var13 = new PrintWriter(new LogWriter("FragmentManager"));
                     var12.dump("  ", var13, false);
                     var13.close();
                  }
      ...
      if (this.mActive != null) {
         if (this.mActive.size() <= 0) {
            ...
            for(var6 = 0; var6 < var3; ++var6) {
               var7 = (Fragment)this.mActive.get(var6);
               if (var7 != null) {
                  if (var7.mIndex < 0) {
                     this.throwException(new IllegalStateException("Failure saving state: active " + var7 + " has cleared index: " + var7.mIndex));
                  }

                  boolean var8 = true;
                  FragmentState var10 = new FragmentState(var7);
                  var4[var6] = var10;
                  if (var7.mState > 0 && var10.mSavedFragmentState == null) {
                     var10.mSavedFragmentState = this.saveFragmentBasicState(var7);
                     if (var7.mTarget != null) {
                        if (var7.mTarget.mIndex < 0) {
                           this.throwException(new IllegalStateException("Failure saving state: " + var7 + " has target not in fragment manager: " + var7.mTarget));
                        }

                        if (var10.mSavedFragmentState == null) {
                           var10.mSavedFragmentState = new Bundle();
                        }

                        this.putFragment(var10.mSavedFragmentState, "android:target_state", var7.mTarget);
                        if (var7.mTargetRequestCode != 0) {
                           var10.mSavedFragmentState.putInt("android:target_req_state", var7.mTargetRequestCode);
                        }
                     }
                  } else {
                     var10.mSavedFragmentState = var7.mSavedFragmentState;
                  }

                  var5 = var8;
                  if (DEBUG) {
                     Log.v("FragmentManager", "Saved state of " + var7 + ": " + var10.mSavedFragmentState);
                     var5 = var8;
                  }
               }
            }
