   ...
   public void draw(Canvas var1) {
      ...
      if (this.mEdgeGlowTop != null) {
         ...
         if (!this.mEdgeGlowBottom.isFinished()) {
            ...
            var3 = this.getHeight();
            var1.translate((float)(-var5 + this.getPaddingLeft()), (float)(Math.max(this.getScrollRange(), var2) + var3));
            var1.rotate(180.0F, (float)var5, 0.0F);
            this.mEdgeGlowBottom.setSize(var5, var3);
         ...
         if (!super.performAccessibilityAction(var1, var2, var3)) {
            ...
            if (!var7.isEnabled()) {
               ...
               case 4096:
                  ...
                  var2 = Math.min(var7.getScrollY() + (var5 - var6 - var2), var7.getScrollRange());
               ...
               case 8192:
                  ...
                  var2 = Math.max(var7.getScrollY() - (var6 - var2 - var5), 0);
                  if (var2 != var7.getScrollY()) {
                     var7.smoothScrollTo(0, var2);
                  } else {
                     var4 = false;
