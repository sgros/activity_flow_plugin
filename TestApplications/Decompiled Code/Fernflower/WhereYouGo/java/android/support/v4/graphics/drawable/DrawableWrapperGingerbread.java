...
class DrawableWrapperGingerbread extends Drawable implements Callback, DrawableWrapper, TintAwareDrawable {
   ...
   private boolean updateTint(int[] var1) {
      ...
      if (this.isCompatTintEnabled()) {
         ...
         if (var3 != null && var4 != null) {
            ...
            if (!this.mColorFilterSet || var5 != this.mCurrentColor || var4 != this.mCurrentMode) {
               this.setColorFilter(var5, var4);
               this.mCurrentColor = var5;
   ...
   public Drawable mutate() {
      if (!this.mMutated && super.mutate() == this) {
         ...
         if (this.mState != null) {
            DrawableWrapperGingerbread.DrawableWrapperState var1 = this.mState;
            ConstantState var2;
            if (this.mDrawable != null) {
