...
public final class ColorUtils {
   ...
   public static int HSLToColor(@NonNull float[] var0) {
      ...
      case 2:
         ...
         var7 = Math.round(255.0F * (var2 + var3));
         var8 = Math.round(255.0F * (var4 + var3));
         break;
      case 3:
         var6 = Math.round(255.0F * var3);
         var7 = Math.round(255.0F * (var4 + var3));
         var8 = Math.round(255.0F * (var2 + var3));
         break;
      case 4:
         var6 = Math.round(255.0F * (var4 + var3));
      ...
      return Color.rgb(constrain(var6, 0, 255), constrain(var7, 0, 255), constrain(var8, 0, 255));
   }
   ...
   public static void RGBToHSL(@IntRange(from = 0L,to = 255L) int var0, @IntRange(from = 0L,to = 255L) int var1, @IntRange(from = 0L,to = 255L) int var2, @NonNull float[] var3) {
      ...
      if (var7 == var8) {
         ...
         if (var7 == var4) {
            var7 = (var5 - var6) / var9 % 6.0F;
         } else if (var7 == var5) {
            var7 = (var6 - var4) / var9 + 2.0F;
         } else {
            var7 = (var4 - var5) / var9 + 4.0F;
         }

         var6 = var9 / (1.0F - Math.abs(2.0F * var10 - 1.0F));
         var9 = var7;
         var7 = var6;
      }

      var6 = 60.0F * var9 % 360.0F;
      var9 = var6;
      if (var6 < 0.0F) {
         var9 = var6 + 360.0F;
      }
      ...
      var3[1] = constrain(var7, 0.0F, 1.0F);
   ...
   public static int XYZToColor(@FloatRange(from = 0.0D,to = 95.047D) double var0, @FloatRange(from = 0.0D,to = 100.0D) double var2, @FloatRange(from = 0.0D,to = 108.883D) double var4) {
      ...
      if (var6 > 0.0031308D) {
         var0 = 1.055D * Math.pow(var6, 0.4166666666666667D) - 0.055D;
      } else {
         var0 = var6 * 12.92D;
      }

      if (var8 > 0.0031308D) {
         var2 = 1.055D * Math.pow(var8, 0.4166666666666667D) - 0.055D;
      } else {
         var2 = var8 * 12.92D;
      }
      ...
      if (Color.alpha(var1) != 255) {
         ...
         if (calculateContrast(setAlphaComponent(var0, 255), var1) < (double)var2) {
            ...
            while(true) {
               ...
               var3 = (var5 + var6) / 2;
               if (calculateContrast(setAlphaComponent(var0, var3), var1) < (double)var2) {
                  var5 = var3;
               } else {
                  var6 = var3;
               }
