...
public class WherigoLib implements JavaFunction {
   ...
   private int dialog(LuaCallFrame var1, int var2) {
      LuaTable var3 = (LuaTable)var1.get(0);
      int var4 = var3.len();
      String[] var5 = new String[var4];
      Media[] var6 = new Media[var4];

      for(var2 = 1; var2 <= var4; ++var2) {
         LuaTable var7 = (LuaTable)var3.rawget(new Double((double)var2));
         var5[var2 - 1] = Engine.removeHtml((String)var7.rawget("Text"));
         var6[var2 - 1] = (Media)var7.rawget("Media");
      }

      Engine.dialog(var5, var6);
      return 0;
   }
   ...
   public static void register(LuaState var0) {
      if (env.get("DeviceID") == null) {
         ...
         LuaTableImpl var5 = new LuaTableImpl();
         Enumeration var6 = env.keys();

         while(var6.hasMoreElements()) {
            String var7 = (String)var6.nextElement();
            var5.rawset(var7, env.get(var7));
         }

         var5.rawset("Device", Engine.instance.gwcfile.device);
         var1.rawset("Env", var5);
         Cartridge.register();
         Container.register();
         Player.register();
         Timer.register();
