...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
   ...
   public Buffer clone() {
      ...
      if (this.size != 0L) {
         ...
         for(var2 = this.head.next; var2 != this.head; var2 = var2.next) {
            var1.head.prev.push(new Segment(var2));
         }
   ...
   public int readInt() {
      if (this.size < 4L) {
         ...
         if (var3 - var2 < 4) {
            ...
            byte var8 = var4[var6];
            var6 = var5 + 1;
            var2 = (var9 & 255) << 24 | (var7 & 255) << 16 | (var8 & 255) << 8 | var4[var5] & 255;
            this.size -= 4L;
            if (var6 == var3) {
               this.head = var1.pop();
               SegmentPool.recycle(var1);
   ...
   public long readLong() {
      if (this.size < 8L) {
         ...
         if (var3 - var2 < 8) {
            ...
            var2 = var14 + 1;
            long var17 = (long)var6[var14];
            var7 = var2 + 1;
            long var19 = (long)var6[var2];
            var2 = var7 + 1;
            var4 = (long)var6[var7];
            var7 = var2 + 1;
            var4 = (var8 & 255L) << 56 | (var10 & 255L) << 48 | (var12 & 255L) << 40 | (var15 & 255L) << 32 | (var17 & 255L) << 24 | (var19 & 255L) << 16 | (var4 & 255L) << 8 | (long)var6[var2] & 255L;
            this.size -= 8L;
            if (var7 == var3) {
               this.head = var1.pop();
               SegmentPool.recycle(var1);
   ...
   int selectPrefix(Options var1) {
      Segment var2 = this.head;
      ByteString[] var3 = var1.byteStrings;
      int var4 = 0;
      ...
      while(true) {
         ...
         ByteString var8 = var3[var4];
         int var6 = (int)Math.min(this.size, (long)var8.size());
         var7 = var4;
         if (var6 == 0) {
            break;
         }

         if (this.rangeEquals(var2, var2.pos, var8, 0, var6)) {
            var7 = var4;
            break;
         }
   ...
   public Buffer writeDecimalLong(long var1) {
      ...
      if (var1 == 0L) {
         ...
         Segment var9 = this.writableSegment(var8);
         byte[] var11 = var9.data;

         int var12;
         for(var12 = var9.limit + var8; var5 != 0L; var5 /= 10L) {
            int var10 = (int)(var5 % 10L);
            --var12;
            var11[var12] = (byte)DIGITS[var10];
         }

         if (var4) {
            var11[var12 - 1] = (byte)45;
         }
