...
public class GeocachingData extends Storable {
         ...
         label46: {
            ...
            while(true) {
               ...
               if (var5 == -1) {
                  String var11;
                  try {
                     var11 = Utils.doBytesToString(var4.toByteArray());
   ...
   public boolean setDescriptions(String var1, boolean var2, String var3, boolean var4) {
      ...
      try {
         ...
         GZIPOutputStream var9 = new GZIPOutputStream(var7);
         var9.write(Utils.doStringToBytes(var6));
         var9.write(Utils.doStringToBytes(var1));
         var9.close();
         this.mDescBytes = var7.toByteArray();
