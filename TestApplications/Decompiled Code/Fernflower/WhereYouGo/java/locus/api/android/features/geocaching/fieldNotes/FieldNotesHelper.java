...
public class FieldNotesHelper {
   ...
   private static void getImages(Context var0, LocusUtils.LocusVersion var1, FieldNote var2) throws RequiredVersionMissingException {
      ...
      label429: {
         Throwable var10000;
         label433: {
            ContentResolver var5;
            boolean var10001;
            try {
               var5 = var0.getContentResolver();
            ...
            String var50;
            try {
               var50 = Long.toString(var2.getId());
            ...
            try {
               var51 = var5.query(var3, new String[]{"_id"}, "field_note_id=?", new String[]{var50}, (String)null);
   ...
   private static boolean updateImage(Context var0, LocusUtils.LocusVersion var1, FieldNoteImage var2) throws RequiredVersionMissingException {
      boolean var3 = true;
      Uri var5 = getUriFieldNoteImagesTable(var1);
      ContentValues var4 = createContentValues(var2, false);
      if (var0.getContentResolver().update(var5, var4, "_id=?", new String[]{Long.toString(var2.getId())}) != 1) {
         var3 = false;
      }
