...
public class CameraPreview extends ViewGroup {
   ...
   protected Matrix calculateTextureTransform(Size var1, Size var2) {
      ...
      var7.setScale(var5, var3);
      float var6 = (float)var1.width;
      var4 = (float)var1.height;
      var7.postTranslate(((float)var1.width - var6 * var5) / 2.0F, ((float)var1.height - var4 * var3) / 2.0F);
      return var7;
   }
   ...
   protected void initializeAttributes(AttributeSet var1) {
      ...
      var2 = var4.getInteger(R.styleable.zxing_camera_preview_zxing_preview_scaling_strategy, -1);
      if (var2 == 1) {
