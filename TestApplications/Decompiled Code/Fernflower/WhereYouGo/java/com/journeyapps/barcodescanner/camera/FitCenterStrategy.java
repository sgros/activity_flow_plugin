...
public class FitCenterStrategy extends PreviewScalingStrategy {
   ...
   protected float getScore(Size var1, Size var2) {
      ...
      if (var1.width > 0 && var1.height > 0) {
         Size var4 = var1.scaleFit(var2);
         var3 = (float)var4.width * 1.0F / (float)var1.width;
         if (var3 > 1.0F) {
            var3 = (float)Math.pow((double)(1.0F / var3), 1.1D);
         }

         float var5 = (float)var2.width * 1.0F / (float)var4.width * ((float)var2.height * 1.0F / (float)var4.height);
         var3 *= 1.0F / var5 / var5 / var5;
      } else {
         var3 = 0.0F;
      }
