...
final class AlignmentPatternFinder {
   ...
   private AlignmentPattern handlePossibleCenter(int[] var1, int var2, int var3) {
      ...
      if (!Float.isNaN(var8)) {
         ...
         while(var11.hasNext()) {
            AlignmentPattern var10 = (AlignmentPattern)var11.next();
            if (var10.aboutEquals(var9, var8, var7)) {
               var12 = var10.combineEstimate(var8, var7, var9);
               return var12;
            }
         }

         var12 = new AlignmentPattern(var7, var8, var9);
         this.possibleCenters.add(var12);
