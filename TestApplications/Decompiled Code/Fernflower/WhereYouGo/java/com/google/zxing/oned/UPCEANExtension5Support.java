...
final class UPCEANExtension5Support {
   ...
   Result decodeRow(int var1, BitArray var2, int[] var3) throws NotFoundException {
      ...
      ResultPoint var9 = new ResultPoint((float)(var3[0] + var3[1]) / 2.0F, (float)var1);
      ResultPoint var6 = new ResultPoint((float)var5, (float)var1);
      BarcodeFormat var7 = BarcodeFormat.UPC_EAN_EXTENSION;
      Result var10 = new Result(var11, (byte[])null, new ResultPoint[]{var9, var6}, var7);
      if (var8 != null) {
