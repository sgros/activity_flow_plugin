...
public final class HighLevelEncoder {
   ...
   private static int findMinimums(float[] var0, int[] var1, int var2, byte[] var3) {
      ...
      int var5;
      for(var5 = var2; var4 < 6; var5 = var2) {
      ...
      if (var1 < var0.length()) {
         ...
         while(true) {
            if (var1 + var2 == var0.length()) {
               ...
               int[] var9 = new int[6];
               var2 = findMinimums(var3, var9, Integer.MAX_VALUE, var8);
               var1 = getMinimumCount(var8);
               if (var9[0] == var2) {
                  var2 = 0;
               } else if (var1 == 1 && var8[5] > 0) {
                  var2 = 5;
               } else if (var1 == 1 && var8[4] > 0) {
                  var2 = 4;
               } else if (var1 == 1 && var8[2] > 0) {
                  var2 = 2;
               } else if (var1 == 1 && var8[3] > 0) {
                  var2 = 3;
               } else {
                  var2 = 1;
               }
            ...
            if (var6 >= 4) {
               ...
               findMinimums(var3, var7, Integer.MAX_VALUE, var4);
               var2 = getMinimumCount(var4);
               if (var7[0] < var7[5] && var7[0] < var7[1] && var7[0] < var7[2] && var7[0] < var7[3] && var7[0] < var7[4]) {
                  var2 = 0;
                  break;
               }

               if (var7[5] < var7[0] || var4[1] + var4[2] + var4[3] + var4[4] == 0) {
                  var2 = 5;
                  break;
               }
