...
public final class RSSExpandedReader extends AbstractRSSReader {
   ...
   static {
      ...
      int[] var1 = new int[]{2, 6, 5, 1};
      FINDER_PATTERNS = new int[][]{{1, 8, 4, 1}, var0, {3, 4, 6, 1}, {3, 2, 8, 1}, var1, {2, 2, 9, 1}};
      var0 = new int[]{1, 3, 9, 27, 81, 32, 96, 77};
      var1 = new int[]{189, 145, 13, 39, 117, 140, 209, 205};
      int[] var2 = new int[]{16, 48, 144, 10, 30, 90, 59, 177};
      int[] var3 = new int[]{120, 149, 25, 75, 14, 42, 126, 167};
      int[] var4 = new int[]{161, 61, 183, 127, 170, 88, 53, 159};
      WEIGHTS = new int[][]{var0, {20, 60, 180, 118, 143, 7, 21, 63}, var1, {193, 157, 49, 147, 19, 57, 171, 91}, {62, 186, 136, 197, 169, 85, 44, 132}, {185, 133, 188, 142, 4, 12, 36, 108}, {113, 128, 173, 97, 80, 29, 87, 50}, {150, 28, 84, 41, 123, 158, 52, 156}, {46, 138, 203, 187, 139, 206, 196, 166}, {76, 17, 51, 153, 37, 111, 122, 155}, {43, 129, 176, 106, 107, 110, 119, 146}, var2, {109, 116, 137, 200, 178, 112, 125, 164}, {70, 210, 208, 202, 184, 130, 179, 115}, {134, 191, 151, 31, 93, 68, 204, 190}, {148, 22, 66, 198, 172, 94, 71, 2}, {6, 18, 54, 162, 64, 192, 154, 40}, var3, {79, 26, 78, 23, 69, 207, 199, 175}, {103, 98, 83, 38, 114, 131, 182, 124}, var4, {55, 165, 73, 8, 24, 72, 5, 15}, {45, 135, 194, 160, 58, 174, 100, 89}};
      var0 = new int[]{0, 4, 1, 3, 2};
      var1 = new int[]{0, 4, 1, 3, 3, 5};
      var2 = new int[]{0, 0, 1, 1, 2, 2, 3, 4, 4};
      var3 = new int[]{0, 0, 1, 1, 2, 2, 3, 4, 5, 5};
      FINDER_PATTERN_SEQUENCES = new int[][]{{0, 0}, {0, 1, 1}, {0, 2, 1, 3}, var0, var1, {0, 4, 1, 3, 4, 5, 5}, {0, 0, 1, 1, 2, 2, 3, 3}, var2, var3, {0, 0, 1, 1, 2, 3, 3, 4, 4, 5, 5}};
   }
   ...
   static Result constructResult(List var0) throws NotFoundException, FormatException {
      ...
      ResultPoint var4 = var3[0];
      ResultPoint var8 = var3[1];
      BarcodeFormat var5 = BarcodeFormat.RSS_EXPANDED;
      return new Result(var1, (byte[])null, new ResultPoint[]{var6, var7, var4, var8}, var5);
   }
   ...
   private static boolean isPartialRow(Iterable var0, Iterable var1) {
      ...
      while(true) {
         ...
         ExpandedRow var3 = (ExpandedRow)var2.next();
         boolean var4 = true;
         ...
         while(true) {
            ...
            ExpandedPair var6 = (ExpandedPair)var10.next();
            boolean var7 = false;
            Iterator var8 = var3.getPairs().iterator();
   ...
   private FinderPattern parseFoundFinderPattern(BitArray var1, int var2, boolean var3) {
      ...
      if (var3) {
         ...
         ++var4;
         var5 = this.startEnd[0] - var4;
         var6 = this.startEnd[1];
      } else {
         var4 = this.startEnd[0];
         var6 = var1.getNextUnset(this.startEnd[1] + 1);
         var5 = var6 - this.startEnd[1];
      }
      ...
      FinderPattern var9;
      try {
         var5 = parseFinderValue(var8, FINDER_PATTERNS);
      } catch (NotFoundException var7) {
         var9 = null;
         return var9;
      }

      var9 = new FinderPattern(var5, new int[]{var4, var6}, var4, var6, var2);
      return var9;
   }
   ...
   DataCharacter decodeDataCharacter(BitArray var1, FinderPattern var2, boolean var3, boolean var4) throws NotFoundException {
      ...
      if (Math.abs(var6 - var7) / var7 > 0.3F) {
         ...
         int[] var12 = this.getEvenCounts();
         float[] var13 = this.getOddRoundingErrors();
         float[] var17 = this.getEvenRoundingErrors();
         ...
         int var16;
         for(var15 = var12.length - 1; var15 >= 0; var10 = var16) {
            var16 = var10;
            if (isNotA1left(var2, var3, var4)) {
               var16 = WEIGHTS[var14][var15 * 2 + 1];
               var16 = var10 + var12[var15] * var16;
            }
         ...
         if ((var8 & 1) == 0 && var8 <= 13 && var8 >= 4) {
            var8 = (13 - var8) / 2;
            var16 = SYMBOL_WIDEST[var8];
            var15 = RSSUtils.getRSSvalue(var11, var16, true);
            var16 = RSSUtils.getRSSvalue(var12, 9 - var16, false);
            return new DataCharacter(var15 * EVEN_TOTAL_SUBSET[var8] + var16 + GSUM[var8], var9 + var10);
         } else {
            throw NotFoundException.getNotFoundInstance();
         }
      }
