...
public final class ReedSolomonDecoder {
   ...
   public void decode(int[] var1, int var2) throws ReedSolomonException {
      ...
      if (!var5) {
         GenericGFPoly var10 = new GenericGFPoly(this.field, var4);
         GenericGFPoly[] var8 = this.runEuclideanAlgorithm(this.field.buildMonomial(var2, 1), var10, var2);
         var10 = var8[0];
         var3 = var8[1];
         var4 = this.findErrorLocations(var10);
         int[] var9 = this.findErrorMagnitudes(var3, var4);
         ...
         for(var2 = 0; var2 < var4.length; ++var2) {
            ...
            var1[var6] = GenericGF.addOrSubtract(var1[var6], var9[var2]);
         }
      }
