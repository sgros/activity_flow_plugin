               ...
               label110: {
                  ...
                  while(true) {
                     ...
                     label112: {
                        boolean var10001;
                        try {
                           var24 = this.decodeRow(var9, var5, (Map)var11);
                        ...
                        ResultPoint[] var19;
                        try {
                           var24.putMetadata(ResultMetadataType.ORIENTATION, 180);
                           var19 = var24.getResultPoints();
                        ...
                        ResultPoint var13;
                        try {
                           var13 = new ResultPoint((float)var3 - var19[0].getX() - 1.0F, var19[0].getY());
                        ...
                        try {
                           var19[1] = new ResultPoint((float)var3 - var19[1].getX() - 1.0F, var19[1].getY());
                           break;
   ...
   protected static float patternMatchVariance(int[] var0, int[] var1, float var2) {
      ...
      if (var5 < var6) {
         ...
         for(var6 = 0; var6 < var4; ++var6) {
            var7 = var0[var6];
            float var11 = (float)var1[var6] * var9;
            if ((float)var7 > var11) {
               var11 = (float)var7 - var11;
            } else {
               var11 -= (float)var7;
            }
