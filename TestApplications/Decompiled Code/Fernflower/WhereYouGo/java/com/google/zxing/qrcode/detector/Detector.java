...
public class Detector {
   ...
   protected final AlignmentPattern findAlignmentInRegion(float var1, int var2, int var3, float var4) throws NotFoundException {
      ...
      var2 = Math.min(this.image.getWidth() - 1, var2 + var5);
      if ((float)(var2 - var6) < var1 * 3.0F) {
         throw NotFoundException.getNotFoundInstance();
      } else {
         int var7 = Math.max(0, var3 - var5);
         var3 = Math.min(this.image.getHeight() - 1, var3 + var5);
         if ((float)(var3 - var7) < var1 * 3.0F) {
            throw NotFoundException.getNotFoundInstance();
         } else {
            return (new AlignmentPatternFinder(this.image, var6, var7, var2 - var6, var3 - var7, var1, this.resultPointCallback)).find();
         }
      }
   }
      ...
      if (var5 < 1.0F) {
         ...
         if (var7.getAlignmentPatternCenters().length > 0) {
            ...
            while(true) {
               ...
               try {
                  var20 = this.findAlignmentInRegion(var5, var17, var18, var14);
                  break;
