            ...
            for(int var8 = 0; var8 < var7; ++var8) {
               ...
               if (var11 != null) {
                  ...
                  if (var9 >= 0 && var9 < var1.length) {
                     var1[var9][var3].setValue(var11.getValue());
                  }
               }
            }
         }
      ...
      for(var5 = var14; var5 <= var12; var6 = var17) {
         ...
         if (var8.getDetectionResultColumn(var15) == null) {
            ...
            while(true) {
               ...
               label66: {
                  label104: {
                     var16 = getStartColumn(var8, var15, var19, var13);
                     if (var16 >= 0) {
                        var17 = var16;
                        if (var16 <= var7.getMaxX()) {
                           break label104;
                        }
                     }
                  ...
                  Codeword var24 = detectCodeword(var0, var7.getMinX(), var7.getMaxX(), var13, var17, var19, var9, var6);
                  var20 = var26;
                  var21 = var9;
                  var16 = var6;
                  if (var24 != null) {
                     ...
                     var16 = Math.max(var6, var24.getWidth());
                     var20 = var17;
                  }
               }
      ...
      if (var8 == null) {
         ...
         if (!checkCodewordSkew(var2, var6, var7)) {
            ...
            if (var2 == -1) {
               ...
               var9 = new Codeword(var4, var1, getCodewordBucketNumber(var5), var2);
            }
         }
      }
