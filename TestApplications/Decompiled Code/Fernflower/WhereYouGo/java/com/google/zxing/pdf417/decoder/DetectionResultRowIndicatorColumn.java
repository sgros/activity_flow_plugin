...
final class DetectionResultRowIndicatorColumn extends DetectionResultColumn {
   ...
   private void adjustIncompleteIndicatorColumnRowNumbers(BarcodeMetadata var1) {
      ...
      Codeword[] var13 = this.getCodewords();
      int var6 = -1;
      int var7 = 1;
      ...
      for(int var8 = 0; var4 < var5; var7 = var11) {
         ...
         var11 = var7;
         if (var13[var4] != null) {
            Codeword var14 = var13[var4];
            var14.setRowNumberAsRowIndicatorColumn();
            var10 = var14.getRowNumber() - var6;
            if (var10 == 0) {
               var10 = var8 + 1;
               var11 = var7;
               var9 = var6;
               ...
               var10 = 1;
               var9 = var14.getRowNumber();
            } else if (var14.getRowNumber() >= var1.getRowCount()) {
               var13[var4] = null;
               var9 = var6;
               var10 = var8;
               var11 = var7;
