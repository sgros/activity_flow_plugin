...
final class DecodedBitStreamParser {
   ...
   static DecoderResult decode(int[] var0, String var1) throws FormatException {
      ...
      for(var6 = new PDF417ResultMetadata(); var4 < var0[0]; ++var4) {
         switch(var5) {
         case 900:
            var4 = textCompaction(var0, var4, var2);
            break;
         case 901:
         case 924:
            var4 = byteCompaction(var5, var0, var3, var4, var2);
            break;
         case 902:
            var4 = numericCompaction(var0, var4, var2);
            break;
         case 913:
         ...
         case 927:
            ...
            break;
         case 928:
            var4 = decodeMacroBlock(var0, var4, var6);
            break;
         default:
            var4 = textCompaction(var0, var4 - 1, var2);
         }
      ...
      if (var2.length() == 0) {
         ...
         DecoderResult var7 = new DecoderResult((byte[])null, var2.toString(), (List)null, var1);
         var7.setOther(var6);
         return var7;
      }
   }
