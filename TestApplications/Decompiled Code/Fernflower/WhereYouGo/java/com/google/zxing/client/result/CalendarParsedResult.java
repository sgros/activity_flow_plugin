...
public final class CalendarParsedResult extends ParsedResult {
   ...
   private static long parseDurationMS(CharSequence var0) {
      long var1 = -1L;
      if (var0 != null) {
         Matcher var7 = RFC2445_DURATION.matcher(var0);
         if (var7.matches()) {
            long var3 = 0L;
            int var5 = 0;
            ...
            while(true) {
               var1 = var3;
               if (var5 >= RFC2445_DURATION_FIELD_UNITS.length) {
                  break;
               }

               String var6 = var7.group(var5 + 1);
               var1 = var3;
               if (var6 != null) {
                  var1 = var3 + RFC2445_DURATION_FIELD_UNITS[var5] * (long)Integer.parseInt(var6);
               }
