...
public class FinderPatternFinder {
         ...
         if (var2 >= var6) {
            ...
            if (var1 >= var7 && var2 >= var7 && var5[1] <= var3) {
               ...
               if (var5[0] > var3) {
                  ...
                  for(var6 = 1; var1 + var6 < var9 && var2 + var6 < var10 && this.image.get(var2 + var6, var1 + var6); ++var6) {
                     var10002 = var5[2]++;
                  }
                  ...
                  if (var1 + var6 < var9) {
                     var7 = var6;
                     if (var2 + var6 < var10) {
                        while(var1 + var7 < var9 && var2 + var7 < var10 && !this.image.get(var2 + var7, var1 + var7) && var5[3] < var3) {
                           var10002 = var5[3]++;
                           ++var7;
                        }

                        if (var1 + var7 < var9 && var2 + var7 < var10 && var5[3] < var3) {
                           while(var1 + var7 < var9 && var2 + var7 < var10 && this.image.get(var2 + var7, var1 + var7) && var5[4] < var3) {
                              var10002 = var5[4]++;
                              ++var7;
                           }
      ...
      if (var8 < 0) {
         ...
         if (var9 >= 0 && var7[1] <= var3) {
            ...
            if (var7[0] > var3) {
               ...
               for(var9 = var1 + 1; var9 < var6 && var5.get(var9, var2); ++var9) {
                  var10002 = var7[2]++;
               }
               ...
               if (var9 == var6) {
                  ...
                  while(var1 < var6 && !var5.get(var1, var2) && var7[3] < var3) {
                     var10002 = var7[3]++;
                     ++var1;
                  }

                  if (var1 != var6 && var7[3] < var3) {
                     while(var1 < var6 && var5.get(var1, var2) && var7[4] < var3) {
                        var10002 = var7[4]++;
                        ++var1;
                     }
      ...
      if (var8 < 0) {
         ...
         if (var9 >= 0 && var7[1] <= var3) {
            ...
            if (var7[0] > var3) {
               ...
               for(var9 = var1 + 1; var9 < var6 && var5.get(var2, var9); ++var9) {
                  var10002 = var7[2]++;
               }
   ...
   final FinderPatternInfo find(Map var1) throws NotFoundException {
      ...
      boolean var11;
      for(int var8 = var6 - 1; var8 < var4 && !var7; var7 = var11) {
         var12[0] = 0;
         var12[1] = 0;
         var12[2] = 0;
         var12[3] = 0;
         ...
         int var10;
         for(var10 = var6; var14 < var5; var9 = var6) {
            int var10002;
            if (this.image.get(var14, var8)) {
               var6 = var9;
               if ((var9 & 1) == 1) {
                  var6 = var9 + 1;
               }
               ...
               if (var9 == 4) {
                  if (foundPatternCross(var12)) {
                     if (this.handlePossibleCenter(var12, var8, var14, var3)) {
                        byte var15 = 2;
                        if (this.hasSkipped) {
   ...
   protected final boolean handlePossibleCenter(int[] var1, int var2, int var3, boolean var4) {
      ...
      if (!Float.isNaN(var7)) {
         float var8 = this.crossCheckHorizontal((int)var6, (int)var7, var1[2], var5);
         if (!Float.isNaN(var8) && (!var4 || this.crossCheckDiagonal((int)var7, (int)var8, var1[2], var5))) {
            var6 = (float)var5 / 7.0F;
            boolean var11 = false;
            var3 = 0;
            ...
            while(true) {
               ...
               if (var9.aboutEquals(var6, var7, var8)) {
                  this.possibleCenters.set(var3, var9.combineEstimate(var7, var8, var6));
                  var10 = true;
                  break;
               }
            ...
            if (!var10) {
               var9 = new FinderPattern(var8, var7, var6);
