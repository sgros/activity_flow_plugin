...
public final class MultiDetector extends Detector {
   ...
   public DetectorResult[] detectMulti(Map var1) throws NotFoundException {
      ...
      FinderPatternInfo[] var10 = (new MultiFinderPatternFinder(var2, var3)).findMulti(var1);
      if (var10.length == 0) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            FinderPatternInfo var9 = var10[var5];

            try {
               var7.add(this.processFinderPatternInfo(var9));
         ...
         if (var7.isEmpty()) {
            ...
            var8 = (DetectorResult[])var7.toArray(new DetectorResult[var7.size()]);
         }
