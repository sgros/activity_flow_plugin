...
final class BoundingBox {
   ...
   BoundingBox addMissingRows(int var1, int var2, boolean var3) throws NotFoundException {
      ...
      if (var2 > 0) {
         if (var3) {
            var6 = this.bottomLeft;
         } else {
            var6 = this.bottomRight;
         }
         ...
         var6 = new ResultPoint(var6.getX(), (float)var1);
         if (var3) {
            var4 = var6;
            var6 = var7;
         } else {
      ...
      this.calculateMinMaxValues();
      return new BoundingBox(this.image, var8, var4, var9, var6);
   }
