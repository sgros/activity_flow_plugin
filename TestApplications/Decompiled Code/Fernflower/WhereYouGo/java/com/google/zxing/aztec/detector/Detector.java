...
public final class Detector {
   ...
   private static ResultPoint[] expandSquare(ResultPoint[] var0, float var1, float var2) {
      ...
      var4 = var0[1].getX() - var0[3].getX();
      var3 = var0[1].getY() - var0[3].getY();
      var2 = (var0[1].getX() + var0[3].getX()) / 2.0F;
      var5 = (var0[1].getY() + var0[3].getY()) / 2.0F;
      return new ResultPoint[]{var6, new ResultPoint(var1 * var4 + var2, var1 * var3 + var5), var7, new ResultPoint(var2 - var1 * var4, var5 - var1 * var3)};
   }
   ...
   private ResultPoint[] getBullsEyeCorners(Detector.Point var1) throws NotFoundException {
      ...
      if (this.nbCenterLayers != 5 && this.nbCenterLayers != 7) {
         ...
         float var11 = (float)(this.nbCenterLayers * 2 - 3);
         var10 = (float)(this.nbCenterLayers * 2);
         return expandSquare(new ResultPoint[]{var13, var14, var15, var12}, var11, var10);
      }
   }
   ...
   private Detector.Point getMatrixCenter() {
      ...
      try {
         ...
         return new Detector.Point(MathUtils.round((var2.getX() + var3.getX() + var1.getX() + var4.getX()) / 4.0F), MathUtils.round((var2.getY() + var3.getY() + var1.getY() + var4.getY()) / 4.0F));
      }
