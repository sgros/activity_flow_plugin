...
public class KnownPorts {
   ...
   public static String CompileConnectionInfo(int var0, TLType var1) {
      String var2;
      if (isTlsPort(var0)) {
         var2 = "Encrypted";
      } else if (isUnsecurePort(var0)) {
         var2 = "Unencrypted";
      } else if (isInconclusivePort(var0)) {
         var2 = "Inconclusive";
      } else {
         var2 = "Unknown";
      }
   ...
   public static boolean isInconclusivePort(int var0) {
      return Const.INCONCUSIVE_PORTS.contains(var0);
   }

   public static boolean isTlsPort(int var0) {
      return Const.TLS_PORTS.contains(var0);
   }

   public static boolean isUnsecurePort(int var0) {
      return Const.UNSECURE_PORTS.contains(var0);
   }

   public static String resolvePort(int var0) {
      return m.containsKey(var0) ? (String)m.get(var0) : "unknown";
   }
}
