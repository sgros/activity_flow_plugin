...
public class HistoryActivity extends BaseActivity {
   ...
   private void activateHistoryView() {
      ...
      this.expListView.setOnItemLongClickListener(new OnItemLongClickListener() {
         public boolean onItemLongClick(AdapterView var1, View var2, int var3, long var4) {
            ...
            String var8 = ((TextView)var2.findViewById(2131296361)).getText().toString();
            Intent var6 = new Intent(HistoryActivity.this, AppConnections_Chart.class);
            var6.putExtra("AppName", var7);
            var6.putExtra("AppSubName", var8);
            HistoryActivity.this.startActivity(var6);
            return false;
         }
      });
   }
   ...
   private List prepareData(ReportEntity var1) {
      ...
      try {
         ...
         var7.append("Could not find package info for ");
         var7.append(var4);
         var7.append(".");
   ...
   private HashMap provideHistoryReports() {
      ...
      List var14 = Collector.getAppsToIncludeInScan();
      if (!var14.isEmpty()) {
         ArrayList var15 = new ArrayList(new LinkedHashSet(var14));
         var15.removeAll(var1);
         if (!var15.isEmpty()) {
            ...
            while(var9.hasNext()) {
               ...
               try {
                  int var7 = this.getPackageManager().getApplicationInfo(var11, 0).uid;
                  if (!Collector.getKnownUIDs().containsKey(var7)) {
                     new String();
                     Collector.addKnownUIDs(String.valueOf(var7), var11);
                  }

                  HashMap var12 = this.historyReportMap;
                  new String();
                  ArrayList var13 = new ArrayList();
                  var12.put(String.valueOf(var7), var13);
      ...
      Iterator var16 = this.keys.iterator();
