...
public class SelectHistoryAppsActivity extends AppCompatActivity {
   ...
   private void sortAlphabetic_desc() {
      ...
      var1.putAll(this.sortMap);
      this.sortMap = var1;
      Iterator var2 = this.sortMap.entrySet().iterator();

      while(var2.hasNext()) {
         Entry var3 = (Entry)var2.next();
         this.app_list_name.add(((String)var3.getValue()).toString());
      }
   ...
   private void sortInstalledDate_desc() {
      ...
      while(var10.hasNext()) {
         Iterator var13 = ((List)var12.get((Long)var10.next())).iterator();

         while(var13.hasNext()) {
            String var9 = (String)var13.next();
            this.app_list_name.add(var9);
         }
      }
