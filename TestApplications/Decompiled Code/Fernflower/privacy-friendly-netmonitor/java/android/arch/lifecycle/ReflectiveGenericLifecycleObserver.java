...
class ReflectiveGenericLifecycleObserver implements GenericLifecycleObserver {
   ...
   private static ReflectiveGenericLifecycleObserver.CallbackInfo createInfo(Class var0) {
      ...
      for(var4 = 0; var4 < var8; ++var4) {
         Method var12 = var10[var4];
         OnLifecycleEvent var15 = (OnLifecycleEvent)var12.getAnnotation(OnLifecycleEvent.class);
         if (var15 != null) {
            Class[] var14 = var12.getParameterTypes();
            byte var13;
            if (var14.length > 0) {
            ...
            verifyAndPutHandler(var2, new ReflectiveGenericLifecycleObserver.MethodReference(var13, var12), var16, var0);
         }
      }
   ...
   private static void verifyAndPutHandler(Map var0, ReflectiveGenericLifecycleObserver.MethodReference var1, Lifecycle.Event var2, Class var3) {
      ...
      if (var4 != null && var2 != var4) {
         Method var6 = var1.mMethod;
         StringBuilder var5 = new StringBuilder();
         var5.append("Method ");
         var5.append(var6.getName());
         var5.append(" in ");
         var5.append(var3.getName());
         var5.append(" already declared with different @OnLifecycleEvent value: previous");
         var5.append(" value ");
         var5.append(var4);
