...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
   ...
   public void draw(Canvas var1) {
      ...
      if (this.mEdgeGlowTop != null) {
         ...
         if (!this.mEdgeGlowBottom.isFinished()) {
            ...
            var6 = this.getHeight();
            var1.translate((float)(-var3 + this.getPaddingLeft()), (float)(Math.max(this.getScrollRange(), var2) + var6));
            var1.rotate(180.0F, (float)var3, 0.0F);
            this.mEdgeGlowBottom.setSize(var3, var6);
   ...
   protected float getBottomFadingEdgeStrength() {
      if (this.getChildCount() == 0) {
         ...
         var3 = this.getChildAt(0).getBottom() - this.getScrollY() - (var2 - var3);
