...
class FragmentTransitionCompat21 {
   ...
   public static void replaceTargets(Object var0, ArrayList var1, ArrayList var2) {
      ...
      boolean var4 = var3 instanceof TransitionSet;
      int var5 = 0;
      int var6 = 0;
      if (var4) {
         TransitionSet var7 = (TransitionSet)var3;

         for(var5 = var7.getTransitionCount(); var6 < var5; ++var6) {
            replaceTargets(var7.getTransitionAt(var6), var1, var2);
         }
      } else if (!hasSimpleTarget(var3)) {
         List var8 = var3.getTargets();
         if (var8 != null && var8.size() == var1.size() && var8.containsAll(var1)) {
            if (var2 == null) {
               var6 = 0;
            } else {
               var6 = var2.size();
            ...
            while(var5 < var6) {
               var3.addTarget((View)var2.get(var5));
               ++var5;
            }

            for(var6 = var1.size() - 1; var6 >= 0; --var6) {
               var3.removeTarget((View)var1.get(var6));
            }
         }
      }
   ...
   public static void setSharedElementTargets(Object var0, View var1, ArrayList var2) {
      ...
      List var6 = var3.getTargets();
      var6.clear();
      int var4 = var2.size();

      for(int var5 = 0; var5 < var4; ++var5) {
         bfsAddViewChildren(var6, (View)var2.get(var5));
      }

      var6.add(var1);
      var2.add(var1);
      addTargets(var3, var2);
   }
