         ...
         if (!var1.equals(this.mCachedEnabledPackages)) {
            ...
            while(var4.hasNext()) {
               ...
               if (var1.contains(var5.serviceInfo.packageName)) {
                  ComponentName var7 = new ComponentName(var5.serviceInfo.packageName, var5.serviceInfo.name);
            ...
            StringBuilder var8;
            while(var6.hasNext()) {
               ComponentName var9 = (ComponentName)var6.next();
               if (!this.mRecordMap.containsKey(var9)) {
                  if (Log.isLoggable("NotifManCompat", 3)) {
                     var8 = new StringBuilder();
                     var8.append("Adding listener record for ");
                     var8.append(var9);
                     Log.d("NotifManCompat", var8.toString());
                  }
            ...
            while(var6.hasNext()) {
               ...
               if (!var3.contains(var10.getKey())) {
                  if (Log.isLoggable("NotifManCompat", 3)) {
                     var8 = new StringBuilder();
                     var8.append("Removing listener record for ");
                     var8.append(var10.getKey());
                     Log.d("NotifManCompat", var8.toString());
                  }

                  this.ensureServiceUnbound((NotificationManagerCompat.SideChannelManager.ListenerRecord)var10.getValue());
                  var6.remove();
               }
            }
