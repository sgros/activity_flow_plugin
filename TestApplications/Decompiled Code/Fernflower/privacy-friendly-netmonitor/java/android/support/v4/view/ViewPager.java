...
public class ViewPager extends ViewGroup {
   ...
   private boolean performDrag(float var1) {
      ...
      boolean var7 = false;
      boolean var8 = false;
      ViewPager.ItemInfo var9 = (ViewPager.ItemInfo)var5.get(0);
      ViewPager.ItemInfo var12 = (ViewPager.ItemInfo)this.mItems.get(this.mItems.size() - 1);
      boolean var10;
      if (var9.position != 0) {
         var1 = var9.offset * var4;
         var10 = false;
      } else {
         var10 = true;
      }
      ...
      ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
         ...
         public WindowInsetsCompat onApplyWindowInsets(View var1, WindowInsetsCompat var2) {
            ...
            if (var3.isConsumed()) {
               ...
               var6.left = var3.getSystemWindowInsetLeft();
               var6.top = var3.getSystemWindowInsetTop();
               var6.right = var3.getSystemWindowInsetRight();
               var6.bottom = var3.getSystemWindowInsetBottom();
               int var4 = 0;

               for(int var5 = ViewPager.this.getChildCount(); var4 < var5; ++var4) {
                  var2 = ViewCompat.dispatchApplyWindowInsets(ViewPager.this.getChildAt(var4), var3);
                  var6.left = Math.min(var2.getSystemWindowInsetLeft(), var6.left);
                  var6.top = Math.min(var2.getSystemWindowInsetTop(), var6.top);
                  var6.right = Math.min(var2.getSystemWindowInsetRight(), var6.right);
                  var6.bottom = Math.min(var2.getSystemWindowInsetBottom(), var6.bottom);
               }

               return var3.replaceSystemWindowInsets(var6.left, var6.top, var6.right, var6.bottom);
            }
         }
      });
   }
      ...
      while(true) {
         ...
         if (var10.getVisibility() != 8) {
            ...
            if (var11 != null) {
               ...
               var3 = var2;
               if (var11.isDecor) {
                  var4 = var11.gravity & 7;
                  var3 = var11.gravity & 112;
                  boolean var12;
                  if (var3 != 48 && var3 != 80) {
                     var12 = false;
                  } else {
                  ...
                  var10.measure(MeasureSpec.makeMeasureSpec(var13, var15), MeasureSpec.makeMeasureSpec(var4, var9));
                  if (var12) {
                     var3 = var2 - var10.getMeasuredHeight();
                     var4 = var1;
                  } else {
                     var4 = var1;
                     var3 = var2;
                     if (var14) {
                        var4 = var1 - var10.getMeasuredWidth();
                        var3 = var2;
                     }
                  }
               }
         ...
         if (var2 == 0 && var1.getEdgeFlags() != 0) {
            ...
            case 1:
               if (this.mIsBeingDragged) {
                  ...
                  var4 = (float)var9;
                  var6 /= var4;
                  this.setCurrentItemInternal(this.determineTargetPage(var12.position, ((float)var10 / var4 - var12.offset) / (var12.widthFactor + var6), var2, (int)(var1.getX(var1.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, var2);
