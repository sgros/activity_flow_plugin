...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
      ...
      for(; var2 < var3; ++var2) {
         ...
         if (var4 != null) {
            if (var4.getAnimatingAway() != null) {
               int var5 = var4.getStateAfterAnimating();
               View var7 = var4.getAnimatingAway();
               var4.setAnimatingAway((View)null);
               Animation var6 = var7.getAnimation();
               if (var6 != null) {
                  var6.cancel();
                  var7.clearAnimation();
               }

               this.moveToState(var4, var5, 0, 0, false);
   ...
   public boolean dispatchCreateOptionsMenu(Menu var1, MenuInflater var2) {
      ...
      int var6;
      byte var9;
      for(var6 = var4; var6 < this.mAdded.size(); var4 = var9) {
      ...
      if (this.mCreatedMenus != null) {
         for(var6 = var3; var6 < this.mCreatedMenus.size(); ++var6) {
            Fragment var10 = (Fragment)this.mCreatedMenus.get(var6);
   ...
   void dispatchOnFragmentActivityCreated(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         ...
         ((FragmentManager.FragmentLifecycleCallbacks)var6.first).onFragmentActivityCreated(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentPreCreated(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         ...
         ((FragmentManager.FragmentLifecycleCallbacks)var6.first).onFragmentPreCreated(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentViewDestroyed(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         ((FragmentManager.FragmentLifecycleCallbacks)var5.first).onFragmentViewDestroyed(this, var1);
      }
   }
   ...
   void moveToState(int var1, boolean var2) {
      if (this.mHost == null && var1 != 0) {
         ...
         if (this.mActive != null) {
            ...
            for(var6 = var1; var4 < var3; var6 = var1) {
               var5 = (Fragment)this.mActive.valueAt(var4);
               var1 = var6;
               if (var5 != null) {
                  label73: {
                     if (!var5.mRemoving) {
                     ...
                     if (!var5.mIsNewlyAdded) {
                        ...
                        var1 = var6;
                        if (var5.mLoaderManager != null) {
                           var1 = var6 | var5.mLoaderManager.hasRunningLoaders();
                        }
                     }
                  }
               }
