   ...
   private Drawable getThemeUpIndicator() {
      if (this.mActivityImpl != null) {
         ...
         if (VERSION.SDK_INT >= 18) {
            ...
            var2 = ((Context)var4).obtainStyledAttributes((AttributeSet)null, THEME_ATTRS, 16843470, 0);
            var1 = var2.getDrawable(0);
            var2.recycle();
            return var1;
         } else {
            var2 = this.mActivity.obtainStyledAttributes(THEME_ATTRS);
            var1 = var2.getDrawable(0);
            var2.recycle();
            return var1;
         }
