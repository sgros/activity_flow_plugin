   ...
   public BackStackState(BackStackRecord var1) {
      ...
      if (!var1.mAddToBackStack) {
         ...
         for(int var4 = 0; var3 < var2; ++var4) {
            ...
            var6 = this.mOps;
            var7 = var4 + 1;
            var6[var4] = var5.exitAnim;
            var6 = this.mOps;
            var4 = var7 + 1;
            var6[var7] = var5.popEnterAnim;
            this.mOps[var4] = var5.popExitAnim;
            ++var3;
         }
   ...
   public BackStackRecord instantiate(FragmentManagerImpl var1) {
      ...
      for(int var4 = 0; var3 < this.mOps.length; ++var3) {
         ...
         if (FragmentManagerImpl.DEBUG) {
            ...
            var9.append("Instantiate ");
            var9.append(var2);
            var9.append(" op #");
            var9.append(var4);
            var9.append(" base fragment #");
            var9.append(this.mOps[var7]);
         ...
         var6 = this.mOps;
         var3 = var8 + 1;
         var5.popEnterAnim = var6[var8];
         var5.popExitAnim = this.mOps[var3];
