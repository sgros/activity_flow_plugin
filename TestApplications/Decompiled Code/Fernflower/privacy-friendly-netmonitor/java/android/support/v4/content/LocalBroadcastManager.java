            ...
            if (var2 <= 0) {
               ...
               label289: {
                  ...
                  while(true) {
                     ...
                     LocalBroadcastManager.BroadcastRecord var27 = var28[var2];
                     int var4 = var27.receivers.size();

                     for(int var5 = 0; var5 < var4; ++var5) {
                        LocalBroadcastManager.ReceiverRecord var6 = (LocalBroadcastManager.ReceiverRecord)var27.receivers.get(var5);
                        if (!var6.dead) {
                           var6.receiver.onReceive(this.mAppContext, var27.intent);
                        }
                     }
