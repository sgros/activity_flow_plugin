...
public class ViewDragHelper {
   ...
   private boolean checkNewEdgeDrag(float var1, float var2, int var3, int var4) {
      ...
      boolean var6 = false;
      if ((var5 & var4) != var4 || (this.mTrackingEdges & var4) == 0 || (this.mEdgeDragsLocked[var3] & var4) == var4 || (this.mEdgeDragsInProgress[var3] & var4) == var4 || var1 <= (float)this.mTouchSlop && var2 <= (float)this.mTouchSlop) {
         return false;
      } else if (var1 < var2 * 0.5F && this.mCallback.onEdgeLock(var4)) {
   ...
   private int computeAxisDuration(int var1, int var2, int var3) {
      if (var1 == 0) {
         ...
         var2 = Math.abs(var2);
         if (var2 > 0) {
            var1 = 4 * Math.round(1000.0F * Math.abs((var7 + var6 * var7) / (float)var2));
         } else {
   ...
   private int computeSettleDuration(View var1, int var2, int var3, int var4, int var5) {
      ...
      return (int)((float)var2 * var14 + (float)var3 * var12);
   }
   ...
   public boolean checkTouchSlop(int var1, int var2) {
      ...
      if (!var3) {
         ...
         if (var7 && var10) {
            if (var8 * var8 + var9 * var9 > (float)(this.mTouchSlop * this.mTouchSlop)) {
               var6 = true;
            }
   ...
   public boolean continueSettling(boolean var1) {
      ...
      if (var2 == 2) {
         ...
         int var6 = var2 - this.mCapturedView.getLeft();
         int var7 = var5 - this.mCapturedView.getTop();
         if (var6 != 0) {
            ViewCompat.offsetLeftAndRight(this.mCapturedView, var6);
         }
         ...
         if (var6 != 0 || var7 != 0) {
            this.mCallback.onViewPositionChanged(this.mCapturedView, var2, var5, var6, var7);
         }
   ...
   public void processTouchEvent(MotionEvent var1) {
      ...
      case 0:
         var7 = var1.getX();
         var6 = var1.getY();
         var12 = var1.getPointerId(0);
         View var11 = this.findTopChildUnder((int)var7, (int)var6);
         this.saveInitialMotion(var7, var6, var12);
         this.tryCaptureViewForDrag(var11, var12);
         var5 = this.mInitialEdgesTouched[var12];
         if ((this.mTrackingEdges & var5) != 0) {
            this.mCallback.onEdgeTouched(var5 & this.mTrackingEdges, var12);
         }
         break;
      case 1:
         if (this.mDragState == 1) {
      ...
      case 2:
         if (this.mDragState == 1) {
            if (this.isValidPointerForActionMove(this.mActivePointerId)) {
               ...
               var6 = var1.getX(var5);
               var7 = var1.getY(var5);
               var5 = (int)(var6 - this.mLastMotionX[this.mActivePointerId]);
               var12 = (int)(var7 - this.mLastMotionY[this.mActivePointerId]);
               this.dragTo(this.mCapturedView.getLeft() + var5, this.mCapturedView.getTop() + var12, var5, var12);
            ...
            for(var5 = var4; var5 < var3; ++var5) {
               var12 = var1.getPointerId(var5);
               if (this.isValidPointerForActionMove(var12)) {
                  float var8 = var1.getX(var5);
                  var6 = var1.getY(var5);
                  var7 = var8 - this.mInitialMotionX[var12];
                  float var9 = var6 - this.mInitialMotionY[var12];
                  this.reportNewEdgeDrags(var7, var9, var12);
                  if (this.mDragState == 1) {
                     break;
                  }

                  View var10 = this.findTopChildUnder((int)var8, (int)var6);
                  if (this.checkTouchSlop(var10, var7, var9) && this.tryCaptureViewForDrag(var10, var12)) {
                     break;
                  }
               }
            }
      ...
      case 5:
         ...
         var6 = var1.getX(var3);
         var7 = var1.getY(var3);
         this.saveInitialMotion(var6, var7, var5);
         if (this.mDragState == 0) {
            this.tryCaptureViewForDrag(this.findTopChildUnder((int)var6, (int)var7), var5);
            var12 = this.mInitialEdgesTouched[var5];
            if ((this.mTrackingEdges & var12) != 0) {
               this.mCallback.onEdgeTouched(var12 & this.mTrackingEdges, var5);
            }
         } else if (this.isCapturedViewUnder((int)var6, (int)var7)) {
            this.tryCaptureViewForDrag(this.mCapturedView, var5);
         }
         break;
      case 6:
         var12 = var1.getPointerId(var3);
         if (this.mDragState == 1 && var12 == this.mActivePointerId) {
            ...
            while(true) {
               ...
               if (var2 != this.mActivePointerId) {
                  var6 = var1.getX(var5);
                  var7 = var1.getY(var5);
                  if (this.findTopChildUnder((int)var6, (int)var7) == this.mCapturedView && this.tryCaptureViewForDrag(this.mCapturedView, var2)) {
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         if ((this.mTrackingEdges & var3) != 0) {
            this.mCallback.onEdgeTouched(var3 & this.mTrackingEdges, var2);
         }
         break;
      case 1:
      case 3:
         ...
         if (this.mInitialMotionX != null && this.mInitialMotionY != null) {
            ...
            for(var2 = 0; var2 < var6; ++var2) {
               ...
               if (this.isValidPointerForActionMove(var7)) {
                  float var8 = var1.getX(var2);
                  var5 = var1.getY(var2);
                  var4 = var8 - this.mInitialMotionX[var7];
                  float var9 = var5 - this.mInitialMotionY[var7];
                  View var10 = this.findTopChildUnder((int)var8, (int)var5);
                  boolean var19;
                  if (var10 != null && this.checkTouchSlop(var10, var4, var9)) {
                     var19 = true;
                  } else {
                     var19 = false;
                  }
                  ...
                  if (var19) {
                     ...
                     int var12 = (int)var4;
                     int var13 = this.mCallback.clampViewPositionHorizontal(var10, var11 + var12, var12);
                     var12 = var10.getTop();
                     int var14 = (int)var9;
                     int var15 = this.mCallback.clampViewPositionVertical(var10, var12 + var14, var14);
                     var14 = this.mCallback.getViewHorizontalDragRange(var10);
                     int var16 = this.mCallback.getViewVerticalDragRange(var10);
                     if ((var14 == 0 || var14 > 0 && var13 == var11) && (var16 == 0 || var16 > 0 && var15 == var12)) {
                        break;
                     }
                  }

                  this.reportNewEdgeDrags(var4, var9, var7);
