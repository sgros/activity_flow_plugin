...
public final class LocaleListCompat {
      ...
      if (var0 != null && !var0.isEmpty()) {
         ...
         for(int var3 = 0; var3 < var2.length; ++var3) {
            ...
            if (VERSION.SDK_INT >= 21) {
               var4 = Locale.forLanguageTag(var1[var3]);
            } else {
               var4 = LocaleHelper.forLanguageTag(var1[var3]);
            }
   ...
   private void setLocaleList(LocaleList var1) {
      ...
      if (var2 > 0) {
         ...
         for(int var4 = 0; var4 < var2; ++var4) {
            var3[var4] = var1.get(var4);
         }

         IMPL.setLocaleList(var3);
      }
   ...
   static class LocaleListCompatApi24Impl implements LocaleListInterface {
      ...
      @Nullable
      public Locale getFirstMatch(String[] var1) {
         return this.mLocaleList != null ? this.mLocaleList.getFirstMatch(var1) : null;
      }
