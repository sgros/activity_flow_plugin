   ...
   public static Typeface getFontSync(final Context var0, final FontRequest var1, @Nullable final TextView var2, int var3, int var4, final int var5) {
      ...
      if (var7 != null) {
         ...
         if (var29 && var4 == -1) {
            ...
            if (var29) {
               try {
                  Typeface var25 = (Typeface)sBackgroundThread.postAndWait(var26, var4);
                  return var25;
               ...
               label223: {
                  ...
                  sBackgroundThread.postAndReply(var26, new SelfDestructiveThread.ReplyCallback() {
      ...
      var3.post(new Runnable(new Handler()) {
         ...
         public void run() {
            ...
            if (var1x.getStatusCode() != 0) {
               ...
               FontsContractCompat.FontInfo[] var2x = var1x.getFonts();
               if (var2x != null && var2x.length != 0) {
                  int var3 = var2x.length;

                  for(final int var4 = 0; var4 < var3; ++var4) {
                     FontsContractCompat.FontInfo var6 = var2x[var4];
                     if (var6.getResultCode() != 0) {
                        var4 = var6.getResultCode();
                        if (var4 < 0) {
                           this.val$callerThreadHandler.post(new Runnable() {
                              public void run() {
                                 var2.onTypefaceRequestFailed(-3);
                           ...
                           this.val$callerThreadHandler.post(new Runnable() {
                              public void run() {
                                 var2.onTypefaceRequestFailed(var4);
                              }
                           });
                        }
                  ...
                  final Typeface var7 = FontsContractCompat.buildTypeface(var0, (CancellationSignal)null, var2x);
                  if (var7 == null) {
                     this.val$callerThreadHandler.post(new Runnable() {
                        public void run() {
                           var2.onTypefaceRequestFailed(-3);
