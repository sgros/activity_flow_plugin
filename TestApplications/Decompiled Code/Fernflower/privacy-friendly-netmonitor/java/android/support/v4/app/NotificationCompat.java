...
public class NotificationCompat {
   ...
   public static class Action extends NotificationCompatBase.Action {
      ...
      public static final NotificationCompatBase.Action.Factory FACTORY = new NotificationCompatBase.Action.Factory() {
         public NotificationCompatBase.Action build(int var1, CharSequence var2, PendingIntent var3, Bundle var4, RemoteInputCompatBase.RemoteInput[] var5, RemoteInputCompatBase.RemoteInput[] var6, boolean var7) {
            return new NotificationCompat.Action(var1, var2, var3, var4, (RemoteInput[])var5, (RemoteInput[])var6, var7);
         }
      ...
      public static final class Builder {
         ...
         public NotificationCompat.Action build() {
            ...
            if (this.mRemoteInputs != null) {
               ...
               while(var3.hasNext()) {
                  RemoteInput var4 = (RemoteInput)var3.next();
                  if (var4.isDataOnly()) {
                     var1.add(var4);
                  } else {
                     var2.add(var4);
            ...
            if (!var2.isEmpty()) {
               var7 = (RemoteInput[])var2.toArray(new RemoteInput[var2.size()]);
            }

            return new NotificationCompat.Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, var7, var6, this.mAllowGeneratedReplies);
         }
   ...
   public static class Builder {
      ...
      public NotificationCompat.Builder setLights(@ColorInt int var1, int var2, int var3) {
         ...
         this.mNotification.flags = var4 | this.mNotification.flags & -2;
         return this;
      }
      ...
      public static class UnreadConversation extends NotificationCompatBase.UnreadConversation {
         ...
         public static class Builder {
            ...
            public NotificationCompat.CarExtender.UnreadConversation build() {
               ...
               return new NotificationCompat.CarExtender.UnreadConversation(var1, var3, var4, var5, new String[]{var2}, var6);
            }
   ...
   public static class DecoratedCustomViewStyle extends NotificationCompat.Style {
      ...
      private RemoteViews createRemoteViews(RemoteViews var1, boolean var2) {
         ...
         label26: {
            ...
            if (var2 && this.mBuilder.mActions != null) {
               ...
               if (var7 > 0) {
                  ...
                  while(true) {
                     ...
                     RemoteViews var9 = this.generateActionButton((NotificationCompat.Action)this.mBuilder.mActions.get(var8));
                     var6.addView(R.id.actions, var9);
                     ++var8;
                  }
               }
            }
         ...
         var6.setViewVisibility(R.id.actions, var11);
         var6.setViewVisibility(R.id.action_divider, var11);
   ...
   public static class MessagingStyle extends NotificationCompat.Style {
      ...
      public static NotificationCompat.MessagingStyle extractMessagingStyleFromNotification(Notification var0) {
         ...
         NotificationCompat.MessagingStyle var4 = null;
         if (var1 == null || var1.containsKey("android.selfDisplayName")) {
            NotificationCompat.MessagingStyle var2;
            try {
               var2 = new NotificationCompat.MessagingStyle();
               var2.restoreFromCompatExtras(var1);
      ...
      private CharSequence makeMessageLine(NotificationCompat.MessagingStyle.Message var1) {
         ...
         int var7 = var5;
         if (TextUtils.isEmpty(var1.getSender())) {
            Object var8;
            if (this.mUserDisplayName == null) {
               var8 = "";
            } else {
               var8 = this.mUserDisplayName;
            }
            ...
            if (var4) {
               ...
               if (this.mBuilder.getColor() != 0) {
                  var7 = this.mBuilder.getColor();
                  var6 = var8;
               }
            }
         }

         CharSequence var10 = var2.unicodeWrap((CharSequence)var6);
         var3.append(var10);
         var3.setSpan(this.makeFontColorSpan(var7), var3.length() - var10.length(), var3.length(), 33);
         Object var9;
         ...
         var3.append("  ").append(var2.unicodeWrap((CharSequence)var9));
         return var3;
      }
      ...
      public void apply(NotificationBuilderWithBuilderAccessor var1) {
         if (VERSION.SDK_INT >= 24) {
            ...
            while(var7.hasNext()) {
               NotificationCompat.MessagingStyle.Message var8 = (NotificationCompat.MessagingStyle.Message)var7.next();
               var2.add(var8.getText());
               var3.add(var8.getTimestamp());
               var4.add(var8.getSender());
               var5.add(var8.getDataMimeType());
               var6.add(var8.getDataUri());
            }

            NotificationCompatApi24.addMessagingStyle(var1, this.mUserDisplayName, this.mConversationTitle, var2, var3, var4, var5, var6);
         } else {
            NotificationCompat.MessagingStyle.Message var13 = this.findLatestIncomingMessage();
            if (this.mConversationTitle != null) {
               var1.getBuilder().setContentTitle(this.mConversationTitle);
            } else if (var13 != null) {
               var1.getBuilder().setContentTitle(var13.getSender());
            }

            CharSequence var14;
            if (var13 != null) {
               android.app.Notification.Builder var11 = var1.getBuilder();
               if (this.mConversationTitle != null) {
                  var14 = this.makeMessageLine(var13);
               } else {
                  var14 = var13.getText();
               }

               var11.setContentText(var14);
            }
            ...
            if (VERSION.SDK_INT >= 16) {
               ...
               for(int var10 = this.mMessages.size() - 1; var10 >= 0; --var10) {
                  var13 = (NotificationCompat.MessagingStyle.Message)this.mMessages.get(var10);
                  if (var9) {
                     var14 = this.makeMessageLine(var13);
                  } else {
                     var14 = var13.getText();
      ...
      public static final class Message {
         ...
         static NotificationCompat.MessagingStyle.Message getMessageFromBundle(Bundle var0) {
            try {
               if (var0.containsKey("text") && var0.containsKey("time")) {
         ...
         static List getMessagesFromBundleArray(Parcelable[] var0) {
            ...
            ArrayList var2;
            for(var2 = new ArrayList(var0.length); var1 < var0.length; ++var1) {
   ...
   static class NotificationCompatApi24Impl extends NotificationCompat.NotificationCompatApi21Impl {
      ...
      public NotificationCompat.Action[] getActionsFromParcelableArrayList(ArrayList var1) {
         return (NotificationCompat.Action[])NotificationCompatApi24.getActionsFromParcelableArrayList(var1, NotificationCompat.Action.FACTORY, RemoteInput.FACTORY);
      }
   ...
   static class NotificationCompatBaseImpl implements NotificationCompat.NotificationCompatImpl {
      ...
      public static class BuilderBase implements NotificationBuilderWithBuilderAccessor {
         ...
         BuilderBase(Context var1, Notification var2, CharSequence var3, CharSequence var4, CharSequence var5, RemoteViews var6, int var7, PendingIntent var8, PendingIntent var9, Bitmap var10, int var11, int var12, boolean var13) {
            ...
            var17 = var17.setOnlyAlertOnce(var16);
            if ((var2.flags & 16) != 0) {
               var16 = true;
            } else {
               var16 = false;
            ...
            var17 = var17.setAutoCancel(var16).setDefaults(var2.defaults).setContentTitle(var3).setContentText(var4).setContentInfo(var5).setContentIntent(var8).setDeleteIntent(var2.deleteIntent);
            if ((var2.flags & 128) != 0) {
               var16 = true;
            } else {
               var16 = var15;
            ...
            this.mBuilder = var17.setFullScreenIntent(var9, var16).setLargeIcon(var10).setNumber(var7).setProgress(var11, var12, var13);
         }
   ...
   public abstract static class Style {
      ...
      private Bitmap createColoredBitmap(int var1, int var2, int var3) {
         ...
         Bitmap var6 = Bitmap.createBitmap(var1, var5, Config.ARGB_8888);
         var4.setBounds(0, 0, var1, var5);
         if (var2 != 0) {
            var4.mutate().setColorFilter(new PorterDuffColorFilter(var2, Mode.SRC_IN));
         }

         var4.draw(new Canvas(var6));
         return var6;
      }
      ...
      public RemoteViews applyStandardTemplate(boolean var1, int var2, boolean var3) {
         ...
         if (this.mBuilder.mLargeIcon != null) {
            ...
            if (var1 && this.mBuilder.mNotification.icon != 0) {
               var8 = var4.getDimensionPixelSize(R.dimen.notification_right_icon_size);
               var2 = var4.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding);
               if (VERSION.SDK_INT >= 21) {
                  var9 = this.createIconWithBackground(this.mBuilder.mNotification.icon, var8, var8 - var2 * 2, this.mBuilder.getColor());
            ...
            if (VERSION.SDK_INT >= 21) {
               ...
               var2 = var4.getDimensionPixelSize(R.dimen.notification_big_circle_margin);
               var10 = var4.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large);
               var9 = this.createIconWithBackground(this.mBuilder.mNotification.icon, var8 - var2, var10, this.mBuilder.getColor());
