...
public class ActivityCompat extends ContextCompat {
      ...
      if (VERSION.SDK_INT >= 23) {
         ...
         (new Handler(Looper.getMainLooper())).post(new Runnable() {
            public void run() {
               String[] var1x = var1;
               int var2x = 0;
               int[] var6 = new int[var1x.length];
               PackageManager var3 = var0.getPackageManager();
               String var4 = var0.getPackageName();

               for(int var5 = var1.length; var2x < var5; ++var2x) {
                  var6[var2x] = var3.checkPermission(var1[var2x], var4);
               }

               ((ActivityCompat.OnRequestPermissionsResultCallback)var0).onRequestPermissionsResult(var2, var1, var6);
            }
         });
      }
   ...
   public static void setEnterSharedElementCallback(Activity var0, SharedElementCallback var1) {
      ...
      Object var3 = null;
      ActivityCompat.SharedElementCallback23Impl var4 = null;
      if (var2 >= 23) {
         if (var1 != null) {
            var4 = new ActivityCompat.SharedElementCallback23Impl(var1);
         }

         var0.setEnterSharedElementCallback(var4);
      } else if (VERSION.SDK_INT >= 21) {
         ActivityCompat.SharedElementCallback21Impl var5 = (ActivityCompat.SharedElementCallback21Impl)var3;
         if (var1 != null) {
   ...
   public static void setExitSharedElementCallback(Activity var0, SharedElementCallback var1) {
      ...
      if (var2 >= 23) {
         ...
         var0.setExitSharedElementCallback(var4);
      } else if (VERSION.SDK_INT >= 21) {
         ActivityCompat.SharedElementCallback21Impl var5 = (ActivityCompat.SharedElementCallback21Impl)var3;
         if (var1 != null) {
            var5 = new ActivityCompat.SharedElementCallback21Impl(var1);
