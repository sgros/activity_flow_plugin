...
public class ViewCompat {
   ...
   static class ViewCompatApi21Impl extends ViewCompat.ViewCompatApi19Impl {
      ...
      public void offsetLeftAndRight(View var1, int var2) {
         ...
         if (var4 instanceof View) {
            ...
            var6 = var3.intersects(var1.getLeft(), var1.getTop(), var1.getRight(), var1.getBottom()) ^ true;
         } else {
            var6 = false;
         }

         super.offsetLeftAndRight(var1, var2);
         if (var6 && var3.intersect(var1.getLeft(), var1.getTop(), var1.getRight(), var1.getBottom())) {
   ...
   static class ViewCompatBaseImpl {
      ...
      public ViewPropertyAnimatorCompat animate(View var1) {
         ...
         ViewPropertyAnimatorCompat var3 = var2;
         if (var2 == null) {
            var3 = new ViewPropertyAnimatorCompat(var1);
            this.mViewPropertyAnimatorCompatMap.put(var1, var3);
         }
      ...
      public int getMinimumHeight(View var1) {
         ...
         if (sMinHeightField != null) {
            try {
               int var2 = (Integer)sMinHeightField.get(var1);
               return var2;
      ...
      public int getMinimumWidth(View var1) {
         ...
         if (sMinWidthField != null) {
            try {
               int var2 = (Integer)sMinWidthField.get(var1);
               return var2;
            } catch (Exception var5) {
            }
         }
      ...
      public String getTransitionName(View var1) {
         return sTransitionNameMap == null ? null : (String)sTransitionNameMap.get(var1);
      }
      ...
      public boolean hasAccessibilityDelegate(View var1) {
         boolean var2 = sAccessibilityDelegateCheckFailed;
         boolean var3 = false;
         if (var2) {
            return false;
         } else {
