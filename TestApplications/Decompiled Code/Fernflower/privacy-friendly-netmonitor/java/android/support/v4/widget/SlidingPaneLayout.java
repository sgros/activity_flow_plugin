      ...
      for(var5 = 0; var5 < var9; ++var5) {
         ...
         if (var11.getVisibility() != 8) {
            ...
            label85: {
               ...
               if (var12.slideable) {
                  int var14 = var12.leftMargin;
                  var15 = var12.rightMargin;
                  var16 = var7 - var4;
                  var14 = Math.min(var2, var16 - this.mOverhangSize) - var3 - (var14 + var15);
                  this.mSlideRange = var14;
                  if (var6) {
                     var15 = var12.rightMargin;
                  } else {
                     var15 = var12.leftMargin;
                  }

                  if (var3 + var15 + var14 + var13 / 2 > var16) {
                     var1 = true;
                  } else {
                     var1 = false;
                  }
                  ...
                  var16 = (int)((float)var14 * this.mSlideOffset);
                  var3 += var15 + var16;
                  this.mSlideOffset = (float)var16 / (float)this.mSlideRange;
               } else {
                  if (this.mCanSlide && this.mParallaxBy != 0) {
                     var15 = (int)((1.0F - this.mSlideOffset) * (float)this.mParallaxBy);
                     var3 = var2;
                     break label85;
                  }
            ...
            var11.layout(var16, var8, var15, var11.getMeasuredHeight() + var8);
            var2 += var11.getWidth();
         }
      }
            ...
            if (var13.getVisibility() != 8) {
               ...
               if (var13.getVisibility() != 8) {
                  ...
                  if (var10 != 0 && var13 != this.mSlideableView) {
                     ...
                     if (var10 != 0) {
                        var16 = var8 - (var14.leftMargin + var14.rightMargin);
                        int var18 = MeasureSpec.makeMeasureSpec(var16, 1073741824);
                        if (var12 != var16) {
                           var13.measure(var18, var1);
                        }
                     } else {
      ...
      if (!this.mCanSlide) {
         ...
         case 1:
            if (this.isDimmed(this.mSlideableView)) {
               ...
               var4 = var2 - this.mInitialMotionX;
