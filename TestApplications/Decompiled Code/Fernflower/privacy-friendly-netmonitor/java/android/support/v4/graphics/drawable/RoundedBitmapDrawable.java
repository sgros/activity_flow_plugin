   ...
   void updateDstRect() {
      if (this.mApplyGravity) {
         if (this.mIsCircular) {
            ...
            var1 = Math.max(0, (this.mDstRect.width() - var2) / 2);
            int var3 = Math.max(0, (this.mDstRect.height() - var2) / 2);
            this.mDstRect.inset(var1, var3);
            this.mCornerRadius = 0.5F * (float)var2;
         } else {
