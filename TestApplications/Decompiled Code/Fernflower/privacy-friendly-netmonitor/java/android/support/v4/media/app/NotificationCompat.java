   ...
   public static class DecoratedMediaCustomViewStyle extends NotificationCompat.MediaStyle {
      ...
      public RemoteViews makeContentView(NotificationBuilderWithBuilderAccessor var1) {
         if (VERSION.SDK_INT >= 24) {
            ...
            if (VERSION.SDK_INT >= 21) {
               if (var3 || this.mBuilder.getBigContentView() != null) {
                  var2 = true;
               }
   ...
   public static class MediaStyle extends android.support.v4.app.NotificationCompat.Style {
      ...
      RemoteViews generateBigContentView() {
         ...
         if (var1 > 0) {
            for(int var3 = 0; var3 < var1; ++var3) {
               RemoteViews var4 = this.generateMediaActionButton((android.support.v4.app.NotificationCompat.Action)this.mBuilder.mActions.get(var3));
      ...
      RemoteViews generateContentView() {
         ...
         if (this.mActionsToShowInCompact == null) {
            ...
            var3 = Math.min(this.mActionsToShowInCompact.length, 3);
         }
         ...
         if (var3 > 0) {
            for(int var4 = 0; var4 < var3; ++var4) {
               if (var4 >= var2) {
                  throw new IllegalArgumentException(String.format("setShowActionsInCompactView: action %d out of bounds (max %d)", var4, var2 - 1));
               }

               RemoteViews var5 = this.generateMediaActionButton((android.support.v4.app.NotificationCompat.Action)this.mBuilder.mActions.get(this.mActionsToShowInCompact[var4]));
               var1.addView(R.id.media_actions, var5);
            }
         }
