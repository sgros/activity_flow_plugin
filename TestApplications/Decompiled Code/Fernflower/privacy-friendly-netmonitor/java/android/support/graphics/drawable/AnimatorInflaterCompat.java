      ...
      label2954: {
         ...
         label2955: {
            ...
            label2956: {
               ...
               NotFoundException var434;
               try {
                  var434 = new NotFoundException;
               ...
               StringBuilder var431;
               try {
                  var431 = new StringBuilder;
               ...
               try {
                  var431.append("Can't load animation resource ID #0x");
               ...
               try {
                  var431.append(Integer.toHexString(var3));
            ...
            NotFoundException var433;
            try {
               var433 = new NotFoundException;
            ...
            StringBuilder var435;
            try {
               var435 = new StringBuilder;
            ...
            try {
               var435.append("Can't load animation resource ID #0x");
            ...
            try {
               var435.append(Integer.toHexString(var3));
   ...
   private static void setupPathMotion(Path var0, ObjectAnimator var1, float var2, String var3, String var4) {
      ...
      while(true) {
         ...
         if (var14 >= var10) {
            ...
            if (var3 != null) {
               var18 = PropertyValuesHolder.ofFloat(var3, var17);
            } else {
               var18 = null;
            }
            ...
            if (var4 != null) {
               var19 = PropertyValuesHolder.ofFloat(var4, var11);
            }
         ...
         var9.getPosTan(var2, var12, (float[])null);
         var9.getPosTan(var2, var12, (float[])null);
         var17[var14] = var12[0];
         var11[var14] = var12[1];
         var7 = var2 + var8;
