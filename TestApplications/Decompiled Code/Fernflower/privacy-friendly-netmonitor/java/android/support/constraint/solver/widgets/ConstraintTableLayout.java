...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
   ...
   private void updateDebugSolverNames() {
      if (this.system != null) {
         ...
         for(var3 = 0; var3 < var1; ++var3) {
            var4 = (Guideline)this.mVerticalGuidelines.get(var3);
         ...
         for(var3 = var2; var3 < var1; ++var3) {
            var4 = (Guideline)this.mHorizontalGuidelines.get(var3);
            LinearSystem var8 = this.system;
            StringBuilder var7 = new StringBuilder();
            var7.append(this.getDebugName());
            var7.append(".HG");
            var7.append(var3);
            var4.setDebugSolverName(var8, var7.toString());
         }
            ...
            while(true) {
               ...
               if (var6 >= var4) {
                  ...
                  while(true) {
                     ...
                     if (var4 >= var9) {
                        while(var6 < var3) {
                           ((ConstraintWidget)this.mChildren.get(var6)).addToSolver(var1, var2);
                           ++var6;
                        }
                        break label40;
                     }

                     var8 = (Guideline)this.mHorizontalGuidelines.get(var4);
   ...
   public void setTableDimensions() {
      ...
      if (this.mVerticalGrowth) {
         ...
         var2 = var1 / this.mNumCols;
         var3 = var2;
         if (this.mNumCols * var2 < var1) {
            var3 = var2 + 1;
         }

         if (this.mNumRows == var3 && this.mVerticalGuidelines.size() == this.mNumCols - 1) {
            return;
         }
         ...
         var2 = var1 / this.mNumRows;
         var3 = var2;
         if (this.mNumRows * var2 < var1) {
            var3 = var2 + 1;
         }

         if (this.mNumCols == var3 && this.mHorizontalGuidelines.size() == this.mNumRows - 1) {
            return;
         }
