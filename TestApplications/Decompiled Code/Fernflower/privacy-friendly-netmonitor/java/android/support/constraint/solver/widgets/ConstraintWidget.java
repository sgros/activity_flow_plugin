...
public class ConstraintWidget {
   ...
   public void addToSolver(LinearSystem var1, int var2) {
      ...
      if (this.mParent != null) {
         ...
         if (this.mParent.getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && !var10) {
            if (this.mTop.mTarget != null && this.mTop.mTarget.mOwner == this.mParent) {
               ...
               var34 = var1.createObjectVariable(this.mParent.mTop);
               var33 = var1.createRow();
               var33.createRowGreaterThan(var7, var34, var1.createSlackVariable(), 0);
               var1.addConstraint(var33);
            }
            ...
            if (this.mBottom.mTarget != null && this.mBottom.mTarget.mOwner == this.mParent) {
               ...
               var34 = var1.createObjectVariable(this.mParent.mBottom);
               var33 = var1.createRow();
               var33.createRowGreaterThan(var34, var8, var1.createSlackVariable(), 0);
               var1.addConstraint(var33);
            }
         }
      ...
      label332: {
         label331: {
            var19 = this.mDimensionRatioSide;
            var20 = this.mDimensionRatio;
            if (this.mDimensionRatio > 0.0F && this.mVisibility != 8) {
               ...
               if (this.mHorizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                  var21 = (int)((float)this.mHeight * var20);
                  var16 = var15;
                  var9 = var10;
                  var10 = true;
                  var15 = 0;
      ...
      if (this.mHorizontalResolution != 2 && (var2 == Integer.MAX_VALUE || this.mLeft.mGroup == var2 && this.mRight.mGroup == var2)) {
         if (var18 && this.mLeft.mTarget != null && this.mRight.mTarget != null) {
            ...
            var25 = var1.createObjectVariable(this.mRight);
            var11 = var1.createObjectVariable(this.mLeft.getTarget());
            var34 = var1.createObjectVariable(this.mRight.getTarget());
            var1.addGreaterThan(var24, var11, this.mLeft.getMargin(), 3);
            var1.addLowerThan(var25, var34, this.mRight.getMargin() * -1, 3);
            if (!var13) {
               var1.addCentering(var24, var11, this.mLeft.getMargin(), this.mHorizontalBiasPercent, var34, var25, this.mRight.getMargin(), 4);
            }
         } else {
            this.applyConstraints(var1, var23, var10, this.mLeft, this.mRight, this.mX, this.mX + var21, var21, this.mMinWidth, this.mHorizontalBiasPercent, var18, var13, this.mMatchConstraintDefaultWidth, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth);
         }
      }
      ...
      if (this.mVerticalResolution != 2) {
         ...
         if (this.mBaselineDistance > 0) {
            ...
            if (var2 == Integer.MAX_VALUE || this.mTop.mGroup == var2 && var31.mGroup == var2) {
               if (var18 && this.mTop.mTarget != null && this.mBottom.mTarget != null) {
                  ...
                  var7 = var1.createObjectVariable(this.mTop.getTarget());
                  var34 = var1.createObjectVariable(this.mBottom.getTarget());
                  var1.addGreaterThan(var24, var7, this.mTop.getMargin(), 3);
                  var1.addLowerThan(var25, var34, -1 * this.mBottom.getMargin(), 3);
                  if (!var14) {
                     var1.addCentering(var24, var7, this.mTop.getMargin(), this.mVerticalBiasPercent, var34, var25, this.mBottom.getMargin(), 4);
                  }
               } else {
                  this.applyConstraints(var1, var10, var9, this.mTop, var31, this.mY, this.mY + var19, var19, this.mMinHeight, this.mVerticalBiasPercent, var18, var14, this.mMatchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight);
            ...
            label449: {
               ...
               if (var18 && this.mTop.mTarget != null && this.mBottom.mTarget != null) {
                  var25 = var1.createObjectVariable(this.mTop);
                  var4 = var1.createObjectVariable(this.mBottom);
                  var34 = var1.createObjectVariable(this.mTop.getTarget());
                  var24 = var1.createObjectVariable(this.mBottom.getTarget());
                  var1.addGreaterThan(var25, var34, this.mTop.getMargin(), 3);
                  var1.addLowerThan(var4, var24, -1 * this.mBottom.getMargin(), 3);
                  var5 = var7;
                  if (!var14) {
                     var1.addCentering(var25, var34, this.mTop.getMargin(), this.mVerticalBiasPercent, var24, var4, this.mBottom.getMargin(), 4);
                     var5 = var7;
                  }
               } else {
                  ConstraintAnchor var35 = this.mTop;
                  ConstraintAnchor var30 = this.mBottom;
                  int var26 = this.mY;
                  var19 = this.mY;
                  int var27 = this.mMinHeight;
                  var22 = this.mVerticalBiasPercent;
                  int var28 = this.mMatchConstraintDefaultHeight;
                  var21 = this.mMatchConstraintMinHeight;
                  int var29 = this.mMatchConstraintMaxHeight;
                  var5 = var7;
                  this.applyConstraints(var1, var10, var9, var35, var30, var26, var19 + var16, var16, var27, var22, var18, var14, var28, var21, var29);
               }
            }
         }
         ...
         if (var36) {
            ...
            if (var2 == Integer.MAX_VALUE || this.mLeft.mGroup == var2 && this.mRight.mGroup == var2) {
               if (var15 == 0) {
                  var1.addConstraint(var32.createRowDimensionRatio(var11, var3, var6, var5, var20));
               } else if (var15 == 1) {
                  var1.addConstraint(var32.createRowDimensionRatio(var6, var5, var11, var3, var20));
               } else {
                  ...
                  var32.createRowDimensionRatio(var11, var3, var6, var5, var20);
                  var6 = var1.createErrorVariable();
                  var5 = var1.createErrorVariable();
                  var6.strength = 4;
                  var5.strength = 4;
                  var32.addError(var6, var5);
   ...
   public void connect(ConstraintAnchor.Type var1, ConstraintWidget var2, ConstraintAnchor.Type var3, int var4, ConstraintAnchor.Strength var5, int var6) {
      ...
      if (var1 == var7) {
         if (var3 == ConstraintAnchor.Type.CENTER) {
            var14 = this.getAnchor(ConstraintAnchor.Type.LEFT);
            ...
            boolean var15 = true;
            boolean var13;
            if ((var14 == null || !var14.isConnected()) && (var10 == null || !var10.isConnected())) {
            ...
            if ((var12 == null || !var12.isConnected()) && (var9 == null || !var9.isConnected())) {
