   ...
   void applyToInternal(ConstraintLayout var1) {
      ...
      for(int var4 = 0; var4 < var2; ++var4) {
         ...
         if (this.mConstraints.containsKey(var6)) {
            ...
            var8 = (ConstraintLayout.LayoutParams)var5.getLayoutParams();
            var7.applyTo(var8);
      ...
      while(var10.hasNext()) {
         ...
         ConstraintSet.Constraint var9 = (ConstraintSet.Constraint)this.mConstraints.get(var12);
         if (var9.mIsGuideline) {
