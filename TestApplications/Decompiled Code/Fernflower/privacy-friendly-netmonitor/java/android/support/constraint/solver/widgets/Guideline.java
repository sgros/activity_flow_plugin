...
public class Guideline extends ConstraintWidget {
   ...
   public void addToSolver(LinearSystem var1, int var2) {
      ConstraintWidgetContainer var3 = (ConstraintWidgetContainer)this.getParent();
      if (var3 != null) {
         ConstraintAnchor var4 = var3.getAnchor(ConstraintAnchor.Type.LEFT);
         ConstraintAnchor var5 = var3.getAnchor(ConstraintAnchor.Type.RIGHT);
         if (this.mOrientation == 0) {
            var4 = var3.getAnchor(ConstraintAnchor.Type.TOP);
            var5 = var3.getAnchor(ConstraintAnchor.Type.BOTTOM);
         }

         if (this.mRelativeBegin != -1) {
            var1.addConstraint(LinearSystem.createRowEquals(var1, var1.createObjectVariable(this.mAnchor), var1.createObjectVariable(var4), this.mRelativeBegin, false));
         } else if (this.mRelativeEnd != -1) {
            var1.addConstraint(LinearSystem.createRowEquals(var1, var1.createObjectVariable(this.mAnchor), var1.createObjectVariable(var5), -this.mRelativeEnd, false));
   ...
   public Rectangle getHead() {
      ...
      if (this.getOrientation() == 0) {
         this.mHead.setBounds(this.getDrawX() - this.mHeadSize * 2, this.getDrawY() - this.mHeadSize, this.mHeadSize * 2, 2 * this.mHeadSize);
      }
