...
public class SolverVariable {
   ...
   void removeClientEquation(ArrayRow var1) {
      ...
      for(int var3 = 0; var3 < this.mClientEquationsCount; ++var3) {
         if (this.mClientEquations[var3] == var1) {
            while(var2 < this.mClientEquationsCount - var3 - 1) {
   ...
   String strengthsToString() {
      ...
      for(int var2 = 0; var2 < this.strengthVector.length; ++var2) {
         StringBuilder var3 = new StringBuilder();
         var3.append(var4);
         var3.append(this.strengthVector[var2]);
         var4 = var3.toString();
         if (var2 < this.strengthVector.length - 1) {
