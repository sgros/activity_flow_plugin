...
public class LinearSystem {
      ...
      if (var16) {
         ...
         while(true) {
            while(true) {
               ...
               ArrayRow var9;
               int var13;
               for(var2 = 0; var8 < this.mNumRows; var2 = var13) {
               ...
               if (var4 != -1) {
                  ...
                  var9.pivot(this.mCache.mIndexedVariables[var7]);
                  var9.variable.definitionId = var4;

                  for(var2 = 0; var2 < this.mNumRows; ++var2) {
                     this.mRows[var2].updateRowWithEquation(var9);
                  }
   ...
   void displaySystemInformations() {
      ...
      int var4;
      for(var3 = var1; var1 < this.mNumRows; var3 = var4) {
         var4 = var3;
         if (this.mRows[var1] != null) {
            var4 = var3 + this.mRows[var1].sizeInBytes();
         }
