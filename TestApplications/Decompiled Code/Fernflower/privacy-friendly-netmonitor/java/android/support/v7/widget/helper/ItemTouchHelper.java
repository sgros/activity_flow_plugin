...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
            ...
            if (var6 != null) {
               ...
               if (var3 != 6) {
                  ...
                  if (var2.getPointerId(var3) == ItemTouchHelper.this.mActivePointerId) {
                     ...
                     ItemTouchHelper.this.updateDxDy(var2, ItemTouchHelper.this.mSelectedFlags, var3);
                  }
               }
      ...
      for(var3 = 0; var3 < var12; ++var3) {
         ...
         if (var2 != var1.itemView && var2.getBottom() >= var5 && var2.getTop() <= var8 && var2.getRight() >= var4 && var2.getLeft() <= var7) {
            ...
            if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, var13)) {
               int var14 = Math.abs(var9 - (var2.getLeft() + var2.getRight()) / 2);
               var6 = Math.abs(var10 - (var2.getTop() + var2.getBottom()) / 2);
               int var15 = var14 * var14 + var6 * var6;
         ...
         if (this.mRecyclerView.getScrollState() == 1) {
            ...
            if (var4 == null) {
               ...
               if (var1 == 0) {
                  ...
                  var6 -= this.mInitialTouchY;
                  float var7 = Math.abs(var5);
                  float var8 = Math.abs(var6);
                  if (var7 < (float)this.mSlop && var8 < (float)this.mSlop) {
                     return false;
                  } else {
                     if (var7 > var8) {
   ...
   View findChildView(MotionEvent var1) {
      ...
      for(int var4 = this.mRecoverAnimations.size() - 1; var4 >= 0; --var4) {
         ...
         var6 = var5.mViewHolder.itemView;
         if (hitTest(var6, var2, var3, var5.mX, var5.mY)) {
            return var6;
         }
      }
         ...
         if (this.mSelected != null) {
            ...
            if (var4.itemView.getParent() != null) {
               ...
               if (var5 != 4 && var5 != 8 && var5 != 16 && var5 != 32) {
                  ...
                  case 1:
                  case 2:
                     var7 = Math.signum(this.mDy);
                     var8 = (float)this.mRecyclerView.getHeight();
                     var6 = 0.0F;
                     var7 *= var8;
                     break;
                  default:
               ...
               this.getSelectedDxDy(this.mTmpPosition);
               var8 = this.mTmpPosition[0];
               float var10 = this.mTmpPosition[1];
               ItemTouchHelper.RecoverAnimation var13 = new ItemTouchHelper.RecoverAnimation(var4, var14, var3, var8, var10, var6, var7) {
               ...
               var13.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, var14, var6 - var8, var7 - var10));
