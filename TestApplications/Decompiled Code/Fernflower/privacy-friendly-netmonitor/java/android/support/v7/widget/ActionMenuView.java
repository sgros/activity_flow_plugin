...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
   ...
   private void onMeasureExactFormat(int var1, int var2) {
      ...
      if (var10 == 0) {
         ...
         long var23;
         for(var2 = var5; var13 < var12; var17 = var20) {
         ...
         for(var33 = var37; var6 > 0 && var7 > 0; var33 = true) {
            ...
            long var26;
            for(var26 = 0L; var12 < var5; var26 = var23) {
               var22 = (ActionMenuView.LayoutParams)this.getChildAt(var12).getLayoutParams();
               int var28;
               if (!var22.expandable) {
                  var20 = var25;
                  var28 = var8;
                  var23 = var26;
               } else if (var22.cellsUsed < var8) {
                  var28 = var22.cellsUsed;
                  var23 = (long)(1 << var12);
                  var20 = 1;
               } else {
                  var20 = var25;
            ...
            for(var20 = 0; var20 < var5; var15 = var23) {
               var38 = this.getChildAt(var20);
               var36 = (ActionMenuView.LayoutParams)var38.getLayoutParams();
               long var29 = (long)(1 << var20);
               if ((var26 & var29) == 0L) {
                  var1 = var7;
                  var23 = var15;
                  if (var36.cellsUsed == var8 + 1) {
                     var23 = var15 | var29;
                     var1 = var7;
                  }
               } else {
                  if (var35 && var36.preventEdgeOffset && var7 == 1) {
                     var38.setPadding(this.mGeneratedItemPadding + var11, 0, this.mGeneratedItemPadding, 0);
                  }
         ...
         if (var7 > 0 && var15 != 0L && (var7 < var18 - 1 || var34 || var17 > 1)) {
            ...
            if (!var34) {
               ...
               if ((var15 & (long)(1 << var4)) != 0L) {
                  var31 = var32;
                  if (!((ActionMenuView.LayoutParams)this.getChildAt(var4).getLayoutParams()).preventEdgeOffset) {
                     var31 = var32 - 0.5F;
                  }
               }
            }
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      if (!this.mFormatItems) {
         ...
         if (var6 == 1 && var18 == 0) {
            ...
            var4 = var9 / 2 - var2 / 2;
            var5 = var7 - var3 / 2;
            var10.layout(var4, var5, var2 + var4, var3 + var5);
         } else {
            var3 = var4 - (var18 ^ 1);
            if (var3 > 0) {
               var2 /= var3;
               ...
               for(var2 = var16; var2 < var6; var4 = var3) {
                  ...
                  if (var10.getVisibility() != 8) {
                     if (var11.isOverflowButton) {
                        ...
                        var3 = var4 - var11.rightMargin;
                        var4 = var10.getMeasuredWidth();
                        var14 = var10.getMeasuredHeight();
                        var12 = var7 - var14 / 2;
                        var10.layout(var3 - var4, var12, var3, var14 + var12);
                        var3 -= var4 + var11.leftMargin + var5;
                     }
                  }
               ...
               for(var2 = var17; var2 < var6; var3 = var4) {
                  ...
                  if (var10.getVisibility() != 8) {
                     if (var11.isOverflowButton) {
                        ...
                        var4 = var3 + var11.leftMargin;
                        var3 = var10.getMeasuredWidth();
                        var12 = var10.getMeasuredHeight();
                        var14 = var7 - var12 / 2;
                        var10.layout(var4, var14, var4 + var3, var12 + var14);
                        var4 += var3 + var11.rightMargin + var5;
                     }
                  }
