...
public class DiffUtil {
   ...
   public static DiffUtil.DiffResult calculateDiff(DiffUtil.Callback var0, boolean var1) {
      ...
      var3 = Math.abs(var2 - var3) + var2 + var3;
      var2 = var3 * 2;
   ...
   private static DiffUtil.Snake diffPartial(DiffUtil.Callback var0, int var1, int var2, int var3, int var4, int[] var5, int[] var6, int var7) {
      ...
      if (var2 >= 1 && var4 >= 1) {
         int var8 = var2 - var4;
         int var9 = (var2 + var4 + 1) / 2;
         int var10 = var7 - var9 - 1;
         int var11 = var7 + var9 + 1;
         Arrays.fill(var5, var10, var11, 0);
         Arrays.fill(var6, var10 + var8, var11 + var8, var2);
         boolean var19;
         if (var8 % 2 != 0) {
            var19 = true;
         } else {
               ...
               label132: {
                  if (var14 != var13) {
                     label131: {
                        if (var14 != var12) {
                           var11 = var7 + var14;
                           if (var5[var11 - 1] < var5[var11 + 1]) {
                              break label131;
                           }
                        }

                        var11 = var5[var7 + var14 - 1] + 1;
                        var15 = true;
                        break label132;
                     }
                  }

                  var11 = var5[var7 + var14 + 1];
                  var15 = false;
               }

               for(var16 = var11 - var14; var11 < var2 && var16 < var4 && var0.areItemsTheSame(var1 + var11, var3 + var16); ++var16) {
                  ++var11;
               }

               var16 = var7 + var14;
               var5[var16] = var11;
               if (var19 && var14 >= var8 - var12 + 1 && var14 <= var8 + var12 - 1 && var5[var16] >= var6[var16]) {
               ...
               label103: {
                  label102: {
                     ...
                     if (var17 != var12 + var8) {
                        ...
                        var11 = var7 + var17;
                        if (var6[var11 - 1] >= var6[var11 + 1]) {
                           break label102;
                        }
                     }

                     var11 = var6[var7 + var17 - 1];
                     break label103;
                  }

                  var11 = var6[var7 + var17 + 1] - 1;
                  var15 = true;
               }

               for(var16 = var11 - var17; var11 > 0 && var16 > 0 && var0.areItemsTheSame(var1 + var11 - 1, var3 + var16 - 1); --var16) {
                  --var11;
               }
            ...
            for(; var4 >= 0; --var4) {
               ...
               if (var8 != 0) {
                  if (var8 != 4 && var8 != 8) {
                     ...
                     var12 = removePostponedUpdate(var1, var9, false);
                     var2.onMoved(var3 + var4, var12.currentPos - 1);
                     if (var8 == 4) {
                        var2.onChanged(var12.currentPos - 1, 1, this.mCallback.getChangePayload(var7, var9));
                     }
                  }
               } else {
