...
public class GridLayoutManager extends LinearLayoutManager {
   ...
   private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler var1, RecyclerView.State var2, LinearLayoutManager.AnchorInfo var3, int var4) {
      ...
      if (var9) {
         ...
         int var8;
         for(var4 = var3.mPosition; var4 < var6 - 1; var5 = var8) {
            int var7 = var4 + 1;
   ...
   void layoutChunk(RecyclerView.Recycler var1, RecyclerView.State var2, LinearLayoutManager.LayoutState var3, LinearLayoutManager.LayoutChunkResult var4) {
      ...
      if (var11 == 0) {
         ...
         float var17;
         View var19;
         for(var9 = 0; var10 < var11; var15 = var17) {
            ...
            var12 = this.mOrientationHelper.getDecoratedMeasurement(var19);
            var13 = var9;
            if (var12 > var9) {
               var13 = var12;
            }

            GridLayoutManager.LayoutParams var21 = (GridLayoutManager.LayoutParams)var19.getLayoutParams();
            float var16 = 1.0F * (float)this.mOrientationHelper.getDecoratedMeasurementInOther(var19) / (float)var21.mSpanSize;
            var17 = var15;
            if (var16 > var15) {
               var17 = var16;
            }
         ...
         for(var9 = 0; var9 < var11; ++var9) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(var14) != var10) {
               var20 = (GridLayoutManager.LayoutParams)var14.getLayoutParams();
               Rect var22 = var20.mDecorInsets;
               var7 = var22.top + var22.bottom + var20.topMargin + var20.bottomMargin;
               var24 = var22.left + var22.right + var20.leftMargin + var20.rightMargin;
               var13 = this.getSpaceForSpanRange(var20.mSpanIndex, var20.mSpanSize);
               if (this.mOrientation == 1) {
                  var24 = getChildMeasureSpec(var13, 1073741824, var24, var20.width, false);
                  var7 = MeasureSpec.makeMeasureSpec(var10 - var7, 1073741824);
               } else {
                  var24 = MeasureSpec.makeMeasureSpec(var10 - var24, 1073741824);
                  var7 = getChildMeasureSpec(var13, 1073741824, var7, var20.height, false);
               }
         ...
         while(var13 < var11) {
            View var23;
            label114: {
               var23 = this.mSet[var13];
               var20 = (GridLayoutManager.LayoutParams)var23.getLayoutParams();
               if (this.mOrientation == 1) {
                  if (this.isLayoutRTL()) {
                     var7 = this.getPaddingLeft() + this.mCachedBorders[this.mSpanCount - var20.mSpanIndex];
                     var12 = this.mOrientationHelper.getDecoratedMeasurementInOther(var23);
                     var24 = var7;
                     var7 -= var12;
                     break label114;
                  }

                  var24 = this.getPaddingLeft() + this.mCachedBorders[var20.mSpanIndex];
                  var7 = this.mOrientationHelper.getDecoratedMeasurementInOther(var23) + var24;
               } else {
                  var10 = this.getPaddingTop() + this.mCachedBorders[var20.mSpanIndex];
                  var9 = this.mOrientationHelper.getDecoratedMeasurementInOther(var23) + var10;
               }
            ...
            this.layoutDecoratedWithMargins(var23, var7, var10, var24, var9);
            if (var20.isItemRemoved() || var20.isItemChanged()) {
               var4.mIgnoreConsumed = true;
            }

            var4.mFocusable |= var23.hasFocusable();
            var12 = var13 + 1;
            var13 = var24;
            var24 = var7;
            var7 = var13;
               ...
               if (var26.hasFocusable() && var27 != var15) {
                  ...
                  if (var28) {
                     if (var26.hasFocusable()) {
                        ...
                        var18 = Math.min(var22, var9) - Math.max(var21, var8);
                        var6 = var26;
                     } else {
   ...
   public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler var1, RecyclerView.State var2, View var3, AccessibilityNodeInfoCompat var4) {
      ...
      if (!(var5 instanceof GridLayoutManager.LayoutParams)) {
         ...
         if (this.mOrientation == 0) {
            ...
            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(var6, 1, var8, var7, var9, false));
         }
   ...
   public void setMeasuredDimension(Rect var1, int var2, int var3) {
      ...
      if (this.mOrientation == 1) {
         ...
         var4 = chooseSize(var2, this.mCachedBorders[this.mCachedBorders.length - 1] + var4, this.getMinimumWidth());
         var2 = var3;
         var3 = var4;
      } else {
         var2 = chooseSize(var2, var1.width() + var4, this.getMinimumWidth());
         var4 = chooseSize(var3, this.mCachedBorders[this.mCachedBorders.length - 1] + var5, this.getMinimumHeight());
         var3 = var2;
         var2 = var4;
      }
   ...
   public abstract static class SpanSizeLookup {
      ...
      public int getSpanGroupIndex(int var1, int var2) {
         ...
         int var6;
         int var9;
         for(var6 = var4; var4 < var1; var6 = var9) {
