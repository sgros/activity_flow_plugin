...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
   ...
   public RecyclerView(Context var1, @Nullable AttributeSet var2, int var3) {
      ...
      if (var2 != null) {
         ...
         String var11 = var7.getString(R.styleable.RecyclerView_layoutManager);
         ...
         if (this.mEnableFastScroller) {
            this.initFastScroller((StateListDrawable)var7.getDrawable(R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), var7.getDrawable(R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable)var7.getDrawable(R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), var7.getDrawable(R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
         }

         var7.recycle();
         this.createLayoutManager(var1, var11, var2, var3, 0);
         var6 = var4;
         if (VERSION.SDK_INT >= 21) {
   ...
   private void findMinMaxChildLayoutPositions(int[] var1) {
      ...
      if (var2 == 0) {
         ...
         int var7;
         for(int var5 = 0; var5 < var2; var3 = var7) {
         ...
         if (var3 != 33) {
            if (var3 != 66) {
               if (var3 != 130) {
                  ...
                  var8.append("direction must be absolute. received:");
                  var8.append(var3);
                  var8.append(this.exceptionLabel());
   ...
   private void processAdapterUpdatesAndSetAnimationFlags() {
      ...
      var4 = this.mState;
      if (this.mState.mRunSimpleAnimations && var3 && !this.mDataSetHasChangedAfterLayout && this.predictiveItemAnimationsEnabled()) {
         var1 = var2;
      } else {
         var1 = false;
      }
   ...
   public long getChildItemId(View var1) {
      ...
      long var3 = -1L;
      if (var2 != null && this.mAdapter.hasStableIds()) {
   ...
   void offsetPositionRecordsForMove(int var1, int var2) {
      ...
      for(int var7 = 0; var7 < var3; ++var7) {
         ...
         if (var8 != null && var8.mPosition >= var6 && var8.mPosition <= var4) {
      ...
      if (this.mLayout == null) {
         ...
         if (var1.getAction() == 8) {
            ...
            if (var2 != 0.0F || var3 != 0.0F) {
               this.scrollByInternal((int)(var3 * this.mScaledHorizontalScrollFactor), (int)(var2 * this.mScaledVerticalScrollFactor), var1);
            }
         }
   ...
   protected void onMeasure(int var1, int var2) {
      if (this.mLayout == null) {
         ...
         boolean var3 = this.mLayout.mAutoMeasure;
         boolean var4 = false;
         if (var3) {
   ...
   boolean scrollByInternal(int var1, int var2, MotionEvent var3) {
      ...
      if (var4 != null) {
         ...
         this.fillRemainingScrollValues(this.mState);
         if (var1 != 0) {
            var6 = this.mLayout.scrollHorizontallyBy(var1, this.mRecycler, this.mState);
            var7 = var1 - var6;
         } else {
            var6 = 0;
            var7 = var6;
         ...
         int var9;
         if (var2 != 0) {
            var8 = this.mLayout.scrollVerticallyBy(var2, this.mRecycler, this.mState);
            var9 = var2 - var8;
         } else {
            var8 = 0;
            var9 = var8;
      ...
      if (this.dispatchNestedScroll(var10, var6, var7, var8, this.mScrollOffset, 0)) {
         ...
         var11[0] += this.mScrollOffset[0];
         var11 = this.mNestedOffsets;
      ...
      if (var10 != 0 || var6 != 0) {
         this.dispatchOnScrolled(var10, var6);
      }
   ...
   public abstract static class LayoutManager {
      ...
      public void ignoreView(View var1) {
         if (var1.getParent() == this.mRecyclerView && this.mRecyclerView.indexOfChild(var1) != -1) {
            ...
            var3.addFlags(128);
            this.mRecyclerView.mViewInfoStore.removeViewHolder(var3);
         } else {
            StringBuilder var2 = new StringBuilder();
            var2.append("View should be fully attached to be ignored");
            var2.append(this.mRecyclerView.exceptionLabel());
            throw new IllegalArgumentException(var2.toString());
         }
      }
      ...
      public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler var1, RecyclerView.State var2, View var3, AccessibilityNodeInfoCompat var4) {
         boolean var5 = this.canScrollVertically();
         int var6 = 0;
         int var7;
         if (var5) {
            var7 = this.getPosition(var3);
         } else {
            var7 = 0;
         }
         ...
         var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(var7, 1, var6, 1, false, false));
      }
      ...
      void setMeasuredDimensionFromChildren(int var1, int var2) {
         ...
         if (var3 == 0) {
            ...
            int var8;
            int var13;
            for(var8 = Integer.MAX_VALUE; var4 < var3; var7 = var13) {
            ...
            this.mRecyclerView.mTempRect.set(var5, var8, var6, var7);
                     ...
                     if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                        ...
                        if (var9 > 0) {
                           ...
                           if (!RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(var1.mPosition)) {
                              ...
                              while(var9 >= 0) {
                                 var7 = ((RecyclerView.ViewHolder)this.mCachedViews.get(var9)).mPosition;
      ...
      RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int var1, boolean var2, long var3) {
         ...
         if (var1 >= 0 && var1 < RecyclerView.this.mState.getItemCount()) {
            ...
            label144: {
               ...
               var6 = true;
               if (var5) {
                  var7 = this.getChangedScrapViewForPosition(var1);
                  var18 = var7;
                  if (var7 != null) {
                     var9 = true;
                     break label144;
            ...
            boolean var10 = var9;
            if (var7 == null) {
               var7 = this.getScrapOrHiddenOrCachedHolderForPosition(var1, var2);
               var18 = var7;
               var10 = var9;
               if (var7 != null) {
                  if (!this.validateViewHolderForOffsetPosition(var7)) {
                     if (!var2) {
                        var7.addFlags(4);
                        if (var7.isScrap()) {
                           RecyclerView.this.removeDetachedView(var7.itemView, false);
                           var7.unScrap();
                        } else if (var7.wasReturnedFromScrap()) {
                           var7.clearReturnedFromScrapFlag();
                        }

                        this.recycleViewHolderInternal(var7);
                     }
            ...
            label137: {
               RecyclerView.ViewHolder var11 = var18;
               boolean var12 = var10;
               if (var18 == null) {
                  int var21 = RecyclerView.this.mAdapterHelper.findPositionOffset(var1);
                  if (var21 < 0 || var21 >= RecyclerView.this.mAdapter.getItemCount()) {
                     var8 = new StringBuilder();
                     var8.append("Inconsistency detected. Invalid item position ");
                     var8.append(var1);
                     var8.append("(offset:");
                     var8.append(var21);
                     var8.append(").");
                     var8.append("state:");
                     var8.append(RecyclerView.this.mState.getItemCount());
                     var8.append(RecyclerView.this.exceptionLabel());
                     throw new IndexOutOfBoundsException(var8.toString());
                  }

                  int var13 = RecyclerView.this.mAdapter.getItemViewType(var21);
                  var7 = var18;
                  var9 = var10;
                  if (RecyclerView.this.mAdapter.hasStableIds()) {
                     var18 = this.getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(var21), var13, var2);
                     var7 = var18;
                     var9 = var10;
                     if (var18 != null) {
                        var18.mPosition = var21;
                        var9 = true;
                        var7 = var18;
                     }
                  }
                  ...
                  if (var7 == null) {
                     ...
                     if (this.mViewCacheExtension != null) {
                        View var19 = this.mViewCacheExtension.getViewForPositionAndType(this, var1, var13);
                        var18 = var7;
                        if (var19 != null) {
                           var7 = RecyclerView.this.getChildViewHolder(var19);
                           if (var7 == null) {
                              var8 = new StringBuilder();
                              var8.append("getViewForPositionAndType returned a view which does not have a ViewHolder");
                              var8.append(RecyclerView.this.exceptionLabel());
                              throw new IllegalArgumentException(var8.toString());
                           }
                           ...
                           if (var7.shouldIgnore()) {
                              var8 = new StringBuilder();
                              var8.append("getViewForPositionAndType returned a view that is ignored. You must call stopIgnoring before returning this view.");
                              var8.append(RecyclerView.this.exceptionLabel());
                              throw new IllegalArgumentException(var8.toString());
                           }
                        }
                  ...
                  var7 = var18;
                  if (var18 == null) {
                     var18 = this.getRecycledViewPool().getRecycledView(var13);
                     var7 = var18;
                     if (var18 != null) {
                        var18.resetInternal();
                        var7 = var18;
                  ...
                  if (var7 == null) {
                     ...
                     if (var3 != Long.MAX_VALUE && !this.mRecyclerPool.willCreateInTime(var13, var14, var3)) {
                        return null;
                     }

                     var7 = RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, var13);
                     if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                        RecyclerView var22 = RecyclerView.findNestedRecyclerView(var7.itemView);
                        if (var22 != null) {
                           var7.mNestedRecyclerView = new WeakReference(var22);
                        }
                     }

                     long var16 = RecyclerView.this.getNanoTime();
                     this.mRecyclerPool.factorInCreateTime(var13, var16 - var14);
                     break label137;
                  }
               }
            ...
            if (var9 && !RecyclerView.this.mState.isPreLayout() && var7.hasAnyOfTheFlags(8192)) {
               var7.setFlags(0, 8192);
               if (RecyclerView.this.mState.mRunSimpleAnimations) {
                  int var20 = RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(var7);
                  RecyclerView.ItemAnimator.ItemHolderInfo var23 = RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, var7, var20 | 4096, var7.getUnmodifiedPayloads());
                  RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(var7, var23);
               }
            }

            label155: {
               if (RecyclerView.this.mState.isPreLayout() && var7.isBound()) {
                  var7.mPreLayoutPosition = var1;
               } else if (!var7.isBound() || var7.needsUpdate() || var7.isInvalid()) {
                  var2 = this.tryBindViewHolderByDeadline(var7, RecyclerView.this.mAdapterHelper.findPositionOffset(var1), var1, var3);
                  break label155;
               }
            ...
            android.view.ViewGroup.LayoutParams var24 = var7.itemView.getLayoutParams();
            RecyclerView.LayoutParams var25;
            if (var24 == null) {
               var25 = (RecyclerView.LayoutParams)RecyclerView.this.generateDefaultLayoutParams();
               var7.itemView.setLayoutParams(var25);
            } else if (!RecyclerView.this.checkLayoutParams(var24)) {
               var25 = (RecyclerView.LayoutParams)RecyclerView.this.generateLayoutParams(var24);
               var7.itemView.setLayoutParams(var25);
            } else {
               var25 = (RecyclerView.LayoutParams)var24;
            }

            var25.mViewHolder = var7;
            if (var9 && var2) {
               var2 = var6;
            } else {
               var2 = false;
            ...
            var8 = new StringBuilder();
            var8.append("Invalid item position ");
            var8.append(var1);
            var8.append("(");
            var8.append(var1);
            var8.append("). Item count:");
            var8.append(RecyclerView.this.mState.getItemCount());
            var8.append(RecyclerView.this.exceptionLabel());
            throw new IndexOutOfBoundsException(var8.toString());
         }
   ...
   class ViewFlinger implements Runnable {
      ...
      private int computeScrollDuration(int var1, int var2, int var3, int var4) {
         ...
         if (var3 > 0) {
            var1 = 4 * Math.round(1000.0F * Math.abs((var8 + var10 * var8) / (float)var3));
         } else {
            if (var7) {
               var1 = var5;
            } else {
         ...
         if (RecyclerView.this.mLayout == null) {
            ...
            if (var1.computeScrollOffset()) {
               ...
               if (RecyclerView.this.mAdapter != null) {
                  ...
                  if (var8 != 0) {
                     var6 = RecyclerView.this.mLayout.scrollHorizontallyBy(var8, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                     var7 = var8 - var6;
                  } else {
                     var6 = 0;
                     var7 = var6;
                  ...
                  int var11;
                  if (var9 != 0) {
                     var10 = RecyclerView.this.mLayout.scrollVerticallyBy(var9, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                     var11 = var9 - var10;
                  } else {
                     var10 = 0;
                     var11 = var10;
                     ...
                     if (!var2.isPendingInitialRun()) {
                        ...
                        if (var2.isRunning()) {
                           ...
                           if (var12 == 0) {
                              ...
                              var2.onAnimation(var8 - var7, var9 - var11);
                              var12 = var6;
                              var13 = var7;
                              var14 = var10;
                              var15 = var11;
               ...
               if (!RecyclerView.this.dispatchNestedScroll(var12, var14, var13, var15, (int[])null, 1) && (var13 != 0 || var15 != 0)) {
                  label173: {
                  ...
                  if ((var7 != 0 || var13 == var4 || var1.getFinalX() == 0) && (var6 != 0 || var15 == var5 || var1.getFinalY() == 0)) {
                     var1.abortAnimation();
                  }
               }

               if (var12 != 0 || var14 != 0) {
                  RecyclerView.this.dispatchOnScrolled(var12, var14);
               }
               ...
               boolean var17;
               if (var9 != 0 && RecyclerView.this.mLayout.canScrollVertically() && var14 == var9) {
                  var17 = true;
               } else {
                  var17 = false;
               }
