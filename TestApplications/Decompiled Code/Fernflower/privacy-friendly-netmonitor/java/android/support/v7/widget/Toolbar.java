...
public class Toolbar extends ViewGroup {
   ...
   private int getChildTop(View var1, int var2) {
      ...
      if (var5 != 48) {
         if (var5 != 80) {
            ...
            var5 = (var7 - var6 - var2 - var4) / 2;
            if (var5 < var3.topMargin) {
               var2 = var3.topMargin;
            } else {
               var4 = var7 - var2 - var4 - var5 - var6;
               var2 = var5;
   ...
   private int layoutChildRight(View var1, int var2, int[] var3, int var4) {
      ...
      return var2 - (var6 + var5.leftMargin);
   }
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.shouldLayout(this.mCollapseButtonView)) {
         if (var6) {
            var2 = this.layoutChildRight(this.mCollapseButtonView, var4, var14, var5);
            var3 = var15;
         } else {
            var3 = this.layoutChildLeft(this.mCollapseButtonView, var15, var14, var5);
            var2 = var4;
         }
      }
      ...
      if (this.shouldLayout(this.mMenuView)) {
         if (var6) {
            var15 = this.layoutChildLeft(this.mMenuView, var3, var14, var5);
            var4 = var2;
         } else {
            var4 = this.layoutChildRight(this.mMenuView, var2, var14, var5);
            var15 = var3;
         }
      }
      ...
      label199: {
         if (!var16 && !var1) {
               ...
               if (var13 != 80) {
                  ...
                  if (var13 < var17.topMargin + this.mTitleMarginTop) {
                     ...
                     if (var12 < var17.bottomMargin + this.mTitleMarginBottom) {
                        var2 = Math.max(0, var13 - (var22.bottomMargin + this.mTitleMarginBottom - var12));
                     }
                  }
            ...
            if (var1) {
               ...
               this.mSubtitleTextView.layout(var3 - var13, var11, var3, var19 + var11);
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      if (this.shouldLayout(this.mMenuView)) {
         ...
         var8 = Math.max(var10, this.mMenuView.getMeasuredHeight() + this.getVerticalMargins(this.mMenuView));
      ...
      if (this.shouldLayout(this.mTitleTextView)) {
         ...
         var10 = this.getHorizontalMargins(this.mTitleTextView);
         int var13 = this.mTitleTextView.getMeasuredHeight();
         var8 = this.getVerticalMargins(this.mTitleTextView);
