...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
   ...
   public boolean flagActionItems() {
      ...
      int var12;
      int var25;
      for(var25 = var9; var25 < var4; var5 = var12) {
         MenuItemImpl var14 = (MenuItemImpl)var21.get(var25);
      ...
      var11 = var25 - var10;
      SparseBooleanArray var28 = var1.mActionButtonGroups;
      var28.clear();
      int var27;
      if (var1.mStrictWidthLimit) {
         var10 = var6 / var1.mMinCellSize;
         var5 = var1.mMinCellSize;
         var27 = var1.mMinCellSize;
         var12 = var6 % var5 / var10 + var27;
      } else {
         var10 = 0;
         var12 = var10;
      }
      ...
      for(byte var23 = var3; var15 < var6; var5 = var25) {
         ...
         if (var16.requiresActionButton()) {
            ...
            boolean var18 = var28.get(var22);
            boolean var19;
            if (var11 <= 0 && !var18 || var27 <= 0 || this.mStrictWidthLimit && var10 <= 0) {
               var19 = false;
            } else {
               var19 = true;
            }
            ...
            if (var19) {
               ...
               if (this.mStrictWidthLimit) {
                  var25 = ActionMenuView.measureChildForCells(var17, var12, var10, var7, 0);
                  var4 = var10 - var25;
                  var10 = var4;
                  if (var25 == 0) {
                     var19 = false;
            ...
            if (var19 && var22 != 0) {
               var28.put(var22, true);
               var5 = var11;
            } else {
               var5 = var11;
               if (var18) {
                  var28.put(var22, false);
                  var25 = 0;
                  ...
                  while(true) {
                     ...
                     MenuItemImpl var20 = (MenuItemImpl)var21.get(var25);
                     var5 = var11;
   ...
   private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
      ...
      protected boolean setFrame(int var1, int var2, int var3, int var4) {
         ...
         if (var6 != null && var7 != null) {
            ...
            var9 = (var8 + (var9 - var10)) / 2;
            var2 = (var2 + (var3 - var4)) / 2;
            DrawableCompat.setHotspotBounds(var7, var9 - var1, var2 - var1, var9 + var1, var2 + var1);
         }
