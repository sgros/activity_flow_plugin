...
public class ShareActionProvider extends ActionProvider {
   ...
   public void onPrepareSubMenu(SubMenu var1) {
      ...
      for(var6 = 0; var6 < var5; ++var6) {
         ResolveInfo var7 = var2.getActivity(var6);
      ...
      if (var5 < var4) {
         SubMenu var9 = var1.addSubMenu(0, var5, var5, this.mContext.getString(R.string.abc_activity_chooser_view_see_all));

         for(var6 = 0; var6 < var4; ++var6) {
            ResolveInfo var8 = var2.getActivity(var6);
            var9.add(0, var6, var6, var8.loadLabel(var3)).setIcon(var8.loadIcon(var3)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
         }
      }
