         ...
         label48: {
            label47: {
               ...
               if (var6 >= 0) {
                  ...
                  var6 = this.pointToPosition(var2, var7);
                  if (var6 == -1) {
                     var4 = true;
                     break label49;
                  }

                  View var8 = this.getChildAt(var6 - this.getFirstVisiblePosition());
                  this.setPressedItem(var8, var6, (float)var2, (float)var7);
                  if (var3 == 1) {
                     this.clickPressedItem(var8, var6);
                  }
                  break label48;
               }
            }
