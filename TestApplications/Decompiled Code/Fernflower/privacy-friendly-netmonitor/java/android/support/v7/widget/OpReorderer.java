...
class OpReorderer {
   ...
   void swapMoveUpdate(List var1, int var2, AdapterHelper.UpdateOp var3, int var4, AdapterHelper.UpdateOp var5) {
      ...
      if (var3.positionStart <= var5.positionStart) {
         ...
         var7 = var5.positionStart + var5.itemCount - var3.positionStart;
         var8 = this.mCallback.obtainUpdateOp(4, var3.positionStart + 1, var7, var5.payload);
         var5.itemCount -= var7;
      }
