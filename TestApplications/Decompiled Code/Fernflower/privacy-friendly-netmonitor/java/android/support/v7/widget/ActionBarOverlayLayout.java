...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      var8 = Math.max(var5, this.mContent.getMeasuredHeight() + var3.topMargin + var3.bottomMargin);
      ...
      var8 = Math.max(var8 + this.getPaddingTop() + this.getPaddingBottom(), this.getSuggestedMinimumHeight());
      this.setMeasuredDimension(View.resolveSizeAndState(Math.max(var9 + var11 + var5, this.getSuggestedMinimumWidth()), var1, var6), View.resolveSizeAndState(var8, var2, var6 << 16));
   }
