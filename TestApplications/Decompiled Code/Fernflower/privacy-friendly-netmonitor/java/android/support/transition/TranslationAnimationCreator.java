...
class TranslationAnimationCreator {
   static Animator createAnimation(View var0, TransitionValues var1, int var2, int var3, float var4, float var5, float var6, float var7, TimeInterpolator var8) {
      ...
      if (var11 != null) {
         var4 = (float)(var11[0] - var2) + var9;
         var5 = (float)(var11[1] - var3) + var10;
      }

      int var12 = Math.round(var4 - var9);
      int var13 = Math.round(var5 - var10);
      ...
      if (var4 == var6 && var5 == var7) {
         ...
         TranslationAnimationCreator.TransitionPositionListener var14 = new TranslationAnimationCreator.TransitionPositionListener(var0, var1.view, var2 + var12, var3 + var13, var9, var10);
