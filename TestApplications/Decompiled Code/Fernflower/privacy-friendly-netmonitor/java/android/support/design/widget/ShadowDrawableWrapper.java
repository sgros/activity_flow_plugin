...
class ShadowDrawableWrapper extends DrawableWrapper {
   ...
   private void buildShadowCorners() {
      ...
      int var9;
      if (var3 > 0.0F) {
         var4 = this.mCornerRadius / var3;
         float var5 = (1.0F - var4) / 2.0F;
         var6 = this.mCornerShadowPaint;
      ...
      var6 = this.mEdgeShadowPaint;
      var3 = var1.top;
      var4 = var2.top;
      var9 = this.mShadowStartColor;
      var7 = this.mShadowMiddleColor;
      var8 = this.mShadowEndColor;
      TileMode var11 = TileMode.CLAMP;
      var6.setShader(new LinearGradient(0.0F, var3, 0.0F, var4, new int[]{var9, var7, var8}, new float[]{0.0F, 0.5F, 1.0F}, var11));
      this.mEdgeShadowPaint.setAntiAlias(false);
   }
