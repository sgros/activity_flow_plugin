...
public class FloatingActionButton extends VisibilityAwareImageButton {
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      this.setMeasuredDimension(this.mShadowPadding.left + var1 + this.mShadowPadding.right, var1 + this.mShadowPadding.top + this.mShadowPadding.bottom);
   }
   ...
   public static class Behavior extends CoordinatorLayout.Behavior {
      ...
      private void offsetIfNeeded(CoordinatorLayout var1, FloatingActionButton var2) {
         ...
         if (var3 != null && var3.centerX() > 0 && var3.centerY() > 0) {
            ...
            if (var5 != 0) {
               ViewCompat.offsetLeftAndRight(var2, var5);
            }
         }
