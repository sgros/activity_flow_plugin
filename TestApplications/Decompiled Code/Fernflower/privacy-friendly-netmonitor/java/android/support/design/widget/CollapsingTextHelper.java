...
final class CollapsingTextHelper {
   ...
   private void calculateBaseOffsets() {
      ...
      if (var6 != 48) {
         if (var6 != 80) {
            float var7 = (this.mTextPaint.descent() - this.mTextPaint.ascent()) / 2.0F;
            var8 = this.mTextPaint.descent();
      ...
      if (var6 != 48) {
         if (var6 != 80) {
            ...
            var8 = this.mTextPaint.descent();
            this.mExpandedDrawY = (float)this.mExpandedBounds.centerY() + (var3 - var8);
         } else {
