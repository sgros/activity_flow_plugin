...
public class SwipeDismissBehavior extends CoordinatorLayout.Behavior {
   ...
   private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
      ...
      private boolean shouldDismiss(View var1, float var2) {
         ...
         if (var2 != 0.0F) {
            ...
            int var7 = this.mOriginalCapturedViewLeft;
            int var8 = Math.round((float)var1.getWidth() * SwipeDismissBehavior.this.mDragDismissThreshold);
            var5 = var4;
            if (Math.abs(var6 - var7) >= var8) {
               var5 = true;
            }
      ...
      public void onViewReleased(View var1, float var2, float var3) {
         ...
         } else if (var5 && SwipeDismissBehavior.this.mListener != null) {
      ...
      public boolean tryCaptureView(View var1, int var2) {
         boolean var3;
         if (this.mActivePointerId == -1 && SwipeDismissBehavior.this.canSwipeDismissView(var1)) {
            var3 = true;
         } else {
            var3 = false;
         }
   ...
   public int getDragState() {
      int var1;
      if (this.mViewDragHelper != null) {
         var1 = this.mViewDragHelper.getViewDragState();
      } else {
         var1 = 0;
      }
