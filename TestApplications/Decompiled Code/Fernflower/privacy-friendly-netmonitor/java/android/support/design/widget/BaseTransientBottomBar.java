...
public abstract class BaseTransientBottomBar {
   ...
   private void animateViewOut(final int var1) {
      if (VERSION.SDK_INT >= 12) {
         ...
         var2.setIntValues(new int[]{0, this.mView.getHeight()});
         ...
         Animation var3 = android.view.animation.AnimationUtils.loadAnimation(this.mView.getContext(), R.anim.design_snackbar_out);
   ...
   void animateViewIn() {
      if (VERSION.SDK_INT >= 12) {
         ...
         Animation var3 = android.view.animation.AnimationUtils.loadAnimation(this.mView.getContext(), R.anim.design_snackbar_in);
         var3.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
         var3.setDuration(250L);
         var3.setAnimationListener(new AnimationListener() {
   ...
   void onViewHidden(int var1) {
      ...
      if (this.mCallbacks != null) {
         for(int var2 = this.mCallbacks.size() - 1; var2 >= 0; --var2) {
      ...
      if (var3 instanceof ViewGroup) {
         ((ViewGroup)var3).removeView(this.mView);
      }
   ...
   void onViewShown() {
      ...
      if (this.mCallbacks != null) {
         for(int var1 = this.mCallbacks.size() - 1; var1 >= 0; --var1) {
   ...
   final void showView() {
      if (this.mView.getParent() == null) {
         ...
         if (var1 instanceof CoordinatorLayout.LayoutParams) {
            ...
            BaseTransientBottomBar.Behavior var3 = new BaseTransientBottomBar.Behavior();
            var3.setStartAlphaSwipeDistance(0.1F);
            var3.setEndAlphaSwipeDistance(0.6F);
            var3.setSwipeDirection(0);
            var3.setListener(new SwipeDismissBehavior.OnDismissListener() {
