...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
      ...
      for(int var7 = 0; var7 < var3; ++var7) {
         ...
         if (var1 != 0 || var8.getVisibility() != 8) {
            ...
            for(var10 = var7 + 1; var10 < var3; ++var10) {
               ...
               CoordinatorLayout.Behavior var13 = var16.getBehavior();
               if (var13 != null && var13.layoutDependsOn(this, var15, var8)) {
                  if (var1 == 0 && var16.getChangedAfterNestedScroll()) {
                     var16.resetChangedAfterNestedScroll();
                  } else {
                     boolean var14;
                     if (var1 != 2) {
                        var14 = var13.onDependentViewChanged(this, var15, var8);
                     } else {
                        var13.onDependentViewRemoved(this, var15, var8);
                        var14 = true;
                     }
      ...
      for(int var18 = 0; var18 < var16; ++var18) {
         ...
         if (var19.getVisibility() != 8) {
            ...
            if (var15 && !ViewCompat.getFitsSystemWindows(var19)) {
               var14 = this.mLastInsets.getSystemWindowInsetLeft();
               int var24 = this.mLastInsets.getSystemWindowInsetRight();
               var17 = this.mLastInsets.getSystemWindowInsetTop();
               int var25 = this.mLastInsets.getSystemWindowInsetBottom();
               var14 = MeasureSpec.makeMeasureSpec(var10 - (var14 + var24), var9);
               var17 = MeasureSpec.makeMeasureSpec(var12 - (var17 + var25), var11);
            } else {
               var14 = var1;
               var17 = var2;
            }
            ...
            if (var26 == null || !var26.onMeasureChild(this, var19, var14, var22, var17, 0)) {
               this.onMeasureChild(var19, var14, var22, var17, 0);
            }
            ...
            var17 = View.combineMeasuredStates(var21, var19.getMeasuredState());
         }
      }
   ...
   public void onNestedPreScroll(View var1, int var2, int var3, int[] var4, int var5) {
      ...
      int var8;
      byte var12;
      for(var12 = var7; var11 < var6; var10 = var8) {
         ...
         if (var13.getVisibility() == 8) {
            ...
            if (!var14.isNestedScrollAccepted(var5)) {
               ...
               if (var17 != null) {
                  ...
                  var15[0] = 0;
                  var17.onNestedPreScroll(this, var13, var1, var2, var3, this.mTempIntPair, var5);
                  if (var2 > 0) {
                     var8 = Math.max(var9, this.mTempIntPair[0]);
                  } else {
                     var8 = Math.min(var9, this.mTempIntPair[0]);
                  }
   ...
   protected void onRestoreInstanceState(Parcelable var1) {
      if (!(var1 instanceof CoordinatorLayout.SavedState)) {
         ...
         for(int var4 = this.getChildCount(); var3 < var4; ++var3) {
            ...
            int var6 = var5.getId();
            CoordinatorLayout.Behavior var7 = this.getResolvedLayoutParams(var5).getBehavior();
            if (var6 != -1 && var7 != null) {
               var1 = (Parcelable)var2.get(var6);
               if (var1 != null) {
                  var7.onRestoreInstanceState(this, var5, var1);
               }
            }
         }
