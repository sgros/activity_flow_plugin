   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.mCollapsingTitleEnabled && this.mDummyView != null) {
         ...
         if (this.mDrawCollapsingTitle) {
            ...
            var18.setCollapsedBounds(var12 + var8, var13 + var11 + var14, var15 + var9, this.mTmpRect.bottom + var11 - this.mToolbar.getTitleMarginBottom());
            var18 = this.mCollapsingTextHelper;
            if (var19) {
               var8 = this.mExpandedMarginEnd;
            } else {
               var8 = this.mExpandedMarginStart;
            }

            var9 = this.mTmpRect.top;
            var11 = this.mExpandedMarginTop;
            if (var19) {
            ...
            var18.setExpandedBounds(var8, var9 + var11, var4 - var2 - var10, var5 - var3 - this.mExpandedMarginBottom);
   ...
   private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
      ...
      public void onOffsetChanged(AppBarLayout var1, int var2) {
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            ...
            CollapsingToolbarLayout.LayoutParams var7 = (CollapsingToolbarLayout.LayoutParams)var6.getLayoutParams();
            ViewOffsetHelper var8 = CollapsingToolbarLayout.getViewOffsetHelper(var6);
            switch(var7.mCollapseMode) {
            case 1:
               var8.setTopAndBottomOffset(MathUtils.clamp(-var2, 0, CollapsingToolbarLayout.this.getMaxOffsetForPinChild(var6)));
               break;
            case 2:
               var8.setTopAndBottomOffset(Math.round((float)(-var2) * var7.mParallaxMult));
            }
         }
