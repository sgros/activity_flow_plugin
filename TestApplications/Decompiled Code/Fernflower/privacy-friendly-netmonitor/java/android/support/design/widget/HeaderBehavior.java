   ...
   public boolean onTouchEvent(CoordinatorLayout var1, View var2, MotionEvent var3) {
      ...
      case 1:
         if (this.mVelocityTracker != null) {
            ...
            float var7 = this.mVelocityTracker.getYVelocity(this.mActivePointerId);
      ...
      case 3:
         ...
         break;
      case 2:
         var4 = var3.findPointerIndex(this.mActivePointerId);
         if (var4 == -1) {
            return false;
         }

         int var5 = (int)var3.getY(var4);
         var6 = this.mLastMotionY - var5;
         var4 = var6;
