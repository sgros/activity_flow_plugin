...
public class BottomNavigationView extends FrameLayout {
   ...
   public BottomNavigationView(Context var1, AttributeSet var2, int var3) {
      ...
      this.mMenu.setCallback(new MenuBuilder.Callback() {
         public boolean onMenuItemSelected(MenuBuilder var1, MenuItem var2) {
            BottomNavigationView.OnNavigationItemReselectedListener var4 = BottomNavigationView.this.mReselectedListener;
            boolean var3 = true;
            if (var4 != null && var2.getItemId() == BottomNavigationView.this.getSelectedItemId()) {
               ...
               if (BottomNavigationView.this.mSelectedListener == null || BottomNavigationView.this.mSelectedListener.onNavigationItemSelected(var2)) {
                  var3 = false;
               }
   ...
   public void setSelectedItemId(@IdRes int var1) {
      ...
      if (var2 != null && !this.mMenu.performItemAction(var2, this.mPresenter, 0)) {
