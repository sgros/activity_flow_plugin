...
public final class Snackbar extends BaseTransientBottomBar {
   ...
   public static Snackbar make(@NonNull View var0, @NonNull CharSequence var1, int var2) {
      ViewGroup var3 = findSuitableParent(var0);
      if (var3 == null) {
         throw new IllegalArgumentException("No suitable parent found from the given view. Please provide a valid view.");
      } else {
         SnackbarContentLayout var4 = (SnackbarContentLayout)LayoutInflater.from(var3.getContext()).inflate(R.layout.design_layout_snackbar_include, var3, false);
         Snackbar var5 = new Snackbar(var3, var4, var4);
         var5.setText(var1);
      ...
      protected void onMeasure(int var1, int var2) {
         ...
         for(var1 = 0; var1 < var3; ++var1) {
            ...
            if (var6.getLayoutParams().width == -1) {
               var6.measure(MeasureSpec.makeMeasureSpec(var2 - var4 - var5, 1073741824), MeasureSpec.makeMeasureSpec(var6.getMeasuredHeight(), 1073741824));
            }
         }
