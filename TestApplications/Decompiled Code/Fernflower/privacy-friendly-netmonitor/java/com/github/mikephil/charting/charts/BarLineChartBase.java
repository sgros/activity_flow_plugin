...
public abstract class BarLineChartBase extends Chart implements BarLineScatterCandleBubbleDataProvider {
   ...
   public void calculateOffsets() {
      if (!this.mCustomViewPortEnabled) {
         ...
         var2 = var5 + this.getExtraLeftOffset();
         var5 = Utils.convertDpToPixel(this.mMinOffset);
         this.mViewPortHandler.restrainViewPort(Math.max(var5, var2), Math.max(var5, var1), Math.max(var5, var6), Math.max(var5, var3));
         if (this.mLogEnabled) {
   ...
   protected void onDraw(Canvas var1) {
      ...
      if (this.mData != null) {
         ...
         if (this.mLogEnabled) {
            ...
            this.totalTime += var5;
            ++this.drawCycles;
            var2 = this.totalTime / this.drawCycles;
