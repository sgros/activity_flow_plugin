...
public class PieChartRenderer extends DataRenderer {
   ...
   protected float calculateMinimumRadiusForSpacedSlice(MPPointF var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      float var12 = var1.y + (float)Math.sin(var10) * var2;
      var7 = var1.x;
      var10 = (double)((var6 + var8) * 0.017453292F);
      var8 = (float)Math.cos(var10);
      var6 = var1.y;
      float var13 = (float)Math.sin(var10);
      return (float)((double)(var2 - (float)(Math.sqrt(Math.pow((double)(var9 - var4), 2.0D) + Math.pow((double)(var12 - var5), 2.0D)) / 2.0D * Math.tan(0.017453292519943295D * ((180.0D - (double)var3) / 2.0D)))) - Math.sqrt(Math.pow((double)(var7 + var8 * var2 - (var9 + var4) / 2.0F), 2.0D) + Math.pow((double)(var6 + var13 * var2 - (var12 + var5) / 2.0F), 2.0D)));
   }
         ...
         if (Math.abs(var2.getEntryForIndex(var35).getY()) > Utils.FLOAT_EPSILON && !var3.mChart.needsHighlight(var35)) {
            ...
            if (!var14 || var15 <= 0.0F && !var34) {
               ...
               if (var23 % 360.0F > Utils.FLOAT_EPSILON) {
                  if (var34) {
                     var25 = var23 / 2.0F;
                     var29 = var3.calculateMinimumRadiusForSpacedSlice(var30, var11, var22 * var7, var28, var29, var24, var23);
                     var23 = var30.x;
                     var26 = (double)((var24 + var25) * 0.017453292F);
                     var25 = (float)Math.cos(var26);
                     var24 = var30.y;
                     var28 = (float)Math.sin(var26);
                     var3.mPathBuffer.lineTo(var23 + var25 * var29, var24 + var29 * var28);
                     var33 = var3;
                     var31 = var30;
                     var36 = var37;
                  } else {
               ...
               var28 = var23 / 2.0F;
               var29 = (var22 - var23) * var7;
               var23 = var29;
               if (var29 < 0.0F) {
                  var23 = 0.0F;
               }

               var29 = (var21 + var28) * var7 + var5 + var23;
               if (var24 >= 360.0F && var24 % 360.0F <= Utils.FLOAT_EPSILON) {
                  ...
                  var24 = var31.x;
                  var26 = (double)(var29 * 0.017453292F);
                  var32.lineTo(var24 + (float)Math.cos(var26) * var25, var31.y + var25 * (float)Math.sin(var26));
                  this.mPathBuffer.arcTo(this.mInnerRectBuffer, var29, -var23);
               }
            ...
            if (var14 != null && var14.isHighlightEnabled()) {
               ...
               if (var9 && (var11 > 0.0F || var33)) {
                  ...
                  if (var33) {
                     ...
                     var28 = (float)Math.cos(var29);
                     var25 = var7.y;
                     var21 = (float)Math.sin(var29);
                     this.mPathBuffer.lineTo(var20 + var28 * var23, var25 + var23 * var21);
                  } else {
   ...
   public void drawValues(Canvas var1) {
      ...
      float[] var49;
      for(var10 = var4; var18 < var13.size(); var5 = var49) {
         ...
         if (!var20 && !var15) {
            ...
            for(var18 = var29; var18 < var26; var6 = var6) {
               PieEntry var55 = (PieEntry)var53.getEntryForIndex(var18);
               if (var17 == 0) {
                  var4 = 0.0F;
               } else {
                  var4 = var6[var17 - 1] * var7;
               }

               float var31 = var10 + (var4 + (var56[var17] - var27 / (0.017453292F * var11) / 2.0F) / 2.0F) * var8;
               float var32;
               ...
               if (var37 || var38) {
                  ...
                  var40 = var50.x + var44 * var35;
                  var44 = var44 * var36 + var50.y;
                  ...
                  if (var53.getValueLineColor() != 1122867) {
                     var1.drawLine(var41 * var35 + var43, var41 * var36 + var42, var40, var44, this.mValueLinePaint);
               ...
               MPPointF var45 = var50;
               if (var60 || var39) {
                  var4 = var11 * var35 + var50.x;
                  var41 = var11 * var36 + var50.y;
                  this.mValuePaint.setTextAlign(Align.CENTER);
                  if (var60 && var39) {
                     this.drawValue(var1, var25, var32, var55, 0, var4, var41, var53.getValueTextColor(var18));
                     if (var18 < var12.getEntryCount() && var55.getLabel() != null) {
                        this.drawEntryLabel(var1, var55.getLabel(), var4, var41 + var24);
                     }
                  } else if (var60) {
                     if (var18 < var12.getEntryCount() && var55.getLabel() != null) {
                        this.drawEntryLabel(var1, var55.getLabel(), var4, var41 + var24 / 2.0F);
                     }
                  } else if (var39) {
                     this.drawValue(var1, var25, var32, var55, 0, var4, var41 + var24 / 2.0F, var53.getValueTextColor(var18));
                  }
               }
               ...
               if (var55.getIcon() != null && var53.isDrawIconsEnabled()) {
                  ...
                  var31 = var50.y;
                  var4 = var28.x;
                  Utils.drawImage(var1, var47, (int)((var11 + var41) * var35 + var32), (int)((var11 + var42) * var36 + var31 + var4), var47.getIntrinsicWidth(), var47.getIntrinsicHeight());
               }
