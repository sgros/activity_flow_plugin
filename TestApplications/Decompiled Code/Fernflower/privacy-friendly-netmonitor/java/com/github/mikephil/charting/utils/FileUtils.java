      ...
      label61: {
         ...
         while(true) {
            ...
            if (var4 <= 2) {
               ...
               float[] var18;
               try {
                  var18 = new float[var16.length - 1];
               ...
               while(true) {
                  try {
                     ...
                     var18[var5] = Float.parseFloat(var16[var5]);
               ...
               try {
                  BarEntry var6 = new BarEntry((float)Integer.parseInt(var16[var16.length - 1]), var18);
                  var14.add(var6);
         ...
         while(true) {
            try {
               if (var11.hasNext()) {
                  ...
                  var12.append(var9.getY());
                  var12.append("#");
                  var12.append(var9.getX());
