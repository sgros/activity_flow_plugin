...
public class ByteArrayLoader implements ModelLoader {
   ...
   public ModelLoader.LoadData buildLoadData(byte[] var1, int var2, int var3, Options var4) {
      return new ModelLoader.LoadData(EmptySignature.obtain(), new ByteArrayLoader.Fetcher(var1, this.converter));
   }
   ...
   private static class Fetcher implements DataFetcher {
      ...
      public Fetcher(byte[] var1, ByteArrayLoader.Converter var2) {
         this.model = var1;
         this.converter = var2;
      }
