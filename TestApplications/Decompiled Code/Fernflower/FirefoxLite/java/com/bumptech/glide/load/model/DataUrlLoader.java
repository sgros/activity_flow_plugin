...
public final class DataUrlLoader implements ModelLoader {
   ...
   public ModelLoader.LoadData buildLoadData(String var1, int var2, int var3, Options var4) {
      return new ModelLoader.LoadData(new ObjectKey(var1), new DataUrlLoader.DataUriFetcher(var1, this.dataDecoder));
   }
   ...
   private static final class DataUriFetcher implements DataFetcher {
      ...
      public DataUriFetcher(String var1, DataUrlLoader.DataDecoder var2) {
         this.dataUri = var1;
         this.reader = var2;
      }
