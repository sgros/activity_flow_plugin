...
public final class MediaStoreFileLoader implements ModelLoader {
   ...
   MediaStoreFileLoader(Context var1) {
      this.context = var1;
   }
   ...
   private static class FilePathFetcher implements DataFetcher {
      ...
      public void loadData(Priority var1, DataFetcher.DataCallback var2) {
         Cursor var3 = this.context.getContentResolver().query(this.uri, PROJECTION, (String)null, (String[])null, (String)null);
         String var7 = null;
         Object var4 = null;
         if (var3 != null) {
            var7 = (String)var4;
            ...
            try {
               if (var3.moveToFirst()) {
                  var7 = var3.getString(var3.getColumnIndexOrThrow("_data"));
               }
            } finally {
               var3.close();
            }
