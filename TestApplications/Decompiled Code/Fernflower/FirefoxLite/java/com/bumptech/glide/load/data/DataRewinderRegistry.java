...
public class DataRewinderRegistry {
   ...
   public DataRewinder build(Object var1) {
      ...
      Throwable var10000;
      label288: {
         DataRewinder.Factory var2;
         boolean var10001;
         try {
            Preconditions.checkNotNull(var1);
            var2 = (DataRewinder.Factory)this.rewinders.get(var1.getClass());
         ...
         DataRewinder.Factory var3 = var2;
         if (var2 == null) {
            Iterator var4;
            try {
            ...
            while(true) {
               ...
               try {
                  ...
                  var3 = (DataRewinder.Factory)var4.next();
                  if (var3.getDataClass().isAssignableFrom(var1.getClass())) {
                     break;
                  }
         ...
         label264:
         try {
            DataRewinder var36 = var2.build(var1);
            return var36;
   ...
   private static class DefaultRewinder implements DataRewinder {
      ...
      public DefaultRewinder(Object var1) {
         this.data = var1;
      }
