...
public abstract class BaseStrokeContent implements DrawingContent, KeyPathElementContent, BaseKeyframeAnimation.AnimationListener {
   ...
   BaseStrokeContent(LottieDrawable var1, BaseLayer var2, Cap var3, Join var4, float var5, AnimatableIntegerValue var6, AnimatableFloatValue var7, List var8, AnimatableFloatValue var9) {
      ...
      if (this.dashPatternOffsetAnimation != null) {
         var2.addAnimation(this.dashPatternOffsetAnimation);
      }
   ...
   private void applyDashPatternIfNeeded(Matrix var1) {
      ...
      if (this.dashPatternAnimations.isEmpty()) {
         ...
         for(int var3 = 0; var3 < this.dashPatternAnimations.size(); ++var3) {
            ...
            if (var3 % 2 == 0) {
               if (this.dashPatternValues[var3] < 1.0F) {
                  this.dashPatternValues[var3] = 1.0F;
               }
            } else if (this.dashPatternValues[var3] < 0.1F) {
               this.dashPatternValues[var3] = 0.1F;
            }

            float[] var4 = this.dashPatternValues;
            var4[var3] *= var2;
         }
         ...
         if (this.dashPatternOffsetAnimation == null) {
            ...
            var2 = (Float)this.dashPatternOffsetAnimation.getValue();
         }
   ...
   public void draw(Canvas var1, Matrix var2, int var3) {
      ...
      this.paint.setStrokeWidth((Float)this.widthAnimation.getValue() * Utils.getScale(var2));
      if (this.paint.getStrokeWidth() <= 0.0F) {
         ...
         for(; var3 < this.pathGroups.size(); ++var3) {
            BaseStrokeContent.PathGroup var6 = (BaseStrokeContent.PathGroup)this.pathGroups.get(var3);
            if (var6.trimPath != null) {
               this.applyTrimPath(var1, var6, var2);
            } else {
               L.beginSection("StrokeContent#buildPath");
               this.path.reset();

               for(int var7 = var6.paths.size() - 1; var7 >= 0; --var7) {
                  this.path.addPath(((PathContent)var6.paths.get(var7)).getPath(), var2);
               }
   ...
   public void getBounds(RectF var1, Matrix var2) {
      ...
      for(int var3 = 0; var3 < this.pathGroups.size(); ++var3) {
         BaseStrokeContent.PathGroup var4 = (BaseStrokeContent.PathGroup)this.pathGroups.get(var3);

         for(int var5 = 0; var5 < var4.paths.size(); ++var5) {
            this.path.addPath(((PathContent)var4.paths.get(var5)).getPath(), var2);
         }
      }

      this.path.computeBounds(this.rect, false);
      float var6 = (Float)this.widthAnimation.getValue();
      RectF var8 = this.rect;
      float var7 = this.rect.left;
      var6 /= 2.0F;
      var8.set(var7 - var6, this.rect.top - var6, this.rect.right + var6, this.rect.bottom + var6);
      var1.set(this.rect);
