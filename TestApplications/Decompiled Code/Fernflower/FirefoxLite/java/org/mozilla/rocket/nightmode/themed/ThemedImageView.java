...
public class ThemedImageView extends AppCompatImageView {
   ...
   public ThemedImageView(Context var1) {
      Intrinsics.checkParameterIsNotNull(var1, "context");
      super(var1);
   }

   public ThemedImageView(Context var1, AttributeSet var2) {
      Intrinsics.checkParameterIsNotNull(var1, "context");
      Intrinsics.checkParameterIsNotNull(var2, "attrs");
      super(var1, var2);
   }

   public ThemedImageView(Context var1, AttributeSet var2, int var3) {
      Intrinsics.checkParameterIsNotNull(var1, "context");
      Intrinsics.checkParameterIsNotNull(var2, "attrs");
