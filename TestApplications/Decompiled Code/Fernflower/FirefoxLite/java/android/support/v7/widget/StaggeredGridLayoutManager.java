...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
   ...
   private int fill(RecyclerView.Recycler var1, LayoutState var2, RecyclerView.State var3) {
      ...
      for(var6 = false; var2.hasMore(var3) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty()); var6 = true) {
         ...
         var16 = this.mLazySpanLookup.getSpan(var9);
         boolean var10;
         if (var16 == -1) {
            var10 = true;
         } else {
         ...
         if (var2.mLayoutDirection == 1) {
            ...
            var12 = var16 - this.mPrimaryOrientation.getDecoratedMeasurement(var7);
            if (var10 && var8.mFullSpan) {
         ...
         if (this.mOrientation == 1) {
            this.layoutDecoratedWithMargins(var7, var9, var12, var16, var14);
         } else {
            this.layoutDecoratedWithMargins(var7, var12, var9, var14, var16);
         }
      ...
      var16 = var17;
      if (var4 > 0) {
         var16 = Math.min(var2.mAvailable, var4);
      }
   ...
   private StaggeredGridLayoutManager.Span getNextSpan(LayoutState var1) {
      ...
      if (var6 == 1) {
         ...
         for(var8 = this.mPrimaryOrientation.getStartAfterPadding(); var4 != var3; var6 = var10) {
            var7 = this.mSpans[var4];
            var9 = var7.getEndLine(var8);
            var10 = var6;
            if (var9 < var6) {
               var11 = var7;
               var10 = var9;
         ...
         for(var10 = var4; var10 != var3; var6 = var4) {
            var7 = this.mSpans[var10];
            var9 = var7.getStartLine(var8);
            var4 = var6;
            if (var9 > var6) {
               var11 = var7;
               var4 = var9;
   ...
   private void repositionToWrapContentIfNecessary() {
      if (this.mSecondaryOrientation.getMode() != 1073741824) {
         ...
         int var9 = Math.round(var4 * (float)this.mSpanCount);
         var3 = var9;
         if (this.mSecondaryOrientation.getMode() == Integer.MIN_VALUE) {
            var3 = Math.min(var9, this.mSecondaryOrientation.getTotalSpace());
         }
            ...
            for(; var3 < var1; ++var3) {
               ...
               if (!var10.mFullSpan) {
                  if (this.isLayoutRTL() && this.mOrientation == 1) {
                     ...
                     int var11 = var10.mSpan.mIndex * this.mSizePerSpan;
                     var9 = var10.mSpan.mIndex * var8;
                     if (this.mOrientation == 1) {
                        var5.offsetLeftAndRight(var11 - var9);
                     } else {
                        var5.offsetTopAndBottom(var11 - var9);
                     }
                  }
               }
            }
   ...
   boolean checkForGaps() {
      if (this.getChildCount() != 0 && this.mGapStrategy != 0 && this.isAttachedToWindow()) {
         ...
         if (var1 == 0 && this.hasGapsToFix() != null) {
            ...
            ++var2;
            StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem var5 = var4.getFirstFullSpanItemInRange(var1, var2, var3, true);
            if (var5 == null) {
               this.mLaidOutInvalidFullSpan = false;
               this.mLazySpanLookup.forceInvalidateAfter(var2);
               return false;
            } else {
               StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem var6 = this.mLazySpanLookup.getFirstFullSpanItemInRange(var1, var5.mPosition, var3 * -1, true);
               if (var6 == null) {
   ...
   public void collectAdjacentPrefetchPositions(int var1, int var2, RecyclerView.State var3, RecyclerView.LayoutManager.LayoutPrefetchRegistry var4) {
      ...
      if (this.getChildCount() != 0 && var1 != 0) {
         ...
         int var7;
         for(var1 = 0; var2 < this.mSpanCount; var1 = var7) {
            int var6;
               ...
               label71: {
                  label70: {
                     ...
                     if (this.mShouldReverseLayout) {
                        ...
                        var1 = this.mPrimaryOrientation.getDecoratedStart(var7);
                        var10 = this.mPrimaryOrientation.getDecoratedStart(var9);
                        if (var1 > var10) {
                           return var7;
                        }
   ...
   public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler var1, RecyclerView.State var2, View var3, AccessibilityNodeInfoCompat var4) {
      ...
      if (!(var7 instanceof StaggeredGridLayoutManager.LayoutParams)) {
         ...
         if (this.mOrientation == 0) {
            ...
            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(var5, var6, -1, -1, var8.mFullSpan, false));
         } else {
            var5 = var8.getSpanIndex();
            if (var8.mFullSpan) {
               var6 = this.mSpanCount;
            ...
            var4.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, var5, var6, var8.mFullSpan, false));
         }
   ...
   public void setMeasuredDimension(Rect var1, int var2, int var3) {
      ...
      if (this.mOrientation == 1) {
         ...
         var5 = chooseSize(var2, this.mSizePerSpan * this.mSpanCount + var4, this.getMinimumWidth());
         var2 = var3;
         var3 = var5;
      } else {
         var2 = chooseSize(var2, var1.width() + var4, this.getMinimumWidth());
         var5 = chooseSize(var3, this.mSizePerSpan * this.mSpanCount + var5, this.getMinimumHeight());
         var3 = var2;
         var2 = var5;
      }
