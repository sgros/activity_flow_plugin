      ...
      label92: {
         ...
         if (var7 == Integer.MIN_VALUE) {
            ...
            if (var9 != null && var9.type != 0) {
               if (var9.type == 5) {
                  var4 = (int)var9.getDimension(var3);
               } else if (var9.type == 6) {
                  var4 = (int)var9.getFraction((float)var3.widthPixels, (float)var3.widthPixels);
               } else {
                  var4 = 0;
               }

               if (var4 > 0) {
                  var10 = MeasureSpec.makeMeasureSpec(Math.min(var4 - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(var1)), 1073741824);
                  var11 = true;
                  break label92;
               }
            }
      ...
      if (var8 == Integer.MIN_VALUE) {
         ...
         if (var9 != null) {
            ...
            if (var9.type != 0) {
               ...
               var4 = var2;
               if (var1 > 0) {
                  var4 = MeasureSpec.makeMeasureSpec(Math.min(var1 - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(var2)), 1073741824);
               }
            }
         }
      }
