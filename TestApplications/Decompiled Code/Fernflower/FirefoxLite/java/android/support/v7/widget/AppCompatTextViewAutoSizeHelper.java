...
class AppCompatTextViewAutoSizeHelper {
   ...
   private boolean suggestedSizeFitsInSpace(int var1, RectF var2) {
      ...
      if (var4 != null) {
         CharSequence var9 = var4.getTransformation(var3, this.mTextView);
         var5 = var3;
         if (var9 != null) {
            var5 = var9;
         }
      ...
      if (VERSION.SDK_INT >= 23) {
         var8 = this.createStaticLayoutForMeasuring(var5, var7, Math.round(var2.right), var6);
      } else {
         var8 = this.createStaticLayoutForMeasuringPre23(var5, var7, Math.round(var2.right));
      }

      if (var6 == -1 || var8.getLineCount() <= var6 && var8.getLineEnd(var8.getLineCount() - 1) == var5.length()) {
         return (float)var8.getHeight() <= var2.bottom;
      } else {
         return false;
      }
   }
