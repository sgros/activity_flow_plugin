...
public class DiffUtil {
   ...
   private static DiffUtil.Snake diffPartial(DiffUtil.Callback var0, int var1, int var2, int var3, int var4, int[] var5, int[] var6, int var7) {
      ...
      if (var8 >= 1 && var2 >= 1) {
         ...
         Arrays.fill(var5, var4, var11, 0);
         Arrays.fill(var6, var4 + var9, var11 + var9, var8);
         boolean var19;
         if (var9 % 2 != 0) {
            var19 = true;
         } else {
      ...
      private void findMatchingItems() {
         ...
         for(int var3 = this.mSnakes.size() - 1; var3 >= 0; --var3) {
            ...
            for(var2 = 0; var2 < var4.size; ++var2) {
               ...
               var9 = var4.y + var2;
               byte var10;
               if (this.mCallback.areContentsTheSame(var7, var9)) {
                  var10 = 1;
               } else {
                  var10 = 2;
               }

               this.mOldItemStatuses[var7] = var9 << 5 | var10;
               this.mNewItemStatuses[var9] = var7 << 5 | var10;
            }
