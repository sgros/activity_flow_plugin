      ...
      if (var1 instanceof WrappedDrawable) {
         ...
         if (var1 instanceof LayerDrawable) {
            ...
            for(var7 = 0; var7 < var5; ++var7) {
               ...
               var13[var7] = this.tileify(var4, var2);
            }

            LayerDrawable var15 = new LayerDrawable(var13);

            for(var7 = var6; var7 < var5; ++var7) {
               var15.setId(var7, var10.getId(var7));
            }
