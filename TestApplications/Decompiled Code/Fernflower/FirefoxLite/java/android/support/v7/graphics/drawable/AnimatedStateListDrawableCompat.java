...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
   ...
   private boolean selectTransition(int var1) {
      ...
      int var4 = var10.getKeyframeIdAt(var3);
      int var5 = var10.getKeyframeIdAt(var1);
      if (var5 != 0 && var4 != 0) {
         int var6 = var10.indexOfTransition(var4, var5);
         if (var6 < 0) {
            return false;
         } else {
            boolean var7 = var10.transitionHasReversibleFlag(var4, var5);
            this.selectDrawable(var6);
            Drawable var8 = this.getCurrent();
            Object var11;
            if (var8 instanceof AnimationDrawable) {
               boolean var9 = var10.isTransitionReversed(var4, var5);
               var11 = new AnimatedStateListDrawableCompat.AnimationDrawableTransition((AnimationDrawable)var8, var9, var7);
            } else if (var8 instanceof AnimatedVectorDrawableCompat) {
               var11 = new AnimatedStateListDrawableCompat.AnimatedVectorDrawableTransition((AnimatedVectorDrawableCompat)var8);
            } else {
               if (!(var8 instanceof Animatable)) {
                  return false;
               }

               var11 = new AnimatedStateListDrawableCompat.AnimatableTransition((Animatable)var8);
            }
   ...
   private static class FrameInterpolator implements TimeInterpolator {
      ...
      int updateFrames(AnimationDrawable var1, boolean var2) {
         ...
         this.mFrames = var3;
         if (this.mFrameTimes == null || this.mFrameTimes.length < var3) {
