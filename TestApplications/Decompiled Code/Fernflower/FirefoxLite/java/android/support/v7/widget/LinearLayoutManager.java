      ...
      if ((var3 != null || this.mPendingScrollPosition != -1) && var2.getItemCount() == 0) {
         ...
         if (this.mAnchorInfo.mValid && this.mPendingScrollPosition == -1 && this.mPendingSavedState == null) {
            if (var9 != null && (this.mOrientationHelper.getDecoratedStart(var9) >= this.mOrientationHelper.getEndAfterPadding() || this.mOrientationHelper.getDecoratedEnd(var9) <= this.mOrientationHelper.getStartAfterPadding())) {
               this.mAnchorInfo.assignFromViewAndKeepVisibleRect(var9, this.getPosition(var9));
            }
         } else {
               ...
               if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
                  ...
                  if (var9 != null) {
                     if (this.mShouldReverseLayout) {
                        ...
                        var6 = this.mOrientationHelper.getDecoratedStart(var9);
                        var5 = this.mOrientationHelper.getStartAfterPadding();
                        var6 = this.mPendingScrollPositionOffset - (var6 - var5);
                     }
         ...
         if (this.getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
               ...
               var6 += var11;
               var7 = this.fixLayoutEndGap(var6, var1, var2, false);
               var11 = var5 + var11 + var7;
               var7 += var6;
            }
         }
      ...
      public void assignFromViewAndKeepVisibleRect(View var1, int var2) {
         ...
         if (var3 >= 0) {
            ...
            if (this.mLayoutFromEnd) {
               ...
               if (var2 > 0) {
                  var4 = this.mOrientationHelper.getDecoratedMeasurement(var1);
                  var5 = this.mCoordinate;
                  var3 = this.mOrientationHelper.getStartAfterPadding();
                  var3 = var5 - var4 - (var3 + Math.min(this.mOrientationHelper.getDecoratedStart(var1) - var3, 0));
                  if (var3 < 0) {
                     this.mCoordinate += Math.min(var2, -var3);
                  }
               }
            } else {
               var5 = this.mOrientationHelper.getDecoratedStart(var1);
               var2 = var5 - this.mOrientationHelper.getStartAfterPadding();
               ...
               if (var2 > 0) {
                  ...
                  var3 = this.mOrientationHelper.getEndAfterPadding() - Math.min(0, var7 - var3 - var4) - (var5 + var6);
                  if (var3 < 0) {
                     this.mCoordinate -= Math.min(var2, -var3);
                  }
               }
