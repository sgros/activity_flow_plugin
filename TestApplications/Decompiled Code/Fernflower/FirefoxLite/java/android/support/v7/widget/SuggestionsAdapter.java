   ...
   Drawable getDrawableFromResourceUri(Uri var1) throws FileNotFoundException {
      ...
      if (!TextUtils.isEmpty(var2)) {
         ...
         try {
            ...
            var4.append("No package found for authority: ");
            var4.append(var1);
            throw new FileNotFoundException(var4.toString());
         }

         List var8 = var1.getPathSegments();
         if (var8 != null) {
            int var5 = var8.size();
            if (var5 == 1) {
               try {
                  var5 = Integer.parseInt((String)var8.get(0));
               } catch (NumberFormatException var6) {
                  var4 = new StringBuilder();
                  var4.append("Single path segment is not a resource ID: ");
                  var4.append(var1);
                  throw new FileNotFoundException(var4.toString());
               }
            } else {
               if (var5 != 2) {
                  var4 = new StringBuilder();
                  var4.append("More than two path segments: ");
                  var4.append(var1);
                  throw new FileNotFoundException(var4.toString());
               }

               var5 = var3.getIdentifier((String)var8.get(1), (String)var8.get(0), var2);
            }
            ...
            if (var5 != 0) {
               ...
               var4 = new StringBuilder();
               var4.append("No resource found for: ");
               var4.append(var1);
               throw new FileNotFoundException(var4.toString());
            }
         } else {
