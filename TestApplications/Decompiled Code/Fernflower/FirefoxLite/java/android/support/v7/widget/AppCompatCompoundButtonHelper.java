...
class AppCompatCompoundButtonHelper {
   ...
   void loadFromAttributes(AttributeSet var1, int var2) {
      TypedArray var3 = this.mView.getContext().obtainStyledAttributes(var1, R.styleable.CompoundButton, var2, 0);
      ...
      label211: {
         ...
         label215: {
            ...
            label209: {
               try {
                  if (!var3.hasValue(R.styleable.CompoundButton_android_button)) {
                     break label209;
                  }

                  var2 = var3.getResourceId(R.styleable.CompoundButton_android_button, 0);
            ...
            try {
               if (var3.hasValue(R.styleable.CompoundButton_buttonTint)) {
                  CompoundButtonCompat.setButtonTintList(this.mView, var3.getColorStateList(R.styleable.CompoundButton_buttonTint));
               }
            ...
            label198:
            try {
               if (var3.hasValue(R.styleable.CompoundButton_buttonTintMode)) {
                  CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(var3.getInt(R.styleable.CompoundButton_buttonTintMode, -1), (Mode)null));
               }
               break label211;
