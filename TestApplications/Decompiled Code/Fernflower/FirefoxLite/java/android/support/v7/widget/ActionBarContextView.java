...
public class ActionBarContextView extends AbsActionBarView {
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      if (var3 != 1073741824) {
         ...
         var2 = var1;
         if (var14 != null) {
            var1 = this.measureChildView(this.mClose, var1, var8, 0);
         ...
         if (this.mTitleLayout != null) {
            ...
            if (this.mCustomView == null) {
               if (this.mTitleOptional) {
                  ...
                  var2 = this.measureChildView(this.mTitleLayout, var1, var8, 0);
               }
            }
         }

         if (this.mCustomView != null) {
            LayoutParams var17 = this.mCustomView.getLayoutParams();
            if (var17.width != -2) {
               var1 = 1073741824;
            } else {
