...
class AdapterHelper implements OpReorderer.Callback {
   ...
   private void applyRemove(AdapterHelper.UpdateOp var1) {
      ...
      byte var6;
      int var11;
      for(var6 = -1; var4 < var3; var5 = var11) {
         boolean var8;
         if (this.mCallback.findViewHolder(var4) == null && !this.canFindInPreLayout(var4)) {
            boolean var10;
            if (var6 == 1) {
               this.postponeAndUpdateViewHolders(this.obtainUpdateOp(2, var2, var5, (Object)null));
               var10 = true;
            } else {
               var10 = false;
            }
            ...
            if (var6 == 0) {
               this.dispatchAndUpdateViewHolders(this.obtainUpdateOp(2, var2, var5, (Object)null));
               var8 = true;
            } else {
               var8 = false;
            }
      ...
      if (var5 != var1.itemCount) {
         ...
         var9 = this.obtainUpdateOp(2, var2, var5, (Object)null);
      }
