   ...
   private void buildTaskList() {
      ...
      for(var5 = 0; var3 < var1; ++var3) {
         ...
         if (var6.getWindowVisibility() == 0) {
            ...
            for(var2 = 0; var2 < var7.mCount * 2; var2 += 2) {
               GapWorker.Task var11;
               if (var5 >= this.mTasks.size()) {
                  var11 = new GapWorker.Task();
                  this.mTasks.add(var11);
               } else {
                  var11 = (GapWorker.Task)this.mTasks.get(var5);
               }

               int var9 = var7.mPrefetchArray[var2 + 1];
               boolean var10;
               if (var9 <= var8) {
                  var10 = true;
               } else {
               ...
               var11.view = var6;
               var11.position = var7.mPrefetchArray[var2];
               ++var5;
            }
         }
      }
