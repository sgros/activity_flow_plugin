...
public class AlertDialogLayout extends LinearLayoutCompat {
   ...
   private boolean tryOnMeasure(int var1, int var2) {
      ...
      for(var11 = 0; var13 < var3; var11 = var15) {
         var5 = this.getChildAt(var13);
         var15 = var11;
         if (var5.getVisibility() != 8) {
            var15 = Math.max(var11, var5.getMeasuredWidth());
         }
      ...
      for(var5 = 0; var5 < var10; var2 = var3) {
         ...
         if (var13 != null) {
            ...
            if (var13.getVisibility() != 8) {
               ...
               if (var3 != 1) {
                  if (var3 != 5) {
                     var3 = var17.leftMargin + var6;
                  } else {
                     var3 = var7 - var8 - var14 - var17.rightMargin;
                  }
               } else {
                  var3 = (var7 - var6 - var9 - var14) / 2 + var6 + var17.leftMargin - var17.rightMargin;
               }
               ...
               this.setChildFrame(var13, var3, var2, var14, var15);
               var3 = var2 + var15 + var17.bottomMargin;
            }
         }
