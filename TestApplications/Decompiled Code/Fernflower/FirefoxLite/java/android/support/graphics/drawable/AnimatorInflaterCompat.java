...
public class AnimatorInflaterCompat {
      ...
      while(true) {
         ...
         if (var11 == 2) {
            ...
            if (var14.equals("objectAnimator")) {
               ...
               if (var23 != null && var9 != null && var9 instanceof ValueAnimator) {
   ...
   public static Animator loadAnimator(Context var0, Resources var1, Theme var2, int var3, float var4) throws NotFoundException {
      Object var5 = null;
      Object var6 = null;
   ...
   private static void setupPathMotion(Path var0, ObjectAnimator var1, float var2, String var3, String var4) {
      ...
      while(true) {
         ...
         var9.getPosTan(var2 - (Float)var6.get(var14), var12, (float[])null);
         var17[var13] = var12[0];
         var11[var13] = var12[1];
         var2 += var7;
         int var15 = var14 + 1;
