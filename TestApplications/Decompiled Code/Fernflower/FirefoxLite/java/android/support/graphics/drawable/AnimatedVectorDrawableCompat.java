         ...
         for(int var6 = var2.getDepth(); var5 != 1 && (var2.getDepth() >= var6 + 1 || var5 != 3); var5 = var2.next()) {
            if (var5 == 2) {
               ...
               if ("animated-vector".equals(var7)) {
                  TypedArray var9 = TypedArrayUtils.obtainAttributes(var1, var4, var3, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE);
                  ...
                  if (var5 != 0) {
                     ...
                     this.setupAnimatorsForTarget(var7, AnimatorInflaterCompat.loadAnimator(this.mContext, var5));
                  }
