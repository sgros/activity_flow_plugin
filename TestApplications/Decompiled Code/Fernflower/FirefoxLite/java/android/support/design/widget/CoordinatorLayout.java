...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
   ...
   static CoordinatorLayout.Behavior parseBehavior(Context var0, AttributeSet var1, String var2) {
      if (TextUtils.isEmpty(var2)) {
         ...
         label57: {
            ...
            if (var5 == null) {
               try {
                  var16 = var0.getClassLoader().loadClass(var15).getConstructor(CONSTRUCTOR_PARAMS);
         ...
         if (var1 instanceof CoordinatorLayout.AttachedBehavior) {
            ...
            if (var7 != null) {
               try {
                  ...
                  var8.append(" could not be instantiated. Did you forget");
                  var8.append(" a default constructor?");
            ...
            for(var10 = var7 + 1; var10 < var3; ++var10) {
               ...
               if (var15 != null && var15.layoutDependsOn(this, var13, var8)) {
                  if (var1 == 0 && var16.getChangedAfterNestedScroll()) {
                     ...
                     if (var1 == 1) {
                        var16.setChangedAfterNestedScroll(var14);
                     }
                  }
               }
            }
      ...
      for(int var18 = 0; var18 < var16; ++var18) {
         ...
         if (var19.getVisibility() != 8) {
            ...
            label73: {
               ...
               if (var20.keyline >= 0 && var9 != 0) {
                  ...
                  if (var22 == 3 && !var8 || var22 == 5 && var8) {
                     var22 = Math.max(0, var10 - var5 - var21);
                     break label73;
                  }

                  if (var22 == 5 && !var8 || var22 == 3 && var8) {
                     var22 = Math.max(0, var21 - var3);
                     break label73;
                  }
               }
            ...
            if (var15 && !ViewCompat.getFitsSystemWindows(var19)) {
               ...
               var25 = this.mLastInsets.getSystemWindowInsetTop();
               var21 = this.mLastInsets.getSystemWindowInsetBottom();
               var14 = MeasureSpec.makeMeasureSpec(var10 - (var24 + var14), var9);
               var21 = MeasureSpec.makeMeasureSpec(var12 - (var25 + var21), var11);
               var25 = var14;
               var14 = var21;
            } else {
               var25 = var1;
            ...
            if (var26 == null || !var26.onMeasureChild(this, var19, var25, var22, var14, 0)) {
               this.onMeasureChild(var19, var25, var22, var14, 0);
            }
         ...
         if (var11.getVisibility() == 8) {
            ...
            if (!var14.isNestedScrollAccepted(var5)) {
               ...
               if (var15 != null) {
                  ...
                  var16[0] = 0;
                  var15.onNestedPreScroll(this, var11, var1, var2, var3, this.mTempIntPair, var5);
                  if (var2 > 0) {
                     var13 = Math.max(var9, this.mTempIntPair[0]);
                  } else {
                     var13 = Math.min(var9, this.mTempIntPair[0]);
                  }

                  if (var3 > 0) {
                     var10 = Math.max(var10, this.mTempIntPair[1]);
                  } else {
                     var10 = Math.min(var10, this.mTempIntPair[1]);
                  }
   ...
   public boolean onTouchEvent(MotionEvent var1) {
      ...
      boolean var4;
      boolean var5;
      CoordinatorLayout.Behavior var6;
      label37: {
         label36: {
            ...
            var6 = ((CoordinatorLayout.LayoutParams)this.mBehaviorTouchView.getLayoutParams()).getBehavior();
            var4 = var3;
            if (var6 != null) {
               var4 = var6.onTouchEvent(this, this.mBehaviorTouchView, var1);
               break label37;
            }
         }
      ...
      var6 = null;
      if (var7 == null) {
         var5 = var4 | super.onTouchEvent(var1);
         var1 = var6;
      } else {
         var5 = var4;
         var1 = var6;
