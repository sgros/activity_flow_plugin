...
final class IndicatorViewController {
   ...
   int getErrorViewCurrentTextColor() {
      ...
      if (this.errorView != null) {
         var1 = this.errorView.getCurrentTextColor();
      } else {
         var1 = -1;
      }
   ...
   ColorStateList getErrorViewTextColors() {
      ColorStateList var1;
      if (this.errorView != null) {
         var1 = this.errorView.getTextColors();
      } else {
         var1 = null;
      }
   ...
   int getHelperTextViewCurrentTextColor() {
      ...
      if (this.helperTextView != null) {
         var1 = this.helperTextView.getCurrentTextColor();
      } else {
         var1 = -1;
      }
   ...
   void removeIndicator(TextView var1, int var2) {
      if (this.indicatorArea != null) {
         if (this.isCaptionView(var2) && this.captionArea != null) {
            --this.captionViewsAdded;
   ...
   void setErrorTextAppearance(int var1) {
      ...
      if (this.errorView != null) {
         this.textInputView.setTextAppearanceCompatWithErrorFallback(this.errorView, var1);
      }
   ...
   void setErrorViewTextColor(ColorStateList var1) {
      if (this.errorView != null) {
         this.errorView.setTextColor(var1);
      }
   ...
   void setHelperTextAppearance(int var1) {
      ...
      if (this.helperTextView != null) {
         TextViewCompat.setTextAppearance(this.helperTextView, var1);
      }
   ...
   void setHelperTextViewTextColor(ColorStateList var1) {
      if (this.helperTextView != null) {
         this.helperTextView.setTextColor(var1);
      }
