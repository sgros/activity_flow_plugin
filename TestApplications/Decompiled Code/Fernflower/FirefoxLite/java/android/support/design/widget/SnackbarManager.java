...
class SnackbarManager {
   ...
   private boolean isCurrentSnackbarLocked(SnackbarManager.Callback var1) {
      boolean var2;
      if (this.currentSnackbar != null && this.currentSnackbar.isSnackbar(var1)) {
         var2 = true;
      } else {
         var2 = false;
      }
   ...
   private boolean isNextSnackbarLocked(SnackbarManager.Callback var1) {
      boolean var2;
      if (this.nextSnackbar != null && this.nextSnackbar.isSnackbar(var1)) {
         var2 = true;
      } else {
         var2 = false;
      }
   ...
   private void scheduleTimeoutLocked(SnackbarManager.SnackbarRecord var1) {
      if (var1.duration != -2) {
         ...
         this.handler.removeCallbacksAndMessages(var1);
         this.handler.sendMessageDelayed(Message.obtain(this.handler, 0, var1), (long)var2);
      }
   }
   ...
   private void showNextSnackbarLocked() {
      if (this.nextSnackbar != null) {
         ...
         SnackbarManager.Callback var1 = (SnackbarManager.Callback)this.currentSnackbar.callback.get();
         if (var1 != null) {
            var1.show();
         } else {
