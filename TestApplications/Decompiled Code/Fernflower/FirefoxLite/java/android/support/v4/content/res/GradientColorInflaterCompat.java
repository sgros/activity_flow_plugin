...
final class GradientColorInflaterCompat {
   ...
   static Shader createFromXmlInner(Resources var0, XmlPullParser var1, AttributeSet var2, Theme var3) throws IOException, XmlPullParserException {
      ...
      if (var4.equals("gradient")) {
         ...
         case 2:
            return new SweepGradient(var9, var10, var19.mColors, var19.mOffsets);
         default:
            return new LinearGradient(var5, var6, var7, var8, var19.mColors, var19.mOffsets, parseTileMode(var16));
         }
      } else {
      ...
      while(true) {
         ...
         if (var7 == 2 && var8 <= var4 && var1.getName().equals("item")) {
            ...
            if (!var10 || !var11) {
               ...
               var13.append(": <item> tag requires a 'color' attribute and a 'offset' ");
               var13.append("attribute!");
