...
public class SimpleArrayMap {
   ...
   public Object put(Object var1, Object var2) {
      ...
      if (var4 >= 0) {
         ...
         if (var3 == this.mSize && var4 < this.mHashes.length) {
            this.mHashes[var4] = var5;
   ...
   public Object removeAt(int var1) {
      ...
      if (var4 <= 1) {
         ...
         int var6 = var4 - 1;
         int var7 = this.mHashes.length;
         int var12 = 8;
         int[] var8;
         if (var7 > 8 && this.mSize < this.mHashes.length / 3) {
            if (var4 > 8) {
               var12 = var4 + (var4 >> 1);
            }
            ...
            if (var1 > 0) {
               ...
               System.arraycopy(var14, 0, this.mArray, 0, var3);
            }
            ...
            if (var1 < var6) {
               ...
               int[] var10 = this.mHashes;
               var7 = var6 - var1;
               System.arraycopy(var8, var12, var10, var1, var7);
               System.arraycopy(var14, var12 << 1, this.mArray, var3, var7 << 1);
            }
         } else {
            if (var1 < var6) {
               ...
               var8 = this.mHashes;
               var12 = var6 - var1;
               System.arraycopy(var9, var7, var8, var1, var12);
               System.arraycopy(this.mArray, var7 << 1, this.mArray, var3, var12 << 1);
            }
