...
public class ViewDragHelper {
      ...
      case 2:
         if (this.mDragState == 1) {
            if (this.isValidPointerForActionMove(this.mActivePointerId)) {
               ...
               var7 = var1.getX(var5);
               var6 = var1.getY(var5);
               var12 = (int)(var7 - this.mLastMotionX[this.mActivePointerId]);
               var5 = (int)(var6 - this.mLastMotionY[this.mActivePointerId]);
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         var18 = this.findTopChildUnder((int)var5, (int)var4);
         ...
         if (this.mInitialMotionX != null && this.mInitialMotionY != null) {
            ...
            for(var3 = 0; var3 < var6; ++var3) {
               ...
               if (this.isValidPointerForActionMove(var7)) {
                  float var8 = var1.getX(var3);
                  var5 = var1.getY(var3);
                  float var9 = var8 - this.mInitialMotionX[var7];
                  var4 = var5 - this.mInitialMotionY[var7];
