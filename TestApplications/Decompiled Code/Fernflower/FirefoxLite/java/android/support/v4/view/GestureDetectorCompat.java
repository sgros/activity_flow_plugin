   ...
   static class GestureDetectorCompatImplBase implements GestureDetectorCompat.GestureDetectorCompatImpl {
      ...
      public boolean onTouchEvent(MotionEvent var1) {
         ...
         case 0:
            ...
            var12 = var15 | this.mListener.onDown(var1);
            break;
         case 1:
            this.mStillDown = false;
            ...
            if (this.mInLongPress) {
               ...
               if (this.mIsDoubleTapping) {
                  ...
                  if (var2 > this.mTouchSlopSquare) {
                     var4 = this.mListener.onScroll(this.mCurrentDownEvent, var1, var9, var10);
                     this.mLastFocusX = var8;
                     this.mLastFocusY = var11;
                     this.mAlwaysInTapRegion = false;
                     this.mHandler.removeMessages(3);
                  ...
                  var12 = this.mListener.onScroll(this.mCurrentDownEvent, var1, var9, var10);
                  this.mLastFocusX = var8;
                  this.mLastFocusY = var11;
               }
            }
