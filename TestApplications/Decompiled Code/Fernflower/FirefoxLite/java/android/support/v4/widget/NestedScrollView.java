...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2 {
      ...
      if (var2 == 0) {
         ...
         if (var1.bottom > var6 && var1.top > var7) {
            if (var1.height() > var4) {
               ...
               var2 = var1.bottom - var6 + 0;
            }

            var2 = Math.min(var2, var8.getBottom() + var9.bottomMargin - var5);
         } else {
            var2 = var3;
            if (var1.top < var7) {
               var2 = var3;
      ...
      if (this.mEdgeGlowTop != null) {
         ...
         if (!this.mEdgeGlowBottom.isFinished()) {
            label41: {
               ...
               var9 = var11 - (this.getPaddingLeft() + this.getPaddingRight());
               var6 = 0 + this.getPaddingLeft();
            }
            ...
            var1.translate((float)(var6 - var9), (float)var10);
            var1.rotate(180.0F, (float)var9, 0.0F);
            this.mEdgeGlowBottom.setSize(var9, var11);
      ...
      if (this.mFillViewport) {
         if (MeasureSpec.getMode(var2) != 0) {
            if (this.getChildCount() > 0) {
               ...
               if (var5 < var2) {
                  var3.measure(getChildMeasureSpec(var1, this.getPaddingLeft() + this.getPaddingRight() + var4.leftMargin + var4.rightMargin, var4.width), MeasureSpec.makeMeasureSpec(var2, 1073741824));
               }
            }
   ...
   public void onNestedScroll(View var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      this.dispatchNestedScroll(0, var2, 0, var5 - var2, (int[])null, var6);
   }
