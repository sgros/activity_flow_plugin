...
public class ViewPager extends ViewGroup {
   ...
   void dataSetChanged() {
      ...
      int var10;
      boolean var12;
      for(var12 = false; var5 < this.mItems.size(); var11 = var10) {
      ...
      if (var4) {
         ...
         for(var3 = 0; var3 < var5; ++var3) {
            ViewPager.LayoutParams var13 = (ViewPager.LayoutParams)this.getChildAt(var3).getLayoutParams();
            if (!var13.isDecor) {
   ...
   public void draw(Canvas var1) {
      ...
      if (var2 != 0 && (var2 != 1 || this.mAdapter == null || this.mAdapter.getCount() <= 1)) {
         ...
         if (!this.mLeftEdge.isFinished()) {
            ...
            var2 = this.getWidth();
            var1.rotate(270.0F);
            var1.translate((float)(-var9 + this.getPaddingTop()), this.mFirstOffset * (float)var2);
            this.mLeftEdge.setSize(var9, var2);
         ...
         if (!this.mRightEdge.isFinished()) {
            ...
            this.mRightEdge.setSize(var6 - var8 - var7, var5);
   ...
   void initViewPager() {
      ...
      ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
         ...
         public WindowInsetsCompat onApplyWindowInsets(View var1, WindowInsetsCompat var2) {
            var2 = ViewCompat.onApplyWindowInsets(var1, var2);
            if (var2.isConsumed()) {
               return var2;
            } else {
               Rect var6 = this.mTempRect;
               var6.left = var2.getSystemWindowInsetLeft();
               var6.top = var2.getSystemWindowInsetTop();
               var6.right = var2.getSystemWindowInsetRight();
               var6.bottom = var2.getSystemWindowInsetBottom();
               int var3 = 0;

               for(int var4 = ViewPager.this.getChildCount(); var3 < var4; ++var3) {
                  WindowInsetsCompat var5 = ViewCompat.dispatchApplyWindowInsets(ViewPager.this.getChildAt(var3), var2);
                  var6.left = Math.min(var5.getSystemWindowInsetLeft(), var6.left);
                  var6.top = Math.min(var5.getSystemWindowInsetTop(), var6.top);
                  var6.right = Math.min(var5.getSystemWindowInsetRight(), var6.right);
                  var6.bottom = Math.min(var5.getSystemWindowInsetBottom(), var6.bottom);
               }

               return var2.replaceSystemWindowInsets(var6.left, var6.top, var6.right, var6.bottom);
            }
         }
      });
   }
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      for(var4 = 0; var4 < var6; ++var4) {
         ...
         if (var19.getVisibility() != 8) {
            var18 = (ViewPager.LayoutParams)var19.getLayoutParams();
            if (!var18.isDecor) {
               ViewPager.ItemInfo var21 = this.infoForChild(var19);
               if (var21 != null) {
                  float var20 = (float)(var7 - var3 - var9);
                  var14 = (int)(var21.offset * var20) + var3;
                  if (var18.needsMeasure) {
                     var18.needsMeasure = false;
                     var19.measure(MeasureSpec.makeMeasureSpec((int)(var20 * var18.widthFactor), 1073741824), MeasureSpec.makeMeasureSpec(var8 - var2 - var5, 1073741824));
                  }

                  var19.layout(var14, var2, var19.getMeasuredWidth() + var14, var19.getMeasuredHeight() + var2);
               }
            }
         }
      }
   ...
   protected void onPageScrolled(int var1, float var2, int var3) {
      ...
      if (this.mPageTransformer != null) {
         ...
         for(var1 = var5; var1 < var4; ++var1) {
            ...
            if (!((ViewPager.LayoutParams)var11.getLayoutParams()).isDecor) {
               var2 = (float)(var11.getLeft() - var3) / (float)this.getClientWidth();
         ...
         if (var2 == 0 && var1.getEdgeFlags() != 0) {
            ...
            case 1:
               if (this.mIsBeingDragged) {
                  ...
                  int var9 = (int)var11.getXVelocity(this.mActivePointerId);
                  ...
                  var4 = (float)var10;
                  var6 /= var4;
                  this.setCurrentItemInternal(this.determineTargetPage(var12.position, ((float)var2 / var4 - var12.offset) / (var12.widthFactor + var6), var9, (int)(var1.getX(var1.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, var9);
            ...
            case 2:
               if (!this.mIsBeingDragged) {
                  ...
                  var4 = var1.getX(var2);
                  float var5 = Math.abs(var4 - this.mLastMotionX);
                  var6 = var1.getY(var2);
      ...
      if (this.mAdapter == null) {
         ...
         if (var4 != this.mExpectedAdapterCount) {
            ...
            if (var7 != null) {
               ...
               var16 = var13 + 1;
               if (var12 < 2.0F) {
                  if (var16 < this.mItems.size()) {
                     var6 = (ViewPager.ItemInfo)this.mItems.get(var16);
                  } else {
                     var6 = null;
                  }
                  ...
                  while(true) {
                     ...
                     label242: {
                        if (var12 >= var10 && var8 > var5) {
                           ...
                           this.mItems.remove(var16);
                           this.mAdapter.destroyItem((ViewGroup)this, var8, var14.object);
                           var15 = var12;
                           var1 = var16;
                           if (var16 < this.mItems.size()) {
                              var6 = (ViewPager.ItemInfo)this.mItems.get(var16);
                        ...
                        } else if (var14 != null && var8 == var14.position) {
                           var12 += var14.widthFactor;
                           ++var16;
                           var15 = var12;
                           var1 = var16;
                           ...
                           var6 = this.addNewItem(var8, var16);
                           ++var16;
               ...
               this.mAdapter.setPrimaryItem((ViewGroup)this, this.mCurItem, var7.object);
            }
            ...
            for(var1 = 0; var1 < var13; ++var1) {
               ...
               if (!var20.isDecor && var20.widthFactor == 0.0F) {
                  var2 = this.infoForChild(var18);
                  if (var2 != null) {
                     var20.widthFactor = var2.widthFactor;
                     var20.position = var2.position;
                  }
               }
            }
            ...
            if (this.hasFocus()) {
               ...
               if (var21 != null) {
                  var6 = this.infoForAnyChild(var21);
               } else {
                  var6 = null;
               }
               ...
               if (var6 == null || var6.position != this.mCurItem) {
                  for(var1 = 0; var1 < this.getChildCount(); ++var1) {
                     var18 = this.getChildAt(var1);
                     var6 = this.infoForChild(var18);
                     if (var6 != null && var6.position == this.mCurItem && var18.requestFocus(2)) {
                        break;
                     }
                  }
               }
   ...
   void smoothScrollTo(int var1, int var2, int var3) {
      if (this.getChildCount() == 0) {
         ...
         if (var6 == 0 && var2 == 0) {
            ...
            var1 = Math.abs(var3);
            if (var1 > 0) {
               var1 = Math.round(Math.abs((var8 + var10 * var8) / (float)var1) * 1000.0F) * 4;
            } else {
