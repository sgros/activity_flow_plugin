...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
   ...
   private void addAddedFragments(ArraySet var1) {
      if (this.mCurState >= 1) {
         int var2 = Math.min(this.mCurState, 3);
   ...
   private void animateRemoveFragment(final Fragment var1, FragmentManagerImpl.AnimationOrAnimator var2, int var3) {
      final View var4 = var1.mView;
      final ViewGroup var5 = var1.mContainer;
      var5.startViewTransition(var4);
      var1.setStateAfterAnimating(var3);
      if (var2.animation != null) {
         FragmentManagerImpl.EndViewTransitionAnimator var6 = new FragmentManagerImpl.EndViewTransitionAnimator(var2.animation, var5, var4);
         var1.setAnimatingAway(var1.mView);
         var6.setAnimationListener(new FragmentManagerImpl.AnimationListenerWrapper(getAnimationListener(var6)) {
         ...
         Animator var7 = var2.animator;
         var1.setAnimator(var2.animator);
         var7.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator var1x) {
               var5.endViewTransition(var4);
               var1x = var1.getAnimator();
               var1.setAnimator((Animator)null);
               if (var1x != null && var5.indexOfChild(var4) < 0) {
                  FragmentManagerImpl.this.moveToState(var1, var1.getStateAfterAnimating(), 0, 0, false);
               }
   ...
   private void executeOpsTogether(ArrayList var1, ArrayList var2, int var3, int var4) {
      ...
      if (var6) {
         ...
         this.addAddedFragments(var12);
         var11 = this.postponePostponableTransactions(var1, var2, var3, var4, var12);
         this.makeRemovedFragmentsInvisible(var12);
      } else {
         var11 = var4;
      }
      ...
      if (var11 != var3) {
         var8 = var3;
         if (var6) {
            FragmentTransition.startTransitions(this, var1, var2, var3, var11, true);
      ...
      while(var8 < var4) {
         BackStackRecord var13 = (BackStackRecord)var1.get(var8);
         if ((Boolean)var2.get(var8) && var13.mIndex >= 0) {
            this.freeBackStackIndex(var13.mIndex);
            var13.mIndex = -1;
         }

         var13.runOnCommitRunnables();
         ++var8;
      }
   ...
   public boolean dispatchCreateOptionsMenu(Menu var1, MenuInflater var2) {
      ...
      if (var3 < 1) {
         ...
         boolean var6;
         boolean var9;
         for(var6 = false; var3 < this.mAdded.size(); var6 = var9) {
            Fragment var7 = (Fragment)this.mAdded.get(var3);
            ArrayList var8 = var5;
            var9 = var6;
            if (var7 != null) {
               var8 = var5;
   ...
   void dispatchOnFragmentActivityCreated(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         FragmentManagerImpl.FragmentLifecycleCallbacksHolder var6;
         do {
            if (!var5.hasNext()) {
               return;
            }

            var6 = (FragmentManagerImpl.FragmentLifecycleCallbacksHolder)var5.next();
         } while(var3 && !var6.mRecursive);

         var6.mCallback.onFragmentActivityCreated(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentAttached(Fragment var1, Context var2, boolean var3) {
      ...
      while(true) {
         FragmentManagerImpl.FragmentLifecycleCallbacksHolder var5;
         do {
            if (!var6.hasNext()) {
               return;
            }

            var5 = (FragmentManagerImpl.FragmentLifecycleCallbacksHolder)var6.next();
         } while(var3 && !var5.mRecursive);

         var5.mCallback.onFragmentAttached(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentCreated(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         ...
         var6.mCallback.onFragmentCreated(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentDestroyed(Fragment var1, boolean var2) {
      ...
      while(true) {
         FragmentManagerImpl.FragmentLifecycleCallbacksHolder var4;
         do {
            if (!var5.hasNext()) {
               return;
            }

            var4 = (FragmentManagerImpl.FragmentLifecycleCallbacksHolder)var5.next();
         } while(var2 && !var4.mRecursive);

         var4.mCallback.onFragmentDestroyed(this, var1);
      }
   }
   ...
   void dispatchOnFragmentDetached(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var4.mCallback.onFragmentDetached(this, var1);
      }
   }
   ...
   void dispatchOnFragmentPaused(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var4.mCallback.onFragmentPaused(this, var1);
      }
   }
   ...
   void dispatchOnFragmentPreAttached(Fragment var1, Context var2, boolean var3) {
      ...
      while(true) {
         ...
         var6.mCallback.onFragmentPreAttached(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentPreCreated(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         ...
         var6.mCallback.onFragmentPreCreated(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentResumed(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         do {
            ...
            var5 = (FragmentManagerImpl.FragmentLifecycleCallbacksHolder)var4.next();
         } while(var2 && !var5.mRecursive);

         var5.mCallback.onFragmentResumed(this, var1);
      }
   }
   ...
   void dispatchOnFragmentSaveInstanceState(Fragment var1, Bundle var2, boolean var3) {
      ...
      while(true) {
         ...
         var5.mCallback.onFragmentSaveInstanceState(this, var1, var2);
      }
   }
   ...
   void dispatchOnFragmentStarted(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var4.mCallback.onFragmentStarted(this, var1);
      }
   }
   ...
   void dispatchOnFragmentStopped(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var4.mCallback.onFragmentStopped(this, var1);
      }
   }
   ...
   void dispatchOnFragmentViewCreated(Fragment var1, View var2, Bundle var3, boolean var4) {
      ...
      while(true) {
         ...
         do {
            ...
            var6 = (FragmentManagerImpl.FragmentLifecycleCallbacksHolder)var7.next();
         } while(var4 && !var6.mRecursive);

         var6.mCallback.onFragmentViewCreated(this, var1, var2, var3);
      }
   }
   ...
   void dispatchOnFragmentViewDestroyed(Fragment var1, boolean var2) {
      ...
      while(true) {
         ...
         var4.mCallback.onFragmentViewDestroyed(this, var1);
      }
   }
   ...
   public boolean dispatchPrepareOptionsMenu(Menu var1) {
      ...
      if (var2 < 1) {
         ...
         boolean var4;
         boolean var6;
         for(var4 = false; var3 < this.mAdded.size(); var4 = var6) {
            Fragment var5 = (Fragment)this.mAdded.get(var3);
            var6 = var4;
            if (var5 != null) {
               var6 = var4;
   ...
   void ensureInflatedFragmentView(Fragment var1) {
      if (var1.mFromLayout && !var1.mPerformedCreateView) {
         var1.performCreateView(var1.performGetLayoutInflater(var1.mSavedFragmentState), (ViewGroup)null, var1.mSavedFragmentState);
         if (var1.mView != null) {
   ...
   void moveFragmentToExpectedState(Fragment var1) {
      if (var1 != null) {
         ...
         if (var1.mView != null) {
            ...
            if (var4 != null) {
               View var5 = var4.mView;
               ViewGroup var6 = var1.mContainer;
               var3 = var6.indexOfChild(var5);
               var2 = var6.indexOfChild(var1.mView);
               if (var2 < var3) {
                  var6.removeViewAt(var2);
                  var6.addView(var1.mView, var3);
               }
            }
      ...
      if (this.mHost == null && var1 != 0) {
         ...
         if (this.mActive != null) {
            ...
            for(var1 = 0; var1 < var3; ++var1) {
               this.moveFragmentToExpectedState((Fragment)this.mAdded.get(var1));
            }
            ...
            for(var1 = 0; var1 < var3; ++var1) {
               ...
               if (var4 != null && (var4.mRemoving || var4.mDetached) && !var4.mIsNewlyAdded) {
   ...
   void moveToState(Fragment var1, int var2, int var3, int var4, boolean var5) {
      ...
      if (var1.mDeferStart && var1.mState < 3 && var9 > 2) {
         var2 = 2;
      } else {
         var2 = var9;
      }
               ...
               case 0:
                  ...
                  if (var2 > 0) {
                     ...
                     if (var1.mSavedFragmentState != null) {
                        ...
                        if (var1.mSavedUserVisibleHint != null) {
                           var1.mUserVisibleHint = var1.mSavedUserVisibleHint;
                           var1.mSavedUserVisibleHint = null;
                        } else {
                     ...
                     FragmentManagerImpl var17;
                     if (this.mParent != null) {
                        var17 = this.mParent.mChildFragmentManager;
                     } else {
                        var17 = this.mHost.getFragmentManagerImpl();
                     }

                     var1.mFragmentManager = var17;
                     if (var1.mTarget != null) {
               ...
               case 1:
                  ...
                  if (var9 > 1) {
                     ...
                     if (!var1.mFromLayout) {
                        ...
                        if (var1.mContainerId != 0) {
                           ...
                           if (var11 == null) {
                              ...
                              if (!var1.mRestored) {
                                 String var19;
                                 try {
                                    var19 = var1.getResources().getResourceName(var1.mContainerId);
                        ...
                        var1.performCreateView(var1.performGetLayoutInflater(var1.mSavedFragmentState), var18, var1.mSavedFragmentState);
                        if (var1.mView == null) {
                           var1.mInnerView = null;
                        } else {
                           var1.mInnerView = var1.mView;
            ...
            if (var1.mState > var2) {
               ...
               case 2:
                  if (var2 < 2) {
                     ...
                     if (var1.mView != null && var1.mContainer != null) {
                        ...
                        FragmentManagerImpl.AnimationOrAnimator var14;
                        if (this.mCurState > 0 && !this.mDestroyed && var1.mView.getVisibility() == 0 && var1.mPostponedAlpha >= 0.0F) {
                           var14 = this.loadAnimation(var1, var3, false, var4);
                        } else {
                           var14 = null;
                        }
                        ...
                        var1.mPostponedAlpha = 0.0F;
                        if (var14 != null) {
                           this.animateRemoveFragment(var1, var14, var2);
                        }
               ...
               case 1:
                  ...
                  if (var2 < 1) {
                     if (this.mDestroyed) {
                        if (var1.getAnimatingAway() != null) {
                           View var15 = var1.getAnimatingAway();
                           var1.setAnimatingAway((View)null);
                           var15.clearAnimation();
                        } else if (var1.getAnimator() != null) {
                           Animator var16 = var1.getAnimator();
                           var1.setAnimator((Animator)null);
                           var16.cancel();
                        }
                     }
   ...
   public void registerFragmentLifecycleCallbacks(FragmentManager.FragmentLifecycleCallbacks var1, boolean var2) {
      this.mLifecycleCallbacks.add(new FragmentManagerImpl.FragmentLifecycleCallbacksHolder(var1, var2));
   }
      ...
      if (this.mActive != null && this.mActive.size() > 0) {
         ...
         for(var6 = false; var5 < var2; ++var5) {
            ...
            if (var7 != null) {
               ...
               FragmentState var14 = new FragmentState(var7);
               var3[var5] = var14;
               StringBuilder var9;
               if (var7.mState > 0 && var14.mSavedFragmentState == null) {
                  var14.mSavedFragmentState = this.saveFragmentBasicState(var7);
                  if (var7.mTarget != null) {
                     ...
                     if (var14.mSavedFragmentState == null) {
                        var14.mSavedFragmentState = new Bundle();
                     }

                     this.putFragment(var14.mSavedFragmentState, "android:target_state", var7.mTarget);
                     if (var7.mTargetRequestCode != 0) {
                        var14.mSavedFragmentState.putInt("android:target_req_state", var7.mTargetRequestCode);
                     }
                  }
               } else {
                  var14.mSavedFragmentState = var7.mSavedFragmentState;
               }
               ...
               if (DEBUG) {
                  ...
                  var9.append(var7);
                  var9.append(": ");
                  var9.append(var14.mSavedFragmentState);
         ...
         if (!var6) {
            ...
            if (var11 > 0) {
               ...
               while(true) {
                  ...
                  var15[var5] = ((Fragment)this.mAdded.get(var5)).mIndex;
                  StringBuilder var13;
                  if (var15[var5] < 0) {
                     var13 = new StringBuilder();
                     var13.append("Failure saving state: active ");
                     var13.append(this.mAdded.get(var5));
                     var13.append(" has cleared index: ");
                     var13.append(var15[var5]);
                     this.throwException(new IllegalStateException(var13.toString()));
                  }

                  if (DEBUG) {
                     var13 = new StringBuilder();
                     var13.append("saveAllState: adding fragment #");
                     var13.append(var5);
                     var13.append(": ");
                     var13.append(this.mAdded.get(var5));
                     Log.v("FragmentManager", var13.toString());
            ...
            BackStackState[] var16 = var1;
            if (this.mBackStack != null) {
               var11 = this.mBackStack.size();
               var16 = var1;
               if (var11 > 0) {
                  var1 = new BackStackState[var11];
                  var5 = var4;
   ...
   void saveNonConfig() {
      ...
      if (this.mActive != null) {
         ...
         while(true) {
            ...
            var6 = var2;
            var7 = var3;
            if (var4 >= this.mActive.size()) {
               break;
            }

            Fragment var8 = (Fragment)this.mActive.valueAt(var4);
            var6 = var1;
            ArrayList var9 = var2;
            var5 = var3;
            if (var8 != null) {
               ...
               if (var8.mRetainInstance) {
                  ...
                  if (var8.mTarget != null) {
                     var10 = var8.mTarget.mIndex;
                  } else {
                     var10 = -1;
                  }

                  var8.mTargetIndex = var10;
                  var7 = var6;
                  if (DEBUG) {
                     StringBuilder var11 = new StringBuilder();
                     var11.append("retainNonConfig: keeping retained ");
                     var11.append(var8);
                     Log.v("FragmentManager", var11.toString());
                     var7 = var6;
                  }
               }

               FragmentManagerNonConfig var12;
               if (var8.mChildFragmentManager != null) {
                  var8.mChildFragmentManager.saveNonConfig();
                  var12 = var8.mChildFragmentManager.mSavedNonConfig;
               } else {
                  var12 = var8.mChildNonConfig;
               }
               ...
               if (var2 == null) {
                  var1 = var2;
                  if (var12 != null) {
                     var2 = new ArrayList(this.mActive.size());
                     var10 = 0;
      ...
      if (var5 == null && var6 == null && var7 == null) {
         ...
         this.mSavedNonConfig = new FragmentManagerNonConfig(var5, var6, var7);
      }
   ...
   public void unregisterFragmentLifecycleCallbacks(FragmentManager.FragmentLifecycleCallbacks var1) {
      ...
      label245: {
         ...
         for(; var3 < var4; ++var3) {
            try {
               if (((FragmentManagerImpl.FragmentLifecycleCallbacksHolder)this.mLifecycleCallbacks.get(var3)).mCallback == var1) {
   ...
   private static class AnimationListenerWrapper implements AnimationListener {
      ...
      AnimationListenerWrapper(AnimationListener var1) {
         this.mWrapped = var1;
      }
