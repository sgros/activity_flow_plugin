...
class MediaSessionCompatApi14 {
    ...
    public static void registerRemoteControlClient(Context context, Object rccObj) {
        ((AudioManager) context.getSystemService(LocusConst.VALUE_TRK_REC_ADD_WAYPOINT_AUDIO)).registerRemoteControlClient((RemoteControlClient) rccObj);
    }

    public static void unregisterRemoteControlClient(Context context, Object rccObj) {
        ((AudioManager) context.getSystemService(LocusConst.VALUE_TRK_REC_ADD_WAYPOINT_AUDIO)).unregisterRemoteControlClient((RemoteControlClient) rccObj);
    }
