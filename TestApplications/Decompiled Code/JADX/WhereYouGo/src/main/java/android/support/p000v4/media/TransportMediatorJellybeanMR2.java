...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00834();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00845();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00823();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00856();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00801();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00812();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C00801 implements OnWindowAttachListener {
        C00801() {
        }
    ...
    class C00812 implements OnWindowFocusChangeListener {
        C00812() {
        }
    ...
    class C00823 extends BroadcastReceiver {
        C00823() {
        }
    ...
    class C00834 implements OnAudioFocusChangeListener {
        C00834() {
        }
    ...
    class C00845 implements OnGetPlaybackPositionListener {
        C00845() {
        }
    ...
    class C00856 implements OnPlaybackPositionUpdateListener {
        C00856() {
        }
