...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f20FS = '\u001c';
    /* renamed from: GS */
    private static final char f21GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';
    /* renamed from: NS */
    private static final char f22NS = '￻';
    private static final char PAD = '￼';
    /* renamed from: RS */
    private static final char f23RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, postcode + f21GS + country + f21GS + service + f21GS);
                    break;
                }
                result.insert(9, postcode + f21GS + country + f21GS + service + f21GS);
                break;
            case 4:
    ...
    private static int getCountry(byte[] bytes) {
        return getInt(bytes, new byte[]{ExtraData.SOURCE_ROUTE_LOCATION, (byte) 54, (byte) 43, (byte) 44, (byte) 45, (byte) 46, (byte) 47, ExtraData.SOURCE_UNKNOWN, (byte) 37, (byte) 38});
    }

    private static int getServiceClass(byte[] bytes) {
        return getInt(bytes, new byte[]{ExtraData.SOURCE_OPENSTREETBUGS, ExtraData.SOURCE_INVISIBLE, ExtraData.SOURCE_POI_OSM_DB, ExtraData.SOURCE_MUNZEE, ExtraData.SOURCE_LIVE_TRACKING, (byte) 60, ExtraData.SOURCE_PARKING_SERVICE, ExtraData.SOURCE_GEOCACHING_WAYPOINT, ExtraData.SOURCE_MAP_TEMP, ExtraData.SOURCE_ROUTE_WAYPOINT});
    }
