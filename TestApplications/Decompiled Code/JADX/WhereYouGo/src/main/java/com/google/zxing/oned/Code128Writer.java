...
public final class Code128Writer extends OneDimensionalCodeWriter {
    ...
    private static int chooseCode(CharSequence value, int start, int oldCode) {
        ...
        if (oldCode != 100) {
            ...
            return lookahead == CType.TWO_DIGITS ? CODE_CODE_C : 100;
            ...
            if (lookahead == CType.FNC_1) {
                return findCType(value, start + 3) == CType.TWO_DIGITS ? CODE_CODE_C : 100;
            } else {
                int index = start + 4;
                while (true) {
                ...
                return lookahead == CType.ONE_DIGIT ? 100 : CODE_CODE_C;
            }
        }
    }
}
