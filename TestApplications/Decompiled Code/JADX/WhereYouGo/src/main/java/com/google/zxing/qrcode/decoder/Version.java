...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(1, GeocachingData.CACHE_SOURCE_OPENCACHING_UK));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(4, GeocachingData.CACHE_SOURCE_OPENCACHING_RO));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(1, GeocachingData.CACHE_SOURCE_OPENCACHING_RO), new ECB(5, GeocachingData.CACHE_SOURCE_OPENCACHING_UK));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, ExtraData.PAR_RTE_COMPUTE_TYPE), new ECB(1, ExtraData.PAR_RTE_SIMPLE_ROUNDABOUTS));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, GeocachingData.CACHE_SOURCE_OPENCACHING_RO), new ECB(5, GeocachingData.CACHE_SOURCE_OPENCACHING_UK));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, ExtraData.PAR_RTE_SIMPLE_ROUNDABOUTS), new ECB(5, 122));
        ...
        iArr = new int[]{6, 28, 54, 80, GeocachingData.CACHE_SOURCE_OPENCACHING_PL};
        eCBlocksArr = new ECBlocks[4];
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(8, GeocachingData.CACHE_SOURCE_OPENCACHING_PL), new ECB(4, GeocachingData.CACHE_SOURCE_OPENCACHING_RO));
        ...
        iArr = new int[]{6, 30, 56, 82, GeocachingData.CACHE_SOURCE_OPENCACHING_UK, 134};
        eCBlocksArr = new ECBlocks[4];
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, ExtraData.PAR_RTE_SIMPLE_ROUNDABOUTS), new ECB(7, 122));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, ExtraData.PAR_RTE_SIMPLE_ROUNDABOUTS), new ECB(14, 122));
        ...
        iArr = new int[]{6, 28, 54, 80, GeocachingData.CACHE_SOURCE_OPENCACHING_PL, 132, 158};
        eCBlocksArr = new ECBlocks[4];
