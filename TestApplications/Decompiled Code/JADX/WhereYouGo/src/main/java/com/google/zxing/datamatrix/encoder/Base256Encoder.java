    ...
    public void encode(EncoderContext context) {
        ...
        if (context.hasMoreCharacters() || mustPad) {
            if (dataCount <= 249) {
                ...
                buffer.setCharAt(0, (char) ((dataCount / MapsforgeActivity.FILE_SYSTEM_CACHE_SIZE_DEFAULT) + 249));
                buffer.insert(1, (char) (dataCount % MapsforgeActivity.FILE_SYSTEM_CACHE_SIZE_DEFAULT));
            } else {
