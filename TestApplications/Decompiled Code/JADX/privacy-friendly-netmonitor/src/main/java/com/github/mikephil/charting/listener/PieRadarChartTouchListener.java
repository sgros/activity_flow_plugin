        ...
        if (!this.mGestureDetector.onTouchEvent(motionEvent) && ((PieRadarChartBase) this.mChart).isRotationEnabled()) {
            ...
            switch (motionEvent.getAction()) {
                case 0:
                    ...
                    this.mTouchStartPoint.f488x = x;
                    this.mTouchStartPoint.f489y = y;
                    break;
                case 1:
                    if (((PieRadarChartBase) this.mChart).isDragDecelerationEnabled()) {
                        stopDeceleration();
                ...
                case 2:
                    ...
                    if (this.mTouchMode == 0 && ChartTouchListener.distance(x, this.mTouchStartPoint.f488x, y, this.mTouchStartPoint.f489y) > Utils.convertDpToPixel(8.0f)) {
