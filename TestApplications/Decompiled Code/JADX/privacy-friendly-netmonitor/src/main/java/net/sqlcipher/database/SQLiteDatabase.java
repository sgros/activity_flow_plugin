...
public class SQLiteDatabase extends SQLiteClosable {
    ...
    /* renamed from: net.sqlcipher.database.SQLiteDatabase$1 */
    static class C05501 implements LibraryLoader {
        C05501() {
        }
    ...
    public static synchronized void loadLibs(Context context, File file) {
        synchronized (SQLiteDatabase.class) {
            loadLibs(context, file, new C05501());
        }
    }
    ...
    L_0x0093:
        ...
        r0.append(r8);
        r5.lock();
        r8 = r0.toString();	 Catch:{ SQLiteDatabaseCorruptException -> 0x012b }
        r8 = r5.compileStatement(r8);	 Catch:{ SQLiteDatabaseCorruptException -> 0x012b }
    ...
    L_0x00cc:
        ...
        r7 = r5.lastChangeCount();	 Catch:{ SQLiteDatabaseCorruptException -> 0x00c9, all -> 0x00c7 }
        r0 = -1;
        if (r7 <= 0) goto L_0x00dc;
    L_0x00d7:
        r2 = r5.lastInsertRow();	 Catch:{ SQLiteDatabaseCorruptException -> 0x00c9, all -> 0x00c7 }
        goto L_0x00dd;
    L_0x00dc:
        r2 = r0;
    L_0x00dd:
    ...
    L_0x00e1:
        ...
        r0 = "Error inserting <redacted values> using <redacted sql> into ";
    ...
    L_0x0101:
        ...
        r0 = " from <redacted values> using <redacted sql> into ";
        r9.append(r0);	 Catch:{ SQLiteDatabaseCorruptException -> 0x00c9, all -> 0x00c7 }
        r9.append(r6);	 Catch:{ SQLiteDatabaseCorruptException -> 0x00c9, all -> 0x00c7 }
        r6 = r9.toString();	 Catch:{ SQLiteDatabaseCorruptException -> 0x00c9, all -> 0x00c7 }
    ...
    L_0x012b:
        r6 = move-exception;
    L_0x012c:
        r5.onCorruption();	 Catch:{ all -> 0x0128 }
        throw r6;	 Catch:{ all -> 0x0128 }
    L_0x0130:
