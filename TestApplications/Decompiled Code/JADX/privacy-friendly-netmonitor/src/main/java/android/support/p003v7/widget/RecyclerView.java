...
import android.support.p003v7.recyclerview.C0309R;
import android.support.p003v7.widget.AdapterHelper.UpdateOp;
import android.support.p003v7.widget.GapWorker.LayoutPrefetchRegistryImpl;
import android.support.p003v7.widget.ViewBoundsCheck.Callback;
import android.support.p003v7.widget.ViewInfoStore.ProcessCallback;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C03583();
    RecyclerViewAccessibilityDelegate mAccessibilityDelegate;
    private final AccessibilityManager mAccessibilityManager;
    private OnItemTouchListener mActiveOnItemTouchListener;
    C0359Adapter mAdapter;
    ...
    static class C03583 implements Interpolator {
    ...
    public static abstract class C0359Adapter<VH extends ViewHolder> {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03601();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03612();
        private int mWidth;
        ...
        public void onAdapterChanged(C0359Adapter c0359Adapter, C0359Adapter c0359Adapter2) {
        }
        ...
        public void setMeasuredDimension(Rect rect, int i, int i2) {
            setMeasuredDimension(LayoutManager.chooseSize(i, (rect.width() + getPaddingLeft()) + getPaddingRight(), getMinimumWidth()), LayoutManager.chooseSize(i2, (rect.height() + getPaddingTop()) + getPaddingBottom(), getMinimumHeight()));
        }
        ...
        public int getItemCount() {
            C0359Adapter adapter = this.mRecyclerView != null ? this.mRecyclerView.getAdapter() : null;
        ...
        public void measureChild(View view, int i, int i2) {
            ...
            i = LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), (getPaddingLeft() + getPaddingRight()) + (i + (itemDecorInsetsForChild.left + itemDecorInsetsForChild.right)), layoutParams.width, canScrollHorizontally());
            i2 = LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), (getPaddingTop() + getPaddingBottom()) + i2, layoutParams.height, canScrollVertically());
        ...
        public boolean shouldReMeasureChild(View view, int i, int i2, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && LayoutManager.isMeasurementUpToDate(view.getMeasuredWidth(), i, layoutParams.width) && LayoutManager.isMeasurementUpToDate(view.getMeasuredHeight(), i2, layoutParams.height)) ? false : true;
        }

        /* Access modifiers changed, original: 0000 */
        public boolean shouldMeasureChild(View view, int i, int i2, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && LayoutManager.isMeasurementUpToDate(view.getWidth(), i, layoutParams.width) && LayoutManager.isMeasurementUpToDate(view.getHeight(), i2, layoutParams.height)) ? false : true;
        }
        ...
        public void measureChildWithMargins(View view, int i, int i2) {
            ...
            Rect itemDecorInsetsForChild = this.mRecyclerView.getItemDecorInsetsForChild(view);
            i2 += itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom;
            i = LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), (((getPaddingLeft() + getPaddingRight()) + layoutParams.leftMargin) + layoutParams.rightMargin) + (i + (itemDecorInsetsForChild.left + itemDecorInsetsForChild.right)), layoutParams.width, canScrollHorizontally());
            i2 = LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), (((getPaddingTop() + getPaddingBottom()) + layoutParams.topMargin) + layoutParams.bottomMargin) + i2, layoutParams.height, canScrollVertically());
            if (shouldMeasureChild(view, i, i2, layoutParams)) {
                view.measure(i, i2);
            }
        }
    ...
    public static class RecycledViewPool {
        ...
        /* Access modifiers changed, original: 0000 */
        public void attach(C0359Adapter c0359Adapter) {
            this.mAttachCount++;
        }
        ...
        /* Access modifiers changed, original: 0000 */
        public void onAdapterChanged(C0359Adapter c0359Adapter, C0359Adapter c0359Adapter2, boolean z) {
            if (c0359Adapter != null) {
                detach();
            }
            if (!z && this.mAttachCount == 0) {
                clear();
            }
            if (c0359Adapter2 != null) {
                attach(c0359Adapter2);
            }
        }
    ...
    public final class Recycler {
        ...
        L_0x0008:
            r1 = android.support.p003v7.widget.RecyclerView.this;
            r1 = r1.mState;
            r1 = r1.getItemCount();
        ...
        L_0x0045:
            r5 = android.support.p003v7.widget.RecyclerView.this;
            r9 = r1.itemView;
        ...
        L_0x006b:
            r9 = android.support.p003v7.widget.RecyclerView.this;
            r9 = r9.mAdapter;
            r9 = r9.getItemCount();
        ...
        L_0x0077:
            ...
            r10 = android.support.p003v7.widget.RecyclerView.this;
            r10 = r10.mAdapter;
        ...
        L_0x00b0:
            ...
            r1.append(r2);
            r2 = android.support.p003v7.widget.RecyclerView.this;
        ...
        L_0x00fc:
            r1.resetInternal();
            r0 = android.support.p003v7.widget.RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST;
        ...
        L_0x0106:
            if (r1 != 0) goto L_0x018f;
        L_0x0108:
            r0 = android.support.p003v7.widget.RecyclerView.this;
            r0 = r0.getNanoTime();
        ...
        L_0x0124:
            ...
            r5 = android.support.p003v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
            if (r5 == 0) goto L_0x0143;
        L_0x0134:
            r5 = r2.itemView;
            r5 = android.support.p003v7.widget.RecyclerView.findNestedRecyclerView(r5);
            if (r5 == 0) goto L_0x0143;
        L_0x013c:
        ...
        L_0x01a5:
            ...
            if (r0 == 0) goto L_0x01cb;
        L_0x01b0:
            r0 = android.support.p003v7.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(r10);
            r0 = r0 | 4096;
            r1 = android.support.p003v7.widget.RecyclerView.this;
            r1 = r1.mItemAnimator;
            r2 = android.support.p003v7.widget.RecyclerView.this;
        ...
        L_0x020b:
            ...
            r1 = (android.support.p003v7.widget.RecyclerView.LayoutParams) r1;
            r2 = r10.itemView;
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                int i = (RecyclerView.this.mAdapter != null && access$900 && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) ? 1 : false;
        ...
        public void onAdapterChanged(C0359Adapter c0359Adapter, C0359Adapter c0359Adapter2, boolean z) {
            clear();
            getRecycledViewPool().onAdapterChanged(c0359Adapter, c0359Adapter2, z);
        }
    ...
    public static class State {
        ...
        /* Access modifiers changed, original: 0000 */
        public void prepareForNestedPrefetch(C0359Adapter c0359Adapter) {
            this.mLayoutStep = 1;
            this.mItemCount = c0359Adapter.getItemCount();
    ...
    class ViewFlinger implements Runnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:56:0x0140  */
        /* JADX WARNING: Missing block: B:52:0x0134, code skipped:
     ...
     */
        ...
        L_0x0023:
            r3 = android.support.p003v7.widget.RecyclerView.this;
        ...
        L_0x0071:
            ...
            r5 = android.support.p003v7.widget.RecyclerView.this;
            r5 = r5.mRecycler;
            r7 = android.support.p003v7.widget.RecyclerView.this;
            r7 = r7.mState;
        ...
        L_0x0088:
            r7 = android.support.p003v7.widget.RecyclerView.this;
            r7 = r7.mLayout;
            r8 = android.support.p003v7.widget.RecyclerView.this;
            r8 = r8.mRecycler;
            r9 = android.support.p003v7.widget.RecyclerView.this;
            r9 = r9.mState;
        ...
        L_0x0106:
            r15 = android.support.p003v7.widget.RecyclerView.this;
            r20 = 0;
            r21 = 1;
            r16 = r3;
            r17 = r7;
        ...
        L_0x0137:
            r9 = r4;
        L_0x0138:
            r4 = android.support.p003v7.widget.RecyclerView.this;
        ...
        L_0x01c4:
            ...
            r1 = android.support.p003v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
    ...
    class C05414 implements ProcessCallback {
        C05414() {
        }
    ...
    class C05425 implements ChildHelper.Callback {
        C05425() {
        }
    ...
    class C05436 implements AdapterHelper.Callback {
        C05436() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03621 implements ClassLoaderCreator<SavedState> {
            C03621() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C03561();
        ...
        this.mItemAnimatorRunner = new C03572();
        this.mViewInfoProcessCallback = new C05414();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0309R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0309R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0309R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0309R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0309R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0309R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0309R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0309R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C05425());
    }

    /* Access modifiers changed, original: 0000 */
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C05436());
    }
    ...
    public void swapAdapter(C0359Adapter c0359Adapter, boolean z) {
        setLayoutFrozen(false);
        setAdapterInternal(c0359Adapter, true, z);
        requestLayout();
    }

    public void setAdapter(C0359Adapter c0359Adapter) {
        setLayoutFrozen(false);
        setAdapterInternal(c0359Adapter, false, true);
        requestLayout();
    }
    ...
    private void setAdapterInternal(C0359Adapter c0359Adapter, boolean z, boolean z2) {
        ...
        C0359Adapter c0359Adapter2 = this.mAdapter;
        this.mAdapter = c0359Adapter;
        if (c0359Adapter != null) {
            c0359Adapter.registerAdapterDataObserver(this.mObserver);
            c0359Adapter.onAttachedToRecyclerView(this);
        }
        if (this.mLayout != null) {
            this.mLayout.onAdapterChanged(c0359Adapter2, this.mAdapter);
        }
        this.mRecycler.onAdapterChanged(c0359Adapter2, this.mAdapter, z);
        this.mState.mStructureChanged = true;
        setDataSetChangedAfterLayout();
    }

    public C0359Adapter getAdapter() {
    ...
    L_0x0026:
        r0 = android.support.p003v7.widget.GapWorker.sGapWorker;
        r0 = r0.get();
        r0 = (android.support.p003v7.widget.GapWorker) r0;
        r4.mGapWorker = r0;
        r0 = r4.mGapWorker;
    ...
    L_0x0034:
        ...
        r0.<init>();
        r4.mGapWorker = r0;
        r0 = android.support.p000v4.view.ViewCompat.getDisplay(r4);
    ...
    private void dispatchLayoutStep1() {
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (childCount = 0; childCount < this.mChildHelper.getChildCount(); childCount++) {
                ViewHolder childViewHolderInt2 = RecyclerView.getChildViewHolderInt(this.mChildHelper.getChildAt(childCount));
    ...
    private void dispatchLayoutStep3() {
        ...
        if (this.mState.mRunSimpleAnimations) {
            for (int childCount = this.mChildHelper.getChildCount() - 1; childCount >= 0; childCount--) {
                ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(this.mChildHelper.getChildAt(childCount));
                if (!childViewHolderInt.shouldIgnore()) {
    ...
    public void offsetPositionRecordsForMove(int i, int i2) {
        ...
        for (int i6 = 0; i6 < unfilteredChildCount; i6++) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(i6));
    ...
    public void offsetPositionRecordsForRemove(int i, int i2, boolean z) {
        ...
        for (int i4 = 0; i4 < unfilteredChildCount; i4++) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(this.mChildHelper.getUnfilteredChildAt(i4));
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0309R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0309R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0309R.dimen.fastscroll_margin));
    }
