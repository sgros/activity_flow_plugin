...
public class TextInputLayout extends LinearLayout {
    ...
    class C00661 implements TextWatcher {
    ...
    class C00705 implements AnimatorUpdateListener {
        C00705() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C00711 implements ClassLoaderCreator<SavedState> {
            C00711() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0023R.styleable.TextInputLayout, i, C0023R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = obtainStyledAttributes.getBoolean(C0023R.styleable.TextInputLayout_hintEnabled, true);
        setHint(obtainStyledAttributes.getText(C0023R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = obtainStyledAttributes.getBoolean(C0023R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (obtainStyledAttributes.hasValue(C0023R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0023R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (obtainStyledAttributes.getResourceId(C0023R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(obtainStyledAttributes.getResourceId(C0023R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = obtainStyledAttributes.getResourceId(C0023R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean z = obtainStyledAttributes.getBoolean(C0023R.styleable.TextInputLayout_errorEnabled, false);
        boolean z2 = obtainStyledAttributes.getBoolean(C0023R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(obtainStyledAttributes.getInt(C0023R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = obtainStyledAttributes.getResourceId(C0023R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = obtainStyledAttributes.getResourceId(C0023R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = obtainStyledAttributes.getBoolean(C0023R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = obtainStyledAttributes.getDrawable(C0023R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = obtainStyledAttributes.getText(C0023R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (obtainStyledAttributes.hasValue(C0023R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = obtainStyledAttributes.getColorStateList(C0023R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (obtainStyledAttributes.hasValue(C0023R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0023R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00661());
    ...
    L_0x0014:
        ...
        r5.mErrorView = r1;
        r1 = r5.mErrorView;
        r2 = android.support.design.C0023R.C0022id.textinput_error;
        r1.setId(r2);
        r1 = r5.mTypeface;
    ...
    L_0x0054:
        r2 = r5.mErrorView;
        r3 = android.support.p003v7.appcompat.C0305R.style.TextAppearance_AppCompat_Caption;
        android.support.p000v4.widget.TextViewCompat.setTextAppearance(r2, r3);
        r2 = r5.mErrorView;
        r3 = r5.getContext();
        r4 = android.support.p003v7.appcompat.C0305R.color.error_color_material;
        r3 = android.support.p000v4.content.ContextCompat.getColor(r3, r4);
        r2.setTextColor(r3);
    L_0x006a:
        r2 = r5.mErrorView;
        r3 = 4;
    ...
    private void setError(@Nullable final CharSequence charSequence, boolean z) {
        ...
        if (this.mErrorShown) {
            ...
            if (z) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00672()).start();
            } else {
    ...
    public void setCounterEnabled(boolean z) {
        if (this.mCounterEnabled != z) {
            if (z) {
                ...
                this.mCounterView.setId(C0023R.C0022id.textinput_counter);
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0305R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0305R.color.error_color_material));
                }
    ...
    public void updateCounter(int i) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0023R.string.character_counter_pattern, new Object[]{Integer.valueOf(i), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00694());
                }
    ...
    public void animateToExpansionFraction(float f) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != f) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C00705());
            }
