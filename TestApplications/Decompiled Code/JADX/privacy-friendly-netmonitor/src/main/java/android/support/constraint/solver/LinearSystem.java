...
public class LinearSystem {
    ...
    private int enforceBFS(Goal goal) throws Exception {
        ...
        while (i3 < this.mNumRows) {
            if (this.mRows[i3].variable.mType != Type.UNRESTRICTED && this.mRows[i3].constantValue < 0.0f) {
                obj = 1;
                break;
            }
            i3++;
            ...
            while (obj == null) {
                ...
                for (int i7 = 0; i7 < this.mNumRows; i7++) {
                    ...
                    if (arrayRow.variable.mType != Type.UNRESTRICTED && arrayRow.constantValue < 0.0f) {
                        ...
                        int i9 = i5;
                        i5 = i4;
                        for (i4 = 1; i4 < this.mNumColumns; i4++) {
                ...
                if (i4 != -1) {
                    ...
                    for (int i10 = 0; i10 < this.mNumRows; i10++) {
                        this.mRows[i10].updateRowWithEquation(arrayRow2);
                    }
                    goal.updateFromSystem(this);
                } else {
                    Goal goal2 = goal;
        ...
        i2 = 0;
        while (i2 < this.mNumRows && (this.mRows[i2].variable.mType == Type.UNRESTRICTED || this.mRows[i2].constantValue >= 0.0f)) {
            i2++;
        }
        return i;
    }
