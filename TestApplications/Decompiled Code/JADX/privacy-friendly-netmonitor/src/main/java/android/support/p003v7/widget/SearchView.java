...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C036410 implements TextWatcher {
    ...
    class C03673 implements OnFocusChangeListener {
        C03673() {
        }
    ...
    class C03684 implements OnLayoutChangeListener {
        C03684() {
        }
    ...
    class C03695 implements OnClickListener {
        C03695() {
        }
    ...
    class C03706 implements OnKeyListener {
        C03706() {
        }
    ...
    class C03717 implements OnEditorActionListener {
        C03717() {
        }
    ...
    class C03728 implements OnItemClickListener {
        C03728() {
        }
    ...
    class C03739 implements OnItemSelectedListener {
     ...
     */
        ...
        L_0x003c:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.SearchView$AutoCompleteTextViewReflector.<init>():void");
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0305R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C03751();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0305R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C03651();
        this.mReleaseCursorRunnable = new C03662();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03695();
        this.mTextKeyListener = new C03706();
        this.mOnEditorActionListener = new C03717();
        this.mOnItemClickListener = new C03728();
        this.mOnItemSelectedListener = new C03739();
        this.mTextWatcher = new C036410();
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0305R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0305R.styleable.SearchView_layout, C0305R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0305R.C0304id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0305R.C0304id.search_edit_frame);
        this.mSearchPlate = findViewById(C0305R.C0304id.search_plate);
        this.mSubmitArea = findViewById(C0305R.C0304id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0305R.C0304id.search_button);
        this.mGoButton = (ImageView) findViewById(C0305R.C0304id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0305R.C0304id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0305R.C0304id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0305R.C0304id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0305R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0305R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0305R.styleable.SearchView_suggestionRowLayout, C0305R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0305R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03673());
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0305R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0305R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0305R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0305R.styleable.SearchView_queryHint);
        dimensionPixelSize = obtainStyledAttributes.getInt(C0305R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0305R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0305R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C03684());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0305R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0305R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0305R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0305R.dimen.abc_dropdownitem_text_padding_left) : 0;
