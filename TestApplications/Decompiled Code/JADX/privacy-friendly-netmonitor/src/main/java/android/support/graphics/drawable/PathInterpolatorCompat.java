...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        stringBuilder2.append(this.f15mX[0]);
        stringBuilder2.append(",");
        stringBuilder2.append(this.f16mY[0]);
        stringBuilder2.append(" end:");
        min--;
        stringBuilder2.append(this.f15mX[min]);
        stringBuilder2.append(",");
        stringBuilder2.append(this.f16mY[min]);
    ...
    public float getInterpolation(float f) {
        ...
        return f3 + (f * (this.f16mY[length] - f3));
    }
}
