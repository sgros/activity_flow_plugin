...
public final class BidiFormatter {
    ...
    private String markAfter(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        ...
        if (this.mIsRtlContext || (!isRtl && BidiFormatter.getExitDir(charSequence) != 1)) {
            return (!this.mIsRtlContext || (isRtl && BidiFormatter.getExitDir(charSequence) != -1)) ? "" : RLM_STRING;
        } else {
            return LRM_STRING;
        }
    }
    ...
    private String markBefore(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        boolean isRtl = textDirectionHeuristicCompat.isRtl(charSequence, 0, charSequence.length());
        if (this.mIsRtlContext || (!isRtl && BidiFormatter.getEntryDir(charSequence) != 1)) {
            return (!this.mIsRtlContext || (isRtl && BidiFormatter.getEntryDir(charSequence) != -1)) ? "" : RLM_STRING;
        } else {
            return LRM_STRING;
        }
    }
