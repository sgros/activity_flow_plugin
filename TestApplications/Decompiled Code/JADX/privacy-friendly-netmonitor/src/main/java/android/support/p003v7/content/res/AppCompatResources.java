...
public final class AppCompatResources {
    ...
    public static ColorStateList getColorStateList(@NonNull Context context, @ColorRes int i) {
        ...
        ColorStateList cachedColorStateList = AppCompatResources.getCachedColorStateList(context, i);
        if (cachedColorStateList != null) {
            return cachedColorStateList;
        }
        cachedColorStateList = AppCompatResources.inflateColorStateList(context, i);
        if (cachedColorStateList == null) {
            return ContextCompat.getColorStateList(context, i);
        }
        AppCompatResources.addColorStateListToCache(context, i, cachedColorStateList);
        return cachedColorStateList;
    }
    ...
    private static ColorStateList inflateColorStateList(Context context, int i) {
        if (AppCompatResources.isColorInt(context, i)) {
            return null;
        }
    ...
    L_0x0013:
        ...
        r2 = (android.support.p003v7.content.res.AppCompatResources.ColorStateListCacheEntry) r2;	 Catch:{ all -> 0x0035 }
        if (r2 == 0) goto L_0x0032;
    L_0x001b:
