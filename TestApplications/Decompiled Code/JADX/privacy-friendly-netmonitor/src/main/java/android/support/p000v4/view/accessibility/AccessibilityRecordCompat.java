...
public class AccessibilityRecordCompat {
    ...
    public void setSource(View view, int i) {
        AccessibilityRecordCompat.setSource(this.mRecord, view, i);
    }
    ...
    public void setMaxScrollX(int i) {
        AccessibilityRecordCompat.setMaxScrollX(this.mRecord, i);
    }
    ...
    public void setMaxScrollY(int i) {
        AccessibilityRecordCompat.setMaxScrollY(this.mRecord, i);
    }
