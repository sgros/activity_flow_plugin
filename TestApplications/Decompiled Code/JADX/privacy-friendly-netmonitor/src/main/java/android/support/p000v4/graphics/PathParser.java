...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        public static void nodesToPath(PathDataNode[] pathDataNodeArr, Path path) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                PathDataNode.addCommand(path, fArr, c, pathDataNodeArr[i].mType, pathDataNodeArr[i].mParams);
     ...
     */
        /* JADX WARNING: Missing block: B:51:0x0180, code skipped:
            ...
            r11 = r8;
            r26 = r9;
            android.support.p000v4.graphics.PathParser.PathDataNode.drawArc(r10, r8, r7, r3, r4, r5, r6, r23, r24, r25);
            r8 = r11 + r13[r14];
            r7 = r12 + r13[r15];
     */
     ...
     */
        /* JADX WARNING: Missing block: B:88:0x02c9, code skipped:
            android.support.p000v4.graphics.PathParser.PathDataNode.drawArc(r10, r11, r12, r3, r4, r5, r6, r7, r8, r9);
            r8 = r13[r14];
            r7 = r13[r15];
     */
     ...
     */
        ...
        L_0x0180:
            ...
            r26 = r9;
            r9 = r25;
            android.support.p000v4.graphics.PathParser.PathDataNode.drawArc(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            r0 = r13[r14];
            r8 = r11 + r0;
            r0 = r13[r15];
            r7 = r12 + r0;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (cos < Utils.DOUBLE_EPSILON) {
                ...
                PathDataNode.drawArc(path, f, f2, f9, f4, f10 * f8, f11 * f8, f7, z, z2);
                return;
            }
            boolean z4 = z2;
            ...
            if (z4 != (atan2 >= Utils.DOUBLE_EPSILON)) {
                atan2 = atan2 > Utils.DOUBLE_EPSILON ? atan2 - 6.283185307179586d : atan2 + 6.283185307179586d;
            }
            d11 *= d9;
            d12 *= toRadians;
            PathDataNode.arcToBezier(path, (d11 * d14) - (d12 * d13), (d11 * d13) + (d12 * d14), d9, toRadians, d3, d5, d2, sqrt, atan2);
        }
    ...
    public static Path createPathFromPathData(String str) {
        Path path = new Path();
        PathDataNode[] createNodesFromPathData = PathParser.createNodesFromPathData(str);
    ...
    public static PathDataNode[] createNodesFromPathData(String str) {
        ...
        int i2 = 0;
        while (i < str.length()) {
            i = PathParser.nextStart(str, i);
            String trim = str.substring(i2, i).trim();
            if (trim.length() > 0) {
                PathParser.addNode(arrayList, trim.charAt(0), PathParser.getFloats(trim));
            }
            i2 = i;
            i++;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            PathParser.addNode(arrayList, str.charAt(i2), new float[0]);
        }
    ...
    /* JADX WARNING: Missing block: B:17:0x002c, code skipped:
            return false;
     */
    public static boolean canMorph(android.support.p000v4.graphics.PathParser.PathDataNode[] r4, android.support.p000v4.graphics.PathParser.PathDataNode[] r5) {
        /*
        r0 = 0;
    ...
    L_0x002c:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.graphics.PathParser.canMorph(android.support.v4.graphics.PathParser$PathDataNode[], android.support.v4.graphics.PathParser$PathDataNode[]):boolean");
    }
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            int i2 = 0;
            while (i < length) {
                PathParser.extract(str, i, extractFloatResult);
            ...
            return PathParser.copyOfRange(fArr, 0, i2);
