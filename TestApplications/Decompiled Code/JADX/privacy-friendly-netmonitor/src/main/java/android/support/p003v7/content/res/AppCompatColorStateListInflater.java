...
final class AppCompatColorStateListInflater {
    ...
    L_0x0011:
        ...
        throw r4;
    L_0x0019:
        r4 = android.support.p003v7.content.res.AppCompatColorStateListInflater.createFromXmlInner(r4, r5, r0, r6);
        return r4;
        */
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                TypedArray obtainAttributes = AppCompatColorStateListInflater.obtainAttributes(resources, theme, attributeSet2, C0305R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0305R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0305R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0305R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0305R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0305R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                while (i3 < next) {
                    ...
                    if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0305R.attr.alpha)) {
                        i = i4 + 1;
                ...
                next = AppCompatColorStateListInflater.modulateColorAlpha(color, f);
                if (i2 != 0) {
