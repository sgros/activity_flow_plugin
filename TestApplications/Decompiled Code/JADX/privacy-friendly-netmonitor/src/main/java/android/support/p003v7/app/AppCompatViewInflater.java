...
class AppCompatViewInflater {
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z2 || z3) {
            context2 = AppCompatViewInflater.themifyContext(context2, attributeSet, z2, z3);
        }
        if (z4) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0305R.styleable.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C0305R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(C0305R.styleable.View_theme, 0);
            if (resourceId != 0) {
