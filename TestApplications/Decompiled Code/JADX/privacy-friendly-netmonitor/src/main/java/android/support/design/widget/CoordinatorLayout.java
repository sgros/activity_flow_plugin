...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0023R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0023R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0023R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0023R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0023R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0023R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0023R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0023R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0023R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
    ...
    class C05071 implements OnApplyWindowInsetsListener {
        C05071() {
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0023R.styleable.CoordinatorLayout, i, C0023R.style.Widget_Design_CoordinatorLayout);
        int i2 = 0;
        i = obtainStyledAttributes.getResourceId(C0023R.styleable.CoordinatorLayout_keylines, 0);
        if (i != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0023R.styleable.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r32, int r33) {
        ...
        r10 = android.support.p000v4.view.ViewCompat.getLayoutDirection(r31);
        r2 = 1;
    ...
    L_0x0042:
        r3 = android.support.p000v4.view.ViewCompat.getFitsSystemWindows(r31);
        if (r3 == 0) goto L_0x004b;
    L_0x0048:
        r19 = r2;
        goto L_0x004d;
    ...
    L_0x007f:
        ...
        r2 = android.support.p000v4.view.GravityCompat.getAbsoluteGravity(r2, r10);
        r2 = r2 & 7;
        r22 = r3;
        r3 = 3;
    ...
    L_0x00c6:
        r0 = android.support.p000v4.view.ViewCompat.getFitsSystemWindows(r1);
    ...
    private void offsetChildByInset(android.view.View r9, android.graphics.Rect r10, int r11) {
        /*
        r8 = this;
        r0 = android.support.p000v4.view.ViewCompat.isLaidOut(r9);
    ...
    L_0x007f:
        ...
        r11 = android.support.p000v4.view.GravityCompat.getAbsoluteGravity(r1, r11);
        r1 = r11 & 48;
        r3 = 48;
        r4 = 1;
        r5 = 0;
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C05071();
                }
