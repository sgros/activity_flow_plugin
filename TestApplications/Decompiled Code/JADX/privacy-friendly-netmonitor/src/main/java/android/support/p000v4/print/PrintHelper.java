    ...
    private static class PrintHelperApi19 implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String str, Bitmap bitmap, OnPrintFinishCallback onPrintFinishCallback) {
            if (bitmap != null) {
                ...
                if (PrintHelperApi19.isPortrait(bitmap)) {
        ...
        private void writeBitmap(PrintAttributes printAttributes, int i, Bitmap bitmap, ParcelFileDescriptor parcelFileDescriptor, CancellationSignal cancellationSignal, WriteResultCallback writeResultCallback) {
            ...
            new AsyncTask<Void, Void, Throwable>() {
                ...
                L_0x000a:
                    ...
                    r1 = android.support.p000v4.print.PrintHelper.PrintHelperApi19.this;	 Catch:{ Throwable -> 0x00ea }
                ...
                L_0x002c:
                    ...
                    r4 = android.support.p000v4.print.PrintHelper.PrintHelperApi19.this;	 Catch:{ all -> 0x00d5 }
                ...
                L_0x0045:
                    ...
                    r5 = android.support.p000v4.print.PrintHelper.PrintHelperApi19.this;	 Catch:{ all -> 0x00d5 }
        ...
        public void printBitmap(String str, Uri uri, OnPrintFinishCallback onPrintFinishCallback) throws FileNotFoundException {
            ...
            final Uri uri2 = uri;
            final OnPrintFinishCallback onPrintFinishCallback2 = onPrintFinishCallback;
            C02223 c02223 = new PrintDocumentAdapter() {
                private PrintAttributes mAttributes;
                Bitmap mBitmap = null;
                ...
                public void onLayout(PrintAttributes printAttributes, PrintAttributes printAttributes2, CancellationSignal cancellationSignal, LayoutResultCallback layoutResultCallback, Bundle bundle) {
                    ...
                    if (cancellationSignal.isCanceled()) {
                        ...
                        this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                            ...
                            class C02201 implements OnCancelListener {
                                C02201() {
                                }

                                public void onCancel() {
                                    C02223.this.cancelLoad();
                            ...
                            public void onPreExecute() {
                                cancellationSignal2.setOnCancelListener(new C02201());
                            }
                            ...
                            public void onPostExecute(Bitmap bitmap) {
                                ...
                                if (bitmap != null && (!PrintHelperApi19.this.mPrintActivityRespectsOrientation || PrintHelperApi19.this.mOrientation == 0)) {
                                    MediaSize mediaSize;
                                    synchronized (this) {
                                        mediaSize = C02223.this.mAttributes.getMediaSize();
                                    }
            ...
            printManager.print(str, c02223, builder.build());
        }
