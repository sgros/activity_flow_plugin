...
import android.support.p003v7.widget.helper.ItemTouchUIUtilImpl.Api21Impl;
import android.support.p003v7.widget.helper.ItemTouchUIUtilImpl.BaseImpl;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* renamed from: UP */
    public static final int f484UP = 1;
    int mActionState = 0;
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C05472();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C03881();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C03901();
        private static final Interpolator sDragViewScrollCapInterpolator = new C03912();
        ...
        static class C03912 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        public static int makeMovementFlags(int i, int i2) {
            return Callback.makeFlag(2, i) | (Callback.makeFlag(1, i2) | Callback.makeFlag(0, i2 | i));
        }
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas2, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f40mX, recoverAnimation.f41mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas2.save();
                onChildDrawOver(canvas2, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f40mX, recoverAnimation.f41mY, recoverAnimation.mActionState, false);
                canvas2.restoreToCount(save);
            }
            if (viewHolder != null) {
                i2 = canvas2.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C03921 implements AnimatorUpdateListener {
            C03921() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new C03921());
        ...
        public void update() {
            if (this.mStartDx == this.mTargetX) {
                ...
                this.f40mX = this.mStartDx + (this.mFraction * (this.mTargetX - this.mStartDx));
            }
            if (this.mStartDy == this.mTargetY) {
                this.f41mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f41mY = this.mStartDy + (this.mFraction * (this.mTargetY - this.mStartDy));
            }
        }
    ...
    class C05472 implements OnItemTouchListener {
        C05472() {
        }
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ItemTouchHelper itemTouchHelper = ItemTouchHelper.this;
                        itemTouchHelper.mInitialTouchX -= findAnimation.f40mX;
                        itemTouchHelper = ItemTouchHelper.this;
                        itemTouchHelper.mInitialTouchY -= findAnimation.f41mY;
    ...
    class C05495 implements ChildDrawingOrderCallback {
        C05495() {
        }
    ...
    L_0x0094:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.helper.ItemTouchHelper.checkSelectForSwipe(int, android.view.MotionEvent, int):boolean");
    }
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (ItemTouchHelper.hitTest(view2, x, y, recoverAnimation.f40mX, recoverAnimation.f41mY)) {
                return view2;
            }
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C05495();
            }
