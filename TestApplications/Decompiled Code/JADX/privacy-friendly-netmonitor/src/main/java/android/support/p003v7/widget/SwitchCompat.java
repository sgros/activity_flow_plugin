...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0305R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0305R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0305R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0305R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C0305R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0305R.styleable.SwitchCompat_android_textOff);
        this.mShowText = obtainStyledAttributes.getBoolean(C0305R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C0305R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C0305R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C0305R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C0305R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0305R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0305R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        colorStateList = obtainStyledAttributes.getColorStateList(C0305R.styleable.SwitchCompat_trackTint);
        if (colorStateList != null) {
            this.mTrackTintList = colorStateList;
            this.mHasTrackTint = true;
        }
        parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0305R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        i = obtainStyledAttributes.getResourceId(C0305R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (i != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        i = obtainStyledAttributes.getDimensionPixelSize(C0305R.styleable.TextAppearance_android_textSize, 0);
        if (i != 0) {
            float f = (float) i;
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C0305R.styleable.TextAppearance_android_typeface, -1), obtainStyledAttributes.getInt(C0305R.styleable.TextAppearance_android_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(C0305R.styleable.TextAppearance_textAllCaps, false)) {
            ...
            case 2:
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        x = SwitchCompat.constrain(this.mThumbPosition + y, 0.0f, 1.0f);
