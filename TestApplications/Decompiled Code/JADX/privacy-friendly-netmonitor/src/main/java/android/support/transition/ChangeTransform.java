...
public class ChangeTransform extends Transition {
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0110R.C0109id.transition_transform, null);
            this.mView.setTag(C0110R.C0109id.parent_matrix, null);
        }
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0110R.C0109id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0110R.C0109id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z) {
        ...
        final boolean z2 = z;
        C01033 c01033 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (z2 && ChangeTransform.this.mUseOverlay) {
                        ...
                        view.setTag(C0110R.C0109id.transition_transform, null);
                        view.setTag(C0110R.C0109id.parent_matrix, null);
                    }
                }
            ...
            private void setCurrentMatrix(Matrix matrix) {
                ...
                view.setTag(C0110R.C0109id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
        ofPropertyValuesHolder.addListener(c01033);
        AnimatorUtils.addPauseListener(ofPropertyValuesHolder, c01033);
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0110R.C0109id.parent_matrix, matrix);
