...
class FocusStrategy {
    ...
    public static <L, T> T findNextFocusInRelativeDirection(@NonNull L l, @NonNull CollectionAdapter<L, T> collectionAdapter, @NonNull BoundsAdapter<T> boundsAdapter, @Nullable T t, int i, boolean z, boolean z2) {
        ...
        switch (i) {
            case 1:
                return FocusStrategy.getPreviousFocusable(t, arrayList, z2);
            case 2:
                return FocusStrategy.getNextFocusable(t, arrayList, z2);
            default:
    ...
    public static <L, T> T findNextFocusInAbsoluteDirection(@NonNull L l, @NonNull CollectionAdapter<L, T> collectionAdapter, @NonNull BoundsAdapter<T> boundsAdapter, @Nullable T t, @NonNull Rect rect, int i) {
        ...
        while (i2 < size) {
            ...
            if (t3 != t) {
                ...
                if (FocusStrategy.isBetterCandidate(i, rect, rect3, rect2)) {
                    rect2.set(rect3);
                    t2 = t3;
                }
            }
    ...
    private static boolean isBetterCandidate(int i, @NonNull Rect rect, @NonNull Rect rect2, @NonNull Rect rect3) {
        boolean z = false;
        if (!FocusStrategy.isCandidate(rect, rect2, i)) {
            return false;
        }
        if (!FocusStrategy.isCandidate(rect, rect3, i) || FocusStrategy.beamBeats(i, rect, rect2, rect3)) {
            return true;
        }
        if (FocusStrategy.beamBeats(i, rect, rect3, rect2)) {
            return false;
        }
        if (FocusStrategy.getWeightedDistanceFor(FocusStrategy.majorAxisDistance(i, rect, rect2), FocusStrategy.minorAxisDistance(i, rect, rect2)) < FocusStrategy.getWeightedDistanceFor(FocusStrategy.majorAxisDistance(i, rect, rect3), FocusStrategy.minorAxisDistance(i, rect, rect3))) {
            z = true;
        }
        return z;
    }
    ...
    private static boolean beamBeats(int i, @NonNull Rect rect, @NonNull Rect rect2, @NonNull Rect rect3) {
        boolean beamsOverlap = FocusStrategy.beamsOverlap(i, rect, rect2);
        if (FocusStrategy.beamsOverlap(i, rect, rect3) || !beamsOverlap) {
            return false;
        }
        boolean z = true;
        if (!FocusStrategy.isToDirectionOf(i, rect, rect3) || i == 17 || i == 66) {
            return true;
        }
        if (FocusStrategy.majorAxisDistance(i, rect, rect2) >= FocusStrategy.majorAxisDistanceToFarEdge(i, rect, rect3)) {
            z = false;
        }
        return z;
    }
    ...
    private static int majorAxisDistance(int i, @NonNull Rect rect, @NonNull Rect rect2) {
        return Math.max(0, FocusStrategy.majorAxisDistanceRaw(i, rect, rect2));
    }
    ...
    private static int majorAxisDistanceToFarEdge(int i, @NonNull Rect rect, @NonNull Rect rect2) {
        return Math.max(1, FocusStrategy.majorAxisDistanceToFarEdgeRaw(i, rect, rect2));
    }
