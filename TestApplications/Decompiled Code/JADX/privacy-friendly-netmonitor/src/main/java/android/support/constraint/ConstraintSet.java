...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0009R.styleable.ConstraintSet_layout_constraintLeft_creator, 60);
        mapToConstant.append(C0009R.styleable.ConstraintSet_layout_constraintTop_creator, 60);
        mapToConstant.append(C0009R.styleable.ConstraintSet_layout_constraintRight_creator, 60);
        mapToConstant.append(C0009R.styleable.ConstraintSet_layout_constraintBottom_creator, 60);
        mapToConstant.append(C0009R.styleable.ConstraintSet_layout_constraintBaseline_creator, 60);
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0009R.styleable.ConstraintSet);
