...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C03771();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C03771 implements Creator<FullSpanItem> {
                C03771() {
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C03781 implements Creator<SavedState> {
            C03781() {
            }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCheckForGapsRunnable = new C03761();
    ...
    L_0x0030:
        ...
        r8 = (android.support.p003v7.widget.StaggeredGridLayoutManager.LayoutParams) r8;
        r9 = r8.mSpan;
        r9 = r9.mIndex;
        r9 = r2.get(r9);
    ...
    L_0x008d:
        ...
        r9 = (android.support.p003v7.widget.StaggeredGridLayoutManager.LayoutParams) r9;
        r8 = r8.mSpan;
        r8 = r8.mIndex;
        r9 = r9.mSpan;
        r9 = r9.mIndex;
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (isLayoutRTL() && this.mOrientation == 1) {
                if (layoutParams.mFullSpan) {
                    i = this.mSecondaryOrientation.getEndAfterPadding();
                } else {
                    i = this.mSecondaryOrientation.getEndAfterPadding() - (((this.mSpanCount - 1) - span2.mIndex) * this.mSizePerSpan);
                }
                i5 = i;
                ...
                if (layoutParams.mFullSpan) {
                    ...
                    i = (span2.mIndex * this.mSizePerSpan) + this.mSecondaryOrientation.getStartAfterPadding();
                }
                decoratedMeasurement2 = i;
                i5 = this.mSecondaryOrientation.getDecoratedMeasurement(next) + i;
            }
            if (this.mOrientation == 1) {
