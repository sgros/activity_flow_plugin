...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C03503 implements OnItemSelectedListener {
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0305R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0305R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0305R.styleable.ListPopupWindow, i, i2);
        this.mDropDownHorizontalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0305R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = obtainStyledAttributes.getDimensionPixelOffset(C0305R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    public boolean onKeyDown(int i, @NonNull KeyEvent keyEvent) {
        if (isShowing() && i != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !ListPopupWindow.isConfirmKey(i))) {
            int count;
    ...
    public boolean onKeyUp(int i, @NonNull KeyEvent keyEvent) {
        ...
        if (onKeyUp && ListPopupWindow.isConfirmKey(i)) {
            dismiss();
        }
        return onKeyUp;
    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C03492();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C03503());
