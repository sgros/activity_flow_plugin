...
class FloatingActionButtonImpl {
    ...
    class C00583 implements OnPreDrawListener {
        C00583() {
        }
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements AnimatorUpdateListener {
        ...
        /* synthetic */ ShadowAnimatorImpl(FloatingActionButtonImpl floatingActionButtonImpl, C00561 c00561) {
            this();
        }
    ...
    public CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(ContextCompat.getColor(context, C0023R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0023R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0023R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0023R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00583();
        }
    }
