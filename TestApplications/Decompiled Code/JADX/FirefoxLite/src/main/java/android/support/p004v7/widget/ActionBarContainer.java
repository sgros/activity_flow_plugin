...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        if (getId() == C0187R.C0186id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0187R.C0186id.action_bar);
        this.mContextView = findViewById(C0187R.C0186id.action_context_bar);
    }
