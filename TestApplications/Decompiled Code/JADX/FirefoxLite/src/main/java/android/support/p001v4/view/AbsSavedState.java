...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C01542();
    public static final AbsSavedState EMPTY_STATE = new C01551();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C01542 implements ClassLoaderCreator<AbsSavedState> {
        C01542() {
        }
    ...
    static class C01551 extends AbsSavedState {
        C01551() {
            super();
        }
    }
