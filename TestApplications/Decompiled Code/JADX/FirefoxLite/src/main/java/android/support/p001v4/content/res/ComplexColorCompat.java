...
public final class ComplexColorCompat {
    ...
    public static ComplexColorCompat inflate(Resources resources, int i, Theme theme) {
        try {
            return ComplexColorCompat.createFromXml(resources, i, theme);
        } catch (Exception e) {
     ...
     */
    private static android.support.p001v4.content.res.ComplexColorCompat createFromXml(android.content.res.Resources r6, int r7, android.content.res.Resources.Theme r8) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        /*
        r7 = r6.getXml(r7);
    ...
    L_0x0040:
        ...
        throw r6;
    L_0x005e:
        r6 = android.support.p001v4.content.res.GradientColorInflaterCompat.createFromXmlInner(r6, r7, r0, r8);
        r6 = android.support.p001v4.content.res.ComplexColorCompat.from(r6);
        return r6;
    L_0x0067:
        r6 = android.support.p001v4.content.res.ColorStateListInflaterCompat.createFromXmlInner(r6, r7, r0, r8);
        r6 = android.support.p001v4.content.res.ComplexColorCompat.from(r6);
        return r6;
    L_0x0070:
        r6 = new org.xmlpull.v1.XmlPullParserException;
