...
public class MenuPopupHelper {
    ...
    class C02011 implements OnDismissListener {
        C02011() {
        }
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z, int i, int i2) {
        ...
        this.mInternalOnDismissListener = new C02011();
    ...
    private MenuPopup createPopup() {
        ...
        if ((Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0187R.dimen.abc_cascading_menus_min_smallest_width) ? 1 : null) != null) {
