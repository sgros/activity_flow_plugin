...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    private static final int ITEM_LAYOUT = C0187R.layout.abc_cascading_menu_item_layout;
    private View mAnchorView;
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C01992();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C01981();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C06363();
    ...
    class C01981 implements OnGlobalLayoutListener {
        C01981() {
        }
    ...
    class C01992 implements OnAttachStateChangeListener {
    ...
    class C06363 implements MenuItemHoverListener {
        C06363() {
        }
