...
public final class ColorStateListInflaterCompat {
    ...
    L_0x0011:
        r4 = android.support.p001v4.content.res.ColorStateListInflaterCompat.createFromXmlInner(r4, r5, r0, r6);
        return r4;
    L_0x0016:
    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                TypedArray obtainAttributes = ColorStateListInflaterCompat.obtainAttributes(resources, theme, attributeSet2, C0017R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0017R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0017R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0017R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0017R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0017R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                for (int i4 = 0; i4 < next; i4++) {
                    ...
                    if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0017R.attr.alpha)) {
                        i = i3 + 1;
                ...
                next = ColorStateListInflaterCompat.modulateColorAlpha(color, f);
                if (i2 != 0) {
