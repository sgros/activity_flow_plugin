...
import android.support.p004v7.widget.ActionMenuView.OnMenuItemClickListener;
...
public class Toolbar extends ViewGroup {
    ...
    class C02561 implements OnMenuItemClickListener {
        C02561() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02551 implements ClassLoaderCreator<SavedState> {
            C02551() {
            }
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new C02561();
        this.mShowOverflowMenuRunnable = new C02532();
        ...
        if (obtainStyledAttributes.hasValue(C0187R.styleable.Toolbar_titleMargins)) {
            dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_titleMargins, dimensionPixelOffset);
        }
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_titleMarginStart, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginStart = dimensionPixelOffset;
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_titleMarginEnd, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginEnd = dimensionPixelOffset;
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_titleMarginTop, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginTop = dimensionPixelOffset;
        }
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_titleMarginBottom, -1);
        if (dimensionPixelOffset >= 0) {
            this.mTitleMarginBottom = dimensionPixelOffset;
        }
        this.mMaxButtonHeight = obtainStyledAttributes.getDimensionPixelSize(C0187R.styleable.Toolbar_maxButtonHeight, -1);
        dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset2 = obtainStyledAttributes.getDimensionPixelOffset(C0187R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        ...
        text = obtainStyledAttributes.getText(C0187R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text)) {
            setSubtitle(text);
        }
        ...
        text = obtainStyledAttributes.getText(C0187R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text)) {
            setNavigationContentDescription(text);
        }
        drawable = obtainStyledAttributes.getDrawable(C0187R.styleable.Toolbar_logo);
        if (drawable != null) {
            setLogo(drawable);
        }
        text = obtainStyledAttributes.getText(C0187R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text)) {
            setLogoDescription(text);
        }
        if (obtainStyledAttributes.hasValue(C0187R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(obtainStyledAttributes.getColor(C0187R.styleable.Toolbar_titleTextColor, -1));
        }
        if (obtainStyledAttributes.hasValue(C0187R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(obtainStyledAttributes.getColor(C0187R.styleable.Toolbar_subtitleTextColor, -1));
        }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0187R.attr.toolbarNavigationButtonStyle);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0187R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C02543());
        }
    }
    ...
    public void onLayout(boolean r25, int r26, int r27, int r28, int r29) {
        ...
        r24 = this;
        r0 = r24;
        r1 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r24);
        r2 = 1;
        r3 = 0;
    ...
    L_0x000d:
        ...
        r11[r2] = r3;
        r11[r3] = r3;
        r12 = android.support.p001v4.view.ViewCompat.getMinimumHeight(r24);
    ...
    L_0x00e7:
        ...
        r15 = (android.support.p004v7.widget.Toolbar.LayoutParams) r15;
        r3 = r15.topMargin;
        r19 = r7;
    ...
    L_0x0105:
        ...
        r7 = (android.support.p004v7.widget.Toolbar.LayoutParams) r7;
        r15 = r7.topMargin;
        r20 = r4;
    ...
    L_0x0139:
        ...
        r4 = (android.support.p004v7.widget.Toolbar.LayoutParams) r4;
        r7 = r7.getLayoutParams();
        r7 = (android.support.p004v7.widget.Toolbar.LayoutParams) r7;
    ...
    L_0x01d2:
        ...
        r1 = (android.support.p004v7.widget.Toolbar.LayoutParams) r1;
