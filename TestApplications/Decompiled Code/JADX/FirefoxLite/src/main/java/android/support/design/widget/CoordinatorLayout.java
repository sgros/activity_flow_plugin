...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    class C06111 implements OnApplyWindowInsetsListener {
        C06111() {
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        if (i == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0024R.styleable.CoordinatorLayout, 0, C0024R.style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0024R.styleable.CoordinatorLayout, i, 0);
        }
        i = obtainStyledAttributes.getResourceId(C0024R.styleable.CoordinatorLayout_keylines, 0);
        if (i != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0024R.styleable.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r31, int r32) {
        ...
        r10 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r30);
        r2 = 1;
    ...
    L_0x0042:
        r3 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r30);
        if (r3 == 0) goto L_0x004b;
    L_0x0048:
        r19 = 1;
        goto L_0x004d;
    ...
    L_0x007e:
        ...
        r11 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r11, r10);
        r11 = r11 & 7;
        r22 = r2;
        r2 = 3;
    ...
    L_0x00c1:
        r0 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r20);
    ...
    private void offsetChildByInset(android.view.View r9, android.graphics.Rect r10, int r11) {
        /*
        r8 = this;
        r0 = android.support.p001v4.view.ViewCompat.isLaidOut(r9);
    ...
    L_0x0080:
        ...
        r11 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r1, r11);
        r1 = r11 & 48;
        r3 = 48;
        r4 = 1;
        r5 = 0;
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C06111();
                }
