...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0187R.layout.abc_tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0187R.C0186id.message);
        ...
        this.mLayoutParams.windowAnimations = C0187R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, LayoutParams layoutParams) {
        ...
        if (view.getHeight() >= dimensionPixelOffset) {
            dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0187R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(z ? C0187R.dimen.tooltip_y_offset_touch : C0187R.dimen.tooltip_y_offset_non_touch);
