...
final class StandardMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnItemClickListener, OnDismissListener {
    private static final int ITEM_LAYOUT = C0187R.layout.abc_popup_menu_item_layout;
    private final MenuAdapter mAdapter;
    private View mAnchorView;
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02032();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C02021();
    ...
    class C02021 implements OnGlobalLayoutListener {
        C02021() {
        }
    ...
    class C02032 implements OnAttachStateChangeListener {
