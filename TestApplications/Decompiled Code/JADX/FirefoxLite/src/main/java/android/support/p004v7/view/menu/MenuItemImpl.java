...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    class C06371 implements VisibilityListener {
        C06371() {
        }
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            stringBuilder.append(resources.getString(C0187R.string.abc_prepend_shortcut_label));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        MenuItemImpl.appendModifier(stringBuilder, i, 65536, resources.getString(C0187R.string.abc_menu_meta_shortcut_label));
        MenuItemImpl.appendModifier(stringBuilder, i, 4096, resources.getString(C0187R.string.abc_menu_ctrl_shortcut_label));
        MenuItemImpl.appendModifier(stringBuilder, i, 2, resources.getString(C0187R.string.abc_menu_alt_shortcut_label));
        MenuItemImpl.appendModifier(stringBuilder, i, 1, resources.getString(C0187R.string.abc_menu_shift_shortcut_label));
        MenuItemImpl.appendModifier(stringBuilder, i, 4, resources.getString(C0187R.string.abc_menu_sym_shortcut_label));
        MenuItemImpl.appendModifier(stringBuilder, i, 8, resources.getString(C0187R.string.abc_menu_function_shortcut_label));
        if (shortcut == 8) {
            stringBuilder.append(resources.getString(C0187R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == 10) {
            stringBuilder.append(resources.getString(C0187R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut != ' ') {
            stringBuilder.append(shortcut);
        } else {
            stringBuilder.append(resources.getString(C0187R.string.abc_menu_space_shortcut_label));
        }
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        if (this.mActionProvider != null) {
            this.mActionProvider.setVisibilityListener(new C06371());
        }
        return this;
    }
