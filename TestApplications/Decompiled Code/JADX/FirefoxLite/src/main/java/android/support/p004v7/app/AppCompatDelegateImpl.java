...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    class C01816 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImpl.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new C01821());
                return;
            }
            AppCompatDelegateImpl.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImpl.this.mActionModeView.setVisibility(0);
    ...
    final class AutoNightModeManager {
        ...
        public void setup() {
            ...
            if (this.mAutoTimeChangeReceiver == null) {
                this.mAutoTimeChangeReceiver = new C01831();
            }
    ...
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0187R.layout.abc_list_menu_item_layout);
    ...
    class C06263 implements OnApplyWindowInsetsListener {
        C06263() {
        }
    ...
    class C06274 implements OnFitSystemWindowsListener {
        C06274() {
        }
    ...
    class C06285 implements OnAttachListener {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C06291 extends ViewPropertyAnimatorListenerAdapter {
            C06291() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImpl.this.mActionModeView != null) {
                ...
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new C06291());
            }
    ...
    class C06307 extends ViewPropertyAnimatorListenerAdapter {
        C06307() {
        }
        ...
        if (obtainStyledAttributes.hasValue(C0187R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0187R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0187R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(viewGroup, new C06263());
                } else {
                    ((FitWindowsViewGroup) viewGroup).setOnFitSystemWindowsListener(new C06274());
                }
            } else if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0187R.layout.abc_dialog_title_material, null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0187R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0187R.C0186id.decor_content_parent);
            ...
            if (viewGroup != null) {
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0187R.C0186id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0187R.C0186id.action_bar_activity_content);
                ...
                contentFrameLayout.setAttachListener(new C06285());
                return viewGroup;
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    public android.support.p004v7.view.ActionMode startSupportActionModeFromWindow(android.support.p004v7.view.ActionMode.Callback r8) {
        /*
        r7 = this;
    ...
    L_0x0007:
        ...
        r0.finish();
    L_0x000c:
        r0 = r8 instanceof android.support.p004v7.app.AppCompatDelegateImpl.ActionModeCallbackWrapperV9;
    ...
    L_0x0037:
        ...
        r4 = r7.mContext;
        r4 = r4.getTheme();
        r5 = android.support.p004v7.appcompat.C0187R.attr.actionBarTheme;
    ...
    L_0x006e:
        ...
        r6 = android.support.p004v7.appcompat.C0187R.attr.actionModePopupWindowStyle;
        r5.<init>(r4, r1, r6);
        ...
        r5.setWidth(r6);
        r5 = r4.getTheme();
        r6 = android.support.p004v7.appcompat.C0187R.attr.actionBarSize;
    ...
    L_0x00bb:
        r0 = r7.mSubDecor;
        r4 = android.support.p004v7.appcompat.C0187R.C0186id.action_mode_bar_stub;
        r0 = r0.findViewById(r4);
        r0 = (android.support.p004v7.widget.ViewStubCompat) r0;
        if (r0 == 0) goto L_0x00da;
    L_0x00c7:
        ...
        r0 = r0.inflate();
        r0 = (android.support.p004v7.widget.ActionBarContextView) r0;
    ...
    L_0x0115:
        ...
        r8.setAlpha(r1);
        r8 = r7.mActionModeView;
        r8 = android.support.p001v4.view.ViewCompat.animate(r8);
        r8 = r8.alpha(r0);
        r7.mFadeAnim = r8;
        r8 = r7.mFadeAnim;
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    ...
                    if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                        ...
                        if (layoutParams2 != null && layoutParams2.width == -1) {
                            ...
                            layoutParams = new WindowManager.LayoutParams(i, -2, panelFeatureState.f21x, panelFeatureState.f22y, 1002, 8519680, -3);
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0187R.color.abc_input_method_navigation_guard));
