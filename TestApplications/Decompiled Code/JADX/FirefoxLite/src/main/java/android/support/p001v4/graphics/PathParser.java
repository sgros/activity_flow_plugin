...
public class PathParser {
     ...
     */
        ...
        L_0x0185:
            ...
            r25 = r9;
            r9 = r26;
            android.support.p001v4.graphics.PathParser.PathDataNode.drawArc(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            r0 = r13[r14];
            r8 = r11 + r0;
            r0 = r13[r15];
            r7 = r12 + r0;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d14 < 0.0d) {
                ...
                PathDataNode.drawArc(path, f, f2, f3, f4, f10 * f8, f6 * f8, f7, z, z2);
                return;
            }
            sin = Math.sqrt(d14);
            d7 *= sin;
            ...
            d11 *= d9;
            d12 *= d;
            PathDataNode.arcToBezier(path, (d11 * cos) - (d12 * d13), (d11 * d13) + (d12 * cos), d9, d, d3, d5, toRadians, d6, atan2);
        }
    ...
    /* JADX WARNING: Missing block: B:17:0x002c, code skipped:
            return false;
     */
    public static boolean canMorph(android.support.p001v4.graphics.PathParser.PathDataNode[] r4, android.support.p001v4.graphics.PathParser.PathDataNode[] r5) {
        /*
        r0 = 0;
    ...
    L_0x002c:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.graphics.PathParser.canMorph(android.support.v4.graphics.PathParser$PathDataNode[], android.support.v4.graphics.PathParser$PathDataNode[]):boolean");
    }
