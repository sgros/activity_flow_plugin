...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C01701();
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                c01741 = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
                ...
                c01741 = new CursorAdapter(this.mContext, this.mCursor, false) {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0187R.styleable.AlertDialog, C0187R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0187R.C0186id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0187R.C0186id.topPanel);
        View findViewById3 = findViewById.findViewById(C0187R.C0186id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0187R.C0186id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0187R.C0186id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0187R.C0186id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0187R.C0186id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0187R.C0186id.buttonPanel);
        ...
        if (!(z2 || resolvePanel2 == null)) {
            findViewById5 = resolvePanel2.findViewById(C0187R.C0186id.textSpacerNoButtons);
        ...
        if (z) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                findViewById5 = resolvePanel.findViewById(C0187R.C0186id.titleDividerNoCustom);
            }
            if (findViewById5 != null) {
                findViewById5.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            findViewById2 = resolvePanel2.findViewById(C0187R.C0186id.textSpacerNoTitle);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View findViewById = this.mWindow.findViewById(C0187R.C0186id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0187R.C0186id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0187R.C0186id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0187R.C0186id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0187R.C0186id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0187R.C0186id.scrollView);
