...
import android.support.p004v7.recyclerview.C0192R;
import android.support.p004v7.widget.AdapterHelper.UpdateOp;
import android.support.p004v7.widget.GapWorker.LayoutPrefetchRegistryImpl;
import android.support.p004v7.widget.ViewBoundsCheck.Callback;
import android.support.p004v7.widget.ViewInfoStore.ProcessCallback;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02333();
    ...
    static class C02333 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C02341();
        ...
        private final Callback mVerticalBoundCheckCallback = new C02352();
        private int mWidth;
        ...
        class C02352 implements Callback {
            C02352() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0192R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0192R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0192R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0192R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0192R.styleable.RecyclerView_stackFromEnd, false);
    ...
    public final class Recycler {
        ...
        L_0x0008:
            r1 = android.support.p004v7.widget.RecyclerView.this;
            r1 = r1.mState;
            r1 = r1.getItemCount();
        ...
        L_0x0043:
            r5 = android.support.p004v7.widget.RecyclerView.this;
            r9 = r1.itemView;
        ...
        L_0x0069:
            r9 = android.support.p004v7.widget.RecyclerView.this;
            r9 = r9.mAdapter;
            r9 = r9.getItemCount();
        ...
        L_0x0073:
            ...
            r10 = android.support.p004v7.widget.RecyclerView.this;
            r10 = r10.mAdapter;
        ...
        L_0x00b3:
            ...
            r1.append(r2);
            r2 = android.support.p004v7.widget.RecyclerView.this;
        ...
        L_0x00f9:
            r1.resetInternal();
            r0 = android.support.p004v7.widget.RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST;
        ...
        L_0x0103:
            if (r1 != 0) goto L_0x0189;
        L_0x0105:
            r0 = android.support.p004v7.widget.RecyclerView.this;
            r0 = r0.getNanoTime();
        ...
        L_0x0121:
            ...
            r5 = android.support.p004v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
            if (r5 == 0) goto L_0x013e;
        L_0x012f:
            r5 = r2.itemView;
            r5 = android.support.p004v7.widget.RecyclerView.findNestedRecyclerView(r5);
            if (r5 == 0) goto L_0x013e;
        L_0x0137:
        ...
        L_0x019f:
            ...
            if (r0 == 0) goto L_0x01c5;
        L_0x01aa:
            r0 = android.support.p004v7.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(r10);
            r0 = r0 | 4096;
            r1 = android.support.p004v7.widget.RecyclerView.this;
            r1 = r1.mItemAnimator;
            r2 = android.support.p004v7.widget.RecyclerView.this;
        ...
        L_0x0208:
            ...
            r1 = (android.support.p004v7.widget.RecyclerView.LayoutParams) r1;
            r2 = r10.itemView;
     ...
     */
        ...
        L_0x0023:
            r3 = android.support.p004v7.widget.RecyclerView.this;
        ...
        L_0x00c5:
            r15 = android.support.p004v7.widget.RecyclerView.this;
            r20 = 0;
            r21 = 1;
            r16 = r3;
            r17 = r5;
        ...
        L_0x00f6:
            r9 = 0;
        L_0x00f7:
            r4 = android.support.p004v7.widget.RecyclerView.this;
        ...
        L_0x0183:
            ...
            r1 = android.support.p004v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
    ...
    class C06434 implements ProcessCallback {
        C06434() {
        }
    ...
    class C06445 implements ChildHelper.Callback {
        C06445() {
        }
    ...
    class C06456 implements AdapterHelper.Callback {
        C06456() {
        }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02311();
        ...
        this.mItemAnimatorRunner = new C02322();
        this.mViewInfoProcessCallback = new C06434();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0192R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0192R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0192R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0192R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0192R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0192R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0192R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0192R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C06445());
    }

    /* Access modifiers changed, original: 0000 */
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C06456());
    }
    ...
    L_0x0026:
        r0 = android.support.p004v7.widget.GapWorker.sGapWorker;
        r0 = r0.get();
        r0 = (android.support.p004v7.widget.GapWorker) r0;
        r4.mGapWorker = r0;
        r0 = r4.mGapWorker;
    ...
    L_0x0034:
        ...
        r0.<init>();
        r4.mGapWorker = r0;
        r0 = android.support.p001v4.view.ViewCompat.getDisplay(r4);
        ...
        if (dispatchOnItemTouch(motionEvent)) {
            ...
            switch (actionMasked) {
                ...
                case 1:
                    ...
                    this.mVelocityTracker.computeCurrentVelocity(Constants.ONE_SECOND, (float) this.mMaxFlingVelocity);
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0192R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0192R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0192R.dimen.fastscroll_margin));
    }
