...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        i2 = ((Integer) transitionValues3.values.get("android:changeBounds:windowX")).intValue();
        int intValue = ((Integer) transitionValues3.values.get("android:changeBounds:windowY")).intValue();
        i = ((Integer) transitionValues4.values.get("android:changeBounds:windowX")).intValue();
        i3 = ((Integer) transitionValues4.values.get("android:changeBounds:windowY")).intValue();
        if (!(i2 == i && intValue == i3)) {
