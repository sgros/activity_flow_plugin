...
public class MenuBuilder implements SupportMenu {
    ...
    public MenuItem addInternal(int i, int i2, int i3, CharSequence charSequence) {
        ...
        this.mItems.add(MenuBuilder.findInsertIndex(this.mItems, ordering), createNewMenuItem);
        onItemsChanged(true);
    ...
    public void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (!(((modifiers & 69647) == ((isQwertyMode ? menuItemImpl.getAlphabeticModifiers() : menuItemImpl.getNumericModifiers()) & 69647) ? 1 : null) == null || alphabeticShortcut == 0 || ((alphabeticShortcut != keyData.meta[0] && alphabeticShortcut != keyData.meta[2] && (!isQwertyMode || alphabeticShortcut != 8 || i != 67)) || !menuItemImpl.isEnabled()))) {
