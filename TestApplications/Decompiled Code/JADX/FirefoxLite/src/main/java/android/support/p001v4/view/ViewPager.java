...
public class ViewPager extends ViewGroup {
    private static final Comparator<ItemInfo> COMPARATOR = new C01571();
    static final int[] LAYOUT_ATTRS = new int[]{16842931};
    private static final Interpolator sInterpolator = new C01582();
    ...
    private final Runnable mEndScrollRunnable = new C01593();
    ...
    static class C01571 implements Comparator<ItemInfo> {
        C01571() {
        }
    ...
    static class C01582 implements Interpolator {
    ...
    class C01614 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C01601();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C01601 implements ClassLoaderCreator<SavedState> {
            C01601() {
            }
    ...
    public void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01614());
    }
    ...
    L_0x0054:
        r8 = r0.mItems;
        r8 = r8.get(r7);
        r8 = (android.support.p001v4.view.ViewPager.ItemInfo) r8;
        r9 = r8.position;
        r10 = r0.mCurItem;
    ...
    L_0x007e:
        r11 = r0.mItems;
        r11 = r11.get(r10);
        r11 = (android.support.p001v4.view.ViewPager.ItemInfo) r11;
        goto L_0x0088;
    L_0x0087:
        r11 = 0;
    L_0x0088:
    ...
    L_0x00ca:
        r5 = r0.mItems;
        r5 = r5.get(r10);
        r5 = (android.support.p001v4.view.ViewPager.ItemInfo) r5;
        goto L_0x0100;
    L_0x00d3:
    ...
    L_0x01af:
        ...
        r4 = (android.support.p001v4.view.ViewPager.LayoutParams) r4;
        r4.childIndex = r2;
        r5 = r4.isDecor;
    ...
    private void calculatePageOffsets(android.support.p001v4.view.ViewPager.ItemInfo r11, int r12, android.support.p001v4.view.ViewPager.ItemInfo r13) {
        /*
        r10 = this;
        r0 = r10.mAdapter;
        r0 = r0.getCount();
    ...
    L_0x00e1:
        r7 = r10.mItems;
        r7 = r7.get(r5);
        r7 = (android.support.p001v4.view.ViewPager.ItemInfo) r7;
    L_0x00e9:
        r8 = r7.position;
    ...
    L_0x0118:
        r4 = r10.mItems;
        r4 = r4.get(r12);
        r4 = (android.support.p001v4.view.ViewPager.ItemInfo) r4;
    L_0x0120:
        r5 = r4.position;
    ...
    L_0x0145:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.view.ViewPager.calculatePageOffsets(android.support.v4.view.ViewPager$ItemInfo, int, android.support.v4.view.ViewPager$ItemInfo):void");
    }
    ...
    public void onMeasure(int r17, int r18) {
        ...
        r1 = 0;
        r2 = r17;
        r2 = android.support.p001v4.view.ViewPager.getDefaultSize(r1, r2);
        r3 = r18;
        r3 = android.support.p001v4.view.ViewPager.getDefaultSize(r1, r3);
    ...
    L_0x0050:
        ...
        r6 = (android.support.p001v4.view.ViewPager.LayoutParams) r6;
    ...
    L_0x00ea:
        ...
        r5 = (android.support.p001v4.view.ViewPager.LayoutParams) r5;
    ...
    L_0x001f:
        ...
        r9 = (android.support.p001v4.view.ViewPager.LayoutParams) r9;
        r10 = r9.isDecor;
    ...
    L_0x007e:
        ...
        r0 = (android.support.p001v4.view.ViewPager.LayoutParams) r0;
        r0 = r0.isDecor;
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(Constants.ONE_SECOND, (float) this.mMaximumVelocity);
