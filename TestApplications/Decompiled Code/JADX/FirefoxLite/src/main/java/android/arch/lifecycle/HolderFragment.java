...
public class HolderFragment extends Fragment implements ViewModelStoreOwner {
    ...
    static class HolderFragmentManager {
        private ActivityLifecycleCallbacks mActivityCallbacks = new C00081();
        private boolean mActivityCallbacksIsAdded = false;
        private Map<Activity, HolderFragment> mNotCommittedActivityHolders = new HashMap();
        private Map<Fragment, HolderFragment> mNotCommittedFragmentHolders = new HashMap();
        private FragmentLifecycleCallbacks mParentDestroyedCallback = new C00092();

        /* renamed from: android.arch.lifecycle.HolderFragment$HolderFragmentManager$1 */
        class C00081 extends EmptyActivityLifecycleCallbacks {
            C00081() {
            }
        ...
        class C00092 extends FragmentLifecycleCallbacks {
            C00092() {
            }
