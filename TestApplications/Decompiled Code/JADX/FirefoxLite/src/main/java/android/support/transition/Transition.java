...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C00991();
    ...
    class C00983 extends AnimatorListenerAdapter {
        C00983() {
        }
    ...
    static class C00991 extends PathMotion {
        C00991() {
        }
    ...
    L_0x0046:
        r1 = android.support.p001v4.view.ViewCompat.getTransitionName(r6);
        if (r1 == 0) goto L_0x0059;
    L_0x004c:
        r1 = r5.mTargetNameExcludes;
        r3 = android.support.p001v4.view.ViewCompat.getTransitionName(r6);
        r1 = r1.contains(r3);
        if (r1 == 0) goto L_0x0059;
    L_0x0058:
        return r2;
    ...
    public void animate(Animator animator) {
        ...
        animator.addListener(new C00983());
        animator.start();
    }
