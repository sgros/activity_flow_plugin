...
class FragmentTransition {
    ...
    private static final FragmentTransitionImpl SUPPORT_IMPL = FragmentTransition.resolveSupportImpl();
    ...
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentManagerImpl, int i, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap) {
        ...
        if (view3 != null) {
            ...
            if (chooseImpl != null) {
                ...
                Object configureSharedElementsReordered = FragmentTransition.configureSharedElementsReordered(chooseImpl, view3, view, arrayMap, fragmentContainerTransition, arrayList2, arrayList, enterTransition, exitTransition);
                Object obj2 = obj;
                ...
                enterTransition = exitTransition;
                ArrayList configureEnteringExitingViews = FragmentTransition.configureEnteringExitingViews(chooseImpl, enterTransition, fragment2, arrayList3, view2);
                ArrayList configureEnteringExitingViews2 = FragmentTransition.configureEnteringExitingViews(chooseImpl, obj2, fragment, arrayList, view2);
                ...
                Object mergeTransitions = FragmentTransition.mergeTransitions(chooseImpl, obj2, enterTransition, configureSharedElementsReordered, fragment3, z);
                if (mergeTransitions != null) {
                    FragmentTransition.replaceHide(chooseImpl, enterTransition, fragment2, arrayList4);
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentManagerImpl, int i, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap) {
        ...
        if (view3 != null) {
            ...
            if (chooseImpl != null) {
                ...
                exitTransition = FragmentTransition.configureSharedElementsOrdered(chooseImpl, view3, view, arrayMap, fragmentContainerTransition, arrayList, arrayList2, enterTransition, obj2);
                Object obj4 = obj3;
                ...
                obj = obj2;
                ArrayList configureEnteringExitingViews = FragmentTransition.configureEnteringExitingViews(fragmentTransitionImpl, obj, fragment2, arrayList3, view2);
                ...
                Object mergeTransitions = FragmentTransition.mergeTransitions(fragmentTransitionImpl, obj4, obj5, exitTransition, fragment, fragmentContainerTransition2.lastInIsPop);
                if (mergeTransitions != null) {
                    ...
                    FragmentTransition.scheduleTargetChange(fragmentTransitionImpl2, view3, fragment, view, arrayList2, obj4, arrayList3, obj5, configureEnteringExitingViews);
    ...
    private static void scheduleTargetChange(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, Fragment fragment, View view, ArrayList<View> arrayList, Object obj, ArrayList<View> arrayList2, Object obj2, ArrayList<View> arrayList3) {
        ...
        OneShotPreDrawListener.add(viewGroup, c01182);
    }
    ...
    private static Object configureSharedElementsReordered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        if (arrayMap.isEmpty()) {
            ...
            obj4 = FragmentTransition.getSharedElementTransition(fragmentTransitionImpl2, fragment, fragment2, z);
        }
        ArrayMap captureOutSharedElements = FragmentTransition.captureOutSharedElements(fragmentTransitionImpl2, arrayMap2, obj4, fragmentContainerTransition2);
        ...
        if (arrayMap.isEmpty()) {
            ...
            FragmentTransition.addSharedElementsWithMatchingNames(arrayList3, captureOutSharedElements, arrayMap.keySet());
            FragmentTransition.addSharedElementsWithMatchingNames(arrayList4, captureInSharedElements, arrayMap.values());
            obj5 = obj4;
        }
        ...
        if (obj5 != null) {
            ...
            FragmentTransition.setOutEpicenter(fragmentTransitionImpl, obj5, obj2, captureOutSharedElements, fragmentContainerTransition2.firstOutIsPop, fragmentContainerTransition2.firstOutTransaction);
            Rect rect2 = new Rect();
            View inEpicenterView = FragmentTransition.getInEpicenterView(captureInSharedElements, fragmentContainerTransition2, obj3, z);
    ...
    private static Object configureSharedElementsOrdered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        OneShotPreDrawListener.add(viewGroup, c01204);
        return obj5;
    }
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransition.addToFirstInLastOut(backStackRecord, (C0106Op) backStackRecord.mOps.get(i), sparseArray, false, z);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        if (backStackRecord.mManager.mContainer.onHasView()) {
            for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
                FragmentTransition.addToFirstInLastOut(backStackRecord, (C0106Op) backStackRecord.mOps.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    /* JADX WARNING: Missing block: B:55:0x0089, code skipped:
            r1 = true;
     */
    private static void addToFirstInLastOut(android.support.p001v4.app.BackStackRecord r15, android.support.p001v4.app.BackStackRecord.C0106Op r16, android.util.SparseArray<android.support.p001v4.app.FragmentTransition.FragmentContainerTransition> r17, boolean r18, boolean r19) {
        /*
        r0 = r15;
        r1 = r16;
        r2 = r17;
    ...
    L_0x008f:
        r6 = r2.get(r11);
        r6 = (android.support.p001v4.app.FragmentTransition.FragmentContainerTransition) r6;
        if (r4 == 0) goto L_0x00a1;
    L_0x0097:
        r6 = android.support.p001v4.app.FragmentTransition.ensureContainer(r6, r2, r11);
        r6.lastIn = r10;
        r6.lastInIsPop = r3;
    ...
    L_0x00d1:
        r14 = android.support.p001v4.app.FragmentTransition.ensureContainer(r14, r2, r11);
        r14.firstOut = r10;
