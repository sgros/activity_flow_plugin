...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C023810 implements TextWatcher {
    ...
    class C02413 implements OnFocusChangeListener {
        C02413() {
        }
    ...
    class C02424 implements OnLayoutChangeListener {
        C02424() {
        }
    ...
    class C02446 implements OnKeyListener {
        C02446() {
        }
    ...
    class C02457 implements OnEditorActionListener {
        C02457() {
        }
    ...
    class C02468 implements OnItemClickListener {
        C02468() {
        }
    ...
    class C02479 implements OnItemSelectedListener {
     ...
     */
        ...
        L_0x003c:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.SearchView$AutoCompleteTextViewReflector.<init>():void");
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02481 implements ClassLoaderCreator<SavedState> {
            C02481() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            ...
            this.mRunShowSoftInputIfNecessary = new C02491();
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02391();
        this.mReleaseCursorRunnable = new C02402();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02435();
        this.mTextKeyListener = new C02446();
        this.mOnEditorActionListener = new C02457();
        this.mOnItemClickListener = new C02468();
        this.mOnItemSelectedListener = new C02479();
        this.mTextWatcher = new C023810();
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0187R.C0186id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0187R.C0186id.search_edit_frame);
        this.mSearchPlate = findViewById(C0187R.C0186id.search_plate);
        this.mSubmitArea = findViewById(C0187R.C0186id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0187R.C0186id.search_button);
        this.mGoButton = (ImageView) findViewById(C0187R.C0186id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0187R.C0186id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0187R.C0186id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0187R.C0186id.search_mag_icon);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02413());
        ...
        dimensionPixelSize = obtainStyledAttributes.getInt(C0187R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0187R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02424());
        }
