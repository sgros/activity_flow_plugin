...
class TypefaceCompatBaseImpl {
    ...
    class C01321 implements StyleExtractor<FontInfo> {
        C01321() {
        }
    ...
    class C01332 implements StyleExtractor<FontFileResourceEntry> {
        C01332() {
        }
    ...
    public FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) TypefaceCompatBaseImpl.findBestFont(fontInfoArr, i, new C01321());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) TypefaceCompatBaseImpl.findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C01332());
    }
