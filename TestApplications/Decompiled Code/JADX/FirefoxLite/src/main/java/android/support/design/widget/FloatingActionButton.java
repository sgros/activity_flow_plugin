...
public class FloatingActionButton extends VisibilityAwareImageButton implements ExpandableTransformationWidget, TintableBackgroundView, TintableImageSourceView {
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends android.support.design.widget.CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0028R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C0028R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
    ...
    private int getSizeDimension(int i) {
        ...
        if (i == -1) {
            ...
            return resources.getDimensionPixelSize(C0028R.dimen.design_fab_size_normal);
        } else {
            return resources.getDimensionPixelSize(C0028R.dimen.design_fab_size_mini);
        }
    }
