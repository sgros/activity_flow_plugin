...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C06492();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C02601();
    ...
    public static abstract class Callback {
        private static final Interpolator sDragScrollInterpolator = new C02621();
        private static final Interpolator sDragViewScrollCapInterpolator = new C02632();
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C02621 implements Interpolator {
        ...
        static class C02632 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        L_0x002a:
            r9 = r16;
            r10 = r9.get(r8);
            r10 = (android.support.p004v7.widget.RecyclerView.ViewHolder) r10;
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0192R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C02641 implements AnimatorUpdateListener {
            C02641() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new C02641());
    ...
    class C06492 implements OnItemTouchListener {
        C06492() {
        }
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ItemTouchHelper itemTouchHelper = ItemTouchHelper.this;
                        itemTouchHelper.mInitialTouchX -= findAnimation.f26mX;
                        itemTouchHelper = ItemTouchHelper.this;
                        itemTouchHelper.mInitialTouchY -= findAnimation.f27mY;
    ...
    class C06515 implements ChildDrawingOrderCallback {
        C06515() {
        }
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0192R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0192R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    L_0x0094:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.helper.ItemTouchHelper.checkSelectForSwipe(int, android.view.MotionEvent, int):void");
    }
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (ItemTouchHelper.hitTest(view2, x, y, recoverAnimation.f26mX, recoverAnimation.f27mY)) {
                return view2;
            }
        }
    ...
    private int checkHorizontalSwipe(ViewHolder viewHolder, int i) {
        if ((i & 12) != 0) {
            ...
            if (this.mVelocityTracker != null && this.mActivePointerId > -1) {
                this.mVelocityTracker.computeCurrentVelocity(Constants.ONE_SECOND, this.mCallback.getSwipeVelocityThreshold(this.mMaxSwipeVelocity));
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C06515();
            }
