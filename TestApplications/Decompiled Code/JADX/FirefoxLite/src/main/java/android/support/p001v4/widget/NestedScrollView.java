...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2 {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.mIsLaidOut) {
            ...
            i = getScrollY();
            i5 = NestedScrollView.clamp(i, i4, i5);
            if (i5 != i) {
    ...
    L_0x0027:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.widget.NestedScrollView.onSizeChanged(int, int, int, int):void");
    }
    ...
    public void scrollTo(int i, int i2) {
        if (getChildCount() > 0) {
            ...
            i = NestedScrollView.clamp(i, (getWidth() - getPaddingLeft()) - getPaddingRight(), width);
            i2 = NestedScrollView.clamp(i2, height, height2);
