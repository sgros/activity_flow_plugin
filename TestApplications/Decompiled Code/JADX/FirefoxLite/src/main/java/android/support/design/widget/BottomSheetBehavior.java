...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    int collapsedOffset;
    private final Callback dragCallback = new C06072();
    ...
    class C06072 extends Callback {
        ...
        L_0x00e2:
            ...
            r10 = android.support.design.widget.BottomSheetBehavior.this;
            r9.<init>(r8, r2);
            android.support.p001v4.view.ViewCompat.postOnAnimation(r8, r9);
            goto L_0x00f8;
        L_0x00f3:
        ...
        L_0x00f8:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.design.widget.BottomSheetBehavior$C06072.onViewReleased(android.view.View, float, float):void");
        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static class C00651 implements ClassLoaderCreator<SavedState> {
            C00651() {
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0028R.styleable.BottomSheetBehavior_Layout);
        TypedValue peekValue = obtainStyledAttributes.peekValue(C0028R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(obtainStyledAttributes.getDimensionPixelSize(C0028R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(peekValue.data);
        }
        setHideable(obtainStyledAttributes.getBoolean(C0028R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setFitToContents(obtainStyledAttributes.getBoolean(C0028R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(obtainStyledAttributes.getBoolean(C0028R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.peekHeightAuto) {
            if (this.peekHeightMin == 0) {
                this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C0028R.dimen.design_bottom_sheet_peek_height_min);
            }
    ...
    private float getYVelocity() {
        ...
        this.velocityTracker.computeCurrentVelocity(Constants.ONE_SECOND, this.maximumVelocity);
