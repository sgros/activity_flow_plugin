...
import android.support.p001v4.widget.CursorFilter.CursorFilterClient;
...
public abstract class CursorAdapter extends BaseAdapter implements CursorFilterClient, Filterable {
    ...
    L_0x001c:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.widget.CursorAdapter.getItemId(int):long");
    }
