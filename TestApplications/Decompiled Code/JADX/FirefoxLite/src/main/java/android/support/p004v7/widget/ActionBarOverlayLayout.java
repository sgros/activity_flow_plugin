...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0187R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02051();
        this.mRemoveActionBarHideOffset = new C02062();
        this.mAddActionBarHideOffset = new C02073();
        init(context);
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0187R.C0186id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0187R.C0186id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0187R.C0186id.action_bar));
        }
    }
