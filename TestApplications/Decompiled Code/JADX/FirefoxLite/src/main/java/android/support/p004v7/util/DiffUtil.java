...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C01961();

    /* renamed from: android.support.v7.util.DiffUtil$1 */
    static class C01961 implements Comparator<Snake> {
        C01961() {
        }
    ...
    public static class DiffResult {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (i3--; i3 >= 0; i3--) {
                    if ((this.mOldItemStatuses[snake.f24x + i3] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f24x + i3, 1, this.mCallback.getChangePayload(snake.f24x + i3, snake.f25y + i3));
                    }
                }
                i = snake.f24x;
                i2 = snake.f25y;
