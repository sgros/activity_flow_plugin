...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            if (drawable == null) {
                int resourceId = obtainStyledAttributes.getResourceId(C0187R.styleable.AppCompatImageView_srcCompat, -1);
                if (resourceId != -1) {
            ...
            if (obtainStyledAttributes.hasValue(C0187R.styleable.AppCompatImageView_tintMode)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0187R.styleable.AppCompatImageView_tintMode, -1), null));
            }
