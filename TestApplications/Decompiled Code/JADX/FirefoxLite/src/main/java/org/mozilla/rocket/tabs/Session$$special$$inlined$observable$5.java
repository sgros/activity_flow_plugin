...
public final class Session$$special$$inlined$observable$5 extends ObservableProperty<Boolean> {
    ...
    public void afterChange(KProperty<?> kProperty, Boolean bool, Boolean bool2) {
        ...
        this.this$0.notifyObservers(Boolean.valueOf(bool.booleanValue()), Boolean.valueOf(booleanValue), new Session$$special$$inlined$observable$5$lambda$1(booleanValue, this));
    }
}
