...
final class SessionManager$removeTabInternal$1 extends Lambda implements Function1<Observer, Unit> {
    final /* synthetic */ SessionManager this$0;

    SessionManager$removeTabInternal$1(SessionManager sessionManager) {
