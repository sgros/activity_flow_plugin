...
final class DownloadInfoRepository$queryIndicatorStatus$1 implements AsyncQueryListener {
    final /* synthetic */ OnQueryListCompleteListener $listenerList;

    DownloadInfoRepository$queryIndicatorStatus$1(OnQueryListCompleteListener onQueryListCompleteListener) {
