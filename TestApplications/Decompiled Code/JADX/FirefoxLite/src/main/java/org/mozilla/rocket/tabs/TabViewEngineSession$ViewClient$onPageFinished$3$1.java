...
final class TabViewEngineSession$ViewClient$onPageFinished$3$1 extends Lambda implements Function1<Observer, Unit> {
    final /* synthetic */ TabView $it;

    TabViewEngineSession$ViewClient$onPageFinished$3$1(TabView tabView) {
        this.$it = tabView;
        super(1);
    }
