...
final class DownloadInfoRepository$queryByRowId$1 implements AsyncQueryListener {
    final /* synthetic */ OnQueryItemCompleteListener $listenerItem;

    DownloadInfoRepository$queryByRowId$1(OnQueryItemCompleteListener onQueryItemCompleteListener) {
