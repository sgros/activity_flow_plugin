...
final class TabViewEngineSession$ChromeClient$onReceivedTitle$2$1 extends Lambda implements Function1<Observer, Unit> {
    final /* synthetic */ String $it;

    TabViewEngineSession$ChromeClient$onReceivedTitle$2$1(String str) {
        this.$it = str;
        super(1);
    }
