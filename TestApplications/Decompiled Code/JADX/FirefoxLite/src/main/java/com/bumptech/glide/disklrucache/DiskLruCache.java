...
public final class DiskLruCache implements Closeable {
    ...
    private final Callable<Void> cleanupCallable = new C03871();
    ...
    class C03871 implements Callable<Void> {
        C03871() {
        }
     ...
     */
        ...
        L_0x0028:
            ...
            throw r1;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.disklrucache.DiskLruCache$C03871.call():java.lang.Void");
        }
    }
    ...
    private static final class DiskLruCacheThreadFactory implements ThreadFactory {
        ...
        /* synthetic */ DiskLruCacheThreadFactory(C03871 c03871) {
            this();
        }
    ...
    public final class Editor {
        ...
        /* synthetic */ Editor(DiskLruCache diskLruCache, Entry entry, C03871 c03871) {
            this(entry);
        }
    ...
    private final class Entry {
        ...
        /* synthetic */ Entry(DiskLruCache diskLruCache, String str, C03871 c03871) {
            this(str);
        }
    ...
    public final class Value {
        ...
        /* synthetic */ Value(DiskLruCache diskLruCache, String str, long j, File[] fileArr, long[] jArr, C03871 c03871) {
    ...
    private synchronized com.bumptech.glide.disklrucache.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        ...
        r0 = r4.lruEntries;	 Catch:{ all -> 0x005d }
        r0 = r0.get(r5);	 Catch:{ all -> 0x005d }
    ...
    L_0x0021:
        ...
        r0.<init>(r4, r5, r3);	 Catch:{ all -> 0x005d }
        r6 = r4.lruEntries;	 Catch:{ all -> 0x005d }
        r6.put(r5, r0);	 Catch:{ all -> 0x005d }
        goto L_0x0034;
    L_0x002c:
        r6 = r0.currentEditor;	 Catch:{ all -> 0x005d }
        if (r6 == 0) goto L_0x0034;
    L_0x0032:
        monitor-exit(r4);
        return r3;
    L_0x0034:
        r6 = new com.bumptech.glide.disklrucache.DiskLruCache$Editor;	 Catch:{ all -> 0x005d }
        r6.<init>(r4, r0, r3);	 Catch:{ all -> 0x005d }
        r0.currentEditor = r6;	 Catch:{ all -> 0x005d }
        r7 = r4.journalWriter;	 Catch:{ all -> 0x005d }
        r0 = "DIRTY";
        ...
        r5 = r4.journalWriter;	 Catch:{ all -> 0x005d }
        r7 = 10;
