...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static /* synthetic */ class C03991 {
        ...
        L_0x0035:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy$C03991.<clinit>():void");
        }
    }
    ...
    private static Config[] getInConfigs(Config config) {
        switch (C03991.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
