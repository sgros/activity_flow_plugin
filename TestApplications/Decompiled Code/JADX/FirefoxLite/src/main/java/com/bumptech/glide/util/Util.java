...
public final class Util {
    ...
    static /* synthetic */ class C04111 {
        ...
        L_0x0035:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util$C04111.<clinit>():void");
        }
    }
    ...
    private static int getBytesPerPixel(Config config) {
        ...
        switch (C04111.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 1;
            case 2:
            case 3:
