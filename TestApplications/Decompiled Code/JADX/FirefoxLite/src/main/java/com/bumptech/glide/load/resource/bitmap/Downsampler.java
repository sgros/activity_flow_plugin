...
public final class Downsampler {
    ...
    private static final DecodeCallbacks EMPTY_CALLBACKS = new C04081();
    ...
    static class C04081 implements DecodeCallbacks {
    ...
    public Resource<Bitmap> decode(InputStream inputStream, int i, int i2, com.bumptech.glide.load.Options options, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        try {
            Resource<Bitmap> obtain = BitmapResource.obtain(decodeFromWrappedStreams(inputStream, defaultOptions, downsampleStrategy, decodeFormat, decodeFormat == DecodeFormat.PREFER_ARGB_8888_DISALLOW_HARDWARE ? false : z, i, i2, booleanValue, decodeCallbacks), this.bitmapPool);
            return obtain;
        } finally {
    ...
    static void calculateScaling(ImageType imageType, InputStream inputStream, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, Options options) throws IOException {
            ...
            if (scaleFactor > 0.0f) {
                ...
                if (sampleSizeRounding != null) {
                    ...
                    if (Log.isLoggable("Downsampler", 2)) {
                        ...
                        stringBuilder.append(scaleFactor2);
    ...
    private void calculateConfig(InputStream inputStream, DecodeFormat decodeFormat, boolean z, boolean z2, Options options, int i, int i2) throws IOException {
