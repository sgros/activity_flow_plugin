...
public class LoadPath<Data, ResourceType, Transcode> {
    ...
    public LoadPath(Class<Data> cls, Class<ResourceType> cls2, Class<Transcode> cls3, List<DecodePath<Data, ResourceType, Transcode>> list, Pool<List<Exception>> pool) {
        this.dataClass = cls;
        this.listPool = pool;
    ...
    private Resource<Transcode> loadWithExceptionList(DataRewinder<Data> dataRewinder, Options options, int i, int i2, DecodeCallback<ResourceType> decodeCallback, List<Exception> list) throws GlideException {
        List<Exception> list2 = list;
    ...
    public String toString() {
        ...
        stringBuilder.append(Arrays.toString(this.decodePaths.toArray(new DecodePath[this.decodePaths.size()])));
        stringBuilder.append('}');
