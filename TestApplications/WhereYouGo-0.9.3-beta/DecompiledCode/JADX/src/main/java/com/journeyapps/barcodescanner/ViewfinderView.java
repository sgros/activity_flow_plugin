...
public class ViewfinderView extends View {
    ...
    class C02201 implements StateListener {
        C02201() {
        }
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = getContext().obtainStyledAttributes(attrs, C0186R.styleable.zxing_finder);
        this.maskColor = attributes.getColor(C0186R.styleable.zxing_finder_zxing_viewfinder_mask, resources.getColor(C0186R.color.zxing_viewfinder_mask));
        this.resultColor = attributes.getColor(C0186R.styleable.zxing_finder_zxing_result_view, resources.getColor(C0186R.color.zxing_result_view));
        this.laserColor = attributes.getColor(C0186R.styleable.zxing_finder_zxing_viewfinder_laser, resources.getColor(C0186R.color.zxing_viewfinder_laser));
        this.resultPointColor = attributes.getColor(C0186R.styleable.zxing_finder_zxing_possible_result_points, resources.getColor(C0186R.color.zxing_possible_result_points));
        attributes.recycle();
        this.scannerAlpha = 0;
    ...
    public void setCameraPreview(CameraPreview view) {
        ...
        view.addStateListener(new C02201());
    }
