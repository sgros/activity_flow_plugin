...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    private static final byte[] DIGITS = new byte[]{ExtraData.SOURCE_UNKNOWN, ExtraData.SOURCE_PARKING_SERVICE, ExtraData.SOURCE_GEOCACHING_WAYPOINT, ExtraData.SOURCE_MAP_TEMP, ExtraData.SOURCE_ROUTE_WAYPOINT, ExtraData.SOURCE_ROUTE_LOCATION, (byte) 54, ExtraData.SOURCE_OPENSTREETBUGS, ExtraData.SOURCE_INVISIBLE, ExtraData.SOURCE_POI_OSM_DB, (byte) 97, (byte) 98, (byte) 99, (byte) 100, (byte) 101, (byte) 102};
    static final int REPLACEMENT_CHARACTER = 65533;
    Segment head;
    long size;

    /* renamed from: okio.Buffer$1 */
    class C03591 extends OutputStream {
        C03591() {
        }
    ...
    class C03602 extends InputStream {
        C03602() {
        }
    ...
    private ByteString digest(String algorithm) {
        try {
            ...
            return ByteString.m31of(messageDigest.digest());
    ...
    private ByteString hmac(String algorithm, ByteString key) {
        try {
            ...
            return ByteString.m31of(mac.doFinal());
        } catch (NoSuchAlgorithmException e) {
            throw new AssertionError();
