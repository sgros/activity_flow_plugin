...
public class PathTextBuilder {
    ...
    public PathTextBuilder(GraphicAdapter graphicAdapter, String elementName, Attributes attributes) throws SAXException {
    ...
    private void extractValues(GraphicAdapter graphicAdapter, String elementName, Attributes attributes) throws SAXException {
        ...
        XmlUtils.checkMandatoryAttribute(elementName, f73K, this.textKey);
    }
}
