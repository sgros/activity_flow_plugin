...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00381();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00412();
    ...
    class C00412 extends WorkerRunnable<Params, Result> {
        C00412() {
        }
