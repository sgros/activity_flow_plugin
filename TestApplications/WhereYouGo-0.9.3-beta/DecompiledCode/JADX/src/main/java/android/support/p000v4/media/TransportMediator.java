...
public class TransportMediator extends TransportController {
    ...
    class C00792 implements Callback {
        C00792() {
        }
    ...
    class C03911 implements TransportMediatorCallback {
        C03911() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C03911();
        this.mKeyEventCallback = new C00792();
        this.mContext = activity != null ? activity : view.getContext();
        this.mCallbacks = callbacks;
        this.mAudioManager = (AudioManager) this.mContext.getSystemService(LocusConst.VALUE_TRK_REC_ADD_WAYPOINT_AUDIO);
        if (activity != null) {
