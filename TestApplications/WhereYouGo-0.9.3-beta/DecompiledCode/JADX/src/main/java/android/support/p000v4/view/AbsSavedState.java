...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C01162());
    public static final AbsSavedState EMPTY_STATE = new C01151();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C01151 extends AbsSavedState {
        C01151() {
            super();
        }
    }
    ...
    static class C01162 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C01162() {
        }
