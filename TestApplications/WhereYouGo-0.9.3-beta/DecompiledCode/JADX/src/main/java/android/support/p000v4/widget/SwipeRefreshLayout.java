...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01541 implements AnimationListener {
        C01541() {
        }
    ...
    class C01552 extends Animation {
        C01552() {
        }
    ...
    class C01563 extends Animation {
        C01563() {
        }
    ...
    class C01585 implements AnimationListener {
        C01585() {
        }
    ...
    class C01596 extends Animation {
        C01596() {
        }
    ...
    class C01607 extends Animation {
        C01607() {
        }
    ...
    class C01618 extends Animation {
        C01618() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01541();
        this.mAnimateToCorrectPosition = new C01596();
        this.mAnimateToStartPosition = new C01607();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01552();
    ...
    public void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01563();
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01618();
