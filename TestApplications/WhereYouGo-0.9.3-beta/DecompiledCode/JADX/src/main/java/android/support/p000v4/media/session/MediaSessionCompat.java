...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private Callback mVolumeCallback = new C00971();
        ...
        class C00982 implements MediaSessionCompatApi19.Callback {
            C00982() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
            ...
            this.mAudioManager = (AudioManager) context.getSystemService(LocusConst.VALUE_TRK_REC_ADD_WAYPOINT_AUDIO);
            this.mTag = tag;
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            MediaSessionCompatApi19.Callback cb19 = new C00982();
            if (VERSION.SDK_INT >= 18) {
            ...
            if (this.mIsActive) {
                if (!this.mIsMbrRegistered && (this.mFlags & 1) != 0) {
                    if (VERSION.SDK_INT >= 18) {
                        ...
                        ((AudioManager) this.mContext.getSystemService(LocusConst.VALUE_TRK_REC_ADD_WAYPOINT_AUDIO)).registerMediaButtonEventReceiver(this.mMediaButtonReceiverComponentName);
                    }
                    ...
                    if (VERSION.SDK_INT >= 18) {
                        ...
                        ((AudioManager) this.mContext.getSystemService(LocusConst.VALUE_TRK_REC_ADD_WAYPOINT_AUDIO)).unregisterMediaButtonEventReceiver(this.mMediaButtonReceiverComponentName);
                    }
