...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01001();
    ...
    static class C01001 implements Creator<PlaybackStateCompat> {
        C01001() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01011();
        ...
        static class C01011 implements Creator<CustomAction> {
            C01011() {
            }
