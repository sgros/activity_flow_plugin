...
public final class RSS14Reader extends AbstractRSSReader {
   ...
   private static Result constructResult(Pair var0, Pair var1) {
      ...
      String var10 = String.valueOf(var3.toString());
      ResultPoint var11 = var12[0];
      ResultPoint var14 = var12[1];
      ResultPoint var13 = var8[0];
      ResultPoint var9 = var8[1];
      BarcodeFormat var15 = BarcodeFormat.RSS_14;
      return new Result(var10, (byte[])null, new ResultPoint[]{var11, var14, var13, var9}, var15);
   }
   ...
   private DataCharacter decodeDataCharacter(BitArray var1, FinderPattern var2, boolean var3) throws NotFoundException {
      ...
      int[] var8 = this.getEvenCounts();
      float[] var16 = this.getOddRoundingErrors();
      float[] var14 = this.getEvenRoundingErrors();
      ...
      if (var3) {
         ...
         var11 = RSSUtils.getRSSvalue(var8, 9 - var11, true);
         var15 = new DataCharacter(var12 * OUTSIDE_EVEN_TOTAL_SUBSET[var9] + var11 + OUTSIDE_GSUM[var9], var5);
      } else {
         if ((var11 & 1) != 0 || var11 > 10 || var11 < 4) {
            throw NotFoundException.getNotFoundInstance();
         }

         var9 = (10 - var11) / 2;
         var11 = INSIDE_ODD_WIDEST[var9];
         var12 = RSSUtils.getRSSvalue(var7, var11, true);
         var15 = new DataCharacter(RSSUtils.getRSSvalue(var8, 9 - var11, false) * INSIDE_ODD_TOTAL_SUBSET[var9] + var12 + INSIDE_GSUM[var9], var5);
      }
   ...
   private int[] findFinderPattern(BitArray var1, int var2, boolean var3) throws NotFoundException {
      ...
      for(int var9 = var8; var10 < var5; var7 = var3) {
         if (var1.get(var10) ^ var7) {
   ...
   public Result decodeRow(int var1, BitArray var2, Map var3) throws NotFoundException {
      ...
      var2.reverse();
      Iterator var5 = this.possibleLeftPairs.iterator();
      ...
      while(true) {
         do {
            ...
            var4 = (Pair)var5.next();
         } while(var4.getCount() <= 1);

         Iterator var8 = this.possibleRightPairs.iterator();

         while(var8.hasNext()) {
            Pair var6 = (Pair)var8.next();
            if (var6.getCount() > 1 && checkChecksum(var4, var6)) {
               return constructResult(var4, var6);
            }
         }
      }
   }
