   ...
   public Result decodeRow(int var1, BitArray var2, Map var3) throws NotFoundException, ChecksumException, FormatException {
      ...
      if (var10 != var5 && var2.get(var10)) {
         if (var7.length() < 2) {
            ...
            ResultPoint var20 = new ResultPoint(var13, (float)var1);
            ResultPoint var18 = new ResultPoint(var14 + var15, (float)var1);
            BarcodeFormat var19 = BarcodeFormat.CODE_93;
            return new Result(var16, (byte[])null, new ResultPoint[]{var20, var18}, var19);
         }
      } else {
         throw NotFoundException.getNotFoundInstance();
      }
