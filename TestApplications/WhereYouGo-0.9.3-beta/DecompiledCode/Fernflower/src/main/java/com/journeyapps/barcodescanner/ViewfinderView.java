   ...
   public void onDraw(Canvas var1) {
      ...
      if (this.framingRect != null && this.previewFramingRect != null) {
         ...
         if (this.resultBitmap != null) {
            ...
            List var13 = this.possibleResultPoints;
            List var11 = this.lastPossibleResultPoints;
            var5 = var2.left;
            var7 = var2.top;
            ResultPoint var14;
            if (var13.isEmpty()) {
               ...
               this.possibleResultPoints = new ArrayList(5);
               this.lastPossibleResultPoints = var13;
               this.paint.setAlpha(160);
               this.paint.setColor(this.resultPointColor);
               Iterator var10 = var13.iterator();

               while(var10.hasNext()) {
                  var14 = (ResultPoint)var10.next();
                  var1.drawCircle((float)((int)(var14.getX() * var8) + var5), (float)((int)(var14.getY() * var9) + var7), 6.0F, this.paint);
               }
            }
            ...
            if (var11 != null) {
               ...
               while(var12.hasNext()) {
                  var14 = (ResultPoint)var12.next();
                  var1.drawCircle((float)((int)(var14.getX() * var8) + var5), (float)((int)(var14.getY() * var9) + var7), 3.0F, this.paint);
               }
            }
