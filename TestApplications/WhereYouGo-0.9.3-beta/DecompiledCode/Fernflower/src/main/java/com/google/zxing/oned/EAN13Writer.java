...
public final class EAN13Writer extends UPCEANWriter {
   ...
   public boolean[] encode(String var1) {
      if (var1.length() != 13) {
         ...
         var2 += appendPattern(var4, var2, UPCEANReader.MIDDLE_PATTERN, false);

         for(var5 = 7; var5 <= 12; ++var5) {
            var7 = Integer.parseInt(var1.substring(var5, var5 + 1));
            var2 += appendPattern(var4, var2, UPCEANReader.L_PATTERNS[var7], true);
         }

         appendPattern(var4, var2, UPCEANReader.START_END_PATTERN, true);
         return var4;
      }
   }
}
