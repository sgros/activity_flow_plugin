      ...
      if (var2 < 3) {
         ...
         if (var2 == 3) {
            ...
            for(int var5 = 0; var5 < var2 - 2; ++var5) {
               FinderPattern var15 = (FinderPattern)var1.get(var5);
               if (var15 != null) {
                  for(int var6 = var5 + 1; var6 < var2 - 1; ++var6) {
                     FinderPattern var7 = (FinderPattern)var1.get(var6);
                     if (var7 != null) {
                        float var8 = (var15.getEstimatedModuleSize() - var7.getEstimatedModuleSize()) / Math.min(var15.getEstimatedModuleSize(), var7.getEstimatedModuleSize());
                        if (Math.abs(var15.getEstimatedModuleSize() - var7.getEstimatedModuleSize()) > 0.5F && var8 >= 0.05F) {
                           break;
                        }
                        ...
                        for(int var9 = var6 + 1; var9 < var2; ++var9) {
                           ...
                           if (var10 != null) {
                              ...
                              FinderPattern[] var11 = new FinderPattern[]{var15, var7, var10};
                              ...
                              float var14 = (var12 + var13) / (var15.getEstimatedModuleSize() * 2.0F);
                              if (var14 <= 180.0F && var14 >= 9.0F && Math.abs((var12 - var13) / Math.min(var12, var13)) < 0.1F) {
                                 var12 = (float)Math.sqrt((double)(var12 * var12 + var13 * var13));
                                 if (Math.abs((var8 - var12) / Math.min(var8, var12)) < 0.1F) {
                                    var4.add(var11);
                                 }
                              }
                           }
            ...
            var3 = (FinderPattern[][])var4.toArray(new FinderPattern[var4.size()][]);
         }
