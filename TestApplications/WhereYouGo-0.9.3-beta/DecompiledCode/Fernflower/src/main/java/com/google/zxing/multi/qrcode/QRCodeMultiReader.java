            ...
            do {
               if (!var5.hasNext()) {
                  ...
                  while(true) {
                     ...
                     do {
                        if (!var18.hasNext()) {
                           Result var19 = new Result(var13.toString(), var22, NO_POINTS, BarcodeFormat.QR_CODE);
                           if (var17 > 0) {
                              ArrayList var14 = new ArrayList();
                              var14.add(var20);
                              var19.putMetadata(ResultMetadataType.BYTE_SEGMENTS, var14);
                           }
                        ...
                        var9 = (Result)var18.next();
                        System.arraycopy(var9.getRawBytes(), 0, var22, var15, var9.getRawBytes().length);
                        var10 = var15 + var9.getRawBytes().length;
                        var15 = var10;
                     } while(!var9.getResultMetadata().containsKey(ResultMetadataType.BYTE_SEGMENTS));

                     Iterator var23 = ((Iterable)var9.getResultMetadata().get(ResultMetadataType.BYTE_SEGMENTS)).iterator();
                     var8 = var7;
                     ...
                     while(true) {
                        ...
                        byte[] var11 = (byte[])var23.next();
                        System.arraycopy(var11, 0, var20, var8, var11.length);
                        var8 += var11.length;
                     }
                  }
               }
               ...
               var7 = var15 + var6.getRawBytes().length;
               var15 = var7;
            } while(!var6.getResultMetadata().containsKey(ResultMetadataType.BYTE_SEGMENTS));

            Iterator var21 = ((Iterable)var6.getResultMetadata().get(ResultMetadataType.BYTE_SEGMENTS)).iterator();
            var8 = var17;
