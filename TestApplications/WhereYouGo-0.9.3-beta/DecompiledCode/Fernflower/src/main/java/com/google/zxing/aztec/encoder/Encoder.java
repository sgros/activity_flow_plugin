...
public final class Encoder {
   ...
   public static AztecCode encode(byte[] var0, int var1, int var2) {
      ...
      BitArray var13 = generateModeMessage(var8, var9, var5);
      if (var8) {
         var18 = 11;
      } else {
         var18 = 14;
      ...
      if (var8) {
         ...
         while(true) {
            ...
            var1 = var2 + var2 / 15;
            var19[var11 - var2 - 1] = var7 - var1 - 1;
            var19[var11 + var2] = var7 + var1 + 1;
            ++var2;
         }
      }
      ...
      for(var12 = 0; var2 < var9; ++var2) {
         ...
         int var14 = (var9 - var2 << 2) + var21;

         for(var11 = 0; var11 < var14; ++var11) {
            int var15 = var11 << 1;

            for(var7 = 0; var7 < 2; ++var7) {
               if (var3.get(var12 + var15 + var7)) {
                  var17.set(var19[(var2 << 1) + var7], var19[(var2 << 1) + var11]);
               }

               if (var3.get((var14 << 1) + var12 + var15 + var7)) {
                  var17.set(var19[(var2 << 1) + var11], var19[var4 - 1 - (var2 << 1) - var7]);
               }

               if (var3.get((var14 << 2) + var12 + var15 + var7)) {
                  var17.set(var19[var4 - 1 - (var2 << 1) - var7], var19[var4 - 1 - (var2 << 1) - var11]);
               }

               if (var3.get(var14 * 6 + var12 + var15 + var7)) {
                  var17.set(var19[var4 - 1 - (var2 << 1) - var11], var19[(var2 << 1) + var7]);
               }
            }
         }
      ...
      drawModeMessage(var17, var8, var1, var13);
      if (var8) {
         ...
         for(var2 = 0; var12 < var4 / 2 - 1; var2 += 16) {
            for(var11 = var1 / 2 & 1; var11 < var1; var11 += 2) {
               var17.set(var1 / 2 - var2, var11);
               var17.set(var1 / 2 + var2, var11);
               var17.set(var11, var1 / 2 - var2);
               var17.set(var11, var1 / 2 + var2);
            }
      ...
      AztecCode var20 = new AztecCode();
      var20.setCompact(var8);
      var20.setSize(var1);
      var20.setLayers(var9);
      var20.setCodeWords(var5);
      var20.setMatrix(var17);
      return var20;
   }
