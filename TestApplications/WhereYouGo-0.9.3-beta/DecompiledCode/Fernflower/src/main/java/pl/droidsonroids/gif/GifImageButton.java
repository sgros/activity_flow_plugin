...
public class GifImageButton extends ImageButton {
   ...
   public GifImageButton(Context var1) {
      super(var1);
   }

   public GifImageButton(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.postInit(GifViewUtils.initImageView(this, var2, 0, 0));
   }

   public GifImageButton(Context var1, AttributeSet var2, int var3) {
      super(var1, var2, var3);
      this.postInit(GifViewUtils.initImageView(this, var2, var3, 0));
   }

   @RequiresApi(21)
   public GifImageButton(Context var1, AttributeSet var2, int var3, int var4) {
