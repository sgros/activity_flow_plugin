...
public class CustomDialog {
   ...
   private static void setCustomDialogTitleButton(View var0, int var1, int var2, final CustomDialog.OnClickListener var3) {
      if (var2 != Integer.MIN_VALUE && var3 != null) {
         ...
         ImageButton var5;
         if (var1 == 1) {
            var4 = (ImageView)var0.findViewById(2131492892);
            var5 = (ImageButton)var0.findViewById(2131492893);
         } else {
            var4 = (ImageView)var0.findViewById(2131492890);
            var5 = (ImageButton)var0.findViewById(2131492891);
         }
