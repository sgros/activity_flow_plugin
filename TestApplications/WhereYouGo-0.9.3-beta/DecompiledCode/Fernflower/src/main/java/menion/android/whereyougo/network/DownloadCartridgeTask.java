   ...
   private boolean init() {
      ...
      label23: {
         ...
         try {
            ...
            OkHttpClient.Builder var6 = new OkHttpClient.Builder();
            TLSSocketFactory var3 = new TLSSocketFactory();
            OkHttpClient.Builder var7 = var6.sslSocketFactory(var3);
            NonPersistentCookieJar var8 = new NonPersistentCookieJar();
            this.httpClient = var7.cookieJar(var8).connectTimeout(30L, TimeUnit.SECONDS).readTimeout(30L, TimeUnit.SECONDS).writeTimeout(30L, TimeUnit.SECONDS).build();
            break label23;
         ...
         Logger.e("DownloadCartridgeTask", "init()", (Exception)var2);
         this.errorMessage = ((GeneralSecurityException)var2).getMessage();
      }
