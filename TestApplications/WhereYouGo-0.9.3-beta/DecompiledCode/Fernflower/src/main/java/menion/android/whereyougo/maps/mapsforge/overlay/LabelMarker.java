   ...
   public boolean draw(BoundingBox var1, byte var2, Canvas var3, Point var4) {
      ...
      label284: {
         ...
         label285: {
            ...
            try {
               GeoPoint var34 = this.getGeoPoint();
               Drawable var6 = this.getDrawable();
               double var7 = var34.latitude;
               int var9 = (int)(MercatorProjection.longitudeToPixelX(var34.longitude, var2) - var4.x);
               int var10 = (int)(MercatorProjection.latitudeToPixelY(var7, var2) - var4.y);
               Rect var35 = var6.copyBounds();
               ...
               var9 = (var9 + var11 + var9 + var12) / 2 - var36.width() / 2;
               var35 = new Rect(var9 - 2, var10 - 2, var36.width() + var9 + 2, var36.height() + var10 + 2);
               var3.drawRect(var35, labelBgPaint);
               var3.drawRect(var35, labelPaint);
               var3.drawText(this.label, (float)var9, (float)(var36.height() + var10), labelPaint);
