...
public class MainMenuActivity extends CustomActivity implements IRefreshable {
   ...
   public void onCreate(Bundle var1) {
      ...
      if (A.getMain() != null && Engine.instance != null) {
         ...
         String var2;
         CustomDialog.OnClickListener var3;
         if (Preferences.GLOBAL_SAVEGAME_SLOTS > 0) {
            var2 = this.getString(2131165403);
            var3 = new CustomDialog.OnClickListener() {
            ...
            var2 = this.getString(2131165399);
            var3 = new CustomDialog.OnClickListener() {
               public boolean onClick(CustomDialog var1, View var2, int var3) {
         ...
         while(true) {
            ...
            label72: {
               try {
                  ...
                  File var15 = new File(var7.append(var3.getAbsolutePath()).append(".").append(var5).toString());
                  if (var15.exists()) {
                     var4 = String.format("%s %d: %s", this.getString(2131165402), var5, UtilsFormat.formatDatetime(var15.lastModified()));
                     break label72;
                  }
            ...
            MainActivity.wui.setOnSavingFinished(new Runnable() {
               public void run() {
                  try {
                     ...
                     String var5 = String.format("%s: %s", MainMenuActivity.this.getString(2131165397), UtilsFormat.formatDatetime(var1x.lastModified()));
                     MainMenuActivity.this.saveGameMainMenuItem.setTitle(var5);
                     String var6 = String.format("%s %d: %s", MainMenuActivity.this.getString(2131165402), var1.getItemId(), UtilsFormat.formatDatetime(var2.lastModified()));
                     var1.setTitle(var6);
                     var6 = String.format("%s %d\n%s", MainMenuActivity.this.getString(2131165402), var1.getItemId(), MainMenuActivity.this.getText(2131165401));
                     ManagerNotify.toastShortMessage(MainMenuActivity.this, var6);
