      ...
      if (!var2.equals("X")) {
         if (Preferences.comparePreferenceKey(var2, 2131165569)) {
            ...
            if (Preferences.comparePreferenceKey(var2, 2131165574)) {
               ...
               ArrayList var7 = StringToken.parse(var4, "_");
               Configuration var8 = this.getBaseContext().getResources().getConfiguration();
               java.util.Locale var9;
               if ("default".equals(var4)) {
                  var9 = java.util.Locale.getDefault();
               } else if (var7.size() == 1) {
                  var9 = new java.util.Locale(var4);
               } else if (var7.size() == 2) {
                  var9 = new java.util.Locale((String)var7.get(0), (String)var7.get(1));
               } else {
                  var9 = var8.locale;
               }
