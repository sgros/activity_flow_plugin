...
public class MainApplication extends Application {
   ...
   private void initCore() {
      ...
      try {
         String var2 = String.format("%s, app:%s", A.getAppName(), A.getAppVersion());
         String var6 = String.format("Android %s", VERSION.RELEASE);
         WherigoLib.env.put("DeviceID", var2);
         WherigoLib.env.put("Platform", var6);
