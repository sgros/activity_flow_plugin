...
public class ActionTools {
   ...
   public static int updateLocusWaypoint(Context var0, LocusUtils.LocusVersion var1, Waypoint var2, boolean var3, boolean var4) throws RequiredVersionMissingException {
      ...
      if (!LocusUtils.isLocusFreePro(var1, var5)) {
         ...
         Uri var6 = getContentProviderData(var1, LocusUtils.VersionCode.UPDATE_01, "waypoint");
         if (var6 != null) {
            ContentValues var7 = new ContentValues();
            var7.put("waypoint", var2.getAsBytes());
            var7.put("forceOverwrite", var3);
            var7.put("loadAllGcWaypoints", var4);
            return var0.getContentResolver().update(var6, var7, (String)null, (String[])null);
         } else {
            throw new RequiredVersionMissingException(var5);
         }
      }
