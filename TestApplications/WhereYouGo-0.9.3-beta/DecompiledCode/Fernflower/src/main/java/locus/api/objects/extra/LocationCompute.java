...
public class LocationCompute {
   ...
   public static void computeDistanceAndBearing(double var0, double var2, double var4, double var6, double var8, double var10, double var12, float[] var14) {
      ...
      var8 = 0.0D;
      var0 = Math.atan((1.0D - var12) * Math.tan(var0 * 0.017453292519943295D));
      var2 = Math.atan((1.0D - var12) * Math.tan(var4 * 0.017453292519943295D));
      double var19 = Math.cos(var0);
      double var21 = Math.cos(var2);
      double var23 = Math.sin(var0);
      double var25 = Math.sin(var2);
      ...
      while(true) {
         ...
         var42 = var42 / 1024.0D * (256.0D + (-128.0D + (74.0D - 47.0D * var42) * var42) * var42);
         double var44 = var12 / 16.0D * var31 * (4.0D + (4.0D - 3.0D * var31) * var12);
         var31 = var40 * var40;
         var31 = var42 * var36 * (var42 / 4.0D * ((-1.0D + 2.0D * var31) * var38 - var42 / 6.0D * var40 * (-3.0D + 4.0D * var36 * var36) * (-3.0D + 4.0D * var31)) + var40);
         var40 = var17 + (1.0D - var44) * var12 * var4 * (var44 * var36 * (var44 * var38 * (-1.0D + 2.0D * var40 * var40) + var40) + var2);
