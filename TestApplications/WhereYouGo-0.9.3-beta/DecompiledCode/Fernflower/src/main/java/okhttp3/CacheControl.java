      ...
      for(int var15 = var0.size(); var14 < var15; var12 = var31) {
         ...
         label85: {
            ...
            while(true) {
               ...
               var27 = HttpHeaders.skipUntil(var17, var18, "=,;");
               var16 = var17.substring(var18, var27).trim();
               if (var27 != var17.length() && var17.charAt(var27) != ',' && var17.charAt(var27) != ';') {
                  var18 = HttpHeaders.skipWhitespace(var17, var27 + 1);
                  if (var18 < var17.length() && var17.charAt(var18) == '"') {
                     var27 = var18 + 1;
                     var18 = HttpHeaders.skipUntil(var17, var27, "\"");
                     var30 = var17.substring(var27, var18);
                     var27 = var18 + 1;
                  } else {
                     var27 = HttpHeaders.skipUntil(var17, var18, ",;");
                     var30 = var17.substring(var18, var27).trim();
                  }
               } else {
                  ++var27;
                  var30 = null;
