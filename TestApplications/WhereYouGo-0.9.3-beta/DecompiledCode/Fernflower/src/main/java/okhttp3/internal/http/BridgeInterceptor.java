...
public final class BridgeInterceptor implements Interceptor {
   ...
   public Response intercept(Interceptor.Chain var1) throws IOException {
      ...
      Response var12 = var1.proceed(var3.build());
      HttpHeaders.receiveHeaders(this.cookieJar, var2.url(), var12.headers());
      Response.Builder var10 = var12.newBuilder().request(var2);
      if (var9 && "gzip".equalsIgnoreCase(var12.header("Content-Encoding")) && HttpHeaders.hasBody(var12)) {
         GzipSource var11 = new GzipSource(var12.body().source());
         Headers var13 = var12.headers().newBuilder().removeAll("Content-Encoding").removeAll("Content-Length").build();
         var10.headers(var13);
         var10.body(new RealResponseBody(var13, Okio.buffer((Source)var11)));
      }
