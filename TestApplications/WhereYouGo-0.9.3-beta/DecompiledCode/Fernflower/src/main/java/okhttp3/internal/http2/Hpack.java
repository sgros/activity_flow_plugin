   ...
   static final class Reader {
      ...
      private void insertIntoDynamicTable(int var1, Header var2) {
         ...
         if (var4 > this.maxDynamicTableByteCount) {
            ...
            var3 = this.evictToRecoverBytes(this.dynamicTableByteCount + var4 - this.maxDynamicTableByteCount);
            if (var1 == -1) {
               if (this.headerCount + 1 > this.dynamicTable.length) {
                  Header[] var5 = new Header[this.dynamicTable.length * 2];
                  System.arraycopy(this.dynamicTable, 0, var5, this.dynamicTable.length, this.dynamicTable.length);
                  this.nextHeaderIndex = this.dynamicTable.length - 1;
               ...
               int var6 = this.dynamicTableIndex(var1);
               this.dynamicTable[var1 + var6 + var3] = var2;
            }
