      ...
      public Entry(Source var1) throws IOException {
         label1451: {
            ...
            label1455: {
               ...
               String var7;
               try {
                  var6 = var3.get(SENT_MILLIS);
                  var7 = var3.get(RECEIVED_MILLIS);
               ...
               label1411: {
                  try {
                     ...
                     if (this.isHttps()) {
                        String var170 = var2.readUtf8LineStrict();
                        if (var170.length() > 0) {
                           StringBuilder var174 = new StringBuilder();
                           IOException var169 = new IOException(var174.append("expected \"\" but was \"").append(var170).append("\"").toString());
                           throw var169;
                        }
                        break label1411;
                     }
               ...
               label1401: {
                  try {
                     var172 = CipherSuite.forJavaName(var2.readUtf8LineStrict());
                     var171 = this.readCertificateList(var2);
                     var173 = this.readCertificateList(var2);
                     if (!var2.exhausted()) {
               ...
               label1394:
               try {
                  this.handshake = Handshake.get(var166, var172, var171, var173);
                  break label1451;
         ...
         if (var2 == -1) {
            ...
            label35: {
               ...
               while(true) {
                  ...
                  try {
                     String var7 = var1.readUtf8LineStrict();
                     Buffer var11 = new Buffer();
                     var11.write(ByteString.decodeBase64(var7));
                     var5.add(var4.generateCertificate(var11.inputStream()));
