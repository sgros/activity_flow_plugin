   ...
   private X509TrustManager systemDefaultTrustManager() {
      try {
         ...
         if (var2.length == 1 && var2[0] instanceof X509TrustManager) {
            X509TrustManager var6 = (X509TrustManager)var2[0];
            return var6;
         } else {
            StringBuilder var5 = new StringBuilder();
            IllegalStateException var3 = new IllegalStateException(var5.append("Unexpected default trust managers:").append(Arrays.toString(var2)).toString());
            throw var3;
         }
