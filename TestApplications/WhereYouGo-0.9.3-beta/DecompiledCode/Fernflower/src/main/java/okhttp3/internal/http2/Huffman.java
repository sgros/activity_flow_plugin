...
class Huffman {
   ...
   private void addCode(int var1, int var2, byte var3) {
      ...
      Huffman.Node var5;
      for(var5 = this.root; var3 > 8; var5 = var5.children[var1]) {
         var3 = (byte)(var3 - 8);
         var1 = var2 >>> var3 & 255;
         ...
         if (var5.children[var1] == null) {
            var5.children[var1] = new Huffman.Node();
         }
      }
      ...
      for(var1 = var2; var1 < var2 + (1 << var6); ++var1) {
         var5.children[var1] = var4;
      }

   }

   private void buildTree() {
      for(int var1 = 0; var1 < CODE_LENGTHS.length; ++var1) {
         this.addCode(var1, CODES[var1], CODE_LENGTHS[var1]);
      }
   ...
   byte[] decode(byte[] var1) {
      ...
      while(true) {
         int var7 = var5;
         Huffman.Node var8 = var3;
         if (var6 >= var1.length) {
            while(var7 > 0) {
               Huffman.Node var9 = var8.children[var4 << 8 - var7 & 255];
               if (var9.children != null || var9.terminalBits > var7) {
                  break;
               }

               var2.write(var9.symbol);
               var7 -= var9.terminalBits;
               var8 = this.root;
            }
         ...
         var4 = var4 << 8 | var1[var6] & 255;
         var5 += 8;

         while(var5 >= 8) {
            var3 = var3.children[var4 >>> var5 - 8 & 255];
            if (var3.children == null) {
               var2.write(var3.symbol);
               var5 -= var3.terminalBits;
               var3 = this.root;
            } else {
               var5 -= 8;
            }
   ...
   void encode(ByteString var1, BufferedSink var2) throws IOException {
      ...
      for(int var6 = 0; var6 < var1.size(); ++var6) {
         int var7 = var1.getByte(var6) & 255;
         int var8 = CODES[var7];
         byte var9 = CODE_LENGTHS[var7];
         var3 = var3 << var9 | (long)var8;
         var5 += var9;

         while(var5 >= 8) {
            var5 -= 8;
            var2.writeByte((int)(var3 >> var5));
         }
      }

      if (var5 > 0) {
         var2.writeByte((int)(var3 << 8 - var5 | (long)(255 >>> var5)));
      }
   ...
   int encodedLength(ByteString var1) {
      ...
      for(int var4 = 0; var4 < var1.size(); ++var4) {
         byte var5 = var1.getByte(var4);
         var2 += (long)CODE_LENGTHS[var5 & 255];
      }

      return (int)(7L + var2 >> 3);
   }
