...
public final class Headers {
   ...
   public static Headers of(String... var0) {
      if (var0 == null) {
         ...
         for(var2 = 0; var2 < var1.length; var2 += 2) {
            String var4 = var1[var2];
            String var3 = var1[var2 + 1];
            if (var4.length() == 0 || var4.indexOf(0) != -1 || var3.indexOf(0) != -1) {
               throw new IllegalArgumentException("Unexpected header: " + var4 + ": " + var3);
            }
         }
