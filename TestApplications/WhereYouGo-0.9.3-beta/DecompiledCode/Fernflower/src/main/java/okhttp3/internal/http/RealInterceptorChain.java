   ...
   public Response proceed(Request var1, StreamAllocation var2, HttpCodec var3, Connection var4) throws IOException {
      if (this.index >= this.interceptors.size()) {
         ...
         if (this.httpCodec != null && !this.sameConnection(var1.url())) {
            ...
            RealInterceptorChain var5 = new RealInterceptorChain(this.interceptors, var2, var3, var4, this.index + 1, var1);
            Interceptor var6 = (Interceptor)this.interceptors.get(this.index);
            Response var7 = var6.intercept(var5);
            if (var3 != null && this.index + 1 < this.interceptors.size() && var5.calls != 1) {
               throw new IllegalStateException("network interceptor " + var6 + " must call proceed() exactly once");
            } else if (var7 == null) {
               throw new NullPointerException("interceptor " + var6 + " returned null");
            } else {
               return var7;
            }
         }
