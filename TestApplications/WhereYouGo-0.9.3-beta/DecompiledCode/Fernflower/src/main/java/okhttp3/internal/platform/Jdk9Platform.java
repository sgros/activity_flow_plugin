...
final class Jdk9Platform extends Platform {
   ...
   public Jdk9Platform(Method var1, Method var2) {
   ...
   public static Jdk9Platform buildIfSupported() {
      Jdk9Platform var2;
      try {
         Method var0 = SSLParameters.class.getMethod("setApplicationProtocols", String[].class);
         Method var1 = SSLSocket.class.getMethod("getApplicationProtocol");
         var2 = new Jdk9Platform(var0, var1);
