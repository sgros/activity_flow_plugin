         ...
         if (var2 != null) {
            ...
            try {
               if ((long)var7.size() > 123L) {
                  ...
                  IllegalArgumentException var41 = new IllegalArgumentException(var43.append("reason.size() > 123: ").append(var2).toString());
                  throw var41;
               }
         ...
         label287: {
            ...
            if (!var8) {
               try {
                  ...
                  ArrayDeque var42 = this.messageAndCloseQueue;
                  RealWebSocket.Close var40 = new RealWebSocket.Close(var1, var6, var3);
                  var42.add(var40);
                  this.runWriter();
                  return var5;
   ...
   public void connect(OkHttpClient var1) {
      ...
      this.call.enqueue(new Callback() {
         ...
         public void onResponse(Call var1, Response var2x) {
            ...
            var6.noNewStreams();
            RealWebSocket.Streams var3x = var6.connection().newWebSocketStreams(var6);
            ...
            try {
               ...
               RealWebSocket.this.initReaderAndWriter(var8, (long)var2, var3x);
   ...
   public void initReaderAndWriter(String var1, long var2, RealWebSocket.Streams var4) throws IOException {
      ...
      label281: {
         ...
         label282: {
            ...
            if (var2 != 0L) {
               try {
                  ScheduledExecutorService var36 = this.executor;
                  RealWebSocket.PingRunnable var39 = new RealWebSocket.PingRunnable();
                  var36.scheduleAtFixedRate(var39, var2, var2, TimeUnit.MILLISECONDS);
               } catch (Throwable var34) {
                  var10000 = var34;
                  var10001 = false;
                  break label282;
