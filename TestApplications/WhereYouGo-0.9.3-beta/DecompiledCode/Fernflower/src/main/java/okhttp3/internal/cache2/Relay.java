...
final class Relay {
   ...
   public static Relay read(File var0) throws IOException {
      ...
      FileOperator var7 = new FileOperator(var1.getChannel());
      Buffer var2 = new Buffer();
      var7.read(0L, var2, 32L);
      if (!var2.readByteString((long)PREFIX_CLEAN.size()).equals(PREFIX_CLEAN)) {
         ...
         var2 = new Buffer();
         var7.read(32L + var3, var2, var5);
         return new Relay(var1, (Source)null, var3, var2.readByteString(), 0L);
      }
   }
