...
public abstract class RequestBody {
   public static RequestBody create(final MediaType var0, final File var1) {
      if (var1 == null) {
   ...
   public static RequestBody create(MediaType var0, String var1) {
   ...
   public static RequestBody create(final MediaType var0, final ByteString var1) {
      return new RequestBody() {
   ...
   public static RequestBody create(MediaType var0, byte[] var1) {
      return create(var0, var1, 0, var1.length);
   }

   public static RequestBody create(final MediaType var0, final byte[] var1, final int var2, final int var3) {
      if (var1 == null) {
         throw new NullPointerException("content == null");
      } else {
