      ...
      if (var5 < 1) {
         ...
         while(true) {
            ...
            if (var9 >= 0 && var9 <= 20) {
               ...
               if (var10 >= 0 && var10 <= 22) {
                  var8.zoomLevelMin = (byte)var10;
                  var9 = var1.readByte();
                  if (var9 >= 0 && var9 <= 22) {
                     var8.zoomLevelMax = (byte)var9;
                     if (var10 > var9) {
                        var15 = new FileOpenResult("invalid zoom level range: " + var10 + ' ' + var9);
                        break;
                     }
                  ...
                  var15 = new FileOpenResult("invalid maximum zoom level: " + var9);
                  break;
               }

               var15 = new FileOpenResult("invalid minimum zoom level: " + var10);
               break;
            }
