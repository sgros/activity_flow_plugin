...
public class Zone extends Thing {
   ...
   private void preprocess() {
      if (this.points != null && this.points.length != 0) {
         ...
         double var8;
         for(var1 = 0; var1 < this.points.length; var6 = var8) {
            var8 = this.points[var1].latitude - this.bbCenter.latitude;
            double var10 = this.points[var1].longitude - this.bbCenter.longitude;
            var10 = var8 * var8 + var10 * var10;
            var8 = var6;
            if (var10 > var6) {
      ...
      if (this.active && this.points != null && this.points.length != 0 && var1 != null) {
         ...
         if (var1.latitude > this.pbbBottom && var1.latitude < this.pbbTop && var1.longitude > this.pbbLeft && var1.longitude < this.pbbRight) {
                     ...
                     if (var2 <= var6) {
                        if (var8 > var4 && var14 > var4) {
                           ...
                           label150: {
                              ...
                              var22 = var10;
                              if ((var4 - var18) * (var6 - var16) < (var20 - var18) * (var2 - var16)) {
                                 if (!var10) {
                                    var22 = true;
                                 } else {
                                    var22 = false;
            ...
            if (this.ncontain != 2) {
               ...
               for(int var25 = 0; var25 < this.points.length; var23 = var18) {
                  var20 = this.points[var25].latitude;
                  var14 = this.points[var25].longitude;
                  var4 = (var1.latitude - var6) * (var20 - var6) + (var1.longitude - var8) * (var14 - var8);
                  if (var4 > 0.0D) {
                     var18 = (var1.latitude - var20) * (var6 - var20) + (var1.longitude - var14) * (var8 - var14);
                     if (var18 <= 0.0D) {
                        var6 = var20;
                        var8 = var14;
                     } else {
                        var6 += (var20 - var6) * var4 / (var4 + var18);
                        var8 += (var14 - var8) * var4 / (var4 + var18);
                     }
                  }

                  var4 = (var6 - var1.latitude) * (var6 - var1.latitude) + (var8 - var1.longitude) * (var8 - var1.longitude);
                  var18 = var23;
                  if (var4 < var23) {
                     var18 = var4;
                     var12 = var8;
               ...
               this.nearestPoint.latitude = var16;
               this.nearestPoint.longitude = var12;
               var8 = var1.distance(var16, var12);
               this.distance = var8;
