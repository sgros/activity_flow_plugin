   ...
   public boolean onTouchEvent(MotionEvent var1) {
      ...
      if (var3 == 0 || !this.mIgnoreTap) {
         ...
         case 0:
            ...
            break;
         case 1:
            if (var4 < (float)(this.mCurrText.getLeft() - this.mTabPadding)) {
               this.mPager.setCurrentItem(this.mPager.getCurrentItem() - 1);
            } else if (var4 > (float)(this.mCurrText.getRight() + this.mTabPadding)) {
               this.mPager.setCurrentItem(this.mPager.getCurrentItem() + 1);
            }
            break;
         case 2:
            if (Math.abs(var4 - this.mInitialMotionX) > (float)this.mTouchSlop || Math.abs(var5 - this.mInitialMotionY) > (float)this.mTouchSlop) {
