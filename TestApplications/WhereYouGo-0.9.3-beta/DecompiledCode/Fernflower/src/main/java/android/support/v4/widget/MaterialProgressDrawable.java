...
class MaterialProgressDrawable extends Drawable implements Animatable {
   ...
   private int evaluateColorChange(float var1, int var2, int var3) {
      ...
      return (int)((float)((var3 >> 24 & 255) - var5) * var1) + var5 << 24 | (int)((float)((var3 >> 16 & 255) - var6) * var1) + var6 << 16 | (int)((float)((var3 >> 8 & 255) - var2) * var1) + var2 << 8 | (int)((float)((var3 & 255) - var4) * var1) + var4;
   }
