   ...
   static class GestureDetectorCompatImplBase implements GestureDetectorCompat.GestureDetectorCompatImpl {
      ...
      public boolean onTouchEvent(MotionEvent var1) {
         ...
         case 1:
            ...
            if (this.mIsDoubleTapping) {
               ...
               label152: {
                  ...
                  var5 = VelocityTrackerCompat.getYVelocity(var16, var17);
                  var6 = VelocityTrackerCompat.getXVelocity(var16, var17);
                  ...
                  var12 = this.mListener.onFling(this.mCurrentDownEvent, var1, var6, var5);
               }
            }
         ...
         case 2:
            ...
            if (!this.mInLongPress) {
               ...
               if (this.mIsDoubleTapping) {
                  ...
                  var4 = (int)(var5 - this.mDownFocusX);
                  var17 = (int)(var6 - this.mDownFocusY);
                  var17 = var4 * var4 + var17 * var17;
                  var11 = var9;
         ...
         case 6:
            ...
            var6 = VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, var17);
            var5 = VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, var17);
            var17 = 0;
            ...
            while(true) {
               ...
               if (var17 != var4) {
                  ...
                  if (var6 * VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, var8) + var5 * VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, var8) < 0.0F) {
