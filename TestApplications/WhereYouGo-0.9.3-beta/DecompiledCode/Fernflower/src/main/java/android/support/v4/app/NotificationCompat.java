...
public class NotificationCompat {
   ...
   static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor var0, NotificationCompat.Style var1) {
      if (var1 != null) {
         if (var1 instanceof NotificationCompat.MessagingStyle) {
            NotificationCompat.MessagingStyle var2 = (NotificationCompat.MessagingStyle)var1;
            ArrayList var3 = new ArrayList();
            ArrayList var4 = new ArrayList();
            ArrayList var5 = new ArrayList();
            ArrayList var6 = new ArrayList();
            ArrayList var9 = new ArrayList();
            Iterator var7 = var2.mMessages.iterator();

            while(var7.hasNext()) {
               NotificationCompat.MessagingStyle.Message var8 = (NotificationCompat.MessagingStyle.Message)var7.next();
               var3.add(var8.getText());
               var4.add(var8.getTimestamp());
               var5.add(var8.getSender());
               var6.add(var8.getDataMimeType());
               var9.add(var8.getDataUri());
            }

            NotificationCompatApi24.addMessagingStyle(var0, var2.mUserDisplayName, var2.mConversationTitle, var3, var4, var5, var6, var9);
         } else {
   ...
   public static class MessagingStyle extends NotificationCompat.Style {
      ...
      public static final class Message {
         ...
         static NotificationCompat.MessagingStyle.Message getMessageFromBundle(Bundle var0) {
            NotificationCompat.MessagingStyle.Message var1;
            label62: {
               label63: {
                  boolean var10001;
                  try {
                  ...
                  NotificationCompat.MessagingStyle.Message var2;
                  try {
                     var2 = new NotificationCompat.MessagingStyle.Message(var0.getCharSequence("text"), var0.getLong("time"), var0.getCharSequence("sender"));
                  ...
                  try {
                     if (!var0.containsKey("uri")) {
                        return var1;
                     }

                     var2.setData(var0.getString("type"), (Uri)var0.getParcelable("uri"));
   ...
   static class NotificationCompatImplJellybean extends NotificationCompat.NotificationCompatImplBase {
      public Notification build(NotificationCompat.Builder var1, NotificationCompat.BuilderExtender var2) {
         ...
         Notification var4 = var2.build(var1, var3);
         if (var1.mStyle != null) {
            Bundle var5 = this.getExtras(var4);
            if (var5 != null) {
