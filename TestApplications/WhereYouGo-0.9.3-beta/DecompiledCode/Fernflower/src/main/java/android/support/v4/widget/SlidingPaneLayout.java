...
public class SlidingPaneLayout extends ViewGroup {
            ...
            if (var21.getVisibility() != 8) {
               ...
               if (var21.getVisibility() != 8) {
                  ...
                  if (var9 && var21 != this.mSlideableView) {
                     ...
                     if (var9) {
                        int var18 = var10 - (var20.leftMargin + var20.rightMargin);
                        var15 = MeasureSpec.makeMeasureSpec(var18, 1073741824);
                        if (var7 != var18) {
                           var21.measure(var15, var1);
                        }
                     } else {
      ...
      if (!this.mCanSlide) {
         ...
         case 1:
            ...
            if (this.isDimmed(this.mSlideableView)) {
               var5 = var1.getX();
               var6 = var1.getY();
               float var7 = var5 - this.mInitialMotionX;
               float var8 = var6 - this.mInitialMotionY;
               var3 = this.mDragHelper.getTouchSlop();
               var2 = var4;
               if (var7 * var7 + var8 * var8 < (float)(var3 * var3)) {
                  var2 = var4;
                  if (this.mDragHelper.isViewUnder(this.mSlideableView, (int)var5, (int)var6)) {
   ...
   boolean smoothSlideTo(float var1, int var2) {
      ...
      if (this.mCanSlide) {
         ...
         if (var4) {
            var2 = this.getPaddingRight();
            int var6 = var5.rightMargin;
            int var7 = this.mSlideableView.getWidth();
            var2 = (int)((float)this.getWidth() - ((float)(var2 + var6) + (float)this.mSlideRange * var1 + (float)var7));
         } else {
