...
class FragmentTransition {
   ...
   private static void callSharedElementStartEnd(Fragment var0, Fragment var1, boolean var2, ArrayMap var3, boolean var4) {
      ...
      if (var8 != null) {
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            var5.add(var3.keyAt(var7));
            var9.add(var3.valueAt(var7));
         }
   ...
   private static void configureTransitionsOptimized(FragmentManagerImpl var0, int var1, FragmentTransition.FragmentContainerTransition var2, View var3, ArrayMap var4) {
      ...
      if (var5 != null) {
         ...
         Object var14 = getEnterTransition(var6, var8);
         Object var12 = getExitTransition(var7, var9);
         Object var15 = configureSharedElementsOptimized(var5, var3, var4, var2, var11, var10, var14, var12);
         if (var14 != null || var15 != null || var12 != null) {
            ArrayList var13 = configureEnteringExitingViews(var12, var7, var11, var3);
            ArrayList var16 = configureEnteringExitingViews(var14, var6, var10, var3);
            setViewVisibility(var16, 4);
            Object var17 = mergeTransitions(var14, var12, var15, var6, var8);
            if (var17 != null) {
               replaceHide(var12, var7, var13);
               ArrayList var18 = FragmentTransitionCompat21.prepareSetNameOverridesOptimized(var10);
               FragmentTransitionCompat21.scheduleRemoveTargets(var17, var14, var16, var12, var13, var15, var10);
               ...
               FragmentTransitionCompat21.swapSharedElementTargets(var15, var11, var10);
            }
         }
      }
