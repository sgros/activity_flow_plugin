...
public class ViewDragHelper {
   ...
   private int computeSettleDuration(View var1, int var2, int var3, int var4, int var5) {
      ...
      float var12;
      if (var6 != 0) {
         var12 = (float)var9 / (float)var11;
      } else {
         var12 = (float)var7 / (float)var5;
      }

      float var13;
      if (var4 != 0) {
         var13 = (float)var10 / (float)var11;
      } else {
         var13 = (float)var8 / (float)var5;
      }

      var2 = this.computeAxisDuration(var2, var6, this.mCallback.getViewHorizontalDragRange(var1));
   ...
   public void processTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         this.tryCaptureViewForDrag(var12, var2);
      ...
      case 2:
         if (this.mDragState == 1) {
            if (this.isValidPointerForActionMove(this.mActivePointerId)) {
               ...
               var4 = var1.getX(var3);
               var5 = var1.getY(var3);
               var2 = (int)(var4 - this.mLastMotionX[this.mActivePointerId]);
               var3 = (int)(var5 - this.mLastMotionY[this.mActivePointerId]);
               this.dragTo(this.mCapturedView.getLeft() + var2, this.mCapturedView.getTop() + var3, var2, var3);
            ...
            for(var3 = 0; var3 < var2; ++var3) {
               ...
               if (this.isValidPointerForActionMove(var13)) {
                  float var7 = var1.getX(var3);
                  var5 = var1.getY(var3);
                  var4 = var7 - this.mInitialMotionX[var13];
                  float var8 = var5 - this.mInitialMotionY[var13];
                  this.reportNewEdgeDrags(var4, var8, var13);
                  if (this.mDragState == 1) {
                     break;
                  }

                  View var9 = this.findTopChildUnder((int)var7, (int)var5);
                  if (this.checkTouchSlop(var9, var4, var8) && this.tryCaptureViewForDrag(var9, var13)) {
                     break;
                  }
               }
            }
      ...
      case 5:
         ...
         if (this.mDragState == 0) {
            this.tryCaptureViewForDrag(this.findTopChildUnder((int)var4, (int)var5), var2);
            var3 = this.mInitialEdgesTouched[var2];
            if ((this.mTrackingEdges & var3) != 0) {
               this.mCallback.onEdgeTouched(this.mTrackingEdges & var3, var2);
            }
         } else if (this.isCapturedViewUnder((int)var4, (int)var5)) {
         ...
         if (this.mDragState == 1 && var10 == this.mActivePointerId) {
            ...
            while(true) {
               ...
               if (var2 != this.mActivePointerId) {
                  var5 = var1.getX(var3);
                  var4 = var1.getY(var3);
                  if (this.findTopChildUnder((int)var5, (int)var4) == this.mCapturedView && this.tryCaptureViewForDrag(this.mCapturedView, var2)) {
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      case 0:
         ...
         var6 = var1.getY();
         var2 = var1.getPointerId(0);
         this.saveInitialMotion(var5, var6, var2);
         ...
         if (this.mInitialMotionX != null && this.mInitialMotionY != null) {
            ...
            for(var2 = 0; var2 < var7; ++var2) {
               ...
               if (this.isValidPointerForActionMove(var8)) {
                  ...
                  float var10 = var1.getY(var2);
                  var6 = var9 - this.mInitialMotionX[var8];
                  var5 = var10 - this.mInitialMotionY[var8];
                  View var11 = this.findTopChildUnder((int)var9, (int)var10);
                  boolean var19;
                  if (var11 != null && this.checkTouchSlop(var11, var6, var5)) {
                     var19 = true;
                  } else {
                     var19 = false;
                  }
                  ...
                  if (var19) {
                     ...
                     int var13 = (int)var6;
                     var13 = this.mCallback.clampViewPositionHorizontal(var11, var12 + var13, (int)var6);
                     int var14 = var11.getTop();
                     int var15 = (int)var5;
                     var15 = this.mCallback.clampViewPositionVertical(var11, var14 + var15, (int)var5);
                     int var16 = this.mCallback.getViewHorizontalDragRange(var11);
                     int var17 = this.mCallback.getViewVerticalDragRange(var11);
                     if ((var16 == 0 || var16 > 0 && var13 == var12) && (var17 == 0 || var17 > 0 && var15 == var14)) {
                        break;
                     }
                  }

                  this.reportNewEdgeDrags(var6, var5, var8);
