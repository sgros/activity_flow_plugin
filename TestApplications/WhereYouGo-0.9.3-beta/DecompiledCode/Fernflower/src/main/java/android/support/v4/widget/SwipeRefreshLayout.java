   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.getChildCount() != 0) {
         ...
         if (this.mTarget != null) {
            ...
            var6.layout(var4, var3, var4 + (var2 - this.getPaddingLeft() - this.getPaddingRight()), var3 + (var5 - this.getPaddingTop() - this.getPaddingBottom()));
                     ...
                     case 1:
                        ...
                        if (var3 < 0) {
                           ...
                           if (this.mIsBeingDragged) {
                              ...
                              var5 = this.mInitialMotionY;
                              this.mIsBeingDragged = false;
                              this.finishSpinner((var6 - var5) * 0.5F);
                           }
