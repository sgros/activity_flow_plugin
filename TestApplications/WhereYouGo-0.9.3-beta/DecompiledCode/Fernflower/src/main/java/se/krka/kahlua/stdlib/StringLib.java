...
public final class StringLib implements JavaFunction {
   ...
   private static String addString(StringLib.MatchState var0, Object var1, StringLib.StringPointer var2, StringLib.StringPointer var3) {
      ...
      StringLib.StringPointer var11 = new StringLib.StringPointer(var4);
      StringBuffer var5 = new StringBuffer();

      for(int var6 = 0; var6 < var4.length(); ++var6) {
         if (var11.getChar(var6) != '%') {
            var5.append(var11.getChar(var6));
         } else {
            int var7 = var6 + 1;
            if (!Character.isDigit(var11.getChar(var7))) {
               var5.append(var11.getChar(var7));
               var6 = var7;
            } else if (var11.getChar(var7) == '0') {
               ...
               var5.append(var8.substring(0, var6));
               var6 = var7;
            } else {
               var6 = var11.getChar(var7) - 49;
               Object[] var12 = var0.getCaptures();
               if (var12 == null || var6 > var0.level) {
                  throw new RuntimeException("invalid capture index");
               }

               Object var13 = var12[var6];
               if (var13 instanceof Double) {
                  Double var10 = (Double)var13;
                  if (var10 - (double)var10.intValue() == 0.0D) {
                     var5.append(String.valueOf(((Double)var13).intValue()));
                     var6 = var7;
                  } else {
                     var5.append(String.valueOf((Double)var13));
                     var6 = var7;
                  }
               } else {
                  var5.append(var13);
   ...
   private static int findAux(LuaCallFrame var0, boolean var1) {
      ...
      if (var1 && (var5 || noSpecialChars(var4))) {
         ...
         StringLib.StringPointer var8 = new StringLib.StringPointer(var4);
         StringLib.MatchState var9 = new StringLib.MatchState();
         boolean var14 = false;
         if (var8.getChar() == '^') {
            var14 = true;
            var8.postIncrString(1);
         }

         StringLib.StringPointer var12 = var11.getClone();
         var12.postIncrString(var7);
         var9.callFrame = var0;
         var9.src_init = var11.getClone();
         var9.endIndex = var11.getString().length();

         do {
            var9.level = 0;
            StringLib.StringPointer var13 = match(var9, var12, var8);
            if (var13 != null) {
               if (var1) {
                  var7 = var0.push(new Double((double)(var11.length() - var12.length() + 1)), new Double((double)(var11.length() - var13.length()))) + push_captures(var9, (StringLib.StringPointer)null, (StringLib.StringPointer)null);
               } else {
                  var7 = push_captures(var9, var12, var13);
               }

               return var7;
            }
         } while(var12.postIncrStringI(1) < var9.endIndex && !var14);
      }
               ...
               while(true) {
                  ...
                  default:
                     ...
                     case 'x':
                        ...
                        break;
                     default:
                        throw new RuntimeException("invalid option '%" + var7 + "' to 'format'");
                     }
                     ...
                     int var43 = var6.length();
                     if (!var11) {
                        this.extend(var6, var42, var27);
                     }
                     ...
                     case 'e':
                     case 'f':
                        var46 = this.getDoubleArg(var1, var5);
                        if (!var46.isInfinite() && !var46.isNaN()) {
                           var36 = false;
                        } else {
                           var36 = true;
                        }
                        ...
                        if (var36) {
                           var6.append(BaseLib.numberToString(var46));
                        } else if (var7 == 'f') {
                     ...
                     case 'g':
                        ...
                        if (var36) {
                           ...
                           var32 = MathLib.roundToSignificantNumbers(var34, var45);
                           if (var32 == 0.0D || var32 >= 1.0E-4D && var32 < MathLib.ipow(10.0D, var45)) {
                              if (var32 == 0.0D) {
                                 var39 = 1;
                              ...
                              this.appendSignificantNumber(var6, var32, var45 - var39, var9);
                              break;
                           }

                           this.appendScientificNumber(var6, var32, var45 - 1, var9, true);
                        }
                        break;
                     case 'X':
                     case 'o':
                     ...
                     case 'x':
                        ...
                        if (var9) {
                           ...
                           } else if (var40 == 16 && var28 != 0L) {
                              var6.append(var26);
                           }
                        }

                        if (var28 != 0L || var16 > 0) {
                           stringBufferAppend(var6, (double)var28, var40, false, var16);
                        }
                        break;
                     case 'c':
                     ...
                     case 'i':
                        ...
                        if (var30 != 0L || var16 > 0) {
                           stringBufferAppend(var6, (double)var30, var40, false, var16);
                        }
                        break;
                     case 'q':
                        var26 = this.getStringArg(var1, var5);
                        var6.append('"');

                        for(var2 = 0; var2 < var26.length(); ++var2) {
                           var7 = var26.charAt(var2);
                           switch(var7) {
                           case '\n':
                              var6.append("\\\n");
                              break;
                     ...
                     case 's':
                        ...
                        var2 = var26.length();
                        if (var18) {
                           var2 = Math.min(var16, var26.length());
                        }

                        this.append(var6, var26, 0, var2);
                        break;
                     default:
                     ...
                     if (var11) {
                        var2 = var42 - (var6.length() - var43);
                        if (var2 > 0) {
                           this.extend(var6, var2, ' ');
                        }
                     } else {
                        var2 = Math.min(var6.length() - var43 - var42, var42);
                        if (var2 > 0) {
                           var6.delete(var43, var43 + var2);
                        }

                        if (var41) {
                           var2 = var43 + (var42 - var2);
                           var7 = var6.charAt(var2);
                           if (var7 == '+' || var7 == '-' || var7 == ' ') {
                              var6.setCharAt(var2, '0');
                              var6.setCharAt(var43, var7);
                           }
                        }
                     }

                     if (var38) {
                        this.stringBufferUpperCase(var6, var43);
                     }
   ...
   private static int gsub(LuaCallFrame var0, int var1) {
      ...
      while(true) {
         ...
         var8.level = 0;
         StringLib.StringPointer var13 = match(var8, var12, var15);
         var1 = var9;
         if (var13 != null) {
            var1 = var9 + 1;
            addValue(var8, var4, var10, var12, var13);
         }

         if (var13 != null && var13.getIndex() > var12.getIndex()) {
            var12.setIndex(var13.getIndex());
         } else {
            var11 = var1;
            ...
            var10.append(var12.postIncrString(1));
         }
      ...
      return var0.push(var10.append(var12.getString()).toString(), new Double((double)var11));
   }
