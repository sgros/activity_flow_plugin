...
public final class Headers
{
    ...
    public static final class Builder
    {
        ...
        Builder addLenient(final String s) {
            ...
            Builder builder;
            if (index != -1) {
                builder = this.addLenient(s.substring(0, index), s.substring(index + 1));
            }
            else if (s.startsWith(":")) {
                builder = this.addLenient("", s.substring(1));
            }
            else {
                builder = this.addLenient("", s);
            }
            return builder;
        }
