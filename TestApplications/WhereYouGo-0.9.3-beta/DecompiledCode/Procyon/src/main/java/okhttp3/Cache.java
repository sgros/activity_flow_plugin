                    ...
                    Label_0306:
                        while (true) {
                            try {
                                ...
                                Serializable value2 = ((Headers.Builder)str).get(Entry.RECEIVED_MILLIS);
                                ...
                                if (value != null) {
                                    ...
                                    if (((String)str).length() > 0) {
                                        ...
                                        throw new IOException(((StringBuilder)value2).append("expected \"\" but was \"").append((String)str).append("\"").toString());
                                    }
                                    break Label_0312;
                                }
                            }
