...
final class Hpack
{
    ...
    private static Map<ByteString, Integer> nameToFirstIndex() {
        final LinkedHashMap<ByteString, Integer> m = new LinkedHashMap<ByteString, Integer>(Hpack.STATIC_HEADER_TABLE.length);
        ...
        return Collections.unmodifiableMap((Map<? extends ByteString, ? extends Integer>)m);
    }
    ...
    static final class Reader
    {
        ...
        private ByteString getName(final int n) {
            ...
            if (this.isStaticHeader(n)) {
                ...
                byteString = this.dynamicTable[this.dynamicTableIndex(n - Hpack.STATIC_HEADER_TABLE.length)].name;
            }
            return byteString;
        }
        ...
        ByteString readByteString() throws IOException {
            ...
            ByteString byteString;
            if (n != 0) {
                byteString = ByteString.of(Huffman.get().decode(this.source.readByteArray(int1)));
            }
            else {
                byteString = this.source.readByteString(int1);
            }
            return byteString;
        }
