...
final class Base64
{
    ...
    Label_0185_Outer:
        ...
        if (n11 != array.length) {
            array2 = new byte[n11];
            System.arraycopy(array, 0, array2, 0, n11);
            return array2;
        }
        return array2;
    }
                    ...
                    case 1: {
                        Label_0193: {
                            ...
                            try {
                                ...
                                final int n7 = n6 + 1;
                                bytes[n6] = array2[(array[n] & 0x3) << 4 | (array[n + 1] & 0xFF) >> 4];
                                final int n8 = n7 + 1;
                                bytes[n7] = array2[(array[n + 1] & 0xF) << 2];
                                bytes[n8] = 61;
                                return new String(bytes, "US-ASCII");
                                final int n9 = n2 + 1;
                                bytes[n2] = array2[(array[n] & 0xFF) >> 2];
                                final int n10 = n9 + 1;
                                bytes[n9] = array2[(array[n] & 0x3) << 4];
                                final int n11 = n10 + 1;
                                bytes[n10] = 61;
                                bytes[n11] = 61;
                                return new String(bytes, "US-ASCII");
