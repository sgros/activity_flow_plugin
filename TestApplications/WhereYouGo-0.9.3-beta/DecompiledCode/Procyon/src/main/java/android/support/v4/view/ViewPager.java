    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener((View)this, new OnApplyWindowInsetsListener() {
            ...
            public WindowInsetsCompat onApplyWindowInsets(final View view, WindowInsetsCompat dispatchApplyWindowInsets) {
                WindowInsetsCompat windowInsetsCompat = ViewCompat.onApplyWindowInsets(view, dispatchApplyWindowInsets);
                if (!windowInsetsCompat.isConsumed()) {
                    final Rect mTempRect = this.mTempRect;
                    mTempRect.left = windowInsetsCompat.getSystemWindowInsetLeft();
                    mTempRect.top = windowInsetsCompat.getSystemWindowInsetTop();
                    mTempRect.right = windowInsetsCompat.getSystemWindowInsetRight();
                    mTempRect.bottom = windowInsetsCompat.getSystemWindowInsetBottom();
                    for (int i = 0; i < ViewPager.this.getChildCount(); ++i) {
                        dispatchApplyWindowInsets = ViewCompat.dispatchApplyWindowInsets(ViewPager.this.getChildAt(i), windowInsetsCompat);
                    ...
                    windowInsetsCompat = windowInsetsCompat.replaceSystemWindowInsets(mTempRect.left, mTempRect.top, mTempRect.right, mTempRect.bottom);
                }
