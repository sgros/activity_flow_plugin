    ...
    private static class RenderThread extends Thread implements TextureView$SurfaceTextureListener
    {
        ...
        public void run() {
            while (true) {
                ...
                Label_0073: {
                    try {
                        o = this.mGifTextureViewReference.get();
                        if (o != null) {
                            (this.mGifInfoHandle = ((GifTextureView)o).mInputSource.open()).setOptions('\u0001', ((GifTextureView)o).isOpaque());
                    ...
                    Label_0186: {
                        ...
                        try {
                            ...
                            if (surfaceTexture != null) {
                                ...
                                final GifTextureView gifTextureView2 = (GifTextureView)o;
                                final RenderThread renderThread2 = this;
                                final long[] array = renderThread2.mSavedState;
                                gifInfoHandle.bindSurface((Surface)gifTextureView2, array);
                                continue;
                            }
                            continue;
                        }
