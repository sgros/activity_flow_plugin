...
public class GifImageButton extends ImageButton
{
    ...
    public GifImageButton(final Context context) {
        super(context);
    }
    
    public GifImageButton(final Context context, final AttributeSet set) {
        super(context, set);
        this.postInit(GifViewUtils.initImageView((ImageView)this, set, 0, 0));
    }
    
    public GifImageButton(final Context context, final AttributeSet set, final int n) {
        super(context, set, n);
        this.postInit(GifViewUtils.initImageView((ImageView)this, set, n, 0));
    }
    
    @RequiresApi(21)
    public GifImageButton(final Context context, final AttributeSet set, final int n, final int n2) {
        super(context, set, n, n2);
        this.postInit(GifViewUtils.initImageView((ImageView)this, set, n, n2));
    }
    ...
    public void setBackgroundResource(final int backgroundResource) {
        if (!GifViewUtils.setResource((ImageView)this, false, backgroundResource)) {
    ...
    public void setImageResource(final int imageResource) {
        if (!GifViewUtils.setResource((ImageView)this, true, imageResource)) {
            super.setImageResource(imageResource);
        }
    }
    
    public void setImageURI(final Uri imageURI) {
        if (!GifViewUtils.setGifImageUri((ImageView)this, imageURI)) {
