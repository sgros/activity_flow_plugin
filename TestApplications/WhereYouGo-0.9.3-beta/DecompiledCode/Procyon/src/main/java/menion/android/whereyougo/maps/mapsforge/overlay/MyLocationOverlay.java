...
public class MyLocationOverlay implements LocationListener, Overlay
{
    ...
    public MyLocationOverlay(final Context context, final MapView mapView, final Marker marker) {
        this(context, mapView, marker, getDefaultCircleFill(), getDefaultCircleStroke());
    }
    
    public MyLocationOverlay(final Context context, final MapView mapView, final Marker marker, final Paint paint, final Paint paint2) {
