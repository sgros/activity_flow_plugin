        ...
        this.runOnUiThread((Runnable)new Runnable() {
            ...
            public void run() {
                ...
                if (et != null && et.isLocated() && et.isVisible() && A.getGuidingContent() != null) {
                    final Location targetLocation = A.getGuidingContent().getTargetLocation();
                    final Location location = UtilsWherigo.extractLocation(et);
                    if (location != null && !location.equals(targetLocation)) {
                        A.getGuidingContent().guideStart(new Guide(et.name, location));
                    }
                }
            }
        });
