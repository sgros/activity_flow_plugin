...
public class DownloadCartridgeTask extends AsyncTask<String, Progress, Boolean>
{
    ...
    private boolean init() {
        ...
        try {
            ...
            Object o = new OkHttpClient.Builder();
            final OkHttpClient.Builder sslSocketFactory = ((OkHttpClient.Builder)o).sslSocketFactory(new TLSSocketFactory());
            o = new NonPersistentCookieJar();
            this.httpClient = sslSocketFactory.cookieJar((CookieJar)o).connectTimeout(30L, TimeUnit.SECONDS).readTimeout(30L, TimeUnit.SECONDS).writeTimeout(30L, TimeUnit.SECONDS).build();
        ...
        catch (KeyManagementException o) {
            goto Label_0127;
        }
    }
