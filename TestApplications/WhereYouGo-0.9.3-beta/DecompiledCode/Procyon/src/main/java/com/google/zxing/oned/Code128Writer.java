...
public final class Code128Writer extends OneDimensionalCodeWriter
{
    ...
    public boolean[] encode(final String s) {
        ...
        for (int j = 0; j < length; j = n4) {
            final int chooseCode = chooseCode(s, j, n3);
            int int1 = 0;
            int n5;
            if (chooseCode == n3) {
                switch (s.charAt(j)) {
        ...
        final boolean[] array2 = new boolean[n7];
        int n10 = 0;
        final Iterator<Object> iterator2 = list.iterator();
        while (iterator2.hasNext()) {
            n10 += OneDimensionalCodeWriter.appendPattern(array2, n10, iterator2.next(), true);
        }
        return array2;
    }
