...
public class Waypoint extends GeoData
{
    ...
    public void setExtraCallback(String generateCallbackString, final String s, final String s2, final String s3, final String s4) {
        generateCallbackString = ExtraData.generateCallbackString(generateCallbackString, s, s2, s3, s4);
