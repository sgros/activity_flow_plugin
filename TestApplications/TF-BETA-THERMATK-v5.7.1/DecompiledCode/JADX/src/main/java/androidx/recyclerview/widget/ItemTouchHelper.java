...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C33052();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C00711();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C00731();
        private static final Interpolator sDragViewScrollCapInterpolator = new C00742();
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: androidx.recyclerview.widget.ItemTouchHelper$Callback$1 */
        static class C00731 implements Interpolator {
        ...
        static class C00742 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = AndroidUtilities.m26dp(20.0f);
            }
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f5mX, recoverAnimation.f6mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f5mX, recoverAnimation.f6mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                i2 = canvas.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C00751 implements AnimatorUpdateListener {
            C00751() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new C00751());
        ...
        public void update() {
            ...
            if (f == f2) {
                this.f5mX = this.mViewHolder.itemView.getTranslationX();
            } else {
                this.f5mX = f + (this.mFraction * (f2 - f));
            }
            f = this.mStartDy;
            f2 = this.mTargetY;
            if (f == f2) {
                this.f6mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f6mY = f + (this.mFraction * (f2 - f));
            }
        }
    ...
    class C33052 implements OnItemTouchListener {
        C33052() {
        }
            ...
            if (actionMasked == 0) {
                ...
                if (itemTouchHelper.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ...
                        itemTouchHelper2.mInitialTouchX -= findAnimation.f5mX;
                        itemTouchHelper2.mInitialTouchY -= findAnimation.f6mY;
    ...
    class C33075 implements ChildDrawingOrderCallback {
        C33075() {
        }
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = (float) AndroidUtilities.m26dp(120.0f);
                this.mMaxSwipeVelocity = (float) AndroidUtilities.m26dp(800.0f);
                setupCallbacks();
            }
        }
    }
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f5mX, recoverAnimation.f6mY)) {
                return view2;
            }
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C33075();
            }
