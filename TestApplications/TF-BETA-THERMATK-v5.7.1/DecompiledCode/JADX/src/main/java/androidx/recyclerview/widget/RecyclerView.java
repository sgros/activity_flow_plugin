...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    static final Interpolator sQuinticInterpolator = new C00813();
    ...
    static class C00813 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C00821();
        ...
        private final Callback mVerticalBoundCheckCallback = new C00832();
        private int mWidth;
        ...
        class C00832 implements Callback {
            C00832() {
            }
    ...
    public final class Recycler {
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
            jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:60:0x011b in {4, 14, 15, 19, 20, 28, 38, 39, 40, 41, 42, 44, 49, 50, 52, 54, 57, 59} preds:[]
        ...
        void recycleViewHolderInternal(androidx.recyclerview.widget.RecyclerView.ViewHolder r7) {
            ...
            r3 = r3 + -1;
            r4 = androidx.recyclerview.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
            ...
            r4 = r6.mCachedViews;
            r4 = r4.get(r3);
            r4 = (androidx.recyclerview.widget.RecyclerView.ViewHolder) r4;
            r4 = r4.mPosition;
            ...
            r1.append(r2);
            r1.append(r7);
            r7 = androidx.recyclerview.widget.RecyclerView.this;
    ...
    class C33084 implements ProcessCallback {
        C33084() {
        }
    ...
    class C33095 implements Callback {
        C33095() {
        }
    ...
    class C33106 implements Callback {
        C33106() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C00841 implements ClassLoaderCreator<SavedState> {
            C00841() {
            }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C00791();
        ...
        this.mItemAnimatorRunner = new C00802();
        this.mViewInfoProcessCallback = new C33084();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C33095());
    }

    /* Access modifiers changed, original: 0000 */
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C33106());
    }
    ...
    L_0x0097:
        ...
        r0 = androidx.core.view.MotionEventCompat.isFromSource(r11, r0);
    ...
    public View focusSearch(View view, int i) {
        ...
        Object obj = (this.mAdapter == null || this.mLayout == null || isComputingLayout() || this.mLayoutSuppressed) ? null : 1;
    ...
    L_0x0009:
        goto L_0x01cb;
    L_0x000b:
        r0 = r14.dispatchToOnItemTouchListeners(r15);
        r2 = 1;
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (childCount = 0; childCount < this.mChildHelper.getChildCount(); childCount++) {
                ...
                if (!(childViewHolderInt2.shouldIgnore() || this.mViewInfoStore.isInPreLayout(childViewHolderInt2))) {
                    ...
                    boolean hasAnyOfTheFlags = childViewHolderInt2.hasAnyOfTheFlags(MessagesController.UPDATE_MASK_CHAT);
                    if (!hasAnyOfTheFlags) {
    ...
    public void recordAnimationInfoIfBouncedHiddenView(ViewHolder viewHolder, ItemHolderInfo itemHolderInfo) {
        viewHolder.setFlags(0, MessagesController.UPDATE_MASK_CHAT);
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(50.0f), 0);
    }
