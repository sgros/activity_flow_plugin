...
public final class AppCompatDrawableManager {
    ...
    L_0x0053:
        ...
        if (r7 == 0) goto L_0x00aa;
    L_0x005f:
        r1 = r1.getXml(r12);	 Catch:{ Exception -> 0x00a2 }
        r7 = android.util.Xml.asAttributeSet(r1);	 Catch:{ Exception -> 0x00a2 }
    L_0x0067:
        r8 = r1.next();	 Catch:{ Exception -> 0x00a2 }
        r9 = 2;
    ...
    L_0x0073:
        r3 = r1.getName();	 Catch:{ Exception -> 0x00a2 }
        r8 = r10.mKnownDrawableIdTags;	 Catch:{ Exception -> 0x00a2 }
        r8.append(r12, r3);	 Catch:{ Exception -> 0x00a2 }
        r8 = r10.mDelegates;	 Catch:{ Exception -> 0x00a2 }
        r3 = r8.get(r3);	 Catch:{ Exception -> 0x00a2 }
        r3 = (androidx.appcompat.widget.AppCompatDrawableManager.InflateDelegate) r3;	 Catch:{ Exception -> 0x00a2 }
        if (r3 == 0) goto L_0x008f;
    L_0x0086:
        r8 = r11.getTheme();	 Catch:{ Exception -> 0x00a2 }
        r1 = r3.createFromXmlInner(r11, r1, r7, r8);	 Catch:{ Exception -> 0x00a2 }
        r6 = r1;
    L_0x008f:
        if (r6 == 0) goto L_0x00aa;
    L_0x0091:
        r0 = r0.changingConfigurations;	 Catch:{ Exception -> 0x00a2 }
        r6.setChangingConfigurations(r0);	 Catch:{ Exception -> 0x00a2 }
        r10.addDrawableToCache(r11, r4, r6);	 Catch:{ Exception -> 0x00a2 }
        goto L_0x00aa;
    L_0x009a:
        r11 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ Exception -> 0x00a2 }
