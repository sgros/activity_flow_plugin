        ...
        if (isEmpty != 0 || isEmpty2 != 0 || isEmpty4 != 0 || isEmpty3 != 0) {
            ...
            if (isEmpty2 != 0) {
                ...
                if (!this.delayAnimations || isEmpty == 0) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c00611, getRemoveDuration());
                }
            }
            if (isEmpty3 != 0) {
                arrayList = new ArrayList();
                ...
                if (!this.delayAnimations || isEmpty == 0) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c00622, getRemoveDuration());
                }
            }
            if (isEmpty4 != 0) {
                ...
                if (!this.delayAnimations || (isEmpty == 0 && isEmpty2 == 0 && isEmpty3 == 0)) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c00633, removeDuration + Math.max(moveDuration, j));
                }
            }
        }
    }
