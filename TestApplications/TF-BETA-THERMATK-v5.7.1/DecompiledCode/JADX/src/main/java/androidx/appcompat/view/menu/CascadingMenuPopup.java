...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C00032();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C00021();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C32973();
    ...
    class C00021 implements OnGlobalLayoutListener {
        C00021() {
        }
    ...
    class C00032 implements OnAttachStateChangeListener {
    ...
    class C32973 implements MenuItemHoverListener {
        C32973() {
        }
