...
final class GapWorker implements Runnable {
    ...
    static Comparator<Task> sTaskComparator = new C00701();
    ...
    static class C00701 implements Comparator<Task> {
        C00701() {
        }
    ...
    public void run() {
        ...
        androidx.core.p001os.TraceCompat.beginSection(r2);	 Catch:{ all -> 0x004f }
        ...
        r6 = (androidx.recyclerview.widget.RecyclerView) r6;	 Catch:{ all -> 0x004f }
    ...
    private void flushTaskWithDeadline(Task task, long j) {
        ViewHolder prefetchPositionWithDeadline = prefetchPositionWithDeadline(task.view, task.position, task.immediate ? TimestampAdjuster.DO_NOT_OFFSET : j);
