...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    class C32981 implements VisibilityListener {
        C32981() {
        }
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(stringBuilder, i, MessagesController.UPDATE_MASK_CHECK, resources.getString(R$string.abc_menu_meta_shortcut_label));
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        if (actionProvider != null) {
            actionProvider.setVisibilityListener(new C32981());
        }
        return this;
    }
