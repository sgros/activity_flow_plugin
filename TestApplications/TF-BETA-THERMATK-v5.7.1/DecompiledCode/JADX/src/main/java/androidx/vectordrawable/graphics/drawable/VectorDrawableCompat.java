...
public class VectorDrawableCompat extends VectorDrawableCommon {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (vPath.isClipPath()) {
                    ...
                    if (!(vFullPath.mTrimPathStart == 0.0f && vFullPath.mTrimPathEnd == 1.0f)) {
                        ...
                        f3 = (f3 + f4) % 1.0f;
                        float f5 = (vFullPath.mTrimPathEnd + f4) % 1.0f;
                        ...
                        if (f3 > f5) {
                            ...
                            this.mPathMeasure.getSegment(f3, f5, path, true);
                        }
    ...
    private static class VectorDrawableCompatState extends ConstantState {
        ...
        public VectorDrawableCompatState(VectorDrawableCompatState vectorDrawableCompatState) {
            ...
            if (vectorDrawableCompatState != null) {
                ...
                paint = vectorDrawableCompatState.mVPathRenderer.mStrokePaint;
                if (paint != null) {
        ...
        public boolean hasTranslucentRoot() {
            return this.mVPathRenderer.getRootAlpha() < NalUnitUtil.EXTENDED_SAR;
        }
        ...
        public VGroup(VGroup vGroup, ArrayMap<String, Object> arrayMap) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof VGroup) {
                    ...
                    String str2 = vFullPath.mPathName;
                    if (str2 != null) {
                        arrayMap.put(str2, vFullPath);
                    }
                }
            }
        }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:34:0x00d9 in {4, 11, 12, 17, 18, 23, 24, 28, 29, 31, 33} preds:[]
    ...
    private void inflateInternal(android.content.res.Resources r11, org.xmlpull.v1.XmlPullParser r12, android.util.AttributeSet r13, android.content.res.Resources.Theme r14) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        r3 = r12.getName();
        r7 = r2.peek();
        r7 = (androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.VGroup) r7;
        r8 = "path";
        r8 = r8.equals(r3);
        if (r8 == 0) goto L_0x0060;
        r3 = new androidx.vectordrawable.graphics.drawable.VectorDrawableCompat$VFullPath;
        r3.<init>();
        ...
        r3 = new androidx.vectordrawable.graphics.drawable.VectorDrawableCompat$VClipPath;
        r3.<init>();
        r3.inflate(r11, r13, r14, r12);
        r7 = r7.mChildren;
        r7.add(r3);
