...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i == 4096) {
                ...
                return true;
            } else if (i != MessagesController.UPDATE_MASK_CHAT) {
                return false;
            } else {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        action &= NalUnitUtil.EXTENDED_SAR;
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (obj != null) {
                            ...
                            ensureGlows();
                            int i6 = scrollY + actionMasked;
                            if (i6 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) actionMasked) / ((float) getHeight()), motionEvent2.getX(i4) / ((float) getWidth()));
                                ...
                                scrollY2 = i4;
                                if (i6 > i3) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) actionMasked) / ((float) getHeight()), 1.0f - (motionEvent2.getX(scrollY2) / ((float) getWidth())));
