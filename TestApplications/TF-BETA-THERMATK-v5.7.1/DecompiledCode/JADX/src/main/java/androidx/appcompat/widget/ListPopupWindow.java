...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C00163 implements OnItemSelectedListener {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C00152();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C00163());
        ...
        Rect rect2;
        if (i5 == -2) {
            i6 = this.mContext.getResources().getDisplayMetrics().widthPixels;
            rect2 = this.mTempRect;
            makeMeasureSpec = MeasureSpec.makeMeasureSpec(i6 - (rect2.left + rect2.right), Integer.MIN_VALUE);
        } else if (i5 != -1) {
            makeMeasureSpec = MeasureSpec.makeMeasureSpec(i5, 1073741824);
        } else {
            i6 = this.mContext.getResources().getDisplayMetrics().widthPixels;
            rect2 = this.mTempRect;
            makeMeasureSpec = MeasureSpec.makeMeasureSpec(i6 - (rect2.left + rect2.right), 1073741824);
        }
