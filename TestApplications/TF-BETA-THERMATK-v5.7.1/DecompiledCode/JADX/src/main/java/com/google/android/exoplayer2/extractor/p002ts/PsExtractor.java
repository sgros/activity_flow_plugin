...
public final class PsExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = C3341-$$Lambda$PsExtractor$U8l9TedlJUwsYwV9EOSFo_ngcXY.INSTANCE;
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (442 != (((((bArr[0] & NalUnitUtil.EXTENDED_SAR) << 24) | ((bArr[1] & NalUnitUtil.EXTENDED_SAR) << 16)) | ((bArr[2] & NalUnitUtil.EXTENDED_SAR) << 8)) | (bArr[3] & NalUnitUtil.EXTENDED_SAR)) || (bArr[4] & 196) != 68 || (bArr[6] & 4) != 4 || (bArr[8] & 4) != 4 || (bArr[9] & 1) != 1 || (bArr[12] & 3) != 3) {
            return false;
        }
        extractorInput.advancePeekPosition(bArr[13] & 7);
        extractorInput.peekFully(bArr, 0, 3);
        if (1 == ((((bArr[0] & NalUnitUtil.EXTENDED_SAR) << 16) | ((bArr[1] & NalUnitUtil.EXTENDED_SAR) << 8)) | (bArr[2] & NalUnitUtil.EXTENDED_SAR))) {
            z = true;
        }
        return z;
    }
    ...
    public void seek(long j, long j2) {
        int i = 0;
        if (!((this.timestampAdjuster.getTimestampOffsetUs() == -9223372036854775807L ? 1 : null) == null && (this.timestampAdjuster.getFirstSampleTimestampUs() == 0 || this.timestampAdjuster.getFirstSampleTimestampUs() == j2))) {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        if (readInt == 442) {
            ...
            if (pesReader == null) {
                ...
                extractorInput.readFully(this.psPacketBuffer.data, 0, i);
