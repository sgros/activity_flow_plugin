...
public final class WebvttCue extends Cue {
    ...
    static /* synthetic */ class C02151 {
        ...
        L_0x002a:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.text.webvtt.WebvttCue$C02151.<clinit>():void");
        }
    }
    ...
    public static class Builder {
        ...
        private Builder derivePositionAnchorFromAlignment() {
            ...
            if (alignment == null) {
                ...
                int i = C02151.$SwitchMap$android$text$Layout$Alignment[alignment.ordinal()];
                if (i == 1) {
                    ...
                    Log.m18w("WebvttCueBuilder", stringBuilder.toString());
                    this.positionAnchor = 0;
                } else {
