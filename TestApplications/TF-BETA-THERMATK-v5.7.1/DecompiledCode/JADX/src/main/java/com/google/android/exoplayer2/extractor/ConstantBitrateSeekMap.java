...
public class ConstantBitrateSeekMap implements SeekMap {
    ...
    private long getFramePositionForTimeUs(long j) {
        j = (j * ((long) this.bitrate)) / 8000000;
        int i = this.frameSize;
        return this.firstFrameBytePosition + Util.constrainValue((j / ((long) i)) * ((long) i), 0, this.dataSize - ((long) i));
    }
}
