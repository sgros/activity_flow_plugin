...
public final class PrivateCommand extends SpliceCommand {
    public static final Creator<PrivateCommand> CREATOR = new C01871();
    public final byte[] commandBytes;
    public final long identifier;
    public final long ptsAdjustment;

    /* renamed from: com.google.android.exoplayer2.metadata.scte35.PrivateCommand$1 */
    static class C01871 implements Creator<PrivateCommand> {
        C01871() {
        }
    ...
    /* synthetic */ PrivateCommand(Parcel parcel, C01871 c01871) {
        this(parcel);
    }
