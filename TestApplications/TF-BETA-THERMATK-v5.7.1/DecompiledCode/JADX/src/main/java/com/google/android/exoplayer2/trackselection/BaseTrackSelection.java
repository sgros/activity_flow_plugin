...
import com.google.android.exoplayer2.trackselection.TrackSelection.C0221-CC;
...
public abstract class BaseTrackSelection implements TrackSelection {
    ...
    public /* synthetic */ void onDiscontinuity() {
        C0221-CC.$default$onDiscontinuity(this);
    }
    ...
    public /* synthetic */ void updateSelectedTrack(long j, long j2, long j3) {
        C0221-CC.$default$updateSelectedTrack(this, j, j2, j3);
    }
    ...
    public /* synthetic */ void updateSelectedTrack(long j, long j2, long j3, List<? extends MediaChunk> list, MediaChunkIterator[] mediaChunkIteratorArr) {
        C0221-CC.$default$updateSelectedTrack(this, j, j2, j3, list, mediaChunkIteratorArr);
    }
    ...
    public final boolean blacklist(int i, long j) {
        ...
        jArr[i] = Math.max(jArr[i], Util.addWithOverflowDefault(elapsedRealtime, j, TimestampAdjuster.DO_NOT_OFFSET));
        return true;
    }
