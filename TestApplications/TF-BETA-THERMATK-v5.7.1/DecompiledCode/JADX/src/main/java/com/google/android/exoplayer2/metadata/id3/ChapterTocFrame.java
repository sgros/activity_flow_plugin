...
public final class ChapterTocFrame extends Id3Frame {
    public static final Creator<ChapterTocFrame> CREATOR = new C01791();
    ...
    static class C01791 implements Creator<ChapterTocFrame> {
        C01791() {
        }
    ...
    public int hashCode() {
        int i = (((527 + this.isRoot) * 31) + this.isOrdered) * 31;
