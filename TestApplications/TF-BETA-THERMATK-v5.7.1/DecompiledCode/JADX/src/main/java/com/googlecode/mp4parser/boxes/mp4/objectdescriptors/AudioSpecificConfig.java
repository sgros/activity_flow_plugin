...
public class AudioSpecificConfig extends BaseDescriptor {
    ...
    static {
        ...
        Map map = samplingFrequencyIndexMap;
        Integer valueOf = Integer.valueOf(1);
        map.put(valueOf, Integer.valueOf(88200));
        map = samplingFrequencyIndexMap;
        ...
        audioObjectTypeMap.put(valueOf, "AAC main");
        audioObjectTypeMap.put(valueOf2, "AAC LC");
        audioObjectTypeMap.put(valueOf3, "AAC SSR");
        audioObjectTypeMap.put(valueOf4, "AAC LTP");
        audioObjectTypeMap.put(valueOf5, "SBR");
        audioObjectTypeMap.put(valueOf6, "AAC Scalable");
        audioObjectTypeMap.put(valueOf7, "TwinVQ");
        audioObjectTypeMap.put(Integer.valueOf(8), "CELP");
        audioObjectTypeMap.put(Integer.valueOf(9), "HVXC");
        String str = "(reserved)";
        audioObjectTypeMap.put(Integer.valueOf(10), str);
        audioObjectTypeMap.put(Integer.valueOf(11), str);
        ...
        audioObjectTypeMap.put(Integer.valueOf(18), str);
    ...
    public void parseDetail(ByteBuffer byteBuffer) throws IOException {
        ...
        switch (i) {
            ...
            case 22:
            case 23:
                parseGaSpecificConfig(this.samplingFrequencyIndex, this.channelConfiguration, i, bitReaderBuffer);
                break;
            case 8:
            ...
            case 26:
            case 27:
                parseParametricSpecificConfig(this.samplingFrequencyIndex, this.channelConfiguration, i, bitReaderBuffer);
                break;
            case 28:
