...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private static final class CueBuilder {
        ...
        public void defineWindow(boolean z, boolean z2, boolean z3, int i, boolean z4, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            if (!(i10 == 0 || this.windowStyleId == i10)) {
                this.windowStyleId = i10;
                i9 = i10 - 1;
            ...
            if (i11 != 0 && this.penStyleId != i11) {
                this.penStyleId = i11;
                i9 = i11 - 1;
                setPenAttributes(0, 1, 1, false, false, PEN_STYLE_EDGE_TYPE[i9], PEN_STYLE_FONT_STYLE[i9]);
                setPenColor(COLOR_SOLID_WHITE, PEN_STYLE_BACKGROUND[i9], COLOR_SOLID_BLACK);
            }
        }
        ...
        public void setPenColor(int i, int i2, int i3) {
            if (this.foregroundColorStartPosition != -1) {
                i3 = this.foregroundColor;
                if (i3 != i) {
                    this.captionStringBuilder.setSpan(new ForegroundColorSpan(i3), this.foregroundColorStartPosition, this.captionStringBuilder.length(), 33);
                }
            }
        ...
        L_0x0017:
            ...
            goto L_0x000f;
        L_0x002a:
            r1 = r15.buildSpannableString();
            r2.append(r1);
            r1 = r15.justification;
            r3 = 2;
            r4 = 3;
            r5 = 1;
        ...
        L_0x003f:
            ...
            r1.<init>();
            r2 = "Unexpected justification value: ";
            r1.append(r2);
            r2 = r15.justification;
            r1.append(r2);
            r1 = r1.toString();
            r0.<init>(r1);
            throw r0;
        ...
        L_0x0060:
            r6 = r1;
            r1 = r15.relativePositioning;
            if (r1 == 0) goto L_0x0070;
        L_0x0065:
            r1 = r15.horizontalAnchor;
            r1 = (float) r1;
            r7 = 1120272384; // 0x42c60000 float:99.0 double:5.53488099E-315;
            r1 = r1 / r7;
            r8 = r15.verticalAnchor;
            r8 = (float) r8;
            r8 = r8 / r7;
            goto L_0x007d;
        L_0x0070:
            r1 = r15.horizontalAnchor;
            r1 = (float) r1;
            r7 = 1129381888; // 0x43510000 float:209.0 double:5.57988792E-315;
            r1 = r1 / r7;
            r7 = r15.verticalAnchor;
            r7 = (float) r7;
            r8 = 1116995584; // 0x42940000 float:74.0 double:5.518691446E-315;
            r8 = r7 / r8;
        L_0x007d:
            r7 = 1063675494; // 0x3f666666 float:0.9 double:5.2552552E-315;
            r1 = r1 * r7;
            r9 = 1028443341; // 0x3d4ccccd float:0.05 double:5.081185235E-315;
            r10 = r1 + r9;
            r8 = r8 * r7;
            r7 = r8 + r9;
            r1 = r15.anchorId;
        ...
        L_0x00a6:
            r9 = 2;
        L_0x00a7:
            r1 = r15.windowFillColor;
            r3 = COLOR_SOLID_BLACK;
            if (r1 == r3) goto L_0x00ae;
        L_0x00ad:
            r0 = 1;
        L_0x00ae:
            r13 = new com.google.android.exoplayer2.text.cea.Cea708Cue;
            r5 = 0;
            r11 = 1;
            r12 = r15.windowFillColor;
            r14 = r15.priority;
            r1 = r13;
            r3 = r6;
            r4 = r7;
        ...
        L_0x0032:
            r4 = android.graphics.Color.argb(r7, r4, r5, r1);
            return r4;
            */
            ...
            if (i == 2 || i == 3) {
                if (obj != null) {
                    ...
                    if (i == 3) {
                        ...
                        readUnsignedByte = (readUnsignedByte2 & 192) >> 6;
                        int i2 = readUnsignedByte2 & 63;
                        if (i2 == 0) {
                            i2 = 64;
                        }
                        this.currentDtvCcPacket = new DtvCcPacket(readUnsignedByte, i2);
                        dtvCcPacket = this.currentDtvCcPacket;
                        bArr = dtvCcPacket.packetData;
                        i = dtvCcPacket.currentIndex;
                        dtvCcPacket.currentIndex = i + 1;
                        bArr[i] = readUnsignedByte3;
                    } else {
                        if (i == 2) {
                            z = true;
                        }
                        ...
                        dtvCcPacket = this.currentDtvCcPacket;
                        if (dtvCcPacket == null) {
                            Log.m14e("Cea708Decoder", "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START");
                        } else {
                            bArr = dtvCcPacket.packetData;
                            i = dtvCcPacket.currentIndex;
                            dtvCcPacket.currentIndex = i + 1;
                            bArr[i] = readUnsignedByte2;
                            i = dtvCcPacket.currentIndex;
                            dtvCcPacket.currentIndex = i + 1;
                            bArr[i] = readUnsignedByte3;
                        }
    ...
    private void processCurrentPacket() {
        ...
        i = this.serviceBlockPacket.readBits(5);
        if (readBits == 7) {
            ...
            if (readBits < 7) {
                ...
                Log.m18w(str, stringBuilder2.toString());
            }
        }
        if (i == 0) {
            if (readBits != 0) {
                StringBuilder stringBuilder3 = new StringBuilder();
                stringBuilder3.append("serviceNumber is non-zero (");
                stringBuilder3.append(readBits);
                stringBuilder3.append(") when blockSize is 0");
                Log.m18w(str, stringBuilder3.toString());
            }
            ...
            while (this.serviceBlockPacket.bitsLeft() > 0) {
                ...
                if (i == 16) {
                    ...
                    if (i <= 31) {
                        ...
                        handleC3Command(i);
                    } else if (i <= NalUnitUtil.EXTENDED_SAR) {
                        handleG3Character(i);
                    } else {
                        stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Invalid extended command: ");
    ...
    /* JADX WARNING: Missing block: B:24:0x0093, code skipped:
    ...
    /* JADX WARNING: Missing block: B:46:0x00f3, code skipped:
            if (r2 > 8) goto L_0x0117;
     */
    /* JADX WARNING: Missing block: B:48:0x00fb, code skipped:
            if (r4.serviceBlockPacket.readBit() == false) goto L_0x0106;
     */
    /* JADX WARNING: Missing block: B:49:0x00fd, code skipped:
    ...
    private void handleG0Character(int i) {
        if (i == 127) {
            ...
            this.currentCueBuilder.append((char) (i & NalUnitUtil.EXTENDED_SAR));
        }
    }
                ...
                default:
                    switch (i) {
                        ...
                        default:
                            ...
                            stringBuilder.append(i);
                            Log.m18w("Cea708Decoder", stringBuilder.toString());
                            return;
                    }
            }
        } else {
