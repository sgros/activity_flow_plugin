...
public class GammaEvaluator {
    ...
    public static int evaluate(float f, int i, int i2) {
        float f2 = ((float) ((i >> 24) & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float f3 = ((float) ((i >> 8) & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float f4 = ((float) (i & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float f5 = ((float) ((i2 >> 24) & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float f6 = ((float) ((i2 >> 16) & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float f7 = ((float) ((i2 >> 8) & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float f8 = ((float) (i2 & NalUnitUtil.EXTENDED_SAR)) / 255.0f;
        float EOCF_sRGB = EOCF_sRGB(((float) ((i >> 16) & NalUnitUtil.EXTENDED_SAR)) / 255.0f);
        f3 = EOCF_sRGB(f3);
        f4 = EOCF_sRGB(f4);
        f6 = EOCF_sRGB(f6);
