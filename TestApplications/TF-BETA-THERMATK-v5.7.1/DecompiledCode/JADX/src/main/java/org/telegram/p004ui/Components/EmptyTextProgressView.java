...
public class EmptyTextProgressView extends FrameLayout {
    ...
    public EmptyTextProgressView(Context context) {
        ...
        this.textView.setPadding(AndroidUtilities.m26dp(20.0f), 0, AndroidUtilities.m26dp(20.0f), 0);
        ...
        setOnTouchListener(C2584-$$Lambda$EmptyTextProgressView$AeVTSCBshpCl6wf4siSABV33AKw.INSTANCE);
    }
    ...
    public void setTopImage(int i) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_emptyListPlaceholder), Mode.MULTIPLY));
        }
        this.textView.setCompoundDrawablesWithIntrinsicBounds(null, mutate, null, null);
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m26dp(1.0f));
    }
