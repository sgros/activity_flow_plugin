...
public class ShareActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTheme(C1067R.style.f918Theme.TMessages.Transparent);
            ...
            if ("android.intent.action.VIEW".equals(intent.getAction()) && intent.getData() != null) {
                ...
                if ("tgb".equals(scheme) && uri.toLowerCase().startsWith("tgb://share_game_score") && !TextUtils.isEmpty(queryParameter)) {
                    ...
                    try {
                        ...
                        this.visibleDialog.setOnDismissListener(new C2075-$$Lambda$ShareActivity$8CDJt1az5uGqAsSjal6N7RJDepQ(this));
