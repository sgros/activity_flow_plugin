...
public class PipVideoView {
    ...
    class C29282 extends AnimatorListenerAdapter {
        C29282() {
        }
    ...
    private class MiniControlsView extends FrameLayout {
        ...
        private Runnable hideRunnable = new C2650x7d27d95e(this);
        ...
        private Runnable progressRunnable = new C29291();

        /* renamed from: org.telegram.ui.Components.PipVideoView$MiniControlsView$1 */
        class C29291 implements Runnable {
            C29291() {
            }
        ...
        class C29302 extends AnimatorListenerAdapter {
            C29302() {
            }
        ...
        class C29313 extends AnimatorListenerAdapter {
            C29313() {
            }
        ...
        public MiniControlsView(Context context, boolean z) {
            ...
            this.inlineButton.setImageResource(C1067R.C1065drawable.ic_outinline);
            addView(this.inlineButton, LayoutHelper.createFrame(56, 48, 53));
            this.inlineButton.setOnClickListener(new C2652x2503cba9(this));
            if (z) {
                ...
                this.playButton.setOnClickListener(new C2649xe483d1cd(this));
            }
            setOnTouchListener(C2651x59f211f4.INSTANCE);
            updatePlayButton();
            show(false, false);
        }
        ...
        private void updatePlayButton() {
            if (PipVideoView.this.photoViewer != null) {
                ...
                if (videoPlayer != null) {
                    ...
                    if (videoPlayer.isPlaying()) {
                        this.playButton.setImageResource(C1067R.C1065drawable.ic_pauseinline);
                        AndroidUtilities.runOnUIThread(this.progressRunnable, 500);
                    } else if (this.isCompleted) {
                        this.playButton.setImageResource(C1067R.C1065drawable.ic_againinline);
                    } else {
                        this.playButton.setImageResource(C1067R.C1065drawable.ic_playinline);
                    }
                }
            }
        }
            ...
            if (this.isVisible != z) {
                ...
                if (this.isVisible) {
                    if (z2) {
                        ...
                        this.currentAnimation.addListener(new C29302());
                    ...
                    animatorSet2.playTogether(animatorArr);
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.addListener(new C29313());
                    this.currentAnimation.start();
                } else {
                    setAlpha(0.0f);
                }
        ...
        public void onDraw(Canvas canvas) {
            ...
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m26dp(3.0f);
            AndroidUtilities.m26dp(7.0f);
            float f = (float) (measuredWidth - 0);
            int i = ((int) (this.progress * f)) + 0;
            float f2 = this.bufferedPosition;
            if (f2 != 0.0f) {
                float f3 = (float) null;
                canvas.drawRect(f3, (float) measuredHeight, f3 + (f * f2), (float) (AndroidUtilities.m26dp(3.0f) + measuredHeight), this.progressInnerPaint);
            }
            canvas.drawRect((float) null, (float) measuredHeight, (float) i, (float) (measuredHeight + AndroidUtilities.m26dp(3.0f)), this.progressPaint);
        }
    }
    ...
    public TextureView show(Activity activity, PhotoViewer photoViewer, EmbedBottomSheet embedBottomSheet, View view, float f, int i, WebView webView) {
        ...
        if (f > 1.0f) {
            this.videoWidth = AndroidUtilities.m26dp(192.0f);
            this.videoHeight = (int) (((float) this.videoWidth) / f);
        } else {
            this.videoHeight = AndroidUtilities.m26dp(192.0f);
        ...
        try {
            ...
            this.windowLayoutParams.x = PipVideoView.getSideCoord(true, i2, f2, this.videoWidth);
            this.windowLayoutParams.y = PipVideoView.getSideCoord(false, i3, f3, this.videoHeight);
    ...
    public void onConfigurationChanged() {
        ...
        this.windowLayoutParams.x = PipVideoView.getSideCoord(true, i, f, this.videoWidth);
        this.windowLayoutParams.y = PipVideoView.getSideCoord(false, i2, f2, this.videoHeight);
    ...
    private void animateToBoundsMaybe() {
        ...
        r3 = 0;
        r4 = 1;
        r1 = org.telegram.p004ui.Components.PipVideoView.getSideCoord(r4, r3, r2, r1);
        r5 = r0.videoWidth;
        r5 = org.telegram.p004ui.Components.PipVideoView.getSideCoord(r4, r4, r2, r5);
        r6 = r0.videoHeight;
        r6 = org.telegram.p004ui.Components.PipVideoView.getSideCoord(r3, r3, r2, r6);
        r7 = r0.videoHeight;
        r7 = org.telegram.p004ui.Components.PipVideoView.getSideCoord(r3, r4, r2, r7);
        r8 = r0.preferences;
        r8 = r8.edit();
    ...
    L_0x0126:
        r2 = r0.windowLayoutParams;
        r2 = r2.y;
        r11 = org.telegram.p004ui.ActionBar.C2190ActionBar.getCurrentActionBarHeight();
    ...
    L_0x01bb:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.PipVideoView.animateToBoundsMaybe():void");
    }
    ...
    public static Rect getPipRect(float f) {
        ...
        if (f > 1.0f) {
            dp = AndroidUtilities.m26dp(192.0f);
            int i4 = dp;
            dp = (int) (((float) dp) / f);
            i = i4;
        } else {
        ...
        return new Rect((float) PipVideoView.getSideCoord(true, i2, f2, i), (float) PipVideoView.getSideCoord(false, i3, f3, dp), (float) i, (float) dp);
    }
