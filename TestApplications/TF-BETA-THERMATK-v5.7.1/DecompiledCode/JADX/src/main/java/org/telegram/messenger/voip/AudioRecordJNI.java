...
public class AudioRecordJNI {
    ...
    /* renamed from: ns */
    private NoiseSuppressor f429ns;
            ...
            if (tryInit) {
                if (VERSION.SDK_INT >= 16) {
                    ...
                    try {
                        ...
                        VLog.m37e("error creating AutomaticGainControl", th);
                    }
                    try {
                        if (NoiseSuppressor.isAvailable()) {
                            this.f429ns = NoiseSuppressor.create(this.audioRecord.getAudioSessionId());
                            if (this.f429ns != null) {
                                NoiseSuppressor noiseSuppressor = this.f429ns;
                                tryInit = VoIPServerConfig.getBoolean("use_system_ns", true) && isGoodAudioEffect(this.f429ns);
                        ...
                        VLog.m37e("error creating NoiseSuppressor", th2);
                    }
                    try {
                        ...
                        VLog.m37e("error creating AcousticEchoCanceler", th3);
                    }
                }
    ...
    public boolean start() {
        ...
        if (audioRecord != null && audioRecord.getState() == 1) {
            try {
                ...
                VLog.m37e("Error initializing AudioRecord", e);
            }
        }
        return false;
    }
    ...
    private static boolean isGoodAudioEffect(AudioEffect audioEffect) {
        ...
        VLog.m35d(stringBuilder.toString());
