...
public class MaxFileSizeCell extends FrameLayout {
    ...
    public MaxFileSizeCell(Context context) {
        ...
        this.sizeTextView.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2));
        ...
        this.seekBarView.setDelegate(new C3939-$$Lambda$MaxFileSizeCell$cPUnEl5DY5tp-A3IQaD5cETcr3k(this));
    ...
    public /* synthetic */ void lambda$new$0$MaxFileSizeCell(float f) {
        ...
        textView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C1067R.string.AutodownloadSizeLimitUpTo, objArr));
        this.currentSize = j;
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(80.0f), 1073741824));
        setMeasuredDimension(MeasureSpec.getSize(i), AndroidUtilities.m26dp(80.0f));
        i = getMeasuredWidth() - AndroidUtilities.m26dp(42.0f);
        this.sizeTextView.measure(MeasureSpec.makeMeasureSpec(i, Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(30.0f), 1073741824));
        this.textView.measure(MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m26dp(10.0f), (i - this.sizeTextView.getMeasuredWidth()) - AndroidUtilities.m26dp(8.0f)), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(30.0f), 1073741824));
        this.seekBarView.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth() - AndroidUtilities.m26dp(20.0f), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(30.0f), 1073741824));
    }
    ...
    public void setSize(long j) {
        float max;
        this.currentSize = j;
        this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C1067R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
        j -= 512000;
        if (j < 536576) {
