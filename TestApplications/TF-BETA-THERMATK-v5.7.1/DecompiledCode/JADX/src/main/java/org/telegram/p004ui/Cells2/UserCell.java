package org.telegram.p004ui.Cells2;
...
public class UserCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(70.0f), 1073741824));
    }
    ...
    L_0x01c0:
        r0 = r12.statusTextView;
        r1 = 2131558988; // 0x7f0d024c float:1.8743307E38 double:1.053130068E-314;
        r2 = "ChannelPrivate";
    ...
    L_0x01cf:
        r0 = r12.statusTextView;
        r1 = 2131558991; // 0x7f0d024f float:1.8743313E38 double:1.0531300695E-314;
        r2 = "ChannelPublic";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setText(r1);
        goto L_0x0213;
    ...
    L_0x024c:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells2.UserCell.update(int):void");
    }
}
