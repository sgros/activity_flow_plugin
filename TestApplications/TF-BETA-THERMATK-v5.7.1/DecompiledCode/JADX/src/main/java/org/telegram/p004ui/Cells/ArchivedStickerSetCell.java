...
import org.telegram.p004ui.Components.Switch.OnCheckedChangeListener;
...
public class ArchivedStickerSetCell extends FrameLayout {
    ...
    public void setOnCheckClick(OnCheckedChangeListener onCheckedChangeListener) {
        ...
        this.checkBox.setOnClickListener(new C2328-$$Lambda$ArchivedStickerSetCell$9Rmaru-mwDl6BO3ARD8hu93oKu8(this));
    }
