    ...
    public void onDraw(Canvas canvas, RecyclerView recyclerView, State state) {
        ...
        while (i < childCount) {
            ...
            if (!(recyclerView.getChildAdapterPosition(childAt) < this.skipRows || (childAt instanceof GroupCreateSectionCell) || (childAt2 instanceof GroupCreateSectionCell))) {
                ...
                canvas.drawLine(LocaleController.isRTL ? 0.0f : (float) AndroidUtilities.m26dp(72.0f), bottom, (float) (width - (LocaleController.isRTL ? AndroidUtilities.m26dp(72.0f) : 0)), bottom, Theme.dividerPaint);
            }
            i++;
        }
    }
