...
public class NumberTextView extends View {
    ...
    class C28691 extends AnimatorListenerAdapter {
        C28691() {
        }
    ...
    public void setNumber(int i, boolean z) {
        ...
        if (this.currentNumber != i2 || !z) {
            ...
            if (z && !this.oldLetters.isEmpty()) {
                ...
                this.animator.addListener(new C28691());
                this.animator.start();
            }
            invalidate();
        }
    ...
    public void onDraw(Canvas canvas) {
        if (!this.letters.isEmpty()) {
            ...
            while (i < max) {
                ...
                canvas.restore();
                canvas.translate(staticLayout != null ? staticLayout.getLineWidth(0) : staticLayout2.getLineWidth(0) + ((float) AndroidUtilities.m26dp(1.0f)), 0.0f);
                i++;
            }
            canvas.restore();
        }
