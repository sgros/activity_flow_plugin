...
public class Switch extends View {
    ...
    class C29511 extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawCircle((float) bounds.centerX(), (float) bounds.centerY(), (float) AndroidUtilities.m26dp(18.0f), Switch.this.ripplePaint);
        }
    }

    /* renamed from: org.telegram.ui.Components.Switch$2 */
    class C29522 extends AnimatorListenerAdapter {
        C29522() {
        }
    ...
    class C29533 extends AnimatorListenerAdapter {
        C29533() {
        }
    ...
    public Switch(Context context) {
        ...
        this.paint2.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
    }
    ...
    public void setDrawRipple(boolean z) {
        if (VERSION.SDK_INT >= 21 && z != this.drawRipple) {
            ...
            if (this.rippleDrawable == null) {
                ...
                if (VERSION.SDK_INT >= 23) {
                    this.rippleDrawable.setRadius(AndroidUtilities.m26dp(18.0f));
                }
            ...
            if (VERSION.SDK_INT >= 28 && z) {
                this.rippleDrawable.setHotspot(this.isChecked ? 0.0f : (float) AndroidUtilities.m26dp(100.0f), (float) AndroidUtilities.m26dp(18.0f));
            }
    ...
    private void animateToCheckedState(boolean z) {
        ...
        this.checkAnimator.addListener(new C29522());
    ...
    private void animateIcon(boolean z) {
        ...
        this.iconAnimator.addListener(new C29533());
    ...
    L_0x000b:
        ...
        org.telegram.messenger.AndroidUtilities.m26dp(r3);
        ...
        r9 = r9 + r3;
        r10 = 1099431936; // 0x41880000 float:17.0 double:5.431915495E-315;
    ...
    L_0x0177:
        ...
        r6 = r9 - r6;
        r8 = org.telegram.messenger.AndroidUtilities.m26dp(r4);
        r8 = r10 - r8;
        r11 = org.telegram.messenger.AndroidUtilities.m26dp(r4);
        r11 = r11 + r9;
    ...
    L_0x02a1:
        r7 = 1093455053; // 0x412ccccd float:10.8 double:5.40238577E-315;
        r7 = org.telegram.messenger.AndroidUtilities.m26dp(r7);
        r7 = (float) r7;
        r8 = 1067869798; // 0x3fa66666 float:1.3 double:5.275977814E-315;
        ...
        r6 = r6 - r4;
        r10 = (int) r6;
        r4 = 1083388723; // 0x40933333 float:4.6 double:5.35265149E-315;
        r4 = org.telegram.messenger.AndroidUtilities.dpf2(r4);
        r4 = (int) r4;
        r4 = r4 + r9;
        r6 = 1092091904; // 0x41180000 float:9.5 double:5.39565092E-315;
        r6 = org.telegram.messenger.AndroidUtilities.dpf2(r6);
        r7 = (float) r10;
        r6 = r6 + r7;
        r6 = (int) r6;
        ...
        r11 = r11 + r6;
        r12 = 1089470464; // 0x40f00000 float:7.5 double:5.382699284E-315;
        r13 = org.telegram.messenger.AndroidUtilities.dpf2(r12);
        r13 = (int) r13;
        r13 = r13 + r9;
        r14 = 1085066445; // 0x40accccd float:5.4 double:5.36094054E-315;
        ...
        r2 = (int) r2;
        r2 = r2 + r9;
        r4 = 1095237632; // 0x41480000 float:12.5 double:5.41119288E-315;
        r4 = org.telegram.messenger.AndroidUtilities.dpf2(r4);
        r4 = (int) r4;
        r4 = r4 + r10;
        r8 = 1088421888; // 0x40e00000 float:7.0 double:5.37751863E-315;
    ...
    L_0x0379:
        r7 = r0.paint2;
        r11 = 1132396544; // 0x437f0000 float:255.0 double:5.5947823E-315;
        r12 = r0.iconProgress;
        r13 = 1065353216; // 0x3f800000 float:1.0 double:5.263544247E-315;
        r12 = r13 - r12;
        r12 = r12 * r11;
    ...
    L_0x03eb:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.Switch.onDraw(android.graphics.Canvas):void");
    }
