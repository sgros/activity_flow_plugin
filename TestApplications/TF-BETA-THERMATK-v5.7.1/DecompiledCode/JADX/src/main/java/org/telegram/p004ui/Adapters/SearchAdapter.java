...
public class SearchAdapter extends SelectionAdapter {
    ...
    class C39221 implements SearchAdapterHelperDelegate {
    ...
    public SearchAdapter(Context context, SparseArray<User> sparseArray, boolean z, boolean z2, boolean z3, boolean z4, int i) {
        ...
        this.searchAdapterHelper.setDelegate(new C39221());
    }
    ...
    private void processSearch(String str) {
        AndroidUtilities.runOnUIThread(new C2264-$$Lambda$SearchAdapter$orWB0TdKMjyMiCeh3w5NvcjUVZU(this, str));
    }
    ...
    public /* synthetic */ void lambda$processSearch$1$SearchAdapter(String str) {
        ...
        Utilities.searchQueue.postRunnable(new C2263-$$Lambda$SearchAdapter$MJ9cur0I3ZiqQGm3sZTS0MY0LdM(this, str, new ArrayList(ContactsController.getInstance(i).contacts), i));
    }
    ...
    L_0x0142:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.SearchAdapter.lambda$null$0$SearchAdapter(java.lang.String, java.util.ArrayList, int):void");
    }

    private void updateSearchResults(ArrayList<TLObject> arrayList, ArrayList<CharSequence> arrayList2) {
        AndroidUtilities.runOnUIThread(new C2262-$$Lambda$SearchAdapter$6uwOh4k7ujlooXYRN4wF38fqlek(this, arrayList, arrayList2));
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i != 0) {
            ...
            graySectionCell.setText(LocaleController.getString("GlobalSearch", C1067R.string.GlobalSearch));
