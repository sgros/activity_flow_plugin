...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        ...
        this.shadowView.setImageResource(C1067R.C1065drawable.bottom_shadow);
        addView(this.shadowView, LayoutHelper.createFrame(-1, 70, 83));
        this.avatarImageView = new BackupImageView(context);
        this.avatarImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m26dp(32.0f));
        ...
        if (this.accountsShowed) {
            i = C1067R.string.AccDescrHideAccounts;
            str = "AccDescrHideAccounts";
        } else {
            i = C1067R.string.AccDescrShowAccounts;
    ...
    public void onMeasure(int i, int i2) {
        if (VERSION.SDK_INT >= 21) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(148.0f) + AndroidUtilities.statusBarHeight, 1073741824));
            return;
        }
        try {
            super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(148.0f), 1073741824));
        } catch (Exception e) {
            setMeasuredDimension(MeasureSpec.getSize(i), AndroidUtilities.m26dp(148.0f));
            FileLog.m30e(e);
        }
    }
    ...
    public void onDraw(android.graphics.Canvas r9) {
        /*
        r8 = this;
        r0 = org.telegram.p004ui.ActionBar.Theme.getCachedWallpaper();
    ...
    L_0x0012:
        r1 = org.telegram.p004ui.ActionBar.Theme.isCustomTheme();
        if (r1 == 0) goto L_0x0022;
    L_0x0018:
        r1 = org.telegram.p004ui.ActionBar.Theme.isPatternWallpaper();
        if (r1 != 0) goto L_0x0022;
    L_0x001e:
    ...
    L_0x0025:
        ...
        r5 = org.telegram.p004ui.ActionBar.Theme.hasThemeKey(r4);
    ...
    L_0x0032:
        ...
        r4 = org.telegram.p004ui.ActionBar.Theme.hasThemeKey(r2);
        if (r4 == 0) goto L_0x003f;
    L_0x003a:
        r4 = org.telegram.p004ui.ActionBar.Theme.getColor(r2);
        goto L_0x0046;
    L_0x003f:
        r2 = org.telegram.p004ui.ActionBar.Theme.getServiceMessageColor();
    ...
    L_0x012a:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.DrawerProfileCell.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setAccountsShowed(boolean z) {
        if (this.accountsShowed != z) {
            ...
            this.arrowView.setImageResource(this.accountsShowed ? C1067R.C1065drawable.collapse_up : C1067R.C1065drawable.collapse_down);
        }
    }

    public void setOnArrowClickListener(OnClickListener onClickListener) {
        this.arrowView.setOnClickListener(new C2333-$$Lambda$DrawerProfileCell$E00gMmT74biKthBWyKI7QNe-uk4(this, onClickListener));
    }
