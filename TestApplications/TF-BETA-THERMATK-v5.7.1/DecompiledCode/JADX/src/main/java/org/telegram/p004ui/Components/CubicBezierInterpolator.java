...
public class CubicBezierInterpolator implements Interpolator {
    ...
    public float getBezierCoordinateY(float f) {
        PointF pointF = this.f586c;
        PointF pointF2 = this.start;
        pointF.y = pointF2.y * 3.0f;
        PointF pointF3 = this.f585b;
    ...
    private float getXDerivate(float f) {
        return this.f586c.x + (f * ((this.f585b.x * 2.0f) + ((this.f584a.x * 3.0f) * f)));
    }
