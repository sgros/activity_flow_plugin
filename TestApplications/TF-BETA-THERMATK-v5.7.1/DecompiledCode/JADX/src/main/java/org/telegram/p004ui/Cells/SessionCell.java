...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context, int i) {
        ...
        if (i == 1) {
            ...
            this.avatarDrawable.setTextSize(AndroidUtilities.m26dp(10.0f));
            this.imageView = new BackupImageView(context2);
            this.imageView.setRoundRadius(AndroidUtilities.m26dp(10.0f));
        ...
        addView(textView2, LayoutHelper.createFrame(-1, -2.0f, i4 | 48, 21.0f, 59.0f, 21.0f, 0.0f));
    }

    /* Access modifiers changed, original: protected */
    public void onMeasure(int i, int i2) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(90.0f) + this.needDivider, 1073741824));
    }

    public void setSession(TLObject tLObject, boolean z) {
        this.needDivider = z;
        z = tLObject instanceof TL_authorization;
        String str = "— ";
        String str2 = " ";
        String str3 = Theme.key_windowBackgroundWhiteGrayText3;
        String str4 = ", ";
        ...
        if (z) {
            ...
            if ((tL_authorization.flags & 1) != 0) {
                String str5 = Theme.key_windowBackgroundWhiteValueText;
                setTag(str5);
            ...
            if (tL_authorization.f469ip.length() != 0) {
                stringBuilder.append(tL_authorization.f469ip);
            }
            ...
            if (!tL_authorization.official_app) {
                ...
                stringBuilder.append(LocaleController.getString("UnofficialApp", C1067R.string.UnofficialApp));
            ...
            this.onlineTextView.setTextColor(Theme.getColor(str3));
            stringBuilder = new StringBuilder();
            if (tL_webAuthorization.f532ip.length() != 0) {
                stringBuilder.append(tL_webAuthorization.f532ip);
            }
