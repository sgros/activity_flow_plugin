...
public class NewContactActivity extends BaseFragment implements OnItemSelectedListener {
    ...
    class C30982 implements TextWatcher {
    ...
    class C30993 implements TextWatcher {
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        }
    ...
    class C31004 implements TextWatcher {
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        }
        ...
        public void afterTextChanged(Editable editable) {
            if (!NewContactActivity.this.ignoreOnTextChange) {
                ...
                String stripExceptNumbers = C0278PhoneFormat.stripExceptNumbers(NewContactActivity.this.codeField.getText().toString());
                NewContactActivity.this.codeField.setText(stripExceptNumbers);
                String str = null;
                if (stripExceptNumbers.length() == 0) {
                    NewContactActivity.this.countryButton.setText(LocaleController.getString("ChooseCountry", C1067R.string.ChooseCountry));
                    ...
                    if (str2 != null) {
                        ...
                        if (indexOf != -1) {
                            ...
                            NewContactActivity.this.countryButton.setText(LocaleController.getString(str3, C1067R.string.WrongCountry));
                            NewContactActivity.this.phoneField.setHintText(null);
    ...
    class C31015 implements TextWatcher {
    ...
    class C42411 extends ActionBarMenuOnItemClick {
        C42411() {
        }
        ...
        public void onItemClick(int i) {
            if (i == -1) {
                ...
                if (NewContactActivity.this.firstNameField.length() == 0) {
                    ...
                    ConnectionsManager.getInstance(NewContactActivity.this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(NewContactActivity.this.currentAccount).sendRequest(tL_contacts_importContacts, new C3754-$$Lambda$NewContactActivity$1$WRq0Ss-PBCngsAibqDEMoSm52R4(this, tL_inputPhoneContact, tL_contacts_importContacts), 2), NewContactActivity.this.classGuid);
                }
            }
        }
        ...
        public /* synthetic */ void lambda$onItemClick$2$NewContactActivity$1(TL_inputPhoneContact tL_inputPhoneContact, TL_contacts_importContacts tL_contacts_importContacts, TLObject tLObject, TL_error tL_error) {
            AndroidUtilities.runOnUIThread(new C1672-$$Lambda$NewContactActivity$1$FpIczF_U6R8AHoZNqQVCZxCiBTs(this, (TL_contacts_importedContacts) tLObject, tL_inputPhoneContact, tL_error, tL_contacts_importContacts));
        }
        ...
        public /* synthetic */ void lambda$null$1$NewContactActivity$1(TL_contacts_importedContacts tL_contacts_importedContacts, TL_inputPhoneContact tL_inputPhoneContact, TL_error tL_error, TL_contacts_importContacts tL_contacts_importContacts) {
            ...
            if (tL_contacts_importedContacts == null) {
                ...
                builder.setMessage(LocaleController.formatString("ContactNotRegistered", C1067R.string.ContactNotRegistered, ContactsController.formatName(tL_inputPhoneContact.first_name, tL_inputPhoneContact.last_name)));
                builder.setNegativeButton(LocaleController.getString("Cancel", C1067R.string.Cancel), null);
                builder.setPositiveButton(LocaleController.getString("Invite", C1067R.string.Invite), new C1671-$$Lambda$NewContactActivity$1$D3bcNIiNfpYsfTq2W2DLeJJEU84(this, tL_inputPhoneContact));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C42411());
        this.avatarDrawable = new AvatarDrawable();
        String str = "";
        this.avatarDrawable.setInfo(5, str, str, false);
        this.editDoneItem = this.actionBar.createMenu().addItemWithWidth(1, C1067R.C1065drawable.ic_done, AndroidUtilities.m26dp(56.0f));
        this.editDoneItem.setContentDescription(LocaleController.getString("Done", C1067R.string.Done));
        ...
        linearLayout.setPadding(AndroidUtilities.m26dp(24.0f), 0, AndroidUtilities.m26dp(24.0f), 0);
        linearLayout.setOrientation(1);
        ((ScrollView) this.fragmentView).addView(linearLayout, LayoutHelper.createScroll(-1, -2, 51));
        linearLayout.setOnTouchListener(C1678-$$Lambda$NewContactActivity$dyt1ArQHbLSL06GO-wtQQZkRhQE.INSTANCE);
        ...
        this.firstNameField.setOnEditorActionListener(new C1675-$$Lambda$NewContactActivity$OEffd5rsJU1asHgIO5gqt5wMyr4(this));
        this.firstNameField.addTextChangedListener(new C30982());
        ...
        this.lastNameField.setOnEditorActionListener(new C1677-$$Lambda$NewContactActivity$caCQM7G1cFeQM5WDamEHC5G1jDk(this));
        this.lastNameField.addTextChangedListener(new C30993());
        this.countryButton = new TextView(context2);
        this.countryButton.setTextSize(1, 18.0f);
        this.countryButton.setPadding(AndroidUtilities.m26dp(6.0f), AndroidUtilities.m26dp(10.0f), AndroidUtilities.m26dp(6.0f), 0);
        ...
        this.countryButton.setOnClickListener(new C1676-$$Lambda$NewContactActivity$PQwWlWssBZjUKNZQJ0dIzeJV9OI(this));
        this.lineView = new View(context2);
        this.lineView.setPadding(AndroidUtilities.m26dp(8.0f), 0, AndroidUtilities.m26dp(8.0f), 0);
        ...
        this.codeField.addTextChangedListener(new C31004());
        this.codeField.setOnEditorActionListener(new C1680-$$Lambda$NewContactActivity$sAQJMXy-aH9t_IBkPAm16jh4ito(this));
        ...
        this.phoneField.addTextChangedListener(new C31015());
        this.phoneField.setOnEditorActionListener(new C1674-$$Lambda$NewContactActivity$6q60KF1tjXtvySPg1IX8F4PNNEY(this));
        this.phoneField.setOnKeyListener(new C1673-$$Lambda$NewContactActivity$5Ca3pvZCNy2Se-fsqStW34es8nQ(this));
    ...
    public /* synthetic */ void lambda$createView$5$NewContactActivity(View view) {
        ...
        countrySelectActivity.setCountrySelectActivityDelegate(new C3755-$$Lambda$NewContactActivity$RKjBEG5T2-fQQhQFnlm7ULenE4I(this));
        presentFragment(countrySelectActivity);
    }

    public /* synthetic */ void lambda$null$4$NewContactActivity(String str, String str2) {
        selectCountry(str);
        AndroidUtilities.runOnUIThread(new C1679-$$Lambda$NewContactActivity$kdGKhx_RKvrLvJRlZLpJl1Jr720(this), 300);
        this.phoneField.requestFocus();
        HintEditText hintEditText = this.phoneField;
        hintEditText.setSelection(hintEditText.length());
    }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        C3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk = new C3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk(this);
        r10[26] = new ThemeDescription(null, 0, null, null, new Drawable[]{Theme.avatar_broadcastDrawable, Theme.avatar_savedDrawable}, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_text);
        r10[27] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundRed);
        r10[28] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundOrange);
        r10[29] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundViolet);
        r10[30] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundGreen);
        r10[31] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundCyan);
        r10[32] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundBlue);
        r10[33] = new ThemeDescription(null, 0, null, null, null, c3753-$$Lambda$NewContactActivity$-TdFXabn_cMkV_y0uLVuNwOAoYk, Theme.key_avatar_backgroundPink);
        return r10;
    }
