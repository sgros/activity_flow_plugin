...
public class StickerEmojiCell extends FrameLayout {
    ...
    L_0x00c9:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.StickerEmojiCell.setSticker(org.telegram.tgnet.TLRPC$Document, java.lang.Object, java.lang.String, boolean):void");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        CharSequence string = LocaleController.getString("AttachSticker", C1067R.string.AttachSticker);
        for (int i = 0; i < this.sticker.attributes.size(); i++) {
            ...
            if (documentAttribute instanceof TL_documentAttributeSticker) {
                ...
                if (str != null && str.length() > 0) {
                    ...
                    textView.setText(Emoji.replaceEmoji(documentAttribute.alt, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m26dp(16.0f), false));
