...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        String str = VERTEX;
        hashMap2.put(str, PAINT_BRUSH_VSH);
        String str2 = FRAGMENT;
        hashMap2.put(str2, PAINT_BRUSH_FSH);
        ...
        hashMap2.put(str, PAINT_BRUSH_VSH);
        hashMap2.put(str2, PAINT_BRUSHLIGHT_FSH);
