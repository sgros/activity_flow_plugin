...
public class FileUploadOperation {
    ...
    public void start() {
        if (this.state == 0) {
            this.state = 1;
            Utilities.stageQueue.postRunnable(new C0466-$$Lambda$FileUploadOperation$UJ53jdSVrDp9jmxTaqaNFaiq47E(this));
        }
    }
    ...
    public void onNetworkChanged(boolean z) {
        if (this.state == 1) {
            Utilities.stageQueue.postRunnable(new C0465-$$Lambda$FileUploadOperation$AsRwZThcGZTT5evyde1j2fU_PqE(this, z));
        }
    }
    ...
    public void cancel() {
        if (this.state != 3) {
            this.state = 2;
            Utilities.stageQueue.postRunnable(new C0464-$$Lambda$FileUploadOperation$1Av0AtRL3UNZuURFidi06RFneIU(this));
    ...
    public void checkNewDataAvailable(long j, long j2) {
        Utilities.stageQueue.postRunnable(new C0468-$$Lambda$FileUploadOperation$gwhBTZdvm3NdxGlA-jj4tE_lywA(this, j2, j));
    }
    ...
    private void storeFileUploadInfo() {
        ...
        if (this.isEncrypted) {
            ...
            stringBuilder.append(this.fileKey);
            stringBuilder.append("_iv");
            edit.putString(stringBuilder.toString(), Utilities.bytesToHex(this.f52iv));
            stringBuilder = new StringBuilder();
            stringBuilder.append(this.fileKey);
            stringBuilder.append("_ivc");
    ...
    L_0x0192:
        ...
        r12.f52iv = r3;	 Catch:{ Exception -> 0x04a8 }
        r3 = r12.key;	 Catch:{ Exception -> 0x04a8 }
        if (r3 == 0) goto L_0x01bc;
    L_0x01a2:
        r3 = r12.f52iv;	 Catch:{ Exception -> 0x04a8 }
        if (r3 == 0) goto L_0x01bc;
    L_0x01a6:
        r3 = r12.key;	 Catch:{ Exception -> 0x04a8 }
    ...
    L_0x01d5:
        ...
        r15 = 1168687104; // 0x45a8c000 float:5400.0 double:5.77408149E-315;
        r14 = r14 - r15;
    ...
    L_0x02e6:
        ...
        r3 = r12.f52iv;	 Catch:{ Exception -> 0x0314 }
    ...
    L_0x0314:
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Exception -> 0x04a8 }
    L_0x0318:
            ...
            if (!(tLObject3 instanceof TL_boolTrue)) {
                ...
                if (this.isLastPart && this.currentUploadRequetsCount == 0 && this.state == 1) {
                    ...
                    if (this.key == null) {
                        ...
                        tL_inputFileBig.f454id = this.currentFileId;
                    ...
                    if (!(this.estimatedSize != 0 || this.uploadFirstPartLater || this.nextPartFirst)) {
                        ...
                        if (i7 == i6) {
                            ...
                            while (true) {
                                ...
                                bArr2 = uploadCachedResult.f51iv;
                            ...
                            if (obj != null) {
                                uploadCachedResult2.f51iv = new byte[32];
                                System.arraycopy(obj, 0, uploadCachedResult2.f51iv, 0, 32);
                            }
    ...
    public /* synthetic */ void lambda$startUploadRequest$6$FileUploadOperation() {
        Utilities.stageQueue.postRunnable(new C0467-$$Lambda$FileUploadOperation$gfXB7X6eyjMCnkoAcAZ52SVcCAA(this));
    }
