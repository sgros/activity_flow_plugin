...
public class NotificationBadge {
    ...
    public static class OPPOHomeBader implements Badger {
        ...
        private void executeBadgeByContentProvider(int i) {
            try {
                ...
                ApplicationLoader.applicationContext.getContentResolver().call(Uri.parse(PROVIDER_CONTENT_URI), "setAppBadgeCount", null, bundle);
    ...
    private static boolean initBadger() {
        ...
        ResolveInfo resolveActivity = context.getPackageManager().resolveActivity(launchIntentForPackage, MessagesController.UPDATE_MASK_CHECK);
        ...
        List queryIntentActivities = context.getPackageManager().queryIntentActivities(launchIntentForPackage, MessagesController.UPDATE_MASK_CHECK);
