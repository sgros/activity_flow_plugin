...
public class BotHelpCell extends View {
    ...
    public void setText(String str) {
        if (str == null || str.length() == 0) {
            ...
            String string = LocaleController.getString("BotInfoTitle", C1067R.string.BotInfoTitle);
            ...
            Emoji.replaceEmoji(spannableStringBuilder, Theme.chat_msgTextPaint.getFontMetricsInt(), AndroidUtilities.m26dp(20.0f), false);
            try {
                ...
                this.width = 0;
                this.height = this.textLayout.getHeight() + AndroidUtilities.m26dp(22.0f);
            ...
            this.width += AndroidUtilities.m26dp(22.0f);
        }
    }
    ...
    L_0x0097:
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Exception -> 0x009c }
        goto L_0x0100;
    L_0x009c:
        r0 = move-exception;
        r1 = 1;
    ...
    L_0x00b5:
        r1 = r0 instanceof org.telegram.p004ui.Components.URLSpanNoUnderline;	 Catch:{ Exception -> 0x00f9 }
        if (r1 == 0) goto L_0x00e1;
    L_0x00b9:
        r0 = (org.telegram.p004ui.Components.URLSpanNoUnderline) r0;	 Catch:{ Exception -> 0x00f9 }
    ...
    L_0x010c:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.BotHelpCell.onTouchEvent(android.view.MotionEvent):boolean");
    }

    /* Access modifiers changed, original: protected */
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), this.height + AndroidUtilities.m26dp(8.0f));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.save();
        int dp2 = AndroidUtilities.m26dp(11.0f) + width;
        this.textX = dp2;
        float f = (float) dp2;
        int dp3 = AndroidUtilities.m26dp(11.0f) + dp;
        this.textY = dp3;
