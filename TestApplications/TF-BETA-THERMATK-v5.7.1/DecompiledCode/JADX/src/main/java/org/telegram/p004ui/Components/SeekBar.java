...
public class SeekBar {
    ...
    private int height;
    private int lineHeight = AndroidUtilities.m26dp(2.0f);
    ...
    public SeekBar(Context context) {
        if (paint == null) {
            paint = new Paint(1);
            thumbWidth = AndroidUtilities.m26dp(24.0f);
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle((float) (this.thumbX + (thumbWidth / 2)), (float) (this.height / 2), (float) AndroidUtilities.m26dp(this.pressed ? 8.0f : 6.0f), paint);
    }
}
