    ...
    public void runPendingAnimations() {
        ...
        if ((this.mPendingRemovals.isEmpty() ^ 1) != 0 || isEmpty != 0 || isEmpty3 != 0 || isEmpty2 != 0) {
            ...
            if (isEmpty != 0) {
                ...
                new C2549-$$Lambda$DialogsItemAnimator$FzJ8o5Mz2rO6C7ZkKkUswV9PN8U(this, arrayList).run();
            }
            if (isEmpty2 != 0) {
                arrayList = new ArrayList(this.mPendingChanges);
                this.mChangesList.add(arrayList);
                this.mPendingChanges.clear();
                new C2550-$$Lambda$DialogsItemAnimator$cc5l3oNCPWmFl8oTuclZaKvqaQ8(this, arrayList).run();
            }
            if (isEmpty3 != 0) {
                arrayList = new ArrayList(this.mPendingAdditions);
                this.mAdditionsList.add(arrayList);
                this.mPendingAdditions.clear();
                new C2551-$$Lambda$DialogsItemAnimator$zsvBbBTBPz9JWwcIM9KIgALVodc(this, arrayList).run();
            }
        }
    }
