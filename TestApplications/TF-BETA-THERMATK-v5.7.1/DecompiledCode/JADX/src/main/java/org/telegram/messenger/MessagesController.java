...
public class MessagesController implements NotificationCenterDelegate {
    ...
    private final Comparator<Dialog> dialogComparator = new C10462();
    ...
    private Runnable passwordCheckRunnable = new C10451();
    ...
    private Runnable themeCheckRunnable = C0931-$$Lambda$RQB0Jwr1FTqp6hrbGUHuOs-9k1I.INSTANCE;
    public int unreadUnmutedDialogs;
    private final Comparator<Update> updatesComparator = new C0698-$$Lambda$MessagesController$jdY-gZP_eY5WAh_nSc2UhUqpq4M(this);
    ...
    class C10462 implements Comparator<Dialog> {
        C10462() {
        }
     ...
     */
        ...
        L_0x0074:
            return r3;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.MessagesController$C10462.compare(org.telegram.tgnet.TLRPC$Dialog, org.telegram.tgnet.TLRPC$Dialog):int");
        }
    }
    ...
    private class ReadTask {
        ...
        /* synthetic */ ReadTask(MessagesController messagesController, C10451 c10451) {
            this();
        }
    }
    ...
    private class UserActionUpdatesPts extends Updates {
        ...
        /* synthetic */ UserActionUpdatesPts(MessagesController messagesController, C10451 c10451) {
            this();
        }
    }
    ...
    private class UserActionUpdatesSeq extends Updates {
        ...
        /* synthetic */ UserActionUpdatesSeq(MessagesController messagesController, C10451 c10451) {
            this();
        }
    }
    ...
    public MessagesController(int i) {
        ...
        AndroidUtilities.runOnUIThread(new C0735-$$Lambda$MessagesController$y42O_-dKOKyzNi5k5aHwMy0RjOs(this));
        addSupportUser();
        String str = "emoji";
    ...
    public void updateConfig(TL_config tL_config) {
        AndroidUtilities.runOnUIThread(new C0611-$$Lambda$MessagesController$E_B3T1gXoq4eD739GgHdBDLPpBs(this, tL_config));
    }
    ...
    public void addSupportUser() {
        ...
        tL_userForeign_old2.f534id = 333000;
        String str = "Telegram";
        ...
        tL_userForeign_old2.f534id = 777000;
    ...
    public InputUser getInputUser(User user) {
        ...
        if (user.f534id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
            tL_inputUserSelf = new TL_inputUserSelf();
        } else {
            InputUser tL_inputUser = new TL_inputUser();
            tL_inputUser.user_id = user.f534id;
    ...
    public static InputChannel getInputChannel(Chat chat) {
        ...
        tL_inputChannel.channel_id = chat.f434id;
        ...
        if (i == NotificationCenter.FileDidUpload) {
            ...
            if (str2 == null || !str2.equals(str)) {
                ...
                if (str2 != null && str2.equals(str)) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_uploadWallPaper, new C3463-$$Lambda$MessagesController$G2pKRuboIkVmyKgcxHs4KK8Bkn4(this, tL_wallPaperSettings));
                    return;
                }
                return;
            }
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_photos_uploadProfilePhoto, new C3493-$$Lambda$MessagesController$avFJzHcfb0E8c4wljuXOjwoiTOA(this));
            ...
            if (messageObject != null && (messageObject.getId() == num.intValue() || messageObject.messageOwner.local_id == num.intValue())) {
                messageObject.messageOwner.f461id = num2.intValue();
            ...
            MessageObject messageObject3 = (MessageObject) this.dialogMessagesByIds.get(message.f461id);
    ...
    public /* synthetic */ void lambda$didReceivedNotification$4$MessagesController(TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            if (user != null) {
                ...
                AndroidUtilities.runOnUIThread(new C0664-$$Lambda$MessagesController$VkYWRm7oeBHADU-2qscNSGE0Axs(this));
            }
        }
    }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$6$MessagesController(TL_wallPaperSettings tL_wallPaperSettings, TLObject tLObject, TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new C0653-$$Lambda$MessagesController$RwdHkk3sx1H7HCQZHIZAoujW4QQ(this, tL_wallPaper, tL_wallPaperSettings, file));
    }
    ...
    public /* synthetic */ void lambda$null$5$MessagesController(TL_wallPaper tL_wallPaper, TL_wallPaperSettings tL_wallPaperSettings, File file) {
        if (this.uploadingWallpaper != null && tL_wallPaper != null) {
            ...
            edit.putLong("selectedBackground2", tL_wallPaper.f569id);
            edit.commit();
            ...
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.wallpapersNeedReload, Long.valueOf(tL_wallPaper.f569id));
        }
    }
    ...
    public void cleanup() {
        ...
        Utilities.stageQueue.postRunnable(new C0681-$$Lambda$MessagesController$cyTTwmVBJXbVI4kVZKxLSy4FE3s(this));
        ...
        Utilities.stageQueue.postRunnable(new C0592-$$Lambda$MessagesController$6czMCwAPM6zONbsB9qHk4xGgZKk(this));
    ...
    public void setLastCreatedDialogId(long j, boolean z) {
        ...
        Utilities.stageQueue.postRunnable(new C0618-$$Lambda$MessagesController$GClBurUFA5765ROku5c8uOseY60(this, z, j));
    }
    ...
    public void putUsers(ArrayList<User> arrayList, boolean z) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            if (obj != null) {
                AndroidUtilities.runOnUIThread(new C0639-$$Lambda$MessagesController$MHasUaMkg9dD-kjYrwSO8zJY7Bs(this));
            }
        }
    }
    ...
    public void putChat(Chat chat, boolean z) {
        if (chat != null) {
            Chat chat2 = (Chat) this.chats.get(Integer.valueOf(chat.f434id));
            if (chat2 != chat) {
                    ...
                    if (!z) {
                        if (chat2 != null) {
                            if (chat.version != chat2.version) {
                                this.loadedFullChats.remove(Integer.valueOf(chat.f434id));
                            }
                            ...
                            if (!(i == i2 && z3 == z2)) {
                                AndroidUtilities.runOnUIThread(new C0630-$$Lambda$MessagesController$JQg5AlfE18YOamojW_v4DYkKyIA(this, chat));
                            }
                        }
                        this.chats.put(Integer.valueOf(chat.f434id), chat);
                    } else if (chat2 == null) {
                        this.chats.put(Integer.valueOf(chat.f434id), chat);
                    } else if (chat2.min) {
                        chat.min = false;
    ...
    public void putEncryptedChat(EncryptedChat encryptedChat, boolean z) {
        if (encryptedChat != null) {
            if (z) {
                this.encryptedChats.putIfAbsent(Integer.valueOf(encryptedChat.f445id), encryptedChat);
            } else {
                this.encryptedChats.put(Integer.valueOf(encryptedChat.f445id), encryptedChat);
            }
        }
    }
        ...
        if (j != 0 || (arrayList != null && !arrayList.isEmpty())) {
            ...
            if (arrayList != null) {
                for (int i = 0; i < arrayList.size(); i++) {
                    InputPeer inputPeer = getInputPeer((int) ((Dialog) arrayList.get(i)).f440id);
            ...
            if (!tL_messages_getPeerDialogs.peers.isEmpty()) {
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPeerDialogs, new C3491-$$Lambda$MessagesController$YrH4Mr-BWV-6GLj5qWieGm840u8(this));
            }
        }
    }
    ...
    public /* synthetic */ void lambda$reloadDialogsReadValue$12$MessagesController(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            for (int i = 0; i < tL_messages_peerDialogs.dialogs.size(); i++) {
                ...
                Integer num = (Integer) this.dialogs_read_inbox_max.get(Long.valueOf(dialog.f440id));
                if (num == null) {
                    num = Integer.valueOf(0);
                }
                this.dialogs_read_inbox_max.put(Long.valueOf(dialog.f440id), Integer.valueOf(Math.max(dialog.read_inbox_max_id, num.intValue())));
                if (num.intValue() == 0) {
                ...
                num = (Integer) this.dialogs_read_outbox_max.get(Long.valueOf(dialog.f440id));
                if (num == null) {
                    num = Integer.valueOf(0);
                }
                this.dialogs_read_outbox_max.put(Long.valueOf(dialog.f440id), Integer.valueOf(Math.max(dialog.read_outbox_max_id, num.intValue())));
                if (num.intValue() == 0) {
                    if (dialog.peer.channel_id != 0) {
    ...
    public void loadChannelAdmins(int i, boolean z) {
        if (this.loadingChannelAdmins.indexOfKey(i) < 0) {
            ...
            if (z) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getParticipants, new C3445-$$Lambda$MessagesController$5NQ9MFRgqgfYWG2HdrbXnmbFM_o(this, i));
            }
        }
    }
    ...
    public void processLoadedChannelAdmins(ArrayList<Integer> arrayList, int i, boolean z) {
        ...
        AndroidUtilities.runOnUIThread(new C0711-$$Lambda$MessagesController$qaVxMxZZgT13ZZ7VOgNBw4U51uM(this, i, arrayList, z));
    }
    ...
    public void loadFullChat(int i, int i2, boolean z) {
        ...
        if (!this.loadingFullChats.contains(Integer.valueOf(i))) {
            if (z || !contains) {
                ...
                i = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getFullChannel, new C3500-$$Lambda$MessagesController$ebifWTnrFPKK5b_9D1xusLXGK7Q(this, chat, j, i, i2));
                if (i2 != 0) {
    ...
    public /* synthetic */ void lambda$loadFullChat$17$MessagesController(Chat chat, long j, int i, int i2, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            AndroidUtilities.runOnUIThread(new C0737-$$Lambda$MessagesController$yEPLjf91Lbxq_PAfwQRKxAmq0Lc(this, i, tL_messages_chatFull, i2));
            return;
        }
        AndroidUtilities.runOnUIThread(new C0704-$$Lambda$MessagesController$mp8VRdAuIDk5ecDgkI3J_hxLXEM(this, tL_error, i));
    }
    ...
    public void loadFullUser(User user, int i, boolean z) {
        if (user != null && !this.loadingFullUsers.contains(Integer.valueOf(user.f534id))) {
            if (z || !this.loadedFullUsers.contains(Integer.valueOf(user.f534id))) {
                this.loadingFullUsers.add(Integer.valueOf(user.f534id));
                TL_users_getFullUser tL_users_getFullUser = new TL_users_getFullUser();
                tL_users_getFullUser.f530id = getInputUser(user);
                long j = (long) user.f534id;
                if (this.dialogs_read_inbox_max.get(Long.valueOf(j)) == null || this.dialogs_read_outbox_max.get(Long.valueOf(j)) == null) {
                    reloadDialogsReadValue(null, j);
                }
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_users_getFullUser, new C3519-$$Lambda$MessagesController$sHevIZGEf9jGeQ0PmpgZfE-2SOQ(this, user, i)), i);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$loadFullUser$20$MessagesController(User user, int i, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            AndroidUtilities.runOnUIThread(new C0581-$$Lambda$MessagesController$11fT0i1GEqsG3tRPr2wtXLuwL70(this, user, userFull, i));
            return;
        }
        AndroidUtilities.runOnUIThread(new C0622-$$Lambda$MessagesController$HIj5jF1rkzKmEGzAia-8fTi8vbE(this, user));
    }

    public /* synthetic */ void lambda$null$18$MessagesController(User user, UserFull userFull, int i) {
        applyDialogNotificationsSettings((long) user.f534id, userFull.notify_settings);
        if (userFull.bot_info instanceof TL_botInfo) {
            DataQuery.getInstance(this.currentAccount).putBotInfo(userFull.bot_info);
        }
        int indexOfKey = this.blockedUsers.indexOfKey(user.f534id);
        if (userFull.blocked) {
            if (indexOfKey < 0) {
                SparseIntArray sparseIntArray = new SparseIntArray();
                sparseIntArray.put(user.f534id, 1);
                MessagesStorage.getInstance(this.currentAccount).putBlockedUsers(sparseIntArray, false);
                this.blockedUsers.put(user.f534id, 1);
            ...
            MessagesStorage.getInstance(this.currentAccount).deleteBlockedUser(user.f534id);
            this.blockedUsers.removeAt(indexOfKey);
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.blockedUsersDidLoad, new Object[0]);
        }
        this.fullUsers.put(user.f534id, userFull);
        this.loadingFullUsers.remove(Integer.valueOf(user.f534id));
        this.loadedFullUsers.add(Integer.valueOf(user.f534id));
        StringBuilder stringBuilder = new StringBuilder();
    ...
    private void reloadMessages(ArrayList<Integer> arrayList, long j) {
        if (!arrayList.isEmpty()) {
            ...
            if (ChatObject.isChannel(chatByDialog)) {
                ...
                tL_channels_getMessages.f475id = arrayList2;
            } else {
                tL_channels_getMessages = new TL_messages_getMessages();
                tL_channels_getMessages.f506id = arrayList2;
            }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getMessages, new C3518-$$Lambda$MessagesController$rxB6ZCv-wieivWsHR6TFAEUSbcc(this, j, chatByDialog, arrayList2));
            }
        }
    }
    ...
    public /* synthetic */ void lambda$reloadMessages$22$MessagesController(long j, Chat chat, ArrayList arrayList, TLObject tLObject, TL_error tL_error) {
        ...
        if (tL_error == null) {
            ...
            for (int i2 = 0; i2 < messages_messages.chats.size(); i2++) {
                ...
                sparseArray2.put(chat3.f434id, chat3);
            }
            Integer num = (Integer) this.dialogs_read_inbox_max.get(Long.valueOf(j));
            if (num == null) {
            ...
            while (i3 < messages_messages.messages.size()) {
                ...
                message.unread = (message.out ? num3 : num).intValue() < message.f461id;
            ...
            AndroidUtilities.runOnUIThread(new C0655-$$Lambda$MessagesController$SnNO4Xza4siBfE3j_QycdBx_L6U(this, j, arrayList, arrayList2));
        }
    }
    ...
    public void hideReportSpam(long j, User user, Chat chat) {
        if (user != null || chat != null) {
            ...
            if (((int) j) != 0) {
                ...
                if (user != null) {
                    tL_messages_hideReportSpam.peer = getInputPeer(user.f534id);
                } else if (chat != null) {
                    tL_messages_hideReportSpam.peer = getInputPeer(-chat.f434id);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_hideReportSpam, C3442-$$Lambda$MessagesController$48y_t5lk6J6veA_TARwt8n5wq_Y.INSTANCE);
            }
        }
    }
    ...
    public void reportSpam(long j, User user, Chat chat, EncryptedChat encryptedChat) {
        if (user != null || chat != null || encryptedChat != null) {
            ...
            if (((int) j) != 0) {
                ...
                if (chat != null) {
                    tL_messages_reportSpam.peer = getInputPeer(-chat.f434id);
                } else if (user != null) {
                    tL_messages_reportSpam.peer = getInputPeer(user.f534id);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_reportSpam, C3455-$$Lambda$MessagesController$A-WQ0vAsaYkwbum0RRlzdSDsvGo.INSTANCE, 2);
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_reportEncryptedSpam, C3527-$$Lambda$MessagesController$z4dPdFyhgWJPX_RIzHIHAuPr2cc.INSTANCE, 2);
            }
        }
    }
        ...
        if (user != null || chat != null) {
            ...
            if (this.loadingPeerSettings.indexOfKey(j) < 0) {
                ...
                if (sharedPreferences.getBoolean(stringBuilder4.toString(), false)) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_hideReportSpam, new C3499-$$Lambda$MessagesController$earKZXcnSlbNSw2ZGT5Q1z7WPUw(this, j));
                    return;
                }
                TL_messages_getPeerSettings tL_messages_getPeerSettings = new TL_messages_getPeerSettings();
                if (user != null) {
                    tL_messages_getPeerSettings.peer = getInputPeer(user.f534id);
                } else if (chat != null) {
                    tL_messages_getPeerSettings.peer = getInputPeer(-chat.f434id);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPeerSettings, new C3460-$$Lambda$MessagesController$Akjl4BU34QO3ZqaL4fYbP0pvGoA(this, j));
            }
        }
    }

    public /* synthetic */ void lambda$loadPeerSettings$27$MessagesController(long j, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0659-$$Lambda$MessagesController$T_4uY71RM8CIJ1_vMFx7lbM6TkI(this, j));
    }
    ...
    public /* synthetic */ void lambda$loadPeerSettings$29$MessagesController(long j, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0724-$$Lambda$MessagesController$vHup36gKZnehVbIgi6EYZgekiCc(this, j, tLObject));
    }
    ...
    public void processNewChannelDifferenceParams(int i, int i2, int i3) {
        ...
        if (i4 + i2 == i) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("APPLY CHANNEL PTS");
            }
    ...
    public void didAddedNewTask(int i, SparseArray<ArrayList<Long>> sparseArray) {
        Utilities.stageQueue.postRunnable(new C0638-$$Lambda$MessagesController$LoBRzobgnJFkXmFzseR6vqsooQs(this, i));
        AndroidUtilities.runOnUIThread(new C0678-$$Lambda$MessagesController$bHd9VuzZp_-o4GfCjtn5be2-y4I(this, sparseArray));
    }
    ...
    public void getNewDeleteTask(ArrayList<Integer> arrayList, int i) {
        Utilities.stageQueue.postRunnable(new C0719-$$Lambda$MessagesController$uJw9E53v9xDGKUuX24rMZpaODgA(this, arrayList, i));
    }
    ...
    public /* synthetic */ void lambda$checkDeletingTask$34$MessagesController(ArrayList arrayList) {
        ...
        Utilities.stageQueue.postRunnable(new C0626-$$Lambda$MessagesController$Ipa0eWaVXBEreH61uO9jqrPCC0g(this, arrayList));
    }
    ...
    public void processLoadedDeleteTask(int i, ArrayList<Integer> arrayList, int i2) {
        Utilities.stageQueue.postRunnable(new C0591-$$Lambda$MessagesController$5rDlON84Ua92gPbhSWYw9Sv_2ig(this, arrayList, i));
    }
    ...
    public /* synthetic */ void lambda$processLoadedDeleteTask$36$MessagesController(ArrayList arrayList, int i) {
        ...
        if (arrayList != null) {
            ...
            if (!checkDeletingTask(false)) {
                this.currentDeleteTaskRunnable = new C0738-$$Lambda$MessagesController$yKVMzLBuY9JjdZe9ImZ-PuELipE(this);
    ...
    public void loadDialogPhotos(int i, int i2, long j, boolean z, int i3) {
        if (z) {
            ...
            if (user != null) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_photos_getUserPhotos, new C3486-$$Lambda$MessagesController$WZMD1Tmg9CzkfKN6c7nkyjvpJFA(this, i, i2, j, i3)), i3);
            }
        } else if (i < 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_search, new C3512-$$Lambda$MessagesController$mljRdiyVSAoNeixnSx85I7LZjOE(this, i, i2, j, i3)), i3);
        }
    }
    ...
    public void blockUser(int i) {
        ...
        if (user != null && this.blockedUsers.indexOfKey(i) < 0) {
            ...
            tL_contacts_block.f479id = getInputUser(user);
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_block, new C3484-$$Lambda$MessagesController$UR0KC8eSIVhCkdT-PUu4ASoxIZg(this, user));
        }
    }
    ...
    public void setUserBannedRole(int i, User user, TL_chatBannedRights tL_chatBannedRights, boolean z, BaseFragment baseFragment) {
        if (user != null && tL_chatBannedRights != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_editBanned, new C3473-$$Lambda$MessagesController$PTatBcwlbxdtRxQAlB57_yJjqhU(this, i, baseFragment, tL_channels_editBanned, z));
        }
    }
    ...
    public /* synthetic */ void lambda$setUserBannedRole$42$MessagesController(int i, BaseFragment baseFragment, TL_channels_editBanned tL_channels_editBanned, boolean z, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            AndroidUtilities.runOnUIThread(new C0584-$$Lambda$MessagesController$1dVEAugRY-eNBjCuCw7fZ-d6SjQ(this, i), 1000);
            return;
        }
        AndroidUtilities.runOnUIThread(new C0721-$$Lambda$MessagesController$uqMzh59_UK2vW6XHpekt8li6T30(this, tL_error, baseFragment, tL_channels_editBanned, z));
    }
    ...
    public void setDefaultBannedRole(int i, TL_chatBannedRights tL_chatBannedRights, boolean z, BaseFragment baseFragment) {
        if (tL_chatBannedRights != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editChatDefaultBannedRights, new C3436-$$Lambda$MessagesController$1P_GCY-PWvevMznLENn0Y1ly8wA(this, i, baseFragment, tL_messages_editChatDefaultBannedRights, z));
        }
    }
    ...
    public /* synthetic */ void lambda$setDefaultBannedRole$45$MessagesController(int i, BaseFragment baseFragment, TL_messages_editChatDefaultBannedRights tL_messages_editChatDefaultBannedRights, boolean z, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            processUpdates((Updates) tLObject, false);
            AndroidUtilities.runOnUIThread(new C0707-$$Lambda$MessagesController$nf_CcZzYILO5CfS-8KQCWMOSEPI(this, i), 1000);
            return;
        }
        AndroidUtilities.runOnUIThread(new C0696-$$Lambda$MessagesController$jTlC42LjZXj4VFuUMm4RDeppjZs(this, tL_error, baseFragment, tL_messages_editChatDefaultBannedRights, z));
    }
    ...
    public void setUserAdminRole(int i, User user, TL_chatAdminRights tL_chatAdminRights, boolean z, BaseFragment baseFragment, boolean z2) {
        if (user != null && tL_chatAdminRights != null) {
            ...
            if (ChatObject.isChannel(chat)) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_editAdmin, new C3517-$$Lambda$MessagesController$ruvO2GOVq6vr5RbeSeoQf9j2-3I(this, i, baseFragment, tL_channels_editAdmin, z));
                return;
            }
            ...
            C3513-$$Lambda$MessagesController$oInAanuig7UbxR7DhBxjsIzAZu4 c3513-$$Lambda$MessagesController$oInAanuig7UbxR7DhBxjsIzAZu4 = new C3513-$$Lambda$MessagesController$oInAanuig7UbxR7DhBxjsIzAZu4(this, i, baseFragment, tL_messages_editChatAdmin);
            if (tL_messages_editChatAdmin.is_admin && z2) {
                addUserToChat(i, user, null, 0, null, baseFragment, new C0713-$$Lambda$MessagesController$re3lVjnmONchziB0xgSqaVhxV5Q(this, tL_messages_editChatAdmin, c3513-$$Lambda$MessagesController$oInAanuig7UbxR7DhBxjsIzAZu4));
            } else {
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editChatAdmin, c3513-$$Lambda$MessagesController$oInAanuig7UbxR7DhBxjsIzAZu4);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$setUserAdminRole$48$MessagesController(int i, BaseFragment baseFragment, TL_channels_editAdmin tL_channels_editAdmin, boolean z, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            processUpdates((Updates) tLObject, false);
            AndroidUtilities.runOnUIThread(new C0585-$$Lambda$MessagesController$1jQ0-MBw6KZOFlWcz0l4GlwUKWE(this, i), 1000);
            return;
        }
        AndroidUtilities.runOnUIThread(new C0732-$$Lambda$MessagesController$xQRkDsNdc7E8A8vOKZnj4SaYK-I(this, tL_error, baseFragment, tL_channels_editAdmin, z));
    }
    ...
    public /* synthetic */ void lambda$setUserAdminRole$51$MessagesController(int i, BaseFragment baseFragment, TL_messages_editChatAdmin tL_messages_editChatAdmin, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            AndroidUtilities.runOnUIThread(new C0619-$$Lambda$MessagesController$G__d657sEgRw5eIUK22CxKPabk8(this, i), 1000);
        } else {
            AndroidUtilities.runOnUIThread(new C0702-$$Lambda$MessagesController$lgHhjVycSWp0O6n3iqFJOy3XH1A(this, tL_error, baseFragment, tL_messages_editChatAdmin));
        }
    }
    ...
    public void unblockUser(int i) {
        ...
        User user = getUser(Integer.valueOf(i));
        if (user != null) {
            this.blockedUsers.delete(user.f534id);
            tL_contacts_unblock.f483id = getInputUser(user);
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.blockedUsersDidLoad, new Object[0]);
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_unblock, new C3514-$$Lambda$MessagesController$opwePRyqFhALjQxPzCei2q6RZPU(this, user));
        }
    }
    ...
    public void getBlockedUsers(boolean z) {
        if (UserConfig.getInstance(this.currentAccount).isClientActivated() && !this.loadingBlockedUsers) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_getBlocked, new C3474-$$Lambda$MessagesController$R5tZYjWVTciy1Jz1GsIoNOmiXf8(this));
        }
    }
    ...
    public void processLoadedBlockedUsers(SparseIntArray sparseIntArray, ArrayList<User> arrayList, boolean z) {
        AndroidUtilities.runOnUIThread(new C0629-$$Lambda$MessagesController$JPDY_4SRGvZvjZ1pDyebULwuKFA(this, arrayList, z, sparseIntArray));
    }
    ...
    public void deleteUserPhoto(InputPhoto inputPhoto) {
        if (inputPhoto == null) {
            ...
            tL_photos_updateProfilePhoto.f526id = new TL_inputPhotoEmpty();
            ...
            if (user != null) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_photos_updateProfilePhoto, new C3439-$$Lambda$MessagesController$3uRiNEdYGV34lhCOa9clmeKBj1M(this));
            } else {
                return;
            }
        }
        TL_photos_deletePhotos tL_photos_deletePhotos = new TL_photos_deletePhotos();
        tL_photos_deletePhotos.f525id.add(inputPhoto);
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_photos_deletePhotos, C3510-$$Lambda$MessagesController$lnX7i9eGTDuJovXhCLpz1QuqmLE.INSTANCE);
    }
    ...
    public /* synthetic */ void lambda$deleteUserPhoto$57$MessagesController(TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            if (user != null) {
                ...
                AndroidUtilities.runOnUIThread(new C0614-$$Lambda$MessagesController$FS6UDAATQ6vB2PUbj-Uk45N_XpU(this));
            }
        }
    }
    ...
    public void processLoadedUserPhotos(photos_Photos photos_photos, int i, int i2, long j, boolean z, int i3) {
        ...
        AndroidUtilities.runOnUIThread(new C0642-$$Lambda$MessagesController$NAWdcL37DBZ4gWGx1x8HuDp86gI(this, photos_photos, z, i, i2, i3));
    }
        ...
        if (file2 != null) {
            ...
            if (j3 != 0) {
                ...
                try {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_installWallPaper, new C3490-$$Lambda$MessagesController$YmKMKppARt1F8875D8216H1-tmM(this, j4, z3, j));
                }
                j4 = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
            }
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_installWallPaper, new C3490-$$Lambda$MessagesController$YmKMKppARt1F8875D8216H1-tmM(this, j4, z3, j));
            ...
            if (i != 0) {
                if (tLObject != null) {
                    ...
                    try {
                        ...
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new C3453-$$Lambda$MessagesController$9B6lLHcMl9ABhpIDa9aeiv_K8oA(this, i, j));
                    }
                    j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new C3453-$$Lambda$MessagesController$9B6lLHcMl9ABhpIDa9aeiv_K8oA(this, i, j));
                ...
                if (tLObject != null) {
                    ...
                    try {
                        ...
                        FileLog.m30e(e);
                        j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new C3515-$$Lambda$MessagesController$py2_IIRHD2uCa7xVMrMM8SVKTaA(this, j));
                    }
                    j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new C3515-$$Lambda$MessagesController$py2_IIRHD2uCa7xVMrMM8SVKTaA(this, j));
    ...
    public void pinMessage(Chat chat, User user, int i, boolean z) {
        if (chat != null || user != null) {
            ...
            tL_messages_updatePinnedMessage.peer = getInputPeer(chat != null ? -chat.f434id : user.f534id);
            tL_messages_updatePinnedMessage.f520id = i;
            tL_messages_updatePinnedMessage.silent = z ^ 1;
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_updatePinnedMessage, new C3529-$$Lambda$MessagesController$zi8soJuISiGh3kdE6Q_S1wPr31c(this));
        }
    }
    ...
    public void deleteUserChannelHistory(Chat chat, User user, int i) {
        if (i == 0) {
            MessagesStorage.getInstance(this.currentAccount).deleteUserChannelHistory(chat.f434id, user.f534id);
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_deleteUserHistory, new C3432-$$Lambda$MessagesController$-lPnTSKn3lxlWS4m8gq50UHxeAw(this, chat, user));
    }
    ...
    public /* synthetic */ void lambda$deleteUserChannelHistory$64$MessagesController(Chat chat, User user, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            processNewChannelDifferenceParams(tL_messages_affectedHistory.pts, tL_messages_affectedHistory.pts_count, chat.f434id);
        }
    }
    ...
    private void removeDialog(Dialog dialog) {
        if (dialog != null) {
            long j = dialog.f440id;
            if (this.dialogsServerOnly.remove(dialog) && DialogObject.isChannel(dialog)) {
                Utilities.stageQueue.postRunnable(new C0725-$$Lambda$MessagesController$vWlNj3xTvw31mmNI0cEnDFi4DZ8(this, j));
            }
    ...
    public /* synthetic */ void lambda$deleteDialog$67$MessagesController(long j) {
        AndroidUtilities.runOnUIThread(new C0632-$$Lambda$MessagesController$KpbyllFi8c4LuRHme4BUUg14Dek(this, j));
    }
    ...
    public /* synthetic */ void lambda$deleteDialog$69$MessagesController(long j, long j2, TLObject tLObject, TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new C0610-$$Lambda$MessagesController$DwkK6UVHlAwcTaxAil0Ui6ghGR0(this, j2));
    }
    ...
    public void saveGif(Object obj, Document document) {
        if (obj != null && MessageObject.isGifDocument(document)) {
            ...
            tL_messages_saveGif.f511id = new TL_inputDocument();
            InputDocument inputDocument = tL_messages_saveGif.f511id;
            inputDocument.f452id = document.f441id;
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_saveGif, new C3457-$$Lambda$MessagesController$AJRaVVVB2-z__jsu2wGba-x0X0k(this, obj, tL_messages_saveGif));
        }
    }
    ...
    public void saveRecentSticker(Object obj, Document document, boolean z) {
        if (obj != null && document != null) {
            ...
            tL_messages_saveRecentSticker.f512id = new TL_inputDocument();
            InputDocument inputDocument = tL_messages_saveRecentSticker.f512id;
            inputDocument.f452id = document.f441id;
            inputDocument.access_hash = document.access_hash;
            inputDocument.file_reference = document.file_reference;
            if (inputDocument.file_reference == null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_saveRecentSticker, new C3459-$$Lambda$MessagesController$Ac6iMOZ3v5XiuSoBQXhRvLk2mds(this, obj, tL_messages_saveRecentSticker));
        }
    }
    ...
    public void loadChannelParticipants(Integer num) {
        if (!this.loadingFullParticipants.contains(num) && !this.loadedFullParticipants.contains(num)) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getParticipants, new C3438-$$Lambda$MessagesController$2gEZaEhNLvSnEOT8iEFZtRspSU0(this, num));
        }
    }
    ...
    public /* synthetic */ void lambda$loadChannelParticipants$74$MessagesController(Integer num, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0677-$$Lambda$MessagesController$atBLO-w4l-c1A3YUDnxbyiiuEDs(this, tL_error, tLObject, num));
    }
    ...
    public void processChatInfo(int i, ChatFull chatFull, ArrayList<User> arrayList, boolean z, boolean z2, boolean z3, MessageObject messageObject) {
        ...
        if (chatFull != null) {
            AndroidUtilities.runOnUIThread(new C0676-$$Lambda$MessagesController$aj9gT3RqpNCMmoGiSwlydWLbsP8(this, arrayList, z, chatFull, z3, messageObject));
        }
    }
    ...
    public void processUserInfo(User user, UserFull userFull, boolean z, boolean z2, MessageObject messageObject, int i) {
        ...
        if (userFull != null) {
            if (this.fullUsers.get(user.f534id) == null) {
                this.fullUsers.put(user.f534id, userFull);
            }
            AndroidUtilities.runOnUIThread(new C0723-$$Lambda$MessagesController$vF733kQiTAupYlV5PFZpkpSFLz4(this, user, userFull, messageObject));
        }
    }
    ...
    public /* synthetic */ void lambda$processUserInfo$76$MessagesController(User user, UserFull userFull, MessageObject messageObject) {
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.userInfoDidLoad, Integer.valueOf(user.f534id), userFull, messageObject);
    }
    ...
    public void updateTimerProc() {
        ...
        if (UserConfig.getInstance(this.currentAccount).isClientActivated()) {
            ...
            if (ConnectionsManager.getInstance(this.currentAccount).getPauseTime() == 0 && ApplicationLoader.isScreenOn && !ApplicationLoader.mainInterfacePausedStageQueue) {
                if (ApplicationLoader.mainInterfacePausedStageQueueTime != 0 && Math.abs(ApplicationLoader.mainInterfacePausedStageQueueTime - System.currentTimeMillis()) > 1000 && this.statusSettingState != 1 && (this.lastStatusUpdateTime == 0 || Math.abs(System.currentTimeMillis() - this.lastStatusUpdateTime) >= 55000 || this.offlineSent)) {
                    ...
                    this.statusRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_updateStatus, new C3495-$$Lambda$MessagesController$cfQiiK2gKJLj20bAsG92QXAhxfU(this));
                }
                ...
                this.statusRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_updateStatus, new C3522-$$Lambda$MessagesController$ueghtSvHFDbkkKRlzH3zhB7vPCY(this));
            }
        ...
        if (Math.abs(System.currentTimeMillis() - this.lastViewsCheckTime) >= 5000) {
            ...
            if (this.channelViewsToSend.size() != 0) {
                ...
                while (i < this.channelViewsToSend.size()) {
                    ...
                    tL_messages_getMessagesViews.f507id = (ArrayList) this.channelViewsToSend.valueAt(i);
                    tL_messages_getMessagesViews.increment = i == 0;
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getMessagesViews, new C3528-$$Lambda$MessagesController$zcPVttRNdPhRMvGP9lvTiB9rsK8(this, keyAt, tL_messages_getMessagesViews));
                    i++;
                }
                this.channelViewsToSend.clear();
            }
            if (this.pollsToCheckSize > 0) {
                AndroidUtilities.runOnUIThread(new C0612-$$Lambda$MessagesController$EvGoS6VQaul799anwg65luJP3kM(this));
            }
        }
        if (!this.onlinePrivacy.isEmpty()) {
            ...
            if (arrayList != null) {
                ...
                AndroidUtilities.runOnUIThread(new C0717-$$Lambda$MessagesController$tRF6Ij6nWDh57hakeYO-dBj2yNg(this));
            }
        }
        ...
        if (this.shortPollOnlines.size() != 0) {
            ...
            while (i < this.shortPollOnlines.size()) {
                ...
                if (((long) this.shortPollOnlines.valueAt(i)) < uptimeMillis) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getOnlines, new C3520-$$Lambda$MessagesController$sjofkBeH5gGrYjjT8WNKFtTfESE(this, keyAt2));
                }
                i++;
            }
        }
        if (!(this.printingUsers.isEmpty() && this.lastPrintingStringCount == this.printingUsers.size())) {
            ...
            if (obj != null) {
                AndroidUtilities.runOnUIThread(new C0643-$$Lambda$MessagesController$NCgFAuLO8OXQTI8IHmqXB1TzYHE(this));
            }
        }
    ...
    public /* synthetic */ void lambda$updateTimerProc$80$MessagesController(int i, TL_messages_getMessagesViews tL_messages_getMessagesViews, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            i = 0;
            while (i < tL_messages_getMessagesViews.f507id.size() && i < vector.objects.size()) {
                sparseIntArray.put(((Integer) tL_messages_getMessagesViews.f507id.get(i)).intValue(), ((Integer) vector.objects.get(i)).intValue());
                i++;
            }
            ...
            AndroidUtilities.runOnUIThread(new C0596-$$Lambda$MessagesController$8xLr-ghSkkpTTqlNVF_KzHO2X20(this, sparseArray));
        }
    }
            ...
            if (sparseArray != null) {
                ...
                while (i2 < size2) {
                    ...
                    if (Math.abs(uptimeMillis - messageObject.pollLastCheckTime) >= 30000) {
                        ...
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPollResults, new C3485-$$Lambda$MessagesController$WAhoxMlOe9rKGiImOpgvJIHyQtk(this));
    ...
    public /* synthetic */ void lambda$updateTimerProc$85$MessagesController(int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            AndroidUtilities.runOnUIThread(new C0649-$$Lambda$MessagesController$OmsxlAaybMmJyhzcSO6qE2vdkAg(this, i, tL_chatOnlines));
        }
    }
    ...
    private void checkTosUpdate() {
        if (this.nextTosCheckTime <= ConnectionsManager.getInstance(this.currentAccount).getCurrentTime() && !this.checkingTosUpdate && UserConfig.getInstance(this.currentAccount).isClientActivated()) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_help_getTermsOfServiceUpdate(), new C3444-$$Lambda$MessagesController$5GO5q-JFS4BEFNcWBCNsIVVD9gY(this));
        }
    }
    ...
    public /* synthetic */ void lambda$checkTosUpdate$88$MessagesController(TLObject tLObject, TL_error tL_error) {
        ...
        if (tLObject instanceof TL_help_termsOfServiceUpdateEmpty) {
            ...
            AndroidUtilities.runOnUIThread(new C0686-$$Lambda$MessagesController$fH6gNCG5Tk-fGc0NroG1SVH_0DA(this, tL_help_termsOfServiceUpdate));
        } else {
    ...
    public void checkProxyInfo(boolean z) {
        Utilities.stageQueue.postRunnable(new C0661-$$Lambda$MessagesController$UmwP8okyEt8khTz852DsKDuGJ70(this, z));
    }
    ...
    public /* synthetic */ void lambda$null$93$MessagesController(long j, TL_help_proxyDataPromo tL_help_proxyDataPromo) {
        ...
        while (i < tL_help_proxyDataPromo.chats.size()) {
            ...
            sparseArray2.put(chat.f434id, chat);
            i++;
        }
        TL_messages_getPeerDialogs tL_messages_getPeerDialogs = new TL_messages_getPeerDialogs();
        TL_inputDialogPeer tL_inputDialogPeer = new TL_inputDialogPeer();
        ...
        tL_messages_getPeerDialogs.peers.add(tL_inputDialogPeer);
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPeerDialogs, new C3508-$$Lambda$MessagesController$jGzHg4Vpn20r2Dvt16XQexkQnM8(this, tL_help_proxyDataPromo, j));
    }
    ...
    public /* synthetic */ void lambda$null$92$MessagesController(TL_help_proxyDataPromo tL_help_proxyDataPromo, long j, TLObject tLObject, TL_error tL_error) {
        if (this.checkingProxyInfoRequestId != 0) {
            ...
            if (tL_messages_peerDialogs == null || tL_messages_peerDialogs.dialogs.isEmpty()) {
                AndroidUtilities.runOnUIThread(new C0673-$$Lambda$MessagesController$__dEtAqUXm-ipyTn-k8IK_xJUDw(this));
            } else {
                ...
                AndroidUtilities.runOnUIThread(new C0579-$$Lambda$MessagesController$0hzwDCgQaQ7-pO9ojVbt_LU0UiE(this, tL_help_proxyDataPromo, tL_messages_peerDialogs, j));
            }
            this.checkingProxyInfo = false;
        }
    }
    ...
    public /* synthetic */ void lambda$null$90$MessagesController(TL_help_proxyDataPromo tL_help_proxyDataPromo, TL_messages_peerDialogs tL_messages_peerDialogs, long j) {
        ...
        if (DialogObject.isChannel(dialog)) {
            ...
            sparseIntArray.put(-((int) dialog2.f440id), dialog2.pts);
        }
        Integer num = (Integer) this.dialogs_read_inbox_max.get(Long.valueOf(this.proxyDialog.f440id));
        if (num == null) {
            num = valueOf;
        }
        this.dialogs_read_inbox_max.put(Long.valueOf(this.proxyDialog.f440id), Integer.valueOf(Math.max(num.intValue(), this.proxyDialog.read_inbox_max_id)));
        num = (Integer) this.dialogs_read_outbox_max.get(Long.valueOf(this.proxyDialog.f440id));
        if (num == null) {
            num = valueOf;
        }
        this.dialogs_read_outbox_max.put(Long.valueOf(this.proxyDialog.f440id), Integer.valueOf(Math.max(num.intValue(), this.proxyDialog.read_outbox_max_id)));
    ...
    public boolean isProxyDialog(long j, boolean z) {
        Dialog dialog = this.proxyDialog;
        return dialog != null && dialog.f440id == j && (!z || this.isLeftProxyChannel);
    }
    ...
    private void updatePrintingStrings() {
            ...
            if (i > 0 || i == 0 || arrayList.size() == 1) {
                ...
                if (getUser(Integer.valueOf(printingUser.userId)) != null) {
                    ...
                    if (sendMessageAction instanceof TL_sendMessageRecordAudioAction) {
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsRecordingAudio", C1067R.string.IsRecordingAudio, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("RecordingAudio", C1067R.string.RecordingAudio));
                        }
                        ...
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsRecordingRound", C1067R.string.IsRecordingRound, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("RecordingRound", C1067R.string.RecordingRound));
                        }
                        longSparseArray2.put(longValue, Integer.valueOf(4));
                    } else if (sendMessageAction instanceof TL_sendMessageUploadAudioAction) {
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsSendingAudio", C1067R.string.IsSendingAudio, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("SendingAudio", C1067R.string.SendingAudio));
                        }
                        ...
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsSendingVideo", C1067R.string.IsSendingVideo, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("SendingVideoStatus", C1067R.string.SendingVideoStatus));
                        }
                        longSparseArray2.put(longValue, Integer.valueOf(2));
                    } else if (sendMessageAction instanceof TL_sendMessageUploadDocumentAction) {
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsSendingFile", C1067R.string.IsSendingFile, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("SendingFile", C1067R.string.SendingFile));
                        }
                        longSparseArray2.put(longValue, Integer.valueOf(2));
                    } else if (sendMessageAction instanceof TL_sendMessageUploadPhotoAction) {
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsSendingPhoto", C1067R.string.IsSendingPhoto, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("SendingPhoto", C1067R.string.SendingPhoto));
                        }
                        longSparseArray2.put(longValue, Integer.valueOf(2));
                    } else if (sendMessageAction instanceof TL_sendMessageGamePlayAction) {
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString("IsSendingGame", C1067R.string.IsSendingGame, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("SendingGame", C1067R.string.SendingGame));
                        }
                        longSparseArray2.put(longValue, Integer.valueOf(3));
                    } else {
                        if (i < 0) {
                            longSparseArray.put(longValue, LocaleController.formatString(str, C1067R.string.IsTypingGroup, getUserNameForTyping(r8)));
                        } else {
                            longSparseArray.put(longValue, LocaleController.getString("Typing", C1067R.string.Typing));
                        }
                ...
                if (stringBuilder.length() != 0) {
                    if (i2 == 1) {
                        longSparseArray.put(longValue, LocaleController.formatString(str, C1067R.string.IsTypingGroup, stringBuilder.toString()));
                        ...
                        longSparseArray.put(longValue, LocaleController.formatString("AreTypingGroup", C1067R.string.AreTypingGroup, stringBuilder.toString()));
                    }
                    longSparseArray2.put(longValue, Integer.valueOf(0));
                }
            }
        ...
        AndroidUtilities.runOnUIThread(new C0620-$$Lambda$MessagesController$Gpj0Tfm4ESrlwMoiHamza4rhl1c(this, longSparseArray, longSparseArray2));
    }
                ...
                if (i3 != 0) {
                    if (i4 != 1) {
                        ...
                        if (tL_messages_setTyping.peer != null) {
                            ...
                            sendRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_setTyping, new C3434-$$Lambda$MessagesController$0RUkjN1o4ur0BN0-Uwykda9jP9E(this, i, j), 2);
                            if (i2 != 0) {
                    ...
                    if (bArr != null && bArr.length > 1 && (encryptedChat instanceof TL_encryptedChat)) {
                        ...
                        longSparseArray.put(j, Boolean.valueOf(true));
                        sendRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_setEncryptedTyping, new C3441-$$Lambda$MessagesController$46d8KXzv97zrAkyG5uwxOcxtLc4(this, i, j), 2);
                        if (i2 != 0) {
                            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(sendRequest, i2);
                        }
                    }
    ...
    public /* synthetic */ void lambda$sendTyping$99$MessagesController(int i, long j, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0729-$$Lambda$MessagesController$wKGVCgj8ovsTOS0jCqWZ3uZqdEI(this, i, j));
    }
    ...
    public /* synthetic */ void lambda$sendTyping$101$MessagesController(int i, long j, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0595-$$Lambda$MessagesController$8jlYAGfWz85ggA903BPszKwwO84(this, i, j));
    }
    ...
    public void removeDeletedMessagesFromArray(long j, ArrayList<Message> arrayList) {
        ...
        if (intValue != 0) {
            int size = arrayList.size();
            while (i < size) {
                if (((Message) arrayList.get(i)).f461id <= intValue) {
                    arrayList.remove(i);
                    i--;
                    size--;
                }
    ...
    private void loadMessagesInternal(long j, int i, int i2, int i3, boolean z, int i4, int i5, int i6, int i7, boolean z2, int i8, int i9, int i10, int i11, boolean z3, int i12, boolean z4) {
        ...
        if (z5 || i23 == 0) {
            ...
            C3479-$$Lambda$MessagesController$TN49v1ka-VM8bKqcQJdVLHWMje8 c3479-$$Lambda$MessagesController$TN49v1ka-VM8bKqcQJdVLHWMje8 = r0;
            TLObject tLObject = tL_messages_getPeerDialogs;
            ConnectionsManager connectionsManager = instance;
            C3479-$$Lambda$MessagesController$TN49v1ka-VM8bKqcQJdVLHWMje8 c3479-$$Lambda$MessagesController$TN49v1ka-VM8bKqcQJdVLHWMje82 = new C3479-$$Lambda$MessagesController$TN49v1ka-VM8bKqcQJdVLHWMje8(this, j, i, i2, i3, i4, i5, i6, z2, i8, i9, i11, z3);
            connectionsManager.sendRequest(tLObject, c3479-$$Lambda$MessagesController$TN49v1ka-VM8bKqcQJdVLHWMje8);
        } else {
            ...
            C3472-$$Lambda$MessagesController$PBgpLRl3hHYMA8ENpUjkzO9CiK0 c3472-$$Lambda$MessagesController$PBgpLRl3hHYMA8ENpUjkzO9CiK0 = r0;
            ConnectionsManager instance2 = ConnectionsManager.getInstance(this.currentAccount);
            TLObject tLObject2 = tL_messages_getHistory;
            C3472-$$Lambda$MessagesController$PBgpLRl3hHYMA8ENpUjkzO9CiK0 c3472-$$Lambda$MessagesController$PBgpLRl3hHYMA8ENpUjkzO9CiK02 = new C3472-$$Lambda$MessagesController$PBgpLRl3hHYMA8ENpUjkzO9CiK0(this, j, i, i2, i24, i5, i9, i7, i10, i11, i6, z2, i8, z3, i12);
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(instance2.sendRequest(tLObject2, c3472-$$Lambda$MessagesController$PBgpLRl3hHYMA8ENpUjkzO9CiK0), i5);
        }
    }
    ...
    public /* synthetic */ void lambda$loadMessagesInternal$103$MessagesController(long j, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, boolean z, int i10, boolean z2, int i11, TLObject tLObject, TL_error tL_error) {
        ...
        if (tLObject != null) {
            ...
            if (i12 == 0 || messages_messages.messages.isEmpty()) {
                ...
                int i14 = ((Message) arrayList.get(arrayList.size() - 1)).f461id;
    ...
    public void reloadWebPages(long j, HashMap<String, ArrayList<MessageObject>> hashMap) {
        for (Entry entry : hashMap.entrySet()) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getWebPagePreview, new C3443-$$Lambda$MessagesController$4nBTlb9eBU7C4QavllU2UZiopks(this, str, j));
        }
    }

    public /* synthetic */ void lambda$reloadWebPages$105$MessagesController(String str, long j, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0603-$$Lambda$MessagesController$CG95xW3CPVaIHZyuw5jMlgk_hAs(this, str, tLObject, j));
    }
        ...
        if (arrayList != null) {
            ...
            if (tLObject instanceof TL_messageMediaWebPage) {
                ...
                if ((webPage instanceof TL_webPage) || (webPage instanceof TL_webPageEmpty)) {
                    ...
                    this.reloadingWebpagesPending.put(webPage.f539id, arrayList);
                }
            } else {
                for (int i2 = 0; i2 < arrayList.size(); i2++) {
    ...
    public void processLoadedMessages(messages_Messages messages_messages, long j, int i, int i2, int i3, boolean z, int i4, int i5, int i6, int i7, int i8, int i9, boolean z2, boolean z3, int i10, boolean z4, int i11) {
        ...
        Utilities.stageQueue.postRunnable(new C0599-$$Lambda$MessagesController$B3eeeWzbYDkKoJj9YxFxBPuwloE(this, messages_messages, j, z, i, i9, z4, i5, i2, i3, i4, i6, z2, i10, i7, i8, i11, z3));
    }
    ...
    public void loadHintDialogs() {
        if (this.hintDialogs.isEmpty() && !TextUtils.isEmpty(this.installReferer)) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_help_getRecentMeUrls, new C3476-$$Lambda$MessagesController$S17IW-TdnLou1yG0GrX54gGAuDE(this));
        }
    }

    public /* synthetic */ void lambda$loadHintDialogs$110$MessagesController(TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            AndroidUtilities.runOnUIThread(new C0645-$$Lambda$MessagesController$OHE7-yHc7AWZbJtLN81PZkwCp4o(this, tLObject));
        }
    }
    ...
    private TL_dialogFolder ensureFolderDialogExists(int i, boolean[] zArr) {
        ...
        tL_dialogFolder.f440id = makeFolderDialogId;
        tL_dialogFolder.peer = new TL_peerUser();
        tL_dialogFolder.folder = new TL_folder();
        TL_folder tL_folder = tL_dialogFolder.folder;
        tL_folder.f485id = i;
        tL_folder.title = LocaleController.getString("ArchivedChats", C1067R.string.ArchivedChats);
    ...
    public void onFolderEmpty(int i) {
        ...
        loadDialogs(i, 0, 10, false, new C0695-$$Lambda$MessagesController$jEkulIUjpo2aQz9ir2LF9vSzFoc(this, i));
    }
    ...
    public void loadGlobalNotificationsSettings() {
        if (this.loadingNotificationSettings == 0 && !UserConfig.getInstance(this.currentAccount).notificationsSettingsLoaded) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_getNotifySettings, new C3469-$$Lambda$MessagesController$Kw60WHVImMJ5bL_qjfLao1O7Ey8(this, i));
            }
        }
    ...
    public /* synthetic */ void lambda$loadGlobalNotificationsSettings$115$MessagesController(int i, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0712-$$Lambda$MessagesController$rNUlr7DAfpCKy3vrWYUfF6QWZEw(this, tLObject, i));
    }
    ...
    public void loadSignUpNotificationsSettings() {
        if (!this.loadingNotificationSignUpSettings) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getContactSignUpNotification(), new C3516-$$Lambda$MessagesController$rOfsCqpWEwvJI16XzaGq8LurqHg(this));
        }
    }

    public /* synthetic */ void lambda$loadSignUpNotificationsSettings$117$MessagesController(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0705-$$Lambda$MessagesController$mxqgqoLhYjlwTctiq5kQ_FZ7lvE(this, tLObject));
    }
            ...
            if (this.gettingUnknownDialogs.indexOfKey(peerDialogId) < 0) {
                ...
                if (j == 0) {
                    ...
                    try {
                        ...
                        FileLog.m30e(e);
                        j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPeerDialogs, new C3433-$$Lambda$MessagesController$-qOB0YtC-RNY0KjHwuxhfdX_Ckg(this, j, peerDialogId));
                    }
                    j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPeerDialogs, new C3433-$$Lambda$MessagesController$-qOB0YtC-RNY0KjHwuxhfdX_Ckg(this, j, peerDialogId));
            ...
            if (dialog instanceof TL_dialogFolder) {
                ...
                if (tL_dialogFolder.top_message == 0 || peerDialogId == 0) {
                    ...
                    for (i2 = 0; i2 < size; i2++) {
                        ...
                        if (peerDialogId == MessageObject.getDialogId(message) && dialog.top_message == message.f461id) {
                            InputPeer tL_inputPeerChannel;
                            TL_dialog tL_dialog = new TL_dialog();
                            tL_dialog.peer = dialog.peer;
                            tL_dialog.top_message = dialog.top_message;
                            tL_dialog.folder_id = tL_dialogFolder.folder.f485id;
                            tL_dialog.flags |= 16;
                            ...
                            if (peer instanceof TL_peerChannel) {
                                ...
                                while (i < i2) {
                                    Chat chat = (Chat) tL_messages_peerDialogs.chats.get(i);
                                    if (chat.f434id == tL_inputPeerChannel.channel_id) {
                                        tL_inputPeerChannel.access_hash = chat.access_hash;
                                        break;
                                    }
                                    i++;
                                ...
                                while (i < i2) {
                                    User user = (User) tL_messages_peerDialogs.users.get(i);
                                    if (user.f534id == tL_inputPeerChannel.user_id) {
                                        tL_inputPeerChannel.access_hash = user.access_hash;
                                        break;
                                    }
                                    i++;
    ...
    public void completeDialogsReset(messages_Dialogs messages_dialogs, int i, int i2, int i3, int i4, int i5, LongSparseArray<Dialog> longSparseArray, LongSparseArray<MessageObject> longSparseArray2, Message message) {
        Utilities.stageQueue.postRunnable(new C0736-$$Lambda$MessagesController$yD6NgtKkjxhJizLM4eoCQwHgn60(this, i3, i4, i5, messages_dialogs, longSparseArray, longSparseArray2));
    }
    ...
    public /* synthetic */ void lambda$completeDialogsReset$122$MessagesController(int i, int i2, int i3, messages_Dialogs messages_dialogs, LongSparseArray longSparseArray, LongSparseArray longSparseArray2) {
        ...
        getDifference();
        AndroidUtilities.runOnUIThread(new C0576-$$Lambda$MessagesController$-JxxcnOrF9NEl3xKvCXKO-45t_Q(this, messages_dialogs, longSparseArray, longSparseArray2));
    }
    ...
    public /* synthetic */ void lambda$null$121$MessagesController(messages_Dialogs messages_dialogs, LongSparseArray longSparseArray, LongSparseArray longSparseArray2) {
        ...
        for (i = 0; i < this.allDialogs.size(); i++) {
            ...
            if (!DialogObject.isSecretDialogId(dialog.f440id)) {
                this.dialogs_dict.remove(dialog.f440id);
                MessageObject messageObject = (MessageObject) this.dialogMessage.get(dialog.f440id);
                this.dialogMessage.remove(dialog.f440id);
                if (messageObject != null) {
        ...
        for (i = 0; i < longSparseArray.size(); i++) {
            ...
            if (dialog.draft instanceof TL_draftMessage) {
                DataQuery.getInstance(this.currentAccount).saveDraft(dialog.f440id, dialog.draft, null, false);
            }
            this.dialogs_dict.put(j, dialog);
            MessageObject messageObject2 = (MessageObject) longSparseArray2.get(dialog.f440id);
            this.dialogMessage.put(j, messageObject2);
    ...
    private void migrateDialogs(int i, int i2, int i3, int i4, int i5, long j) {
        if (!this.migratingDialogs && i != -1) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getDialogs, new C3521-$$Lambda$MessagesController$tmAPAmyX_HLSBIR7TwEc-6LXn_I(this, i));
        }
    }

    public /* synthetic */ void lambda$migrateDialogs$126$MessagesController(int i, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0641-$$Lambda$MessagesController$N9vCK0oGVwwS8iSsLW2lhMHnKHI(this, (messages_Dialogs) tLObject, i));
            return;
        }
        AndroidUtilities.runOnUIThread(new C0650-$$Lambda$MessagesController$PNWG6_UzeZ94xJHGN3qJ4RNxOm0(this));
    }
        ...
        try {
            ...
            while (true) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    ...
                    stringBuilder.append(message2.f461id);
                    stringBuilder.append(str);
            ...
            if (BuildVars.LOGS_ENABLED) {
                ...
                stringBuilder2.append(message.f461id);
                stringBuilder2.append(str);
            ...
            if (messages_dialogs2.dialogs.size() >= 100) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("migrate stop due to not 100 dialogs");
                }
                for (i5 = 0; i5 < 2; i5++) {
            ...
            for (i3 = 0; i3 < messages_dialogs2.dialogs.size(); i3++) {
                ...
                stringBuilder3.append(dialog.f440id);
                longSparseArray.put(dialog.f440id, dialog);
            }
                    ...
                    if (dialog != null) {
                        ...
                        while (i3 < messages_dialogs2.messages.size()) {
                            ...
                            if (MessageObject.getDialogId(message3) == longValue) {
                                ...
                                i3--;
                                if (message3.f461id == dialog.top_message) {
                    ...
                    if (message5.date < max) {
                        if (i2 != i6) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                ...
                                FileLog.m27d(stringBuilder4.toString());
                            }
                            i3 = -1;
                        } else {
                            message4 = message;
                ...
                if (message4 != null) {
                    ...
                    if (message.date < max && i2 != -1) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            ...
                            FileLog.m27d(stringBuilder5.toString());
                        }
                        i4 = -1;
                    }
                } else {
            ...
            if (message.to_id.channel_id != 0) {
                ...
                for (i2 = 0; i2 < messages_dialogs2.chats.size(); i2++) {
                    ...
                    if (chat.f434id == UserConfig.getInstance(this.currentAccount).migrateOffsetChannelId) {
                ...
                for (i2 = 0; i2 < messages_dialogs2.chats.size(); i2++) {
                    chat = (Chat) messages_dialogs2.chats.get(i2);
                    if (chat.f434id == UserConfig.getInstance(this.currentAccount).migrateOffsetChatId) {
                        UserConfig.getInstance(this.currentAccount).migrateOffsetAccess = chat.access_hash;
                        break;
                    }
                }
                ...
                while (i5 < messages_dialogs2.users.size()) {
                    ...
                    if (user.f534id == UserConfig.getInstance(this.currentAccount).migrateOffsetUserId) {
            ...
            FileLog.m30e(e);
            AndroidUtilities.runOnUIThread(new C0706-$$Lambda$MessagesController$n72oPYeD0dDCBaP1ov8Q-eP6egE(this));
        }
    }
    ...
    public void processLoadedDialogs(messages_Dialogs messages_dialogs, ArrayList<EncryptedChat> arrayList, int i, int i2, int i3, int i4, boolean z, boolean z2, boolean z3) {
        Utilities.stageQueue.postRunnable(new C0716-$$Lambda$MessagesController$shj4tQAJ8i7NH8eiXBAGt48jDcs(this, i, i4, messages_dialogs, z, i3, arrayList, i2, z3, z2));
    }
        ...
        while (i5 < longSparseArray.size()) {
            ...
            if (!z || i6 == 0 || dialog.last_message_date >= i6) {
                ...
                if (dialog2 == null) {
                    ...
                    messageObject = (MessageObject) longSparseArray4.get(dialog.f440id);
                    ...
                    if ((messageObject == null || !messageObject.deleted) && messageObject != null && dialog2.top_message <= 0) {
                        i6 = i10;
                        obj = obj2;
                        messageObject2 = (MessageObject) longSparseArray4.get(dialog.f440id);
    ...
    public void reloadMentionsCountForChannels(ArrayList<Integer> arrayList) {
        AndroidUtilities.runOnUIThread(new C0665-$$Lambda$MessagesController$Wb5lXI806u6uYMpUfHZLtqjdAzg(this, arrayList));
    }
    ...
    public /* synthetic */ void lambda$reloadMentionsCountForChannels$132$MessagesController(ArrayList arrayList) {
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getUnreadMentions, new C3487-$$Lambda$MessagesController$XzymKbdqXufr7jm1iFFTz7X7ruw(this, j));
        }
    }

    public /* synthetic */ void lambda$null$131$MessagesController(long j, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0709-$$Lambda$MessagesController$pgmXc5wuX4vuUELeAuqKQqje9q8(this, tLObject, j));
    }
    ...
    public void processDialogsUpdateRead(LongSparseArray<Integer> longSparseArray, LongSparseArray<Integer> longSparseArray2) {
        AndroidUtilities.runOnUIThread(new C0672-$$Lambda$MessagesController$_YsSBCaL_qbcH96s3TWAMj3YbZI(this, longSparseArray, longSparseArray2));
    }
        ...
        if (longSparseArray2 != null) {
            for (i = 0; i < longSparseArray2.size(); i++) {
                ...
                if (dialog2 != null) {
                    ...
                    if (this.createdDialogMainThreadIds.contains(Long.valueOf(dialog2.f440id))) {
                        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.updateMentionsCount, Long.valueOf(dialog2.f440id), Integer.valueOf(dialog2.unread_mentions_count));
                    }
                }
            }
        }
                ...
                if (j == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            nativeByteBuffer.writeInt64(dialog.f440id);
                        ...
                        FileLog.m30e(e);
                        j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getHistory, new C3470-$$Lambda$MessagesController$LzTCLk4PcU0AIVN_3fmrcJA4k9I(this, i, dialog, j));
                    }
                    j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getHistory, new C3470-$$Lambda$MessagesController$LzTCLk4PcU0AIVN_3fmrcJA4k9I(this, i, dialog, j));
    ...
    public /* synthetic */ void lambda$checkLastDialogMessage$136$MessagesController(int i, Dialog dialog, long j, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            if (messages_messages.messages.isEmpty()) {
                AndroidUtilities.runOnUIThread(new C0598-$$Lambda$MessagesController$B2hd0oVj2x9ARog9ivfgDWOv-vg(this, dialog));
            } else {
                TL_messages_dialogs tL_messages_dialogs = new TL_messages_dialogs();
                Message message = (Message) messages_messages.messages.get(0);
                TL_dialog tL_dialog = new TL_dialog();
                tL_dialog.flags = dialog.flags;
                tL_dialog.top_message = message.f461id;
        ...
        AndroidUtilities.runOnUIThread(new C0663-$$Lambda$MessagesController$Vi0DJPkGrsNPy-GOeNVBnJWDwnE(this, i));
    }

    public /* synthetic */ void lambda$null$134$MessagesController(Dialog dialog) {
        Dialog dialog2 = (Dialog) this.dialogs_dict.get(dialog.f440id);
        if (dialog2 != null && dialog2.top_message == 0) {
            deleteDialog(dialog.f440id, 3);
        }
    }
    ...
    public void processDialogsUpdate(messages_Dialogs messages_dialogs, ArrayList<EncryptedChat> arrayList) {
        Utilities.stageQueue.postRunnable(new C0710-$$Lambda$MessagesController$q64E9hWX3Xly3JADViQSa2zMJVo(this, messages_dialogs));
    }
    ...
    public /* synthetic */ void lambda$processDialogsUpdate$138$MessagesController(messages_Dialogs messages_dialogs) {
        ...
        for (i = 0; i < messages_dialogs2.chats.size(); i++) {
            ...
            sparseArray2.put(chat2.f434id, chat2);
        }
        int i3 = 0;
        while (true) {
            j = 0;
        ...
        while (i2 < messages_dialogs2.dialogs.size()) {
            ...
            if (j3 == j || j3 != dialog.f440id) {
                if (DialogObject.isChannel(dialog)) {
                    chat = (Chat) sparseArray2.get(-((int) dialog.f440id));
                    if (chat != null && chat.left) {
                        i2++;
                        j = 0;
                    }
                } else {
                    long j4 = dialog.f440id;
                    if (((int) j4) < 0) {
            ...
            if (dialog.last_message_date == 0) {
                messageObject = (MessageObject) longSparseArray2.get(dialog.f440id);
                if (messageObject != null) {
                    dialog.last_message_date = messageObject.messageOwner.date;
                }
            }
            longSparseArray.put(dialog.f440id, dialog);
            longSparseArray3.put(dialog.f440id, Integer.valueOf(dialog.unread_count));
            Integer num = (Integer) this.dialogs_read_inbox_max.get(Long.valueOf(dialog.f440id));
            if (num == null) {
                num = valueOf;
            }
            this.dialogs_read_inbox_max.put(Long.valueOf(dialog.f440id), Integer.valueOf(Math.max(num.intValue(), dialog.read_inbox_max_id)));
            num = (Integer) this.dialogs_read_outbox_max.get(Long.valueOf(dialog.f440id));
            if (num == null) {
                num = valueOf;
            }
            this.dialogs_read_outbox_max.put(Long.valueOf(dialog.f440id), Integer.valueOf(Math.max(num.intValue(), dialog.read_outbox_max_id)));
            i2++;
            j = 0;
        }
        AndroidUtilities.runOnUIThread(new C0708-$$Lambda$MessagesController$oWzxev3PBWOpBqcrFUkL5QjXPQo(this, messages_dialogs, longSparseArray, longSparseArray2, longSparseArray3));
    }
    ...
    public /* synthetic */ void lambda$null$137$MessagesController(messages_Dialogs messages_dialogs, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, LongSparseArray longSparseArray3) {
        ...
        for (int i = 0; i < longSparseArray.size(); i++) {
            ...
            if (dialog2 == null) {
                ...
                this.dialogs_dict.put(keyAt, dialog);
                MessageObject messageObject = (MessageObject) longSparseArray5.get(dialog.f440id);
                this.dialogMessage.put(keyAt, messageObject);
                if (messageObject != null && messageObject.messageOwner.to_id.channel_id == 0) {
                    this.dialogMessagesByIds.put(messageObject.getId(), messageObject);
                ...
                if (messageObject2 != null && dialog2.top_message <= 0) {
                    MessageObject messageObject3 = (MessageObject) longSparseArray5.get(dialog.f440id);
                    ...
                    long j3;
                    this.dialogs_dict.put(keyAt, dialog);
                    MessageObject messageObject4 = (MessageObject) longSparseArray5.get(dialog.f440id);
    ...
    public void addToViewsQueue(MessageObject messageObject) {
        Utilities.stageQueue.postRunnable(new C0679-$$Lambda$MessagesController$cWol_41rOBrStFY3FKcjDkmBodE(this, messageObject));
    }
    ...
    public void markMessageContentAsRead(MessageObject messageObject) {
        ...
        if (messageObject.getId() < 0) {
            ...
            if (tL_channels_readMessageContents.channel != null) {
                tL_channels_readMessageContents.f476id.add(Integer.valueOf(messageObject.getId()));
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_readMessageContents, C3464-$$Lambda$MessagesController$GZZLBgVSubugJqEDeBHWQk3eSTE.INSTANCE);
            }
        } else {
            TL_messages_readMessageContents tL_messages_readMessageContents = new TL_messages_readMessageContents();
            tL_messages_readMessageContents.f509id.add(Integer.valueOf(messageObject.getId()));
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_readMessageContents, new C3502-$$Lambda$MessagesController$gAx8uSIsyHdT1Tx6VIiWEu0UYbQ(this));
        }
    }
    ...
    public void markMentionMessageAsRead(int i, int i2, long j) {
        ...
        if (i2 != 0) {
            ...
            if (tL_channels_readMessageContents.channel != null) {
                tL_channels_readMessageContents.f476id.add(Integer.valueOf(i));
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_readMessageContents, C3458-$$Lambda$MessagesController$APiRxvKDu_B4Za4CATjRgQ8eiYM.INSTANCE);
            } else {
                return;
            }
        }
        TL_messages_readMessageContents tL_messages_readMessageContents = new TL_messages_readMessageContents();
        tL_messages_readMessageContents.f509id.add(Integer.valueOf(i));
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_readMessageContents, new C3466-$$Lambda$MessagesController$HGjYxt4hoLR6qJGd10EuSLrAkII(this));
    }
            ...
            if (((int) j) == 0) {
                ...
                if (encryptedChat != null) {
                    ...
                    if (i > 0) {
                        ...
                        MessagesStorage.getInstance(this.currentAccount).createTaskForSecretChat(encryptedChat.f445id, currentTime, currentTime, 0, arrayList);
                    }
                }
            }
        }
    ...
    private void completeReadTask(ReadTask readTask) {
        ...
        if (i != 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_readHistory, new C3501-$$Lambda$MessagesController$f6Fg5cePsPVR4IQG1UUiIG6Ywco(this));
            return;
        }
        EncryptedChat encryptedChat = getEncryptedChat(Integer.valueOf(i2));
        byte[] bArr = encryptedChat.auth_key;
        if (bArr != null && bArr.length > 1 && (encryptedChat instanceof TL_encryptedChat)) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_readEncryptedHistory, C3511-$$Lambda$MessagesController$mkj69nAVhIC1gtqhKztic36PgeU.INSTANCE);
        }
    }
    ...
    public void markDialogAsReadNow(long j) {
        Utilities.stageQueue.postRunnable(new C0590-$$Lambda$MessagesController$5qY48mZcpUp58ZVQMwppSQnDlKQ(this, j));
    }
    ...
    public void markMentionsAsRead(long j) {
        ...
        if (i != 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_readMentions, C3498-$$Lambda$MessagesController$eUPv0EVHJrau5dp5Vk20Bf_j8L4.INSTANCE);
        }
    }
    ...
    public /* synthetic */ void lambda$markDialogAsRead$151$MessagesController(long j, int i, int i2, boolean z, boolean z2) {
        AndroidUtilities.runOnUIThread(new C0652-$$Lambda$MessagesController$QJU8iYKsFf9hbJ-ao3ktQ9SZw_c(this, j, i, i2, z, z2));
    }
    ...
    public /* synthetic */ void lambda$null$150$MessagesController(long j, int i, int i2, boolean z, boolean z2) {
        ...
        if (dialog != null) {
            ...
            if (i4 != 0) {
                ...
                if (dialog2 != null) {
                    if (z) {
                        if (isDialogMuted(dialog.f440id)) {
            ...
            if (dialog.unread_mark) {
                ...
                MessagesStorage.getInstance(this.currentAccount).setDialogUnread(dialog.f440id, false);
            }
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.updateInterfaces, Integer.valueOf(256));
        }
    ...
    public /* synthetic */ void lambda$markDialogAsRead$153$MessagesController(long j, int i, boolean z, int i2, int i3, boolean z2) {
        AndroidUtilities.runOnUIThread(new C0589-$$Lambda$MessagesController$3aeD82p4JOknKdKlPd_JqRJlTgE(this, j, i, z, i2, i3, z2));
    }
    ...
    public int createChat(String str, ArrayList<Integer> arrayList, String str2, int i, BaseFragment baseFragment) {
        ...
        if (i == 1) {
            ...
            tL_chat.f434id = UserConfig.getInstance(this.currentAccount).lastBroadcastId;
            tL_chat.title = str;
            ...
            tL_chatFull.f435id = tL_chat.f434id;
            ...
            chatParticipants.chat_id = tL_chat.f434id;
            ...
            tL_messageService.dialog_id = AndroidUtilities.makeBroadcastId(tL_chat.f434id);
            tL_messageService.to_id = new TL_peerChat();
            tL_messageService.to_id.chat_id = tL_chat.f434id;
            ...
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.chatDidCreated, Integer.valueOf(tL_chat.f434id));
            return 0;
        } else if (i == 0) {
            ...
            return ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_createChat, new C3461-$$Lambda$MessagesController$BwCRJLOHKlBHZCobPU1cBtbarBc(this, baseFragment, tL_messages_createChat), 2);
        } else if (i != 2 && i != 4) {
            return 0;
        } else {
            ...
            return ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_createChannel, new C3435-$$Lambda$MessagesController$0bxY0b0iZuUAKIyUkrQ28a0391w(this, baseFragment, tL_channels_createChannel), 2);
        }
    }
    ...
    public /* synthetic */ void lambda$createChat$157$MessagesController(BaseFragment baseFragment, TL_messages_createChat tL_messages_createChat, TLObject tLObject, TL_error tL_error) {
        if (tL_error != null) {
            AndroidUtilities.runOnUIThread(new C0666-$$Lambda$MessagesController$WsumHWD0PnGJZt7IOqYp5KdvEJ0(this, tL_error, baseFragment, tL_messages_createChat));
            return;
        }
        Updates updates = (Updates) tLObject;
        processUpdates(updates, false);
        AndroidUtilities.runOnUIThread(new C0682-$$Lambda$MessagesController$eAZO9_fJVDn41rVP_qwqU45S3MA(this, updates));
    }
    ...
    public /* synthetic */ void lambda$null$156$MessagesController(Updates updates) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.chatDidCreated, Integer.valueOf(((Chat) updates.chats.get(0)).f434id));
    }
    ...
    public /* synthetic */ void lambda$createChat$160$MessagesController(BaseFragment baseFragment, TL_channels_createChannel tL_channels_createChannel, TLObject tLObject, TL_error tL_error) {
        if (tL_error != null) {
            AndroidUtilities.runOnUIThread(new C0583-$$Lambda$MessagesController$1QEtWqNTIuN7FfcY0dyqyX9a0nc(this, tL_error, baseFragment, tL_channels_createChannel));
            return;
        }
        Updates updates = (Updates) tLObject;
        processUpdates(updates, false);
        AndroidUtilities.runOnUIThread(new C0728-$$Lambda$MessagesController$wCKcwOawGryKMm_2e04hmPYVRmA(this, updates));
    }
    ...
    public void convertToMegaGroup(Context context, int i, IntCallback intCallback) {
        ...
        alertDialog.setOnCancelListener(new C0654-$$Lambda$MessagesController$SIGUP1wZNKHgQo2aKPuAgpDjucg(this, ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_migrateChat, new C3462-$$Lambda$MessagesController$EkRPBwXKrGufP9yBw39xD6g-xjo(this, context, alertDialog, intCallback))));
        try {
            alertDialog.show();
        } catch (Exception unused) {
        }
    ...
    public /* synthetic */ void lambda$convertToMegaGroup$164$MessagesController(Context context, AlertDialog alertDialog, IntCallback intCallback, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            AndroidUtilities.runOnUIThread(new C0635-$$Lambda$MessagesController$LMu-cf6mwPFEIl5BHsSN1A4tDck(context, alertDialog));
            Updates updates = (Updates) tLObject;
            processUpdates(updates, false);
            AndroidUtilities.runOnUIThread(new C0680-$$Lambda$MessagesController$ccOtwUqv0B2ZPbEC4t1iqZYvu2U(intCallback, updates));
            return;
        }
        AndroidUtilities.runOnUIThread(new C0577-$$Lambda$MessagesController$04Zo7VbxddrCSSpeIC1emxiw6QE(context, alertDialog));
    }
    ...
    static /* synthetic */ void lambda$null$163(Context context, AlertDialog alertDialog) {
        if (!((Activity) context).isFinishing()) {
            ...
            builder.setMessage(LocaleController.getString("ErrorOccurred", C1067R.string.ErrorOccurred));
    ...
    public void addUsersToChannel(int i, ArrayList<InputUser> arrayList, BaseFragment baseFragment) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_inviteToChannel, new C3480-$$Lambda$MessagesController$TfiNuUXCjyH-kDhosYCjp7Cg5Gk(this, baseFragment, tL_channels_inviteToChannel));
        }
    }
    ...
    public /* synthetic */ void lambda$addUsersToChannel$167$MessagesController(BaseFragment baseFragment, TL_channels_inviteToChannel tL_channels_inviteToChannel, TLObject tLObject, TL_error tL_error) {
        if (tL_error != null) {
            AndroidUtilities.runOnUIThread(new C0631-$$Lambda$MessagesController$JvtxNBYrSDi77SdNL-OBKU4hIZo(this, tL_error, baseFragment, tL_channels_inviteToChannel));
        } else {
            processUpdates((Updates) tLObject, false);
        }
    }
    ...
    public void toogleChannelSignatures(int i, boolean z) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_toggleSignatures, new C3492-$$Lambda$MessagesController$aeXtWX5NT1IBK6iBhloNZ1bs-M4(this), 64);
    }

    public /* synthetic */ void lambda$toogleChannelSignatures$169$MessagesController(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            processUpdates((Updates) tLObject, false);
            AndroidUtilities.runOnUIThread(new C0588-$$Lambda$MessagesController$3BIrPkpsnU56wDIO-4y6LdEZG1o(this));
        }
    }
    ...
    public void toogleChannelInvitesHistory(int i, boolean z) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_togglePreHistoryHidden, new C3489-$$Lambda$MessagesController$YebMv5xtYdxqizkIFhqWdfrEUcI(this), 64);
    }

    public /* synthetic */ void lambda$toogleChannelInvitesHistory$171$MessagesController(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            processUpdates((Updates) tLObject, false);
            AndroidUtilities.runOnUIThread(new C0640-$$Lambda$MessagesController$MQt495ngo0PePemjE4vQFdgondE(this));
        }
    }
    ...
    public void updateChatAbout(int i, String str, ChatFull chatFull) {
        if (chatFull != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editChatAbout, new C3449-$$Lambda$MessagesController$7X_q4bvD4zimEhOUjsZ_PwkItoo(this, chatFull, str), 64);
        }
    }
    ...
    public /* synthetic */ void lambda$updateChatAbout$173$MessagesController(ChatFull chatFull, String str, TLObject tLObject, TL_error tL_error) {
        if (tLObject instanceof TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new C0623-$$Lambda$MessagesController$HY_Xxx1aYrQjlxZz1_f8hnkFqxY(this, chatFull, str));
        }
    }
    ...
    public void updateChannelUserName(int i, String str) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_updateUsername, new C3471-$$Lambda$MessagesController$Ov1XVh0U9G1mRr1zQgjy3_Hz5dQ(this, i, str), 64);
    }
    ...
    public /* synthetic */ void lambda$updateChannelUserName$175$MessagesController(int i, String str, TLObject tLObject, TL_error tL_error) {
        if (tLObject instanceof TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new C0674-$$Lambda$MessagesController$a0Xdl6BGzzSwlj898G_QllCxUyU(this, i, str));
        }
    }
    ...
    public void sendBotStart(User user, String str) {
        if (user != null) {
            ...
            tL_messages_startBot.peer = getInputPeer(user.f534id);
            tL_messages_startBot.start_param = str;
            tL_messages_startBot.random_id = Utilities.random.nextLong();
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_startBot, new C3497-$$Lambda$MessagesController$dxMathd1bP5-uSwd4Gt7ZvEOFtw(this));
        }
    }
    ...
    public void addUserToChat(int i, User user, ChatFull chatFull, int i2, String str, BaseFragment baseFragment, Runnable runnable) {
        ...
        if (user2 != null) {
            if (i3 > 0) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new C3505-$$Lambda$MessagesController$h5a2RdtziFUaSy5oo3g6ZX4SUu4(this, isChannel, inputUser, i, baseFragment, tLObject, z, runnable));
            } else if (chatFull2 instanceof TL_chatFull) {
                int i4 = 0;
                while (i4 < chatFull2.participants.participants.size()) {
                    if (((ChatParticipant) chatFull2.participants.participants.get(i4)).user_id != user2.f534id) {
                        i4++;
                    } else {
                        return;
                    }
                ...
                MessagesStorage.getInstance(this.currentAccount).putUsersAndChats(null, arrayList, true, true);
                TL_chatParticipant tL_chatParticipant = new TL_chatParticipant();
                tL_chatParticipant.user_id = user2.f534id;
                tL_chatParticipant.inviter_id = UserConfig.getInstance(this.currentAccount).getClientUserId();
    ...
    public /* synthetic */ void lambda$addUserToChat$180$MessagesController(boolean z, InputUser inputUser, int i, BaseFragment baseFragment, TLObject tLObject, boolean z2, Runnable runnable, TLObject tLObject2, TL_error tL_error) {
        ...
        if (z && (inputUser2 instanceof TL_inputUserSelf)) {
            AndroidUtilities.runOnUIThread(new C0689-$$Lambda$MessagesController$gHAV7k8HUui7jwavTT5ub-YwyHk(this, i));
        }
        if (tL_error != null) {
            AndroidUtilities.runOnUIThread(new C0616-$$Lambda$MessagesController$FzKpDwgMKXFwcQpN6PW-r4fPJ0A(this, tL_error, baseFragment, tLObject, z, z2, inputUser));
            return;
        }
        Object obj;
        ...
        if (z) {
            ...
            AndroidUtilities.runOnUIThread(new C0594-$$Lambda$MessagesController$8h8cgPEI6kzZTDRtvYPddJzervw(this, i), 1000);
        }
        if (z && (inputUser2 instanceof TL_inputUserSelf)) {
    ...
    public void deleteUserFromChat(int i, User user, ChatFull chatFull, boolean z, boolean z2) {
        if (user != null) {
            if (i > 0) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_deleteChatUser, new C3467-$$Lambda$MessagesController$IE4i2TewkP8XTc8wTYcnuzt-GP0(this, isChannel, inputUser, i), 64);
                ...
                for (i = 0; i < chatFull.participants.participants.size(); i++) {
                    if (((ChatParticipant) chatFull.participants.participants.get(i)).user_id == user.f534id) {
    ...
    public /* synthetic */ void lambda$deleteUserFromChat$182$MessagesController(boolean z, InputUser inputUser, int i, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            processUpdates((Updates) tLObject, false);
            if (z && !(inputUser instanceof TL_inputUserSelf)) {
                AndroidUtilities.runOnUIThread(new C0733-$$Lambda$MessagesController$xTU7cEe4T3HaWaI7TTVa9Ed-zvk(this, i), 1000);
            }
        }
    }
    ...
    public void changeChatTitle(int i, String str) {
        if (i > 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_editTitle, new C3440-$$Lambda$MessagesController$40Sp7FeVOZVQXMLSFubFHF48OI8(this), 64);
            return;
        }
        Chat chat = getChat(Integer.valueOf(i));
        chat.title = str;
    ...
    public void changeChatAvatar(int i, InputFile inputFile, FileLocation fileLocation, FileLocation fileLocation2) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_editPhoto, new C3525-$$Lambda$MessagesController$xhFZ44TZl-2-TmtDUCclv1zCK1g(this, fileLocation, fileLocation2), 64);
    }
    ...
    public void unregistedPush() {
        if (UserConfig.getInstance(this.currentAccount).registeredForPush && SharedConfig.pushString.length() == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_unregisterDevice, C3451-$$Lambda$MessagesController$8PliyHoMopJhuU4eiI2hN2lPvKs.INSTANCE);
        }
    }
    ...
    public void performLogout(int i) {
        ...
        if (i == 1) {
            unregistedPush();
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_auth_logOut(), new C3507-$$Lambda$MessagesController$iSBguIqFt9uYneQ2bb0JRjCTxlQ(this));
        } else {
            ConnectionsManager instance = ConnectionsManager.getInstance(this.currentAccount);
            if (i != 2) {
                z = false;
    ...
    public void generateUpdateMessage() {
        if (!BuildVars.DEBUG_VERSION) {
            ...
            if (str != null && !str.equals(BuildVars.BUILD_VERSION_STRING)) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_help_getAppChangelog, new C3468-$$Lambda$MessagesController$IayzOkIFtocnVFRbLM-8qmLr-wI(this));
            }
        }
    }
    ...
    public void registerForPush(String str) {
        if (!TextUtils.isEmpty(str) && !this.registeringForPush && UserConfig.getInstance(this.currentAccount).getClientUserId() != 0 && (!UserConfig.getInstance(this.currentAccount).registeredForPush || !str.equals(SharedConfig.pushString))) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_registerDevice, new C3475-$$Lambda$MessagesController$RQIUdGcrH5D0HSeyADRBCxVETRg(this, str));
        }
    }
    ...
    public /* synthetic */ void lambda$registerForPush$189$MessagesController(String str, TLObject tLObject, TL_error tL_error) {
        ...
        AndroidUtilities.runOnUIThread(new C0656-$$Lambda$MessagesController$SwAlAjR_w1esOUP73MiMXDofIVc(this));
    }
    ...
    public void loadCurrentState() {
        if (!this.updatingState) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_updates_getState(), new C3494-$$Lambda$MessagesController$cVyFjAxO3BTy-3AQHVKKSH7bs_0(this));
        }
    }
    ...
    private void processChannelsUpdatesQueue(int i, int i2) {
        ...
        if (arrayList != null) {
            ...
            StringBuilder stringBuilder;
            Collections.sort(arrayList, C0627-$$Lambda$MessagesController$JGJclbw8cDS2wcbI-Tj2zlng-g0.INSTANCE);
            if (i2 == 2) {
    ...
    private void processUpdatesQueue(int i, int i2) {
        ...
        if (i == 0) {
            ...
            Collections.sort(arrayList, new C0670-$$Lambda$MessagesController$ZJInZNgn5fe5N3COP4HchbUkZ4o(this));
        } else if (i == 1) {
            arrayList = this.updatesQueuePts;
            Collections.sort(arrayList, C0605-$$Lambda$MessagesController$CXfuZJPIy1bgOC7pFoaz-w6qqDM.INSTANCE);
        } else if (i == 2) {
            arrayList = this.updatesQueueQts;
            Collections.sort(arrayList, C0607-$$Lambda$MessagesController$CpLCaAXrUWrrraDtT2_grVns0kE.INSTANCE);
        } else {
            arrayList = null;
        }
        if (!(arrayList == null || arrayList.isEmpty())) {
            ...
            while (arrayList.size() > 0) {
                ...
                if (isValidUpdate == 0) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m27d("HOLE IN UPDATES QUEUE - getDifference");
                    }
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m27d("HOLE IN UPDATES QUEUE - will wait more time");
                    }
                    if (obj != null) {
            ...
            arrayList.clear();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("UPDATES QUEUE PROCEED - OK");
            }
        }
        setUpdatesStartTime(i, 0);
    }
    ...
    public void loadUnknownChannel(Chat chat, long j) {
        Throwable e;
        if ((chat instanceof TL_channel) && this.gettingUnknownChannels.indexOfKey(chat.f434id) < 0) {
            ...
            if (j == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        FileLog.m30e(e);
                        j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPeerDialogs, new C3504-$$Lambda$MessagesController$gfG4ToHa5Z2rjZdIfshLWaUs_Ms(this, j, chat));
                    }
                } catch (Exception e3) {
                    e = e3;
                    FileLog.m30e(e);
    ...
    public /* synthetic */ void lambda$loadUnknownChannel$195$MessagesController(long j, Chat chat, TLObject tLObject, TL_error tL_error) {
        ...
        this.gettingUnknownChannels.delete(chat.f434id);
    }

    public void startShortPoll(Chat chat, boolean z) {
        Utilities.stageQueue.postRunnable(new C0606-$$Lambda$MessagesController$ChpY-h3KplD8DdHCKUKN4FRi5P8(this, z, chat));
    }

    public /* synthetic */ void lambda$startShortPoll$196$MessagesController(boolean z, Chat chat) {
        if (z) {
            this.needShortPollChannels.delete(chat.f434id);
            if (chat.megagroup) {
                this.needShortPollOnlines.delete(chat.f434id);
                return;
            }
            return;
        }
        this.needShortPollChannels.put(chat.f434id, 0);
        if (this.shortPollChannels.indexOfKey(chat.f434id) < 0) {
            getChannelDifference(chat.f434id, 3, 0, null);
        }
        if (chat.megagroup) {
            this.needShortPollOnlines.put(chat.f434id, 0);
            if (this.shortPollOnlines.indexOfKey(chat.f434id) < 0) {
                this.shortPollOnlines.put(chat.f434id, 0);
            }
        }
    }
    ...
    L_0x0012:
        ...
        if (r1 == r0) goto L_0x0099;
    L_0x0017:
        r0 = 4244000; // 0x40c220 float:5.94711E-39 double:2.0968146E-317;
        if (r1 == r0) goto L_0x0099;
    L_0x001c:
        r0 = 4245000; // 0x40c608 float:5.948512E-39 double:2.0973087E-317;
        if (r1 == r0) goto L_0x0099;
    L_0x0021:
    ...
    L_0x0030:
        ...
        if (r1 == r0) goto L_0x0099;
    L_0x0035:
        r0 = 431415000; // 0x19b6ded8 float:1.8908365E-23 double:2.131473306E-315;
        if (r1 == r0) goto L_0x0099;
    L_0x003a:
        r0 = 434000; // 0x69f50 float:6.08164E-40 double:2.144245E-318;
        if (r1 == r0) goto L_0x0099;
    L_0x003f:
    ...
    L_0x005d:
        ...
        if (r1 == r0) goto L_0x0099;
    L_0x0062:
        r0 = 455000; // 0x6f158 float:6.37591E-40 double:2.248E-318;
        if (r1 == r0) goto L_0x0099;
    L_0x0067:
    ...
    L_0x006c:
        ...
        if (r1 == r0) goto L_0x0099;
    L_0x0071:
        r0 = 479000; // 0x74f18 float:6.71222E-40 double:2.366574E-318;
        if (r1 == r0) goto L_0x0099;
    L_0x0076:
        r0 = 796000; // 0xc2560 float:1.115434E-39 double:3.932763E-318;
        if (r1 == r0) goto L_0x0099;
    L_0x007b:
    ...
    public /* synthetic */ void lambda$getChannelDifference$205$MessagesController(int i, int i2, long j, TLObject tLObject, TL_error tL_error) {
        ...
        if (tLObject != null) {
            ...
            AndroidUtilities.runOnUIThread(new C0586-$$Lambda$MessagesController$28A9t6uw6zcK-zdsc5pJbUtacP4(this, updates_channeldifference));
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0701-$$Lambda$MessagesController$lCXOkGLPvyvcFRmbZ7785J1HE74(this, arrayList, i, updates_channeldifference, chat, sparseArray, i2, j));
        } else if (tL_error2 != null) {
            AndroidUtilities.runOnUIThread(new C0734-$$Lambda$MessagesController$xuR4Dv4llnFxbNDnZ9xFUOdZuww(this, tL_error2, i));
    ...
    public /* synthetic */ void lambda$null$203$MessagesController(ArrayList arrayList, int i, updates_ChannelDifference updates_channeldifference, Chat chat, SparseArray sparseArray, int i2, long j) {
        if (!arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                long[] updateMessageStateAndId = MessagesStorage.getInstance(this.currentAccount).updateMessageStateAndId(tL_updateMessageID.random_id, null, tL_updateMessageID.f567id, 0, false, i);
                if (updateMessageStateAndId != null) {
                    sparseArray2.put(tL_updateMessageID.f567id, updateMessageStateAndId);
                }
            }
            if (sparseArray2.size() != 0) {
                AndroidUtilities.runOnUIThread(new C0700-$$Lambda$MessagesController$knZtwzjIKj6DQF9JLJKyqk4QKIg(this, sparseArray2));
            }
        }
        Utilities.stageQueue.postRunnable(new C0722-$$Lambda$MessagesController$vDE_ZP4HWcci4r3xUMBi6xf1Wh0(this, updates_channeldifference, i, chat, sparseArray, i2, j));
    }
    ...
    public /* synthetic */ void lambda$null$201$MessagesController(ArrayList arrayList, updates_ChannelDifference updates_channeldifference) {
        if (!arrayList.isEmpty()) {
            AndroidUtilities.runOnUIThread(new C0600-$$Lambda$MessagesController$BmJZ4Zdfo6BIVJxBYMn2TEeaaC0(this, arrayList));
        }
    ...
    private void checkChannelError(java.lang.String r6, int r7) {
        ...
        r5 = this;
        r0 = r6.hashCode();
        r1 = -1809401834; // 0xffffffff9426b816 float:-8.417163E-27 double:NaN;
        r2 = 0;
        r3 = 2;
        r4 = 1;
        if (r0 == r1) goto L_0x002b;
    L_0x000c:
        r1 = -795226617; // 0xffffffffd099ce07 float:-2.064333E10 double:NaN;
        if (r0 == r1) goto L_0x0021;
    L_0x0011:
        r1 = -471086771; // 0xffffffffe3ebc94d float:-8.69898E21 double:NaN;
    ...
    public void getDifference(int i, int i2, int i3, boolean z) {
        ...
        if (MessagesStorage.getInstance(this.currentAccount).getLastPtsValue() == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_updates_getDifference, new C3481-$$Lambda$MessagesController$TiSv3h40ZHze2ul5Mr-eNiZvHcc(this, i2, i3));
        }
    }
    ...
    public /* synthetic */ void lambda$getDifference$214$MessagesController(int i, int i2, TLObject tLObject, TL_error tL_error) {
        ...
        if (tL_error == null) {
            ...
            if (updates_difference instanceof TL_updates_differenceTooLong) {
                AndroidUtilities.runOnUIThread(new C0657-$$Lambda$MessagesController$T4klBi4vmBoUx4jRc3cN4SM0ygE(this, updates_difference, i, i2));
                return;
            }
            ...
            AndroidUtilities.runOnUIThread(new C0718-$$Lambda$MessagesController$uHgsA63Vu83OxWhkgJ5VeBJ4ndU(this, updates_difference));
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0597-$$Lambda$MessagesController$ACN99JV2xbYO8r_lQdJPW0MPsd4(this, updates_difference, arrayList, sparseArray, sparseArray2));
            return;
        }
        this.gettingDifference = false;
        ConnectionsManager.getInstance(this.currentAccount).setIsUpdating(false);
    ...
    public /* synthetic */ void lambda$null$213$MessagesController(updates_Difference updates_difference, ArrayList arrayList, SparseArray sparseArray, SparseArray sparseArray2) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (i < arrayList.size()) {
                ...
                long[] updateMessageStateAndId = MessagesStorage.getInstance(this.currentAccount).updateMessageStateAndId(tL_updateMessageID.random_id, null, tL_updateMessageID.f567id, 0, false, 0);
                if (updateMessageStateAndId != null) {
                    sparseArray3.put(tL_updateMessageID.f567id, updateMessageStateAndId);
                }
                i++;
            }
            if (sparseArray3.size() != 0) {
                AndroidUtilities.runOnUIThread(new C0625-$$Lambda$MessagesController$ITmJA6kLHBukKSXRGmYt1a3rPug(this, sparseArray3));
            }
        }
        Utilities.stageQueue.postRunnable(new C0613-$$Lambda$MessagesController$Ey750lTvkjqFS34n7sagq8Medx8(this, updates_difference2, sparseArray, sparseArray2));
    }
    ...
    public /* synthetic */ void lambda$null$212$MessagesController(updates_Difference updates_difference, SparseArray sparseArray, SparseArray sparseArray2) {
        ...
        if (!(updates_difference2.new_messages.isEmpty() && updates_difference2.new_encrypted_messages.isEmpty())) {
            ...
            for (int i3 = 0; i3 < updates_difference2.new_messages.size(); i3++) {
                ...
                if (((int) message.dialog_id) != 0) {
                    ...
                    if ((messageAction instanceof TL_messageActionChatMigrateTo) || (messageAction instanceof TL_messageActionChannelCreate)) {
                        ...
                        message.unread = num.intValue() < message.f461id;
                    }
                } else {
                    sparseArray3 = sparseArray;
                }
            ...
            AndroidUtilities.runOnUIThread(new C0593-$$Lambda$MessagesController$7U_DZAtefOGyLnbtJ_TzAYloz70(this, longSparseArray));
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0604-$$Lambda$MessagesController$CTc5p-O22dGYncyM4gxumAZNVws(this, arrayList, updates_difference2));
    ...
    public /* synthetic */ void lambda$null$211$MessagesController(ArrayList arrayList, updates_Difference updates_difference) {
        if (!arrayList.isEmpty()) {
            AndroidUtilities.runOnUIThread(new C0684-$$Lambda$MessagesController$ecwYtn1RRyD-7_xCcWPT8y9SkzY(this, arrayList, updates_difference));
        }
            ...
            if (!(inputPeer instanceof TL_inputPeerEmpty)) {
                ...
                if (j2 == 0) {
                    ...
                    try {
                        ...
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_markDialogUnread, new C3523-$$Lambda$MessagesController$vdUYw660VQTUH5B-NPbzLsGZ09M(this, j2));
                    }
                    j2 = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                }
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_markDialogUnread, new C3523-$$Lambda$MessagesController$vdUYw660VQTUH5B-NPbzLsGZ09M(this, j2));
    ...
    public void loadUnreadDialogs() {
        if (!this.loadingUnreadDialogs && !UserConfig.getInstance(this.currentAccount).unreadDialogsLoaded) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_messages_getDialogUnreadMarks(), new C3456-$$Lambda$MessagesController$A7Jim0c_hwW7n1Xp7g9CGcD85b0(this));
        }
    }

    public /* synthetic */ void lambda$loadUnreadDialogs$217$MessagesController(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0609-$$Lambda$MessagesController$DRgtzkEskOqTf7dqRkfnjux7IBI(this, tLObject));
    }
            ...
            if (!dialogs.isEmpty()) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (!(dialog instanceof TL_dialogFolder)) {
                        ...
                        MessagesStorage.getInstance(this.currentAccount).setDialogPinned(dialog.f440id, dialog.pinnedNum);
                        if (((int) dialog.f440id) != 0) {
                            InputPeer inputPeer = getInputPeer((int) ((Dialog) dialogs.get(i3)).f440id);
                            TL_inputDialogPeer tL_inputDialogPeer = new TL_inputDialogPeer();
                            tL_inputDialogPeer.peer = inputPeer;
                ...
                try {
                    ...
                    try {
                        ...
                        FileLog.m30e(e);
                        j = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_reorderPinnedDialogs, new C3506-$$Lambda$MessagesController$iDjQfJMpGMx6ueasQejBNbv1luw(this, j));
                    }
                } catch (Exception e3) {
                    e = e3;
                    nativeByteBuffer = null;
        ...
        if (!(i == 0 || j2 == -1)) {
            ...
            if (j2 == 0) {
                ...
                try {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_toggleDialogPin, new C3478-$$Lambda$MessagesController$T-HrG7SvNN3seY_Zr_dkkRoKYHQ(this, createPendingTask));
    ...
    public void loadPinnedDialogs(int i, long j, ArrayList<Long> arrayList) {
        if (this.loadingPinnedDialogs.indexOfKey(i) < 0 && !UserConfig.getInstance(this.currentAccount).isPinnedDialogsLoaded(i)) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getPinnedDialogs, new C3446-$$Lambda$MessagesController$5ms5SUOMLniJAFeiQgpTUwbDtSY(this, i));
        }
    }
    ...
    public /* synthetic */ void lambda$loadPinnedDialogs$222$MessagesController(int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            for (i3 = 0; i3 < size; i3++) {
                ...
                Chat chat2;
                if (DialogObject.isChannel(dialog)) {
                    chat2 = (Chat) sparseArray2.get(-((int) dialog.f440id));
                ...
                if (dialog.last_message_date == 0) {
                    MessageObject messageObject2 = (MessageObject) longSparseArray.get(dialog.f440id);
                    if (messageObject2 != null) {
            ...
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0587-$$Lambda$MessagesController$2xwawfxy77A7uYEfX2S3k-suXFE(this, i, arrayList, z, tL_messages_peerDialogs, longSparseArray, tL_messages_dialogs));
        }
    }
    ...
    public /* synthetic */ void lambda$null$221$MessagesController(int i, ArrayList arrayList, boolean z, TL_messages_peerDialogs tL_messages_peerDialogs, LongSparseArray longSparseArray, TL_messages_dialogs tL_messages_dialogs) {
        AndroidUtilities.runOnUIThread(new C0636-$$Lambda$MessagesController$LYiV_HiXwANpNMOPEqVG43Un0Dg(this, i, arrayList, z, tL_messages_peerDialogs, longSparseArray, tL_messages_dialogs));
    }
    ...
    public /* synthetic */ void lambda$null$220$MessagesController(int i, ArrayList arrayList, boolean z, TL_messages_peerDialogs tL_messages_peerDialogs, LongSparseArray longSparseArray, TL_messages_dialogs tL_messages_dialogs) {
        ...
        if (arrayList.isEmpty()) {
            ...
            while (i2 < size) {
                ...
                dialogs.add(Long.valueOf(dialog2.f440id));
                dialog = (Dialog) this.dialogs_dict.get(dialog2.f440id);
                if (dialog != null) {
                    dialog.pinned = true;
                    dialog.pinnedNum = dialog2.pinnedNum;
                    MessagesStorage.getInstance(this.currentAccount).setDialogPinned(dialog2.f440id, dialog2.pinnedNum);
                    LongSparseArray longSparseArray2 = longSparseArray;
                } else {
                    this.dialogs_dict.put(dialog2.f440id, dialog2);
                    MessageObject messageObject = (MessageObject) longSparseArray.get(dialog2.f440id);
                    this.dialogMessage.put(dialog2.f440id, messageObject);
                    if (messageObject != null && messageObject.messageOwner.to_id.channel_id == 0) {
                        this.dialogMessagesByIds.put(messageObject.getId(), messageObject);
                        long j = messageObject.messageOwner.random_id;
                        if (j != 0) {
    ...
    public void generateJoinMessage(int i, boolean z) {
        ...
        if (chat != null && ChatObject.isChannel(i, this.currentAccount)) {
            if ((!chat.left && !chat.kicked) || z) {
                ...
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0692-$$Lambda$MessagesController$goN3mCs2oD94EPYohjkaDpROs2E(this, arrayList));
                MessagesStorage.getInstance(this.currentAccount).putMessages(arrayList2, true, true, false, 0);
                AndroidUtilities.runOnUIThread(new C0647-$$Lambda$MessagesController$OUR20mf5_d9gsY1zs0m8SWbYyH8(this, i, arrayList));
            }
        }
    }

    public /* synthetic */ void lambda$generateJoinMessage$224$MessagesController(ArrayList arrayList) {
        AndroidUtilities.runOnUIThread(new C0575-$$Lambda$MessagesController$-9gXGASI7A4n8RAC9ZRRZOYw_fA(this, arrayList));
    }
    ...
    public void checkChannelInviter(int i) {
        AndroidUtilities.runOnUIThread(new C0582-$$Lambda$MessagesController$1DIYKuDA2QelETVd6XOA-sCNt2w(this, i));
    }
    ...
    public /* synthetic */ void lambda$checkChannelInviter$231$MessagesController(int i) {
        ...
        if (chat != null && ChatObject.isChannel(i, this.currentAccount) && !chat.creator) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getParticipant, new C3452-$$Lambda$MessagesController$8UBdkj2QNJAC0y4BPGNDaiXhz9c(this, chat, i));
        }
    }
    ...
    public /* synthetic */ void lambda$null$230$MessagesController(Chat chat, int i, TLObject tLObject, TL_error tL_error) {
        ...
        if (tL_channels_channelParticipant != null) {
            ...
            if ((channelParticipant instanceof TL_channelParticipantSelf) && channelParticipant.inviter_id != UserConfig.getInstance(this.currentAccount).getClientUserId() && (!chat.megagroup || !MessagesStorage.getInstance(this.currentAccount).isMigratedChat(chat.f434id))) {
                AndroidUtilities.runOnUIThread(new C0644-$$Lambda$MessagesController$Nh66UA3TNkn3k9orw-Ewox9RITw(this, tL_channels_channelParticipant));
                ...
                while (i2 < tL_channels_channelParticipant.users.size()) {
                    ...
                    concurrentHashMap.put(Integer.valueOf(user.f534id), user);
                    i2++;
                }
                arrayList2.add(tL_messageService);
                arrayList.add(new MessageObject(this.currentAccount, tL_messageService, concurrentHashMap, true));
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0601-$$Lambda$MessagesController$BtccFZ3tf0NlzJfs-5gQlx4EP8M(this, arrayList));
                MessagesStorage.getInstance(this.currentAccount).putMessages(arrayList2, true, true, false, 0);
                AndroidUtilities.runOnUIThread(new C0637-$$Lambda$MessagesController$LcotUNrqwp_WpEp6G2YIbDReBNg(this, i, arrayList));
            }
        }
    }
    ...
    public /* synthetic */ void lambda$null$228$MessagesController(ArrayList arrayList) {
        AndroidUtilities.runOnUIThread(new C0730-$$Lambda$MessagesController$w_u2qeXpmHAUSajG7KA1I1Awfes(this, arrayList));
    }
    ...
    L_0x025d:
        org.telegram.messenger.FileLog.m27d(r7);
    L_0x0260:
    ...
    L_0x02e4:
        ...
        r6.append(r11);
        r6 = r6.toString();
        org.telegram.messenger.FileLog.m27d(r6);
    L_0x030d:
    ...
    L_0x04f0:
        org.telegram.messenger.FileLog.m27d(r18);
    L_0x04f3:
    ...
    L_0x09bc:
        ...
        r4 = org.telegram.messenger.C3454-$$Lambda$MessagesController$9PuTSEkyzwdd31UYsaKLfGdsGkM.INSTANCE;
    ...
    public /* synthetic */ void lambda$processUpdates$235$MessagesController(ArrayList arrayList) {
        AndroidUtilities.runOnUIThread(new C0667-$$Lambda$MessagesController$XG76p4T0ljFB2rIL7TEvl_qU3ss(this, arrayList));
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:646:0x0f48  */
    /* JADX WARNING: Removed duplicated region for block: B:653:0x0f74  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:638:0x0f39  */
    /* JADX WARNING: Removed duplicated region for block: B:646:0x0f48  */
    /* JADX WARNING: Removed duplicated region for block: B:651:0x0f6f  */
    /* JADX WARNING: Removed duplicated region for block: B:653:0x0f74  */
    /* JADX WARNING: Removed duplicated region for block: B:722:0x1076  */
    ...
    public /* synthetic */ void lambda$processUpdateArray$241$MessagesController(TL_updateUserBlocked tL_updateUserBlocked) {
        AndroidUtilities.runOnUIThread(new C0624-$$Lambda$MessagesController$IE61P-jfCib0uHF9uB4VvmEoPuE(this, tL_updateUserBlocked));
    }
    ...
    public /* synthetic */ void lambda$processUpdateArray$245$MessagesController(ArrayList arrayList) {
        AndroidUtilities.runOnUIThread(new C0602-$$Lambda$MessagesController$C4rRzL3XbhcTq3487s-diR-40t4(this, arrayList));
    }
    ...
    public /* synthetic */ void lambda$processUpdateArray$252$MessagesController(SparseLongArray sparseLongArray, SparseLongArray sparseLongArray2, SparseIntArray sparseIntArray, ArrayList arrayList, SparseArray sparseArray, SparseIntArray sparseIntArray2) {
        AndroidUtilities.runOnUIThread(new C0731-$$Lambda$MessagesController$xLr6cfkOLJahxhWtfNWAwSwDpgA(this, sparseLongArray, sparseLongArray2, sparseIntArray, arrayList, sparseArray, sparseIntArray2));
    }
            ...
            if (sparseLongArray3 != null) {
                ...
                for (i2 = 0; i2 < size; i2++) {
                    ...
                    if (dialog != null) {
                        ...
                        if (i3 > 0 && i3 <= valueAt) {
                            messageObject = (MessageObject) this.dialogMessage.get(dialog.f440id);
            ...
            if (sparseLongArray4 != null) {
                ...
                for (size = 0; size < size2; size++) {
                    ...
                    if (dialog2 != null) {
                        ...
                        if (i > 0 && i <= keyAt) {
                            messageObject2 = (MessageObject) this.dialogMessage.get(dialog2.f440id);
            ...
            if (messageObject != null) {
                ...
                if (messageObject.messageOwner.action instanceof TL_messageActionChatMigrateTo) {
                    if (tL_dialog != null) {
                        ...
                        this.dialogs_dict.remove(tL_dialog.f440id);
                        this.dialogs_read_inbox_max.remove(Long.valueOf(tL_dialog.f440id));
                        this.dialogs_read_outbox_max.remove(Long.valueOf(tL_dialog.f440id));
                        int i5 = this.nextDialogsCacheOffset.get(tL_dialog.folder_id, 0);
                        if (i5 > 0) {
                            this.nextDialogsCacheOffset.put(tL_dialog.folder_id, i5 - 1);
                        }
                        this.dialogMessage.remove(tL_dialog.f440id);
                        ...
                        NotificationsController.getInstance(this.currentAccount).removeNotificationsForDialog(tL_dialog.f440id);
                ...
                if (tL_dialog != null) {
                    ...
                    if (obj2 != null) {
                        i6 = 1;
                        if (tL_dialog.folder_id == 1 && !isDialogMuted(tL_dialog.f440id)) {
                            tL_dialog.folder_id = 0;
                            tL_dialog.pinned = false;
                            tL_dialog.pinnedNum = 0;
                            MessagesStorage.getInstance(this.currentAccount).setDialogsFolderId(null, null, tL_dialog.f440id, 0);
                            i = 1;
                        }
                    } else {
                        i6 = 1;
                    ...
                    if ((i2 == 0 || chat != null) && (chat == null || !chat.left)) {
                        ...
                        MessagesStorage.getInstance(this.currentAccount).getDialogFolderId(j2, new C3483-$$Lambda$MessagesController$UGzhyEr_7mVrPzKWG0QmrzUROSg(this, tL_dialog2, j2));
                        i = 1;
                    } else {
                        return;
                    }
    ...
    private void addDialogToItsFolder(int i, Dialog dialog, boolean z) {
        ...
        if (!(i2 == 0 || dialog.unread_count == 0)) {
            ...
            if (dialog2 != null) {
                ...
                } else if (isDialogMuted(dialog.f440id)) {
                    dialog2.unread_count++;
                } else {
                    dialog2.unread_mentions_count++;
                }
            ...
            if (str != null) {
                ...
                if (i != 0) {
                    ...
                    if (i > 0 || !ChatObject.isChannel(r3)) {
                        ...
                        tL_messages_getMessages.f506id.add(Integer.valueOf(messageObject.getId()));
                    } else {
                        Chat chat2 = getChat(Integer.valueOf(-i));
                        tL_messages_getMessages = new TL_channels_getMessages();
                        tL_messages_getMessages.channel = getInputChannel(chat2);
                        tL_messages_getMessages.f475id.add(Integer.valueOf(messageObject.getId()));
                    }
                    alertDialog.setOnCancelListener(new C0662-$$Lambda$MessagesController$Uy5HFVAD0pdKo9Ipvs8fE566HbU(this, ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getMessages, new C3447-$$Lambda$MessagesController$6GNHdOHS4ayBESoK8wFIXPmSlYs(this, alertDialog, baseFragment, bundle)), baseFragment));
    ...
    public /* synthetic */ void lambda$checkCanOpenChat$257$MessagesController(AlertDialog alertDialog, BaseFragment baseFragment, Bundle bundle, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0699-$$Lambda$MessagesController$khcet7XZs3bzMGRlSwPxErmYGcs(this, alertDialog, tLObject, baseFragment, bundle));
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x002b  */
    /* JADX WARNING: Removed duplicated region for block: B:16:0x002f  */
    public void openByUserName(java.lang.String r6, org.telegram.p004ui.ActionBar.BaseFragment r7, int r8) {
        /*
        r5 = this;
    ...
    L_0x003c:
        return;
    L_0x003d:
        r0 = new org.telegram.p004ui.ActionBar.AlertDialog[r0];
    ...
    public /* synthetic */ void lambda$openByUserName$260$MessagesController(AlertDialog[] alertDialogArr, BaseFragment baseFragment, int i, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0651-$$Lambda$MessagesController$PtlR0pP29l9GCXkUdVv_AI_Hdug(this, alertDialogArr, baseFragment, tL_error, tLObject, i));
    }
    ...
    public /* synthetic */ void lambda$null$259$MessagesController(AlertDialog[] alertDialogArr, BaseFragment baseFragment, TL_error tL_error, TLObject tLObject, int i) {
        ...
        if (tL_error == null) {
            ...
            try {
                Toast.makeText(baseFragment.getParentActivity(), LocaleController.getString("NoUsernameFound", C1067R.string.NoUsernameFound), 0).show();
            } catch (Exception e) {
                FileLog.m30e(e);
            }
        }
    ...
    public /* synthetic */ void lambda$openByUserName$262$MessagesController(AlertDialog[] alertDialogArr, int i, BaseFragment baseFragment) {
        if (alertDialogArr[0] != null) {
            alertDialogArr[0].setOnCancelListener(new C0658-$$Lambda$MessagesController$TMnAL0Zt--AXB8RK3P6tM9ad784(this, i));
