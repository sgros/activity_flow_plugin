...
public class RadioButton extends View {
    ...
    private int size = AndroidUtilities.m26dp(16.0f);
    ...
    public RadioButton(Context context) {
        ...
        try {
            this.bitmap = Bitmap.createBitmap(AndroidUtilities.m26dp((float) this.size), AndroidUtilities.m26dp((float) this.size), Config.ARGB_4444);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (bitmap2 != null) {
            ...
            if (this.progress <= 0.5f) {
                this.bitmapCanvas.drawCircle((float) (getMeasuredWidth() / 2), (float) (getMeasuredHeight() / 2), f3 - ((float) AndroidUtilities.m26dp(1.0f)), checkedPaint);
                this.bitmapCanvas.drawCircle((float) (getMeasuredWidth() / 2), (float) (getMeasuredHeight() / 2), (f3 - ((float) AndroidUtilities.m26dp(1.0f))) * (1.0f - f), eraser);
            } else {
                this.bitmapCanvas.drawCircle((float) (getMeasuredWidth() / 2), (float) (getMeasuredHeight() / 2), ((float) (this.size / 4)) + (((f3 - ((float) AndroidUtilities.m26dp(1.0f))) - ((float) (this.size / 4))) * f), checkedPaint);
            }
