...
public class TgChooserTargetService extends ChooserTargetService {
    ...
    public List<ChooserTarget> onGetChooserTargets(ComponentName componentName, IntentFilter intentFilter) {
        ...
        MessagesStorage.getInstance(i).getStorageQueue().postRunnable(new C1013-$$Lambda$TgChooserTargetService$Tk7TkprF_pFKgMncgdcbNzQeTqs(this, i, arrayList, new ComponentName(getPackageName(), LaunchActivity.class.getCanonicalName()), countDownLatch));
        try {
    ...
    L_0x0189:
        ...
        r8 = 2131165549; // 0x7f07016d float:1.7945318E38 double:1.0529356834E-314;
