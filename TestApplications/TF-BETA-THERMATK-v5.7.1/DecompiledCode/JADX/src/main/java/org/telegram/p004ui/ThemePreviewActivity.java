...
import org.telegram.p004ui.Cells.DialogCell.CustomDialog;
...
public class ThemePreviewActivity extends BaseFragment implements NotificationCenterDelegate {
    private C2190ActionBar actionBar2;
    ...
    class C32293 extends ViewOutlineProvider {
        C32293() {
        }
    ...
    class C43411 extends ActionBarMenuItemSearchListener {
    ...
    class C43436 implements OnPageChangeListener {
    ...
    class C43447 extends PagerAdapter {
        public int getCount() {
            return 2;
        }
    ...
    public class MessagesAdapter extends SelectionAdapter {
        ...
        class C43451 implements ChatMessageCellDelegate {
        ...
        class C43462 implements ChatActionCellDelegate {
        ...
        public MessagesAdapter(Context context) {
            ...
            if (this.showSecretMessages) {
                ...
                tL_user.f534id = Integer.MAX_VALUE;
                tL_user.first_name = "Me";
                TL_user tL_user2 = new TL_user();
                tL_user2.f534id = 2147483646;
                ...
                tL_message2.from_id = tL_user2.f534id;
                ...
                tL_message3.from_id = tL_user2.f534id;
                ...
                tL_message4.from_id = tL_user.f534id;
                ...
                tL_photoSize.size = 0;
                tL_photoSize.f465w = 500;
                tL_photoSize.f464h = 302;
                tL_photoSize.type = "s";
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                chatMessageCell.setDelegate(new C43451());
            } else if (i == 1) {
                chatMessageCell = new ChatActionCell(this.mContext);
                chatMessageCell.setDelegate(new C43462());
            } else {
        ...
        L_0x009d:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ThemePreviewActivity$MessagesAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, (int) C1067R.C1065drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C43411()).setSearchFieldHint(LocaleController.getString("Search", C1067R.string.Search));
        this.actionBar.setBackButtonDrawable(new MenuDrawable());
        this.actionBar.setAddToContainer(false);
        this.actionBar.setTitle(LocaleController.getString("ThemePreview", C1067R.string.ThemePreview));
        this.page1 = new FrameLayout(context2) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                ThemePreviewActivity.this.listView.measure(MeasureSpec.makeMeasureSpec(size, 1073741824), MeasureSpec.makeMeasureSpec(size2, 1073741824));
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            stateListAnimator.addState(new int[]{16842919}, ObjectAnimator.ofFloat(this.floatingButton, str, new float[]{(float) AndroidUtilities.m26dp(2.0f), (float) AndroidUtilities.m26dp(4.0f)}).setDuration(200));
            stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(this.floatingButton, str, new float[]{(float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(2.0f)}).setDuration(200));
            this.floatingButton.setStateListAnimator(stateListAnimator);
            this.floatingButton.setOutlineProvider(new C32293());
        }
        ...
        this.page2 = new SizeNotifierFrameLayout(context2) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                ThemePreviewActivity.this.listView2.measure(MeasureSpec.makeMeasureSpec(size, 1073741824), MeasureSpec.makeMeasureSpec(size2, 1073741824));
            }
                ...
                if (view instanceof ChatMessageCell) {
                    ...
                    if (avatarImage != null) {
                        ...
                        if (chatMessageCell.isPinnedTop()) {
                            ...
                            if (childViewHolder2 != null) {
                                ...
                                while (i < 20) {
                                    ...
                                    if (top2 - AndroidUtilities.m26dp(48.0f) < childViewHolder2.itemView.getBottom()) {
                        ...
                        if (top2 - AndroidUtilities.m26dp(48.0f) < top) {
                            top2 = top + AndroidUtilities.m26dp(48.0f);
                        }
        ...
        this.listView2.setPadding(0, AndroidUtilities.m26dp(4.0f), 0, AndroidUtilities.m26dp(4.0f));
        ...
        viewPager.addOnPageChangeListener(new C43436());
        viewPager.setAdapter(new C43447());
        ...
        this.dotsContainer = new View(context2) {
            ...
            public void onDraw(Canvas canvas) {
                ...
                while (i < 2) {
                    ...
                    canvas.drawCircle((float) AndroidUtilities.m26dp((float) ((i * 15) + 3)), (float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(3.0f), this.paint);
                    i++;
                }
            }
        };
        ...
        textView.setPadding(AndroidUtilities.m26dp(29.0f), 0, AndroidUtilities.m26dp(29.0f), 0);
        textView.setText(LocaleController.getString("Cancel", C1067R.string.Cancel).toUpperCase());
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        frameLayout2.addView(textView, LayoutHelper.createFrame(-2, -1, 51));
        textView.setOnClickListener(new C2099-$$Lambda$ThemePreviewActivity$VGx4sgeoasvuNaWlUta0WpzoZKY(this));
        ...
        textView.setBackgroundDrawable(Theme.createSelectorDrawable(Theme.ACTION_BAR_AUDIO_SELECTOR_COLOR, 0));
        textView.setPadding(AndroidUtilities.m26dp(29.0f), 0, AndroidUtilities.m26dp(29.0f), 0);
        textView.setText(LocaleController.getString("ApplyTheme", C1067R.string.ApplyTheme).toUpperCase());
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        frameLayout2.addView(textView, LayoutHelper.createFrame(-2, -1, 53));
        textView.setOnClickListener(new C2100-$$Lambda$ThemePreviewActivity$YPhE-lyYHwkD5fNafYq-tQN7oD0(this));
