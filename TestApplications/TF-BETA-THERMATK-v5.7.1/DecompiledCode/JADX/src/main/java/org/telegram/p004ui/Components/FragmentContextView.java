...
import org.telegram.p004ui.LocationActivity;
...
public class FragmentContextView extends FrameLayout implements NotificationCenterDelegate {
    ...
    private Runnable checkLocationRunnable = new C28471();
    ...
    class C28482 extends AnimatorListenerAdapter {
        C28482() {
        }
    ...
    class C28493 extends AnimatorListenerAdapter {
        C28493() {
        }
    ...
    class C28504 extends AnimatorListenerAdapter {
        C28504() {
        }
    ...
    class C28515 extends AnimatorListenerAdapter {
        C28515() {
        }
    ...
    class C28526 extends AnimatorListenerAdapter {
        C28526() {
        }
    ...
    class C28537 extends AnimatorListenerAdapter {
        C28537() {
        }
    ...
    public FragmentContextView(Context context, BaseFragment baseFragment, boolean z) {
        ...
        view.setBackgroundResource(C1067R.C1065drawable.header_shadow);
        ...
        this.playButton.setOnClickListener(new C2589-$$Lambda$FragmentContextView$xaUr_8YxtF96bWuD8Iv6_gj2wjI(this));
        ...
        if (!z) {
            ...
            this.playbackSpeedButton.setImageResource(C1067R.C1065drawable.voice2x);
            this.playbackSpeedButton.setContentDescription(LocaleController.getString("AccDescrPlayerSpeed", C1067R.string.AccDescrPlayerSpeed));
            if (AndroidUtilities.density >= 3.0f) {
                this.playbackSpeedButton.setPadding(0, 1, 0, 0);
            }
            addView(this.playbackSpeedButton, LayoutHelper.createFrame(36, 36.0f, 53, 0.0f, 0.0f, 36.0f, 0.0f));
            this.playbackSpeedButton.setOnClickListener(new C2586-$$Lambda$FragmentContextView$mn4uoFbwvEVtbgf8Ptja5mtZJQM(this));
            updatePlaybackButton();
        }
        this.closeButton = new ImageView(context);
        this.closeButton.setImageResource(C1067R.C1065drawable.miniplayer_close);
        ...
        this.closeButton.setOnClickListener(new C2585-$$Lambda$FragmentContextView$A00dqLRerQA-JpKS29_7k-ZhsDA(this));
        setOnClickListener(new C2588-$$Lambda$FragmentContextView$oHS8Qv6e4NDG6yqH2reqe1Dmqu0(this));
    }
    ...
    public /* synthetic */ void lambda$new$3$FragmentContextView(View view) {
        if (this.currentStyle == 2) {
            ...
            if (baseFragment instanceof DialogsActivity) {
                builder.setMessage(LocaleController.getString("StopLiveLocationAlertAll", C1067R.string.StopLiveLocationAlertAll));
            } else {
                ChatActivity chatActivity = (ChatActivity) baseFragment;
                Chat currentChat = chatActivity.getCurrentChat();
                User currentUser = chatActivity.getCurrentUser();
                if (currentChat != null) {
                    builder.setMessage(LocaleController.formatString("StopLiveLocationAlertToGroup", C1067R.string.StopLiveLocationAlertToGroup, currentChat.title));
                } else if (currentUser != null) {
                    builder.setMessage(LocaleController.formatString("StopLiveLocationAlertToUser", C1067R.string.StopLiveLocationAlertToUser, UserObject.getFirstName(currentUser)));
                } else {
                    builder.setMessage(LocaleController.getString("AreYouSure", C1067R.string.AreYouSure));
                }
            }
            builder.setPositiveButton(LocaleController.getString("OK", C1067R.string.f61OK), new C2587-$$Lambda$FragmentContextView$n_uFawyX6mh1KEybpEHLF-yq7cs(this));
    ...
    public /* synthetic */ void lambda$new$4$FragmentContextView(View view) {
        ...
        if (i == 0) {
            ...
            if (dialogId != 0) {
                ...
                this.fragment.showDialog(new SharingLocationsAlert(getContext(), new C4046-$$Lambda$FragmentContextView$Z72HHKSvAYjXtWgaFaDIC5DAHI8(this)));
            }
        }
    }
    ...
    private void openSharingLocation(SharingLocationInfo sharingLocationInfo) {
        if (sharingLocationInfo != null && this.fragment.getParentActivity() != null) {
            ...
            locationActivity.setDelegate(new C4047-$$Lambda$FragmentContextView$qSdNXrOdRWHj2Hn2uLFHHQL36iI(sharingLocationInfo, sharingLocationInfo.messageObject.getDialogId()));
    ...
    L_0x0013:
        ...
        r1 = r5.fragment;
        r1 = (org.telegram.p004ui.ChatActivity) r1;
        r3 = r1.getDialogId();
    ...
    L_0x0052:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.FragmentContextView.checkVisibility():void");
    }
    ...
    public void setTopPadding(float f) {
        ...
        if (this.fragment != null && getParent() != null) {
            ...
            int dp = (fragmentContextView == null || fragmentContextView.getVisibility() != 0 || this.additionalContextView.getParent() == null) ? 0 : AndroidUtilities.m26dp(36.0f);
            ...
            if (this.isLocation) {
                ...
                if (fragmentContextView2 != null) {
                    ((LayoutParams) fragmentContextView2.getLayoutParams()).topMargin = (-AndroidUtilities.m26dp(36.0f)) - ((int) this.topPadding);
                }
            }
        }
    }
        ...
        if (this.currentStyle != i) {
            ...
            if (i == 0 || i == 2) {
                ...
                if (i == 0) {
                    ...
                    this.closeButton.setContentDescription(LocaleController.getString("AccDescrClosePlayer", C1067R.string.AccDescrClosePlayer));
                } else if (i == 2) {
                    ...
                    this.closeButton.setContentDescription(LocaleController.getString("AccDescrStopLiveLocation", C1067R.string.AccDescrStopLiveLocation));
                }
            } else if (i == 1) {
                this.titleTextView.setText(LocaleController.getString("ReturnToCall", C1067R.string.ReturnToCall));
                FrameLayout frameLayout2 = this.frameLayout;
                String str2 = Theme.key_returnToCallBackground;
                frameLayout2.setBackgroundColor(Theme.getColor(str2));
                this.frameLayout.setTag(str2);
                TextView textView2 = this.titleTextView;
                str2 = Theme.key_returnToCallText;
    ...
    private void checkLiveLocation(boolean z) {
        ...
        if (isSharingLocation) {
            ...
            if (!this.visible) {
                if (!z) {
                    ...
                    this.animatorSet.addListener(new C28493());
            ...
            if (this.fragment instanceof DialogsActivity) {
                String firstName;
                String string = LocaleController.getString("AttachLiveLocation", C1067R.string.AttachLiveLocation);
                ...
                String format = String.format(LocaleController.getString("AttachLiveLocationIsSharing", C1067R.string.AttachLiveLocationIsSharing), new Object[]{string, firstName});
        ...
        if (this.visible) {
            ...
            this.animatorSet.setDuration(200);
            this.animatorSet.addListener(new C28482());
            this.animatorSet.start();
        }
    }
            ...
            if (this.lastLocationSharingCount != i) {
                ...
                if (i == 0) {
                    ...
                    if (isSharingLocation) {
                        ...
                        if (i == 0) {
                            str = String.format(str4, new Object[]{string, LocaleController.getString(str5, C1067R.string.ChatYourSelfName)});
                        } else if (i != 1 || user == null) {
                            str = String.format(str3, new Object[]{string, LocaleController.getString(str5, C1067R.string.ChatYourSelfName), LocaleController.formatPluralString(str2, i)});
                        } else {
                            Object[] objArr = new Object[2];
                            objArr[0] = string;
                            objArr[1] = LocaleController.formatString("SharingYouAndOtherName", C1067R.string.SharingYouAndOtherName, UserObject.getFirstName(user));
        ...
        if (playingMessageObject == null || playingMessageObject.getId() == 0 || playingMessageObject.isVideo()) {
            ...
            if (obj != null) {
                ...
                if (z) {
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.animatorSet.setDuration(200);
                    this.animatorSet.addListener(new C28504());
                    this.animatorSet.start();
                }
            }
        } else {
            ...
            if (z && this.topPadding == 0.0f) {
                ...
                if (fragmentContextView == null || fragmentContextView.getVisibility() != 0) {
                    ((LayoutParams) getLayoutParams()).topMargin = -AndroidUtilities.m26dp(36.0f);
                } else {
                    ((LayoutParams) getLayoutParams()).topMargin = -AndroidUtilities.m26dp(72.0f);
                }
                this.yPosition = 0.0f;
            }
            if (!this.visible) {
                if (!z) {
                    ...
                    animatorSet.playTogether(animatorArr2);
                    this.animatorSet.setDuration(200);
                    this.animatorSet.addListener(new C28515());
                    this.animatorSet.start();
                }
                this.visible = true;
                setVisibility(0);
            ...
            if (MediaController.getInstance().isMessagePaused()) {
                this.playButton.setImageResource(C1067R.C1065drawable.miniplayer_play);
                this.playButton.setContentDescription(LocaleController.getString("AccActionPlay", C1067R.string.AccActionPlay));
            } else {
                this.playButton.setImageResource(C1067R.C1065drawable.miniplayer_pause);
            ...
            if (!(this.lastMessageObject == playingMessageObject && i == 0)) {
                ...
                if (this.lastMessageObject.isVoice() || this.lastMessageObject.isRoundVideo()) {
                    ...
                    this.titleTextView.setPadding(0, 0, AndroidUtilities.m26dp(44.0f), 0);
        ...
        if (obj != null) {
            ...
            if (!this.visible) {
                if (!z) {
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.animatorSet.setDuration(200);
                    this.animatorSet.addListener(new C28537());
                    this.animatorSet.start();
                }
                this.visible = true;
                setVisibility(0);
            ...
            animatorSet.playTogether(animatorArr);
            this.animatorSet.setDuration(200);
            this.animatorSet.addListener(new C28526());
            this.animatorSet.start();
        }
    }
}
