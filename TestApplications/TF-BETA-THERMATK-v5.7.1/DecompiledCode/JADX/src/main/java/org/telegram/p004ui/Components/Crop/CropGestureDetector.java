...
public class CropGestureDetector {
    ...
    final float mTouchSlop = ((float) AndroidUtilities.m26dp(1.0f));
    private VelocityTracker mVelocityTracker;
    private boolean started;

    /* renamed from: org.telegram.ui.Components.Crop.CropGestureDetector$1 */
    class C27941 implements OnScaleGestureListener {
    ...
    public CropGestureDetector(Context context) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new C27941());
    }
