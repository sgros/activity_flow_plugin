...
public class ManageChatTextCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.valueTextView.measure(MeasureSpec.makeMeasureSpec(i - AndroidUtilities.m26dp(24.0f), Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(20.0f), 1073741824));
        ...
        setMeasuredDimension(i, AndroidUtilities.m26dp(56.0f) + this.divider);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        i = LocaleController.isRTL ? AndroidUtilities.m26dp(24.0f) : 0;
        SimpleTextView simpleTextView = this.valueTextView;
        ...
        textHeight = !LocaleController.isRTL ? AndroidUtilities.m26dp(71.0f) : AndroidUtilities.m26dp(24.0f);
        ...
        textHeight = AndroidUtilities.m26dp(9.0f);
    ...
    public void setText(String str, String str2, int i, boolean z) {
        ...
        this.imageView.setPadding(0, AndroidUtilities.m26dp(5.0f), 0, 0);
    ...
    public void onDraw(Canvas canvas) {
        if (this.divider) {
            canvas.drawLine((float) AndroidUtilities.m26dp(71.0f), (float) (getMeasuredHeight() - 1), (float) getMeasuredWidth(), (float) (getMeasuredHeight() - 1), Theme.dividerPaint);
        }
    }
}
