...
public class StickerMasksView extends FrameLayout implements NotificationCenterDelegate {
    ...
    class C41422 extends SpanSizeLookup {
        C41422() {
        }
    ...
    class C41433 extends OnScrollListener {
        C41433() {
        }
    ...
    private class StickersGridAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View c41441;
            if (i == 0) {
                c41441 = new StickerEmojiCell(this.context) {
                ...
                c41441 = new EmptyCell(this.context);
            }
            return new Holder(c41441);
        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == this.totalItems) {
                    ...
                    i = StickerMasksView.this.stickersGridView.getMeasuredHeight() - (((int) Math.ceil((double) (((float) tL_messages_stickerSet.documents.size()) / ((float) this.stickersPerRow)))) * AndroidUtilities.m26dp(82.0f));
    ...
    public StickerMasksView(Context context) {
        ...
        this.stickersLayoutManager.setSpanSizeLookup(new C41422());
        this.stickersGridView.setPadding(0, AndroidUtilities.m26dp(4.0f), 0, 0);
        ...
        this.stickersGridView.setOnTouchListener(new C2675-$$Lambda$StickerMasksView$UsFOY2iHtoAth4G0Jx5Am_K6Gjw(this));
        this.stickersOnItemClickListener = new C4059-$$Lambda$StickerMasksView$dIIbEIRSoGx8-DynOnZBV9n5UHM(this);
        ...
        this.scrollSlidingTabStrip.setUnderlineHeight(AndroidUtilities.m26dp(1.0f));
        this.scrollSlidingTabStrip.setIndicatorColor(-10305560);
        this.scrollSlidingTabStrip.setUnderlineColor(-15066598);
        this.scrollSlidingTabStrip.setIndicatorHeight(AndroidUtilities.m26dp(1.0f) + 1);
        addView(this.scrollSlidingTabStrip, LayoutHelper.createFrame(-1, 48, 51));
        updateStickerTabs();
        this.scrollSlidingTabStrip.setDelegate(new C4058-$$Lambda$StickerMasksView$AhwYOOvx1aUeFtWqQPYn16OGWYU(this));
        this.stickersGridView.setOnScrollListener(new C41433());
    }
    ...
    private void updateStickerTabs() {
        ...
        if (scrollSlidingTabStrip != null) {
            ...
            String str = Theme.key_chat_emojiPanelIcon;
            Drawable drawable;
            if (i == 0) {
                drawable = getContext().getResources().getDrawable(C1067R.C1065drawable.ic_masks_msk1);
                Theme.setDrawableColorByKey(drawable, str);
                this.scrollSlidingTabStrip.addIconTab(drawable);
                this.stickersEmptyView.setText(LocaleController.getString("NoStickers", C1067R.string.NoStickers));
            } else {
                drawable = getContext().getResources().getDrawable(C1067R.C1065drawable.ic_masks_sticker1);
                Theme.setDrawableColorByKey(drawable, str);
                this.scrollSlidingTabStrip.addIconTab(drawable);
                this.stickersEmptyView.setText(LocaleController.getString("NoMasks", C1067R.string.NoMasks));
            }
            if (!this.recentStickers[this.currentType].isEmpty()) {
                i = this.stickersTabOffset;
                this.recentTabBum = i;
                this.stickersTabOffset = i + 1;
                this.scrollSlidingTabStrip.addIconTab(Theme.createEmojiIconSelectorDrawable(getContext(), C1067R.C1065drawable.ic_masks_recent1, Theme.getColor(Theme.key_chat_emojiPanelMasksIcon), Theme.getColor(Theme.key_chat_emojiPanelMasksIconSelected)));
            }
    ...
    public void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(new C2674-$$Lambda$StickerMasksView$77XyfxOn3O_qUeajE-5-7BnPFnM(this));
    }
