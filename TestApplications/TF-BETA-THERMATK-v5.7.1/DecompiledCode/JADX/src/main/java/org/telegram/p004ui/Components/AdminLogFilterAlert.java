...
import org.telegram.p004ui.Cells.CheckBoxUserCell;
...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    class C40713 extends OnScrollListener {
        C40713() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                String string;
                if (i == 0) {
                    string = LocaleController.getString("EventLogFilterAll", C1067R.string.EventLogFilterAll);
                    if (AdminLogFilterAlert.this.currentFilter == null) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.restrictionsRow) {
                    string = LocaleController.getString("EventLogFilterNewRestrictions", C1067R.string.EventLogFilterNewRestrictions);
                    if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.kick && AdminLogFilterAlert.this.currentFilter.ban && AdminLogFilterAlert.this.currentFilter.unkick && AdminLogFilterAlert.this.currentFilter.unban)) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.adminsRow) {
                    string = LocaleController.getString("EventLogFilterNewAdmins", C1067R.string.EventLogFilterNewAdmins);
                    if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.promote && AdminLogFilterAlert.this.currentFilter.demote)) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.membersRow) {
                    string = LocaleController.getString("EventLogFilterNewMembers", C1067R.string.EventLogFilterNewMembers);
                    if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.invite && AdminLogFilterAlert.this.currentFilter.join)) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                    ...
                    if (AdminLogFilterAlert.this.isMegagroup) {
                        string = LocaleController.getString("EventLogFilterGroupInfo", C1067R.string.EventLogFilterGroupInfo);
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                            z = true;
                        }
                        checkBoxCell.setText(string, str, z, true);
                    ...
                    string = LocaleController.getString("EventLogFilterChannelInfo", C1067R.string.EventLogFilterChannelInfo);
                    if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.deleteRow) {
                    string = LocaleController.getString("EventLogFilterDeletedMessages", C1067R.string.EventLogFilterDeletedMessages);
                    if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.delete) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.editRow) {
                    string = LocaleController.getString("EventLogFilterEditedMessages", C1067R.string.EventLogFilterEditedMessages);
                    if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.edit) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.pinnedRow) {
                    string = LocaleController.getString("EventLogFilterPinnedMessages", C1067R.string.EventLogFilterPinnedMessages);
                    if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.pinned) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
                } else if (i == AdminLogFilterAlert.this.leavingRow) {
                    string = LocaleController.getString("EventLogFilterLeavingMembers", C1067R.string.EventLogFilterLeavingMembers);
                    if (!(AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.leave)) {
                        z2 = false;
                    }
                    checkBoxCell.setText(string, str, z2, false);
                } else if (i == AdminLogFilterAlert.this.allAdminsRow) {
                    string = LocaleController.getString("EventLogAllAdmins", C1067R.string.EventLogAllAdmins);
                    if (AdminLogFilterAlert.this.selectedAdmins == null) {
                        z = true;
                    }
                    checkBoxCell.setText(string, str, z, true);
    ...
    public AdminLogFilterAlert(Context context, TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter, SparseArray<User> sparseArray, boolean z) {
        ...
        this.containerView = new FrameLayout(context) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                getMeasuredWidth();
                int dp = (AndroidUtilities.m26dp(48.0f) + ((AdminLogFilterAlert.this.isMegagroup ? 9 : 7) * AndroidUtilities.m26dp(48.0f))) + AdminLogFilterAlert.this.backgroundPaddingTop;
                if (AdminLogFilterAlert.this.currentAdmins != null) {
                    dp += ((AdminLogFilterAlert.this.currentAdmins.size() + 1) * AndroidUtilities.m26dp(48.0f)) + AndroidUtilities.m26dp(20.0f);
                }
                int i3 = i2 / 5;
        ...
        this.listView.setOnScrollListener(new C40713());
        this.listView.setOnItemClickListener(new C4009-$$Lambda$AdminLogFilterAlert$PQg5JdNAPilzJKQuE1cFzZ18AW4(this));
        ...
        this.saveButton.setTextAndIcon(LocaleController.getString("Save", C1067R.string.Save).toUpperCase(), 0);
        this.saveButton.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2));
        this.saveButton.setOnClickListener(new C2462-$$Lambda$AdminLogFilterAlert$P34SvMRGiZ3R-8FDoPqX6OJH8LA(this));
        ...
        if (view instanceof CheckBoxCell) {
            ...
            if (this.selectedAdmins == null) {
                ...
                while (i2 < this.currentAdmins.size()) {
                    ...
                    this.selectedAdmins.put(user.f534id, user);
                    i2++;
                }
            }
            ...
            if (z) {
                this.selectedAdmins.remove(currentUser.f534id);
            } else {
                this.selectedAdmins.put(currentUser.f534id, currentUser);
            }
