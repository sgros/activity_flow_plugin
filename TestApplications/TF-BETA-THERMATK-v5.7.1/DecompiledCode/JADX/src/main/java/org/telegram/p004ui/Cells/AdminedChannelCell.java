...
public class AdminedChannelCell extends FrameLayout {
    ...
    public AdminedChannelCell(Context context, OnClickListener onClickListener) {
        ...
        this.deleteButton.setImageResource(C1067R.C1065drawable.msg_panel_clear);
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp((float) ((this.isLast ? 12 : 0) + 60)), 1073741824));
    }
