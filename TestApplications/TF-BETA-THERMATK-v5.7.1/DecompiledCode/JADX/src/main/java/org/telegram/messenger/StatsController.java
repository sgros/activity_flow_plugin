...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C10721();
    ...
    private Runnable saveRunnable = new C10732();
    ...
    static class C10721 extends ThreadLocal<Long> {
        C10721() {
        }
    ...
    private int bytesToInt(byte[] bArr) {
        return (bArr[3] & NalUnitUtil.EXTENDED_SAR) | (((bArr[0] << 24) | ((bArr[1] & NalUnitUtil.EXTENDED_SAR) << 16)) | ((bArr[2] & NalUnitUtil.EXTENDED_SAR) << 8));
    }
