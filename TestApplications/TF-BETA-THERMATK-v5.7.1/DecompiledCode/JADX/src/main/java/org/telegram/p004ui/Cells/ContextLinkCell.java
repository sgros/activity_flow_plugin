...
public class ContextLinkCell extends View implements FileDownloadProgressListener {
    ...
    private int descriptionY = AndroidUtilities.m26dp(27.0f);
    ...
    private int titleY = AndroidUtilities.m26dp(7.0f);
    ...
    public void onMeasure(int r37, int r38) {
        ...
        r0 = 1104674816; // 0x41d80000 float:27.0 double:5.457818764E-315;
    ...
    L_0x0020:
        ...
        r2 = org.telegram.messenger.AndroidUtilities.m26dp(r4);
    ...
    L_0x0070:
        r8 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_titleTextPaint;	 Catch:{ Exception -> 0x00bd }
        ...
        r9 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_titleTextPaint;	 Catch:{ Exception -> 0x00bd }
        r9 = r9.getFontMetricsInt();	 Catch:{ Exception -> 0x00bd }
        r10 = 1097859072; // 0x41700000 float:15.0 double:5.424144515E-315;
        r10 = org.telegram.messenger.AndroidUtilities.m26dp(r10);	 Catch:{ Exception -> 0x00bd }
        ...
        r18 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_titleTextPaint;	 Catch:{ Exception -> 0x00bd }
        r8 = 1082130432; // 0x40800000 float:4.0 double:5.34643471E-315;
        r8 = org.telegram.messenger.AndroidUtilities.m26dp(r8);	 Catch:{ Exception -> 0x00bd }
        r19 = r7 + r8;
    ...
    L_0x00d0:
        r8 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_descriptionTextPaint;	 Catch:{ Exception -> 0x0118 }
        r8 = r8.getFontMetricsInt();	 Catch:{ Exception -> 0x0118 }
        r9 = 1095761920; // 0x41500000 float:13.0 double:5.413783207E-315;
        r9 = org.telegram.messenger.AndroidUtilities.m26dp(r9);	 Catch:{ Exception -> 0x0118 }
        r8 = org.telegram.messenger.Emoji.replaceEmoji(r0, r8, r9, r2);	 Catch:{ Exception -> 0x0118 }
        r9 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_descriptionTextPaint;	 Catch:{ Exception -> 0x0118 }
        r0 = 0;
        r16 = 3;
        r10 = r7;
        r11 = r7;
        ...
        r6 = 32;
        r13 = r16;
        r0 = org.telegram.p004ui.Cells.ChatMessageCell.generateStaticLayout(r8, r9, r10, r11, r12, r13);	 Catch:{ Exception -> 0x0116 }
    ...
    L_0x00fc:
        ...
        r8 = org.telegram.messenger.AndroidUtilities.m26dp(r8);	 Catch:{ Exception -> 0x0116 }
        r0 = r0 + r8;
    ...
    L_0x0125:
        ...
        if (r0 == 0) goto L_0x016b;
    L_0x012b:
        r8 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_descriptionTextPaint;	 Catch:{ Exception -> 0x0164 }
        ...
        r6 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_descriptionTextPaint;	 Catch:{ Exception -> 0x0164 }
        ...
        r10 = org.telegram.p004ui.ActionBar.Theme.chat_contextResult_descriptionTextPaint;	 Catch:{ Exception -> 0x0164 }
    ...
    L_0x02d0:
        ...
        r0 = r35;
    L_0x02d5:
        r13 = 1117782016; // 0x42a00000 float:80.0 double:5.522576936E-315;
        if (r12 == 0) goto L_0x02db;
    L_0x02d9:
        if (r0 != 0) goto L_0x02e0;
    L_0x02db:
        r12 = org.telegram.messenger.AndroidUtilities.m26dp(r13);
        r0 = r12;
    L_0x02e0:
    ...
    L_0x0455:
        r0 = r1.mediaWebpage;
        r3 = 1103101952; // 0x41c00000 float:24.0 double:5.450047783E-315;
    ...
    L_0x0465:
        ...
        r8 = org.telegram.messenger.AndroidUtilities.m26dp(r3);
        r8 = r8 + r4;
    ...
    L_0x04d9:
        ...
        r4 = 1116209152; // 0x42880000 float:68.0 double:5.514805956E-315;
        r4 = org.telegram.messenger.AndroidUtilities.m26dp(r4);
    ...
    L_0x051b:
        ...
        r7 = org.telegram.messenger.AndroidUtilities.m26dp(r4);
        r9 = r2 + r0;
    ...
    L_0x0563:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ContextLinkCell.onMeasure(int, int):void");
    }
    ...
    private void setAttachType() {
        ...
        if (document == null) {
            ...
            if (botInlineResult != null) {
                ...
                } else if (botInlineResult.type.equals(MimeTypes.BASE_TYPE_AUDIO)) {
    ...
    L_0x000e:
        ...
        org.telegram.messenger.AndroidUtilities.m26dp(r2);
    ...
    L_0x00e0:
        ...
        return r9;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ContextLinkCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate((float) AndroidUtilities.m26dp(LocaleController.isRTL ? 8.0f : (float) AndroidUtilities.leftBaseline), (float) this.descriptionY);
        ...
        if (this.linkLayout != null) {
            ...
            canvas.translate((float) AndroidUtilities.m26dp(f), (float) this.linkY);
        ...
        if (this.mediaWebpage) {
            ...
            if (intrinsicWidth == 3 || intrinsicWidth == 5) {
                ...
                if (botInlineResult == null || !botInlineResult.type.equals("file")) {
                    botInlineResult = this.inlineResult;
                    if (botInlineResult == null || !(botInlineResult.type.equals(MimeTypes.BASE_TYPE_AUDIO) || this.inlineResult.type.equals("voice"))) {
                        botInlineResult = this.inlineResult;
                        if (botInlineResult == null || !(botInlineResult.type.equals("venue") || this.inlineResult.type.equals("geo"))) {
                            ...
                            imageY = this.linkImageView.getImageX() + ((AndroidUtilities.m26dp(52.0f) - intrinsicWidth) / 2);
                            imageY2 = this.linkImageView.getImageY() + ((AndroidUtilities.m26dp(52.0f) - imageX) / 2);
                            canvas.drawRect((float) this.linkImageView.getImageX(), (float) this.linkImageView.getImageY(), (float) (this.linkImageView.getImageX() + AndroidUtilities.m26dp(52.0f)), (float) (this.linkImageView.getImageY() + AndroidUtilities.m26dp(52.0f)), LetterDrawable.paint);
        ...
        if (this.needDivider && !this.mediaWebpage) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, (float) (getMeasuredHeight() - 1), (float) (getMeasuredWidth() - AndroidUtilities.m26dp((float) AndroidUtilities.leftBaseline)), (float) (getMeasuredHeight() - 1), Theme.dividerPaint);
            } else {
                canvas.drawLine((float) AndroidUtilities.m26dp((float) AndroidUtilities.leftBaseline), (float) (getMeasuredHeight() - 1), (float) getMeasuredWidth(), (float) (getMeasuredHeight() - 1), Theme.dividerPaint);
            }
        }
        if (this.needShadow) {
            Theme.chat_contextResult_shadowUnderSwitchDrawable.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m26dp(3.0f));
    ...
    L_0x01eb:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ContextLinkCell.updateButtonState(boolean, boolean):void");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        switch (this.documentAttachType) {
            case 1:
                stringBuilder.append(LocaleController.getString("AttachDocument", C1067R.string.AttachDocument));
                break;
            case 2:
                stringBuilder.append(LocaleController.getString("AttachGif", C1067R.string.AttachGif));
                break;
            case 3:
                stringBuilder.append(LocaleController.getString("AttachAudio", C1067R.string.AttachAudio));
                break;
            case 4:
                stringBuilder.append(LocaleController.getString("AttachVideo", C1067R.string.AttachVideo));
                break;
            case 5:
                stringBuilder.append(LocaleController.getString("AttachMusic", C1067R.string.AttachMusic));
                if (!(this.descriptionLayout == null || this.titleLayout == null)) {
                    stringBuilder.append(str);
                    stringBuilder.append(LocaleController.formatString("AccDescrMusicInfo", C1067R.string.AccDescrMusicInfo, this.descriptionLayout.getText(), this.titleLayout.getText()));
                    break;
                }
            case 6:
                stringBuilder.append(LocaleController.getString("AttachSticker", C1067R.string.AttachSticker));
                break;
            case 7:
                stringBuilder.append(LocaleController.getString("AttachPhoto", C1067R.string.AttachPhoto));
                break;
            case 8:
                stringBuilder.append(LocaleController.getString("AttachLocation", C1067R.string.AttachLocation));
                break;
            default:
