...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    class C23621 extends AnimatorListenerAdapter {
        C23621() {
        }
    ...
    public void showCheck(boolean z) {
        ...
        this.animatorSet.addListener(new C23621());
    ...
    public void setImage(SearchImage searchImage) {
        Drawable drawable = getResources().getDrawable(C1067R.C1065drawable.nophotos);
