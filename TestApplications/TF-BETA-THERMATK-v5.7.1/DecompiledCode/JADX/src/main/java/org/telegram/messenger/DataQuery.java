...
import org.telegram.p004ui.Components.StickersArchiveAlert;
...
public class DataQuery {
    ...
    private static Comparator<MessageEntity> entityComparator = C0385-$$Lambda$DataQuery$_GtBS_Mb74mqs3D5Wip5N2Gb424.INSTANCE;
    ...
    public /* synthetic */ void lambda$loadFeaturedStickers$17$DataQuery() {
        ...
        r4 = r3;
        r3 = 0;
        org.telegram.messenger.FileLog.m30e(r4);	 Catch:{ all -> 0x008a }
    ...
    public /* synthetic */ void lambda$loadMediaDatabase$63$DataQuery(int r27, long r28, int r30, boolean r31, int r32, int r33, int r34) {
        ...
        r7.f461id = r8;	 Catch:{ Exception -> 0x032d, all -> 0x0329 }
        ...
        r1.clear();	 Catch:{ all -> 0x0360 }
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ all -> 0x0360 }
        r1 = r26;
        r2 = r5;
        r3 = r28;
        r5 = r27;
    ...
    public /* synthetic */ void lambda$loadStickers$33$DataQuery(int r13) {
        ...
        r4 = r0;
        r3 = 0;
        org.telegram.messenger.FileLog.m30e(r2);	 Catch:{ all -> 0x007b }
    ...
    public boolean isStickerInFavorites(Document document) {
        for (int i = 0; i < this.recentStickers[2].size(); i++) {
            ...
            if (document2.f441id == document.f441id && document2.dc_id == document.dc_id) {
                return true;
            }
        }
        return false;
    ...
    L_0x004b:
        ...
        r3 = 2131560555; // 0x7f0d086b float:1.8746486E38 double:1.0531308423E-314;
    ...
    L_0x005e:
        r2 = org.telegram.messenger.ApplicationLoader.applicationContext;
        r3 = 2131558597; // 0x7f0d00c5 float:1.8742514E38 double:1.053129875E-314;
        r4 = "AddedToFavorites";
        r3 = org.telegram.messenger.LocaleController.getString(r4, r3);
        r2 = android.widget.Toast.makeText(r2, r3, r8);
        r2.show();
    ...
    public void removeRecentGif(Document document) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_saveGif, new C3364-$$Lambda$DataQuery$2rJc9xeBmgwGexV2v1U_RebLTns(this, tL_messages_saveGif));
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0334-$$Lambda$DataQuery$-3R_0wEE3expP9wo0aColXdZCOk(this, document));
    }
    ...
    public boolean hasRecentGif(Document document) {
        for (int i = 0; i < this.recentGifs.size(); i++) {
            ...
            if (document2.f441id == document.f441id) {
    ...
    public void addRecentGif(Document document, int i) {
        ...
        if (this.recentGifs.size() > MessagesController.getInstance(this.currentAccount).maxRecentGifsCount) {
            ...
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0425-$$Lambda$DataQuery$xvF6o-1_RcVDv47fzE1DMviRP_s(this, (Document) arrayList.remove(arrayList.size() - 1)));
        }
    ...
    public TL_messages_stickerSet getGroupStickerSetById(StickerSet stickerSet) {
        TL_messages_stickerSet tL_messages_stickerSet = (TL_messages_stickerSet) this.stickerSetsById.get(stickerSet.f466id);
        if (tL_messages_stickerSet == null) {
            tL_messages_stickerSet = (TL_messages_stickerSet) this.groupStickerSets.get(stickerSet.f466id);
            if (tL_messages_stickerSet != null) {
    ...
    public void putGroupStickerSet(TL_messages_stickerSet tL_messages_stickerSet) {
        this.groupStickerSets.put(tL_messages_stickerSet.set.f466id, tL_messages_stickerSet);
    }

    private void loadGroupStickerSet(StickerSet stickerSet, boolean z) {
        if (z) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0335-$$Lambda$DataQuery$-TcC0mAoIoAzht6PKxrSMA0GNwQ(this, stickerSet));
            return;
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getStickerSet, new C3388-$$Lambda$DataQuery$sSt--gYzisWLp4pAgk5FJ0UZgFM(this));
    }
    ...
    public /* synthetic */ void lambda$loadGroupStickerSet$6$DataQuery(StickerSet stickerSet) {
        try {
            ...
            stringBuilder.append(stickerSet.f466id);
            ...
            if (tL_messages_stickerSet != null && tL_messages_stickerSet.set != null) {
                AndroidUtilities.runOnUIThread(new C0409-$$Lambda$DataQuery$mnsVNSCVdaMktJngurpfoZuqcbc(this, tL_messages_stickerSet));
            }
        } catch (Throwable th) {
            FileLog.m30e(th);
        }
    ...
    public /* synthetic */ void lambda$null$5$DataQuery(TL_messages_stickerSet tL_messages_stickerSet) {
        this.groupStickerSets.put(tL_messages_stickerSet.set.f466id, tL_messages_stickerSet);
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.groupStickersDidLoad, Long.valueOf(tL_messages_stickerSet.set.f466id));
    }

    public /* synthetic */ void lambda$loadGroupStickerSet$8$DataQuery(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0379-$$Lambda$DataQuery$Wjx9ZjzCtddl-eyuO29wwGUiJOs(this, (TL_messages_stickerSet) tLObject));
        }
    }
    ...
    private void putSetToCache(TL_messages_stickerSet tL_messages_stickerSet) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0359-$$Lambda$DataQuery$Gs_0kL3OC_eV-RiFuvATRDxcFsE(this, tL_messages_stickerSet));
    }
    ...
    public /* synthetic */ void lambda$putSetToCache$9$DataQuery(TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        try {
            ...
            stringBuilder.append(tL_messages_stickerSet.set.f466id);
    ...
    public boolean areAllTrendingStickerSetsUnread() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!getInstance(this.currentAccount).isStickerPackInstalled(stickerSetCovered.set.f466id) && ((!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) && !this.unreadStickerSets.contains(Long.valueOf(stickerSetCovered.set.f466id)))) {
                return false;
            }
        }
        return true;
    ...
    public /* synthetic */ void lambda$loadRecents$11$DataQuery(boolean z, int i) {
        ...
        try {
            ...
            queryFinalized.dispose();
            AndroidUtilities.runOnUIThread(new C0339-$$Lambda$DataQuery$4Ct3KKcQG3d2vX_KGUT-tJNgszQ(this, z, arrayList, i));
        } catch (Throwable th) {
            FileLog.m30e(th);
        }
    }
    ...
    public void processLoadedRecentDocuments(int i, ArrayList<Document> arrayList, boolean z, int i2, boolean z2) {
        if (arrayList != null) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0419-$$Lambda$DataQuery$uuHSgHUH35SvbaUdMusqTnQ-iPk(this, z, i, arrayList, z2, i2));
        }
        if (i2 == 0) {
            AndroidUtilities.runOnUIThread(new C0343-$$Lambda$DataQuery$7M05Rnf_3mDk_ioxbIIY86tv1DE(this, z, i, arrayList));
        }
    }
        ...
        try {
            ...
            if (arrayList.size() >= i4) {
                ...
                while (i4 < arrayList.size()) {
                    ...
                    stringBuilder2.append(((Document) arrayList2.get(i4)).f441id);
    ...
    public void reorderStickers(int i, ArrayList<Long> arrayList) {
        Collections.sort(this.stickerSets[i], new C0392-$$Lambda$DataQuery$dtOJW5lUpjPVOn6aZw8KSWcnFQs(arrayList));
    ...
    static /* synthetic */ int lambda$reorderStickers$16(ArrayList arrayList, TL_messages_stickerSet tL_messages_stickerSet, TL_messages_stickerSet tL_messages_stickerSet2) {
        int indexOf = arrayList.indexOf(Long.valueOf(tL_messages_stickerSet.set.f466id));
        int indexOf2 = arrayList.indexOf(Long.valueOf(tL_messages_stickerSet2.set.f466id));
        if (indexOf > indexOf2) {
            return 1;
        }
    ...
    public void addNewStickerSet(TL_messages_stickerSet tL_messages_stickerSet) {
        if (this.stickerSetsById.indexOfKey(tL_messages_stickerSet.set.f466id) < 0 && !this.stickerSetsByName.containsKey(tL_messages_stickerSet.set.short_name)) {
            int i;
            boolean z = tL_messages_stickerSet.set.masks;
            this.stickerSets[z].add(0, tL_messages_stickerSet);
            this.stickerSetsById.put(tL_messages_stickerSet.set.f466id, tL_messages_stickerSet);
            this.installedStickerSetsById.put(tL_messages_stickerSet.set.f466id, tL_messages_stickerSet);
            ...
            for (i = 0; i < tL_messages_stickerSet.documents.size(); i++) {
                ...
                longSparseArray.put(document.f441id, document);
            }
    ...
    public void loadFeaturedStickers(boolean z, boolean z2) {
        if (!this.loadingFeaturedStickers) {
            ...
            if (z) {
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0386-$$Lambda$DataQuery$_js4uGbpT5ecS0xV_WWy27wFeXg(this));
            } else {
                int i;
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getFeaturedStickers, new C3374-$$Lambda$DataQuery$KjoE15J_7Y5rDsfACZqjBs6rNXk(this, tL_messages_getFeaturedStickers));
            }
        }
    }
    ...
    public /* synthetic */ void lambda$loadFeaturedStickers$19$DataQuery(TL_messages_getFeaturedStickers tL_messages_getFeaturedStickers, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0365-$$Lambda$DataQuery$LGTT4xzHAhL56fxY9zS2yMdk6qA(this, tLObject, tL_messages_getFeaturedStickers));
    }
    ...
    private void processLoadedFeaturedStickers(ArrayList<StickerSetCovered> arrayList, ArrayList<Long> arrayList2, boolean z, int i, int i2) {
        AndroidUtilities.runOnUIThread(new C0350-$$Lambda$DataQuery$Br07Yue1FWlAHhubZJ8mcHmpI1c(this));
        Utilities.stageQueue.postRunnable(new C0389-$$Lambda$DataQuery$cOH-T13u95HL6anewGDnniRkdeE(this, z, arrayList, i, i2, arrayList2));
    }
    ...
    public /* synthetic */ void lambda$processLoadedFeaturedStickers$24$DataQuery(boolean z, ArrayList arrayList, int i, int i2, ArrayList arrayList2) {
        ...
        if ((z && (arrayList == null || Math.abs((System.currentTimeMillis() / 1000) - ((long) i)) >= 3600)) || (!z && arrayList == null && i2 == 0)) {
            C0406-$$Lambda$DataQuery$kRg5HaPmcNQUyKbUY_yQPqEg7dE c0406-$$Lambda$DataQuery$kRg5HaPmcNQUyKbUY_yQPqEg7dE = new C0406-$$Lambda$DataQuery$kRg5HaPmcNQUyKbUY_yQPqEg7dE(this, arrayList, i2);
            if (arrayList != null || z) {
                j = 0;
            }
            AndroidUtilities.runOnUIThread(c0406-$$Lambda$DataQuery$kRg5HaPmcNQUyKbUY_yQPqEg7dE, j);
            if (arrayList == null) {
                return;
            }
        }
        ...
        if (arrayList != null) {
            try {
                ...
                while (i3 < arrayList.size()) {
                    ...
                    longSparseArray.put(stickerSetCovered.set.f466id, stickerSetCovered);
                    i3++;
                }
                if (!z) {
                    putFeaturedStickersToCache(arrayList3, arrayList2, i, i2);
                }
                AndroidUtilities.runOnUIThread(new C0391-$$Lambda$DataQuery$dAuSsiUmfJ4Spuw_RVTqCszQl9Y(this, arrayList2, longSparseArray, arrayList3, i2, i));
            } catch (Throwable th) {
                FileLog.m30e(th);
            }
        } else if (!z) {
            AndroidUtilities.runOnUIThread(new C0377-$$Lambda$DataQuery$W2Cvj9Df-M9tvBcZ-35ZTktPTCg(this, i));
    ...
    private void putFeaturedStickersToCache(ArrayList<StickerSetCovered> arrayList, ArrayList<Long> arrayList2, int i, int i2) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0355-$$Lambda$DataQuery$EvRKZ0icyHpXu5syph8WWuRUigE(this, arrayList != null ? new ArrayList(arrayList) : null, arrayList2, i, i2));
    }
    ...
    public void markFaturedStickersAsRead(boolean z) {
        if (!this.unreadStickerSets.isEmpty()) {
            ...
            if (z) {
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_messages_readFeaturedStickers(), C3375-$$Lambda$DataQuery$TygWBWHmoEKh7kTWN3Sp59N9f8M.INSTANCE);
            }
        }
    }
    ...
    public void markFaturedStickersByIdAsRead(long j) {
        if (this.unreadStickerSets.contains(Long.valueOf(j)) && !this.readingStickerSets.contains(Long.valueOf(j))) {
            ...
            tL_messages_readFeaturedStickers.f508id.add(Long.valueOf(j));
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_readFeaturedStickers, C3369-$$Lambda$DataQuery$CoOuaI5Ui4g_M8Hv23Yz8tRYQcY.INSTANCE);
            AndroidUtilities.runOnUIThread(new C0396-$$Lambda$DataQuery$g0o9Z-244wbMtOYxpACC2qzITTc(this, j), 1000);
        }
    }
    ...
    public void loadArchivedStickersCount(int i, boolean z) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getArchivedStickers, new C3392-$$Lambda$DataQuery$vXxSlr6eK9Z6xNmLs0Dj7UWvraQ(this, i));
    }

    public /* synthetic */ void lambda$loadArchivedStickersCount$30$DataQuery(int i, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0402-$$Lambda$DataQuery$ii2s4yGT-QcUcBrCrSZAhn6DFB4(this, tL_error, tLObject, i));
    }
        ...
        while (i2 < messages_allstickers.sets.size()) {
            ...
            if (tL_messages_stickerSet != null) {
                ...
                if (stickerSet2.hash == stickerSet.hash) {
                    ...
                    longSparseArray.put(stickerSet2.f466id, tL_messages_stickerSet);
            ...
            inputStickerSet.f460id = stickerSet.f466id;
            inputStickerSet.access_hash = stickerSet.access_hash;
            C3393-$$Lambda$DataQuery$w1XixRjF16wrwBdg1yg9ZISWPKs c3393-$$Lambda$DataQuery$w1XixRjF16wrwBdg1yg9ZISWPKs = r0;
            ConnectionsManager instance = ConnectionsManager.getInstance(this.currentAccount);
            C3393-$$Lambda$DataQuery$w1XixRjF16wrwBdg1yg9ZISWPKs c3393-$$Lambda$DataQuery$w1XixRjF16wrwBdg1yg9ZISWPKs2 = new C3393-$$Lambda$DataQuery$w1XixRjF16wrwBdg1yg9ZISWPKs(this, arrayList, i2, longSparseArray, stickerSet, tL_messages_allStickers, i);
            instance.sendRequest(tL_messages_getStickerSet, c3393-$$Lambda$DataQuery$w1XixRjF16wrwBdg1yg9ZISWPKs);
            i2++;
            j = 1000;
        }
    }
    ...
    public /* synthetic */ void lambda$processLoadStickersResponse$32$DataQuery(ArrayList arrayList, int i, LongSparseArray longSparseArray, StickerSet stickerSet, TL_messages_allStickers tL_messages_allStickers, int i2, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0408-$$Lambda$DataQuery$m9Jrl7_U-_SUx_Gpw56kknTexVQ(this, tLObject, arrayList, i, longSparseArray, stickerSet, tL_messages_allStickers, i2));
    }
    ...
    public /* synthetic */ void lambda$null$31$DataQuery(TLObject tLObject, ArrayList arrayList, int i, LongSparseArray longSparseArray, StickerSet stickerSet, TL_messages_allStickers tL_messages_allStickers, int i2) {
        ...
        longSparseArray.put(stickerSet.f466id, tL_messages_stickerSet);
    ...
    public void loadStickers(int i, boolean z, boolean z2) {
        if (!this.loadingStickers[i]) {
            ...
            if (z) {
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0424-$$Lambda$DataQuery$xa4Sj3vXQ9Lm0vsRxYjFZWyzhng(this, i));
            } else {
                int i2 = 0;
                if (i == 3) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getAllStickers, new C3387-$$Lambda$DataQuery$rOQjG3YS0y6BqT7zHxJCSwr131o(this, i, i2));
            }
        }
    }

    public /* synthetic */ void lambda$loadStickers$35$DataQuery(int i, int i2, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0401-$$Lambda$DataQuery$iGCHItKH69AqIe-44thbbHy-0Sg(this, tLObject, i, i2));
    }
    ...
    private void putStickersToCache(int i, ArrayList<TL_messages_stickerSet> arrayList, int i2, int i3) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0363-$$Lambda$DataQuery$HuXXMuf2NeuYCbcUMY_TfU-FwGA(this, arrayList != null ? new ArrayList(arrayList) : null, i, i2, i3));
    }
    ...
    private void processLoadedStickers(int i, ArrayList<TL_messages_stickerSet> arrayList, boolean z, int i2, int i3) {
        AndroidUtilities.runOnUIThread(new C0348-$$Lambda$DataQuery$9vMJ1w-Dj5oCt4zZwXAybfYG_nU(this, i));
        Utilities.stageQueue.postRunnable(new C0403-$$Lambda$DataQuery$inBvXSiWQIx1Y9BuZIwlL6K4fAA(this, z, arrayList, i2, i3, i));
    }
    ...
    public /* synthetic */ void lambda$processLoadedStickers$41$DataQuery(boolean z, ArrayList arrayList, int i, int i2, int i3) {
        ...
        if ((z && (arrayList2 == null || Math.abs((System.currentTimeMillis() / 1000) - ((long) i4)) >= 3600)) || (!z && arrayList2 == null && i5 == 0)) {
            C0411-$$Lambda$DataQuery$p-_TrjJXc0wEGRq96cujq9LPyXc c0411-$$Lambda$DataQuery$p-_TrjJXc0wEGRq96cujq9LPyXc = new C0411-$$Lambda$DataQuery$p-_TrjJXc0wEGRq96cujq9LPyXc(this, arrayList2, i5, i6);
            if (arrayList2 != null || z) {
                j = 0;
            }
            AndroidUtilities.runOnUIThread(c0411-$$Lambda$DataQuery$p-_TrjJXc0wEGRq96cujq9LPyXc, j);
            if (arrayList2 == null) {
                return;
            }
        }
            ...
            try {
                ...
                while (i7 < arrayList.size()) {
                    ...
                    if (tL_messages_stickerSet != null) {
                        ...
                        longSparseArray2.put(tL_messages_stickerSet.set.f466id, tL_messages_stickerSet);
                        ...
                        while (i8 < tL_messages_stickerSet.documents.size()) {
                            ...
                            if (document != null) {
                                if (!(document instanceof TL_documentEmpty)) {
                                    longSparseArray4.put(document.f441id, document);
                                }
                            }
                            i8++;
                ...
                AndroidUtilities.runOnUIThread(new C0415-$$Lambda$DataQuery$tJcdmi2t6adWqXKlQnAh02D50rs(this, i3, longSparseArray, hashMap, arrayList3, i2, i, hashMap2, longSparseArray3));
            } catch (Throwable th) {
                FileLog.m30e(th);
            }
        } else if (!z) {
            AndroidUtilities.runOnUIThread(new C0345-$$Lambda$DataQuery$8k_rAECt-51WNomiJ13t8JNjAGU(this, i6, i4));
    ...
    public /* synthetic */ void lambda$null$39$DataQuery(int i, LongSparseArray longSparseArray, HashMap hashMap, ArrayList arrayList, int i2, int i3, HashMap hashMap2, LongSparseArray longSparseArray2) {
        ...
        for (i4 = 0; i4 < this.stickerSets[i].size(); i4++) {
            ...
            this.stickerSetsById.remove(stickerSet.f466id);
            this.installedStickerSetsById.remove(stickerSet.f466id);
    ...
    public void removeStickersSet(android.content.Context r11, org.telegram.tgnet.TLRPC.StickerSet r12, int r13, org.telegram.p004ui.ActionBar.BaseFragment r14, boolean r15) {
        /*
        r10 = this;
        r2 = r12.masks;
    ...
    public /* synthetic */ void lambda$removeStickersSet$44$DataQuery(int i, int i2, BaseFragment baseFragment, boolean z, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0367-$$Lambda$DataQuery$O3U-V0n7MR7QFur96I7yoxXpLvQ(this, tLObject, i, i2, baseFragment, z));
        AndroidUtilities.runOnUIThread(new C0382-$$Lambda$DataQuery$XkVtXDXzkHZcNcyTDn3dq8s1agk(this, i), 1000);
    }
    ...
    public /* synthetic */ void lambda$removeStickersSet$46$DataQuery(StickerSet stickerSet, Context context, int i, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0423-$$Lambda$DataQuery$x29XwwId3_CQasQvc9QUrJecg8c(this, tL_error, stickerSet, context, i));
    }
    ...
    public /* synthetic */ void lambda$null$45$DataQuery(TL_error tL_error, StickerSet stickerSet, Context context, int i) {
        if (tL_error == null) {
            try {
                if (stickerSet.masks) {
                    Toast.makeText(context, LocaleController.getString("MasksRemoved", C1067R.string.MasksRemoved), 0).show();
                } else {
                    Toast.makeText(context, LocaleController.getString("StickersRemoved", C1067R.string.StickersRemoved), 0).show();
                }
            } catch (Exception e) {
                FileLog.m30e(e);
            }
        } else {
            Toast.makeText(context, LocaleController.getString("ErrorOccurred", C1067R.string.ErrorOccurred), 0).show();
        }
        loadStickers(i, false, true);
    }
    ...
    private void searchMessagesInChat(String str, long j, long j2, int i, int i2, boolean z, User user) {
        ...
        if (j3 == j && i5 != 0) {
            if (j4 != 0) {
                ...
                if (inputPeer != null) {
                    ...
                    C3376-$$Lambda$DataQuery$X_xjH4zrLbF98x7_YlP3_d_hOC0 c3376-$$Lambda$DataQuery$X_xjH4zrLbF98x7_YlP3_d_hOC0 = r0;
                    C3376-$$Lambda$DataQuery$X_xjH4zrLbF98x7_YlP3_d_hOC0 c3376-$$Lambda$DataQuery$X_xjH4zrLbF98x7_YlP3_d_hOC02 = new C3376-$$Lambda$DataQuery$X_xjH4zrLbF98x7_YlP3_d_hOC0(this, j2, tL_messages_search, j, i, i2, user);
                    this.mergeReqId = instance2.sendRequest(tL_messages_search, c3376-$$Lambda$DataQuery$X_xjH4zrLbF98x7_YlP3_d_hOC0, 2);
                    return;
                }
                return;
            }
        ...
        if (tL_messages_search2.peer != null) {
            ...
            tL_messages_search2.f513q = str4;
            ...
            this.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_search2, new C3377-$$Lambda$DataQuery$YQtVaGINuYPbSOpEA3NgINY1Mog(this, i7, tL_messages_search2, j3, j, i, j2, user), 2);
        }
    }
    ...
    public /* synthetic */ void lambda$searchMessagesInChat$48$DataQuery(long j, TL_messages_search tL_messages_search, long j2, int i, int i2, User user, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0394-$$Lambda$DataQuery$eJFDqCNJQlVs4Vxl5xT4VYdEsgw(this, j, tLObject, tL_messages_search, j2, i, i2, user));
    }
    ...
    public /* synthetic */ void lambda$null$47$DataQuery(long j, TLObject tLObject, TL_messages_search tL_messages_search, long j2, int i, int i2, User user) {
        if (this.lastMergeDialogId == j) {
            ...
            if (tLObject != null) {
                ...
                searchMessagesInChat(tL_messages_search.f513q, j2, j, i, i2, true, user);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$searchMessagesInChat$50$DataQuery(int i, TL_messages_search tL_messages_search, long j, long j2, int i2, long j3, User user, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0338-$$Lambda$DataQuery$2id2umTzhmpQDk5s-dtlRZWpox0(this, i, tLObject, tL_messages_search, j, j2, i2, j3, user));
    }
    ...
    public void loadMedia(long j, int i, int i2, int i3, int i4, int i5) {
        ...
        if (i4 != 0 || i7 == 0) {
            ...
            if (tL_messages_search.peer != null) {
                i8 = i5;
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_search, new C3389-$$Lambda$DataQuery$sZkwI2OJzSWG6qrblxHbvHglZsU(this, j, i, i2, i3, i8, z)), i8);
            }
        }
    }
    ...
    public void getMediaCounts(long j, int i) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0366-$$Lambda$DataQuery$NQ5MkErWobCUOgqYnlpeC3jx-Y8(this, j, i));
    }
    ...
    L_0x011b:
        r1 = "";
        r3.f513q = r1;	 Catch:{ Exception -> 0x0186 }
        r1 = r7.currentAccount;	 Catch:{ Exception -> 0x0186 }
    ...
    public /* synthetic */ void lambda$null$54$DataQuery(int[] iArr, int i, long j, TLObject tLObject, TL_error tL_error) {
        ...
        obj = 1;
        if (obj != null) {
            AndroidUtilities.runOnUIThread(new C0352-$$Lambda$DataQuery$D0edyBe7uzUZgJEes_37nxNPUP8(this, j, iArr));
        }
    }
    ...
    public void getMediaCount(long j, int i, int i2, boolean z) {
        ...
        if (z || i3 == 0) {
            ...
            if (tL_messages_search.peer != null) {
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_search, new C3379-$$Lambda$DataQuery$b79Pt8rqwc9fu4IUQhVikz5ynL4(this, j, i, i2)), i2);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$getMediaCount$58$DataQuery(long j, int i, int i2, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            int i3 = size;
            AndroidUtilities.runOnUIThread(new C0357-$$Lambda$DataQuery$GKdiXJjXrtMcEJNPcPmeNeb7UEQ(this, messages_messages));
    ...
    private void processLoadedMedia(messages_Messages messages_messages, long j, int i, int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        ...
        if (i6 == 0 || !messages_messages2.messages.isEmpty() || i7 == 0) {
            ...
            AndroidUtilities.runOnUIThread(new C0336-$$Lambda$DataQuery$0dlxm8i-c0v_chVqHF7I-je7M4g(this, messages_messages, i4, j, arrayList, i5, i3, z2));
        } else if (i6 != 2) {
    ...
    private void processLoadedMediaCount(int i, long j, int i2, int i3, boolean z, int i4) {
        AndroidUtilities.runOnUIThread(new C0358-$$Lambda$DataQuery$GYaSd5P0GrMZfcQPvBwtuZFrwqw(this, j, z, i, i2, i4, i3));
    }
    ...
    private void putMediaCountDatabase(long j, int i, int i2) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0374-$$Lambda$DataQuery$VPyo4uiijc6Mw5vRqsga_xtHpO4(this, j, i, i2));
    }
    ...
    private void getMediaCountDatabase(long j, int i, int i2) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0413-$$Lambda$DataQuery$r7IDcaPS4_-Lq9u-Bcjhps7n1wc(this, j, i, i2));
    }
    ...
    private void loadMediaDatabase(long j, int i, int i2, int i3, int i4, boolean z, int i5) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0368-$$Lambda$DataQuery$OqcREWH3JA8hAPi-XM3PyDyEsWM(this, i, j, i2, z, i3, i5, i4));
    }

    private void putMediaDatabase(long j, int i, ArrayList<Message> arrayList, int i2, boolean z) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0375-$$Lambda$DataQuery$VgKCIvejIuaPm3YY59TrIO7FIyE(this, arrayList, z, j, i2, i));
    }
        ...
        try {
            ...
            if (!(z && i3 == 0)) {
                ...
                if (z) {
                    ...
                    ArrayList arrayList2 = arrayList;
                    i5 = ((Message) arrayList.get(arrayList.size() - 1)).f461id;
                }
                if (i3 != 0) {
    ...
    public void loadMusic(long j, long j2) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0388-$$Lambda$DataQuery$cA-X50sc6geZKVWNtiHKllnXTb8(this, j, j2));
    }
    ...
    public /* synthetic */ void lambda$loadMusic$66$DataQuery(long j, long j2) {
        ...
        queryFinalized.dispose();
        AndroidUtilities.runOnUIThread(new C0395-$$Lambda$DataQuery$etglwa1VnT5BvHlWsrv51HhlBY4(this, j, arrayList));
    }
    ...
    public void buildShortcuts() {
        if (VERSION.SDK_INT >= 25) {
            ...
            Utilities.globalQueue.postRunnable(new C0418-$$Lambda$DataQuery$usUs3tLksjqGquVtjg9TZkSDUaI(this, arrayList));
        }
    }
    ...
    L_0x00a1:
        ...
        r11 = org.telegram.p004ui.LaunchActivity.class;
        ...
        r12 = 2131559899; // 0x7f0d05db float:1.8745155E38 double:1.053130518E-314;
        ...
        r12 = 2131165825; // 0x7f070281 float:1.7945878E38 double:1.0529358197E-314;
    ...
    L_0x01bf:
        ...
        r0 = org.telegram.messenger.AndroidUtilities.m26dp(r0);	 Catch:{ Throwable -> 0x0250 }
    ...
    L_0x01d6:
        ...
        r0 = r0 / 2;
        r17 = org.telegram.messenger.AndroidUtilities.m26dp(r18);	 Catch:{ Throwable -> 0x0250 }
        r0 = r0 - r17;
    ...
    L_0x0220:
        ...
        r1 = org.telegram.messenger.AndroidUtilities.m26dp(r18);	 Catch:{ Throwable -> 0x0250 }
        r1 = (float) r1;	 Catch:{ Throwable -> 0x0250 }
        r2 = org.telegram.messenger.AndroidUtilities.m26dp(r18);	 Catch:{ Throwable -> 0x0250 }
        r2 = (float) r2;	 Catch:{ Throwable -> 0x0250 }
        r13 = 1110966272; // 0x42380000 float:46.0 double:5.488902687E-315;
        r15 = org.telegram.messenger.AndroidUtilities.m26dp(r13);	 Catch:{ Throwable -> 0x0250 }
        r15 = (float) r15;	 Catch:{ Throwable -> 0x0250 }
        r13 = org.telegram.messenger.AndroidUtilities.m26dp(r13);	 Catch:{ Throwable -> 0x0250 }
        r13 = (float) r13;	 Catch:{ Throwable -> 0x0250 }
    ...
    L_0x0255:
        ...
        r10 = r2;
    L_0x0258:
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Throwable -> 0x02bd }
        goto L_0x025e;
    L_0x025c:
        r2 = 0;
        r10 = r2;
    ...
    L_0x0292:
        r2 = org.telegram.messenger.ApplicationLoader.applicationContext;	 Catch:{ Throwable -> 0x02bd }
        r4 = 2131165826; // 0x7f070282 float:1.794588E38 double:1.05293582E-314;
    ...
    public void loadHints(boolean z) {
        if (!this.loading && UserConfig.getInstance(this.currentAccount).suggestContacts) {
            if (!z) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_getTopPeers, new C3385-$$Lambda$DataQuery$pT1Y9otWt0WNp61eT_y0o9CzuLY(this));
            } else if (!this.loaded) {
                this.loading = true;
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0407-$$Lambda$DataQuery$lAwKQ3k2p-MRBgXcDMGAD4Or380(this));
                this.loaded = true;
            }
        }
    }
    ...
    public /* synthetic */ void lambda$loadHints$69$DataQuery() {
        ...
        try {
            ...
            AndroidUtilities.runOnUIThread(new C0414-$$Lambda$DataQuery$rnIvVF8aLiMm_ZCPm9Vn6vsrLWI(this, arrayList3, arrayList4, arrayList, arrayList2));
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }
    ...
    public /* synthetic */ void lambda$loadHints$74$DataQuery(TLObject tLObject, TL_error tL_error) {
        if (tLObject instanceof TL_contacts_topPeers) {
            AndroidUtilities.runOnUIThread(new C0410-$$Lambda$DataQuery$oRCKjdqN7faicjM2qImTY_wiotg(this, tLObject));
        } else if (tLObject instanceof TL_contacts_topPeersDisabled) {
            AndroidUtilities.runOnUIThread(new C0398-$$Lambda$DataQuery$g9_k4zEX2f9EpLAUA_w8HsokieE(this));
        }
    }
    ...
    public /* synthetic */ void lambda$null$72$DataQuery(TLObject tLObject) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.reloadHints, new Object[0]);
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.reloadInlineHints, new Object[0]);
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0393-$$Lambda$DataQuery$dzi9o0LNVO5dhAL5CQyt7dNBMiU(this, tL_contacts_topPeers));
    }
    ...
    public /* synthetic */ void lambda$null$71$DataQuery(TL_contacts_topPeers tL_contacts_topPeers) {
        try {
            ...
            executeFast.dispose();
            MessagesStorage.getInstance(this.currentAccount).getDatabase().commitTransaction();
            AndroidUtilities.runOnUIThread(new C0372-$$Lambda$DataQuery$SlSBEOrYr_Gu3TZ2prgLfFC7QFU(this));
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }
    ...
    public void clearTopPeers() {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.reloadHints, new Object[0]);
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.reloadInlineHints, new Object[0]);
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0361-$$Lambda$DataQuery$HUiUbvM6V-1I-4yUAM7UkocMBMA(this));
        buildShortcuts();
    }
    ...
    public void increaseInlineRaiting(int i) {
        if (UserConfig.getInstance(this.currentAccount).suggestContacts) {
            ...
            Collections.sort(this.inlineBots, C0370-$$Lambda$DataQuery$PxKOMpM0CQNQDkCfpxm9xlSwLx0.INSTANCE);
    ...
    public void removeInline(int i) {
        for (int i2 = 0; i2 < this.inlineBots.size(); i2++) {
            if (((TL_topPeer) this.inlineBots.get(i2)).peer.user_id == i) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_resetTopPeerRating, C3384-$$Lambda$DataQuery$nEW3BBG5NIOAbnpoGoJ7S4IYot0.INSTANCE);
                deletePeer(i, 1);
                NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.reloadInlineHints, new Object[0]);
                return;
            }
    ...
    public void removePeer(int i) {
        for (int i2 = 0; i2 < this.hints.size(); i2++) {
            if (((TL_topPeer) this.hints.get(i2)).peer.user_id == i) {
                ...
                tL_contacts_resetTopPeerRating.peer = MessagesController.getInstance(this.currentAccount).getInputPeer(i);
                deletePeer(i, 0);
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_resetTopPeerRating, C3381-$$Lambda$DataQuery$eHV0FXEJJkBEZzT5FGLWr-l3mT8.INSTANCE);
                return;
            }
        }
    }
        ...
        if (UserConfig.getInstance(this.currentAccount).suggestContacts) {
            ...
            if (i > 0) {
                ...
                if (!(user == null || user.bot || user.self)) {
                    MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0342-$$Lambda$DataQuery$5no8NqhTBSPD_1vCOByuz2PkDVw(this, j, i));
                }
            }
        }
    }
    ...
    public /* synthetic */ void lambda$increasePeerRaiting$81$DataQuery(long j, int i) {
        ...
        AndroidUtilities.runOnUIThread(new C0341-$$Lambda$DataQuery$5DGSvGUh65NYBwUAJYUrimvkN1o(this, i, d, j));
    }
    ...
    public /* synthetic */ void lambda$null$80$DataQuery(int i, double d, long j) {
        ...
        Collections.sort(this.hints, C0337-$$Lambda$DataQuery$12fipD1xacUTdjkG1gIFzgfExOI.INSTANCE);
    ...
    private void savePeer(int i, int i2, double d) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0420-$$Lambda$DataQuery$v4m2TDWRtPX_m91A0Er26YD_Gv8(this, i, i2, d));
    }
    ...
    private void deletePeer(int i, int i2) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0426-$$Lambda$DataQuery$zfORkxHX1nBnvnpPSEIl0qTrWEM(this, i, i2));
    }
    ...
    L_0x0068:
        r9 = "SavedMessages";
        r10 = 2131560633; // 0x7f0d08b9 float:1.8746644E38 double:1.053130881E-314;
    ...
    L_0x00b4:
        r12 = 1114112000; // 0x42680000 float:58.0 double:5.50444465E-315;
        r12 = org.telegram.messenger.AndroidUtilities.m26dp(r12);	 Catch:{ Throwable -> 0x0158 }
    ...
    L_0x012a:
        ...
        r8 = 2131165314; // 0x7f070082 float:1.7944842E38 double:1.0529355673E-314;
        r0 = r0.getDrawable(r8);	 Catch:{ Throwable -> 0x0158 }
        r8 = 1097859072; // 0x41700000 float:15.0 double:5.424144515E-315;
        r8 = org.telegram.messenger.AndroidUtilities.m26dp(r8);	 Catch:{ Throwable -> 0x0158 }
        r12 = r12 - r8;
        r9 = 1073741824; // 0x40000000 float:2.0 double:5.304989477E-315;
        r15 = org.telegram.messenger.AndroidUtilities.m26dp(r9);	 Catch:{ Throwable -> 0x0158 }
        r15 = r12 - r15;
        r9 = org.telegram.messenger.AndroidUtilities.m26dp(r9);	 Catch:{ Throwable -> 0x0158 }
        r12 = r12 - r9;
        r9 = r15 + r8;
        r8 = r8 + r12;
    ...
    L_0x0158:
        r0 = move-exception;
    L_0x0159:
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Exception -> 0x0249 }
    L_0x015c:
        r13 = r10;
    L_0x015d:
        r0 = android.os.Build.VERSION.SDK_INT;	 Catch:{ Exception -> 0x0249 }
        r8 = 26;
        r9 = 2131165312; // 0x7f070080 float:1.7944838E38 double:1.0529355663E-314;
        r10 = 2131165313; // 0x7f070081 float:1.794484E38 double:1.052935567E-314;
        r12 = 2131165311; // 0x7f07007f float:1.7944836E38 double:1.052935566E-314;
        r14 = 2131165315; // 0x7f070083 float:1.7944844E38 double:1.0529355677E-314;
    ...
    public MessageObject loadPinnedMessage(long j, int i, int i2, boolean z) {
        ...
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0400-$$Lambda$DataQuery$hzk0ktoumSLB8vFJVERgSnj2uGI(this, j, i, i2));
        return null;
    }
    ...
    L_0x0071:
        ...
        r12.f461id = r8;	 Catch:{ Exception -> 0x016f }
        r8 = 2;
    ...
    L_0x00b7:
        ...
        r5 = r8.f461id;	 Catch:{ Exception -> 0x016f }
    ...
    L_0x00e6:
        ...
        r1 = r0.f475id;	 Catch:{ Exception -> 0x016f }
        ...
        r3 = new org.telegram.messenger.-$$Lambda$DataQuery$sut4gZqSHSa63dx_2bNsxpC35Sk;	 Catch:{ Exception -> 0x016f }
    ...
    L_0x010f:
        ...
        r0.<init>();	 Catch:{ Exception -> 0x016f }
        r1 = r0.f506id;	 Catch:{ Exception -> 0x016f }
        r3 = java.lang.Integer.valueOf(r20);	 Catch:{ Exception -> 0x016f }
        r1.add(r3);	 Catch:{ Exception -> 0x016f }
        r1 = r7.currentAccount;	 Catch:{ Exception -> 0x016f }
        r1 = org.telegram.tgnet.ConnectionsManager.getInstance(r1);	 Catch:{ Exception -> 0x016f }
    ...
    private void savePinnedMessage(Message message) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0347-$$Lambda$DataQuery$9sCQAO18nnba6ToshnaeVPhZWRk(this, message));
    }
    ...
    public /* synthetic */ void lambda$savePinnedMessage$88$DataQuery(Message message) {
        try {
            ...
            if (message.to_id.channel_id != 0) {
                ...
                executeFast.requery();
                executeFast.bindLong(1, j);
                executeFast.bindInteger(2, message.f461id);
    ...
    private MessageObject broadcastPinnedMessage(Message message, ArrayList<User> arrayList, ArrayList<Chat> arrayList2, boolean z, boolean z2) {
        ...
        AndroidUtilities.runOnUIThread(new C0383-$$Lambda$DataQuery$Yx2wTX87h9OMWDNW8TJbWVjbdlk(this, arrayList, z, arrayList2, message, sparseArray, sparseArray2));
        return null;
    }
    ...
    public void loadReplyMessagesForMessages(ArrayList<MessageObject> arrayList, long j) {
        ...
        if (((int) j) == 0) {
            ...
            if (!arrayList3.isEmpty()) {
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0380-$$Lambda$DataQuery$WzRDIT94H3f0FgoSArkqNqup9dc(this, arrayList3, j, longSparseArray));
            } else {
                return;
            }
        }
        ...
        if (!arrayList3.isEmpty()) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0349-$$Lambda$DataQuery$BoxhS9ivFCv8Vy62eC0FaKjPf8o(this, stringBuilder, j, arrayList3, sparseArray, i2));
        }
    }
    ...
    public /* synthetic */ void lambda$loadReplyMessagesForMessages$91$DataQuery(ArrayList arrayList, long j, LongSparseArray longSparseArray) {
        try {
            ...
            AndroidUtilities.runOnUIThread(new C0381-$$Lambda$DataQuery$Xhb2v_0o_Dm3WG47KU6zYke67-0(this, j));
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }
        ...
        try {
            ...
            while (queryFinalized.next()) {
                ...
                if (byteBufferValue != null) {
                    ...
                    arrayList2.remove(Integer.valueOf(TLdeserialize.f461id));
                }
            }
            queryFinalized.dispose();
            String str = ",";
            ...
            if (!arrayList.isEmpty()) {
                if (i2 != 0) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getMessages, new C3373-$$Lambda$DataQuery$JW_1UL1JA9UbvXsdwarITz2ppQM(this, sparseArray2, j2));
                    return;
                }
                TL_messages_getMessages tL_messages_getMessages = new TL_messages_getMessages();
                tL_messages_getMessages.f506id = arrayList2;
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getMessages, new C3370-$$Lambda$DataQuery$DP0ftrGTBszIUd99KwPuGmnwqBM(this, sparseArray2, j2));
            }
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    ...
    private void saveReplyMessages(SparseArray<ArrayList<MessageObject>> sparseArray, ArrayList<Message> arrayList) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0360-$$Lambda$DataQuery$H2PEh31YFWmyOEdst-RwAHB_-gE(this, arrayList, sparseArray));
    }
    ...
    public /* synthetic */ void lambda$saveReplyMessages$95$DataQuery(ArrayList arrayList, SparseArray sparseArray) {
        try {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                Message message = (Message) arrayList.get(i);
                ArrayList arrayList2 = (ArrayList) sparseArray.get(message.f461id);
                if (arrayList2 != null) {
                    NativeByteBuffer nativeByteBuffer = new NativeByteBuffer(message.getObjectSize());
                    message.serializeToStream(nativeByteBuffer);
                    for (int i2 = 0; i2 < arrayList2.size(); i2++) {
    ...
    private void broadcastReplyMessages(ArrayList<Message> arrayList, SparseArray<ArrayList<MessageObject>> sparseArray, ArrayList<User> arrayList2, ArrayList<Chat> arrayList3, long j, boolean z) {
        ...
        for (int i = 0; i < arrayList2.size(); i++) {
            ...
            sparseArray2.put(user.f534id, user);
        }
        arrayList4 = arrayList2;
        SparseArray sparseArray3 = new SparseArray();
        for (int i2 = 0; i2 < arrayList3.size(); i2++) {
            Chat chat = (Chat) arrayList3.get(i2);
            sparseArray3.put(chat.f434id, chat);
        }
        AndroidUtilities.runOnUIThread(new C0404-$$Lambda$DataQuery$j3QDbBWi358gz3ac8yzLPqCuKcU(this, arrayList2, z, arrayList3, arrayList, sparseArray, sparseArray2, sparseArray3, j));
    }
    ...
    public /* synthetic */ void lambda$broadcastReplyMessages$96$DataQuery(ArrayList arrayList, boolean z, ArrayList arrayList2, ArrayList arrayList3, SparseArray sparseArray, SparseArray sparseArray2, SparseArray sparseArray3, long j) {
        ...
        for (int i = 0; i < arrayList3.size(); i++) {
            ...
            ArrayList arrayList5 = (ArrayList) sparseArray.get(message.f461id);
            if (arrayList5 != null) {
    ...
    L_0x01a0:
        ...
        r3 = r20[r2];
        r3 = r3.length();
        r4 = org.telegram.p004ui.Components.TypefaceSpan.class;
        r3 = r1.getSpans(r2, r3, r4);
        r3 = (org.telegram.p004ui.Components.TypefaceSpan[]) r3;
    ...
    L_0x0207:
        r3 = r20[r2];
        r3 = r3.length();
        r4 = org.telegram.p004ui.Components.URLSpanUserMention.class;
        r3 = r1.getSpans(r2, r3, r4);
        r3 = (org.telegram.p004ui.Components.URLSpanUserMention[]) r3;
    ...
    L_0x027c:
        r3 = r20[r2];
        r3 = r3.length();
        r4 = org.telegram.p004ui.Components.URLSpanReplacement.class;
        r3 = r1.getSpans(r2, r3, r4);
        r3 = (org.telegram.p004ui.Components.URLSpanReplacement[]) r3;
    ...
    public void loadDrafts() {
        if (!UserConfig.getInstance(this.currentAccount).draftsLoaded && !this.loadingDrafts) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_messages_getAllDrafts(), new C3368-$$Lambda$DataQuery$A03PPqgH8dlVye1igOOaKjX18Mo(this));
        }
    }
    ...
    public /* synthetic */ void lambda$loadDrafts$98$DataQuery(TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            AndroidUtilities.runOnUIThread(new C0376-$$Lambda$DataQuery$VlsaxyuL0jbFdSJtmR9unZb00xo(this));
        }
    }
    ...
    public void saveDraft(long j, CharSequence charSequence, ArrayList<MessageEntity> arrayList, Message message, boolean z, boolean z2) {
        ...
        if (message != null) {
            tL_draftMessageEmpty.reply_to_msg_id = message.f461id;
        ...
        if (z2 || !((draftMessage != null && draftMessage.message.equals(tL_draftMessageEmpty.message) && draftMessage.reply_to_msg_id == tL_draftMessageEmpty.reply_to_msg_id && draftMessage.no_webpage == tL_draftMessageEmpty.no_webpage) || (draftMessage == null && TextUtils.isEmpty(tL_draftMessageEmpty.message) && tL_draftMessageEmpty.reply_to_msg_id == 0))) {
            ...
            if (i != 0) {
                ...
                if (tL_messages_saveDraft.peer != null) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_saveDraft, C3383-$$Lambda$DataQuery$jWB8qVUldoWOaeSwZryuPoQq0I0.INSTANCE);
                } else {
                    return;
                }
            }
        ...
        if (z) {
            if (draftMessage.reply_to_msg_id != 0 && message == null) {
                ...
                if (!(user == null && chat == null)) {
                    ...
                    MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0364-$$Lambda$DataQuery$JgCeTQWWzbO2EPbV9fjIFzenxxY(this, j2, i2, j));
                }
            }
    ...
    public /* synthetic */ void lambda$saveDraft$102$DataQuery(long j, int i, long j2) {
        ...
        try {
            ...
            if (message != null) {
                ...
                tL_channels_getMessages.f475id.add(Integer.valueOf((int) j));
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getMessages, new C3372-$$Lambda$DataQuery$Fmy_RKu5TkGeEmPjdx9-EaHjKV0(this, j2));
            } else {
                TL_messages_getMessages tL_messages_getMessages = new TL_messages_getMessages();
                tL_messages_getMessages.f506id.add(Integer.valueOf((int) j));
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getMessages, new C3378-$$Lambda$DataQuery$a_Ly20evk0XxP_zooJOMw6rmEJc(this, j2));
            }
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    ...
    private void saveDraftReplyMessage(long j, Message message) {
        if (message != null) {
            AndroidUtilities.runOnUIThread(new C0390-$$Lambda$DataQuery$d7oypRr3g0xB92hPNQy49uD_p8A(this, j, message));
        }
    }

    public /* synthetic */ void lambda$saveDraftReplyMessage$103$DataQuery(long j, Message message) {
        DraftMessage draftMessage = (DraftMessage) this.drafts.get(j);
        if (draftMessage != null && draftMessage.reply_to_msg_id == message.f461id) {
            this.draftMessages.put(j, message);
    ...
    public void clearBotKeyboard(long j, ArrayList<Integer> arrayList) {
        AndroidUtilities.runOnUIThread(new C0340-$$Lambda$DataQuery$4JOcfs_Jho1Vm_zEM2xMi0yW30I(this, arrayList, j));
    }
    ...
    public void loadBotKeyboard(long j) {
        ...
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0351-$$Lambda$DataQuery$C70bX86RVrRMk7D3n7tAtGTuntU(this, j));
    }
    ...
    public /* synthetic */ void lambda$loadBotKeyboard$106$DataQuery(long j) {
        ...
        try {
            ...
            queryFinalized.dispose();
            if (message != null) {
                AndroidUtilities.runOnUIThread(new C0412-$$Lambda$DataQuery$pG7ILjNgxGBHl9Rr7Ps_HNlhdG8(this, message, j));
            }
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    ...
    public void loadBotInfo(int i, boolean z, int i2) {
        if (!z || ((BotInfo) this.botInfos.get(i)) == null) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0371-$$Lambda$DataQuery$RU0vB5vrHjb7JApo8zy3krcj73Y(this, i, i2));
            return;
        }
    ...
    public /* synthetic */ void lambda$loadBotInfo$108$DataQuery(int i, int i2) {
        ...
        try {
            ...
            queryFinalized.dispose();
            if (botInfo != null) {
                AndroidUtilities.runOnUIThread(new C0344-$$Lambda$DataQuery$8CCh4-uK8so3qsC-8J2GOPVArpo(this, botInfo, i2));
            }
        } catch (Exception e) {
            FileLog.m30e(e);
        }
        ...
        if (message != null) {
            try {
                ...
                if (i < message.f461id) {
                    ...
                    nativeByteBuffer.reuse();
                    executeFast.dispose();
                    AndroidUtilities.runOnUIThread(new C0397-$$Lambda$DataQuery$g5fV5AzEjpYa9k_FQikVmx9CWxY(this, j, message));
                }
            } catch (Exception e) {
                FileLog.m30e(e);
            }
    ...
    public /* synthetic */ void lambda$putBotKeyboard$109$DataQuery(long j, Message message) {
        ...
        if (message2 != null) {
            this.botKeyboardsByMids.delete(message2.f461id);
        }
        this.botKeyboardsByMids.put(message.f461id, j);
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.botKeyboardDidLoad, message, Long.valueOf(j));
    }
    ...
    public void putBotInfo(BotInfo botInfo) {
        if (botInfo != null) {
            ...
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0384-$$Lambda$DataQuery$Z9uUIzBqjWHBx6zjrK5T9uXZVkc(this, botInfo));
        }
    }
        ...
        if (strArr != null) {
            ...
            while (i < strArr.length) {
                ...
                if (!TextUtils.isEmpty(charSequence) && this.currentFetchingEmoji.get(charSequence) == null) {
                    ...
                    MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0369-$$Lambda$DataQuery$PLdKh5WsK6t3m__-OQnCRDAEWbk(this, charSequence));
                    i++;
                } else {
                    return;
                }
    ...
    public /* synthetic */ void lambda$null$115$DataQuery(int i, String str, String str2, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            if (i == -1 || tL_emojiKeywordsDifference.lang_code.equals(str)) {
                ...
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0416-$$Lambda$DataQuery$tmdFPTFKuPJBcR8hsRDSJe8XFo4(this, str2));
                return;
            }
        }
        AndroidUtilities.runOnUIThread(new C0346-$$Lambda$DataQuery$9eXVS7UU9pt2ANgZ-_XiV0PmN8Y(this, str2));
    }
    ...
    public /* synthetic */ void lambda$null$113$DataQuery(String str) {
        try {
            ...
            executeFast.step();
            executeFast.dispose();
            AndroidUtilities.runOnUIThread(new C0353-$$Lambda$DataQuery$DNPRuAZm79Q9W4IPII5JfioAwcA(this, str));
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }
    ...
    private void putEmojiKeywords(String str, TL_emojiKeywordsDifference tL_emojiKeywordsDifference) {
        if (tL_emojiKeywordsDifference != null) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0387-$$Lambda$DataQuery$_y89sXvt9qXhyQF6eZF_c0a7Hdc(this, tL_emojiKeywordsDifference, str));
        }
    }
    ...
    public /* synthetic */ void lambda$putEmojiKeywords$118$DataQuery(TL_emojiKeywordsDifference tL_emojiKeywordsDifference, String str) {
        try {
            ...
            executeFast.step();
            executeFast.dispose();
            AndroidUtilities.runOnUIThread(new C0373-$$Lambda$DataQuery$TyujBNGo6dMrF4_NTghE5U4jKgQ(this, str));
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }
    ...
    public void getEmojiSuggestions(String[] strArr, String str, boolean z, KeywordResultCallback keywordResultCallback, CountDownLatch countDownLatch) {
        if (keywordResultCallback != null) {
            ...
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0399-$$Lambda$DataQuery$gSc9XYndBuKxL05LBD_zU8iVGWA(this, strArr, keywordResultCallback, str, z, new ArrayList(Emoji.recentEmoji), countDownLatch));
    ...
    public /* synthetic */ void lambda$getEmojiSuggestions$122$DataQuery(String[] strArr, KeywordResultCallback keywordResultCallback, String str, boolean z, ArrayList arrayList, CountDownLatch countDownLatch) {
        ...
        if (obj == null) {
            AndroidUtilities.runOnUIThread(new C0356-$$Lambda$DataQuery$F5S3CTjE-FLA0OXEFvyeWWAj6H0(this, strArr2, keywordResultCallback2, arrayList2));
            return;
        }
        ...
        Collections.sort(arrayList2, new C0354-$$Lambda$DataQuery$EciNoKVivTg7lU2H2PBLqQwZEOk(arrayList));
        if (countDownLatch != null) {
            keywordResultCallback2.run(arrayList2, str2);
            countDownLatch.countDown();
        } else {
            AndroidUtilities.runOnUIThread(new C0378-$$Lambda$DataQuery$WcOlD4X1lYU5wXzTVWls1TBaRSM(keywordResultCallback2, arrayList2, str2));
        }
    }
