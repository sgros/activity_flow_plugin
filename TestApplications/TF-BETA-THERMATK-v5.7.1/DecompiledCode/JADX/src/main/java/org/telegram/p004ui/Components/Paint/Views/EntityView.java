...
public class EntityView extends FrameLayout {
    ...
    class C28951 extends SimpleOnGestureListener {
        C28951() {
        }
    ...
    public class SelectionView extends FrameLayout {
        ...
        public SelectionView(Context context) {
            ...
            this.dotStrokePaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.0f));
        }
        ...
        public void updatePosition() {
            ...
            layoutParams.leftMargin = ((int) selectionBounds.f602x) + EntityView.this.offsetX;
            layoutParams.topMargin = ((int) selectionBounds.f603y) + EntityView.this.offsetY;
     ...
     */
        ...
        L_0x001c:
            r0 = r12.getRawX();
            r2 = r12.getRawY();
            r3 = org.telegram.p004ui.Components.Paint.Views.EntityView.this;
            r2 = r3.onTouchMove(r0, r2);
            goto L_0x0130;
        L_0x002c:
            if (r0 == 0) goto L_0x0130;
        L_0x002e:
            r0 = org.telegram.p004ui.Components.Paint.Views.EntityView.this;
            r0.hasTransformed = r3;
            r0 = new org.telegram.ui.Components.Point;
            r2 = r12.getRawX();
            r5 = org.telegram.p004ui.Components.Paint.Views.EntityView.this;
            r5 = r5.previousLocationX;
            r2 = r2 - r5;
            r5 = r12.getRawY();
            r6 = org.telegram.p004ui.Components.Paint.Views.EntityView.this;
        ...
        L_0x007b:
            ...
            r0 = r0 / r5;
            r0 = r0 + r2;
            r2 = org.telegram.p004ui.Components.Paint.Views.EntityView.this;
            r2.scale(r0);
            r0 = r11.getLeft();
            r2 = r11.getWidth();
            r2 = r2 / r4;
        ...
        L_0x013d:
            return r2;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.Paint.Views.EntityView$SelectionView.onTouchEvent(android.view.MotionEvent):boolean");
        }
    }
    ...
    public EntityView(Context context, Point point) {
        super(context);
        this.position = point;
        this.gestureDetector = new GestureDetector(context, new C28951());
    }
    ...
    private boolean onTouchMove(float f, float f2) {
        ...
        if (((float) Math.hypot((double) point.f600x, (double) point.f601y)) <= (this.hasPanned ? 6.0f : 16.0f)) {
            return false;
        }
        pan(point);
    ...
    L_0x0053:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.Paint.Views.EntityView.onTouchEvent(android.view.MotionEvent):boolean");
    }

    public void pan(Point point) {
        Point point2 = this.position;
        point2.f600x += point.f600x;
        point2.f601y += point.f601y;
        updatePosition();
    }
    ...
    public void updatePosition() {
        ...
        setX(this.position.f600x - (((float) getWidth()) / 2.0f));
        setY(this.position.f601y - height);
        updateSelectionView();
    }
