...
public class SerializedData extends AbstractSerializedData {
    /* renamed from: in */
    private DataInputStream f631in;
    ...
    public byte[] readByteArray(boolean r7) {
        /*
        r6 = this;
        r0 = r6.f631in;	 Catch:{ Exception -> 0x0051 }
        ...
        r0 = r6.f631in;	 Catch:{ Exception -> 0x0051 }
        r0 = r0.read();	 Catch:{ Exception -> 0x0051 }
        r1 = r6.f631in;	 Catch:{ Exception -> 0x0051 }
        ...
        r5 = r6.f631in;	 Catch:{ Exception -> 0x0051 }
        ...
        org.telegram.messenger.FileLog.m28e(r1);
        r7 = 0;
        return r7;
    ...
    public java.lang.String readString(boolean r7) {
        /*
        r6 = this;
        r0 = r6.f631in;	 Catch:{ Exception -> 0x0058 }
        ...
        r0 = r6.f631in;	 Catch:{ Exception -> 0x0058 }
        r0 = r0.read();	 Catch:{ Exception -> 0x0058 }
        r1 = r6.f631in;	 Catch:{ Exception -> 0x0058 }
        ...
        r5 = r6.f631in;	 Catch:{ Exception -> 0x0058 }
    ...
    public SerializedData(byte[] bArr) {
        ...
        this.f631in = new DataInputStream(this.inbuf);
        this.len = 0;
    }
        ...
        while (i2 < 4) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m28e("write int32 error");
                    return;
                }
                return;
            }
    ...
    private void writeInt64(long j, DataOutputStream dataOutputStream) {
        ...
        while (i < 8) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m28e("write int64 error");
                    return;
                }
                return;
            }
    ...
    public void writeBytes(byte[] bArr, int i, int i2) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m28e("write bytes error");
            }
        }
    }
    ...
    public void writeByteArray(byte[] bArr) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m28e("write byte array error");
            }
        }
    }
    ...
    public void writeString(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m28e("write string error");
            }
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m28e("write double error");
            }
        }
    }
    ...
    public void skip(int i) {
        if (i != 0) {
            if (this.justCalc) {
                ...
                DataInputStream dataInputStream = this.f631in;
