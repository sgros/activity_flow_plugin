...
public class FileLoadOperation {
    ...
    public FileLoadOperation(ImageLocation imageLocation, Object obj, String str, int i) {
        ...
        if (imageLocation.isEncrypted()) {
            ...
            this.f50iv = new byte[32];
            byte[] bArr = imageLocation.f53iv;
            byte[] bArr2 = this.f50iv;
            ...
            if (imageLocation.photoId != 0) {
                ...
                inputFileLocation = this.location;
                inputFileLocation.f455id = imageLocation.photoId;
                tL_fileLocationToBeDeprecated = imageLocation.location;
                ...
                inputFileLocation = this.location;
                inputFileLocation.f455id = imageLocation.documentId;
                tL_fileLocationToBeDeprecated = imageLocation.location;
                inputFileLocation.volume_id = tL_fileLocationToBeDeprecated.volume_id;
                inputFileLocation.local_id = tL_fileLocationToBeDeprecated.local_id;
                inputFileLocation.access_hash = imageLocation.access_hash;
    ...
    public FileLoadOperation(SecureDocument secureDocument) {
        ...
        inputFileLocation.f455id = tL_secureFile.f561id;
    ...
    L_0x0015:
        ...
        r4 = r7.f441id;	 Catch:{ Exception -> 0x0107 }
        r8.f455id = r4;	 Catch:{ Exception -> 0x0107 }
        r8 = r6.location;	 Catch:{ Exception -> 0x0107 }
        ...
        r6.f50iv = r8;	 Catch:{ Exception -> 0x0107 }
        r8 = r7.f442iv;	 Catch:{ Exception -> 0x0107 }
        r4 = r6.f50iv;	 Catch:{ Exception -> 0x0107 }
        r5 = r6.f50iv;	 Catch:{ Exception -> 0x0107 }
    ...
    public File getCurrentFile() {
        ...
        Utilities.stageQueue.postRunnable(new C0440-$$Lambda$FileLoadOperation$sszlpx-7B35gY8yLDFGHhHn8Nio(this, fileArr, countDownLatch));
        try {
    ...
    public int getDownloadedLengthFromOffset(int i, int i2) {
        CountDownLatch countDownLatch = new CountDownLatch(1);
        int[] iArr = new int[1];
        Utilities.stageQueue.postRunnable(new C0432-$$Lambda$FileLoadOperation$7ur7HYEmrvSDh4lwc7_mdrw1G5A(this, iArr, i, i2, countDownLatch));
        try {
            countDownLatch.await();
    ...
    public void removeStreamListener(FileStreamLoadOperation fileStreamLoadOperation) {
        Utilities.stageQueue.postRunnable(new C0439-$$Lambda$FileLoadOperation$pRXavC_xR0CSUF8u1ykitHqvWcY(this, fileStreamLoadOperation));
    }
    ...
    L_0x040c:
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Exception -> 0x0414 }
    L_0x0410:
    ...
    L_0x053a:
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Exception -> 0x0547 }
    L_0x053e:
        r0 = r1.preloadStream;	 Catch:{ Exception -> 0x0547 }
    ...
    L_0x06c9:
        ...
        r2 = r1.f50iv;	 Catch:{ Exception -> 0x06d8 }
        r3 = 0;
    ...
    public void setIsPreloadVideoOperation(boolean z) {
        ...
        if (z || !this.isPreloadVideoOperation) {
            ...
            Utilities.stageQueue.postRunnable(new C0438-$$Lambda$FileLoadOperation$dCUC8Z2YsvYYD1fE6icyc8raIws(this, z));
        } else {
            this.isPreloadVideoOperation = z;
        }
    }
    ...
    public void cancel() {
        Utilities.stageQueue.postRunnable(new C0435-$$Lambda$FileLoadOperation$J6yoj3V6lUrD2GOh_IqPARM2LhA(this));
    }
        ...
        try {
            if (this.filePartsStream != null) {
                try {
                    ...
                    FileLog.m30e(e222222);
                }
                this.filePartsStream.close();
                this.filePartsStream = null;
            }
        } catch (Exception e2222222) {
            FileLog.m30e(e2222222);
        }
        try {
            if (this.fiv != null) {
                this.fiv.close();
                ...
                if (file != null) {
                    ...
                    if (!(this.ungzip || this.cacheFileTemp.renameTo(this.cacheFileFinal))) {
                        ...
                        if (this.renameRetryCount < 3) {
                            this.state = 1;
                            Utilities.stageQueue.postRunnable(new C0437-$$Lambda$FileLoadOperation$Pg1188DV6hLAQ13wzfrMjXc2Ie0(this, z), 200);
                            return;
                        }
        ...
        do {
            if (i >= i2 - (this.preloadTempBuffer != null ? 16 : 0)) {
                ...
                if (i < i3) {
                    ...
                    bArr = this.preloadTempBuffer;
                    i4 = ((((bArr[0] & NalUnitUtil.EXTENDED_SAR) << 24) + ((bArr[1] & NalUnitUtil.EXTENDED_SAR) << 16)) + ((bArr[2] & NalUnitUtil.EXTENDED_SAR) << 8)) + (bArr[3] & NalUnitUtil.EXTENDED_SAR);
                    if (i4 == 0) {
                        return 0;
                    }
                    if (i4 == 1) {
                        i4 = ((((bArr[12] & NalUnitUtil.EXTENDED_SAR) << 24) + ((bArr[13] & NalUnitUtil.EXTENDED_SAR) << 16)) + ((bArr[14] & NalUnitUtil.EXTENDED_SAR) << 8)) + (bArr[15] & NalUnitUtil.EXTENDED_SAR);
                    }
    ...
    private void requestFileOffsets(int i) {
        if (!this.requestingCdnOffsets) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_upload_getCdnFileHashes, new C3396-$$Lambda$FileLoadOperation$AloCOvGHlndklEjA6lccwgvlez8(this), null, null, 0, this.datacenterId, 1, true);
        }
    }
    ...
    L_0x0114:
        ...
        org.telegram.messenger.FileLog.m27d(r2);	 Catch:{ Exception -> 0x0498 }
    L_0x013c:
    ...
    L_0x022d:
        ...
        r11 = r1.f50iv;	 Catch:{ Exception -> 0x0498 }
        r17 = 0;
        r18 = 1;
        r19 = 0;
    ...
    L_0x02a3:
        ...
        org.telegram.messenger.FileLog.m27d(r3);	 Catch:{ Exception -> 0x0498 }
    L_0x02c3:
    ...
    L_0x0369:
        ...
        r3 = r1.location;	 Catch:{ Exception -> 0x0498 }
        r3 = r3.f455id;	 Catch:{ Exception -> 0x0498 }
        r0.append(r3);	 Catch:{ Exception -> 0x0498 }
        ...
        org.telegram.messenger.FileLog.m28e(r0);	 Catch:{ Exception -> 0x0498 }
        goto L_0x03dc;
    L_0x03b8:
    ...
    L_0x03f5:
        ...
        r0 = r1.fiv;	 Catch:{ Exception -> 0x0498 }
        r2 = r1.f50iv;	 Catch:{ Exception -> 0x0498 }
    ...
    public void onFail(boolean z, int i) {
        ...
        this.state = 2;
        if (z) {
            Utilities.stageQueue.postRunnable(new C0433-$$Lambda$FileLoadOperation$9spswKeKfAcOLWXDEy_zgCWBTtA(this, i));
        } else {
    ...
    public void startDownloadRequest() {
        if (!this.paused && this.state == 1 && ((this.nextPartWasPreloaded || this.requestInfos.size() + this.delayedRequestInfos.size() < this.currentMaxDownloadRequests) && (!this.isPreloadVideoOperation || (this.requestedBytesCount <= preloadMaxBytes && (this.moovFound == 0 || this.requestInfos.size() <= 0))))) {
            ...
            while (i < max) {
                ...
                if (!this.isPreloadVideoOperation) {
                    ...
                    if (size == -1) {
                        Object obj;
                        i2 = 0;
                        for (size = (preloadMaxBytes / this.currentDownloadChunkSize) + 2; size != 0; size--) {
                    ...
                    if (sparseArray != null) {
                        ...
                        if (preloadRange != null) {
                            ...
                            try {
                                ...
                                Utilities.stageQueue.postRunnable(new C0434-$$Lambda$FileLoadOperation$CkXyQ6ScRYNY6TMd6qRPWNLnxAA(this, requestInfo));
                            } catch (Exception unused) {
                            }
                            i++;
                        }
                ...
                requestInfo.requestToken = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject, new C3398-$$Lambda$FileLoadOperation$pLwgbN71WnWYsTs7i_Ie2IK-Sjs(this, requestInfo, tLObject), null, null, i9, this.isCdn ? this.cdnDatacenterId : this.datacenterId, i7, z);
                this.requestsCount++;
                i++;
            }
        }
    ...
    public /* synthetic */ void lambda$startDownloadRequest$12$FileLoadOperation(RequestInfo requestInfo, TLObject tLObject, TLObject tLObject2, TL_error tL_error) {
        if (this.requestInfos.contains(requestInfo)) {
            ...
            if (tLObject2 instanceof TL_upload_fileCdnRedirect) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_upload_reuploadCdnFile, new C3397-$$Lambda$FileLoadOperation$_RANhbuGWnPnpbUnhksdq4cjW2c(this, requestInfo), null, null, 0, this.datacenterId, 1, true);
            }
        }
    }
