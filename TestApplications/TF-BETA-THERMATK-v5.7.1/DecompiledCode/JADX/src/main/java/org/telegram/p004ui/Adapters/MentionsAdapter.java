...
import org.telegram.p004ui.Cells.BotSwitchCell;
import org.telegram.p004ui.Cells.ContextLinkCell;
import org.telegram.p004ui.Cells.MentionCell;
...
public class MentionsAdapter extends SelectionAdapter {
    ...
    private LocationProvider locationProvider = new LocationProvider(new C39191()) {
        public void stop() {
            super.stop();
    ...
    class C39191 implements LocationProviderDelegate {
        C39191() {
        }
    ...
    class C39213 implements SearchAdapterHelperDelegate {
    ...
    public MentionsAdapter(Context context, boolean z, long j, MentionsAdapterDelegate mentionsAdapterDelegate) {
        ...
        this.searchAdapterHelper.setDelegate(new C39213());
    }
    ...
    public int getContextBotId() {
        ...
        return user != null ? user.f534id : 0;
    }
    ...
    private void processFoundUser(User user) {
        ...
        if (user == null || !user.bot || user.bot_inline_placeholder == null) {
            ...
            if (this.foundContextBot.bot_inline_geo) {
                ...
                stringBuilder.append(this.foundContextBot.f534id);
                if (!notificationsSettings.getBoolean(stringBuilder.toString(), false)) {
                    ...
                    if (!(chatActivity == null || chatActivity.getParentActivity() == null)) {
                        ...
                        builder.setMessage(LocaleController.getString("ShareYouLocationInline", C1067R.string.ShareYouLocationInline));
                        boolean[] zArr = new boolean[1];
                        builder.setPositiveButton(LocaleController.getString("OK", C1067R.string.f61OK), new C2251-$$Lambda$MentionsAdapter$3hBy3ePtH3hOR9uoZtzoQOcheTs(this, zArr, user));
                        builder.setNegativeButton(LocaleController.getString("Cancel", C1067R.string.Cancel), new C2254-$$Lambda$MentionsAdapter$CT1DE5mOMJY5cACE3GAb-uXrprc(this, zArr));
                        this.parentFragment.showDialog(builder.create(), new C2256-$$Lambda$MentionsAdapter$MgskdrDXUdlxFwtdPn3PQRymvWA(this, zArr));
                    }
                }
    ...
    L_0x00e7:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.MentionsAdapter.searchForContextBot(java.lang.String, java.lang.String):void");
    }
    ...
    L_0x0036:
        ...
        r13 = -4571364728013586432; // 0xc08f400000000000 float:0.0 double:-1000.0;
    ...
    L_0x00cf:
        r1 = r1.getLatitude();
        r3 = -4571364728013586432; // 0xc08f400000000000 float:0.0 double:-1000.0;
    ...
    L_0x012c:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.MentionsAdapter.searchForContextBotResults(boolean, org.telegram.tgnet.TLRPC$User, java.lang.String, java.lang.String):void");
    }
    ...
    public /* synthetic */ void lambda$searchForContextBotResults$4$MentionsAdapter(String str, boolean z, User user, String str2, MessagesStorage messagesStorage, String str3, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2255-$$Lambda$MentionsAdapter$HVDPv79fAM1RehGsWWysAxv-W1Q(this, str, z, tLObject, user, str2, messagesStorage, str3));
    }
    ...
    L_0x03eb:
        r4 = r2.get(r3);
        r4 = (org.telegram.p004ui.Adapters.SearchAdapterHelper.HashtagObject) r4;
    ...
    L_0x04e5:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.MentionsAdapter.searchUsernameOrHashtag(java.lang.String, int, java.util.ArrayList, boolean):void");
    }

    static /* synthetic */ int lambda$searchUsernameOrHashtag$5(SparseArray sparseArray, ArrayList arrayList, User user, User user2) {
        if (sparseArray.indexOfKey(user.f534id) >= 0 && sparseArray.indexOfKey(user2.f534id) >= 0) {
            return 0;
        }
        ...
        int i = 1;
        if (sparseArray.indexOfKey(user2.f534id) >= 0) {
            return 1;
        }
        int indexOf = arrayList.indexOf(Integer.valueOf(user.f534id));
        int indexOf2 = arrayList.indexOf(Integer.valueOf(user2.f534id));
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            mentionCell.setDelegate(new C3912-$$Lambda$MentionsAdapter$VoCNDYNNW-mhCQ-lScxh9-TCNkI(this));
        } else if (i != 2) {
            mentionCell = new TextView(this.mContext);
            mentionCell.setPadding(AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(8.0f));
            ...
            if (currentChat != null) {
                if (!ChatObject.hasAdminRights(currentChat)) {
                    ...
                    if (tL_chatBannedRights != null && tL_chatBannedRights.send_inline) {
                        textView.setText(LocaleController.getString("GlobalAttachInlineRestricted", C1067R.string.GlobalAttachInlineRestricted));
                        return;
                    }
                }
                if (AndroidUtilities.isBannedForever(currentChat.banned_rights)) {
                    textView.setText(LocaleController.getString("AttachInlineRestrictedForever", C1067R.string.AttachInlineRestrictedForever));
                } else {
                    textView.setText(LocaleController.formatString("AttachInlineRestricted", C1067R.string.AttachInlineRestricted, LocaleController.formatDateForBan((long) currentChat.banned_rights.until_date)));
                }
            }
