...
public class TimerDrawable extends Drawable {
    ...
    public TimerDrawable(Context context) {
        ...
        this.timePaint.setTextSize((float) AndroidUtilities.m26dp(11.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        int i = this.time;
        String str = Theme.key_chat_secretTimerBackground;
        String str2 = Theme.key_chat_secretTimerText;
        if (i == 0) {
            ...
            canvas2.drawLine((float) AndroidUtilities.m26dp(9.0f), (float) AndroidUtilities.m26dp(9.0f), (float) AndroidUtilities.m26dp(13.0f), (float) AndroidUtilities.m26dp(9.0f), this.linePaint);
            canvas2.drawLine((float) AndroidUtilities.m26dp(9.0f), (float) AndroidUtilities.m26dp(5.0f), (float) AndroidUtilities.m26dp(9.0f), (float) AndroidUtilities.m26dp(9.5f), this.linePaint);
            ...
            canvas.drawCircle((float) AndroidUtilities.m26dp(9.5f), (float) AndroidUtilities.m26dp(9.5f), (float) AndroidUtilities.m26dp(9.5f), this.paint);
        }
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m26dp(19.0f);
    }
