...
public class ProxyDrawable extends Drawable {
    ...
    public ProxyDrawable(Context context) {
        this.emptyDrawable = context.getResources().getDrawable(C1067R.C1065drawable.proxy_off);
        this.fullDrawable = context.getResources().getDrawable(C1067R.C1065drawable.proxy_on);
    ...
    public void draw(Canvas canvas) {
        ...
        if (!this.isEnabled) {
            ...
            width = (width / 2) - AndroidUtilities.m26dp(3.0f);
            int height = (getBounds().height() / 2) - AndroidUtilities.m26dp(3.0f);
            this.cicleRect.set((float) width, (float) height, (float) (width + AndroidUtilities.m26dp(6.0f)), (float) (height + AndroidUtilities.m26dp(6.0f)));
