...
public class HeaderCell extends FrameLayout {
    ...
    public HeaderCell(Context context, boolean z, int i, int i2, boolean z2) {
        ...
        this.textView.setMinHeight(AndroidUtilities.m26dp((float) (this.height - i3)));
        if (z) {
    ...
    public void setHeight(int i) {
        this.textView.setMinHeight(AndroidUtilities.m26dp((float) this.height) - ((LayoutParams) this.textView.getLayoutParams()).topMargin);
    }
