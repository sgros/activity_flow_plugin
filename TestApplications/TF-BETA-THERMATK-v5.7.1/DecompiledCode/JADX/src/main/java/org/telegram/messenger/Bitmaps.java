...
public class Bitmaps {
    ...
    private static final ThreadLocal<byte[]> jpegData = new C10191();
    private static volatile Matrix sScaleMatrix;

    /* renamed from: org.telegram.messenger.Bitmaps$1 */
    static class C10191 extends ThreadLocal<byte[]> {
        C10191() {
        }
    ...
    static /* synthetic */ class C10202 {
        ...
        L_0x0035:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.Bitmaps$C10202.<clinit>():void");
        }
    }
    ...
    public static Bitmap createBitmap(Bitmap bitmap, int i, int i2, int i3, int i4, Matrix matrix, boolean z) {
        ...
        if (i5 <= bitmap.getWidth()) {
            ...
            if (i6 > bitmap.getHeight()) {
                ...
                if (config2 != null) {
                    i2 = C10202.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
                    if (i2 == 1) {
