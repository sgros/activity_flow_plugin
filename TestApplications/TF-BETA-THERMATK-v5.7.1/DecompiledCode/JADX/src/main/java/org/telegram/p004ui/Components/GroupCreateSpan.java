...
public class GroupCreateSpan extends View {
    ...
    public GroupCreateSpan(android.content.Context r22, org.telegram.tgnet.TLObject r23, org.telegram.messenger.ContactsController.Contact r24) {
        ...
        r3 = r21.getResources();
        r4 = 2131165372; // 0x7f0700bc float:1.794496E38 double:1.052935596E-314;
    ...
    L_0x00c4:
        r2 = 1136066560; // 0x43b70000 float:366.0 double:5.612914587E-315;
    ...
    L_0x00cd:
        ...
        r3 = 1126432768; // 0x43240000 float:164.0 double:5.56531733E-315;
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r3);
        r2 = r2 - r3;
        r2 = r2 / 2;
    L_0x00e0:
    ...
    L_0x0124:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.GroupCreateSpan.<init>(android.content.Context, org.telegram.tgnet.TLObject, org.telegram.messenger.ContactsController$Contact):void");
    }
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m26dp(57.0f) + this.textWidth, AndroidUtilities.m26dp(32.0f));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.save();
        this.rect.set(0.0f, 0.0f, (float) getMeasuredWidth(), (float) AndroidUtilities.m26dp(32.0f));
        ...
        canvas.drawRoundRect(this.rect, (float) AndroidUtilities.m26dp(16.0f), (float) AndroidUtilities.m26dp(16.0f), backPaint);
        ...
        if (this.progress != 0.0f) {
            ...
            canvas.drawCircle((float) AndroidUtilities.m26dp(16.0f), (float) AndroidUtilities.m26dp(16.0f), (float) AndroidUtilities.m26dp(16.0f), backPaint);
            canvas.save();
            canvas.rotate((1.0f - this.progress) * 45.0f, (float) AndroidUtilities.m26dp(16.0f), (float) AndroidUtilities.m26dp(16.0f));
            this.deleteDrawable.setBounds(AndroidUtilities.m26dp(11.0f), AndroidUtilities.m26dp(11.0f), AndroidUtilities.m26dp(21.0f), AndroidUtilities.m26dp(21.0f));
            this.deleteDrawable.setAlpha((int) (this.progress * 255.0f));
            this.deleteDrawable.draw(canvas);
            canvas.restore();
        }
        canvas.translate(this.textX + ((float) AndroidUtilities.m26dp(41.0f)), (float) AndroidUtilities.m26dp(8.0f));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (isDeleting() && VERSION.SDK_INT >= 21) {
            accessibilityNodeInfo.addAction(new AccessibilityAction(AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString("Delete", C1067R.string.Delete)));
        }
    }
}
