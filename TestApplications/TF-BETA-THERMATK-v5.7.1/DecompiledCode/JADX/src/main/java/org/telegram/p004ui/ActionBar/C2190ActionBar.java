...
import org.telegram.p004ui.Components.FireworksEffect;
import org.telegram.p004ui.Components.LayoutHelper;
import org.telegram.p004ui.Components.SnowflakesEffect;

/* renamed from: org.telegram.ui.ActionBar.ActionBar */
public class C2190ActionBar extends FrameLayout {
    ...
    class C21892 extends AnimatorListenerAdapter {
        C21892() {
        }

        public void onAnimationEnd(Animator animator) {
            if (C2190ActionBar.this.actionModeAnimation != null && C2190ActionBar.this.actionModeAnimation.equals(animator)) {
                C2190ActionBar.this.actionModeAnimation = null;
                C2190ActionBar.this.actionMode.setVisibility(4);
                if (C2190ActionBar.this.occupyStatusBar && C2190ActionBar.this.actionModeTop != null) {
                    C2190ActionBar.this.actionModeTop.setVisibility(4);
                }
                if (C2190ActionBar.this.actionModeExtraView != null) {
                    C2190ActionBar.this.actionModeExtraView.setVisibility(4);
                }
            }
        }
    ...
    public C2190ActionBar(Context context) {
        super(context);
        this.occupyStatusBar = VERSION.SDK_INT >= 21;
        this.addToContainer = true;
        this.interceptTouches = true;
        this.castShadows = true;
        setOnClickListener(new C2148-$$Lambda$ActionBar$ipLNSE-u7HuyPKHoD94Vr_WlQ-U(this));
    }
    ...
    private void createBackButtonImage() {
        if (this.backButtonImageView == null) {
            ...
            this.backButtonImageView.setPadding(AndroidUtilities.m26dp(1.0f), 0, 0, 0);
            addView(this.backButtonImageView, LayoutHelper.createFrame(54, 54, 51));
            this.backButtonImageView.setOnClickListener(new C2147-$$Lambda$ActionBar$VS8eczH_GWXmmp1KP0J3EUbIWcg(this));
            this.backButtonImageView.setContentDescription(LocaleController.getString("AccDescrGoBack", C1067R.string.AccDescrGoBack));
        }
    }
    ...
    public ActionBarMenu createActionMode(boolean z) {
        ...
        actionBarMenu.setBackgroundColor(Theme.getColor(Theme.key_actionBarActionModeDefault));
        ...
        if (this.actionMode != null && !this.actionModeVisible) {
            ...
            this.actionModeAnimation.addListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
                    C2190ActionBar.this.actionMode.setVisibility(0);
                    if (C2190ActionBar.this.occupyStatusBar && C2190ActionBar.this.actionModeTop != null) {
                        C2190ActionBar.this.actionModeTop.setVisibility(0);
                    }
                }
                ...
                public void onAnimationEnd(Animator animator) {
                    if (C2190ActionBar.this.actionModeAnimation != null && C2190ActionBar.this.actionModeAnimation.equals(animator)) {
                        C2190ActionBar.this.actionModeAnimation = null;
                        if (C2190ActionBar.this.titleTextView != null) {
                            C2190ActionBar.this.titleTextView.setVisibility(4);
                        }
                        if (!(C2190ActionBar.this.subtitleTextView == null || TextUtils.isEmpty(C2190ActionBar.this.subtitleTextView.getText()))) {
                            C2190ActionBar.this.subtitleTextView.setVisibility(4);
                        }
                        if (C2190ActionBar.this.menu != null) {
                            C2190ActionBar.this.menu.setVisibility(4);
                        }
                        if (C2190ActionBar.this.actionModeHidingViews != null) {
                            int i = 0;
                            while (i < C2190ActionBar.this.actionModeHidingViews.length) {
                                if (C2190ActionBar.this.actionModeHidingViews[i] != null) {
                                    boolean[] zArr = zArr;
                                    if (zArr == null || i >= zArr.length || zArr[i]) {
                                        C2190ActionBar.this.actionModeHidingViews[i].setVisibility(4);
                                    }
                                }
                                i++;
                            }
    ...
    public void hideActionMode() {
        ...
        if (actionBarMenu != null && this.actionModeVisible) {
            ...
            this.actionModeAnimation.playTogether(arrayList);
            this.actionModeAnimation.setDuration(200);
            this.actionModeAnimation.addListener(new C21892());
            this.actionModeAnimation.start();
    ...
    L_0x0074:
        r13 = 1104150528; // 0x41d00000 float:26.0 double:5.455228437E-315;
        goto L_0x0079;
    L_0x0077:
    ...
    L_0x0093:
        r5 = 1116995584; // 0x42940000 float:74.0 double:5.518691446E-315;
        goto L_0x0098;
    L_0x0096:
        r5 = 1115947008; // 0x42840000 float:66.0 double:5.51351079E-315;
    L_0x0098:
        r5 = org.telegram.messenger.AndroidUtilities.m26dp(r5);
        r5 = r0 - r5;
        r5 = android.view.View.MeasureSpec.makeMeasureSpec(r5, r1);
    ...
    L_0x01c3:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ActionBar.C2190ActionBar.onMeasure(int, int):void");
    }
    ...
    L_0x002b:
        ...
        goto L_0x0030;
    L_0x002e:
        r1 = 1116733440; // 0x42900000 float:72.0 double:5.517396283E-315;
    L_0x0030:
    ...
    L_0x003b:
        r1 = 1104150528; // 0x41d00000 float:26.0 double:5.455228437E-315;
        goto L_0x0040;
    L_0x003e:
    ...
    L_0x0058:
        r3 = 1116995584; // 0x42940000 float:74.0 double:5.518691446E-315;
        goto L_0x005d;
    L_0x005b:
        r3 = 1115947008; // 0x42840000 float:66.0 double:5.51351079E-315;
    L_0x005d:
    ...
    L_0x0091:
        r3 = org.telegram.p004ui.ActionBar.C2190ActionBar.getCurrentActionBarHeight();
        r3 = r3 / r4;
    ...
    L_0x00e3:
        r3 = org.telegram.p004ui.ActionBar.C2190ActionBar.getCurrentActionBarHeight();
        r3 = r3 / r4;
        r5 = org.telegram.p004ui.ActionBar.C2190ActionBar.getCurrentActionBarHeight();
        r5 = r5 / r4;
    ...
    L_0x019e:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ActionBar.C2190ActionBar.onLayout(boolean, int, int, int, int):void");
    }
    ...
    public static int getCurrentActionBarHeight() {
        if (AndroidUtilities.isTablet()) {
            return AndroidUtilities.m26dp(64.0f);
        }
        Point point = AndroidUtilities.displaySize;
        if (point.x > point.y) {
            return AndroidUtilities.m26dp(48.0f);
        }
        return AndroidUtilities.m26dp(56.0f);
    }
}
