...
public class C0278PhoneFormat {
    private static volatile C0278PhoneFormat Instance;
    ...
    public void init(java.lang.String r8) {
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.PhoneFormat.C0278PhoneFormat.init(java.lang.String):void");
    }

    public static C0278PhoneFormat getInstance() {
        C0278PhoneFormat c0278PhoneFormat = Instance;
        if (c0278PhoneFormat == null) {
            synchronized (C0278PhoneFormat.class) {
                c0278PhoneFormat = Instance;
                if (c0278PhoneFormat == null) {
                    c0278PhoneFormat = new C0278PhoneFormat();
                    Instance = c0278PhoneFormat;
                }
            }
        }
        return c0278PhoneFormat;
    }
    ...
    public static String stripExceptNumbers(String str) {
        return C0278PhoneFormat.stripExceptNumbers(str, false);
    }

    public C0278PhoneFormat() {
        init(null);
    }

    public C0278PhoneFormat(String str) {
        init(str);
    }
    ...
    public String format(String str) {
        ...
        try {
            String strip = C0278PhoneFormat.strip(str);
    ...
    public boolean isPhoneNumberValid(String str) {
        ...
        str = C0278PhoneFormat.strip(str);
    ...
    public CallingCodeInfo callingCodeInfo(String str) {
        C0278PhoneFormat c0278PhoneFormat = this;
        String str2 = str;
        CallingCodeInfo callingCodeInfo = (CallingCodeInfo) c0278PhoneFormat.callingCodeData.get(str2);
        if (callingCodeInfo != null) {
            return callingCodeInfo;
        }
        Integer num = (Integer) c0278PhoneFormat.callingCodeOffsets.get(str2);
        if (num == null) {
            return callingCodeInfo;
        }
        byte[] bArr = c0278PhoneFormat.data;
        int intValue = num.intValue();
        CallingCodeInfo callingCodeInfo2 = new CallingCodeInfo();
        callingCodeInfo2.callingCode = str2;
        callingCodeInfo2.countries = (ArrayList) c0278PhoneFormat.callingCodeCountries.get(str2);
        c0278PhoneFormat.callingCodeData.put(str2, callingCodeInfo2);
        short value16 = c0278PhoneFormat.value16(intValue);
        int i = 2;
        int i2 = (intValue + 2) + 2;
        short value162 = c0278PhoneFormat.value16(i2);
        i2 = (i2 + 2) + 2;
        short value163 = c0278PhoneFormat.value16(i2);
        i2 = (i2 + 2) + 2;
        ArrayList arrayList = new ArrayList(5);
        while (true) {
            String valueString = c0278PhoneFormat.valueString(i2);
        ...
        while (true) {
            String valueString2 = c0278PhoneFormat.valueString(i2);
        ...
        while (s < value163) {
            ...
            ruleSet.matchLen = c0278PhoneFormat.value16(i3);
            i3 += i;
            short value164 = c0278PhoneFormat.value16(i3);
            i3 += i;
            ...
            while (s2 < value164) {
                ...
                phoneRule.minVal = c0278PhoneFormat.value32(i5);
                i5 += 4;
                phoneRule.maxVal = c0278PhoneFormat.value32(i5);
                i5 += 4;
                int i6 = i5 + 1;
                ...
                value16 = c0278PhoneFormat.value16(i5);
                i5 += i;
                phoneRule.format = c0278PhoneFormat.valueString((intValue + value162) + value16);
