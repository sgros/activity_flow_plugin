...
public class UpdateAppAlertDialog extends AlertDialog implements NotificationCenterDelegate {
    ...
    public UpdateAppAlertDialog(Activity activity, TL_help_appUpdate tL_help_appUpdate, int i) {
        ...
        setTopImage((int) C1067R.C1065drawable.update, Theme.getColor(Theme.key_dialogTopBackground));
        setTopHeight(175);
        ...
        setTitle(LocaleController.getString("UpdateTelegram", C1067R.string.UpdateTelegram));
        setPositiveButton(LocaleController.getString("UpdateNow", C1067R.string.UpdateNow), new C2712-$$Lambda$UpdateAppAlertDialog$voSGHXhYuACsnb2-x2STYrPYmkw(this));
        setNeutralButton(LocaleController.getString("Later", C1067R.string.Later), new C2711-$$Lambda$UpdateAppAlertDialog$egnS6_js0sES87wcIflPDbL7olc(this));
        this.radialProgressView = new FrameLayout(this.parentActivity) {
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                i3 = (i3 - dp) / 2;
                i4 = ((i4 - dp) / 2) + AndroidUtilities.m26dp(2.0f);
        ...
        this.radialProgress.setStrokeWidth(AndroidUtilities.m26dp(2.0f));
