...
public class MrzRecognizer {
    ...
    L_0x0014:
        ...
        goto L_0x0042;
    L_0x0018:
        r1 = 1140850688; // 0x44000000 float:512.0 double:5.63655132E-315;
        r3 = r26.getWidth();
        r4 = r26.getHeight();
    ...
    L_0x0087:
        ...
        r7 = r1 / r7;
        r1 = r1 / r11;
        r11 = 4608758678669597082; // 0x3ff599999999999a float:-1.5881868E-23 double:1.35;
        r3 = (r13 > r11 ? 1 : (r13 == r11 ? 0 : -1));
        if (r3 < 0) goto L_0x01d5;
    L_0x00da:
        r11 = 4610560118520545280; // 0x3ffc000000000000 float:0.0 double:1.75;
        r3 = (r13 > r11 ? 1 : (r13 == r11 ? 0 : -1));
        if (r3 > 0) goto L_0x01d5;
    L_0x00e0:
        r11 = 4608758678669597082; // 0x3ff599999999999a float:-1.5881868E-23 double:1.35;
    ...
    L_0x010d:
        ...
        r13 = r13 + r7;
        r13 = r13 + r1;
        r1 = 4616189618054758400; // 0x4010000000000000 float:0.0 double:4.0;
        r13 = r13 / r1;
        r1 = 1024; // 0x400 float:1.435E-42 double:5.06E-321;
        r2 = 4652218415073722368; // 0x4090000000000000 float:0.0 double:1024.0;
        r2 = r2 / r13;
    ...
    L_0x01d5:
        ...
        goto L_0x0203;
    L_0x01d7:
        r1 = 1153138688; // 0x44bb8000 float:1500.0 double:5.697262106E-315;
        r2 = r26.getWidth();
        r3 = r26.getHeight();
    ...
    private static String russianPassportTranslit(String str) {
        ...
        for (int i = 0; i < toCharArray.length; i++) {
            int indexOf = "ABVGDE2JZIQKLMNOPRSTUFHC34WXY9678".indexOf(toCharArray[i]);
            if (indexOf != -1) {
