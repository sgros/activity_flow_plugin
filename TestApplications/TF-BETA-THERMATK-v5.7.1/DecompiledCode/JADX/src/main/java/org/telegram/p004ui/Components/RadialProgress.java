...
public class RadialProgress {
    ...
    private int diff = AndroidUtilities.m26dp(4.0f);
    ...
    private class CheckDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            int centerX = getBounds().centerX() - AndroidUtilities.m26dp(12.0f);
            int centerY = getBounds().centerY() - AndroidUtilities.m26dp(6.0f);
            float f = 1.0f;
            if (this.progress != 1.0f) {
                f = RadialProgress.decelerateInterpolator.getInterpolation(this.progress);
            }
            Canvas canvas2 = canvas;
            canvas2.drawLine((float) (AndroidUtilities.m26dp(7.0f) + centerX), (float) (((int) AndroidUtilities.dpf2(13.0f)) + centerY), (float) (((int) (((float) AndroidUtilities.m26dp(7.0f)) - (((float) AndroidUtilities.m26dp(6.0f)) * f))) + centerX), (float) (((int) (AndroidUtilities.dpf2(13.0f) - (((float) AndroidUtilities.m26dp(6.0f)) * f))) + centerY), this.paint);
            Canvas canvas3 = canvas;
            canvas3.drawLine((float) (((int) AndroidUtilities.dpf2(7.0f)) + centerX), (float) (((int) AndroidUtilities.dpf2(13.0f)) + centerY), (float) (centerX + ((int) (AndroidUtilities.dpf2(7.0f) + (((float) AndroidUtilities.m26dp(13.0f)) * f)))), (float) (centerY + ((int) (AndroidUtilities.dpf2(13.0f) - (((float) AndroidUtilities.m26dp(13.0f)) * f)))), this.paint);
        }
    ...
    public RadialProgress(View view) {
        ...
        this.progressPaint.setStrokeWidth((float) AndroidUtilities.m26dp(3.0f));
        ...
        this.miniProgressPaint.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
    ...
    public void setCheckBackground(boolean z, boolean z2) {
        if (this.checkDrawable == null) {
            ...
            this.checkBackgroundDrawable = Theme.createCircleDrawableWithIcon(AndroidUtilities.m26dp(48.0f), this.checkDrawable, 0);
        }
    ...
    L_0x002f:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.RadialProgress.setBackground(android.graphics.drawable.Drawable, boolean, boolean):void");
    }
    ...
    L_0x0037:
        ...
        r4 = org.telegram.messenger.AndroidUtilities.m26dp(r3);	 Catch:{ Throwable -> 0x0053 }
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r3);	 Catch:{ Throwable -> 0x0053 }
    ...
    L_0x005f:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.RadialProgress.setMiniBackground(android.graphics.drawable.Drawable, boolean, boolean):void");
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (Math.abs(this.progressRect.width() - ((float) AndroidUtilities.m26dp(44.0f))) < AndroidUtilities.density) {
            i2 = 20;
            f2 = (float) 16;
            centerY = this.progressRect.centerY() + ((float) AndroidUtilities.m26dp(f2));
            f2 = this.progressRect.centerX() + ((float) AndroidUtilities.m26dp(f2));
            i3 = 0;
        } else {
            i2 = 22;
            centerY = this.progressRect.centerY() + ((float) AndroidUtilities.m26dp(18.0f));
            f2 = this.progressRect.centerX() + ((float) AndroidUtilities.m26dp(18.0f));
            i3 = 2;
        }
        int i4 = i2 / 2;
        ...
        if (canvas3 != null) {
            ...
            canvas3.drawCircle((float) AndroidUtilities.m26dp(f5), (float) AndroidUtilities.m26dp(f5), ((float) AndroidUtilities.m26dp((float) (i4 + 1))) * f3, Theme.checkboxSquare_eraserPaint);
        } else {
            this.miniProgressBackgroundPaint.setColor(this.progressColor);
            if (this.previousMiniDrawable == null || this.currentMiniDrawable != null) {
                this.miniProgressBackgroundPaint.setAlpha(NalUnitUtil.EXTENDED_SAR);
            } else {
                this.miniProgressBackgroundPaint.setAlpha((int) ((this.animatedAlphaValue * 255.0f) * this.overrideAlpha));
            }
            canvas2.drawCircle(f2, centerY, (float) AndroidUtilities.m26dp(12.0f), this.miniProgressBackgroundPaint);
        }
        if (this.miniDrawCanvas != null) {
        ...
        if (drawable != null) {
            ...
            f4 = (float) i4;
            this.previousMiniDrawable.setBounds((int) (f2 - (((float) AndroidUtilities.m26dp(f4)) * f3)), (int) (centerY - (((float) AndroidUtilities.m26dp(f4)) * f3)), (int) ((((float) AndroidUtilities.m26dp(f4)) * f3) + f2), (int) ((((float) AndroidUtilities.m26dp(f4)) * f3) + centerY));
        ...
        if (!this.hideCurrentDrawable) {
            ...
            if (drawable != null) {
                ...
                f4 = (float) i4;
                this.currentMiniDrawable.setBounds((int) (f2 - ((float) AndroidUtilities.m26dp(f4))), (int) (centerY - ((float) AndroidUtilities.m26dp(f4))), (int) (((float) AndroidUtilities.m26dp(f4)) + f2), (int) (((float) AndroidUtilities.m26dp(f4)) + centerY));
        ...
        if (this.currentMiniWithRound || this.previousMiniWithRound) {
            ...
            f4 = (float) (i4 - 2);
            this.cicleRect.set(f2 - (((float) AndroidUtilities.m26dp(f4)) * f3), centerY - (((float) AndroidUtilities.m26dp(f4)) * f3), f2 + (((float) AndroidUtilities.m26dp(f4)) * f3), centerY + (((float) AndroidUtilities.m26dp(f4)) * f3));
