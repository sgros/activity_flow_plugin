...
public class StickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C43331 extends ActionBarMenuOnItemClick {
        C43331() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public long getItemId(int i) {
            if (i < StickersActivity.this.stickersStartRow || i >= StickersActivity.this.stickersEndRow) {
                ...
                return ((TL_messages_stickerSet) DataQuery.getInstance(StickersActivity.this.currentAccount).getStickerSets(StickersActivity.this.currentType).get(i - StickersActivity.this.stickersStartRow)).set.f466id;
            }
        }
            ...
            if (i == 0) {
                ...
                if (i == 2) {
                    try {
                        ...
                        StickersActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("StickersShare", C1067R.string.StickersShare)), 500);
                    } catch (Exception e) {
                        FileLog.m30e(e);
                    }
                } else if (i == 3) {
                    try {
                        ...
                        Toast.makeText(StickersActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", C1067R.string.LinkCopied), 0).show();
                    } catch (Exception e2) {
                        FileLog.m30e(e2);
                    }
                }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType == 3) {
                        itemViewType = StickersActivity.this.stickersShadowRow;
                    ...
                    string = LocaleController.getString("FeaturedStickers", C1067R.string.FeaturedStickers);
                    if (i != 0) {
                    ...
                    if (StickersActivity.this.currentType == 0) {
                        ((TextSettingsCell) viewHolder.itemView).setText(LocaleController.getString("ArchivedStickers", C1067R.string.ArchivedStickers), false);
                    } else {
                        ((TextSettingsCell) viewHolder.itemView).setText(LocaleController.getString("ArchivedMasks", C1067R.string.ArchivedMasks), false);
                    }
                } else if (i == StickersActivity.this.masksRow) {
                    ((TextSettingsCell) viewHolder.itemView).setText(LocaleController.getString("Masks", C1067R.string.Masks), false);
                } else if (i == StickersActivity.this.suggestRow) {
                    i = SharedConfig.suggestStickers;
                    if (i == 0) {
                        format = LocaleController.getString("SuggestStickersAll", C1067R.string.SuggestStickersAll);
                    } else if (i != 1) {
                        format = LocaleController.getString("SuggestStickersNone", C1067R.string.SuggestStickersNone);
                    } else {
                        format = LocaleController.getString("SuggestStickersInstalled", C1067R.string.SuggestStickersInstalled);
                    }
                    ((TextSettingsCell) viewHolder.itemView).setTextAndValue(LocaleController.getString("SuggestStickers", C1067R.string.SuggestStickers), format, true);
                }
            } else if (i == StickersActivity.this.featuredInfoRow) {
                format = LocaleController.getString("FeaturedStickersInfo", C1067R.string.FeaturedStickersInfo);
                string = "@stickers";
                ...
                if (StickersActivity.this.currentType == 0) {
                    ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString("ArchivedStickersInfo", C1067R.string.ArchivedStickersInfo));
                } else {
                    ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString("ArchivedMasksInfo", C1067R.string.ArchivedMasksInfo));
                }
            } else if (i == StickersActivity.this.masksInfoRow) {
                ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString("MasksInfo", C1067R.string.MasksInfo));
            }
        }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$1$StickersActivity$ListAdapter(View view) {
            ...
            if (StickersActivity.this.currentType == 0) {
                if (stickersSet.set.official) {
                    iArr = new int[]{0};
                    charSequenceArr = new CharSequence[]{LocaleController.getString(str4, C1067R.string.StickersHide)};
                } else {
                    iArr = new int[]{0, 1, 2, 3};
                    charSequenceArr2 = new CharSequence[]{LocaleController.getString(str4, C1067R.string.StickersHide), LocaleController.getString(str3, C1067R.string.StickersRemove), LocaleController.getString(str2, C1067R.string.StickersShare), LocaleController.getString(str, C1067R.string.StickersCopy)};
                    builder.setItems(charSequenceArr2, new C2077x1fbdbaac(this, iArr, stickersSet));
                    StickersActivity.this.showDialog(builder.create());
                }
            } else if (stickersSet.set.official) {
                iArr = new int[]{0};
                charSequenceArr = new CharSequence[]{LocaleController.getString(str3, C1067R.string.StickersHide)};
            } else {
                iArr = new int[]{0, 1, 2, 3};
                charSequenceArr2 = new CharSequence[]{LocaleController.getString(str4, C1067R.string.StickersHide), LocaleController.getString(str3, C1067R.string.StickersRemove), LocaleController.getString(str2, C1067R.string.StickersShare), LocaleController.getString(str, C1067R.string.StickersCopy)};
                builder.setItems(charSequenceArr2, new C2077x1fbdbaac(this, iArr, stickersSet));
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            textSettingsCell.setBackgroundColor(Theme.getColor(str));
            textSettingsCell.setOnOptionsClick(new C2078x83bb67db(this));
    ...
    public View createView(Context context) {
        ...
        if (this.currentType == 0) {
            this.actionBar.setTitle(LocaleController.getString("StickersName", C1067R.string.StickersName));
        } else {
            this.actionBar.setTitle(LocaleController.getString("Masks", C1067R.string.Masks));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C43331());
        ...
        this.listView.setOnItemClickListener(new C3870-$$Lambda$StickersActivity$52bQnWSJW3OnfBam1s3y37TWiNA(this));
    ...
    public /* synthetic */ void lambda$createView$1$StickersActivity(View view, int i) {
        if (i >= this.stickersStartRow && i < this.stickersEndRow && getParentActivity() != null) {
            ...
            builder.setTitle(LocaleController.getString("SuggestStickers", C1067R.string.SuggestStickers));
            builder.setItems(new CharSequence[]{LocaleController.getString("SuggestStickersAll", C1067R.string.SuggestStickersAll), LocaleController.getString("SuggestStickersInstalled", C1067R.string.SuggestStickersInstalled), LocaleController.getString("SuggestStickersNone", C1067R.string.SuggestStickersNone)}, new C2076-$$Lambda$StickersActivity$43apBJTj1nQwZFS8l5r8_cQqass(this));
    ...
    private void sendReorder() {
        if (this.needReorder) {
            ...
            for (int i = 0; i < stickerSets.size(); i++) {
                tL_messages_reorderStickerSets.order.add(Long.valueOf(((TL_messages_stickerSet) stickerSets.get(i)).set.f466id));
            }
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_reorderStickerSets, C3871-$$Lambda$StickersActivity$eNJ1JVvMbECvyP_jXUZlvL1o67I.INSTANCE);
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        themeDescriptionArr[17] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_stickers_menuSelector);
