...
public class VideoPlayer implements EventListener, VideoListener, NotificationCenterDelegate {
    ...
    class C41531 implements EventListener {
    ...
    private void ensurePleyaerCreated() {
        LoadControl defaultLoadControl = new DefaultLoadControl(new DefaultAllocator(true, MessagesController.UPDATE_MASK_CHECK), 15000, 50000, 100, 5000, -1, true);
        if (this.player == null) {
        ...
        if (this.mixedAudio && this.audioPlayer == null) {
            ...
            this.audioPlayer.addListener(new C41531());
    ...
    L_0x00a5:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.VideoPlayer.preparePlayer(android.net.Uri, java.lang.String):void");
    }
