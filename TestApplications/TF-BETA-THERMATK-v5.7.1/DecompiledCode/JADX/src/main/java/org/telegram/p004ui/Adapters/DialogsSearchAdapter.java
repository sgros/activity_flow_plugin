...
public class DialogsSearchAdapter extends SelectionAdapter {
    ...
    private class DialogSearchResult {
        ...
        /* synthetic */ DialogSearchResult(DialogsSearchAdapter dialogsSearchAdapter, C39181 c39181) {
            this();
        }
    }
    ...
    class C39181 implements SearchAdapterHelperDelegate {
    ...
    private class CategoryAdapterRecycler extends SelectionAdapter {
        ...
        /* synthetic */ CategoryAdapterRecycler(DialogsSearchAdapter dialogsSearchAdapter, C39181 c39181) {
            this();
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            hintDialogCell.setLayoutParams(new LayoutParams(AndroidUtilities.m26dp(80.0f), AndroidUtilities.m26dp(86.0f)));
    ...
    public DialogsSearchAdapter(Context context, int i, int i2) {
        this.searchAdapterHelper.setDelegate(new C39181());
    ...
    private void searchMessagesInternal(String str) {
        if (!(this.needMessagesSearch == 0 || (TextUtils.isEmpty(this.lastMessagesSearchString) && TextUtils.isEmpty(str)))) {
            ...
            tL_messages_searchGlobal.f515q = str;
            ...
            this.lastReqId = i3;
            this.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_searchGlobal, new C3908-$$Lambda$DialogsSearchAdapter$jvBeESgA8AL2rHOVVbFgj80mlPg(this, i3, tL_messages_searchGlobal), 2);
        }
    }
    ...
    public /* synthetic */ void lambda$searchMessagesInternal$1$DialogsSearchAdapter(int i, TL_messages_searchGlobal tL_messages_searchGlobal, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2247-$$Lambda$DialogsSearchAdapter$tzGJ1M1cHM4tSDBBFCCxa18ZhzA(this, i, tL_error, tLObject, tL_messages_searchGlobal));
    }
    ...
    public void loadRecentSearch() {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2239-$$Lambda$DialogsSearchAdapter$EdS8aWM1r9L4_WkQYwpXcCyFRfM(this));
    }
    ...
    L_0x00e7:
        ...
        r10 = r10.f445id;	 Catch:{ Exception -> 0x0191 }
        r10 = (long) r10;	 Catch:{ Exception -> 0x0191 }
        r10 = r10 << r8;
        r10 = r6.get(r10);	 Catch:{ Exception -> 0x0191 }
        r10 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.RecentSearchObject) r10;	 Catch:{ Exception -> 0x0191 }
    ...
    L_0x0121:
        ...
        r8 = r7.f434id;	 Catch:{ Exception -> 0x0191 }
    ...
    L_0x013a:
        ...
        r7 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.RecentSearchObject) r7;	 Catch:{ Exception -> 0x0191 }
    ...
    L_0x0149:
        ...
        r8 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.RecentSearchObject) r8;	 Catch:{ Exception -> 0x0191 }
    ...
    L_0x016d:
        ...
        r3 = r1.f534id;	 Catch:{ Exception -> 0x0191 }
        r3 = (long) r3;	 Catch:{ Exception -> 0x0191 }
        r3 = r6.get(r3);	 Catch:{ Exception -> 0x0191 }
        r3 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.RecentSearchObject) r3;	 Catch:{ Exception -> 0x0191 }
    ...
    L_0x0180:
        ...
        goto L_0x0167;
    L_0x0183:
        r0 = org.telegram.p004ui.Adapters.C2242-$$Lambda$DialogsSearchAdapter$TgrSEhniISqCg6ct5i9NTHhT7C8.INSTANCE;	 Catch:{ Exception -> 0x0191 }
    ...
    L_0x0195:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.DialogsSearchAdapter.lambda$loadRecentSearch$4$DialogsSearchAdapter():void");
    }
    ...
    public void putRecentSearch(long j, TLObject tLObject) {
        ...
        notifyDataSetChanged();
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2238-$$Lambda$DialogsSearchAdapter$EHNVdrp_nz-CUR77EsM44jqsFBg(this, j));
    }
    ...
    public void clearRecentSearch() {
        ...
        notifyDataSetChanged();
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2241-$$Lambda$DialogsSearchAdapter$It_IWmufaVpNeuW4BM4G8iqCxcU(this));
    }
    ...
    private void searchDialogsInternal(String str, int i) {
        if (this.needMessagesSearch != 2) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2246-$$Lambda$DialogsSearchAdapter$jlz_Jg93hVH6t3KHP9A-P2d1MzU(this, str, i));
        }
    }
    ...
    public /* synthetic */ void lambda$searchDialogsInternal$8$DialogsSearchAdapter(java.lang.String r25, int r26) {
        ...
        r1 = r24;
        r0 = "SavedMessages";
        r2 = 2131560633; // 0x7f0d08b9 float:1.8746644E38 double:1.053130881E-314;
    ...
    L_0x0113:
        ...
        r0 = r2.f534id;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x01ee:
        ...
        r2 = r13.f534id;	 Catch:{ Exception -> 0x068b }
        r2 = (long) r2;	 Catch:{ Exception -> 0x068b }
        r2 = r12.get(r2);	 Catch:{ Exception -> 0x068b }
        r2 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.DialogSearchResult) r2;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x0317:
        ...
        if (r2 != 0) goto L_0x029d;
    L_0x031d:
        r2 = r9.f434id;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x040f:
        r2 = r3.f445id;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x04af:
        ...
        r11 = org.telegram.p004ui.ActionBar.Theme.getColor(r11);	 Catch:{ Exception -> 0x068b }
    ...
    L_0x052d:
        ...
        r3 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.DialogSearchResult) r3;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x053e:
        ...
        goto L_0x0527;
    L_0x0541:
        r0 = org.telegram.p004ui.Adapters.C2240-$$Lambda$DialogsSearchAdapter$FVguPxj8QpbjyrNjyvgW9r4iI6c.INSTANCE;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x0557:
        ...
        r9 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.DialogSearchResult) r9;	 Catch:{ Exception -> 0x068b }
    ...
    L_0x068f:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.DialogsSearchAdapter.lambda$searchDialogsInternal$8$DialogsSearchAdapter(java.lang.String, int):void");
    }
    ...
    private void updateSearchResults(ArrayList<TLObject> arrayList, ArrayList<CharSequence> arrayList2, ArrayList<User> arrayList3, int i) {
        AndroidUtilities.runOnUIThread(new C2235-$$Lambda$DialogsSearchAdapter$-rG-J91Hu2opSK8sjEhFEpnZiuA(this, i, arrayList, arrayList3, arrayList2));
    }
    ...
    public void searchDialogs(String str) {
        if (str == null || !str.equals(this.lastSearchText)) {
            ...
            if (TextUtils.isEmpty(trim)) {
                ...
                C2236-$$Lambda$DialogsSearchAdapter$2OrdD5nR-nF-l2wgPqqTnpM3YF8 c2236-$$Lambda$DialogsSearchAdapter$2OrdD5nR-nF-l2wgPqqTnpM3YF8 = new C2236-$$Lambda$DialogsSearchAdapter$2OrdD5nR-nF-l2wgPqqTnpM3YF8(this, trim, i2);
                this.searchRunnable = c2236-$$Lambda$DialogsSearchAdapter$2OrdD5nR-nF-l2wgPqqTnpM3YF8;
                dispatchQueue.postRunnable(c2236-$$Lambda$DialogsSearchAdapter$2OrdD5nR-nF-l2wgPqqTnpM3YF8, 300);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$searchDialogs$11$DialogsSearchAdapter(String str, int i) {
        ...
        C2243-$$Lambda$DialogsSearchAdapter$VsX50TGE7QZO8RUCru1or1M1bIg c2243-$$Lambda$DialogsSearchAdapter$VsX50TGE7QZO8RUCru1or1M1bIg = new C2243-$$Lambda$DialogsSearchAdapter$VsX50TGE7QZO8RUCru1or1M1bIg(this, i, str);
        this.searchRunnable2 = c2243-$$Lambda$DialogsSearchAdapter$VsX50TGE7QZO8RUCru1or1M1bIg;
        AndroidUtilities.runOnUIThread(c2243-$$Lambda$DialogsSearchAdapter$VsX50TGE7QZO8RUCru1or1M1bIg);
    }
    ...
    L_0x0024:
        r0 = r8.recentSearchObjects;
        r9 = r0.get(r9);
        r9 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.RecentSearchObject) r9;
        r9 = r9.object;
    ...
    L_0x00ec:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.DialogsSearchAdapter.getItem(int):java.lang.Object");
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            View c43722 = new RecyclerListView(this.mContext) {
            ...
            c43722.setTag(Integer.valueOf(9));
            c43722.setItemAnimator(null);
            c43722.setLayoutAnimation(null);
            C43713 c43713 = new LinearLayoutManager(this.mContext) {
                public boolean supportsPredictiveItemAnimations() {
                    return false;
                }
            };
            c43713.setOrientation(0);
            c43722.setLayoutManager(c43713);
            c43722.setAdapter(new CategoryAdapterRecycler(this, null));
            c43722.setOnItemClickListener(new C3906-$$Lambda$DialogsSearchAdapter$DZkEHCwRy7JqjbUQmUNPYIVHu-I(this));
            c43722.setOnItemLongClickListener(new C3907-$$Lambda$DialogsSearchAdapter$VmJg1wMYhOLJS8dwKIzHrQMjS0A(this));
            this.innerListView = c43722;
            view = c43722;
        }
        if (i == 5) {
            view.setLayoutParams(new LayoutParams(-1, AndroidUtilities.m26dp(86.0f)));
        } else {
    ...
    L_0x001e:
        r0 = r0.itemView;
        r0 = (org.telegram.p004ui.Components.RecyclerListView) r0;
        r0 = r0.getAdapter();
        r0 = (org.telegram.p004ui.Adapters.DialogsSearchAdapter.CategoryAdapterRecycler) r0;
        r2 = r2 / r5;
        r0.setIndex(r2);
        goto L_0x02f9;
    L_0x002e:
        r0 = r0.itemView;
        r0 = (org.telegram.p004ui.Cells.HashtagSearchCell) r0;
    ...
    L_0x004d:
        r0 = r0.itemView;
        r0 = (org.telegram.p004ui.Cells.DialogCell) r0;
        r3 = r17.getItemCount();
        r3 = r3 - r7;
    ...
    L_0x006e:
        r0 = r0.itemView;
        r0 = (org.telegram.p004ui.Cells.GraySectionCell) r0;
        r3 = r17.isRecentSearchDisplayed();
        r4 = 2131559102; // 0x7f0d02be float:1.8743539E38 double:1.0531301244E-314;
        r7 = "ClearButton";
    ...
    L_0x008f:
        r2 = 2131559029; // 0x7f0d0275 float:1.874339E38 double:1.0531300883E-314;
        r3 = "ChatHints";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r0.setText(r2);
        goto L_0x02f9;
    L_0x009d:
        r2 = 2131560537; // 0x7f0d0859 float:1.874645E38 double:1.0531308334E-314;
        r3 = "Recent";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
    ...
    L_0x00bc:
        r2 = 2131559634; // 0x7f0d04d2 float:1.8744618E38 double:1.053130387E-314;
        r3 = "Hashtags";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r3 = org.telegram.messenger.LocaleController.getString(r7, r4);
    ...
    L_0x00f2:
        r2 = 2131559594; // 0x7f0d04aa float:1.8744536E38 double:1.0531303675E-314;
        r3 = "GlobalSearch";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r0.setText(r2);
        goto L_0x02f9;
    L_0x0100:
        r2 = 2131560655; // 0x7f0d08cf float:1.8746688E38 double:1.0531308917E-314;
        r3 = "SearchMessages";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r0.setText(r2);
        goto L_0x02f9;
    L_0x010e:
        r0 = r0.itemView;
        r8 = r0;
        r8 = (org.telegram.p004ui.Cells.ProfileSearchCell) r8;
        r0 = r1.getItem(r2);
    ...
    L_0x0234:
        ...
        r11 = org.telegram.p004ui.ActionBar.Theme.getColor(r16);
        r2.<init>(r11);
        r0 = r0.length();
        r0 = r0 + r14;
    ...
    L_0x0254:
        r0 = r0.substring(r7);
    L_0x0258:
        r2 = new android.text.SpannableStringBuilder;	 Catch:{ Exception -> 0x0288 }
        r2.<init>();	 Catch:{ Exception -> 0x0288 }
        r2.append(r13);	 Catch:{ Exception -> 0x0288 }
        r2.append(r11);	 Catch:{ Exception -> 0x0288 }
        r13 = r11.toLowerCase();	 Catch:{ Exception -> 0x0288 }
        r13 = r13.indexOf(r0);	 Catch:{ Exception -> 0x0288 }
        if (r13 == r9) goto L_0x0285;
    L_0x026d:
        r0 = r0.length();	 Catch:{ Exception -> 0x0288 }
    ...
    L_0x0276:
        r13 = r13 + 1;
    L_0x0278:
        r9 = new android.text.style.ForegroundColorSpan;	 Catch:{ Exception -> 0x0288 }
        r14 = org.telegram.p004ui.ActionBar.Theme.getColor(r16);	 Catch:{ Exception -> 0x0288 }
        r9.<init>(r14);	 Catch:{ Exception -> 0x0288 }
        r0 = r0 + r13;
        r2.setSpan(r9, r13, r0, r15);	 Catch:{ Exception -> 0x0288 }
    L_0x0285:
        r9 = r2;
        goto L_0x01fe;
    L_0x0288:
    ...
    L_0x029a:
        r0 = 2131560633; // 0x7f0d08b9 float:1.8746644E38 double:1.053130881E-314;
        r2 = "SavedMessages";
    ...
    L_0x02f9:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.DialogsSearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
