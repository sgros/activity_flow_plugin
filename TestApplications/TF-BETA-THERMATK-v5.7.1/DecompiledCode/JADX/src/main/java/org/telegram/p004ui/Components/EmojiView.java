...
import org.telegram.p004ui.Cells.ContextLinkCell;
import org.telegram.p004ui.Cells.EmptyCell;
import org.telegram.p004ui.Cells.FeaturedStickerSetInfoCell;
import org.telegram.p004ui.Cells.StickerEmojiCell;
import org.telegram.p004ui.Cells.StickerSetGroupInfoCell;
import org.telegram.p004ui.Cells.StickerSetNameCell;
import org.telegram.p004ui.Components.PagerSlidingTabStrip.IconTabProvider;
...
import org.telegram.p004ui.Components.ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate;
...
import org.telegram.p004ui.ContentPreviewViewer.ContentPreviewViewerDelegate.C3013-CC;
...
public class EmojiView extends FrameLayout implements NotificationCenterDelegate {
    private static final OnScrollChangedListener NOP = C2572-$$Lambda$EmojiView$PY-mfpY1F_JSo9ExUvlHDRxz4bQ.INSTANCE;
    ...
    private ContentPreviewViewerDelegate contentPreviewViewerDelegate = new C41041();
    ...
    private int searchFieldHeight = AndroidUtilities.m26dp(64.0f);
    ...
    class C282025 implements OnClickListener {
        C282025() {
        }
    ...
    class C282127 implements OnClickListener {
        C282127() {
        }
    ...
    class C282228 extends ViewOutlineProvider {
        C282228() {
        }

        @SuppressLint({"NewApi"})
        public void getOutline(View view, Outline outline) {
            outline.setOval(0, 0, AndroidUtilities.m26dp(40.0f), AndroidUtilities.m26dp(40.0f));
        }
    }

    /* renamed from: org.telegram.ui.Components.EmojiView$2 */
    class C28242 extends ViewOutlineProvider {
        C28242() {
        }

        @TargetApi(21)
        public void getOutline(View view, Outline outline) {
            outline.setRoundRect(view.getPaddingLeft(), view.getPaddingTop(), view.getMeasuredWidth() - view.getPaddingRight(), view.getMeasuredHeight() - view.getPaddingBottom(), (float) AndroidUtilities.m26dp(6.0f));
        }
    }

    /* renamed from: org.telegram.ui.Components.EmojiView$30 */
    class C282530 extends AnimatorListenerAdapter {
        C282530() {
        }
    ...
    class C283034 extends AnimatorListenerAdapter {

        /* renamed from: org.telegram.ui.Components.EmojiView$34$1 */
        class C28291 extends AnimatorListenerAdapter {
            C28291() {
            }
        ...
        public void onAnimationEnd(Animator animator) {
            AndroidUtilities.runOnUIThread(new C2565-$$Lambda$EmojiView$34$syxP2tKTMRS9T48q548gWNuUVOM(this), 5000);
        }
        ...
        public /* synthetic */ void lambda$onAnimationEnd$0$EmojiView$34() {
            if (EmojiView.this.mediaBanTooltip != null) {
                ...
                animatorSet.addListener(new C28291());
    ...
    class C28318 implements OnFocusChangeListener {
        C28318() {
        }
    ...
    private class EmojiColorPickerView extends View {
        private Drawable arrowDrawable = getResources().getDrawable(C1067R.C1065drawable.stickers_back_arrow);
        private int arrowX;
        private Drawable backgroundDrawable = getResources().getDrawable(C1067R.C1065drawable.stickers_back_all);
        ...
        public void onDraw(Canvas canvas) {
            int i = 0;
            this.backgroundDrawable.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m26dp(AndroidUtilities.isTablet() ? 60.0f : 52.0f));
            this.backgroundDrawable.draw(canvas);
            Drawable drawable = this.arrowDrawable;
            int dp = this.arrowX - AndroidUtilities.m26dp(9.0f);
            float f = 55.5f;
            int dp2 = AndroidUtilities.m26dp(AndroidUtilities.isTablet() ? 55.5f : 47.5f);
            int dp3 = this.arrowX + AndroidUtilities.m26dp(9.0f);
            if (!AndroidUtilities.isTablet()) {
                f = 47.5f;
            }
            drawable.setBounds(dp, dp2, dp3, AndroidUtilities.m26dp(f + 8.0f));
            this.arrowDrawable.draw(canvas);
            if (this.currentEmoji != null) {
                while (i < 6) {
                    int access$2000 = (EmojiView.this.emojiSize * i) + AndroidUtilities.m26dp((float) ((i * 4) + 5));
                    dp = AndroidUtilities.m26dp(9.0f);
                    if (this.selection == i) {
                        this.rect.set((float) access$2000, (float) (dp - ((int) AndroidUtilities.dpf2(3.5f))), (float) (EmojiView.this.emojiSize + access$2000), (float) ((EmojiView.this.emojiSize + dp) + AndroidUtilities.m26dp(3.0f)));
                        canvas.drawRoundRect(this.rect, (float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(4.0f), this.rectPaint);
                    }
    ...
    public interface EmojiViewDelegate {
        ...
        public final /* synthetic */ class C2837-CC {
    ...
    private class SearchField extends FrameLayout {
        ...
        class C28413 extends AnimatorListenerAdapter {
            C28413() {
            }
        ...
        public SearchField(Context context, final int i) {
            ...
            this.backgroundView.setBackgroundColor(Theme.getColor(Theme.key_chat_emojiPanelBackground));
            addView(this.backgroundView, new LayoutParams(-1, EmojiView.this.searchFieldHeight));
            this.searchBackground = new View(context);
            this.searchBackground.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m26dp(18.0f), Theme.getColor(Theme.key_chat_emojiSearchBackground)));
            ...
            this.searchIconImageView.setImageResource(C1067R.C1065drawable.smiles_inputsearch);
            ImageView imageView = this.searchIconImageView;
            String str = Theme.key_chat_emojiSearchIcon;
            ...
            this.progressDrawable.setSide(AndroidUtilities.m26dp(7.0f));
            ...
            this.clearSearchImageView.setOnClickListener(new C2573-$$Lambda$EmojiView$SearchField$04evSuS5X_E-yJiP7OOqbVezHUE(this));
            ...
            if (i == 0) {
                this.searchEditText.setHint(LocaleController.getString("SearchStickersHint", C1067R.string.SearchStickersHint));
            } else if (i == 1) {
                this.searchEditText.setHint(LocaleController.getString("SearchEmojiHint", C1067R.string.SearchEmojiHint));
            } else if (i == 2) {
                this.searchEditText.setHint(LocaleController.getString("SearchGifsTitle", C1067R.string.SearchGifsTitle));
            }
            this.searchEditText.setCursorColor(Theme.getColor(Theme.key_featuredStickers_addedIcon));
            this.searchEditText.setCursorSize(AndroidUtilities.m26dp(20.0f));
        ...
        private void showShadow(boolean z, boolean z2) {
            if (!(z && this.shadowView.getTag() == null) && (z || this.shadowView.getTag() == null)) {
                ...
                if (z2) {
                    ...
                    this.shadowAnimator.addListener(new C28413());
    ...
    class C409812 extends SpanSizeLookup {
        C409812() {
        }
    ...
    class C409913 extends ItemDecoration {
        C409913() {
        }
    ...
    class C410014 extends OnScrollListener {
        C410014() {
        }
    ...
    class C410116 extends SpanSizeLookup {
        C410116() {
        }
    ...
    class C410319 extends SpanSizeLookup {
        C410319() {
        }
    ...
    class C41041 implements ContentPreviewViewerDelegate {
        public /* synthetic */ boolean needOpen() {
            return C3013-CC.$default$needOpen(this);
        }
    ...
    class C410520 extends OnScrollListener {
        C410520() {
        }
    ...
    class C410621 extends OnScrollListener {
        C410621() {
        }
    ...
    class C410826 implements OnPageChangeListener {
    ...
    class C41094 extends SpanSizeLookup {
        C41094() {
        }
    ...
    class C41105 extends OnScrollListener {
        C41105() {
        }
    ...
    class C41116 implements OnItemClickListener {
        C41116() {
        }
    ...
    class C41127 implements OnItemLongClickListener {
        C41127() {
        }
        ...
        public boolean onItemClick(android.view.View r18, int r19) {
            ...
            r0 = r17;
            r1 = r18;
            r2 = r1 instanceof org.telegram.p004ui.Components.EmojiView.ImageViewEmoji;
            r3 = 0;
            if (r2 == 0) goto L_0x0218;
        L_0x0009:
            r2 = r1;
            r2 = (org.telegram.p004ui.Components.EmojiView.ImageViewEmoji) r2;
            r4 = r2.getTag();
        ...
        L_0x0053:
            r4 = org.telegram.p004ui.Components.EmojiView.this;
        ...
        L_0x00bc:
            goto L_0x00f8;
        L_0x00bd:
            r5 = org.telegram.p004ui.Components.EmojiView.this;
            r5 = r5.pickerView;
            r5.setSelection(r4);
            goto L_0x00f8;
        L_0x00c7:
        ...
        L_0x00f8:
            ...
            r5 = org.telegram.p004ui.Components.EmojiView.this;
            r5 = r5.emojiSize;
            r6 = org.telegram.p004ui.Components.EmojiView.this;
            r6 = r6.pickerView;
            r6 = r6.getSelection();
            r5 = r5 * r6;
            r6 = org.telegram.p004ui.Components.EmojiView.this;
        ...
        L_0x0127:
            ...
            r9 = org.telegram.messenger.AndroidUtilities.m26dp(r6);
        ...
        L_0x014f:
            ...
            r4 = r4[r3];
            r4 = r4 - r5;
            r9 = org.telegram.p004ui.Components.EmojiView.this;
            r9 = r9.popupWidth;
            r4 = r4 + r9;
            r9 = org.telegram.messenger.AndroidUtilities.displaySize;
            r9 = r9.x;
            r10 = org.telegram.messenger.AndroidUtilities.m26dp(r6);
            r9 = r9 - r10;
        ...
        L_0x018c:
            r3 = r2.getTop();
        L_0x0190:
            r2 = org.telegram.p004ui.Components.EmojiView.this;
            r2 = r2.pickerView;
        ...
        L_0x01a1:
            ...
            r8 = org.telegram.p004ui.Components.EmojiView.this;
            r8 = r8.emojiSize;
            r6 = r6 - r8;
            r6 = r6 / r13;
            r5 = r5 + r6;
            ...
            r1 = org.telegram.p004ui.Components.EmojiView.this;
            r1 = r1.pager;
        ...
        L_0x0218:
            return r3;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.EmojiView$C41127.onItemClick(android.view.View, int):boolean");
        }
    }

    /* renamed from: org.telegram.ui.Components.EmojiView$9 */
    class C41139 implements ScrollSlidingTabStripDelegate {
        C41139() {
        }
    ...
    private class EmojiPagesAdapter extends PagerAdapter implements IconTabProvider {
        ...
        /* synthetic */ EmojiPagesAdapter(EmojiView emojiView, C41041 c41041) {
            this();
        }
        ...
        public CharSequence getPageTitle(int i) {
            if (i == 0) {
                return LocaleController.getString("Emoji", C1067R.string.Emoji);
            }
            if (i != 1) {
                return i != 2 ? null : LocaleController.getString("AccDescrStickers", C1067R.string.AccDescrStickers);
            } else {
                return LocaleController.getString("AccDescrGIFs", C1067R.string.AccDescrGIFs);
            }
        }
        ...
        public void customOnDraw(Canvas canvas, int i) {
            if (i == 2 && !DataQuery.getInstance(EmojiView.this.currentAccount).getUnreadStickerSets().isEmpty() && EmojiView.this.dotPaint != null) {
                canvas.drawCircle((float) ((canvas.getWidth() / 2) + AndroidUtilities.m26dp(9.0f)), (float) ((canvas.getHeight() / 2) - AndroidUtilities.m26dp(8.0f)), (float) AndroidUtilities.m26dp(5.0f), EmojiView.this.dotPaint);
            }
        }
    ...
    private class EmojiGridAdapter extends SelectionAdapter {
        ...
        /* synthetic */ EmojiGridAdapter(EmojiView emojiView, C41041 c41041) {
            this();
        }
    ...
    private class EmojiSearchAdapter extends SelectionAdapter {
        ...
        class C28342 implements OnClickListener {
            C28342() {
            }
            ...
            public void onClick(View view) {
                ...
                linearLayout.setPadding(AndroidUtilities.m26dp(21.0f), 0, AndroidUtilities.m26dp(21.0f), 0);
                ImageView imageView = new ImageView(EmojiView.this.getContext());
                imageView.setImageResource(C1067R.C1065drawable.smiles_info);
                ...
                textView.setText(LocaleController.getString("EmojiSuggestions", C1067R.string.EmojiSuggestions));
                ...
                textView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EmojiSuggestionsInfo", C1067R.string.EmojiSuggestionsInfo)));
                textView.setTextSize(1, 15.0f);
                ...
                textView.setText(LocaleController.formatString("EmojiSuggestionsUrl", C1067R.string.EmojiSuggestionsUrl, objArr));
                textView.setTextSize(1, 15.0f);
                ...
                textView.setOnClickListener(new OnClickListener() {
                    public void onClick(View view) {
                        ...
                        if (!zArr[0]) {
                            ...
                            AndroidUtilities.runOnUIThread(new C2567xd729a5c2(this, alertDialogArr, ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(tL_messages_getEmojiURL, new C4037x6cb7cc90(this, alertDialogArr, builder))), 1000);
                        }
                    }
                    ...
                    public /* synthetic */ void lambda$onClick$1$EmojiView$EmojiSearchAdapter$2$1(AlertDialog[] alertDialogArr, Builder builder, TLObject tLObject, TL_error tL_error) {
                        AndroidUtilities.runOnUIThread(new C2568x51d2f2a5(this, alertDialogArr, tLObject, builder));
                    }
                    ...
                    public /* synthetic */ void lambda$onClick$3$EmojiView$EmojiSearchAdapter$2$1(AlertDialog[] alertDialogArr, int i) {
                        if (alertDialogArr[0] != null) {
                            alertDialogArr[0].setOnCancelListener(new C2566x6228e32b(this, i));
        ...
        class C28353 implements Runnable {
            C28353() {
            }
        ...
        /* synthetic */ EmojiSearchAdapter(EmojiView emojiView, C41041 c41041) {
            this();
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                imageViewEmoji = new FrameLayout(EmojiView.this.getContext()) {
                    ...
                    public void onMeasure(int i, int i2) {
                        ...
                        if (view != null) {
                            ...
                            i2 = AndroidUtilities.m26dp(120.0f);
                        }
                        super.onMeasure(i, MeasureSpec.makeMeasureSpec(i2 - EmojiView.this.searchFieldHeight, 1073741824));
                    }
                };
                TextView textView = new TextView(EmojiView.this.getContext());
                textView.setText(LocaleController.getString("NoEmojiFound", C1067R.string.NoEmojiFound));
                textView.setTextSize(1, 16.0f);
                String str = Theme.key_chat_emojiPanelEmptyText;
                ...
                imageView.setImageResource(C1067R.C1065drawable.smiles_panel_question);
                imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str), Mode.MULTIPLY));
                imageViewEmoji.addView(imageView, LayoutHelper.createFrame(48, 48, 85));
                imageView.setOnClickListener(new C28342());
        ...
        public void search(String str) {
            ...
            if (!TextUtils.isEmpty(this.lastSearchEmojiString)) {
                C28353 c28353 = new C28353();
                this.searchRunnable = c28353;
                AndroidUtilities.runOnUIThread(c28353, 300);
            }
        }
    }
    ...
    private class GifAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                view.setContentDescription(LocaleController.getString("AttachGif", C1067R.string.AttachGif));
    ...
    /* renamed from: org.telegram.ui.Components.EmojiView$GifSearchAdapter */
    private class GifSearchAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                contextLinkCell.setContentDescription(LocaleController.getString("AttachGif", C1067R.string.AttachGif));
                contextLinkCell.setCanPreviewGif(true);
            } else if (i != 1) {
                contextLinkCell = new FrameLayout(EmojiView.this.getContext()) {
                    /* Access modifiers changed, original: protected */
                    public void onMeasure(int i, int i2) {
                        super.onMeasure(i, MeasureSpec.makeMeasureSpec((int) (((float) (((EmojiView.this.gifGridView.getMeasuredHeight() - EmojiView.this.searchFieldHeight) - AndroidUtilities.m26dp(8.0f)) / 3)) * 1.7f), 1073741824));
                    }
                };
                ImageView imageView = new ImageView(EmojiView.this.getContext());
                imageView.setScaleType(ScaleType.CENTER);
                imageView.setImageResource(C1067R.C1065drawable.gif_empty);
                String str = Theme.key_chat_emojiPanelEmptyText;
                imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str), Mode.MULTIPLY));
                contextLinkCell.addView(imageView, LayoutHelper.createFrame(-2, -2.0f, 17, 0.0f, 0.0f, 0.0f, 59.0f));
                TextView textView = new TextView(EmojiView.this.getContext());
                textView.setText(LocaleController.getString("NoGIFsFound", C1067R.string.NoGIFsFound));
                textView.setTextSize(1, 16.0f);
                textView.setTextColor(Theme.getColor(str));
        ...
        public void search(final String str) {
            ...
            if (!TextUtils.isEmpty(this.lastSearchImageString)) {
                C28392 c28392 = new Runnable() {
                    public void run() {
                        GifSearchAdapter.this.search(str, "", true);
                    }
                };
                this.searchRunnable = c28392;
                AndroidUtilities.runOnUIThread(c28392, 300);
            }
        }
        ...
        private void searchBotUser() {
            if (!this.searchingUser) {
                ...
                ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(tL_contacts_resolveUsername, new C4038-$$Lambda$EmojiView$GifSearchAdapter$rB6iGH2IIIWpfXKf_CfIBRZyOE8(this));
            }
        }

        public /* synthetic */ void lambda$searchBotUser$1$EmojiView$GifSearchAdapter(TLObject tLObject, TL_error tL_error) {
            if (tLObject != null) {
                AndroidUtilities.runOnUIThread(new C2570-$$Lambda$EmojiView$GifSearchAdapter$XYVthzC0iAXb1tv95YkceAYL3QE(this, tLObject));
            }
        }
        ...
        private void search(String str, String str2, boolean z) {
            ...
            if (userOrChat instanceof User) {
                ...
                this.reqId = ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(tL_messages_getInlineBotResults, new C4039-$$Lambda$EmojiView$GifSearchAdapter$rHXwwVWZa9pK-feyWosndOy6a0o(this, tL_messages_getInlineBotResults, str2), 2);
                return;
            }
            if (z) {
                searchBotUser();
        ...
        public /* synthetic */ void lambda$search$3$EmojiView$GifSearchAdapter(TL_messages_getInlineBotResults tL_messages_getInlineBotResults, String str, TLObject tLObject, TL_error tL_error) {
            AndroidUtilities.runOnUIThread(new C2569-$$Lambda$EmojiView$GifSearchAdapter$T00z6XPCmLZsEfaqGzAOZW0Q-C8(this, tL_messages_getInlineBotResults, str, tLObject));
        }
            ...
            if (tL_messages_getInlineBotResults.query.equals(this.lastSearchImageString)) {
                ...
                if (tLObject instanceof messages_BotResults) {
                    ...
                    for (int i2 = 0; i2 < messages_botresults.results.size(); i2++) {
                        ...
                        if (!this.resultsMap.containsKey(botInlineResult.f432id)) {
                            botInlineResult.query_id = messages_botresults.query_id;
                            this.results.add(botInlineResult);
                            this.resultsMap.put(botInlineResult.f432id, botInlineResult);
                            i++;
                        }
                    }
    ...
    private class StickersGridAdapter extends SelectionAdapter {
        ...
        public int getTabForPosition(int i) {
            ...
            if (this.stickersPerRow == 0) {
                ...
                this.stickersPerRow = measuredWidth / AndroidUtilities.m26dp(72.0f);
            }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0$EmojiView$StickersGridAdapter(View view) {
            if (EmojiView.this.groupStickerSet == null) {
                ...
                stringBuilder.append(EmojiView.this.info.f435id);
                edit.putLong(stringBuilder.toString(), EmojiView.this.info.stickerset != null ? EmojiView.this.info.stickerset.f466id : 0).commit();
                ...
                EmojiView.this.delegate.onStickersGroupClick(EmojiView.this.info.f435id);
            }
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View c41141;
            if (i == 0) {
                c41141 = new StickerEmojiCell(this.context) {
                    public void onMeasure(int i, int i2) {
                        super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(82.0f), 1073741824));
                    }
                };
            } else if (i == 1) {
                c41141 = new EmptyCell(this.context);
            } else if (i == 2) {
                c41141 = new StickerSetNameCell(this.context, false);
                c41141.setOnIconClickListener(new C2574x73cc3e8b(this));
            } else if (i == 3) {
                c41141 = new StickerSetGroupInfoCell(this.context);
                c41141.setAddOnClickListener(new C2575x9b810547(this));
                c41141.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
            } else if (i != 4) {
                c41141 = null;
            } else {
                c41141 = new View(this.context);
                c41141.setLayoutParams(new RecyclerView.LayoutParams(-1, EmojiView.this.searchFieldHeight));
            }
            return new Holder(c41141);
        }
                ...
                if (itemViewType == 1) {
                    ...
                    if (i == this.totalItems) {
                        ...
                        if (arrayList == null) {
                            ...
                            emptyCell.setHeight(AndroidUtilities.m26dp(8.0f));
                            return;
                        } else {
                            i = EmojiView.this.pager.getHeight() - (((int) Math.ceil((double) (((float) arrayList.size()) / ((float) this.stickersPerRow)))) * AndroidUtilities.m26dp(82.0f));
                            if (i <= 0) {
                                i = 1;
                            }
                    ...
                    emptyCell.setHeight(AndroidUtilities.m26dp(82.0f));
                    return;
                } else if (itemViewType == 2) {
                    StickerSetNameCell stickerSetNameCell = (StickerSetNameCell) viewHolder.itemView;
                    if (i == EmojiView.this.groupStickerPackPosition) {
                        Chat chat;
                        i = (EmojiView.this.groupStickersHidden && EmojiView.this.groupStickerSet == null) ? 0 : EmojiView.this.groupStickerSet != null ? C1067R.C1065drawable.stickersclose : C1067R.C1065drawable.stickerset_close;
                        if (EmojiView.this.info != null) {
                            chat = MessagesController.getInstance(EmojiView.this.currentAccount).getChat(Integer.valueOf(EmojiView.this.info.f435id));
                        }
                        Object[] objArr = new Object[1];
                        objArr[0] = chat != null ? chat.title : "Group Stickers";
                        stickerSetNameCell.setText(LocaleController.formatString("CurrentGroupStickers", C1067R.string.CurrentGroupStickers, objArr), i);
                        return;
                    }
                    ...
                    if (arrayList2 instanceof TL_messages_stickerSet) {
                        ...
                        stickerSetNameCell.setText(LocaleController.getString("RecentStickers", C1067R.string.RecentStickers), 0);
                        return;
                    } else if (arrayList2 == EmojiView.this.favouriteStickers) {
                        stickerSetNameCell.setText(LocaleController.getString("FavoriteStickers", C1067R.string.FavoriteStickers), 0);
                        return;
                    } else {
                        return;
                    }
    ...
    private class StickersSearchGridAdapter extends SelectionAdapter {
        ...
        private Runnable searchRunnable = new C28431();
     ...
     */
            public void run() {
                /*
                r13 = this;
                r0 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r0 = r0.searchQuery;
            ...
            L_0x000d:
                r0 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r0 = org.telegram.p004ui.Components.EmojiView.this;
                ...
                r1 = 0;
                r0.cleared = r1;
                r0 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.access$13304(r0);
                r2 = new java.util.ArrayList;
                r2.<init>(r1);
                r3 = new android.util.LongSparseArray;
                r3.<init>(r1);
                r4 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r4 = org.telegram.p004ui.Components.EmojiView.this;
                r4 = r4.currentAccount;
                r4 = org.telegram.messenger.DataQuery.getInstance(r4);
                r4 = r4.getAllStickers();
                r5 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r5 = r5.searchQuery;
                r5 = r5.length();
                r6 = 14;
                r7 = 1;
            ...
            L_0x010b:
                r5 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r5 = r5.emojiStickers;
                r6 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r6 = r6.searchQuery;
                r5.put(r2, r6);
                r5 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r5 = r5.emojiArrays;
            ...
            L_0x0158:
                ...
                r6 = org.telegram.p004ui.Components.EmojiView.this;
                r6 = r6.lastSearchKeyboardLanguage;
                r8 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r8 = r8.searchQuery;
            ...
            L_0x019a:
                ...
                r9 = r9.title;
                r9 = r9.toLowerCase();
                r10 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r10 = r10.searchQuery;
                r9 = r9.indexOf(r10);
            ...
            L_0x029b:
                r13.clear();
                r9 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r9 = r9.localPacks;
                r9.add(r8);
                r9 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
            ...
            L_0x032a:
                ...
                r0.emoticon = r4;
                r0.hash = r1;
                r1 = org.telegram.p004ui.Components.EmojiView.StickersSearchGridAdapter.this;
                r4 = org.telegram.p004ui.Components.EmojiView.this;
                r4 = r4.currentAccount;
            ...
            L_0x0351:
                ...
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.EmojiView$StickersSearchGridAdapter$C28431.run():void");
            }
            ...
            public /* synthetic */ void lambda$run$1$EmojiView$StickersSearchGridAdapter$1(TL_messages_searchStickerSets tL_messages_searchStickerSets, TLObject tLObject, TL_error tL_error) {
                if (tLObject instanceof TL_messages_foundStickerSets) {
                    AndroidUtilities.runOnUIThread(new C2577xe8a1ede7(this, tL_messages_searchStickerSets, tLObject));
                }
            }
            ...
            public /* synthetic */ void lambda$null$0$EmojiView$StickersSearchGridAdapter$1(TL_messages_searchStickerSets tL_messages_searchStickerSets, TLObject tLObject) {
                if (tL_messages_searchStickerSets.f516q.equals(StickersSearchGridAdapter.this.searchQuery)) {
                    clear();
            ...
            public /* synthetic */ void lambda$run$3$EmojiView$StickersSearchGridAdapter$1(TL_messages_getStickers tL_messages_getStickers, ArrayList arrayList, LongSparseArray longSparseArray, TLObject tLObject, TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new C2576x8af7df9(this, tL_messages_getStickers, tLObject, arrayList, longSparseArray));
            }
                ...
                if (tL_messages_getStickers.emoticon.equals(StickersSearchGridAdapter.this.searchQuery)) {
                    ...
                    if (tLObject instanceof TL_messages_stickers) {
                        ...
                        while (i < size2) {
                            ...
                            if (longSparseArray.indexOfKey(document.f441id) < 0) {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0$EmojiView$StickersSearchGridAdapter(View view) {
            ...
            if (EmojiView.this.installingStickerSets.indexOfKey(stickerSet.set.f466id) < 0 && EmojiView.this.removingStickerSets.indexOfKey(stickerSet.set.f466id) < 0) {
                if (featuredStickerSetInfoCell.isInstalled()) {
                    EmojiView.this.removingStickerSets.put(stickerSet.set.f466id, stickerSet);
                    EmojiView.this.delegate.onStickerSetRemove(featuredStickerSetInfoCell.getStickerSet());
                } else {
                    EmojiView.this.installingStickerSets.put(stickerSet.set.f466id, stickerSet);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View c41152;
            if (i == 0) {
                c41152 = new StickerEmojiCell(this.context) {
                    public void onMeasure(int i, int i2) {
                        super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(82.0f), 1073741824));
                    }
                };
            } else if (i == 1) {
                c41152 = new EmptyCell(this.context);
            } else if (i == 2) {
                c41152 = new StickerSetNameCell(this.context, false);
            } else if (i == 3) {
                c41152 = new FeaturedStickerSetInfoCell(this.context, 17);
                c41152.setAddOnClickListener(new C2578xff965993(this));
            } else if (i == 4) {
                c41152 = new View(this.context);
                c41152.setLayoutParams(new RecyclerView.LayoutParams(-1, EmojiView.this.searchFieldHeight));
            } else if (i != 5) {
                c41152 = null;
            } else {
                View c28453 = new FrameLayout(this.context) {
                    /* Access modifiers changed, original: protected */
                    public void onMeasure(int i, int i2) {
                        super.onMeasure(i, MeasureSpec.makeMeasureSpec((int) (((float) (((EmojiView.this.stickersGridView.getMeasuredHeight() - EmojiView.this.searchFieldHeight) - AndroidUtilities.m26dp(8.0f)) / 3)) * 1.7f), 1073741824));
                    }
                };
                ImageView imageView = new ImageView(this.context);
                imageView.setScaleType(ScaleType.CENTER);
                imageView.setImageResource(C1067R.C1065drawable.stickers_empty);
                String str = Theme.key_chat_emojiPanelEmptyText;
                imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str), Mode.MULTIPLY));
                c28453.addView(imageView, LayoutHelper.createFrame(-2, -2.0f, 17, 0.0f, 0.0f, 0.0f, 59.0f));
                TextView textView = new TextView(this.context);
                textView.setText(LocaleController.getString("NoStickersFound", C1067R.string.NoStickersFound));
                textView.setTextSize(1, 16.0f);
                textView.setTextColor(Theme.getColor(str));
                c28453.addView(textView, LayoutHelper.createFrame(-2, -2.0f, 17, 0.0f, 0.0f, 0.0f, 9.0f));
                c28453.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
                c41152 = c28453;
            }
            return new Holder(c41152);
        }
                ...
                if (itemViewType == 1) {
                    ...
                    if (i == this.totalItems) {
                        ...
                        if (num == null) {
                            ...
                            i = EmojiView.this.pager.getHeight() - (((int) Math.ceil((double) (((float) num.intValue()) / ((float) EmojiView.this.stickersGridAdapter.stickersPerRow)))) * AndroidUtilities.m26dp(82.0f));
                            if (i <= 0) {
                                i = 1;
                            }
                            emptyCell.setHeight(i);
                    ...
                    Object obj2 = EmojiView.this.installingStickerSets.indexOfKey(stickerSetCovered.set.f466id) >= 0 ? 1 : null;
                    Object obj3 = EmojiView.this.removingStickerSets.indexOfKey(stickerSetCovered.set.f466id) >= 0 ? 1 : null;
                    if (!(obj2 == null && obj3 == null)) {
                        if (obj2 != null && featuredStickerSetInfoCell.isInstalled()) {
                            EmojiView.this.installingStickerSets.remove(stickerSetCovered.set.f466id);
                            obj2 = null;
                        } else if (!(obj3 == null || featuredStickerSetInfoCell.isInstalled())) {
                            EmojiView.this.removingStickerSets.remove(stickerSetCovered.set.f466id);
                            obj3 = null;
                        }
                    }
                    if (obj2 == null && obj3 == null) {
    ...
    private class TrendingGridAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View c41161;
            if (i == 0) {
                c41161 = new StickerEmojiCell(this.context) {
                    public void onMeasure(int i, int i2) {
                        super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(82.0f), 1073741824));
                    }
                };
            } else if (i == 1) {
                c41161 = new EmptyCell(this.context);
            } else if (i != 2) {
                c41161 = null;
            } else {
                c41161 = new FeaturedStickerSetInfoCell(this.context, 17);
                c41161.setAddOnClickListener(new C2579x4b1a4e24(this));
            }
            return new Holder(c41161);
        }
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                ((EmptyCell) viewHolder.itemView).setHeight(AndroidUtilities.m26dp(82.0f));
            } else if (itemViewType == 2) {
                ...
                boolean z2 = unreadStickerSets != null && unreadStickerSets.contains(Long.valueOf(stickerSetCovered.set.f466id));
                FeaturedStickerSetInfoCell featuredStickerSetInfoCell = (FeaturedStickerSetInfoCell) viewHolder.itemView;
                featuredStickerSetInfoCell.setStickerSet(stickerSetCovered, z2);
                if (z2) {
                    DataQuery.getInstance(EmojiView.this.currentAccount).markFaturedStickersByIdAsRead(stickerSetCovered.set.f466id);
                }
                Object obj = EmojiView.this.installingStickerSets.indexOfKey(stickerSetCovered.set.f466id) >= 0 ? 1 : null;
                Object obj2 = EmojiView.this.removingStickerSets.indexOfKey(stickerSetCovered.set.f466id) >= 0 ? 1 : null;
        ...
        public void notifyDataSetChanged() {
            ...
            this.stickersPerRow = Math.max(1, measuredWidth / AndroidUtilities.m26dp(72.0f));
            ...
            if (!EmojiView.this.trendingLoaded) {
                ...
                for (int i3 = 0; i3 < featuredStickerSets.size(); i3++) {
                    ...
                    if (!(DataQuery.getInstance(EmojiView.this.currentAccount).isStickerPackInstalled(stickerSetCovered.set.f466id) || (stickerSetCovered.covers.isEmpty() && stickerSetCovered.cover == null))) {
                        int i4;
    ...
    public EmojiView(boolean z, boolean z2, Context context, boolean z3, ChatFull chatFull) {
        ...
        String str = Theme.key_chat_emojiBottomPanelIcon;
        int color = Theme.getColor(str);
        String str2 = Theme.key_chat_emojiPanelIconSelected;
        drawableArr[0] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_tab_smiles, color, Theme.getColor(str2));
        drawableArr[1] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_tab_gif, Theme.getColor(str), Theme.getColor(str2));
        drawableArr[2] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_tab_stickers, Theme.getColor(str), Theme.getColor(str2));
        this.tabIcons = drawableArr;
        drawableArr = new Drawable[9];
        String str3 = Theme.key_chat_emojiPanelIcon;
        drawableArr[0] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_recent, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[1] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_smiles, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[2] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_cat, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[3] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_food, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[4] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_activities, Theme.getColor(str3), Theme.getColor(str2));
        int i = 5;
        drawableArr[5] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_travel, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[6] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_objects, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[7] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_other, Theme.getColor(str3), Theme.getColor(str2));
        drawableArr[8] = Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_flags, Theme.getColor(str3), Theme.getColor(str2));
        this.emojiIcons = drawableArr;
        this.stickerIcons = new Drawable[]{Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_recent, Theme.getColor(str), Theme.getColor(str2)), Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_faves, Theme.getColor(str), Theme.getColor(str2)), Theme.createEmojiIconSelectorDrawable(context2, C1067R.C1065drawable.smiles_panel_trending, Theme.getColor(str), Theme.getColor(str2))};
        this.emojiTitles = new String[]{LocaleController.getString("Emoji1", C1067R.string.Emoji1), LocaleController.getString("Emoji2", C1067R.string.Emoji2), LocaleController.getString("Emoji3", C1067R.string.Emoji3), LocaleController.getString("Emoji4", C1067R.string.Emoji4), LocaleController.getString("Emoji5", C1067R.string.Emoji5), LocaleController.getString("Emoji6", C1067R.string.Emoji6), LocaleController.getString("Emoji7", C1067R.string.Emoji7), LocaleController.getString("Emoji8", C1067R.string.Emoji8)};
        this.showGifs = z4;
        this.info = chatFull;
        this.dotPaint = new Paint(1);
        this.dotPaint.setColor(Theme.getColor(Theme.key_chat_emojiPanelNewTrending));
        if (VERSION.SDK_INT >= 21) {
            this.outlineProvider = new C28242();
        }
        ...
        this.emojiGridView = new RecyclerListView(context2) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                EmojiView.this.emojiLayoutManager.setSpanCount(MeasureSpec.getSize(i) / AndroidUtilities.m26dp(AndroidUtilities.isTablet() ? 60.0f : 45.0f));
            ...
            L_0x0008:
                ...
                r2 = 3;
                r3 = 5;
                r4 = -971227136; // 0xffffffffc61c4000 float:-10000.0 double:NaN;
                r5 = 1;
            ...
            L_0x006f:
                ...
                r12 = r12.getX();
                r0 = r0 + r12;
                r12 = org.telegram.p004ui.Components.EmojiView.this;
                r12 = r12.pickerView;
                r2 = org.telegram.p004ui.Components.EmojiView.this;
                r2 = r2.location;
            ...
            L_0x012a:
                ...
                r2.put(r1, r12);
                r1 = org.telegram.p004ui.Components.EmojiView.addColorToCode(r1, r12);
                goto L_0x0139;
            L_0x0134:
            ...
            L_0x0175:
                r2 = org.telegram.p004ui.Components.EmojiView.this;
                r2 = r2.emojiTouchedView;
                r12 = org.telegram.p004ui.Components.EmojiView.addColorToCode(r1, r12);
                r2.sendEmoji(r12);
                goto L_0x018c;
            L_0x0183:
                r12 = org.telegram.p004ui.Components.EmojiView.this;
            ...
            L_0x019c:
                ...
                return r12;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.EmojiView$C41213.onTouchEvent(android.view.MotionEvent):boolean");
            }
        };
        ...
        this.emojiGridView.setTopGlowOffset(AndroidUtilities.m26dp(38.0f));
        this.emojiGridView.setBottomGlowOffset(AndroidUtilities.m26dp(48.0f));
        this.emojiGridView.setPadding(0, AndroidUtilities.m26dp(38.0f), 0, 0);
        recyclerListView = this.emojiGridView;
        str = Theme.key_chat_emojiPanelBackground;
        recyclerListView.setGlowColor(Theme.getColor(str));
        this.emojiGridView.setClipToPadding(false);
        this.emojiLayoutManager.setSpanSizeLookup(new C41094());
        recyclerListView = this.emojiGridView;
        ...
        this.emojiGridView.setOnScrollListener(new C41105());
        this.emojiGridView.setOnItemClickListener(new C41116());
        this.emojiGridView.setOnItemLongClickListener(new C41127());
        ...
        if (z5) {
            ...
            this.emojiSearchField.searchEditText.setOnFocusChangeListener(new C28318());
        }
        ...
        this.emojiTabs.setDelegate(new C41139());
        ...
        layoutParams.topMargin = AndroidUtilities.m26dp(38.0f);
        ...
        if (z) {
            ...
            if (z4) {
                ...
                C411811 c411811 = new ExtendedGridLayoutManager(context2, 100) {
                    ...
                    public Size getSizeForItem(int i) {
                        ...
                        if (document != null) {
                            ...
                            if (closestPhotoSizeWithSize != null) {
                                int i3 = closestPhotoSizeWithSize.f465w;
                                if (i3 != 0) {
                                    i2 = closestPhotoSizeWithSize.f464h;
                                    if (i2 != 0) {
                        ...
                        if (arrayList != null) {
                            for (i2 = 0; i2 < arrayList.size(); i2++) {
                                ...
                                if ((documentAttribute instanceof TL_documentAttributeImageSize) || (documentAttribute instanceof TL_documentAttributeVideo)) {
                                    ...
                                    size3.width = (float) documentAttribute.f444w;
                                    size3.height = (float) documentAttribute.f443h;
                                    break;
                                }
                            }
                        }
                ...
                this.gifLayoutManager = c411811;
                recyclerListView2.setLayoutManager(c411811);
                this.gifLayoutManager.setSpanSizeLookup(new C409812());
                this.gifGridView.addItemDecoration(new C409913());
                ...
                this.gifGridView.setOnScrollListener(new C410014());
                this.gifGridView.setOnTouchListener(new C2581-$$Lambda$EmojiView$l7-k5UkFPpeHpKVTvoFojtQIyNg(this));
                this.gifOnItemClickListener = new C4043-$$Lambda$EmojiView$qDPcvu2cn8NHi3uzHeRPO6CJgew(this);
            ...
            this.stickersLayoutManager.setSpanSizeLookup(new C410116());
            this.stickersGridView.setPadding(0, AndroidUtilities.m26dp(52.0f), 0, 0);
            ...
            this.stickersGridView.setOnTouchListener(new C2583-$$Lambda$EmojiView$qCmH2CuXJBuotfYIBsa5LNpa8lQ(this));
            this.stickersOnItemClickListener = new C4044-$$Lambda$EmojiView$sBpUanL5xQpXEXKoK_PK5yrP_k0(this);
            ...
            C411718 c411718 = new GridLayoutManager(context2, 5) {
                public boolean supportsPredictiveItemAnimations() {
                    return false;
                }
            };
            this.trendingLayoutManager = c411718;
            recyclerListView2.setLayoutManager(c411718);
            this.trendingLayoutManager.setSpanSizeLookup(new C410319());
            this.trendingGridView.setOnScrollListener(new C410520());
            this.trendingGridView.setClipToPadding(false);
            this.trendingGridView.setPadding(0, AndroidUtilities.m26dp(48.0f), 0, 0);
            recyclerListView2 = this.trendingGridView;
            ...
            this.trendingGridView.setOnItemClickListener(new C4042-$$Lambda$EmojiView$dYtQT1qlPrE3oYWHySyt2vGHEgc(this));
            ...
            this.stickersTab.setIndicatorHeight(AndroidUtilities.m26dp(2.0f));
            ...
            updateStickerTabs();
            this.stickersTab.setDelegate(new C4036-$$Lambda$EmojiView$EeKK6r6yP0jttMlGjDS2ja6SA2o(this));
            this.stickersGridView.setOnScrollListener(new C410621());
        }
        ...
        this.topShadow.setBackgroundDrawable(Theme.getThemedDrawable(context2, (int) C1067R.C1065drawable.greydivider_bottom, -1907225));
        ...
        this.backspaceButton.setImageResource(C1067R.C1065drawable.smiles_tab_clear);
        ...
        this.backspaceButton.setContentDescription(LocaleController.getString("AccDescrBackspace", C1067R.string.AccDescrBackspace));
        ...
        this.bottomTabContainer.addView(this.bottomTabContainerBackground, new LayoutParams(-1, AndroidUtilities.m26dp(44.0f), 83));
        int i2 = 40;
        int i3 = 44;
        if (z5) {
            addView(this.bottomTabContainer, new LayoutParams(-1, AndroidUtilities.m26dp(44.0f) + AndroidUtilities.getShadowHeight(), 83));
            ...
            this.stickerSettingsButton.setImageResource(C1067R.C1065drawable.smiles_tab_settings);
            this.stickerSettingsButton.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chat_emojiPanelBackspace), Mode.MULTIPLY));
            this.stickerSettingsButton.setScaleType(ScaleType.CENTER);
            this.stickerSettingsButton.setFocusable(true);
            this.stickerSettingsButton.setContentDescription(LocaleController.getString("Settings", C1067R.string.Settings));
            this.bottomTabContainer.addView(this.stickerSettingsButton, LayoutHelper.createFrame(52, 44, 85));
            this.stickerSettingsButton.setOnClickListener(new C282025());
            ...
            this.typeTabs.setTabPaddingLeftRight(AndroidUtilities.m26dp(10.0f));
            this.bottomTabContainer.addView(this.typeTabs, LayoutHelper.createFrame(-2, 44, 81));
            this.typeTabs.setOnPageChangeListener(new C410826());
            this.searchButton = new ImageView(context2);
            this.searchButton.setImageResource(C1067R.C1065drawable.smiles_tab_search);
            this.searchButton.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chat_emojiPanelBackspace), Mode.MULTIPLY));
            this.searchButton.setScaleType(ScaleType.CENTER);
            this.searchButton.setContentDescription(LocaleController.getString("Search", C1067R.string.Search));
            this.searchButton.setFocusable(true);
            this.bottomTabContainer.addView(this.searchButton, LayoutHelper.createFrame(52, 44, 83));
            this.searchButton.setOnClickListener(new C282127());
        } else {
            ...
            Drawable createSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m26dp(56.0f), Theme.getColor(str), Theme.getColor(str));
            if (VERSION.SDK_INT < 21) {
                ...
                combinedDrawable.setIconSize(AndroidUtilities.m26dp(40.0f), AndroidUtilities.m26dp(40.0f));
                createSimpleSelectorCircleDrawable = combinedDrawable;
            } else {
                StateListAnimator stateListAnimator = new StateListAnimator();
                stateListAnimator.addState(new int[]{16842919}, ObjectAnimator.ofFloat(this.floatingButton, View.TRANSLATION_Z, new float[]{(float) AndroidUtilities.m26dp(2.0f), (float) AndroidUtilities.m26dp(4.0f)}).setDuration(200));
                stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(this.floatingButton, View.TRANSLATION_Z, new float[]{(float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(2.0f)}).setDuration(200));
                this.backspaceButton.setStateListAnimator(stateListAnimator);
                this.backspaceButton.setOutlineProvider(new C282228());
            }
            this.backspaceButton.setPadding(0, 0, AndroidUtilities.m26dp(2.0f), 0);
        ...
        this.mediaBanTooltip.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m26dp(3.0f), Theme.getColor(Theme.key_chat_gifSaveHintBackground)));
        this.mediaBanTooltip.setTextColor(Theme.getColor(Theme.key_chat_gifSaveHintText));
        this.mediaBanTooltip.setPadding(AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(7.0f), AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(7.0f));
        ...
        this.emojiSize = AndroidUtilities.m26dp(AndroidUtilities.isTablet() ? 40.0f : 32.0f);
        this.pickerView = new EmojiColorPickerView(context2);
        EmojiColorPickerView emojiColorPickerView = this.pickerView;
        if (!AndroidUtilities.isTablet()) {
            i2 = 32;
        }
        i2 = AndroidUtilities.m26dp((float) (((i2 * 6) + 10) + 20));
        this.popupWidth = i2;
        i3 = AndroidUtilities.m26dp(AndroidUtilities.isTablet() ? 64.0f : 56.0f);
        this.popupHeight = i3;
        ...
        this.pickerViewPopup.getContentView().setOnKeyListener(new C2580-$$Lambda$EmojiView$YBM1z0ObV6f6L9y0M-Yz0CakSrc(this));
    ...
    private void openSearch(SearchField searchField) {
        ...
        while (i < 3) {
            ...
            if (searchField2 == null) {
                ...
                if (searchField2 == this.gifSearchField) {
                    ...
                    if (emojiViewDelegate != null && emojiViewDelegate.isExpanded()) {
                        ...
                        if (obj != null) {
                            ...
                            animatorArr[0] = ObjectAnimator.ofFloat(obj, View.TRANSLATION_Y, new float[]{(float) (-AndroidUtilities.m26dp(48.0f))});
                            animatorArr[1] = ObjectAnimator.ofFloat(recyclerListView, View.TRANSLATION_Y, new float[]{(float) (-AndroidUtilities.m26dp(48.0f))});
                            animatorArr[2] = ObjectAnimator.ofFloat(searchField2, View.TRANSLATION_Y, new float[]{(float) AndroidUtilities.m26dp(0.0f)});
                            animatorSet3.playTogether(animatorArr);
                        } else {
                            animatorSet2 = this.searchAnimation;
                            animatorArr = new Animator[2];
                            animatorArr[0] = ObjectAnimator.ofFloat(recyclerListView, View.TRANSLATION_Y, new float[]{(float) (-AndroidUtilities.m26dp(48.0f))});
                            animatorArr[1] = ObjectAnimator.ofFloat(searchField2, View.TRANSLATION_Y, new float[]{(float) AndroidUtilities.m26dp(0.0f)});
                            animatorSet2.playTogether(animatorArr);
                        }
                            ...
                            public void onAnimationEnd(Animator animator) {
                                if (animator.equals(EmojiView.this.searchAnimation)) {
                                    ...
                                    if (recyclerListView == EmojiView.this.stickersGridView) {
                                        recyclerListView.setPadding(0, AndroidUtilities.m26dp(4.0f), 0, 0);
                ...
                searchField2.setTranslationY((float) AndroidUtilities.m26dp(0.0f));
                if (obj != null) {
                    obj.setTranslationY((float) (-AndroidUtilities.m26dp(48.0f)));
                }
    ...
    private void showEmojiShadow(boolean z, boolean z2) {
        if (!(z && this.emojiTabsShadow.getTag() == null) && (z || this.emojiTabsShadow.getTag() == null)) {
            ...
            if (z2) {
                ...
                this.emojiTabShadowAnimator.addListener(new C282530());
        ...
        if (currentItem == 2 && j2 != -1) {
            ...
            if (stickerSetById != null) {
                ...
                if (positionForPack >= 0) {
                    this.stickersLayoutManager.scrollToPositionWithOffset(positionForPack, AndroidUtilities.m26dp(60.0f));
                }
            }
        }
        int i2 = 0;
            ...
            if (searchField != null) {
                ...
                if (i2 == currentItem && z2) {
                    ...
                    if (obj != null) {
                        ...
                        animatorArr[1] = ObjectAnimator.ofFloat(recyclerListView, View.TRANSLATION_Y, new float[]{(float) (AndroidUtilities.m26dp(48.0f) - this.searchFieldHeight)});
                        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(searchField, View.TRANSLATION_Y, new float[]{(float) (AndroidUtilities.m26dp(48.0f) - this.searchFieldHeight)});
                        i = 2;
                    ...
                    this.searchAnimation.addListener(new AnimatorListenerAdapter() {
                        public void onAnimationEnd(Animator animator) {
                            if (animator.equals(EmojiView.this.searchAnimation)) {
                                ...
                                recyclerListView.setTranslationY(0.0f);
                                if (recyclerListView == EmojiView.this.stickersGridView) {
                                    recyclerListView.setPadding(0, AndroidUtilities.m26dp(52.0f), 0, 0);
                                } else if (recyclerListView == EmojiView.this.emojiGridView) {
                                    recyclerListView.setPadding(0, AndroidUtilities.m26dp(38.0f), 0, 0);
                                }
                    ...
                    gridLayoutManager.scrollToPositionWithOffset(1, 0);
                    searchField.setTranslationY((float) (AndroidUtilities.m26dp(48.0f) - this.searchFieldHeight));
                    if (obj != null) {
    ...
    private void checkBottomTabScroll(float f) {
        ...
        if (this.pager.getCurrentItem() == 0) {
            dp = AndroidUtilities.m26dp(38.0f);
        } else {
            dp = AndroidUtilities.m26dp(48.0f);
        }
            ...
            if (emojiViewDelegate == null || !emojiViewDelegate.isSearchOpened()) {
                ...
                if (z2) {
                    ...
                    if (z) {
                        ...
                        f2 = (float) AndroidUtilities.m26dp(f2);
                    }
                    fArr[0] = f2;
                    ...
                    float[] fArr2 = new float[1];
                    if (!z) {
                        f = (float) AndroidUtilities.m26dp(49.0f);
                    }
                    fArr2[0] = f;
    ...
    private void checkStickersTabY(View view, int i) {
        if (view == null) {
            ...
            if (emojiViewDelegate == null || !emojiViewDelegate.isSearchOpened()) {
                ...
                if (i2 > 0) {
                    this.stickersMinusDy = 0;
                } else if (i2 < (-AndroidUtilities.m26dp(288.0f))) {
                    this.stickersMinusDy = -AndroidUtilities.m26dp(288.0f);
                }
                this.stickersTab.setTranslationY((float) Math.max(-AndroidUtilities.m26dp(48.0f), this.stickersMinusDy));
            }
        }
    }
        ...
        if (emojiViewDelegate == null || !emojiViewDelegate.isSearchOpened()) {
            if (this.emojiSearchField != null) {
                ...
                if (recyclerListView != null) {
                    ...
                    if (findViewHolderForAdapterPosition == null || ((float) findViewHolderForAdapterPosition.itemView.getTop()) < ((float) (AndroidUtilities.m26dp(38.0f) - this.searchFieldHeight)) + this.emojiTabs.getTranslationY()) {
                        z2 = true;
                    }
        ...
        if (view == null) {
            ...
            if (emojiViewDelegate == null || !emojiViewDelegate.isSearchOpened()) {
                ...
                if (i2 > 0) {
                    ...
                    this.emojiMinusDy = -AndroidUtilities.m26dp(288.0f);
                }
                this.emojiTabs.setTranslationY((float) Math.max(-AndroidUtilities.m26dp(38.0f), this.emojiMinusDy));
    ...
    private void postBackspaceRunnable(int i) {
        AndroidUtilities.runOnUIThread(new C2571-$$Lambda$EmojiView$Jrw9DaGNjc5-52tMJtvct_h0u6A(this, i), (long) i);
    }
    ...
    private void updateEmojiTabs() {
        ...
        if (i == -1 || i != isEmpty) {
            ...
            r0 = new String[9];
            int i2 = 0;
            r0[0] = LocaleController.getString("RecentStickers", C1067R.string.RecentStickers);
            r0[1] = LocaleController.getString("Emoji1", C1067R.string.Emoji1);
            r0[2] = LocaleController.getString("Emoji2", C1067R.string.Emoji2);
            r0[3] = LocaleController.getString("Emoji3", C1067R.string.Emoji3);
            r0[4] = LocaleController.getString("Emoji4", C1067R.string.Emoji4);
            r0[5] = LocaleController.getString("Emoji5", C1067R.string.Emoji5);
            r0[6] = LocaleController.getString("Emoji6", C1067R.string.Emoji6);
            r0[7] = LocaleController.getString("Emoji7", C1067R.string.Emoji7);
            r0[8] = LocaleController.getString("Emoji8", C1067R.string.Emoji8);
    ...
    private void updateStickerTabs() {
        ...
        if (scrollSlidingTabStrip != null) {
            ...
            if (this.favouriteStickers.isEmpty()) {
                ...
                this.favTabBum = i;
                this.stickersTabOffset = i + 1;
                this.stickersTab.addIconTab(this.stickerIcons[1]).setContentDescription(LocaleController.getString("FavoriteStickers", C1067R.string.FavoriteStickers));
                obj = 1;
            }
            if (!this.recentStickers.isEmpty()) {
                ...
                this.recentTabBum = i;
                this.stickersTabOffset = i + 1;
                this.stickersTab.addIconTab(this.stickerIcons[0]).setContentDescription(LocaleController.getString("RecentStickers", C1067R.string.RecentStickers));
                obj = 1;
            }
            ...
            if (this.info != null) {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("group_hide_stickers_");
                stringBuilder.append(this.info.f435id);
                long j = emojiSettings.getLong(stringBuilder.toString(), -1);
                Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(this.info.f435id));
                if (chat == null || this.info.stickerset == null || !ChatObject.hasAdminRights(chat)) {
                    ...
                    if (stickerSet != null) {
                        this.groupStickersHidden = j == stickerSet.f466id;
                    }
                }
            ...
            while (i < this.stickerSets.size()) {
                if (i == this.groupStickerPackNum) {
                    Chat chat2 = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(this.info.f435id));
                    if (chat2 == null) {
                    ...
                    stringBuilder2.append(LocaleController.getString("AccDescrStickerSet", C1067R.string.AccDescrStickerSet));
            ...
            if (!(trendingGridAdapter == null || trendingGridAdapter.getItemCount() == 0 || !unreadStickerSets.isEmpty())) {
                ...
                this.stickersTab.addIconTab(this.stickerIcons[2]).setContentDescription(LocaleController.getString("FeaturedStickers", C1067R.string.FeaturedStickers));
            }
    ...
    public void updateUIColors() {
        ...
        String str3 = Theme.key_chat_emojiPanelBackground;
        ...
        ScrollSlidingTabStrip scrollSlidingTabStrip = this.emojiTabs;
        String str4 = Theme.key_chat_emojiPanelShadowLine;
        if (scrollSlidingTabStrip != null) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (searchField != null) {
                ...
                ImageView access$1200 = searchField.clearSearchImageView;
                String str5 = Theme.key_chat_emojiSearchIcon;
                access$1200.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str5), Mode.MULTIPLY));
        ...
        ImageView imageView = this.backspaceButton;
        String str6 = Theme.key_chat_emojiPanelBackspace;
        if (imageView != null) {
        ...
        while (true) {
            ...
            str = Theme.key_chat_emojiPanelIconSelected;
            if (i2 >= i) {
                break;
            }
            Theme.setEmojiDrawableColor(drawableArr[i2], Theme.getColor(Theme.key_chat_emojiBottomPanelIcon), false);
        ...
        while (true) {
            ...
            i = drawableArr.length;
            str2 = Theme.key_chat_emojiPanelIcon;
            if (i2 >= i) {
                break;
            }
        ...
        if (z || this.forseMultiwindowLayout) {
            if (this.currentBackgroundType != 1) {
                if (VERSION.SDK_INT >= 21) {
                    ...
                    setElevation((float) AndroidUtilities.m26dp(2.0f));
                }
                setBackgroundResource(C1067R.C1065drawable.smiles_popup);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view != null) {
            ...
            if (!(this.lastNotifyHeight == i5 && this.lastNotifyHeight2 == height)) {
                EmojiViewDelegate emojiViewDelegate = this.delegate;
                if (emojiViewDelegate != null && emojiViewDelegate.isSearchOpened()) {
                    this.bottomTabContainer.setTranslationY((float) AndroidUtilities.m26dp(49.0f));
    ...
    public void onAttachedToWindow() {
        ...
        if (this.stickersGridAdapter != null) {
            ...
            AndroidUtilities.runOnUIThread(new C2582-$$Lambda$EmojiView$nydI8RFLQx0Boo3VLUW9Gt2FzYg(this));
        }
    }
    ...
    private void checkDocuments(boolean z) {
        ...
        for (int i = 0; i < this.favouriteStickers.size(); i++) {
            ...
            for (int i2 = 0; i2 < this.recentStickers.size(); i2++) {
                ...
                if (document2.dc_id == document.dc_id && document2.f441id == document.f441id) {
            ...
            if (chat != null) {
                ...
                if (!ChatObject.hasAdminRights(chat)) {
                    ...
                    if (tL_chatBannedRights != null && tL_chatBannedRights.send_stickers) {
                        if (z) {
                            this.mediaBanTooltip.setText(LocaleController.getString("GlobalAttachGifRestricted", C1067R.string.GlobalAttachGifRestricted));
                        } else {
                            this.mediaBanTooltip.setText(LocaleController.getString("GlobalAttachStickersRestricted", C1067R.string.GlobalAttachStickersRestricted));
                        }
                        ...
                        animatorSet.addListener(new C283034());
                        animatorSet.setDuration(300);
                        animatorSet.start();
                    }
                }
                ...
                if (tL_chatBannedRights != null) {
                    if (AndroidUtilities.isBannedForever(tL_chatBannedRights)) {
                        if (z) {
                            this.mediaBanTooltip.setText(LocaleController.getString("AttachGifRestrictedForever", C1067R.string.AttachGifRestrictedForever));
                        } else {
                            this.mediaBanTooltip.setText(LocaleController.getString("AttachStickersRestrictedForever", C1067R.string.AttachStickersRestrictedForever));
                        }
                    } else if (z) {
                        this.mediaBanTooltip.setText(LocaleController.formatString("AttachGifRestricted", C1067R.string.AttachGifRestricted, LocaleController.formatDateForBan((long) chat.banned_rights.until_date)));
                    } else {
                        this.mediaBanTooltip.setText(LocaleController.formatString("AttachStickersRestricted", C1067R.string.AttachStickersRestricted, LocaleController.formatDateForBan((long) chat.banned_rights.until_date)));
                    }
                    this.mediaBanTooltip.setVisibility(0);
                    animatorSet = new AnimatorSet();
                    animatorSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.mediaBanTooltip, View.ALPHA, new float[]{0.0f, 1.0f})});
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    ...
                    if (childAt instanceof FeaturedStickerSetInfoCell) {
                        if (((Holder) viewGroup.getChildViewHolder(childAt)) != null) {
                            ...
                            StickerSetCovered stickerSet = featuredStickerSetInfoCell.getStickerSet();
                            boolean z = true;
                            boolean z2 = unreadStickerSets != null && unreadStickerSets.contains(Long.valueOf(stickerSet.set.f466id));
                            featuredStickerSetInfoCell.setStickerSet(stickerSet, z2);
                            if (z2) {
                                DataQuery.getInstance(this.currentAccount).markFaturedStickersByIdAsRead(stickerSet.set.f466id);
                            }
                            Object obj = this.installingStickerSets.indexOfKey(stickerSet.set.f466id) >= 0 ? 1 : null;
                            Object obj2 = this.removingStickerSets.indexOfKey(stickerSet.set.f466id) >= 0 ? 1 : null;
                            if (!(obj == null && obj2 == null)) {
                                if (obj != null && featuredStickerSetInfoCell.isInstalled()) {
                                    this.installingStickerSets.remove(stickerSet.set.f466id);
                                    obj = null;
                                } else if (!(obj2 == null || featuredStickerSetInfoCell.isInstalled())) {
                                    this.removingStickerSets.remove(stickerSet.set.f466id);
                                    obj2 = null;
                                }
                            }
                            if (obj == null) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.stickersDidLoad) {
            ...
            if (chatFull != null) {
                ...
                if (stickerSet != null && stickerSet.f466id == ((Long) objArr[0]).longValue()) {
                    updateStickerTabs();
                }
            }
