...
public class AnimatedFileDrawable extends BitmapDrawable implements Animatable {
    ...
    private Runnable loadFrameRunnable = new C27293();
    private Runnable loadFrameTask;
    protected final Runnable mInvalidateTask = new C2502-$$Lambda$AnimatedFileDrawable$D96GYyKDLrUXCvNeQ7iluME9Yq4(this);
    private final Runnable mStartTask = new C2501-$$Lambda$AnimatedFileDrawable$AmB2znRBjaDHOIPDjH2S8BYovYQ(this);
    ...
    private Runnable uiRunnable = new C27282();
    private Runnable uiRunnableNoFrame = new C27271();
    ...
    class C27293 implements Runnable {
        C27293() {
        }
    ...
    public AnimatedFileDrawable(File file, boolean z, long j, Document document, Object obj, int i) {
        ...
        if (z) {
            this.nativePtr = AnimatedFileDrawable.createDecoder(file.getAbsolutePath(), this.metaData, this.currentAccount, this.streamFileSize, this.stream);
    ...
    public void seekTo(long j, boolean z) {
        synchronized (this.sync) {
            ...
            AnimatedFileDrawable.prepareToSeek(this.nativePtr);
    ...
    public int getIntrinsicHeight() {
        ...
        return i == 0 ? AndroidUtilities.m26dp(100.0f) : i;
    }
