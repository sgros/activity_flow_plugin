...
import org.telegram.p004ui.VoIPFeedbackActivity;
...
public class VoIPService extends VoIPBaseService {
    ...
    class C112312 implements Runnable {
        C112312() {
        }
    ...
    class C112514 implements Runnable {
        C112514() {
        }
    ...
    class C112615 implements Runnable {
        C112615() {
        }
    ...
    class C112716 implements Runnable {
        C112716() {
        }
    ...
    class C112818 implements Runnable {
        C112818() {
        }
        ...
        public void run() {
            ...
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m29e("error restarting activity", e);
                }
    ...
    class C112919 implements Runnable {
        C112919() {
        }
    ...
    class C11376 implements Runnable {
        C11376() {
        }
    ...
    class C11398 implements Runnable {
        C11398() {
        }
    ...
    class C356111 implements RequestDelegate {
        C356111() {
        }
    ...
    class C356213 implements RequestDelegate {
        C356213() {
        }
    ...
    class C356317 implements RequestDelegate {
        C356317() {
        }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        if (VoIPBaseService.sharedInstance != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m28e("Tried to start the VoIP service when it's already started");
            }
            return 2;
        }
        ...
        if (this.currentAccount != -1) {
            ...
            if (this.user == null) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m31w("VoIPService: user==null");
                }
                stopSelf();
                return 2;
            }
            ...
            if (this.isOutgoing) {
                ...
                if (VoIPBaseService.USE_CONNECTION_SERVICE) {
                    ...
                    User user = this.user;
                    instance.createOrUpdateConnectionServiceContact(user.f534id, user.first_name, user.last_name);
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("+99084");
                    stringBuilder.append(this.user.f534id);
                    telecomManager.placeCall(Uri.fromParts("tel", stringBuilder.toString(), null), bundle);
                } else {
                    this.delayedStartOutgoingCall = new C11301();
    ...
    public void onCreate() {
        ...
        if (callIShouldHavePutIntoIntent != null && VERSION.SDK_INT >= 26) {
            ...
            startForeground(201, new Builder(this, NotificationsController.OTHER_NOTIFICATIONS_CHANNEL).setSmallIcon(C1067R.C1065drawable.notification).setContentTitle(LocaleController.getString("VoipOutgoingCall", C1067R.string.VoipOutgoingCall)).setShowWhen(false).build());
        }
    }
    ...
    private void startOutgoingCall() {
        ...
        dispatchStateChanged(14);
        AndroidUtilities.runOnUIThread(new C11313());
                ...
                if (tL_error == null) {
                    ...
                    if (tLObject instanceof TL_messages_dhConfig) {
                        if (Utilities.isGoodPrime(messages_dhconfig.f541p, messages_dhconfig.f540g)) {
                            instance.setSecretPBytes(messages_dhconfig.f541p);
                            instance.setSecretG(messages_dhconfig.f540g);
                    ...
                    ConnectionsManager.getInstance(VoIPService.this.currentAccount).sendRequest(tL_phone_requestCall, new RequestDelegate() {
                        public void run(final TLObject tLObject, final TL_error tL_error) {
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                ...
                                /* renamed from: org.telegram.messenger.voip.VoIPService$4$1$1$1 */
                                class C11331 implements Runnable {

                                    /* renamed from: org.telegram.messenger.voip.VoIPService$4$1$1$1$1 */
                                    class C11341 implements RequestDelegate {

                                        /* renamed from: org.telegram.messenger.voip.VoIPService$4$1$1$1$1$1 */
                                        ...
                                        public void run(TLObject tLObject, TL_error tL_error) {
                                            ...
                                            AndroidUtilities.runOnUIThread(new C11321());
                                        }
                                    }
                                    ...
                                    public void run() {
                                        ...
                                        tL_phone_discardCall.peer.f493id = VoIPService.this.call.f462id;
                                        tL_phone_discardCall.reason = new TL_phoneCallDiscardReasonMissed();
                                        ConnectionsManager.getInstance(VoIPService.this.currentAccount).sendRequest(tL_phone_discardCall, new C11341(), 2);
                                    }
                                }
                                ...
                                public void run() {
                                    ...
                                    if (tL_error == null) {
                                        ...
                                        VoIPService.this.timeoutRunnable = new C11331();
                                        VoIPService voIPService = VoIPService.this;
    ...
    private void acknowledgeCall(final boolean z) {
        if (this.call instanceof TL_phoneCallDiscarded) {
            if (BuildVars.LOGS_ENABLED) {
                ...
                stringBuilder.append(this.call.f462id);
            ...
            tL_inputPhoneCall.f493id = phoneCall.f462id;
                        ...
                        public void run() {
                            if (VoIPBaseService.sharedInstance != null) {
                                ...
                                if (tL_error != null) {
                                    ...
                                    if (VoIPBaseService.USE_CONNECTION_SERVICE) {
                                        ContactsController.getInstance(VoIPService.this.currentAccount).createOrUpdateConnectionServiceContact(VoIPService.this.user.f534id, VoIPService.this.user.first_name, VoIPService.this.user.last_name);
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m28e("MIUI: no permission to show when locked but the screen is locked. ¯\\_(ツ)_/¯");
            }
            stopSelf();
        }
    }
    ...
    public void startRinging() {
        if (this.currentState != 15) {
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("Showing incoming call notification");
                }
            } else {
                startRingtoneAndVibration(this.user.f534id);
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("Starting incall activity for incoming call");
                }
                try {
    ...
    public void acceptIncomingCall() {
        ...
        AndroidUtilities.runOnUIThread(new C11376());
        final MessagesStorage instance = MessagesStorage.getInstance(this.currentAccount);
        TL_messages_getDhConfig tL_messages_getDhConfig = new TL_messages_getDhConfig();
        tL_messages_getDhConfig.random_length = 256;
        tL_messages_getDhConfig.version = instance.getLastSecretVersion();
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getDhConfig, new RequestDelegate() {
            ...
            /* renamed from: org.telegram.messenger.voip.VoIPService$7$1 */
            class C35681 implements RequestDelegate {
                C35681() {
                }
                ...
                if (tL_error == null) {
                    ...
                    if (tLObject instanceof TL_messages_dhConfig) {
                        if (Utilities.isGoodPrime(messages_dhconfig.f541p, messages_dhconfig.f540g)) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m28e("stopping VoIP service, bad prime");
                            }
                            VoIPService.this.callFailed();
                            return;
                        }
                    ...
                    tL_phone_acceptCall.peer.f493id = VoIPService.this.call.f462id;
                    ...
                    tL_phoneCallProtocol.min_layer = 65;
                    tL_phoneCallProtocol.max_layer = VoIPService.CALL_MAX_LAYER;
                    ConnectionsManager.getInstance(VoIPService.this.currentAccount).sendRequest(tL_phone_acceptCall, new C35681(), 2);
                } else {
                    VoIPService.this.callFailed();
                }
            }
    ...
    public void declineIncomingCall(int i, final Runnable runnable) {
        ...
        if (i2 == 14) {
            ...
            if (runnable2 != null) {
                ...
                AndroidUtilities.runOnUIThread(new C11398(), 5000);
            }
            return;
        }
        if (!(i2 == 10 || i2 == 11)) {
    ...
    public void onCallUpdated(PhoneCall phoneCall) {
        ...
        if (phoneCall2 == null) {
            ...
            StringBuilder stringBuilder;
            if (phoneCall.f462id != phoneCall2.f462id) {
                if (BuildVars.LOGS_ENABLED) {
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("onCallUpdated called with wrong call id (got ");
                    stringBuilder.append(phoneCall.f462id);
            ...
            if (phoneCall instanceof TL_phoneCallDiscarded) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("call discarded, stopping service");
                }
                ...
                if (this.needSendDebugLog && this.debugLog != null) {
                    ...
                    tL_inputPhoneCall.access_hash = phoneCall.access_hash;
                    tL_inputPhoneCall.f493id = phoneCall.f462id;
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_phone_saveCallDebug, new C356111());
                }
            } else if ((phoneCall instanceof TL_phoneCall) && this.authKey == null) {
                byte[] bArr = phoneCall.g_a_or_b;
                if (bArr == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m31w("stopping VoIP service, Ga == null");
                    }
                    callFailed();
                    ...
                    if (Utilities.isGoodGaAndGb(bigInteger, bigInteger2)) {
                        ...
                        if (this.keyFingerprint != phoneCall.key_fingerprint) {
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m31w("key fingerprints don't match");
                            }
                            callFailed();
                            return;
                        }
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m31w("stopping VoIP service, bad Ga and Gb (accepting)");
                        }
                        callFailed();
                    }
                } else {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m31w("stopping VoIP service, Ga hash doesn't match");
                    }
                    callFailed();
                }
                ...
                this.timeoutRunnable = new C112312();
    ...
    private void startRatingActivity() {
        try {
            PendingIntent.getActivity(this, 0, new Intent(this, VoIPFeedbackActivity.class).putExtra("call_id", this.call.f462id).putExtra("call_access_hash", this.call.access_hash).putExtra("account", this.currentAccount).addFlags(805306368), 0).send();
        } catch (Exception e) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m29e("Error starting incall activity", e);
            }
    ...
    private void processAcceptedCall() {
        ...
        if (Utilities.isGoodGaAndGb(bigInteger2, bigInteger)) {
            ...
            tL_phoneCallProtocol.udp_reflector = true;
            tL_phoneCallProtocol.udp_p2p = true;
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_phone_confirmCall, new C356213());
            return;
        }
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m31w("stopping VoIP service, bad Ga and Gb");
        }
        callFailed();
    }
    ...
    L_0x0014:
        ...
        org.telegram.messenger.FileLog.m27d(r3);	 Catch:{ Exception -> 0x0187 }
    L_0x002a:
        ...
        r7 = r7.f462id;	 Catch:{ Exception -> 0x0187 }
    ...
    L_0x00a4:
        ...
        r8 = r8 / r6;
        r6 = "VoipDataSaving";
        r7 = org.telegram.p004ui.Components.voip.VoIPHelper.getDataSavingDefault();	 Catch:{ Exception -> 0x0187 }
        ...
        r11 = r1.f462id;	 Catch:{ Exception -> 0x0187 }
        r6 = r2;
    ...
    private void startConnectingSound() {
        ...
        if (this.spPlayID == 0) {
            C112716 c112716 = new C112716();
            this.connectingSoundRunnable = c112716;
            AndroidUtilities.runOnUIThread(c112716, 100);
        }
    }
    ...
    public void callFailed(int i) {
        if (this.call != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("Discarding failed call");
            }
            TL_phone_discardCall tL_phone_discardCall = new TL_phone_discardCall();
            tL_phone_discardCall.peer = new TL_inputPhoneCall();
            TL_inputPhoneCall tL_inputPhoneCall = tL_phone_discardCall.peer;
            ...
            tL_phone_discardCall.connection_id = preferredRelayID;
            tL_phone_discardCall.reason = new TL_phoneCallDiscardReasonDisconnect();
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_phone_discardCall, new C356317());
        }
        super.callFailed(i);
    }
    ...
    public long getCallID() {
        PhoneCall phoneCall = this.call;
        return phoneCall != null ? phoneCall.f462id : 0;
    }
    ...
    public void onUIForegroundStateChanged(boolean z) {
        if (VERSION.SDK_INT < 21 && this.currentState == 15) {
            if (z) {
                ...
                AndroidUtilities.runOnUIThread(new C112818(), 500);
