...
public class SimpleTextView extends View implements Callback {
    ...
    private int drawablePadding = AndroidUtilities.m26dp(4.0f);
    ...
    public void setTextSize(int i) {
        float dp = (float) AndroidUtilities.m26dp((float) i);
    ...
    private void calcOffset(int i) {
        if (this.layout.getLineCount() > 0) {
            ...
            if ((this.gravity & 7) == 3) {
                ...
                this.offsetX = -AndroidUtilities.m26dp(8.0f);
            }
    ...
    private boolean createLayout(int i) {
        if (this.text != null) {
            try {
                ...
                this.layout = new StaticLayout(charSequence2, 0, charSequence2.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m26dp(2000.0f) : AndroidUtilities.m26dp(8.0f) + i, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                calcOffset(i);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (i3 != i4) {
            ...
            this.currentScrollDelay = SCROLL_DELAY_MS;
        }
    ...
    L_0x0014:
        ...
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ActionBar.SimpleTextView.setText(java.lang.CharSequence, boolean):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        i = this.totalWidth + AndroidUtilities.m26dp(16.0f);
        ...
        if (this.layout != null) {
            ...
            if (this.scrollNonFitText && (this.textDoesNotFit || this.scrollingOffset != 0.0f)) {
                if (this.scrollingOffset < ((float) AndroidUtilities.m26dp(10.0f))) {
                    this.fadeDrawable.setAlpha((int) ((this.scrollingOffset / ((float) AndroidUtilities.m26dp(10.0f))) * 255.0f));
                } else if (this.scrollingOffset > ((float) ((this.totalWidth + AndroidUtilities.m26dp(16.0f)) - AndroidUtilities.m26dp(10.0f)))) {
                    this.fadeDrawable.setAlpha((int) ((1.0f - ((this.scrollingOffset - ((float) ((this.totalWidth + AndroidUtilities.m26dp(16.0f)) - AndroidUtilities.m26dp(10.0f)))) / ((float) AndroidUtilities.m26dp(10.0f)))) * 255.0f));
                } else {
                    this.fadeDrawable.setAlpha(NalUnitUtil.EXTENDED_SAR);
                }
                this.fadeDrawable.setBounds(0, 0, AndroidUtilities.m26dp(6.0f), getMeasuredHeight());
                this.fadeDrawable.draw(canvas);
                this.fadeDrawableBack.setBounds(getMeasuredWidth() - AndroidUtilities.m26dp(6.0f), 0, getMeasuredWidth(), getMeasuredHeight());
    ...
    private void updateScrollAnimation() {
        ...
        if (this.textDoesNotFit || this.scrollingOffset != 0.0f) {
            ...
            if (i > 0) {
                ...
                i = this.totalWidth + AndroidUtilities.m26dp(16.0f);
                float f = 50.0f;
                if (this.scrollingOffset < ((float) AndroidUtilities.m26dp(100.0f))) {
                    f = ((this.scrollingOffset / ((float) AndroidUtilities.m26dp(100.0f))) * 20.0f) + 30.0f;
                } else if (this.scrollingOffset >= ((float) (i - AndroidUtilities.m26dp(100.0f)))) {
                    f = 50.0f - (((this.scrollingOffset - ((float) (i - AndroidUtilities.m26dp(100.0f)))) / ((float) AndroidUtilities.m26dp(100.0f))) * 20.0f);
                }
                this.scrollingOffset += (((float) j) / 1000.0f) * ((float) AndroidUtilities.m26dp(f));
