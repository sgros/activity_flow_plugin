...
public class WallpaperParallaxEffect implements SensorEventListener {
    ...
    public WallpaperParallaxEffect(Context context) {
        this.f610wm = (WindowManager) context.getSystemService("window");
    ...
    public float getScale(int i, int i2) {
        float f = (float) i;
        float dp = (float) (AndroidUtilities.m26dp(16.0f) * 2);
        float f2 = (f + dp) / f;
        f = (float) i2;
    ...
    public void onSensorChanged(android.hardware.SensorEvent r17) {
        ...
        r3 = 0;
        r4 = r2[r3];
        r5 = 1092413450; // 0x411ce80a float:9.80665 double:5.397239567E-315;
        r4 = r4 / r5;
        r6 = 1;
        r7 = r2[r6];
        r7 = r7 / r5;
        ...
        r11 = 4614256656552045848; // 0x400921fb54442d18 float:3.37028055E12 double:3.141592653589793;
        r9 = r9 / r11;
        r13 = 4611686018427387904; // 0x4000000000000000 float:0.0 double:2.0;
        r9 = r9 * r13;
        r5 = (float) r9;
        r9 = (double) r7;
        r4 = r4 * r4;
    ...
    L_0x00b8:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.WallpaperParallaxEffect.onSensorChanged(android.hardware.SensorEvent):void");
    }
}
