...
import org.telegram.p004ui.Cells.InviteTextCell;
import org.telegram.p004ui.Cells.InviteUserCell;
...
public class InviteContactsActivity extends BaseFragment implements NotificationCenterDelegate, OnClickListener {
    ...
    class C30565 implements Callback {
    ...
    class C30576 implements OnKeyListener {
    ...
    class C30587 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            if (InviteContactsActivity.this.editText.length() != 0) {
                ...
                InviteContactsActivity.this.emptyView.setText(LocaleController.getString("NoResult", C1067R.string.NoResult));
                return;
            }
    ...
    private class SpansContainer extends ViewGroup {
        ...
        class C30601 extends AnimatorListenerAdapter {
            C30601() {
            }
        ...
        public void onMeasure(int i, int i2) {
            ...
            float f = 32.0f;
            int dp = size - AndroidUtilities.m26dp(32.0f);
            int dp2 = AndroidUtilities.m26dp(12.0f);
            int dp3 = AndroidUtilities.m26dp(12.0f);
            int i3 = 0;
            int i4 = 0;
            int i5 = 0;
            while (true) {
                ...
                if (childAt instanceof GroupCreateSpan) {
                    float f2;
                    float f3;
                    childAt.measure(MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(f), 1073741824));
                    if (childAt == this.removingSpan || childAt.getMeasuredWidth() + i4 <= dp) {
                        f2 = 12.0f;
                    } else {
                        f2 = 12.0f;
                        dp2 += childAt.getMeasuredHeight() + AndroidUtilities.m26dp(12.0f);
                        i4 = 0;
                    }
                    if (childAt.getMeasuredWidth() + i5 > dp) {
                        dp3 += childAt.getMeasuredHeight() + AndroidUtilities.m26dp(f2);
                        f3 = 16.0f;
                        i5 = 0;
                    } else {
                        f3 = 16.0f;
                    }
                    int dp4 = AndroidUtilities.m26dp(f3) + i4;
                    if (!this.animationStarted) {
                        View view = this.removingSpan;
                        if (childAt == view) {
                            childAt.setTranslationX((float) (AndroidUtilities.m26dp(f3) + i5));
                    ...
                    if (childAt != this.removingSpan) {
                        i4 += childAt.getMeasuredWidth() + AndroidUtilities.m26dp(9.0f);
                    }
            ...
            if (AndroidUtilities.isTablet()) {
                childCount = AndroidUtilities.m26dp(366.0f) / 3;
            } else {
                Point point = AndroidUtilities.displaySize;
                childCount = (Math.min(point.x, point.y) - AndroidUtilities.m26dp(164.0f)) / 3;
            }
            if (dp - i4 < childCount) {
                dp2 += AndroidUtilities.m26dp(44.0f);
                i4 = 0;
            }
            if (dp - i5 < childCount) {
                dp3 += AndroidUtilities.m26dp(44.0f);
            }
            InviteContactsActivity.this.editText.measure(MeasureSpec.makeMeasureSpec(dp - i4, 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(32.0f), 1073741824));
            if (!this.animationStarted) {
                dp3 += AndroidUtilities.m26dp(44.0f);
                i4 += AndroidUtilities.m26dp(16.0f);
                InviteContactsActivity.this.fieldY = dp2;
                if (this.currentAnimation != null) {
                    boolean z;
                    if (InviteContactsActivity.this.containerHeight != dp2 + AndroidUtilities.m26dp(44.0f)) {
        ...
        public void addSpan(GroupCreateSpan groupCreateSpan) {
            ...
            this.currentAnimation.addListener(new C30601());
    ...
    class C42031 extends ActionBarMenuOnItemClick {
        C42031() {
        }
    ...
    class C42058 extends OnScrollListener {
        C42058() {
        }
    ...
    public class InviteAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 1) {
                ...
                inviteUserCell.setTextAndIcon(LocaleController.getString("ShareTelegram", C1067R.string.ShareTelegram), C1067R.C1065drawable.share);
            }
        ...
        public void searchDialogs(final String str) {
            ...
            this.searchTimer.schedule(new TimerTask() {
                public void run() {
                    ...
                    AndroidUtilities.runOnUIThread(new C1555x4b718af7(this, str));
                }

                public /* synthetic */ void lambda$run$1$InviteContactsActivity$InviteAdapter$1(String str) {
                    Utilities.searchQueue.postRunnable(new C1554xb8386a57(this, str));
                }
     ...
     */
                ...
                L_0x0010:
                    r1 = org.telegram.p004ui.InviteContactsActivity.InviteAdapter.this;
                ...
                L_0x0046:
                    ...
                    r7 = 0;
                L_0x0051:
                    r8 = org.telegram.p004ui.InviteContactsActivity.InviteAdapter.this;
                    r8 = org.telegram.p004ui.InviteContactsActivity.this;
                ...
                L_0x00df:
                    ...
                    goto L_0x0051;
                L_0x00e4:
                    r3 = org.telegram.p004ui.InviteContactsActivity.InviteAdapter.this;
                    r3.updateSearchResults(r1, r2);
                    return;
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.InviteContactsActivity$InviteAdapter$C30591.lambda$null$0$InviteContactsActivity$InviteAdapter$1(java.lang.String):void");
                }
            }, 200, 300);
        }

        private void updateSearchResults(ArrayList<Contact> arrayList, ArrayList<CharSequence> arrayList2) {
            AndroidUtilities.runOnUIThread(new C1556xcd426364(this, arrayList, arrayList2));
        }

        /* renamed from: lambda$updateSearchResults$0$InviteContactsActivity$InviteAdapter */
        public /* synthetic */ void mo16745xf72d2e5d(ArrayList arrayList, ArrayList arrayList2) {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("InviteFriends", C1067R.string.InviteFriends));
        this.actionBar.setActionBarMenuOnItemClick(new C42031());
        this.fragmentView = new ViewGroup(context2) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                InviteContactsActivity.this.infoTextView.measure(MeasureSpec.makeMeasureSpec(i, 1073741824), MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
                InviteContactsActivity.this.counterView.measure(MeasureSpec.makeMeasureSpec(i, 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(48.0f), 1073741824));
                ...
                InviteContactsActivity.this.scrollView.measure(MeasureSpec.makeMeasureSpec(i, 1073741824), MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
                InviteContactsActivity.this.listView.measure(MeasureSpec.makeMeasureSpec(i, 1073741824), MeasureSpec.makeMeasureSpec((i2 - InviteContactsActivity.this.scrollView.getMeasuredHeight()) - measuredHeight, 1073741824));
                InviteContactsActivity.this.emptyView.measure(MeasureSpec.makeMeasureSpec(i, 1073741824), MeasureSpec.makeMeasureSpec((i2 - InviteContactsActivity.this.scrollView.getMeasuredHeight()) - AndroidUtilities.m26dp(72.0f), 1073741824));
            }
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                InviteContactsActivity.this.emptyView.layout(0, InviteContactsActivity.this.scrollView.getMeasuredHeight() + AndroidUtilities.m26dp(72.0f), InviteContactsActivity.this.emptyView.getMeasuredWidth(), InviteContactsActivity.this.scrollView.getMeasuredHeight() + InviteContactsActivity.this.emptyView.getMeasuredHeight());
                i4 -= i2;
        ...
        this.scrollView = new ScrollView(context2) {
            public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
                ...
                rect.top += InviteContactsActivity.this.fieldY + AndroidUtilities.m26dp(20.0f);
                rect.bottom += InviteContactsActivity.this.fieldY + AndroidUtilities.m26dp(50.0f);
        ...
        this.editText.setHintText(LocaleController.getString("SearchFriends", C1067R.string.SearchFriends));
        this.editText.setCustomSelectionActionModeCallback(new C30565());
        this.editText.setOnKeyListener(new C30576());
        this.editText.addTextChangedListener(new C30587());
        ...
        this.listView.setOnItemClickListener(new C3701-$$Lambda$InviteContactsActivity$2CAh12ObsNHUdlUsHSs_VZmRL0I(this));
        this.listView.setOnScrollListener(new C42058());
        this.infoTextView = new TextView(context2);
        TextView textView = this.infoTextView;
        String str = Theme.key_contacts_inviteBackground;
        textView.setBackgroundColor(Theme.getColor(str));
        textView = this.infoTextView;
        String str2 = Theme.key_contacts_inviteText;
        textView.setTextColor(Theme.getColor(str2));
        this.infoTextView.setGravity(17);
        this.infoTextView.setText(LocaleController.getString("InviteFriendsHelp", C1067R.string.InviteFriendsHelp));
        this.infoTextView.setTextSize(1, 13.0f);
        String str3 = "fonts/rmedium.ttf";
        this.infoTextView.setTypeface(AndroidUtilities.getTypeface(str3));
        this.infoTextView.setPadding(AndroidUtilities.m26dp(17.0f), AndroidUtilities.m26dp(9.0f), AndroidUtilities.m26dp(17.0f), AndroidUtilities.m26dp(9.0f));
        ...
        this.counterView.setOnClickListener(new C1557-$$Lambda$InviteContactsActivity$nq-MZzgy9JlkAxS_tdx9DVT5pQg(this));
        ...
        this.counterTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m26dp(10.0f), Theme.getColor(str2)));
        this.counterTextView.setMinWidth(AndroidUtilities.m26dp(20.0f));
        this.counterTextView.setPadding(AndroidUtilities.m26dp(6.0f), 0, AndroidUtilities.m26dp(6.0f), AndroidUtilities.m26dp(1.0f));
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m26dp(8.0f));
        this.textView.setText(LocaleController.getString("InviteToTelegram", C1067R.string.InviteToTelegram).toUpperCase());
    ...
    private void fetchContacts() {
        ...
        Collections.sort(this.phoneBookContacts, C1558-$$Lambda$InviteContactsActivity$r58ALapXATHsxuXB3Kf3_z6GjIA.INSTANCE);
    ...
    public ThemeDescription[] getThemeDescriptions() {
        C3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI = new C3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI(this);
        ...
        strArr[0] = "textView";
        themeDescriptionArr[19] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_groupcreate_sectionText);
        ...
        strArr = new String[1];
        strArr[0] = "checkBox";
        themeDescriptionArr[21] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_checkbox);
        themeDescriptionArr[22] = new ThemeDescription(this.listView, ThemeDescription.FLAG_TEXTCOLOR, new Class[]{InviteUserCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_checkboxCheck);
        view = this.listView;
        i = ThemeDescription.FLAG_TEXTCOLOR | ThemeDescription.FLAG_CHECKTAG;
        clsArr = new Class[]{InviteUserCell.class};
        strArr = new String[1];
        strArr[0] = "statusTextView";
        themeDescriptionArr[23] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteBlueText);
        themeDescriptionArr[24] = new ThemeDescription(this.listView, ThemeDescription.FLAG_TEXTCOLOR | ThemeDescription.FLAG_CHECKTAG, new Class[]{InviteUserCell.class}, new String[]{"statusTextView"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText);
        ...
        C3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2 = c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI;
        themeDescriptionArr[26] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundRed);
        themeDescriptionArr[27] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundOrange);
        themeDescriptionArr[28] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundViolet);
        themeDescriptionArr[29] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundGreen);
        themeDescriptionArr[30] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundCyan);
        themeDescriptionArr[31] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundBlue);
        themeDescriptionArr[32] = new ThemeDescription(null, 0, null, null, null, c3702-$$Lambda$InviteContactsActivity$lRM1FX-g-ooIebl8RwlJ1GDWMOI2, Theme.key_avatar_backgroundPink);
