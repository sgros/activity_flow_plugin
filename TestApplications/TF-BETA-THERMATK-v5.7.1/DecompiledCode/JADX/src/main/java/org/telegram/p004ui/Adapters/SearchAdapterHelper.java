...
public class SearchAdapterHelper {
    ...
    public interface SearchAdapterHelperDelegate {
        ...
        public final /* synthetic */ class C2281-CC {
    ...
    public void queryServerSearch(String str, boolean z, boolean z2, boolean z3, boolean z4, int i, int i2) {
        ...
        if (str.length() <= 0) {
            ...
            tL_channels_getParticipants.filter.f433q = str2;
            ...
            this.channelReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getParticipants, new C3915-$$Lambda$SearchAdapterHelper$lQm_KegCMNFAimI1TKtkhyCcOJg(this, i3, str, z4), 2);
        } else {
            z5 = z4;
        ...
        if (z) {
            if (str.length() > 0) {
                ...
                tL_contacts_search.f482q = str2;
                tL_contacts_search.limit = 50;
                int i5 = this.lastReqId + 1;
                this.lastReqId = i5;
                this.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_search, new C3914-$$Lambda$SearchAdapterHelper$dscYso9YL4gEzQpoIdpN_Bu9BdA(this, i5, z2, z3, z4, str), 2);
            } else {
                this.globalSearch.clear();
                this.globalSearchMap.clear();
                this.localServerSearch.clear();
    ...
    public /* synthetic */ void lambda$queryServerSearch$1$SearchAdapterHelper(int i, String str, boolean z, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2271-$$Lambda$SearchAdapterHelper$v5cwP_i-1geBZNEja0OzJuPoFoM(this, i, tL_error, tLObject, str, z));
    }
    ...
    public /* synthetic */ void lambda$queryServerSearch$3$SearchAdapterHelper(int i, boolean z, boolean z2, boolean z3, String str, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2265-$$Lambda$SearchAdapterHelper$BW0zXscUb5FIQ5wJIg2kAIcfk-Q(this, i, tL_error, tLObject, z, z2, z3, str));
    }
    ...
    public /* synthetic */ void lambda$null$2$SearchAdapterHelper(int i, TL_error tL_error, TLObject tLObject, boolean z, boolean z2, boolean z3, String str) {
        if (i == this.lastReqId && tL_error == null) {
            ...
            for (i2 = 0; i2 < tL_contacts_found.chats.size(); i2++) {
                ...
                sparseArray.put(chat.f434id, chat);
            }
                ...
                for (int i3 = 0; i3 < arrayList.size(); i3++) {
                    ...
                    if (obj != null) {
                        if (z) {
                            ...
                            this.globalSearchMap.put(-obj.f434id, obj);
                        }
                    } else if (user2 != null && ((z2 || !user2.bot) && (z3 || !user2.self))) {
                        this.globalSearch.add(user2);
                        this.globalSearchMap.put(user2.f534id, user2);
                    }
                }
            }
            if (!this.allResultsAreGlobal) {
                for (int i6 = 0; i6 < tL_contacts_found.my_results.size(); i6++) {
                    ...
                    if (obj3 != null) {
                        ...
                        this.globalSearchMap.put(-obj3.f434id, obj3);
                    } else if (obj2 != null) {
                        this.localServerSearch.add(obj2);
                        this.globalSearchMap.put(obj2.f534id, obj2);
                    }
                }
            }
    ...
    public boolean loadRecentHashtags() {
        ...
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2266-$$Lambda$SearchAdapterHelper$DPsjy4ay_Xo08TMx7YPJqUY2IzQ(this));
        return false;
    }
    ...
    public /* synthetic */ void lambda$loadRecentHashtags$6$SearchAdapterHelper() {
        try {
            ...
            Collections.sort(arrayList, C2269-$$Lambda$SearchAdapterHelper$lNn-ZPLbXEKTf0Mjca-3cj25zrw.INSTANCE);
            AndroidUtilities.runOnUIThread(new C2268-$$Lambda$SearchAdapterHelper$cRKQG3dF6eBcmtMnbev_zK5TKlg(this, arrayList, hashMap));
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }
        ...
        if (this.globalSearchMap.size() != 0 && arrayList != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (tLObject instanceof User) {
                    ...
                    User user2 = (User) this.globalSearchMap.get(user.f534id);
                    if (user2 != null) {
                        this.globalSearch.remove(user2);
                        this.localServerSearch.remove(user2);
                        this.globalSearchMap.remove(user2.f534id);
                    }
                    TLObject tLObject2 = (TLObject) this.groupSearchMap.get(user.f534id);
                    if (tLObject2 != null) {
                        this.groupSearch.remove(tLObject2);
                        this.groupSearchMap.remove(user.f534id);
                    }
                } else if (tLObject instanceof Chat) {
                    Chat chat = (Chat) this.globalSearchMap.get(-((Chat) tLObject).f434id);
                    if (chat != null) {
                        this.globalSearch.remove(chat);
                        this.localServerSearch.remove(chat);
                        this.globalSearchMap.remove(-chat.f434id);
                    }
                }
            }
        }
            ...
            if (excludeUsers != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (user != null) {
                        ...
                        this.globalSearchMap.remove(user.f534id);
                    }
                }
            }
        }
    ...
    private void putRecentHashtags(ArrayList<HashtagObject> arrayList) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2267-$$Lambda$SearchAdapterHelper$GIT1_XH69tqWW5ny1WrNuu7bX8Q(this, arrayList));
    }
    ...
    public void clearRecentHashtags() {
        this.hashtags = new ArrayList();
        this.hashtagsByText = new HashMap();
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C2270-$$Lambda$SearchAdapterHelper$rJWBOKrijR0k23tFEyFN_1lhPTE(this));
    }
