...
import org.telegram.p004ui.Cells.ArchiveHintCell;
import org.telegram.p004ui.Cells.DialogCell;
import org.telegram.p004ui.Cells.DialogMeUrlCell;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                dialogCell.setText(LocaleController.getString("RecentlyViewed", C1067R.string.RecentlyViewed));
                TextView textView = new TextView(this.mContext);
                textView.setTextSize(1, 15.0f);
                textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader));
                textView.setText(LocaleController.getString("RecentlyViewedHide", C1067R.string.RecentlyViewedHide));
                int i2 = 3;
                ...
                textView.setOnClickListener(new C2234-$$Lambda$DialogsAdapter$9rZHEUZrGiCwZ807CAFufwsMqa0(this));
                break;
            case 3:
                c22751 = new FrameLayout(this.mContext) {
                    /* Access modifiers changed, original: protected */
                    public void onMeasure(int i, int i2) {
                        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(12.0f), 1073741824));
                    }
                };
                c22751.setBackgroundColor(Theme.getColor(str2));
                View view = new View(this.mContext);
                view.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider, str));
                c22751.addView(view, LayoutHelper.createFrame(-1, -1.0f));
                break;
            case 4:
            ...
            case 7:
                dialogCell = new HeaderCell(this.mContext);
                dialogCell.setText(LocaleController.getString("YourContacts", C1067R.string.YourContacts));
                break;
            case 8:
                c22751 = new ShadowSectionCell(this.mContext);
                CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(str2)), Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider, str));
                combinedDrawable.setFullsize(true);
                c22751.setBackgroundDrawable(combinedDrawable);
                break;
            case 9:
                ...
                dialogCell = new View(this.mContext) {
                    ...
                    public void onMeasure(int i, int i2) {
                        ...
                        if (!(size == 0 || obj == null)) {
                            ...
                            int dp = AndroidUtilities.m26dp(SharedConfig.useThreeLinesLayout ? 78.0f : 72.0f);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (itemViewType == 0) {
            ...
            if (this.dialogsType == 0 && AndroidUtilities.isTablet()) {
                if (dialog.f440id != this.openedDialogId) {
                    z = false;
                }
                dialogCell.setDialogSelected(z);
            }
            dialogCell.setChecked(this.selectedDialogs.contains(Long.valueOf(dialog.f440id)), false);
