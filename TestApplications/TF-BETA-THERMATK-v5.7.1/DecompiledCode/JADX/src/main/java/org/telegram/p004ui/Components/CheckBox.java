...
public class CheckBox extends View {
    ...
    class C27831 extends AnimatorListenerAdapter {
        C27831() {
        }
    ...
    public CheckBox(Context context, int i) {
        ...
        eraser2.setStrokeWidth((float) AndroidUtilities.m26dp(28.0f));
        backgroundPaint.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0 && this.drawBitmap == null) {
            try {
                this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m26dp((float) this.size), AndroidUtilities.m26dp((float) this.size), Config.ARGB_4444);
                this.bitmapCanvas = new Canvas(this.drawBitmap);
                this.checkBitmap = Bitmap.createBitmap(AndroidUtilities.m26dp((float) this.size), AndroidUtilities.m26dp((float) this.size), Config.ARGB_4444);
    ...
    public void setSize(int i) {
        this.size = i;
        if (i == 40) {
            this.textPaint.setTextSize((float) AndroidUtilities.m26dp(24.0f));
        }
    }
    ...
    private void animateToCheckedState(boolean z) {
        ...
        this.checkAnimator.addListener(new C27831());
    ...
    L_0x0064:
        r9 = org.telegram.messenger.AndroidUtilities.m26dp(r7);
        r9 = (float) r9;
        r9 = r9 * r6;
        r9 = r9 / r8;
    L_0x006c:
    ...
    L_0x00cf:
        r6 = org.telegram.messenger.AndroidUtilities.m26dp(r7);
        r6 = (float) r6;
        r0 = r0 - r6;
    L_0x00d5:
        r6 = r11.bitmapCanvas;
    ...
    L_0x0130:
        r7 = 1105199104; // 0x41e00000 float:28.0 double:5.46040909E-315;
        goto L_0x0135;
    L_0x0133:
    ...
    L_0x016d:
        ...
        r2 = r2 / 2;
        r6 = 1075838976; // 0x40200000 float:2.5 double:5.315350785E-315;
    ...
    L_0x01a6:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.CheckBox.onDraw(android.graphics.Canvas):void");
    }
