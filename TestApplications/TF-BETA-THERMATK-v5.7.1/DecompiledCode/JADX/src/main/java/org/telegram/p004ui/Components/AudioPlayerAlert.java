...
import org.telegram.p004ui.Cells.AudioPlayerCell;
...
public class AudioPlayerAlert extends BottomSheet implements NotificationCenterDelegate, FileDownloadProgressListener {
    ...
    class C27365 extends AnimatorListenerAdapter {
        C27365() {
        }
    ...
    class C40732 extends ActionBarMenuItemSearchListener {
        C40732() {
        }
    ...
    class C40743 extends ActionBarMenuOnItemClick {
        C40743() {
        }
    ...
    class C40768 extends OnScrollListener {
        C40768() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                audioPlayerCell.setLayoutParams(new LayoutParams(-1, AndroidUtilities.m26dp(178.0f)));
            }
        ...
        private void processSearch(String str) {
            AndroidUtilities.runOnUIThread(new C2507x35635be2(this, str));
        }

        public /* synthetic */ void lambda$processSearch$1$AudioPlayerAlert$ListAdapter(String str) {
            Utilities.searchQueue.postRunnable(new C2505x5dc16ece(this, str, new ArrayList(AudioPlayerAlert.this.playlist)));
        }
        ...
        L_0x00c7:
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.AudioPlayerAlert$ListAdapter.lambda$null$0$AudioPlayerAlert$ListAdapter(java.lang.String, java.util.ArrayList):void");
        }

        private void updateSearchResults(ArrayList<MessageObject> arrayList) {
            AndroidUtilities.runOnUIThread(new C2506xc2f42f99(this, arrayList));
        }
    ...
    public AudioPlayerAlert(Context context) {
        ...
        this.noCoverDrawable = context.getResources().getDrawable(C1067R.C1065drawable.nocover).mutate();
        ...
        String str = Theme.key_player_background;
        ...
        this.containerView = new FrameLayout(context2) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                int dp2 = (((AndroidUtilities.m26dp(178.0f) + (AudioPlayerAlert.this.playlist.size() * AndroidUtilities.m26dp(56.0f))) + AudioPlayerAlert.this.backgroundPaddingTop) + C2190ActionBar.getCurrentActionBarHeight()) + AndroidUtilities.statusBarHeight;
                int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i2, 1073741824);
                int i3 = 0;
                if (AudioPlayerAlert.this.searching) {
                    dp = AndroidUtilities.m26dp(178.0f) + C2190ActionBar.getCurrentActionBarHeight();
                    dp2 = VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0;
                } else {
                    dp = dp2 < i2 ? i2 - dp2 : dp2 < i2 ? 0 : i2 - ((i2 / 5) * 3);
                    dp2 = C2190ActionBar.getCurrentActionBarHeight() + (VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
                }
                dp += dp2;
                boolean z = true;
                if (AudioPlayerAlert.this.listView.getPaddingTop() != dp) {
                    this.ignoreLayout = true;
                    AudioPlayerAlert.this.listView.setPadding(0, dp, 0, AndroidUtilities.m26dp(8.0f));
                ...
                i2 = (i2 - i3) - AndroidUtilities.m26dp(120.0f);
                i = Math.max(i2, getMeasuredWidth());
                AudioPlayerAlert.this.thumbMaxX = ((getMeasuredWidth() - i) / 2) - AndroidUtilities.m26dp(17.0f);
                AudioPlayerAlert.this.thumbMaxY = AndroidUtilities.m26dp(19.0f);
                ...
                AudioPlayerAlert.this.endTranslation = (float) (C2190ActionBar.getCurrentActionBarHeight() + (AndroidUtilities.statusBarHeight - AndroidUtilities.m26dp(19.0f)));
        ...
        this.actionBar = new C2190ActionBar(context2);
        ...
        String str2 = Theme.key_player_actionBarTitle;
        c2190ActionBar.setTitleColor(Theme.getColor(str2));
        ...
        this.avatarContainer.setTitleColors(Theme.getColor(str2), Theme.getColor(Theme.key_player_actionBarSubtitle));
        if (playingMessageObject != null) {
        ...
        this.avatarContainer.setSubtitle(LocaleController.getString("AudioTitle", C1067R.string.AudioTitle));
        this.actionBar.addView(this.avatarContainer, 0, LayoutHelper.createFrame(-2, -1.0f, 51, 56.0f, 0.0f, 40.0f, 0.0f));
        ActionBarMenu createMenu = this.actionBar.createMenu();
        createMenu.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C1067R.string.AccDescrMoreOptions));
        this.menuItem = createMenu.addItem(0, (int) C1067R.C1065drawable.ic_ab_other);
        this.menuItem.addSubItem(1, (int) C1067R.C1065drawable.msg_forward, LocaleController.getString("Forward", C1067R.string.Forward));
        this.menuItem.addSubItem(2, (int) C1067R.C1065drawable.msg_shareout, LocaleController.getString("ShareFile", C1067R.string.ShareFile));
        this.menuItem.addSubItem(4, (int) C1067R.C1065drawable.msg_message, LocaleController.getString("ShowInChat", C1067R.string.ShowInChat));
        this.menuItem.setTranslationX((float) AndroidUtilities.m26dp(48.0f));
        this.menuItem.setAlpha(0.0f);
        this.searchItem = createMenu.addItem(0, (int) C1067R.C1065drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C40732());
        this.searchItem.setContentDescription(LocaleController.getString("Search", C1067R.string.Search));
        EditTextBoldCursor searchField = this.searchItem.getSearchField();
        searchField.setHint(LocaleController.getString("Search", C1067R.string.Search));
        searchField.setTextColor(Theme.getColor(str2));
        String str3 = Theme.key_player_time;
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C40743());
        this.shadow = new View(context2);
        this.shadow.setAlpha(0.0f);
        this.shadow.setBackgroundResource(C1067R.C1065drawable.header_shadow);
        this.shadow2 = new View(context2);
        this.shadow2.setAlpha(0.0f);
        this.shadow2.setBackgroundResource(C1067R.C1065drawable.header_shadow);
        ...
        this.placeholderImageView = new BackupImageView(context2) {
            ...
            public void onDraw(Canvas canvas) {
                if (AudioPlayerAlert.this.hasNoCover == 1 || (AudioPlayerAlert.this.hasNoCover == 2 && !(getImageReceiver().hasBitmapImage() && getImageReceiver().getCurrentAlpha() == 1.0f))) {
                    ...
                    int dp = (int) (((float) AndroidUtilities.m26dp(63.0f)) * Math.max(((AudioPlayerAlert.this.thumbMaxScale / getScaleX()) / 3.0f) / AudioPlayerAlert.this.thumbMaxScale, 1.0f / AudioPlayerAlert.this.thumbMaxScale));
                    float f = (float) (dp / 2);
        ...
        this.placeholderImageView.setRoundRadius(AndroidUtilities.m26dp(20.0f));
        this.placeholderImageView.setPivotX(0.0f);
        this.placeholderImageView.setPivotY(0.0f);
        this.placeholderImageView.setOnClickListener(new C2511-$$Lambda$AudioPlayerAlert$rAc8YAca3eZCLAfei_UTWtnjvbQ(this));
        ...
        this.optionsButton = new ActionBarMenuItem(context2, null, 0, Theme.getColor(Theme.key_player_actionBarItems));
        this.optionsButton.setLongClickEnabled(false);
        this.optionsButton.setIcon((int) C1067R.C1065drawable.ic_ab_other);
        this.optionsButton.setAdditionalOffset(-AndroidUtilities.m26dp(120.0f));
        this.playerLayout.addView(this.optionsButton, LayoutHelper.createFrame(40, 40.0f, 53, 0.0f, 19.0f, 10.0f, 0.0f));
        this.optionsButton.addSubItem(1, (int) C1067R.C1065drawable.msg_forward, LocaleController.getString("Forward", C1067R.string.Forward));
        this.optionsButton.addSubItem(2, (int) C1067R.C1065drawable.msg_shareout, LocaleController.getString("ShareFile", C1067R.string.ShareFile));
        this.optionsButton.addSubItem(4, (int) C1067R.C1065drawable.msg_message, LocaleController.getString("ShowInChat", C1067R.string.ShowInChat));
        this.optionsButton.setOnClickListener(new C2504-$$Lambda$AudioPlayerAlert$L6a3eFAcdzUb5tmijbnBD0GiP9c(this));
        this.optionsButton.setDelegate(new C4022-$$Lambda$AudioPlayerAlert$2le4yIg27yXBU0W-K7geAc_qlH0(this));
        this.optionsButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", C1067R.string.AccDescrMoreOptions));
        this.seekBarView = new SeekBarView(context2);
        this.seekBarView.setDelegate(C4026-$$Lambda$AudioPlayerAlert$pQ-5LDOKmp9BWnrwt0sO-Br-q0g.INSTANCE);
        ...
        C27376 c27376 = new FrameLayout(context2) {
            /* Access modifiers changed, original: protected */
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                i3 = ((i3 - i) - AndroidUtilities.m26dp(248.0f)) / 4;
                for (int i5 = 0; i5 < 5; i5++) {
                    i = AndroidUtilities.m26dp((float) ((i5 * 48) + 4)) + (i3 * i5);
                    i2 = AndroidUtilities.m26dp(9.0f);
        ...
        this.playerLayout.addView(c27376, LayoutHelper.createFrame(-1, 66.0f, 51, 0.0f, 106.0f, 0.0f, 0.0f));
        ...
        this.shuffleButton.setAdditionalOffset(-AndroidUtilities.m26dp(10.0f));
        c27376.addView(this.shuffleButton, LayoutHelper.createFrame(48, 48, 51));
        this.shuffleButton.setOnClickListener(new C2512-$$Lambda$AudioPlayerAlert$vDsQnotDAAYl8VqVL3Roz4WO8JM(this));
        TextView addSubItem = this.shuffleButton.addSubItem(1, LocaleController.getString("ReverseOrder", C1067R.string.ReverseOrder));
        addSubItem.setPadding(AndroidUtilities.m26dp(8.0f), 0, AndroidUtilities.m26dp(16.0f), 0);
        this.playOrderButtons[0] = context.getResources().getDrawable(C1067R.C1065drawable.music_reverse).mutate();
        addSubItem.setCompoundDrawablePadding(AndroidUtilities.m26dp(8.0f));
        addSubItem.setCompoundDrawablesWithIntrinsicBounds(this.playOrderButtons[0], null, null, null);
        addSubItem = this.shuffleButton.addSubItem(2, LocaleController.getString("Shuffle", C1067R.string.Shuffle));
        addSubItem.setPadding(AndroidUtilities.m26dp(8.0f), 0, AndroidUtilities.m26dp(16.0f), 0);
        this.playOrderButtons[1] = context.getResources().getDrawable(C1067R.C1065drawable.pl_shuffle).mutate();
        addSubItem.setCompoundDrawablePadding(AndroidUtilities.m26dp(8.0f));
        addSubItem.setCompoundDrawablesWithIntrinsicBounds(this.playOrderButtons[1], null, null, null);
        this.shuffleButton.setDelegate(new C4024-$$Lambda$AudioPlayerAlert$HopcJEXECX0ZxGGa4UewdstQ_LI(this));
        viewArr = this.buttons;
        ImageView imageView = new ImageView(context2);
        viewArr[1] = imageView;
        imageView.setScaleType(ScaleType.CENTER);
        String str4 = Theme.key_player_button;
        int color = Theme.getColor(str4);
        String str5 = Theme.key_player_buttonActive;
        imageView.setImageDrawable(Theme.createSimpleSelectorDrawable(context2, C1067R.C1065drawable.pl_previous, color, Theme.getColor(str5)));
        c27376.addView(imageView, LayoutHelper.createFrame(48, 48, 51));
        imageView.setOnClickListener(C2509-$$Lambda$AudioPlayerAlert$_25s4XwmMXC5vKIS0zNvR6jdxfg.INSTANCE);
        imageView.setContentDescription(LocaleController.getString("AccDescrPrevious", C1067R.string.AccDescrPrevious));
        View[] viewArr2 = this.buttons;
        ImageView imageView2 = new ImageView(context2);
        this.playButton = imageView2;
        viewArr2[2] = imageView2;
        this.playButton.setScaleType(ScaleType.CENTER);
        this.playButton.setImageDrawable(Theme.createSimpleSelectorDrawable(context2, C1067R.C1065drawable.pl_play, Theme.getColor(str4), Theme.getColor(str5)));
        c27376.addView(this.playButton, LayoutHelper.createFrame(48, 48, 51));
        this.playButton.setOnClickListener(C2508-$$Lambda$AudioPlayerAlert$TTY43GWhuW3FlUWxplw8ac-chYU.INSTANCE);
        View[] viewArr3 = this.buttons;
        imageView2 = new ImageView(context2);
        viewArr3[3] = imageView2;
        imageView2.setScaleType(ScaleType.CENTER);
        imageView2.setImageDrawable(Theme.createSimpleSelectorDrawable(context2, C1067R.C1065drawable.pl_next, Theme.getColor(str4), Theme.getColor(str5)));
        c27376.addView(imageView2, LayoutHelper.createFrame(48, 48, 51));
        imageView2.setOnClickListener(C2503-$$Lambda$AudioPlayerAlert$4X94PKs6A-0UhkXhWsjRM6iEc3I.INSTANCE);
        imageView2.setContentDescription(LocaleController.getString("Next", C1067R.string.Next));
        ...
        this.repeatButton.setPadding(0, 0, AndroidUtilities.m26dp(8.0f), 0);
        c27376.addView(this.repeatButton, LayoutHelper.createFrame(50, 48, 51));
        this.repeatButton.setOnClickListener(new C2510-$$Lambda$AudioPlayerAlert$dXFO6JRbR1ZdMBRfhd2XydhikZ0(this));
        this.listView = new RecyclerListView(context2) {
            ...
            public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                ...
                r11 = org.telegram.p004ui.Components.AudioPlayerAlert.this;
            ...
            L_0x001a:
                ...
                r1 = org.telegram.p004ui.Components.AudioPlayerAlert.this;
                r1 = r1.searchOpenPosition;
                r3 = org.telegram.p004ui.Components.AudioPlayerAlert.this;
            ...
            L_0x004b:
                ...
                if (r11 == 0) goto L_0x00cb;
            L_0x005a:
                r0 = org.telegram.p004ui.Components.AudioPlayerAlert.this;
                r0 = r0.listView;
                r0 = r0.getChildCount();
                r3 = 0;
            L_0x0065:
            ...
            L_0x0067:
                r4 = org.telegram.p004ui.Components.AudioPlayerAlert.this;
                r4 = r4.listView;
                r4 = r4.getChildAt(r3);
                r5 = r4 instanceof org.telegram.p004ui.Cells.AudioPlayerCell;
                if (r5 == 0) goto L_0x008a;
            L_0x0075:
                r5 = r4;
                r5 = (org.telegram.p004ui.Cells.AudioPlayerCell) r5;
            ...
            L_0x00cb:
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.AudioPlayerAlert$C40777.onLayout(boolean, int, int, int, int):void");
            }
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                canvas.save();
                canvas.clipRect(0, (AudioPlayerAlert.this.actionBar != null ? AudioPlayerAlert.this.actionBar.getMeasuredHeight() : 0) + AndroidUtilities.m26dp(50.0f), getMeasuredWidth(), getMeasuredHeight());
                boolean drawChild = super.drawChild(canvas, view, j);
                canvas.restore();
                return drawChild;
            }
        };
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m26dp(8.0f));
        ...
        this.listView.setOnItemClickListener(C4023-$$Lambda$AudioPlayerAlert$48MEuBkln-g5kGMLm89eP-Rsutc.INSTANCE);
        this.listView.setOnScrollListener(new C40768());
    ...
    public /* synthetic */ void lambda$new$0$AudioPlayerAlert(View view) {
        ...
        if (this.scrollOffsetY <= this.actionBar.getMeasuredHeight()) {
            ...
            fArr[0] = this.isInFullMode ? 0.0f : 1.0f;
            String str2 = "alpha";
            animatorArr[1] = ObjectAnimator.ofFloat(c2190ActionBar, str2, fArr);
        ...
        this.animatorSet.addListener(new C27365());
        ...
        if (this.isInFullMode) {
            this.shuffleButton.setAdditionalOffset(-AndroidUtilities.m26dp(68.0f));
        } else {
            this.shuffleButton.setAdditionalOffset(-AndroidUtilities.m26dp(10.0f));
        }
    }
    ...
    public void setFullAnimationProgress(float f) {
        ...
        this.placeholderImageView.setRoundRadius(AndroidUtilities.m26dp((1.0f - this.fullAnimationProgress) * 20.0f));
    ...
    L_0x00b3:
        ...
        r0 = "ShareFile";
        r2 = 2131560748; // 0x7f0d092c float:1.8746877E38 double:1.0531309376E-314;
    ...
    L_0x00c9:
        ...
        r0 = "PleaseDownload";
        r1 = 2131560454; // 0x7f0d0806 float:1.874628E38 double:1.0531307924E-314;
    ...
    L_0x017a:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.AudioPlayerAlert.onSubItemClick(int):void");
    }
    ...
    public void onBackPressed() {
        C2190ActionBar c2190ActionBar = this.actionBar;
        if (c2190ActionBar == null || !c2190ActionBar.isSearchFieldVisible()) {
            super.onBackPressed();
        } else {
    ...
    private void updateShuffleButton() {
        ...
        String str2 = Theme.key_player_buttonActive;
        if (z) {
            mutate = getContext().getResources().getDrawable(C1067R.C1065drawable.pl_shuffle).mutate();
            mutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str2), Mode.MULTIPLY));
            this.shuffleButton.setIcon(mutate);
            this.shuffleButton.setContentDescription(LocaleController.getString("Shuffle", C1067R.string.Shuffle));
        } else {
            mutate = getContext().getResources().getDrawable(C1067R.C1065drawable.music_reverse).mutate();
            if (SharedConfig.playOrderReversed) {
                mutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str2), Mode.MULTIPLY));
            } else {
            ...
            this.shuffleButton.setIcon(mutate);
            this.shuffleButton.setContentDescription(LocaleController.getString("ReverseOrder", C1067R.string.ReverseOrder));
        }
    ...
    private void updateRepeatButton() {
        ...
        if (i == 0) {
            this.repeatButton.setImageResource(C1067R.C1065drawable.pl_repeat);
            ...
            this.repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatOff", C1067R.string.AccDescrRepeatOff));
            return;
        }
        String str2 = Theme.key_player_buttonActive;
        if (i == 1) {
            ...
            this.repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatList", C1067R.string.AccDescrRepeatList));
        } else if (i == 2) {
            this.repeatButton.setImageResource(C1067R.C1065drawable.pl_repeat1);
            this.repeatButton.setTag(str2);
            this.repeatButton.setColorFilter(new PorterDuffColorFilter(Theme.getColor(str2), Mode.MULTIPLY));
            this.repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatOne", C1067R.string.AccDescrRepeatOne));
        }
    }
    ...
    private void updateTitle(boolean z) {
        ...
        if ((playingMessageObject == null && z) || (playingMessageObject != null && !playingMessageObject.isMusic())) {
            ...
            String str = Theme.key_player_buttonActive;
            String str2 = Theme.key_player_button;
            ImageView imageView;
            if (isMessagePaused) {
                imageView = this.playButton;
                imageView.setImageDrawable(Theme.createSimpleSelectorDrawable(imageView.getContext(), C1067R.C1065drawable.pl_play, Theme.getColor(str2), Theme.getColor(str)));
                this.playButton.setContentDescription(LocaleController.getString("AccActionPlay", C1067R.string.AccActionPlay));
            } else {
                imageView = this.playButton;
                imageView.setImageDrawable(Theme.createSimpleSelectorDrawable(imageView.getContext(), C1067R.C1065drawable.pl_pause, Theme.getColor(str2), Theme.getColor(str)));
                this.playButton.setContentDescription(LocaleController.getString("AccActionPause", C1067R.string.AccActionPause));
            }
