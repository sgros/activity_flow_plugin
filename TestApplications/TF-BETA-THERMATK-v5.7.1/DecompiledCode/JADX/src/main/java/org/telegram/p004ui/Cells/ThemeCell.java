...
public class ThemeCell extends FrameLayout {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        ...
        */
    public void setTheme(org.telegram.p004ui.ActionBar.Theme.ThemeInfo r17, boolean r18) {
        /*
        r16 = this;
        r1 = r16;
        r0 = r17;
        ...
        r0 = org.telegram.p004ui.ActionBar.Theme.getAssetFile(r0);	 Catch:{ Throwable -> 0x0100 }
    ...
    L_0x00af:
        ...
        goto L_0x0115;
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ all -> 0x00fc }
        if (r2 == 0) goto L_0x0109;
        r2.close();	 Catch:{ Exception -> 0x00f0 }
        if (r4 != 0) goto L_0x0114;
        r0 = r1.paint;
        r2 = org.telegram.p004ui.ActionBar.Theme.getDefaultColor(r3);
        r0.setColor(r2);
        return;
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ThemeCell.setTheme(org.telegram.ui.ActionBar.Theme$ThemeInfo, boolean):void");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            FileLog.m27d(String.format("set color %d %d %d %d", r1));
            float dp = LocaleController.isRTL ? 0.0f : (float) AndroidUtilities.m26dp(20.0f);
        ...
        color = AndroidUtilities.m26dp(31.0f);
        if (LocaleController.isRTL) {
            color = getWidth() - color;
        }
        canvas.drawCircle((float) color, (float) AndroidUtilities.m26dp(24.0f), (float) AndroidUtilities.m26dp(11.0f), this.paint);
    }
