...
public class PollEditTextCell extends FrameLayout {
    ...
    public PollEditTextCell(Context context, OnClickListener onClickListener) {
        ...
        this.textView.setPadding(0, AndroidUtilities.m26dp(14.0f), 0, AndroidUtilities.m26dp(14.0f));
        ...
        if (onClickListener != null) {
            ...
            this.deleteImageView.setImageResource(C1067R.C1065drawable.msg_panel_clear);
            ...
            this.deleteImageView.setContentDescription(LocaleController.getString("Delete", C1067R.string.Delete));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (imageView != null) {
            imageView.measure(MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(48.0f), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(48.0f), 1073741824));
            this.textView2.measure(MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(48.0f), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(24.0f), 1073741824));
        }
        this.textView.measure(MeasureSpec.makeMeasureSpec(((i - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m26dp(this.deleteImageView != null ? 79.0f : 42.0f), 1073741824), MeasureSpec.makeMeasureSpec(0, 0));
        i2 = this.textView.getMeasuredHeight();
        setMeasuredDimension(i, Math.max(AndroidUtilities.m26dp(50.0f), this.textView.getMeasuredHeight()) + this.needDivider);
        SimpleTextView simpleTextView = this.textView2;
        if (simpleTextView != null) {
            simpleTextView.setAlpha(i2 >= AndroidUtilities.m26dp(52.0f) ? 1.0f : 0.0f);
        }
    }
