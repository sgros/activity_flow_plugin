...
import org.telegram.p004ui.Components.Paint.Painting.PaintingDelegate;
...
public class RenderView extends TextureView {
    ...
    class C28821 implements SurfaceTextureListener {

        /* renamed from: org.telegram.ui.Components.Paint.RenderView$1$1 */
        class C28801 implements Runnable {
            C28801() {
            }
        ...
        class C28812 implements Runnable {
            C28812() {
            }
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
            if (RenderView.this.internal != null) {
                ...
                RenderView.this.updateTransform();
                RenderView.this.internal.requestRender();
                RenderView.this.internal.postRunnable(new C28801());
            }
        }

        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            if (!(RenderView.this.internal == null || RenderView.this.shuttingDown)) {
                RenderView.this.painting.onPause(new C28812());
            }
            return true;
        }
    }
    ...
    class C28833 implements Runnable {
        C28833() {
        }
    ...
    class C28912 implements PaintingDelegate {
    ...
    private class CanvasInternal extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C28861();
        private EGL10 egl10;
            ...
            public void run() {
                if (CanvasInternal.this.initialized && !RenderView.this.shuttingDown) {
                    ...
                    if (!CanvasInternal.this.ready) {
                        RenderView.this.queue.postRunnable(new C28851(), 200);
                    }
                }
            }
        }
        ...
        class C28872 implements Runnable {
            C28872() {
            }
        ...
        class C28883 implements Runnable {
            C28883() {
            }
        ...
        class C28894 implements Runnable {
            C28894() {
            }
        ...
        public void scheduleRedraw() {
            ...
            this.scheduledRunnable = new C28883();
    ...
    public RenderView(Context context, Painting painting, Bitmap bitmap, int i) {
        ...
        setSurfaceTextureListener(new C28821());
        this.painting.setDelegate(new C28912());
    }
