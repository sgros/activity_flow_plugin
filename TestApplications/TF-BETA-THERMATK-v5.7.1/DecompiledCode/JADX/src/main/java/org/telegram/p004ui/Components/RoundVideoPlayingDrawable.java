...
public class RoundVideoPlayingDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            canvas.drawRect((float) (AndroidUtilities.m26dp(2.0f) + i), (float) (AndroidUtilities.m26dp((this.progress1 * 7.0f) + 2.0f) + i2), (float) (AndroidUtilities.m26dp(4.0f) + i), (float) (AndroidUtilities.m26dp(10.0f) + i2), this.paint);
            Canvas canvas2 = canvas;
            canvas2.drawRect((float) (AndroidUtilities.m26dp(5.0f) + i), (float) (AndroidUtilities.m26dp((this.progress2 * 7.0f) + 2.0f) + i2), (float) (AndroidUtilities.m26dp(7.0f) + i), (float) (AndroidUtilities.m26dp(10.0f) + i2), this.paint);
            canvas2.drawRect((float) (AndroidUtilities.m26dp(8.0f) + i), (float) (AndroidUtilities.m26dp((this.progress3 * 7.0f) + 2.0f) + i2), (float) (AndroidUtilities.m26dp(10.0f) + i), (float) (AndroidUtilities.m26dp(10.0f) + i2), this.paint);
        }
        if (this.started) {
            update();
        }
