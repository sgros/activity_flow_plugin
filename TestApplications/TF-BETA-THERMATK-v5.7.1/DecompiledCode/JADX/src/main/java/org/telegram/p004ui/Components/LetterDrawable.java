...
public class LetterDrawable extends Drawable {
    ...
    public LetterDrawable() {
        ...
        namePaint.setTextSize((float) AndroidUtilities.m26dp(28.0f));
    ...
    public void setTitle(String str) {
        ...
        if (this.stringBuilder.length() > 0) {
            try {
                this.textLayout = new StaticLayout(this.stringBuilder.toString().toUpperCase(), namePaint, AndroidUtilities.m26dp(100.0f), Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    ...
    public void draw(Canvas canvas) {
        ...
        if (bounds != null) {
            ...
            canvas.drawRoundRect(this.rect, (float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(4.0f), paint);
            canvas.save();
