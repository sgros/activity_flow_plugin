...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C23502 extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawCircle((float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(5.0f), (float) AndroidUtilities.m26dp(3.0f), this.paint);
        }
        ...
        public int getIntrinsicHeight() {
            return AndroidUtilities.m26dp(8.0f);
        }
    }

    /* renamed from: org.telegram.ui.Cells.FeaturedStickerSetCell$3 */
    class C23513 extends AnimatorListenerAdapter {
        C23513() {
        }
    ...
    class C23524 extends AnimatorListenerAdapter {
        C23524() {
        }
        ...
        this.addButton = new TextView(context) {
            ...
            public void onDraw(Canvas canvas) {
                ...
                if (FeaturedStickerSetCell.this.drawProgress || !(FeaturedStickerSetCell.this.drawProgress || FeaturedStickerSetCell.this.progressAlpha == 0.0f)) {
                    FeaturedStickerSetCell.this.progressPaint.setAlpha(Math.min(NalUnitUtil.EXTENDED_SAR, (int) (FeaturedStickerSetCell.this.progressAlpha * 255.0f)));
                    int measuredWidth = getMeasuredWidth() - AndroidUtilities.m26dp(11.0f);
                    FeaturedStickerSetCell.this.progressRect.set((float) measuredWidth, (float) AndroidUtilities.m26dp(3.0f), (float) (measuredWidth + AndroidUtilities.m26dp(8.0f)), (float) AndroidUtilities.m26dp(11.0f));
                    ...
                    invalidate(((int) FeaturedStickerSetCell.this.progressRect.left) - AndroidUtilities.m26dp(2.0f), ((int) FeaturedStickerSetCell.this.progressRect.top) - AndroidUtilities.m26dp(2.0f), ((int) FeaturedStickerSetCell.this.progressRect.right) + AndroidUtilities.m26dp(2.0f), ((int) FeaturedStickerSetCell.this.progressRect.bottom) + AndroidUtilities.m26dp(2.0f));
    ...
    public void setStickersSet(StickerSetCovered stickerSetCovered, boolean z, boolean z2) {
        ...
        if (z2) {
            Drawable c23502 = new C23502();
            TextView textView = this.textView;
            Drawable drawable = LocaleController.isRTL ? null : c23502;
            if (!LocaleController.isRTL) {
                c23502 = null;
            }
            textView.setCompoundDrawablesWithIntrinsicBounds(drawable, null, c23502, null);
        } else {
        ...
        if (obj != null) {
            z4 = this.isInstalled;
            boolean isStickerPackInstalled = DataQuery.getInstance(this.currentAccount).isStickerPackInstalled(stickerSetCovered2.set.f466id);
            ...
            if (isStickerPackInstalled) {
                if (!z4) {
                    ...
                    this.currentAnimation.addListener(new C23513());
                ...
                this.currentAnimation.addListener(new C23524());
                this.currentAnimation.start();
                return;
            } else {
                return;
        ...
        z4 = DataQuery.getInstance(this.currentAccount).isStickerPackInstalled(stickerSetCovered2.set.f466id);
        this.isInstalled = z4;
        if (z4) {
