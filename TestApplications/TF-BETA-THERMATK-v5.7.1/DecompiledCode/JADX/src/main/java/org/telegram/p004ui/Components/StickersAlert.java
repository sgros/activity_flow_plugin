...
public class StickersAlert extends BottomSheet implements NotificationCenterDelegate {
    ...
    class C29509 extends AnimatorListenerAdapter {
        C29509() {
        }
    ...
    private static class LinkMovementMethodMy extends LinkMovementMethod {
        ...
        /* synthetic */ LinkMovementMethodMy(C41461 c41461) {
            this();
        }
    ...
    class C41461 implements ContentPreviewViewerDelegate {
        public /* synthetic */ void gifAddedOrDeleted() {
            C3013-CC.$default$gifAddedOrDeleted(this);
        }
        ...
        public /* synthetic */ void sendGif(Object obj) {
            C3013-CC.$default$sendGif(this, obj);
        }
    ...
    class C41474 extends SpanSizeLookup {
        C41474() {
        }
    ...
    class C41485 extends ItemDecoration {
        C41485() {
        }
    ...
    class C41496 extends OnScrollListener {
        C41496() {
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View featuredStickerSetInfoCell = i != 0 ? i != 1 ? i != 2 ? null : new FeaturedStickerSetInfoCell(this.context, 8) : new EmptyCell(this.context) : new StickerEmojiCell(this.context) {
                public void onMeasure(int i, int i2) {
                    super.onMeasure(MeasureSpec.makeMeasureSpec(StickersAlert.this.itemSize, 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(82.0f), 1073741824));
                }
            };
    ...
    public StickersAlert(Context context, Object obj, Photo photo) {
        ...
        this.previewDelegate = new C41461();
        ...
        tL_inputStickeredMediaPhoto.f551id = new TL_inputPhoto();
        InputPhoto inputPhoto = tL_inputStickeredMediaPhoto.f551id;
        inputPhoto.f459id = photo.f463id;
        ...
        this.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getAttachedStickers, new C4060-$$Lambda$StickersAlert$70AzTfODxLbeSRDlB8gJ7WKPlnE(this, obj, tL_messages_getAttachedStickers, new C4063-$$Lambda$StickersAlert$R4T4Ne-ypM57cFmDbPuLpbHC0Ro(this, tL_messages_getAttachedStickers)));
        init(context);
    }
    ...
    public /* synthetic */ void lambda$new$1$StickersAlert(TL_messages_getAttachedStickers tL_messages_getAttachedStickers, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2681-$$Lambda$StickersAlert$NU6Lj7s7oms1kuoHZ-7sXpiftZ4(this, tL_error, tLObject, tL_messages_getAttachedStickers));
    }
    ...
    private void loadStickerSet() {
        ...
        if (inputStickerSet != null) {
            ...
            if (this.stickerSet == null) {
                this.stickerSet = DataQuery.getInstance(this.currentAccount).getStickerSetById(this.inputStickerSet.f460id);
            }
            if (this.stickerSet == null) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getStickerSet, new C4064-$$Lambda$StickersAlert$dpylIMqKi3ssdFN3dGRn2NGUFco(this));
    ...
    public /* synthetic */ void lambda$loadStickerSet$4$StickersAlert(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2677-$$Lambda$StickersAlert$6dF2CqzwWOiq-mtWdyHxV9DIihc(this, tL_error, tLObject));
    }
    ...
    public /* synthetic */ void lambda$null$3$StickersAlert(TL_error tL_error, TLObject tLObject) {
        ...
        Toast.makeText(getContext(), LocaleController.getString("AddStickersNotFound", C1067R.string.AddStickersNotFound), 0).show();
        dismiss();
    }
    ...
    private void init(Context context) {
        ...
        this.containerView = new FrameLayout(context2) {
            ...
            public void onMeasure(int i, int i2) {
                ...
                getMeasuredWidth();
                StickersAlert.this.itemSize = (MeasureSpec.getSize(i) - AndroidUtilities.m26dp(36.0f)) / 5;
                if (StickersAlert.this.stickerSetCovereds != null) {
                    dp = ((AndroidUtilities.m26dp(56.0f) + (AndroidUtilities.m26dp(60.0f) * StickersAlert.this.stickerSetCovereds.size())) + (StickersAlert.this.adapter.stickersRowCount * AndroidUtilities.m26dp(82.0f))) + StickersAlert.this.backgroundPaddingTop;
                    dp2 = AndroidUtilities.m26dp(24.0f);
                } else {
                    dp = (AndroidUtilities.m26dp(96.0f) + (Math.max(3, StickersAlert.this.stickerSet != null ? (int) Math.ceil((double) (((float) StickersAlert.this.stickerSet.documents.size()) / 5.0f)) : 0) * AndroidUtilities.m26dp(82.0f))) + StickersAlert.this.backgroundPaddingTop;
                ...
                if (StickersAlert.this.stickerSetCovereds != null) {
                    dp2 += AndroidUtilities.m26dp(8.0f);
                }
                if (StickersAlert.this.gridView.getPaddingTop() != dp2) {
                    StickersAlert.this.ignoreLayout = true;
                    StickersAlert.this.gridView.setPadding(AndroidUtilities.m26dp(10.0f), dp2, AndroidUtilities.m26dp(10.0f), 0);
            ...
            public void onDraw(android.graphics.Canvas r14) {
                /*
                r13 = this;
                r0 = org.telegram.p004ui.Components.StickersAlert.this;
                r0 = r0.scrollOffsetY;
                r1 = org.telegram.p004ui.Components.StickersAlert.this;
                ...
                r1 = org.telegram.p004ui.Components.StickersAlert.this;
                r1 = r1.scrollOffsetY;
                r2 = org.telegram.p004ui.Components.StickersAlert.this;
                ...
                r2 = r2 + r3;
                r3 = org.telegram.p004ui.Components.StickersAlert.this;
            ...
            L_0x0059:
                r3 = r6 * 2;
                r3 = r3 - r1;
                r7 = org.telegram.p004ui.Components.StickersAlert.this;
            ...
            L_0x0079:
                r6 = org.telegram.p004ui.Components.StickersAlert.this;
            ...
            L_0x0084:
                r6 = r7 - r1;
                r8 = org.telegram.p004ui.Components.StickersAlert.this;
            ...
            L_0x00b1:
                ...
                r4.setColor(r5);
                r4 = r13.rect;
                r5 = org.telegram.p004ui.Components.StickersAlert.this;
                ...
                r7 = (float) r7;
                r8 = r13.getMeasuredWidth();
                r9 = org.telegram.p004ui.Components.StickersAlert.this;
            ...
            L_0x018e:
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.StickersAlert$C29482.onDraw(android.graphics.Canvas):void");
            }
        };
        ...
        layoutParams.topMargin = AndroidUtilities.m26dp(48.0f);
        this.shadow[0] = new View(context2);
        View view = this.shadow[0];
        String str2 = Theme.key_dialogShadowLine;
        ...
        this.layoutManager.setSpanSizeLookup(new C41474());
        ...
        this.gridView.addItemDecoration(new C41485());
        this.gridView.setPadding(AndroidUtilities.m26dp(10.0f), 0, AndroidUtilities.m26dp(10.0f), 0);
        this.gridView.setClipToPadding(false);
        this.gridView.setEnabled(true);
        this.gridView.setGlowColor(Theme.getColor(Theme.key_dialogScrollGlow));
        this.gridView.setOnTouchListener(new C2683-$$Lambda$StickersAlert$_nwA8t-8QJfVh6HJUgTR9--hiGc(this));
        this.gridView.setOnScrollListener(new C41496());
        this.stickersOnItemClickListener = new C4065-$$Lambda$StickersAlert$pqY8OpOZq71Xrxq3rh8h2TYv4Gk(this);
        ...
        this.emptyView.setOnTouchListener(C2687-$$Lambda$StickersAlert$x4wnZ8iSeVTFndyEhtM4m12j-W8.INSTANCE);
        ...
        this.titleTextView.setPadding(AndroidUtilities.m26dp(18.0f), 0, AndroidUtilities.m26dp(18.0f), 0);
        ...
        this.optionsButton = new ActionBarMenuItem(context2, null, 0, Theme.getColor(Theme.key_sheet_other));
        ...
        this.optionsButton.addSubItem(1, (int) C1067R.C1065drawable.msg_shareout, LocaleController.getString("StickersShare", C1067R.string.StickersShare));
        this.optionsButton.addSubItem(2, (int) C1067R.C1065drawable.msg_link, LocaleController.getString("CopyLink", C1067R.string.CopyLink));
        this.optionsButton.setOnClickListener(new C2678-$$Lambda$StickersAlert$7978RXQKfGxYvNzfCRh5mokiXDU(this));
        this.optionsButton.setDelegate(new C4062-$$Lambda$StickersAlert$9rn6i7qVo7Tr6wYcNUHGgSRyKIM(this));
        ...
        this.pickerBottomLayout.setBackgroundDrawable(Theme.createSelectorWithBackgroundDrawable(Theme.getColor(str), Theme.getColor(Theme.key_listSelector)));
        TextView textView = this.pickerBottomLayout;
        String str4 = Theme.key_dialogTextBlue2;
        textView.setTextColor(Theme.getColor(str4));
        ...
        this.stickerPreviewLayout.setBackgroundColor(Theme.getColor(str) & -536870913);
        ...
        this.stickerPreviewLayout.setOnClickListener(new C2684-$$Lambda$StickersAlert$nsigcALZ-A8eXyilWi1cmTZCn2o(this));
        ...
        this.previewSendButton.setPadding(AndroidUtilities.m26dp(29.0f), 0, AndroidUtilities.m26dp(29.0f), 0);
        ...
        this.previewSendButton.setOnClickListener(new C2679-$$Lambda$StickersAlert$BjajSs_-vXEFUr5UZfKatrtPlkU(this));
        layoutParams = new LayoutParams(-1, AndroidUtilities.getShadowHeight(), 83);
        layoutParams.bottomMargin = AndroidUtilities.m26dp(48.0f);
    ...
    L_0x011a:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.StickersAlert.lambda$init$6$StickersAlert(android.view.View, int):void");
    }
    ...
    private void updateSendButton() {
        ...
        if (this.delegate != null) {
            ...
            if (tL_messages_stickerSet == null || !tL_messages_stickerSet.set.masks) {
                this.previewSendButton.setText(LocaleController.getString("SendSticker", C1067R.string.SendSticker).toUpperCase());
                float f = (float) min;
        ...
        this.previewSendButton.setText(LocaleController.getString("Close", C1067R.string.Close).toUpperCase());
    ...
    L_0x00ac:
        ...
        r1 = r0.set;
        r1 = r1.masks;
        r6 = 2131560554; // 0x7f0d086a float:1.8746484E38 double:1.053130842E-314;
    ...
    L_0x010a:
        ...
        r6 = r0.set;
        r6 = r6.masks;
        r7 = 2131558585; // 0x7f0d00b9 float:1.874249E38 double:1.053129869E-314;
        r8 = "AddStickersCount";
    ...
    L_0x0150:
        ...
        goto L_0x016f;
    L_0x0156:
        r0 = 2131559117; // 0x7f0d02cd float:1.874357E38 double:1.053130132E-314;
        r2 = "Close";
    ...
    L_0x016f:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.StickersAlert.updateFields():void");
    }
    ...
    public /* synthetic */ void lambda$updateFields$13$StickersAlert(View view) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_installStickerSet, new C4061-$$Lambda$StickersAlert$93kNqcLfjawvVuCFuwipI3J4db8(this));
    }

    public /* synthetic */ void lambda$null$12$StickersAlert(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2685-$$Lambda$StickersAlert$u0aZ0wOaqO_c5AszLHG59q2qf_I(this, tL_error, tLObject));
    }
        ...
        if (tL_error == null) {
            try {
                if (this.stickerSet.set.masks) {
                    Toast.makeText(getContext(), LocaleController.getString("AddMasksInstalled", C1067R.string.AddMasksInstalled), 0).show();
                } else {
                    Toast.makeText(getContext(), LocaleController.getString("AddStickersInstalled", C1067R.string.AddStickersInstalled), 0).show();
                }
            ...
            Toast.makeText(getContext(), LocaleController.getString("ErrorOccurred", C1067R.string.ErrorOccurred), 0).show();
        }
    ...
    private void hidePreview() {
        ...
        animatorSet.addListener(new C29509());
        animatorSet.start();
    }
