...
public class Emoji {
    ...
    private static int bigImgSize = AndroidUtilities.m26dp(AndroidUtilities.isTablet() ? 40.0f : 34.0f);
    private static final int[][] cols;
    private static int drawImgSize = AndroidUtilities.m26dp(20.0f);
        ...
        public void draw(Canvas canvas) {
            ...
            if (access$300[drawableInfo.page][drawableInfo.page2] == null) {
                ...
                if (!access$400[drawableInfo.page][drawableInfo.page2]) {
                    ...
                    Utilities.globalQueue.postRunnable(new C0430-$$Lambda$Emoji$EmojiDrawable$tIn098DVTEVbhZUc7ywBHxfGQOU(this));
    ...
    public static class EmojiSpan extends ImageSpan {
        ...
        private int size = AndroidUtilities.m26dp(20.0f);
        ...
        public EmojiSpan(EmojiDrawable emojiDrawable, int i, int i2, FontMetricsInt fontMetricsInt) {
            ...
            if (fontMetricsInt != null) {
                ...
                if (this.size == 0) {
                    this.size = AndroidUtilities.m26dp(20.0f);
                }
            }
        }
    ...
    private static void loadEmoji(int i, int i2) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m29e("Error loading emoji", th);
                return;
            }
            return;
        }
        ...
        AndroidUtilities.runOnUIThread(new C0429-$$Lambda$Emoji$8PuKHwVD-cYGVxmUFCHOFHCQ5bM(i, i2, bitmap));
    }
    ...
    L_0x005a:
        r20 = -4294967296; // 0xffffffff00000000 float:0.0 double:NaN;
        r20 = r11 & r20;
    ...
    L_0x00ad:
        r9 = 61440; // 0xf000 float:8.6096E-41 double:3.03554E-319;
        r9 = r9 & r5;
    ...
    public static void sortEmoji() {
        ...
        Collections.sort(recentEmoji, C0431-$$Lambda$Emoji$IRtAaHh32-YY7tgie8_WycuV8i0.INSTANCE);
