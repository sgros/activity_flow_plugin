...
public class GroupedPhotosListView extends View implements OnGestureListener {
    ...
    public GroupedPhotosListView(Context context) {
        ...
        this.itemWidth = AndroidUtilities.m26dp(42.0f);
        this.itemHeight = AndroidUtilities.m26dp(56.0f);
        this.itemSpacing = AndroidUtilities.m26dp(1.0f);
        this.itemY = AndroidUtilities.m26dp(3.0f);
    ...
    L_0x027f:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.GroupedPhotosListView.fillList():void");
    }
    ...
    L_0x01f6:
        ...
        goto L_0x0258;
    L_0x020a:
        r1 = org.telegram.p004ui.Components.CubicBezierInterpolator.EASE_OUT;
        r6 = r0.moveLineProgress;
        r6 = r8 - r6;
    ...
    L_0x02bd:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.GroupedPhotosListView.onDraw(android.graphics.Canvas):void");
    }
