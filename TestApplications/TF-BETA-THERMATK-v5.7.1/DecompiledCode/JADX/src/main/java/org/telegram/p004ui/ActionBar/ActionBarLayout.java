...
public class ActionBarLayout extends FrameLayout {
    ...
    private C2190ActionBar currentActionBar;
    ...
    class C21933 extends ViewOutlineProvider {
        C21933() {
        }

        @TargetApi(21)
        public void getOutline(View view, Outline outline) {
            outline.setRoundRect(0, AndroidUtilities.statusBarHeight, view.getMeasuredWidth(), view.getMeasuredHeight(), (float) AndroidUtilities.m26dp(6.0f));
        }
    }

    /* renamed from: org.telegram.ui.ActionBar.ActionBarLayout$4 */
    class C21944 extends AnimatorListenerAdapter {
        C21944() {
        }
    ...
    class C21977 implements Runnable {
        C21977() {
        }
    ...
    class C21988 extends AnimatorListenerAdapter {
        C21988() {
        }
    ...
    class C21999 extends AnimatorListenerAdapter {
        C21999() {
        }
    ...
    public ActionBarLayout(Context context) {
        ...
        if (layerShadowDrawable == null) {
            layerShadowDrawable = getResources().getDrawable(C1067R.C1065drawable.layer_shadow);
            headerShadowDrawable = getResources().getDrawable(C1067R.C1065drawable.header_shadow).mutate();
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.inPreviewMode || this.transitionAnimationPreviewMode) {
            ...
            if (view == view2) {
                ...
                if (view2 != null) {
                    ...
                    int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m26dp(24.0f)) / 2;
                    float top = ((float) view2.getTop()) + this.containerView.getTranslationY();
                    if (VERSION.SDK_INT < 21) {
                        i = 20;
                    }
                    int dp = (int) (top - ((float) AndroidUtilities.m26dp((float) (i + 12))));
                    Theme.moveUpDrawable.setBounds(measuredWidth, dp, AndroidUtilities.m26dp(24.0f) + measuredWidth, AndroidUtilities.m26dp(24.0f) + dp);
        ...
        if (paddingRight != 0) {
            if (view == this.containerView) {
                float max = Math.max(0.0f, Math.min(((float) (width - paddingRight)) / ((float) AndroidUtilities.m26dp(20.0f)), 1.0f));
    ...
    private void onSlideAnimationEnd(boolean z) {
        ...
        if (z) {
            if (this.fragmentsStack.size() >= 2) {
                ...
                C2190ActionBar c2190ActionBar = baseFragment.actionBar;
                if (c2190ActionBar != null && c2190ActionBar.getAddToContainer()) {
    ...
    public void onBackPressed() {
        if (!(this.transitionAnimationPreviewMode || this.startedTracking || checkTransitionAnimation() || this.fragmentsStack.isEmpty())) {
            if (!this.currentActionBar.isActionModeShowed()) {
                C2190ActionBar c2190ActionBar = this.currentActionBar;
    ...
    private void startLayoutAnimation(final boolean z, final boolean z2, final boolean z3) {
                ...
                if (ActionBarLayout.this.animationRunnable == this) {
                    ...
                    if (z) {
                        ...
                        if (z3) {
                            ...
                            ActionBarLayout.this.containerView.setTranslationX(((float) AndroidUtilities.m26dp(48.0f)) * (1.0f - interpolation));
                        }
                    } else {
                        ...
                        if (z3) {
                            ...
                            ActionBarLayout.this.containerViewBack.setTranslationX(((float) AndroidUtilities.m26dp(48.0f)) * interpolation);
                        }
                    }
                    if (ActionBarLayout.this.animationProgress < 1.0f) {
        ...
        this.animationRunnable = c21922;
        AndroidUtilities.runOnUIThread(c21922);
    }
    ...
    public boolean presentFragment(BaseFragment baseFragment, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (!checkTransitionAnimation()) {
            ...
            if ((actionBarLayoutDelegate == null || !z3 || actionBarLayoutDelegate.needPresentFragment(baseFragment2, z5, z6, this)) && baseFragment.onFragmentCreate()) {
                ...
                C2190ActionBar c2190ActionBar = baseFragment2.actionBar;
                if (c2190ActionBar != null && c2190ActionBar.getAddToContainer()) {
                    if (this.removeActionBarExtraHeight) {
                ...
                if (z7) {
                    ...
                    dp = AndroidUtilities.m26dp(46.0f);
                ...
                if (z7) {
                    if (VERSION.SDK_INT >= 21) {
                        view.setOutlineProvider(new C21933());
                        view.setClipToOutline(true);
                        view.setElevation((float) AndroidUtilities.m26dp(4.0f));
                    }
                ...
                if (obj == null && !z7) {
                    ...
                    this.onOpenAnimationEndRunnable = new C2153-$$Lambda$ActionBarLayout$pYh6HgDiwfydlsh9Xn7223Bd-IA(baseFragment2);
                    ...
                    this.currentAnimation.addListener(new C21944());
                    this.currentAnimation.start();
                } else {
                    this.transitionAnimationPreviewMode = z7;
                    this.transitionAnimationStartTime = System.currentTimeMillis();
                    this.transitionAnimationInProgress = true;
                    C2151-$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y c2151-$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y = r0;
                    C2151-$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y c2151-$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y2 = new C2151-$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y(this, z4, z, baseFragment3, baseFragment);
                    this.onOpenAnimationEndRunnable = c2151-$$Lambda$ActionBarLayout$gS41pICx_migujhqTs-lczeRv1Y;
                    baseFragment2.onTransitionAnimationStart(true, false);
                    AnimatorSet onCustomTransitionAnimation = !z7 ? baseFragment2.onCustomTransitionAnimation(true, new C2150-$$Lambda$ActionBarLayout$ZVBs3Yp413UBaNwwGzpjbW7oZTc(this)) : null;
    ...
    public void movePreviewFragment(float f) {
        if (this.inPreviewMode && !this.transitionAnimationPreviewMode) {
            ...
            float f3 = 0.0f;
            if (f2 <= 0.0f) {
                if (f2 < ((float) (-AndroidUtilities.m26dp(60.0f)))) {
        ...
        if ((actionBarLayoutDelegate == null || actionBarLayoutDelegate.needCloseLastFragment(this)) && !checkTransitionAnimation() && !this.fragmentsStack.isEmpty()) {
            ...
            if (baseFragment != null) {
                ...
                if (obj != null) {
                    this.transitionAnimationStartTime = System.currentTimeMillis();
                    this.transitionAnimationInProgress = true;
                    this.onCloseAnimationEndRunnable = new C2152-$$Lambda$ActionBarLayout$pBlWjaMhbocc2CQiKAJuI1kS-Ds(this, baseFragment2, baseFragment);
                    if (!(this.inPreviewMode || this.transitionAnimationPreviewMode)) {
                        animatorSet = baseFragment2.onCustomTransitionAnimation(false, new C2154-$$Lambda$ActionBarLayout$r7PgXBy38d_b4XaDN8FoveXk1BE(this));
                    }
                    if (animatorSet != null) {
                        this.currentAnimation = animatorSet;
                        return;
                    } else if (this.containerView.isKeyboardVisible || this.containerViewBack.isKeyboardVisible) {
                        this.waitingForKeyboardCloseRunnable = new C21977();
                        AndroidUtilities.runOnUIThread(this.waitingForKeyboardCloseRunnable, 200);
                        return;
                    } else {
                ...
                this.transitionAnimationStartTime = System.currentTimeMillis();
                this.transitionAnimationInProgress = true;
                this.onCloseAnimationEndRunnable = new C2149-$$Lambda$ActionBarLayout$S9HTTIgsI9OBg6Q7_NNccIiX628(this, baseFragment2);
                ...
                this.currentAnimation.setInterpolator(this.accelerateDecelerateInterpolator);
                this.currentAnimation.setDuration(200);
                this.currentAnimation.addListener(new C21988());
                this.currentAnimation.start();
            } else {
    ...
    public void showLastFragment() {
        if (!this.fragmentsStack.isEmpty()) {
            ...
            for (int i = 0; i < this.fragmentsStack.size() - 1; i++) {
                ...
                c2190ActionBar = baseFragment.actionBar;
                if (c2190ActionBar != null && c2190ActionBar.getAddToContainer()) {
                    viewGroup = (ViewGroup) baseFragment.actionBar.getParent();
                    if (viewGroup != null) {
                        viewGroup.removeView(baseFragment.actionBar);
            ...
            c2190ActionBar = baseFragment2.actionBar;
            if (c2190ActionBar != null && c2190ActionBar.getAddToContainer()) {
                if (this.removeActionBarExtraHeight) {
                    baseFragment2.actionBar.setOccupyStatusBar(false);
                }
        ...
        for (int i = 0; i < 2; i++) {
            if (this.themeAnimatorDescriptions[i] != null) {
                for (int i2 = 0; i2 < this.themeAnimatorDescriptions[i].length; i2++) {
                    ...
                    red = Color.argb(Math.min(NalUnitUtil.EXTENDED_SAR, (int) (((float) alpha2) + (((float) (alpha - alpha2)) * f))), Math.min(NalUnitUtil.EXTENDED_SAR, (int) (((float) red2) + (((float) (red - red2)) * f))), Math.min(NalUnitUtil.EXTENDED_SAR, (int) (((float) green2) + (((float) (green - green2)) * f))), Math.min(NalUnitUtil.EXTENDED_SAR, (int) (((float) blue2) + (((float) (blue - blue2)) * f))));
    ...
    public void animateThemedValues(ThemeInfo themeInfo, boolean z) {
        ...
        if (obj != null) {
            ...
            this.themeAnimatorSet.addListener(new C21999());
    ...
    public boolean onKeyUp(int i, KeyEvent keyEvent) {
        if (!(i != 82 || checkTransitionAnimation() || this.startedTracking)) {
            ...
            if (c2190ActionBar != null) {
                c2190ActionBar.onMenuButtonPressed();
            }
        }
    ...
    public void onActionModeStarted(Object obj) {
        C2190ActionBar c2190ActionBar = this.currentActionBar;
        if (c2190ActionBar != null) {
            c2190ActionBar.setVisibility(8);
        }
    ...
    public void onActionModeFinished(Object obj) {
        C2190ActionBar c2190ActionBar = this.currentActionBar;
        if (c2190ActionBar != null) {
            c2190ActionBar.setVisibility(0);
        }
    ...
    public void setTitleOverlayText(String str, int i, Runnable runnable) {
        ...
        for (int i2 = 0; i2 < this.fragmentsStack.size(); i2++) {
            C2190ActionBar c2190ActionBar = ((BaseFragment) this.fragmentsStack.get(i2)).actionBar;
            if (c2190ActionBar != null) {
                c2190ActionBar.setTitleOverlayText(this.titleOverlayText, this.titleOverlayTextId, runnable);
            }
        }
    }
