        ...
        if (this.hintText != null && length() < this.hintText.length()) {
            ...
            for (int length = length(); length < this.hintText.length(); length++) {
                ...
                if (this.hintText.charAt(length) == ' ') {
                    ...
                    this.rect.set(((int) f) + AndroidUtilities.m26dp(1.0f), measuredHeight, ((int) (this.numberSize + f)) - AndroidUtilities.m26dp(1.0f), AndroidUtilities.m26dp(2.0f) + measuredHeight);
