...
public class SeekBarWaveform {
    ...
    public void draw(Canvas canvas) {
        if (this.waveformBytes != null) {
            ...
            if (i != 0) {
                float f = 3.0f;
                float dp = (float) (i / AndroidUtilities.m26dp(3.0f));
                if (dp > 0.1f) {
                    int i2 = 5;
                    ...
                    int i4 = 2;
                    int dp2 = (this.height - AndroidUtilities.m26dp(14.0f)) / 2;
                    i = 0;
                    int i5 = 0;
                    float f3 = 0.0f;
                    int i6 = 0;
                    while (i < length) {
                        ...
                        if (i != i5) {
                            ...
                            i11 = 0;
                            while (i11 < i8) {
                                i5 = AndroidUtilities.m26dp(f) * i6;
                                if (i5 >= this.thumbX || AndroidUtilities.m26dp(2.0f) + i5 >= this.thumbX) {
                                    float f5 = (float) i5;
                                    float f6 = (((float) i3) * 14.0f) / 31.0f;
                                    i7 = length;
                                    canvas.drawRect(f5, (float) (dp2 + AndroidUtilities.m26dp(14.0f - Math.max(1.0f, f6))), (float) (i5 + AndroidUtilities.m26dp(2.0f)), (float) (dp2 + AndroidUtilities.m26dp(14.0f)), paintInner);
                                    if (i5 < this.thumbX) {
                                        canvas.drawRect(f5, (float) (AndroidUtilities.m26dp(14.0f - Math.max(1.0f, f6)) + dp2), (float) this.thumbX, (float) (AndroidUtilities.m26dp(14.0f) + dp2), paintOuter);
                                        i6++;
                                        i11++;
                                        length = i7;
                                        f = 3.0f;
                                    ...
                                    canvas.drawRect((float) i5, (float) (AndroidUtilities.m26dp(14.0f - Math.max(1.0f, (((float) i3) * 14.0f) / 31.0f)) + dp2), (float) (i5 + AndroidUtilities.m26dp(2.0f)), (float) (AndroidUtilities.m26dp(14.0f) + dp2), paintOuter);
                                    i7 = length;
                                }
                                i6++;
                                i11++;
