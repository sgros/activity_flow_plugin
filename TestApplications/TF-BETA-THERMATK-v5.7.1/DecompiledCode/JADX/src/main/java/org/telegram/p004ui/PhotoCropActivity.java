...
public class PhotoCropActivity extends BaseFragment {
    ...
    private class PhotoCropView extends FrameLayout {
        ...
        class C31541 implements OnTouchListener {
            C31541() {
            }
            ...
            L_0x001a:
                r13 = org.telegram.p004ui.PhotoCropActivity.PhotoCropView.this;
                r2 = r13.rectX;
                r1 = (float) r1;
                r9 = r2 - r1;
            ...
            L_0x00e3:
                r12 = org.telegram.p004ui.PhotoCropActivity.PhotoCropView.this;
            ...
            L_0x0341:
                return r8;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.PhotoCropActivity$PhotoCropView$C31541.onTouch(android.view.View, android.view.MotionEvent):boolean");
            }
        }
        ...
        private void init() {
            ...
            this.rectPaint.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
        ...
        private void updateBitmapSize() {
            if (this.viewWidth != 0 && this.viewHeight != 0 && PhotoCropActivity.this.imageToCrop != null) {
                ...
                this.bitmapX = ((this.viewWidth - this.bitmapWidth) / 2) + AndroidUtilities.m26dp(14.0f);
                this.bitmapY = ((this.viewHeight - this.bitmapHeight) / 2) + AndroidUtilities.m26dp(14.0f);
                int i5;
                if (this.rectX != -1.0f || this.rectY != -1.0f) {
                    ...
                    if (i5 > i) {
                        this.rectY = (float) this.bitmapY;
                        this.rectX = (float) (((this.viewWidth - i) / 2) + AndroidUtilities.m26dp(14.0f));
                        i5 = this.bitmapHeight;
                        this.rectSizeX = (float) i5;
                        this.rectSizeY = (float) i5;
                    } else {
                        this.rectX = (float) this.bitmapX;
                        this.rectY = (float) (((this.viewHeight - i5) / 2) + AndroidUtilities.m26dp(14.0f));
                        i5 = this.bitmapWidth;
                        this.rectSizeX = (float) i5;
                        this.rectSizeY = (float) i5;
                    }
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.viewWidth = (i3 - i) - AndroidUtilities.m26dp(28.0f);
            this.viewHeight = (i4 - i2) - AndroidUtilities.m26dp(28.0f);
            updateBitmapSize();
        }
        ...
        public void onDraw(android.graphics.Canvas r16) {
            ...
            r15 = this;
            r1 = r15;
            r0 = org.telegram.p004ui.PhotoCropActivity.this;
            r0 = r0.drawable;
            if (r0 == 0) goto L_0x0035;
        L_0x0009:
            r0 = org.telegram.p004ui.PhotoCropActivity.this;	 Catch:{ Throwable -> 0x002e }
        ...
        L_0x0037:
            ...
            r5 = org.telegram.messenger.AndroidUtilities.m26dp(r10);
            r5 = (float) r5;
            r5 = r5 + r2;
            r2 = r1.rectY;
            r11 = 3;
            ...
            r2 = r2 + r3;
            r2 = r2 - r9;
            r3 = org.telegram.messenger.AndroidUtilities.m26dp(r10);
            r3 = (float) r3;
            r3 = r2 - r3;
            r2 = r1.rectY;
            r4 = r2 + r9;
            ...
            r2 = r2 + r4;
            r2 = r2 - r9;
            r4 = org.telegram.messenger.AndroidUtilities.m26dp(r10);
            r4 = (float) r4;
            r4 = r2 - r4;
            r2 = r1.rectX;
            r5 = r2 + r0;
        ...
        L_0x0204:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.PhotoCropActivity$PhotoCropView.onDraw(android.graphics.Canvas):void");
        }
    }
    ...
    class C42741 extends ActionBarMenuOnItemClick {
        C42741() {
        }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.imageToCrop == null) {
            ...
            if (AndroidUtilities.isTablet()) {
                dp = AndroidUtilities.m26dp(520.0f);
            } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("CropImage", C1067R.string.CropImage));
        this.actionBar.setActionBarMenuOnItemClick(new C42741());
