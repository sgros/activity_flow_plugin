...
public class DownloadController implements NotificationCenterDelegate {
    ...
    class C10221 extends BroadcastReceiver {
        C10221() {
        }
    ...
    public DownloadController(int i) {
        ...
        AndroidUtilities.runOnUIThread(new C0428-$$Lambda$DownloadController$TvQOK4BckOSg64NROgC4NLSY7xY(this));
        ApplicationLoader.applicationContext.registerReceiver(new C10221(), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
    ...
    public void loadAutoDownloadConfig(boolean z) {
        if (!this.loadingAutoDownloadConfig) {
            if (z || Math.abs(System.currentTimeMillis() - UserConfig.getInstance(this.currentAccount).autoDownloadConfigLoadTime) >= 86400000) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getAutoDownloadSettings(), new C3395-$$Lambda$DownloadController$Vy_RFVunDaT6j2u2tHT0TGLKrLk(this));
            }
        }
    }

    public /* synthetic */ void lambda$loadAutoDownloadConfig$2$DownloadController(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0427-$$Lambda$DownloadController$Sppih-WlM90EoDE67qxYSN9jq_E(this, tLObject));
    }
    ...
    public void savePresetToServer(int i) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_saveAutoDownloadSettings, C3394-$$Lambda$DownloadController$0LtKveHOl8NLZKx-EDiX80oSJa0.INSTANCE);
    }
    ...
    private void checkDownloadFinished(String str, int i) {
        ...
        if (downloadObject != null) {
            ...
            if (i == 0 || i == 2) {
                MessagesStorage.getInstance(this.currentAccount).removeFromDownloadQueue(downloadObject.f49id, downloadObject.type, false);
            }
