...
public class CameraView extends FrameLayout implements SurfaceTextureListener {
    ...
    public CameraView(Context context, boolean z) {
        ...
        this.focusAreaSize = AndroidUtilities.m26dp(96.0f);
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (!(this.focusProgress == 1.0f && this.innerAlpha == 0.0f && this.outerAlpha == 0.0f)) {
            int dp = AndroidUtilities.m26dp(30.0f);
            ...
            float f = (float) dp;
            canvas.drawCircle((float) this.f424cx, (float) this.f425cy, ((1.0f - interpolation) * f) + f, this.outerPaint);
            canvas.drawCircle((float) this.f424cx, (float) this.f425cy, f * interpolation, this.innerPaint);
