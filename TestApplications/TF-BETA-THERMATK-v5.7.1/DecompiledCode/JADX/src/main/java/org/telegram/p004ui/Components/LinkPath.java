    ...
    public void addRect(float f, float f2, float f3, float f4, Direction direction) {
        ...
        if (f > lineLeft || f3 > lineLeft) {
            ...
            if (this.useRoundRect) {
                ...
                this.rect.set(f7 - ((float) AndroidUtilities.m26dp(4.0f)), f8, f6 + ((float) AndroidUtilities.m26dp(4.0f)), f9);
                super.addRoundRect(this.rect, (float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(4.0f), direction);
                return;
            }
