...
public class Input {
    ...
    L_0x00bb:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.Paint.Input.process(android.view.MotionEvent):void");
    }
    ...
    private Point smoothPoint(Point point, Point point2, Point point3, float f) {
        ...
        double d3 = point4.f591x * pow;
        double d4 = point6.f591x;
        Double.isNaN(d);
        d3 += d4 * d;
        d4 = point5.f591x;
        Double.isNaN(d2);
        double d5 = d3 + (d4 * d2);
        double d6 = point4.f592y * pow;
        pow = point6.f592y;
        Double.isNaN(d);
        d6 += pow * d;
        double d7 = point5.f592y;
        Double.isNaN(d2);
    ...
    private void paintPath(final Path path) {
        ...
        this.renderView.getPainting().paintStroke(path, this.clearBuffer, new Runnable() {
            ...
            class C28721 implements Runnable {
                C28721() {
                }

                public void run() {
                    C28731 c28731 = C28731.this;
            ...
            public void run() {
                AndroidUtilities.runOnUIThread(new C28721());
            }
        });
    }
}
