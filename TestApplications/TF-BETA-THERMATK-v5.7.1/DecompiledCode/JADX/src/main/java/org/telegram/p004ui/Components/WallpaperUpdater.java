...
public class WallpaperUpdater {
    ...
    class C29811 implements PhotoAlbumPickerActivityDelegate {
        C29811() {
        }
    ...
    public void showAlert(boolean z) {
        ...
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString(str2, C1067R.string.ChooseTakePhoto), LocaleController.getString(str, C1067R.string.SelectFromGallery), LocaleController.getString("SelectColor", C1067R.string.SelectColor), LocaleController.getString("Default", C1067R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString(str2, C1067R.string.ChooseTakePhoto), LocaleController.getString(str, C1067R.string.SelectFromGallery)};
            iArr = new int[]{C1067R.C1065drawable.menu_camera, C1067R.C1065drawable.profile_photos};
        }
        builder.setItems(charSequenceArr, iArr, new C2713-$$Lambda$WallpaperUpdater$vK87huFk9jAjs7SXqPz2knBtx88(this, z));
        builder.show();
    }
    ...
    public void openGallery() {
        ...
        if (baseFragment != null) {
            ...
            photoAlbumPickerActivity.setDelegate(new C29811());
    ...
    L_0x005f:
        ...
        r9 = r5;
    L_0x0061:
        org.telegram.messenger.FileLog.m30e(r8);	 Catch:{ all -> 0x0071 }
    ...
    L_0x00d6:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.WallpaperUpdater.onActivityResult(int, int, android.content.Intent):void");
    }
}
