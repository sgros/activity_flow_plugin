        ...
        if (viewHolder.getItemViewType() == 0) {
            ...
            if (item instanceof Contact) {
                ...
                if (user == null) {
                    ...
                    userCell.setData(null, ContactsController.formatName(contact.first_name, contact.last_name), contact.phones.isEmpty() ? "" : C0278PhoneFormat.getInstance().format((String) contact.phones.get(0)), 0);
                    user = null;
                }
            } else {
                user = (User) item;
