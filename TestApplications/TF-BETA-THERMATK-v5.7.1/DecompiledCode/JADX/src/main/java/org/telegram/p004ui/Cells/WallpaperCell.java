...
public class WallpaperCell extends FrameLayout {
    ...
    private class WallpaperView extends FrameLayout {
        ...
        public WallpaperView(Context context) {
            ...
            this.imageView = new BackupImageView(context, WallpaperCell.this) {
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas.drawCircle((float) measuredWidth, (float) measuredHeight, (float) AndroidUtilities.m26dp(20.0f), WallpaperCell.this.circlePaint);
            ...
            this.imageView2.setImageResource(C1067R.C1065drawable.ic_gallery_background);
            ...
            this.checkBox = new CheckBox(context, C1067R.C1065drawable.round_check2);
        ...
        public void setWallpaper(Object obj, long j, Drawable drawable, boolean z) {
            ...
            if (obj2 == null) {
                ...
                int i = (j == -1 || j == Theme.DEFAULT_BACKGROUND_ID) ? 1514625126 : 1509949440;
    ...
    public WallpaperCell(Context context) {
        ...
        while (true) {
            ...
            if (i < wallpaperViewArr.length) {
                ...
                wallpaperView.setOnClickListener(new C2339-$$Lambda$WallpaperCell$fnKXvqmCCrXx3zL9kUDMI1LGdcU(this, wallpaperView, i));
                wallpaperView.setOnLongClickListener(new C2338-$$Lambda$WallpaperCell$KQeRkjIAB8SBAWriFhep5_TPLbU(this, wallpaperView, i));
                i++;
            } else {
                this.framePaint = new Paint();
                this.framePaint.setColor(855638016);
                this.circlePaint = new Paint(1);
                this.checkDrawable = context.getResources().getDrawable(C1067R.C1065drawable.background_selected).mutate();
    ...
    public void onMeasure(int i, int i2) {
        ...
        i2 = i - AndroidUtilities.m26dp((float) (((this.spanCount - 1) * 6) + 28));
        int i3 = i2 / this.spanCount;
        int dp = this.currentType == 0 ? AndroidUtilities.m26dp(180.0f) : i3;
        float f = 14.0f;
        int i4 = 0;
        int dp2 = (this.isTop ? AndroidUtilities.m26dp(14.0f) : 0) + dp;
        if (!this.isBottom) {
            f = 6.0f;
        }
        setMeasuredDimension(i, dp2 + AndroidUtilities.m26dp(f));
        while (true) {
            i = this.spanCount;
            if (i4 < i) {
                this.wallpaperViews[i4].measure(MeasureSpec.makeMeasureSpec(i4 == i + -1 ? i2 : i3, 1073741824), MeasureSpec.makeMeasureSpec(dp, 1073741824));
                i2 -= i3;
                i4++;
            } else {
                return;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        i3 = 0;
        int dp = this.isTop ? AndroidUtilities.m26dp(14.0f) : 0;
        while (i3 < this.spanCount) {
            ...
            i += i2 + AndroidUtilities.m26dp(6.0f);
            i3++;
        }
    }
