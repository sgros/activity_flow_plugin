...
public class TextCheckCell2 extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(this.valueTextView.getVisibility() == 0 ? 64.0f : 50.0f) + this.needDivider, 1073741824));
        }
    }
