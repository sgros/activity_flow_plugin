...
public abstract class BaseLocationAdapter extends SelectionAdapter {
    ...
    public void searchDelayed(final String str, final Location location) {
        ...
        this.searchTimer.schedule(new TimerTask() {
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C2230-$$Lambda$BaseLocationAdapter$1$kUOM7MJ1viSwJRv7kesEXXY9pCs(this, str, location));
            }
    ...
    private void searchBotUser() {
        if (!this.searchingUser) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_resolveUsername, new C3904-$$Lambda$BaseLocationAdapter$OUu2tRVUfz8Mg0cIvwT-Hlk9dBk(this));
        }
    }

    public /* synthetic */ void lambda$searchBotUser$1$BaseLocationAdapter(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C2231-$$Lambda$BaseLocationAdapter$3QgE-sikMAhKXc3W4CzFrcyGhVs(this, tLObject));
        }
    }
        ...
        if (location != null) {
            ...
            if (location2 == null || location.distanceTo(location2) >= 200.0f) {
                ...
                if (userOrChat instanceof User) {
                    ...
                    this.currentRequestNum = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getInlineBotResults, new C3905-$$Lambda$BaseLocationAdapter$qLcpONoyStiIgQpEIiVXznU9o5o(this));
                    notifyDataSetChanged();
                } else {
                    if (z) {
                        searchBotUser();
    ...
    public /* synthetic */ void lambda$searchPlacesWithQuery$3$BaseLocationAdapter(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C2232-$$Lambda$BaseLocationAdapter$cZ-97u5GiOnofWCJZtoLbhQZqEs(this, tL_error, tLObject));
    }
