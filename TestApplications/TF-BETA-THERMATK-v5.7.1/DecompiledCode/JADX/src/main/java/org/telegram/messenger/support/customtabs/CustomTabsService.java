...
public abstract class CustomTabsService extends Service {
    ...
    private Stub mBinder = new C11051();
    ...
    class C11051 extends Stub {
        ...
        public boolean newSession(ICustomTabsCallback iCustomTabsCallback) {
            ...
            try {
                C11041 c11041 = new DeathRecipient() {
                    public void binderDied() {
                        CustomTabsService.this.cleanUpSession(customTabsSessionToken);
                    }
                };
                synchronized (CustomTabsService.this.mDeathRecipientMap) {
                    iCustomTabsCallback.asBinder().linkToDeath(c11041, 0);
                    CustomTabsService.this.mDeathRecipientMap.put(iCustomTabsCallback.asBinder(), c11041);
                }
