...
public class ActionBarMenu extends LinearLayout {
    ...
    protected C2190ActionBar parentActionBar;

    public ActionBarMenu(Context context, C2190ActionBar c2190ActionBar) {
        super(context);
        setOrientation(0);
        this.parentActionBar = c2190ActionBar;
    }
    ...
    public ActionBarMenuItem addItem(int i, Drawable drawable) {
        return addItem(i, 0, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, drawable, AndroidUtilities.m26dp(48.0f), null);
    }
    ...
    public ActionBarMenuItem addItem(int i, int i2, int i3) {
        return addItem(i, i2, i3, null, AndroidUtilities.m26dp(48.0f), null);
    }
    ...
    public ActionBarMenuItem addItem(int i, int i2, int i3, Drawable drawable, int i4, CharSequence charSequence) {
        ...
        actionBarMenuItem.setOnClickListener(new C2155-$$Lambda$ActionBarMenu$ppo9UED664gE-YCecAHKNZM7u90(this));
