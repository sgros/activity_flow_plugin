...
public class UserConfig {
    ...
    public int getClientUserId() {
        int i;
        synchronized (this.sync) {
            i = this.currentUser != null ? this.currentUser.f534id : 0;
        }
        return i;
    }
    ...
    L_0x001a:
        ...
        r5 = r5 / r7;
        r6 = (int) r5;	 Catch:{ all -> 0x0214 }
        r5 = 90000; // 0x15f90 float:1.26117E-40 double:4.4466E-319;
        r6 = r6 - r5;
        r2 = r1.getInt(r2, r6);	 Catch:{ all -> 0x0214 }
    ...
    L_0x0109:
        r8 = move-exception;
        org.telegram.messenger.FileLog.m30e(r8);	 Catch:{ all -> 0x0214 }
    L_0x010d:
    ...
    L_0x0172:
        r8 = move-exception;
        org.telegram.messenger.FileLog.m30e(r8);	 Catch:{ Exception -> 0x018e }
        r8 = r6;
    L_0x0177:
