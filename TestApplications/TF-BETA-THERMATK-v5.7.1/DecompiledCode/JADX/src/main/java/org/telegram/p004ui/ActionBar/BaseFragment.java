...
public class BaseFragment {
    protected C2190ActionBar actionBar;
    ...
    public C2190ActionBar getActionBar() {
    ...
    public void setInPreviewMode(boolean z) {
        ...
        if (c2190ActionBar != null) {
            ...
            if (this.inPreviewMode) {
                c2190ActionBar.setOccupyStatusBar(false);
                return;
            }
            if (VERSION.SDK_INT >= 21) {
                z2 = true;
            }
            c2190ActionBar.setOccupyStatusBar(z2);
        }
    }
    ...
    public void clearViews() {
        ...
        C2190ActionBar c2190ActionBar = this.actionBar;
        if (c2190ActionBar != null) {
            viewGroup = (ViewGroup) c2190ActionBar.getParent();
            if (viewGroup != null) {
                try {
    ...
    public C2190ActionBar createActionBar(Context context) {
        C2190ActionBar c2190ActionBar = new C2190ActionBar(context);
        c2190ActionBar.setBackgroundColor(Theme.getColor(Theme.key_actionBarDefault));
        c2190ActionBar.setItemsBackgroundColor(Theme.getColor(Theme.key_actionBarDefaultSelector), false);
        c2190ActionBar.setItemsBackgroundColor(Theme.getColor(Theme.key_actionBarActionModeDefaultSelector), true);
        c2190ActionBar.setItemsColor(Theme.getColor(Theme.key_actionBarDefaultIcon), false);
        c2190ActionBar.setItemsColor(Theme.getColor(Theme.key_actionBarActionModeDefaultIcon), true);
        if (this.inPreviewMode) {
            c2190ActionBar.setOccupyStatusBar(false);
        }
        return c2190ActionBar;
    }
    ...
    public void onFragmentDestroy() {
        ...
        C2190ActionBar c2190ActionBar = this.actionBar;
        if (c2190ActionBar != null) {
            c2190ActionBar.setEnabled(false);
        }
    }
    ...
    public void onBecomeFullyVisible() {
        if (((AccessibilityManager) ApplicationLoader.applicationContext.getSystemService("accessibility")).isEnabled()) {
            C2190ActionBar actionBar = getActionBar();
            if (actionBar != null) {
        ...
        if (dialog != null) {
            ...
            if (!(actionBarLayout == null || actionBarLayout.animationInProgress || actionBarLayout.startedTracking || (!z && actionBarLayout.checkTransitionAnimation()))) {
                ...
                try {
                    ...
                    this.visibleDialog.setOnDismissListener(new C2174-$$Lambda$BaseFragment$vXTvtAK8XZpLjv4Env96FSJndOM(this, onDismissListener));
