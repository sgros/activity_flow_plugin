...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTabStrip(Context context) {
        ...
        this.defaultTabLayoutParams = new LayoutParams(AndroidUtilities.m26dp(52.0f), -1);
    ...
    public TextView addIconTabWithCounter(Drawable drawable) {
        ...
        frameLayout.setOnClickListener(new C2659-$$Lambda$ScrollSlidingTabStrip$mNTU5l0eITNwV9vJo7-FdGx3xIs(this, i));
        ...
        textView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m26dp(9.0f), Theme.getColor(Theme.key_chat_emojiPanelBadgeBackground)));
        textView.setMinWidth(AndroidUtilities.m26dp(18.0f));
        textView.setPadding(AndroidUtilities.m26dp(5.0f), 0, AndroidUtilities.m26dp(5.0f), AndroidUtilities.m26dp(1.0f));
    ...
    public ImageView addIconTab(Drawable drawable) {
        ...
        imageView.setImageDrawable(drawable);
        imageView.setScaleType(ScaleType.CENTER);
        imageView.setOnClickListener(new C2658-$$Lambda$ScrollSlidingTabStrip$_7-oyaI-rm6dAg9Sbg63YJVLh4k(this, i));
    ...
    public void addStickerTab(Chat chat) {
        ...
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setFocusable(true);
        frameLayout.setOnClickListener(new C2656-$$Lambda$ScrollSlidingTabStrip$CxqiesXBMvO9L7nEGHWQr5LTQDY(this, i));
        this.tabsContainer.addView(frameLayout);
        frameLayout.setSelected(i == this.currentPosition);
        BackupImageView backupImageView = new BackupImageView(getContext());
        backupImageView.setRoundRadius(AndroidUtilities.m26dp(15.0f));
        Drawable avatarDrawable = new AvatarDrawable();
        avatarDrawable.setTextSize(AndroidUtilities.m26dp(14.0f));
    ...
    public View addStickerTab(TLObject tLObject, Document document, Object obj) {
        ...
        frameLayout.setTag(C1067R.C1066id.parent_tag, obj);
        frameLayout.setTag(C1067R.C1066id.object_tag, document);
        frameLayout.setFocusable(true);
        frameLayout.setOnClickListener(new C2657-$$Lambda$ScrollSlidingTabStrip$VOvZofAy7NE0HRe6ap1qMeWlOr0(this, i));
        this.tabsContainer.addView(frameLayout);
        frameLayout.setSelected(i == this.currentPosition);
        BackupImageView backupImageView = new BackupImageView(getContext());
        backupImageView.setAspectFit(true);
    ...
    public void setImages() {
        int dp = AndroidUtilities.m26dp(52.0f);
        ...
        while (scrollX < dp) {
            ...
            Object tag2 = childAt.getTag(C1067R.C1066id.parent_tag);
            Document document = (Document) childAt.getTag(C1067R.C1066id.object_tag);
    ...
    public void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        i2 = AndroidUtilities.m26dp(52.0f);
        i3 /= i2;
        i /= i2;
