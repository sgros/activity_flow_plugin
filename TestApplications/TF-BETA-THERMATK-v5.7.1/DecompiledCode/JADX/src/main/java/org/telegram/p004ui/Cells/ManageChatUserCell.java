...
public class ManageChatUserCell extends FrameLayout {
    ...
    public ManageChatUserCell(Context context, int i, int i2, boolean z) {
        ...
        this.avatarImageView.setRoundRadius(AndroidUtilities.m26dp(23.0f));
        int i3 = 5;
        ...
        if (z) {
            ...
            this.optionsButton.setImageResource(C1067R.C1065drawable.ic_ab_other);
            ...
            this.optionsButton.setOnClickListener(new C2334-$$Lambda$ManageChatUserCell$oJTkyKgCBYt9FR4kYNNgwqbXXuY(this));
            this.optionsButton.setContentDescription(LocaleController.getString("AccDescrUserOptions", C1067R.string.AccDescrUserOptions));
        }
    }
    ...
    L_0x00c9:
        r13 = r12.statusTextView;
        r4 = 2131558858; // 0x7f0d01ca float:1.8743044E38 double:1.053130004E-314;
    ...
    L_0x00d8:
        r13 = r12.statusTextView;
        r4 = 2131558859; // 0x7f0d01cb float:1.8743046E38 double:1.0531300043E-314;
        r5 = "BotStatusRead";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r13.setText(r4);
        goto L_0x0144;
    ...
    L_0x0220:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ManageChatUserCell.update(int):void");
    }
