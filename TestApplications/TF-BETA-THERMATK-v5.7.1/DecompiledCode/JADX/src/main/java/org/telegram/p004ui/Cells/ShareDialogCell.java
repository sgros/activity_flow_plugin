...
public class ShareDialogCell extends FrameLayout {
    ...
    public ShareDialogCell(Context context) {
        ...
        this.imageView.setRoundRadius(AndroidUtilities.m26dp(28.0f));
        ...
        this.checkBox.setColor(Theme.key_dialogRoundCheckBox, Theme.key_dialogBackground, Theme.key_dialogRoundCheckBoxCheck);
        this.checkBox.setDrawUnchecked(false);
        this.checkBox.setDrawBackgroundAsArc(4);
        this.checkBox.setProgressDelegate(new C3940-$$Lambda$ShareDialogCell$Ua6Rykc_bDn7xM5VKieCIkl7edo(this));
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(103.0f), 1073741824));
    }
    ...
    public void setDialog(int i, boolean z, CharSequence charSequence) {
        ...
        if (i > 0) {
            ...
            if (UserObject.isUserSelf(this.user)) {
                this.nameTextView.setText(LocaleController.getString("SavedMessages", C1067R.string.SavedMessages));
    ...
    L_0x0061:
        ...
        r4 = r4 * r5;
        r5 = org.telegram.p004ui.ActionBar.Theme.dialogs_onlineCirclePaint;
    ...
    L_0x00f0:
        return r9;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ShareDialogCell.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle((float) left, (float) top, (float) AndroidUtilities.m26dp(28.0f), Theme.checkboxSquare_checkPaint);
    }
}
