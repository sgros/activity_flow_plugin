...
public class CheckBoxBase {
    ...
    class C27841 extends AnimatorListenerAdapter {
        C27841() {
        }
    ...
    public CheckBoxBase(View view) {
        String str = Theme.key_chat_serviceBackground;
        ...
        checkPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.9f));
        backgroundPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.2f));
        this.drawBitmap = Bitmap.createBitmap(AndroidUtilities.m26dp(this.size), AndroidUtilities.m26dp(this.size), Config.ARGB_4444);
    ...
    public void setDrawBackgroundAsArc(int i) {
        ...
        if (i == 4 || i == 5) {
            backgroundPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.9f));
            if (i == 5) {
                checkPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.5f));
            }
        } else if (i == 3) {
            backgroundPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.2f));
        } else if (i != 0) {
            backgroundPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.5f));
        }
    }
    ...
    private void animateToCheckedState(boolean z) {
        ...
        this.checkAnimator.addListener(new C27841());
    ...
    L_0x004d:
        r2 = paint;
        r3 = org.telegram.p004ui.ActionBar.Theme.getServiceMessageColor();
        r3 = r3 & r4;
        r4 = 671088640; // 0x28000000 float:7.1054274E-15 double:3.315618423E-315;
        r3 = r3 | r4;
        r2.setColor(r3);
        r2 = backgroundPaint;
        r3 = r0.checkColorKey;
    ...
    L_0x00f4:
        r1 = -90;
        r2 = -1014562816; // 0xffffffffc3870000 float:-270.0 double:NaN;
        r3 = r0.progress;
        goto L_0x0101;
    L_0x00fb:
        r1 = 90;
    ...
    L_0x015a:
        ...
        r3.setColor(r4);
    L_0x0165:
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r11);
        r3 = (float) r3;
        r9 = r9 - r3;
        r3 = r0.bitmapCanvas;
        r4 = r0.drawBitmap;
    ...
    L_0x01c9:
        r10 = 1061997773; // 0x3f4ccccd float:0.8 double:5.246966156E-315;
    L_0x01cc:
    ...
    L_0x021e:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.CheckBoxBase.draw(android.graphics.Canvas):void");
    }
}
