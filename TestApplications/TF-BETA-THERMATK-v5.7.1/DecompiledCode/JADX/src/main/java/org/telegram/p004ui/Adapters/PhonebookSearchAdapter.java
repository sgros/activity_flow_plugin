...
public class PhonebookSearchAdapter extends SelectionAdapter {
    ...
    private void processSearch(String str) {
        AndroidUtilities.runOnUIThread(new C2260-$$Lambda$PhonebookSearchAdapter$KOELxq6F75LZaR2Hw7LDqS_qxfw(this, str));
    }

    public /* synthetic */ void lambda$processSearch$1$PhonebookSearchAdapter(String str) {
        int i = UserConfig.selectedAccount;
        Utilities.searchQueue.postRunnable(new C2261-$$Lambda$PhonebookSearchAdapter$tWtQ3i-wKL8GTUJsG8Cqe7b7WRE(this, str, new ArrayList(ContactsController.getInstance(i).contactsBook.values()), new ArrayList(ContactsController.getInstance(i).contacts), i));
    }
    ...
    L_0x0279:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Adapters.PhonebookSearchAdapter.lambda$null$0$PhonebookSearchAdapter(java.lang.String, java.util.ArrayList, java.util.ArrayList, int):void");
    }

    private void updateSearchResults(String str, ArrayList<Object> arrayList, ArrayList<CharSequence> arrayList2) {
        AndroidUtilities.runOnUIThread(new C2259-$$Lambda$PhonebookSearchAdapter$5E7mSLYtYVP-MgRNf26lnHW5RXo(this, str, arrayList, arrayList2));
    }
        ...
        if (viewHolder.getItemViewType() == 0) {
            ...
            if (item instanceof Contact) {
                ...
                if (user == null) {
                    ...
                    userCell.setData(null, (CharSequence) this.searchResultNames.get(i), contact.phones.isEmpty() ? "" : C0278PhoneFormat.getInstance().format((String) contact.phones.get(0)), 0);
                    user = null;
                }
            } else {
                user = (User) item;
