...
public class FileLog {
    ...
    /* renamed from: e */
    public static void m29e(String str, Throwable th) {
        if (BuildVars.LOGS_ENABLED) {
            ensureInitied();
            Log.e(tag, str, th);
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new C0456-$$Lambda$FileLog$U3_7mjWjDO5tBtPnAliQ7P97K6k(str, th));
            }
        }
    }
    ...
    public static void m28e(String str) {
        if (BuildVars.LOGS_ENABLED) {
            ...
            Log.e(tag, str);
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new C0458-$$Lambda$FileLog$i7yDAXBrl68gcx0blG9TP5Nmrmw(str));
            }
        }
    }
    ...
    public static void m30e(Throwable th) {
        if (BuildVars.LOGS_ENABLED) {
            ...
            th.printStackTrace();
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new C0459-$$Lambda$FileLog$nIyr75ATOMaf7ha7_MTqnmuRzrQ(th));
            } else {
                th.printStackTrace();
            }
        }
    ...
    public static void m27d(String str) {
        if (BuildVars.LOGS_ENABLED) {
            ...
            Log.d(tag, str);
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new C0457-$$Lambda$FileLog$eWlFO8runhKiadqnBdmm0EveMAs(str));
            }
        }
    }
    ...
    /* renamed from: w */
    public static void m31w(String str) {
        if (BuildVars.LOGS_ENABLED) {
            ensureInitied();
            Log.w(tag, str);
            if (getInstance().streamWriter != null) {
                getInstance().logQueue.postRunnable(new C0455-$$Lambda$FileLog$CtxtnEkTmpoT5uv6cLRigOvvNc8(str));
            }
        }
    }
