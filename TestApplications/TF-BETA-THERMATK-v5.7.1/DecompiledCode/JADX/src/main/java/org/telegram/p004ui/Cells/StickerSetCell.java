...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, int i) {
        ...
        if (i2 == 2) {
            ...
            this.progressView.setSize(AndroidUtilities.m26dp(30.0f));
            ...
            if (i2 == 1) {
                ...
                this.optionsButton.setImageResource(C1067R.C1065drawable.msg_actions);
                ...
                this.optionsButton.setImageResource(C1067R.C1065drawable.sticker_added);
                imageView = this.optionsButton;
                if (LocaleController.isRTL) {
                    i3 = 3;
                }
    ...
    public void setText(String str, String str2, int i, boolean z) {
        ...
        if (TextUtils.isEmpty(str2)) {
            this.textView.setTranslationY((float) AndroidUtilities.m26dp(10.0f));
        } else {
