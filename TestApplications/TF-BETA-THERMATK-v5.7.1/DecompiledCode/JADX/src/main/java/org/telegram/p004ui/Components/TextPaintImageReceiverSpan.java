...
public class TextPaintImageReceiverSpan extends ReplacementSpan {
    ...
    public TextPaintImageReceiverSpan(View view, Document document, Object obj, int i, int i2, boolean z, boolean z2) {
        ...
        if (z2) {
            this.imageReceiver.setDelegate(C4068-$$Lambda$TextPaintImageReceiverSpan$Cb0mzcqNIfBx1iovVDp8PZkH5ug.INSTANCE);
        }
        String str = format;
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, FontMetricsInt fontMetricsInt) {
        if (fontMetricsInt != null) {
            int dp;
            if (this.alignTop) {
                dp = (fontMetricsInt.descent - fontMetricsInt.ascent) - AndroidUtilities.m26dp(4.0f);
                ...
                dp = ((-this.height) / 2) - AndroidUtilities.m26dp(4.0f);
                fontMetricsInt.ascent = dp;
                fontMetricsInt.top = dp;
                dp = this.height;
                dp = (dp - (dp / 2)) - AndroidUtilities.m26dp(4.0f);
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (this.alignTop) {
            ...
            i5 = (i5 - AndroidUtilities.m26dp(4.0f)) - i3;
