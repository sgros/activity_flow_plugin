...
public class PipRoundVideoView implements NotificationCenterDelegate {
    ...
    class C29233 extends ViewOutlineProvider {
        C29233() {
        }

        @TargetApi(21)
        public void getOutline(View view, Outline outline) {
            outline.setOval(0, 0, AndroidUtilities.m26dp(120.0f), AndroidUtilities.m26dp(120.0f));
        }
    }

    /* renamed from: org.telegram.ui.Components.PipRoundVideoView$5 */
    class C29245 extends AnimatorListenerAdapter {
        C29245() {
        }
    ...
    class C29267 extends AnimatorListenerAdapter {
        C29267() {
        }
    ...
    public void show(Activity activity, Runnable runnable) {
        if (activity != null) {
            ...
            this.windowView = new FrameLayout(activity) {
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (drawable != null) {
                        ...
                        Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m26dp(1.0f), AndroidUtilities.m26dp(2.0f), AndroidUtilities.m26dp(125.0f), AndroidUtilities.m26dp(125.0f));
                        ...
                        canvas.drawCircle((float) AndroidUtilities.m26dp(63.0f), (float) AndroidUtilities.m26dp(63.0f), (float) AndroidUtilities.m26dp(59.5f), Theme.chat_docBackPaint);
                    }
                }
            };
            this.windowView.setWillNotDraw(false);
            this.videoWidth = AndroidUtilities.m26dp(126.0f);
            this.videoHeight = AndroidUtilities.m26dp(126.0f);
            if (VERSION.SDK_INT >= 21) {
                ...
                this.aspectRatioFrameLayout.setOutlineProvider(new C29233());
            ...
            try {
                ...
                this.windowLayoutParams.x = PipRoundVideoView.getSideCoord(true, i, f, this.videoWidth);
                this.windowLayoutParams.y = PipRoundVideoView.getSideCoord(false, i2, f2, this.videoHeight);
    ...
    public void showTemporary(boolean z) {
        ...
        this.hideShowAnimation.addListener(new C29245());
    ...
    private void animateToBoundsMaybe() {
        ...
        r3 = 0;
        r4 = 1;
        r1 = org.telegram.p004ui.Components.PipRoundVideoView.getSideCoord(r4, r3, r2, r1);
        r5 = r0.videoWidth;
        r5 = org.telegram.p004ui.Components.PipRoundVideoView.getSideCoord(r4, r4, r2, r5);
        r6 = r0.videoHeight;
        r6 = org.telegram.p004ui.Components.PipRoundVideoView.getSideCoord(r3, r3, r2, r6);
        r7 = r0.videoHeight;
        r7 = org.telegram.p004ui.Components.PipRoundVideoView.getSideCoord(r3, r4, r2, r7);
        r8 = r0.preferences;
        r8 = r8.edit();
    ...
    L_0x01b7:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
