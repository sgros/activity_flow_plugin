...
public class SendMessagesHelper implements NotificationCenterDelegate {
    ...
    private LocationProvider locationProvider = new LocationProvider(new C35521());
    ...
    public static class LocationProvider {
        ...
        private class GpsLocationListener implements LocationListener {
            ...
            /* synthetic */ GpsLocationListener(LocationProvider locationProvider, C35521 c35521) {
                this();
            }
        ...
        public void start() {
            ...
            this.locationQueryCancelRunnable = new C10711();
    ...
    private static class MediaSendPrepareWorker {
        ...
        /* synthetic */ MediaSendPrepareWorker(C35521 c35521) {
            this();
        }
    }
    ...
    class C35521 implements LocationProviderDelegate {
        C35521() {
        }
    ...
    public SendMessagesHelper(int i) {
        ...
        AndroidUtilities.runOnUIThread(new C0968-$$Lambda$SendMessagesHelper$F3OpGpLNH47E9LDuBXXNWIdgYDE(this));
    }
                            ...
                            if (tLObject2 != null) {
                                ...
                                if (delayedMessage.type == 4) {
                                    ...
                                    if (indexOf >= 0) {
                                        ...
                                        if (inputEncryptedFile.f453id == 1) {
                                ...
                                if (decryptedMessage != null) {
                                    ...
                                    decryptedMessageMedia.f438iv = (byte[]) objArr[4];
                                    if (delayedMessage.type == 4) {
                ...
                if (arrayList9 != null) {
                    ...
                    while (i4 < arrayList9.size()) {
                        ...
                        if (obj == null) {
                            ...
                            C0957-$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY c0957-$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY = r0;
                            C0957-$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY c0957-$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY2 = new C0957-$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY(this, file, messageObject5, delayedMessage5, str6);
                            dispatchQueue.postRunnable(c0957-$$Lambda$SendMessagesHelper$1kOX99gMEbip9sYs_E7UQv-97eY);
                        } else if (obj == 1) {
                            stringBuilder5 = new StringBuilder();
                            stringBuilder5.append(Utilities.MD5(str6));
                            stringBuilder5.append(".gif");
                            Utilities.globalQueue.postRunnable(new C1005-$$Lambda$SendMessagesHelper$pp0U4GJ1r75dDYF4YGnbf9kI6EU(this, delayedMessage5, new File(FileLoader.getDirectory(4), stringBuilder5.toString()), messageObject5));
                        }
                        i4++;
                        messageObject2 = null;
                    }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$2$SendMessagesHelper(File file, MessageObject messageObject, DelayedMessage delayedMessage, String str) {
        AndroidUtilities.runOnUIThread(new C0990-$$Lambda$SendMessagesHelper$a2su0LhJhPbUXm5fG2WcDQ_Npn4(this, generatePhotoSizes(file.toString(), null), messageObject, file, delayedMessage, str));
    }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$4$SendMessagesHelper(DelayedMessage delayedMessage, File file, MessageObject messageObject) {
        ...
        AndroidUtilities.runOnUIThread(new C0996-$$Lambda$SendMessagesHelper$ivsY9c3O0F76RgXSqAIraHVU0Fk(this, delayedMessage, file, document, messageObject));
    }
            ...
            if (messageMedia == null || (messageMedia instanceof TL_messageMediaEmpty) || (messageMedia instanceof TL_messageMediaWebPage) || (messageMedia instanceof TL_messageMediaGame) || (messageMedia instanceof TL_messageMediaInvoice)) {
                ...
                if (photo instanceof TL_photo) {
                    ...
                    if (document instanceof TL_document) {
                        ...
                        tL_userContact_old2.f534id = messageMedia2.user_id;
    ...
    public void sendScreenshotMessage(User user, int i, Message message) {
        if (user != null && i != 0 && user.f534id != UserConfig.getInstance(this.currentAccount).getClientUserId()) {
            ...
            if (message != null) {
                ...
                message.to_id.user_id = user.f534id;
        ...
        if (document2 != null) {
            if (((int) j2) == 0) {
                if (MessagesController.getInstance(this.currentAccount).getEncryptedChat(Integer.valueOf((int) (j2 >> 32))) != null) {
                    ...
                    tL_document_layer82.f441id = document2.f441id;
                    ...
                    if (closestPhotoSizeWithSize instanceof TL_photoSize) {
                        ...
                        if (pathToAttach.exists()) {
                            try {
                                ...
                                tL_photoCachedSize.f465w = closestPhotoSizeWithSize.f465w;
                                tL_photoCachedSize.f464h = closestPhotoSizeWithSize.f464h;
    ...
    public /* synthetic */ void lambda$sendMessage$9$SendMessagesHelper(long j, boolean z, boolean z2, LongSparseArray longSparseArray, ArrayList arrayList, ArrayList arrayList2, Peer peer, TL_messages_forwardMessages tL_messages_forwardMessages, TLObject tLObject, TL_error tL_error) {
        ...
        if (tL_error2 == null) {
            ...
            while (true) {
                ...
                if (update instanceof TL_updateMessageID) {
                    ...
                    sparseLongArray.put(tL_updateMessageID.f567id, tL_updateMessageID.random_id);
            ...
            while (i < updates.updates.size()) {
                ...
                if (z5 || (update instanceof TL_updateNewChannelMessage)) {
                    ...
                    message2.unread = num2.intValue() < message2.f461id;
                    if (z2) {
                        message2.out = z4;
                        message2.unread = z3;
                        message2.media_unread = z3;
                    }
                    long j3 = sparseLongArray.get(message2.f461id);
                    if (j3 != 0) {
                        ...
                        if (message3 != null) {
                            ...
                            if (indexOf != -1) {
                                ...
                                updateMediaPaths(messageObject, message2, message2.f461id, null, true);
                                int mediaExistanceFlags = messageObject.getMediaExistanceFlags();
                                message4.f461id = message5.f461id;
                                int i6 = i2 + 1;
                                DispatchQueue storageQueue = MessagesStorage.getInstance(this.currentAccount).getStorageQueue();
                                Message message6 = message5;
                                C0964-$$Lambda$SendMessagesHelper$AguYDqZ0V89DG_eBOiVamirE7iE c0964-$$Lambda$SendMessagesHelper$AguYDqZ0V89DG_eBOiVamirE7iE = r0;
                                sparseLongArray2 = sparseLongArray;
                                C0964-$$Lambda$SendMessagesHelper$AguYDqZ0V89DG_eBOiVamirE7iE c0964-$$Lambda$SendMessagesHelper$AguYDqZ0V89DG_eBOiVamirE7iE2 = new C0964-$$Lambda$SendMessagesHelper$AguYDqZ0V89DG_eBOiVamirE7iE(this, message4, i5, peer, arrayList6, j, message6, mediaExistanceFlags);
                                storageQueue.postRunnable(c0964-$$Lambda$SendMessagesHelper$AguYDqZ0V89DG_eBOiVamirE7iE);
                                i2 = i6;
                                i = i3 + 1;
                                j2 = j;
            ...
            indexOf = 0;
            AndroidUtilities.runOnUIThread(new C0998-$$Lambda$SendMessagesHelper$l40Sz3n3XBnqm5WNgM6XcCJnSAw(this, tL_error2, tL_messages_forwardMessages));
        }
        while (indexOf < arrayList.size()) {
            ...
            AndroidUtilities.runOnUIThread(new C0978-$$Lambda$SendMessagesHelper$OpZpi03weztqM5vuYHFqnb91tB4(this, message7));
            indexOf++;
        }
    }
    ...
    public /* synthetic */ void lambda$null$6$SendMessagesHelper(Message message, int i, Peer peer, ArrayList arrayList, long j, Message message2, int i2) {
        ...
        MessagesStorage.getInstance(this.currentAccount).updateMessageStateAndId(message3.random_id, Integer.valueOf(i), message3.f461id, 0, false, peer.channel_id);
        MessagesStorage.getInstance(this.currentAccount).putMessages(arrayList, true, false, false, 0);
        AndroidUtilities.runOnUIThread(new C0995-$$Lambda$SendMessagesHelper$imJ61LkDqCKC2zsI4rTSXfDp6Z0(this, message3, j, i, message2, i2));
    }
    ...
    public /* synthetic */ void lambda$null$5$SendMessagesHelper(Message message, long j, int i, Message message2, int i2) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(i), Integer.valueOf(message2.f461id), message2, Long.valueOf(j), Long.valueOf(0), Integer.valueOf(i2));
    ...
    public /* synthetic */ void lambda$null$8$SendMessagesHelper(Message message) {
        ...
        processSentMessage(message.f461id);
        removeFromSendingMessages(message.f461id);
    }
    ...
    L_0x0232:
        ...
        r2.<init>();	 Catch:{ Exception -> 0x04de }
        r1.f547id = r2;	 Catch:{ Exception -> 0x04de }
        r2 = r1.f547id;	 Catch:{ Exception -> 0x04de }
        r3 = r13;
        r13 = r0.f463id;	 Catch:{ Exception -> 0x04de }
        r2.f459id = r13;	 Catch:{ Exception -> 0x04de }
        r2 = r1.f547id;	 Catch:{ Exception -> 0x04de }
    ...
    L_0x02c6:
        ...
        org.telegram.messenger.FileLog.m27d(r2);	 Catch:{ Exception -> 0x04de }
        goto L_0x02ce;
    L_0x02cc:
        r11 = r27;
    L_0x02ce:
    ...
    L_0x02d9:
        ...
        r5.<init>();	 Catch:{ Exception -> 0x04de }
        r2.f545id = r5;	 Catch:{ Exception -> 0x04de }
        r5 = r2.f545id;	 Catch:{ Exception -> 0x04de }
        r12 = r1.f441id;	 Catch:{ Exception -> 0x04de }
        r5.f452id = r12;	 Catch:{ Exception -> 0x04de }
        r5 = r2.f545id;	 Catch:{ Exception -> 0x04de }
        r12 = r1.access_hash;	 Catch:{ Exception -> 0x04de }
    ...
    L_0x035d:
        ...
        r0.f457q = r2;	 Catch:{ Exception -> 0x04de }
    L_0x0367:
        r2 = 1;
        goto L_0x036f;
    L_0x0369:
    ...
    L_0x0384:
        ...
        r11.<init>();	 Catch:{ Exception -> 0x04de }
        r5.f545id = r11;	 Catch:{ Exception -> 0x04de }
        r11 = r5.f545id;	 Catch:{ Exception -> 0x04de }
        r12 = r1.f441id;	 Catch:{ Exception -> 0x04de }
        r11.f452id = r12;	 Catch:{ Exception -> 0x04de }
        r11 = r5.f545id;	 Catch:{ Exception -> 0x04de }
        r12 = r1.access_hash;	 Catch:{ Exception -> 0x04de }
    ...
    L_0x03e1:
        ...
        r0.f498id = r1;	 Catch:{ Exception -> 0x04de }
    ...
    public int editMessage(MessageObject messageObject, String str, boolean z, BaseFragment baseFragment, ArrayList<MessageEntity> arrayList, Runnable runnable) {
        ...
        tL_messages_editMessage.f498id = messageObject.getId();
        tL_messages_editMessage.no_webpage = z ^ 1;
        if (arrayList != null) {
            tL_messages_editMessage.entities = arrayList;
            tL_messages_editMessage.flags |= 8;
        }
        return ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editMessage, new C3539-$$Lambda$SendMessagesHelper$0k3RdsQSyxpPqVyuBg3ZosCuce8(this, baseFragment, tL_messages_editMessage, runnable));
    }
    ...
    public /* synthetic */ void lambda$editMessage$11$SendMessagesHelper(BaseFragment baseFragment, TL_messages_editMessage tL_messages_editMessage, Runnable runnable, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            AndroidUtilities.runOnUIThread(new C0991-$$Lambda$SendMessagesHelper$ag0T9ipOWU0deF9XfslwNyap3gA(this, tL_error, baseFragment, tL_messages_editMessage));
        }
    ...
    public void sendNotificationCallback(long j, int i, byte[] bArr) {
        AndroidUtilities.runOnUIThread(new C0971-$$Lambda$SendMessagesHelper$HbRNU4Jc_Y0XpAaKW1pVIkZttzI(this, j, i, bArr));
    }
    ...
    public /* synthetic */ void lambda$sendNotificationCallback$14$SendMessagesHelper(long j, int i, byte[] bArr) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getBotCallbackAnswer, new C3546-$$Lambda$SendMessagesHelper$t77TIdvR5oVS88nA5fB-WrU7owc(this, stringBuilder2), 2);
    ...
    public /* synthetic */ void lambda$null$13$SendMessagesHelper(String str, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0985-$$Lambda$SendMessagesHelper$Vs48x-dR1zvnzDoILUm1BxyX1bc(this, str));
    }
    ...
    public int sendVote(MessageObject messageObject, TL_pollAnswer tL_pollAnswer, Runnable runnable) {
        ...
        return ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_sendVote, new C3547-$$Lambda$SendMessagesHelper$uhLM6ViQVMMdzN56xkU0rITU9CY(this, messageObject, stringBuilder2, runnable));
    }
    ...
    public void sendCallback(boolean r18, org.telegram.messenger.MessageObject r19, org.telegram.tgnet.TLRPC.KeyboardButton r20, org.telegram.p004ui.ChatActivity r21) {
        /*
        r17 = this;
        r8 = r17;
        r9 = r19;
    ...
    public /* synthetic */ void lambda$sendCallback$17$SendMessagesHelper(String str, boolean z, MessageObject messageObject, KeyboardButton keyboardButton, ChatActivity chatActivity, TLObject[] tLObjectArr, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0959-$$Lambda$SendMessagesHelper$4H8dDsDRj446uqFYh4DKm4UlDEU(this, str, z, tLObject, messageObject, keyboardButton, chatActivity, tLObjectArr));
    }
     ...
     */
    public /* synthetic */ void lambda$null$16$SendMessagesHelper(java.lang.String r12, boolean r13, org.telegram.tgnet.TLObject r14, org.telegram.messenger.MessageObject r15, org.telegram.tgnet.TLRPC.KeyboardButton r16, org.telegram.p004ui.ChatActivity r17, org.telegram.tgnet.TLObject[] r18) {
        /*
        r11 = this;
        r0 = r11;
        r1 = r12;
        ...
        if (inputPeer != null && tL_inputMediaGame != null) {
            ...
            if (j2 == 0) {
                ...
                try {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_sendMedia, new C3548-$$Lambda$SendMessagesHelper$ydKQSIv3UJTKVK2ad12P2kFNfXM(this, j2));
                }
                j2 = MessagesStorage.getInstance(this.currentAccount).createPendingTask(nativeByteBuffer);
            }
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_sendMedia, new C3548-$$Lambda$SendMessagesHelper$ydKQSIv3UJTKVK2ad12P2kFNfXM(this, j2));
    ...
    L_0x014b:
        ...
        r5.f534id = r10;	 Catch:{ Exception -> 0x020a }
        r20 = 6;
        goto L_0x0112;
    L_0x0171:
        r5 = r14.type;	 Catch:{ Exception -> 0x020a }
    ...
    L_0x0350:
        ...
        r3 = r7.media;	 Catch:{ Exception -> 0x020a }
        r10 = r2.f534id;	 Catch:{ Exception -> 0x020a }
    ...
    L_0x0480:
        ...
        r4 = r4.stickerset;	 Catch:{ Exception -> 0x020a }
        r3 = r4.f460id;	 Catch:{ Exception -> 0x020a }
    ...
    L_0x04db:
        ...
        r7.f461id = r3;	 Catch:{ Exception -> 0x020a }
    ...
    L_0x0629:
        ...
        r4 = r7.f461id;	 Catch:{ Exception -> 0x020a }
        ...
        r2 = r7.f461id;	 Catch:{ Exception -> 0x020a }
    ...
    L_0x08ca:
        r11 = r7.f461id;	 Catch:{ Exception -> 0x087c }
    ...
    L_0x08d4:
        ...
        org.telegram.messenger.FileLog.m27d(r11);	 Catch:{ Exception -> 0x087c }
        goto L_0x090d;
    L_0x090b:
        r56 = r14;
    L_0x090d:
    ...
    L_0x09d1:
        ...
        org.telegram.messenger.FileLog.m27d(r8);	 Catch:{ Exception -> 0x087c }
        goto L_0x09d9;
    L_0x09d7:
        r13 = r43;
    L_0x09d9:
    ...
    L_0x09f0:
        ...
        r9.<init>();	 Catch:{ Exception -> 0x087c }
        r8.f545id = r9;	 Catch:{ Exception -> 0x087c }
        r9 = r8.f545id;	 Catch:{ Exception -> 0x087c }
        r14 = r12.f441id;	 Catch:{ Exception -> 0x087c }
        r9.f452id = r14;	 Catch:{ Exception -> 0x087c }
        r9 = r8.f545id;	 Catch:{ Exception -> 0x087c }
    ...
    L_0x0ad9:
        ...
        r8.f545id = r9;	 Catch:{ Exception -> 0x0aa5 }
        r9 = r8.f545id;	 Catch:{ Exception -> 0x0aa5 }
        r19 = r11;
        r10 = r12.f441id;	 Catch:{ Exception -> 0x0aa5 }
        r9.f452id = r10;	 Catch:{ Exception -> 0x0aa5 }
        r9 = r8.f545id;	 Catch:{ Exception -> 0x0aa5 }
    ...
    L_0x0b83:
        ...
        r4.f457q = r8;	 Catch:{ Exception -> 0x0aa5 }
    L_0x0b8d:
        r10 = 1;
        goto L_0x0bc3;
    L_0x0b8f:
    ...
    L_0x0bda:
        ...
        r9.<init>();	 Catch:{ Exception -> 0x0c3f }
        r8.f545id = r9;	 Catch:{ Exception -> 0x0c3f }
        r9 = r8.f545id;	 Catch:{ Exception -> 0x0c3f }
        r52 = r6;
        r11 = r7;
        r6 = r12.f441id;	 Catch:{ Exception -> 0x0c3d }
        r9.f452id = r6;	 Catch:{ Exception -> 0x0c3d }
        r6 = r8.f545id;	 Catch:{ Exception -> 0x0c3d }
        r7 = r14;
        r13 = r12.access_hash;	 Catch:{ Exception -> 0x0f1f }
        r6.access_hash = r13;	 Catch:{ Exception -> 0x0f1f }
        r6 = r8.f545id;	 Catch:{ Exception -> 0x0f1f }
    ...
    L_0x0cb0:
        ...
        r8.f547id = r9;	 Catch:{ Exception -> 0x0f1f }
        r9 = r8.f547id;	 Catch:{ Exception -> 0x0f1f }
        r12 = r14.f463id;	 Catch:{ Exception -> 0x0f1f }
        r9.f459id = r12;	 Catch:{ Exception -> 0x0f1f }
        r9 = r8.f547id;	 Catch:{ Exception -> 0x0f1f }
    ...
    L_0x10b9:
        r5 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r8 = r6.f444w;	 Catch:{ Exception -> 0x11ba }
        r5.f439w = r8;	 Catch:{ Exception -> 0x11ba }
        r5 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r8 = r6.f443h;	 Catch:{ Exception -> 0x11ba }
        r5.f436h = r8;	 Catch:{ Exception -> 0x11ba }
        r5 = r2.media;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x10cf:
        r5 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r6 = r4.f464h;	 Catch:{ Exception -> 0x11ba }
        r5.thumb_h = r6;	 Catch:{ Exception -> 0x11ba }
        r5 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r4 = r4.f465w;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x10e4:
        ...
        r4 = r12.f441id;	 Catch:{ Exception -> 0x11ba }
        r3.f453id = r4;	 Catch:{ Exception -> 0x11ba }
        ...
        r4 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r5 = r12.f442iv;	 Catch:{ Exception -> 0x11ba }
        r4.f438iv = r5;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x117c:
        ...
        r3 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r6 = r6.f534id;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x11f6:
        ...
        r6 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r9 = r3.f464h;	 Catch:{ Exception -> 0x11ba }
        r6.thumb_h = r9;	 Catch:{ Exception -> 0x11ba }
        r6 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r3 = r3.f465w;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x1238:
        ...
        r2.media = r3;	 Catch:{ Exception -> 0x11ba }
        r3 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r10 = r12.f441id;	 Catch:{ Exception -> 0x11ba }
        r3.f437id = r10;	 Catch:{ Exception -> 0x11ba }
        r3 = r2.media;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x12c7:
        ...
        r14 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r15 = r6.f464h;	 Catch:{ Exception -> 0x11ba }
        r14.thumb_h = r15;	 Catch:{ Exception -> 0x11ba }
        r14 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r6 = r6.f465w;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x133e:
        ...
        r3.<init>();	 Catch:{ Exception -> 0x11ba }
        r10 = r12.f441id;	 Catch:{ Exception -> 0x11ba }
        r3.f453id = r10;	 Catch:{ Exception -> 0x11ba }
        r10 = r12.access_hash;	 Catch:{ Exception -> 0x11ba }
        r3.access_hash = r10;	 Catch:{ Exception -> 0x11ba }
        r6 = r2.media;	 Catch:{ Exception -> 0x11ba }
        ...
        r6 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r10 = r12.f442iv;	 Catch:{ Exception -> 0x11ba }
        r6.f438iv = r10;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x13c6:
        r6 = r2.media;	 Catch:{ Exception -> 0x14df }
        r13 = r15.f464h;	 Catch:{ Exception -> 0x14df }
        r6.thumb_h = r13;	 Catch:{ Exception -> 0x14df }
        r6 = r2.media;	 Catch:{ Exception -> 0x14df }
        r13 = r15.f465w;	 Catch:{ Exception -> 0x14df }
        r6.thumb_w = r13;	 Catch:{ Exception -> 0x14df }
        r6 = r2.media;	 Catch:{ Exception -> 0x14df }
        r13 = r12.f465w;	 Catch:{ Exception -> 0x14df }
        r6.f439w = r13;	 Catch:{ Exception -> 0x14df }
        r6 = r2.media;	 Catch:{ Exception -> 0x14df }
        r13 = r12.f464h;	 Catch:{ Exception -> 0x14df }
        r6.f436h = r13;	 Catch:{ Exception -> 0x14df }
        r6 = r2.media;	 Catch:{ Exception -> 0x14df }
    ...
    L_0x13ef:
        ...
        r6 = r2.media;	 Catch:{ Exception -> 0x11ba }
        r10 = r12.location;	 Catch:{ Exception -> 0x11ba }
        r10 = r10.f447iv;	 Catch:{ Exception -> 0x11ba }
        r6.f438iv = r10;	 Catch:{ Exception -> 0x11ba }
        r6 = r1.currentAccount;	 Catch:{ Exception -> 0x11ba }
        r6 = org.telegram.messenger.SecretChatHelper.getInstance(r6);	 Catch:{ Exception -> 0x11ba }
        r10 = r7.messageOwner;	 Catch:{ Exception -> 0x11ba }
    ...
    L_0x14c0:
        r8 = r16;
        r2.f453id = r8;	 Catch:{ Exception -> 0x17bb }
    ...
    L_0x1573:
        r4 = r3.f501id;	 Catch:{ Exception -> 0x17bb }
    ...
    L_0x160b:
        ...
        r6 = r10.get(r6);	 Catch:{ Exception -> 0x17bb }
        r6 = (java.lang.String) r6;	 Catch:{ Exception -> 0x17bb }
        r3.f517id = r6;	 Catch:{ Exception -> 0x17bb }
        ...
        if (!(arrayList == null || arrayList.isEmpty())) {
            ...
            while (i < size) {
                ...
                if (photoSize == null || (photoSize instanceof TL_photoStrippedSize) || (photoSize instanceof TL_photoSizeEmpty) || photoSize.location == null) {
                    ...
                    tL_photoSize.f465w = photoSize.f465w;
                    tL_photoSize.f464h = photoSize.f464h;
    ...
    private void performSendDelayedMessage(DelayedMessage delayedMessage, int i) {
        ...
        if (i2 == 0) {
            ...
            if (str2 != null) {
                ...
                putToDelayedMessages(str2, delayedMessage2);
                FileLoader.getInstance(this.currentAccount).uploadFile(str2, false, true, ConnectionsManager.FileTypePhoto);
            } else {
                str2 = FileLoader.getPathToAttach(delayedMessage2.photoSize).toString();
                ...
                putToDelayedMessages(str2, delayedMessage2);
                FileLoader.getInstance(this.currentAccount).uploadFile(str2, true, true, ConnectionsManager.FileTypePhoto);
            }
        } else {
            String str3 = ".jpg";
            String str4 = "_";
            ...
            if (i2 == 1) {
                ...
                if (videoEditedInfo == null || !videoEditedInfo.needConvert()) {
                    ...
                    if (videoEditedInfo != null) {
                        if (videoEditedInfo.file != null) {
                            ...
                            decryptedMessageMedia.f438iv = videoEditedInfo.f423iv;
                            SecretChatHelper instance = SecretChatHelper.getInstance(this.currentAccount);
                    ...
                    if (tLObject != null) {
                        ...
                        if (inputMedia.file == null) {
                            ...
                            if (videoEditedInfo3 == null || !videoEditedInfo3.needConvert()) {
                                ...
                                FileLoader.getInstance(this.currentAccount).uploadFile(str7, false, false, document.size, ConnectionsManager.FileTypeVideo);
                            }
                        } else {
                        ...
                        if (delayedMessage2.sendEncryptedRequest == null || document.dc_id == 0 || new File(str7).exists()) {
                            ...
                            videoEditedInfo3 = delayedMessage2.obj.videoEditedInfo;
                            if (videoEditedInfo3 == null || !videoEditedInfo3.needConvert()) {
                                FileLoader.getInstance(this.currentAccount).uploadFile(str7, true, false, ConnectionsManager.FileTypeVideo);
                            } else {
                                FileLoader.getInstance(this.currentAccount).uploadFile(str7, true, false, document.size, ConnectionsManager.FileTypeVideo);
                            }
                        } else {
                ...
                if (str2 != null) {
                    ...
                    if (tLObject != null) {
                        ...
                        if (inputMedia.file == null) {
                            ...
                            instance2.uploadFile(str2, z2, false, ConnectionsManager.FileTypeFile);
                        ...
                        if (delayedMessage2.sendEncryptedRequest == null || document.dc_id == 0 || new File(str8).exists()) {
                            ...
                            FileLoader.getInstance(this.currentAccount).uploadFile(str8, true, false, ConnectionsManager.FileTypeFile);
                        } else {
                            putToDelayedMessages(FileLoader.getAttachFileName(document), delayedMessage2);
                            FileLoader.getInstance(this.currentAccount).loadFile(document, delayedMessage2.parentObject, 2, 0);
                        }
                ...
                instance3.uploadFile(str2, z, true, ConnectionsManager.FileTypeAudio);
            } else if (i2 == 4) {
                boolean z3;
                boolean z4 = i < 0;
                    ...
                    if (messageObject3.getDocument() != null) {
                        ...
                        if (delayedMessage2.videoEditedInfo != null) {
                            ...
                            if (str == null) {
                                ...
                                stringBuilder.append(FileLoader.getDirectory(4));
                                stringBuilder.append(str6);
                                stringBuilder.append(document2.f441id);
                                stringBuilder.append(str5);
                                str = stringBuilder.toString();
                            }
                            putToDelayedMessages(str, delayedMessage2);
                            ...
                            if (str9 == null) {
                                ...
                                stringBuilder5.append(document3.f441id);
                            ...
                            if (tLObject2 != null) {
                                ...
                                if (inputMedia2.file == null) {
                                    ...
                                    if (videoEditedInfo4 == null || !videoEditedInfo4.needConvert()) {
                                        FileLoader.getInstance(this.currentAccount).uploadFile(str9, false, false, ConnectionsManager.FileTypeVideo);
                                    } else {
                                        FileLoader.getInstance(this.currentAccount).uploadFile(str9, false, false, document3.size, ConnectionsManager.FileTypeVideo);
                                    }
                                } else {
                                    messageObject3 = messageObject4;
                                    stringBuilder = new StringBuilder();
                                    ...
                                    FileLoader.getInstance(this.currentAccount).uploadFile(str, false, true, ConnectionsManager.FileTypePhoto);
                                }
                            } else {
                                messageObject3 = messageObject4;
                                ...
                                videoEditedInfo4 = messageObject3.videoEditedInfo;
                                if (videoEditedInfo4 == null || !videoEditedInfo4.needConvert()) {
                                    FileLoader.getInstance(this.currentAccount).uploadFile(str9, true, false, ConnectionsManager.FileTypeVideo);
                                } else {
                                    FileLoader.getInstance(this.currentAccount).uploadFile(str9, true, false, document3.size, ConnectionsManager.FileTypeVideo);
                                }
                            }
                        }
                        ...
                        if (str8 != null) {
                            ...
                            z3 = true;
                            FileLoader.getInstance(this.currentAccount).uploadFile(str8, delayedMessage2.sendEncryptedRequest != null, true, ConnectionsManager.FileTypePhoto);
                            delayedMessage2.photoSize = null;
                            z5 = false;
    ...
    private void uploadMultiMedia(DelayedMessage delayedMessage, InputMedia inputMedia, InputEncryptedFile inputEncryptedFile, String str) {
        ...
        if (inputMedia != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_uploadMedia, new C3540-$$Lambda$SendMessagesHelper$9ikUx4RLVeYwBBYbegYSYKLcFew(this, inputMedia, delayedMessage));
    ...
    public /* synthetic */ void lambda$uploadMultiMedia$20$SendMessagesHelper(InputMedia inputMedia, DelayedMessage delayedMessage, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0984-$$Lambda$SendMessagesHelper$TtlUVA9H7pRWgwj4hEtQKuSUaGg(this, tLObject, inputMedia, delayedMessage));
    }
    ...
    public /* synthetic */ void lambda$stopVideoService$22$SendMessagesHelper(String str) {
        AndroidUtilities.runOnUIThread(new C1004-$$Lambda$SendMessagesHelper$p5AvMlaNmWbZ3rWK9wlPEhiSpDU(this, str));
    }

    /* Access modifiers changed, original: protected */
    public void stopVideoService(String str) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0958-$$Lambda$SendMessagesHelper$30d877KfsrPIYnw1mIlTicl4KVY(this, str));
    }

    /* Access modifiers changed, original: protected */
    public void putToSendingMessages(Message message) {
        this.sendingMessages.put(message.f461id, message);
    }
    ...
    public void performSendMessageRequestMulti(TL_messages_sendMultiMedia tL_messages_sendMultiMedia, ArrayList<MessageObject> arrayList, ArrayList<String> arrayList2, ArrayList<Object> arrayList3, DelayedMessage delayedMessage) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest((TLObject) tL_messages_sendMultiMedia, new C3542-$$Lambda$SendMessagesHelper$KTc-sr8270evlRbeKgXtKisOYgM(this, arrayList3, tL_messages_sendMultiMedia, arrayList, arrayList2, delayedMessage), null, 68);
    }
    ...
    public /* synthetic */ void lambda$performSendMessageRequestMulti$29$SendMessagesHelper(ArrayList arrayList, TL_messages_sendMultiMedia tL_messages_sendMultiMedia, ArrayList arrayList2, ArrayList arrayList3, DelayedMessage delayedMessage, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0970-$$Lambda$SendMessagesHelper$GqwnlURs2UJWXkcpzjv2EBiLrD0(this, tL_error, arrayList, tL_messages_sendMultiMedia, arrayList2, arrayList3, delayedMessage, tLObject));
    }
    ...
    public /* synthetic */ void lambda$null$28$SendMessagesHelper(TL_error tL_error, ArrayList arrayList, TL_messages_sendMultiMedia tL_messages_sendMultiMedia, ArrayList arrayList2, ArrayList arrayList3, DelayedMessage delayedMessage, TLObject tLObject) {
        ...
        if (tL_error2 == null) {
            ...
            while (i3 < arrayList4.size()) {
                ...
                if (update instanceof TL_updateMessageID) {
                    TL_updateMessageID tL_updateMessageID = (TL_updateMessageID) update;
                    longSparseArray.put(tL_updateMessageID.random_id, Integer.valueOf(tL_updateMessageID.f567id));
                    arrayList4.remove(i3);
                } else if (update instanceof TL_updateNewMessage) {
                    TL_updateNewMessage tL_updateNewMessage = (TL_updateNewMessage) update;
                    message = tL_updateNewMessage.message;
                    sparseArray.put(message.f461id, message);
                    Utilities.stageQueue.postRunnable(new C0974-$$Lambda$SendMessagesHelper$LtIzRBxRfP0h_IpuxXXH0r91OLg(sendMessagesHelper, tL_updateNewMessage));
                    arrayList4.remove(i3);
                } else if (update instanceof TL_updateNewChannelMessage) {
                    TL_updateNewChannelMessage tL_updateNewChannelMessage = (TL_updateNewChannelMessage) update;
                    message = tL_updateNewChannelMessage.message;
                    sparseArray.put(message.f461id, message);
                    Utilities.stageQueue.postRunnable(new C0981-$$Lambda$SendMessagesHelper$QOjj_wrwvuHdKpPrDByKhoWSuVs(sendMessagesHelper, tL_updateNewChannelMessage));
                    arrayList4.remove(i3);
                } else {
                    i3++;
                }
            ...
            while (i4 < arrayList2.size()) {
                ...
                if (num != null) {
                    ...
                    if (message2 != null) {
                        ...
                        updateMediaPaths(messageObject, message2, message2.f461id, str3, false);
                        int mediaExistanceFlags = messageObject.getMediaExistanceFlags();
                        message3.f461id = message2.f461id;
                        ...
                        message2.unread = num.intValue() < message2.f461id;
                        ...
                        NotificationCenter.getInstance(sendMessagesHelper.currentAccount).postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(i6), Integer.valueOf(message3.f461id), message3, Long.valueOf(message3.dialog_id), Long.valueOf(j), Integer.valueOf(mediaExistanceFlags));
                        C1007-$$Lambda$SendMessagesHelper$s-p-jfZFDyfDIdh58D5Hp9jBe_A c1007-$$Lambda$SendMessagesHelper$s-p-jfZFDyfDIdh58D5Hp9jBe_A = r0;
                        Message message4 = message3;
                        DispatchQueue storageQueue = MessagesStorage.getInstance(this.currentAccount).getStorageQueue();
                        SparseArray sparseArray2 = sparseArray;
                        C1007-$$Lambda$SendMessagesHelper$s-p-jfZFDyfDIdh58D5Hp9jBe_A c1007-$$Lambda$SendMessagesHelper$s-p-jfZFDyfDIdh58D5Hp9jBe_A2 = new C1007-$$Lambda$SendMessagesHelper$s-p-jfZFDyfDIdh58D5Hp9jBe_A(this, message4, i6, arrayList8, j, mediaExistanceFlags);
                        storageQueue.postRunnable(c1007-$$Lambda$SendMessagesHelper$s-p-jfZFDyfDIdh58D5Hp9jBe_A);
                        i4++;
            ...
            i = 1;
            obj = null;
            Utilities.stageQueue.postRunnable(new C0960-$$Lambda$SendMessagesHelper$4Kecy4z15gyx9k2PnYvYSIzID4o(thisR, updates));
        } else {
            thisR = sendMessagesHelper;
            i = 1;
        ...
        if (obj != null) {
            for (int i7 = 0; i7 < arrayList2.size(); i7++) {
                ...
                objArr[0] = Integer.valueOf(message5.f461id);
                instance.postNotificationName(i8, objArr);
                thisR.processSentMessage(message5.f461id);
                thisR.removeFromSendingMessages(message5.f461id);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$null$26$SendMessagesHelper(Message message, int i, ArrayList arrayList, long j, int i2) {
        Message message2 = message;
        MessagesStorage.getInstance(this.currentAccount).updateMessageStateAndId(message2.random_id, Integer.valueOf(i), message2.f461id, 0, false, message2.to_id.channel_id);
        MessagesStorage.getInstance(this.currentAccount).putMessages(arrayList, true, false, false, 0);
        AndroidUtilities.runOnUIThread(new C0997-$$Lambda$SendMessagesHelper$jV9Gq3Q6H66Q6pHxnGZUWi6v2TA(this, message2, i, j, i2));
    }
    ...
    public /* synthetic */ void lambda$null$25$SendMessagesHelper(Message message, int i, long j, int i2) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(i), Integer.valueOf(message.f461id), message, Long.valueOf(message.dialog_id), Long.valueOf(j), Integer.valueOf(i2));
        processSentMessage(i);
        removeFromSendingMessages(i);
    }
    ...
    public void performSendMessageRequest(TLObject tLObject, MessageObject messageObject, String str, DelayedMessage delayedMessage, boolean z, DelayedMessage delayedMessage2, Object obj) {
        ...
        message.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLObject2, new C3543-$$Lambda$SendMessagesHelper$Qe-YOTDVha4ZEN36efTByrQcLKk(this, tLObject, obj, messageObject, str, delayedMessage, z, delayedMessage2, message), new C3544-$$Lambda$SendMessagesHelper$_wu1JxbPB7vnkTrFhWBgUdpKleg(this, message), (tLObject2 instanceof TL_messages_sendMessage ? 128 : 0) | 68);
        if (delayedMessage3 != null) {
            delayedMessage.sendDelayedRequests();
        }
    }
    ...
    public /* synthetic */ void lambda$performSendMessageRequest$40$SendMessagesHelper(final TLObject tLObject, Object obj, MessageObject messageObject, String str, DelayedMessage delayedMessage, boolean z, DelayedMessage delayedMessage2, Message message, TLObject tLObject2, TL_error tL_error) {
        ...
        if (tL_error2 != null && (((tLObject3 instanceof TL_messages_sendMedia) || (tLObject3 instanceof TL_messages_editMessage)) && FileRefController.isFileRefError(tL_error2.text))) {
            if (obj2 != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        SendMessagesHelper.this.removeFromSendingMessages(message2.f461id);
        ...
        if (tLObject3 instanceof TL_messages_editMessage) {
            AndroidUtilities.runOnUIThread(new C0966-$$Lambda$SendMessagesHelper$C5CrRoHs0pjHmck8QByYuCo3o_s(this, tL_error, message, tLObject2, messageObject, str, tLObject));
        } else {
            AndroidUtilities.runOnUIThread(new C0994-$$Lambda$SendMessagesHelper$ep4b2HrbYOUHrh_RuM2XFeYU5D8(this, tL_error, message, tLObject, tLObject2, messageObject, str));
        }
    }
    ...
    public /* synthetic */ void lambda$null$32$SendMessagesHelper(TL_error tL_error, Message message, TLObject tLObject, MessageObject messageObject, String str, TLObject tLObject2) {
        ...
        if (tL_error == null) {
            ...
            if (message3 != null) {
                ...
                updateMediaPaths(messageObject, message3, message3.f461id, str, false);
            }
            Utilities.stageQueue.postRunnable(new C0962-$$Lambda$SendMessagesHelper$5FORFfWffqEc1IY97T80wKl0r1Y(this, updates, message));
    ...
    public /* synthetic */ void lambda$null$31$SendMessagesHelper(Updates updates, Message message) {
        MessagesController.getInstance(this.currentAccount).processUpdates(updates, false);
        AndroidUtilities.runOnUIThread(new C0963-$$Lambda$SendMessagesHelper$8gQkjP_exgY3T8Zm64H9fCFaXkg(this, message));
    }
    ...
    public /* synthetic */ void lambda$null$39$SendMessagesHelper(TL_error tL_error, Message message, TLObject tLObject, TLObject tLObject2, MessageObject messageObject, String str) {
        ...
        if (tL_error2 == null) {
            ...
            if (tLObject4 instanceof TL_updateShortSentMessage) {
                ...
                updateMediaPaths(messageObject, null, tL_updateShortSentMessage.f533id, null, false);
                mediaExistanceFlags = messageObject.getMediaExistanceFlags();
                i = tL_updateShortSentMessage.f533id;
                message2.f461id = i;
                message2.local_id = i;
                ...
                Utilities.stageQueue.postRunnable(new C1001-$$Lambda$SendMessagesHelper$oGx4Uga4Fsoa8DwCGDnCb2Zs6E8(this, tL_updateShortSentMessage));
                ...
                while (i < arrayList2.size()) {
                    ...
                    if (update instanceof TL_updateNewMessage) {
                        ...
                        Utilities.stageQueue.postRunnable(new C0972-$$Lambda$SendMessagesHelper$L5hF2IhINUG6nIA5dSvAtaxsz8k(this, tL_updateNewMessage));
                        arrayList2.remove(i);
                        break;
                    } else if (update instanceof TL_updateNewChannelMessage) {
                        TL_updateNewChannelMessage tL_updateNewChannelMessage = (TL_updateNewChannelMessage) update;
                        ...
                        Utilities.stageQueue.postRunnable(new C0988-$$Lambda$SendMessagesHelper$XuUcVoATmHzvdWgq3344GUvreTA(this, tL_updateNewChannelMessage));
                        arrayList2.remove(i);
                    } else {
                        i++;
                    }
                ...
                if (message5 != null) {
                    ...
                    message5.unread = num.intValue() < message5.f461id;
                    updateMediaPaths(messageObject, message5, message5.f461id, str, false);
                    mediaExistanceFlags = messageObject.getMediaExistanceFlags();
                    message2.f461id = message5.f461id;
                ...
                Utilities.stageQueue.postRunnable(new C0986-$$Lambda$SendMessagesHelper$WQ_rgU9i_c841KG3_Zo7CgxwtnA(this, updates));
                obj = obj2;
                i2 = i;
            } else {
                obj = null;
            ...
            if (MessageObject.isLiveLocationMessage(message)) {
                LocationController.getInstance(this.currentAccount).addSharingLocation(message2.dialog_id, message2.f461id, message2.media.period, message);
            }
            if (obj == null) {
                ...
                objArr[1] = Integer.valueOf(z ? i3 : message2.f461id);
                objArr[2] = message2;
                ...
                boolean z2 = z;
                ArrayList arrayList3 = arrayList;
                C1000-$$Lambda$SendMessagesHelper$oDX4i73L5lyJayv_jik2z2hGP7Q c1000-$$Lambda$SendMessagesHelper$oDX4i73L5lyJayv_jik2z2hGP7Q = r0;
                i3 = i2;
                DispatchQueue storageQueue = MessagesStorage.getInstance(this.currentAccount).getStorageQueue();
                C1000-$$Lambda$SendMessagesHelper$oDX4i73L5lyJayv_jik2z2hGP7Q c1000-$$Lambda$SendMessagesHelper$oDX4i73L5lyJayv_jik2z2hGP7Q2 = new C1000-$$Lambda$SendMessagesHelper$oDX4i73L5lyJayv_jik2z2hGP7Q(this, message, i4, z2, arrayList3, i3, str2);
                storageQueue.postRunnable(c1000-$$Lambda$SendMessagesHelper$oDX4i73L5lyJayv_jik2z2hGP7Q);
            }
        } else {
        ...
        if (obj != null) {
            ...
            NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.messageSendError, Integer.valueOf(message2.f461id));
            processSentMessage(message2.f461id);
            if (MessageObject.isVideoMessage(message) || MessageObject.isRoundVideoMessage(message) || MessageObject.isNewGifMessage(message)) {
                stopVideoService(message2.attachPath);
            }
            removeFromSendingMessages(message2.f461id);
        }
    }
    ...
    public /* synthetic */ void lambda$null$38$SendMessagesHelper(Message message, int i, boolean z, ArrayList arrayList, int i2, String str) {
        Message message2 = message;
        MessagesStorage.getInstance(this.currentAccount).updateMessageStateAndId(message2.random_id, Integer.valueOf(i), z ? i : message2.f461id, 0, false, message2.to_id.channel_id);
        ...
        AndroidUtilities.runOnUIThread(new C0975-$$Lambda$SendMessagesHelper$Lyh7x_fVJCtY78eBEW_nfqaECxE(this, z, arrayList, message, i, i2));
        if (MessageObject.isVideoMessage(message) || MessageObject.isRoundVideoMessage(message) || MessageObject.isNewGifMessage(message)) {
    ...
    public /* synthetic */ void lambda$null$37$SendMessagesHelper(boolean z, ArrayList arrayList, Message message, int i, int i2) {
        ...
        objArr[1] = Integer.valueOf(z ? i : message.f461id);
        objArr[2] = message;
    ...
    public /* synthetic */ void lambda$performSendMessageRequest$42$SendMessagesHelper(Message message) {
        AndroidUtilities.runOnUIThread(new C1008-$$Lambda$SendMessagesHelper$s7kB2gRrnjLRX4z7Rxo0J3e9TgU(this, message, message.f461id));
    }
    ...
    public void processUnsentMessages(ArrayList<Message> arrayList, ArrayList<User> arrayList2, ArrayList<Chat> arrayList3, ArrayList<EncryptedChat> arrayList4) {
        AndroidUtilities.runOnUIThread(new C1010-$$Lambda$SendMessagesHelper$uLBi7R9ZOYopc-Gzh-Qk8zK9YAo(this, arrayList2, arrayList3, arrayList4, arrayList));
    }
    ...
    L_0x0145:
        r17 = 0;
    L_0x0147:
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ all -> 0x015a }
    ...
    public static void prepareSendingAudioDocuments(ArrayList<MessageObject> arrayList, long j, MessageObject messageObject, MessageObject messageObject2) {
        new Thread(new C0961-$$Lambda$SendMessagesHelper$4kP0iTjQJZDiTNhQsrN7GEn6QHw(arrayList, j, UserConfig.selectedAccount, messageObject2, messageObject)).start();
    }
    ...
    public static void prepareSendingDocuments(ArrayList<String> arrayList, ArrayList<String> arrayList2, ArrayList<Uri> arrayList3, String str, String str2, long j, MessageObject messageObject, InputContentInfoCompat inputContentInfoCompat, MessageObject messageObject2) {
        if (!(arrayList == null && arrayList2 == null && arrayList3 == null) && (arrayList == null || arrayList2 == null || arrayList.size() == arrayList2.size())) {
            new Thread(new C1009-$$Lambda$SendMessagesHelper$u-MDqklxXvAmqp9ZSz6JzWZDqR0(arrayList, UserConfig.selectedAccount, arrayList2, str2, j, messageObject, str, messageObject2, arrayList3, inputContentInfoCompat)).start();
        }
    }
    ...
    static /* synthetic */ void lambda$prepareSendingDocuments$48(ArrayList arrayList, int i, ArrayList arrayList2, String str, long j, MessageObject messageObject, String str2, MessageObject messageObject2, ArrayList arrayList3, InputContentInfoCompat inputContentInfoCompat) {
        ...
        if (obj != null) {
            AndroidUtilities.runOnUIThread(C0965-$$Lambda$SendMessagesHelper$AzNNw46d9NqQLWk4ri-KgnUrWCU.INSTANCE);
        }
    }

    static /* synthetic */ void lambda$null$47() {
        try {
            Toast.makeText(ApplicationLoader.applicationContext, LocaleController.getString("UnsupportedAttachment", C1067R.string.UnsupportedAttachment), 0).show();
        } catch (Exception e) {
            FileLog.m30e(e);
        }
    }

    public static void prepareSendingLocation(Location location, long j) {
        int i = UserConfig.selectedAccount;
        MessagesStorage.getInstance(i).getStorageQueue().postRunnable(new C0980-$$Lambda$SendMessagesHelper$Q4vzAX7T1ldI1PT8YTFIZJtboaE(location, i, j));
    }

    static /* synthetic */ void lambda$null$49(Location location, int i, long j) {
        MessageMedia tL_messageMediaGeo;
        ...
        if (charSequence == null && charSequence2 == null) {
            tL_messageMediaGeo = new TL_messageMediaGeo();
        } else {
            String str;
            String str2;
            ...
            tL_messageMediaVenue.address = str;
            if (charSequence == null) {
                str2 = str3;
            } else {
                str2 = charSequence.toString();
            }
            tL_messageMediaVenue.title = str2;
            tL_messageMediaVenue.provider = str3;
        ...
        getInstance(i).sendMessage(tL_messageMediaGeo, j, null, null, null);
    }
    ...
    public static void prepareSendingBotContextResult(BotInlineResult botInlineResult, HashMap<String, String> hashMap, long j, MessageObject messageObject) {
        ...
        if (botInlineResult2 != null) {
            ...
            if (botInlineMessage instanceof TL_botInlineMessageMediaAuto) {
                new Thread(new C0973-$$Lambda$SendMessagesHelper$LmDH-h6B9Uggp2w_KTpB6c_fhcQ(j, botInlineResult, i, hashMap, messageObject)).run();
    ...
    static /* synthetic */ void lambda$prepareSendingBotContextResult$53(long r17, org.telegram.tgnet.TLRPC.BotInlineResult r19, int r20, java.util.HashMap r21, org.telegram.messenger.MessageObject r22) {
        /*
        r8 = r19;
        r9 = r21;
        r5 = r17;
    ...
    L_0x0406:
        ...
        r9.put(r1, r0);
    L_0x040d:
        r0 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$NAGNwZznFWBfaOyQvFbS7VcD9Ac;
        r1 = r0;
        r3 = r20;
        r5 = r17;
        r7 = r22;
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.SendMessagesHelper.lambda$prepareSendingBotContextResult$53(long, org.telegram.tgnet.TLRPC$BotInlineResult, int, java.util.HashMap, org.telegram.messenger.MessageObject):void");
    }

    static /* synthetic */ void lambda$null$52(TL_document tL_document, int i, String str, long j, MessageObject messageObject, BotInlineResult botInlineResult, HashMap hashMap, TL_photo tL_photo, TL_game tL_game) {
        BotInlineResult botInlineResult2 = botInlineResult;
    ...
    public static void prepareSendingText(String str, long j) {
        int i = UserConfig.selectedAccount;
        MessagesStorage.getInstance(i).getStorageQueue().postRunnable(new C0999-$$Lambda$SendMessagesHelper$mEb_8CvzR9IFpSPa5BhRMXY7oRk(str, i, j));
    }

    static /* synthetic */ void lambda$null$54(String str, int i, long j) {
    ...
    public static void prepareSendingMedia(ArrayList<SendingMediaInfo> arrayList, long j, MessageObject messageObject, InputContentInfoCompat inputContentInfoCompat, boolean z, boolean z2, MessageObject messageObject2) {
        if (!arrayList.isEmpty()) {
            mediaSendQueue.postRunnable(new C1012-$$Lambda$SendMessagesHelper$x39RupUe-lkQUIgui46eiCkD1zA(arrayList, j, UserConfig.selectedAccount, z, z2, messageObject2, messageObject, inputContentInfoCompat));
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:279:0x06f1  */
    /* JADX WARNING: Removed duplicated region for block: B:234:0x0616  */
    /* JADX WARNING: Removed duplicated region for block: B:285:0x0705  */
    /* JADX WARNING: Removed duplicated region for block: B:291:0x0717  */
    /* JADX WARNING: Removed duplicated region for block: B:298:0x075d  */
    /* JADX WARNING: Removed duplicated region for block: B:441:0x0a7e  */
    /* JADX WARNING: Removed duplicated region for block: B:435:0x0a4f  */
    /* JADX WARNING: Removed duplicated region for block: B:354:0x08e4  */
    /* JADX WARNING: Removed duplicated region for block: B:349:0x08a1  */
    /* JADX WARNING: Removed duplicated region for block: B:349:0x08a1  */
    /* JADX WARNING: Removed duplicated region for block: B:354:0x08e4  */
    /* JADX WARNING: Removed duplicated region for block: B:354:0x08e4  */
    /* JADX WARNING: Removed duplicated region for block: B:349:0x08a1  */
    /* JADX WARNING: Removed duplicated region for block: B:346:0x089b  */
    /* JADX WARNING: Removed duplicated region for block: B:345:0x0891  */
    /* JADX WARNING: Removed duplicated region for block: B:17:0x004a  */
    /* JADX WARNING: Removed duplicated region for block: B:78:0x018d  */
    /* JADX WARNING: Removed duplicated region for block: B:452:0x0b1b  */
    /* JADX WARNING: Removed duplicated region for block: B:451:0x0b10  */
    /* JADX WARNING: Removed duplicated region for block: B:454:0x0b1f  */
    /* JADX WARNING: Removed duplicated region for block: B:461:0x0b31 A:{LOOP_END, LOOP:4: B:459:0x0b2b->B:461:0x0b31} */
    /* JADX WARNING: Removed duplicated region for block: B:479:? A:{SYNTHETIC, RETURN} */
    /* JADX WARNING: Removed duplicated region for block: B:464:0x0b6a  */
    /* JADX WARNING: Removed duplicated region for block: B:145:0x033a  */
    /* JADX WARNING: Removed duplicated region for block: B:144:0x030f  */
    /* JADX WARNING: Removed duplicated region for block: B:150:0x0350  */
     ...
     */
    /* JADX WARNING: Missing block: B:419:0x0a29, code skipped:
            if (r53.size() == 1) goto L_0x0a32;
     */
    /* JADX WARNING: Missing block: B:438:0x0a6f, code skipped:
            if (r11 == (r20 - 1)) goto L_0x0a74;
     */
    static /* synthetic */ void lambda$prepareSendingMedia$63(java.util.ArrayList r53, long r54, int r56, boolean r57, boolean r58, org.telegram.messenger.MessageObject r59, org.telegram.messenger.MessageObject r60, androidx.core.view.inputmethod.InputContentInfoCompat r61) {
        /*
        r1 = r53;
        r14 = r54;
        r13 = r56;
    ...
    L_0x014d:
        ...
        r5 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$TY9aOb7aeyFhqWsPKbd7o8zCP-o;
    ...
    L_0x035b:
        r7.put(r3, r0);
    L_0x035e:
        r0 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$FEI9NpqFFi9VBzbZvdN8Ccx7XJA;
        r2 = r0;
        r3 = r59;
        r11 = r36;
        r4 = r56;
    ...
    L_0x0499:
        ...
        r8.put(r4, r3);
        r11 = 10;
        if (r2 == r11) goto L_0x04bf;
    L_0x04b5:
        r3 = r20 + -1;
        r11 = r43;
        if (r11 != r3) goto L_0x04bc;
    L_0x04bb:
        goto L_0x04c1;
    L_0x04bc:
        r22 = r2;
    ...
    L_0x04cd:
        ...
        r11 = r43;
    L_0x04d1:
        r21 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$bbGr2Hpgnu2is3Sf6gpH4E4chEg;
        r2 = r21;
        r3 = r59;
        r4 = r56;
        r45 = r6;
    ...
    L_0x0764:
        ...
        r5 = r11;
        r6 = 10;
        if (r5 == r6) goto L_0x078e;
    L_0x0784:
        r6 = r20 + -1;
        r11 = r48;
        if (r11 != r6) goto L_0x078b;
    L_0x078a:
        goto L_0x0790;
    L_0x078b:
        r22 = r5;
    ...
    L_0x079c:
        ...
        r11 = r48;
    L_0x07a0:
        r21 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$Os_hFoakwia_R62-A2sPxAENsvo;
        r5 = r1;
        r2 = r21;
        r51 = r5;
        r5 = r59;
    ...
    L_0x091f:
        r0 = r2.sync;	 Catch:{ Exception -> 0x0925 }
        r0.await();	 Catch:{ Exception -> 0x0925 }
        goto L_0x0929;
    L_0x0925:
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);
    ...
    L_0x0a1f:
        r8.put(r11, r1);
    L_0x0a22:
        if (r58 == 0) goto L_0x0a31;
    L_0x0a24:
        r0 = r53.size();	 Catch:{ Exception -> 0x0a2e }
        r1 = 1;
    ...
    L_0x0a31:
        r1 = 1;
    L_0x0a32:
        r0 = r7.sizes;	 Catch:{ Exception -> 0x0a48 }
        r2 = org.telegram.messenger.AndroidUtilities.getPhotoSize();	 Catch:{ Exception -> 0x0a48 }
        r0 = org.telegram.messenger.FileLoader.getClosestPhotoSizeWithSize(r0, r2);	 Catch:{ Exception -> 0x0a48 }
        if (r0 == 0) goto L_0x0a2c;
    L_0x0a3e:
        r10 = 0;
        r0 = getKeyForPhotoSize(r0, r3, r10);	 Catch:{ Exception -> 0x0a46 }
        r4[r10] = r0;	 Catch:{ Exception -> 0x0a46 }
        goto L_0x0a4d;
    L_0x0a46:
        r0 = move-exception;
        goto L_0x0a4a;
    ...
    L_0x0a7e:
        ...
        r0 = r22;
    L_0x0a84:
        r22 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$M7CzdagvPTvoV-_4PfcXK58t2Pc;
        r2 = r22;
        r26 = r5;
        r5 = r59;
        r6 = r56;
    ...
    L_0x0b10:
        r0 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$qXSAXwSZ5y7OeDOMylgcpcvrVQE;
        r13 = r56;
        r0.<init>(r13, r2);
        org.telegram.messenger.AndroidUtilities.runOnUIThread(r0);
        goto L_0x0b1d;
    ...
    L_0x0b84:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.SendMessagesHelper.lambda$prepareSendingMedia$63(java.util.ArrayList, long, int, boolean, boolean, org.telegram.messenger.MessageObject, org.telegram.messenger.MessageObject, androidx.core.view.inputmethod.InputContentInfoCompat):void");
    }

    static /* synthetic */ void lambda$null$57(MediaSendPrepareWorker mediaSendPrepareWorker, int i, SendingMediaInfo sendingMediaInfo, boolean z) {
    ...
    static /* synthetic */ void lambda$null$58(MessageObject messageObject, int i, TL_document tL_document, String str, HashMap hashMap, String str2, long j, MessageObject messageObject2, SendingMediaInfo sendingMediaInfo) {
    ...
    static /* synthetic */ void lambda$null$59(MessageObject messageObject, int i, TL_photo tL_photo, boolean z, SendingMediaInfo sendingMediaInfo, HashMap hashMap, String str, long j, MessageObject messageObject2) {
        SendingMediaInfo sendingMediaInfo2 = sendingMediaInfo;
        String str2 = null;
        if (messageObject != null) {
            SendMessagesHelper instance = getInstance(i);
    ...
    static /* synthetic */ void lambda$null$60(Bitmap bitmap, String str, MessageObject messageObject, int i, VideoEditedInfo videoEditedInfo, TL_document tL_document, String str2, HashMap hashMap, String str3, long j, MessageObject messageObject2, SendingMediaInfo sendingMediaInfo) {
    ...
    static /* synthetic */ void lambda$null$61(Bitmap[] bitmapArr, String[] strArr, MessageObject messageObject, int i, TL_photo tL_photo, HashMap hashMap, String str, long j, MessageObject messageObject2, SendingMediaInfo sendingMediaInfo) {
        SendingMediaInfo sendingMediaInfo2 = sendingMediaInfo;
    ...
    static /* synthetic */ void lambda$null$62(int i, long j) {
        SendMessagesHelper instance = getInstance(i);
    ...
    L_0x0013:
        ...
        r6.f444w = r1;	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
    L_0x0019:
        r1 = 19;
        r1 = r2.extractMetadata(r1);	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
    ...
    L_0x0021:
        r1 = java.lang.Integer.parseInt(r1);	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
        r6.f443h = r1;	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
    L_0x0027:
        r1 = 9;
        r1 = r2.extractMetadata(r1);	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
    ...
    L_0x0060:
        r7 = r6.f444w;	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
        r1 = r6.f443h;	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
        r6.f444w = r1;	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
        r6.f443h = r7;	 Catch:{ Exception -> 0x0074, all -> 0x0072 }
    L_0x0068:
        r7 = 1;
    ...
    L_0x007a:
        r7 = move-exception;
    L_0x007b:
        org.telegram.messenger.FileLog.m30e(r7);	 Catch:{ all -> 0x0077 }
    ...
    L_0x009c:
        ...
        r6.f444w = r7;	 Catch:{ Exception -> 0x00ba }
        r7 = r5.getVideoHeight();	 Catch:{ Exception -> 0x00ba }
        r6.f443h = r7;	 Catch:{ Exception -> 0x00ba }
    ...
    private static org.telegram.messenger.VideoEditedInfo createCompressionSettings(java.lang.String r16) {
        ...
        r2 = 9;
        r2 = new int[r2];
        org.telegram.p004ui.Components.AnimatedFileDrawable.getVideoInfo(r0, r2);
        r3 = 0;
        r3 = r2[r3];
        r4 = 0;
    ...
    L_0x0047:
        ...
        org.telegram.messenger.FileLog.m27d(r0);	 Catch:{ Exception -> 0x00b2 }
    L_0x004c:
        return r4;
    L_0x004d:
    ...
    L_0x0120:
        ...
        r3 = 1151336448; // 0x44a00000 float:1280.0 double:5.68835786E-315;
        goto L_0x0134;
    L_0x0126:
        r3 = 1146355712; // 0x44540000 float:848.0 double:5.66374975E-315;
        r15 = 1100000; // 0x10c8e0 float:1.541428E-39 double:5.43472E-318;
        goto L_0x0134;
    L_0x012c:
        r3 = 1142947840; // 0x44200000 float:640.0 double:5.646912627E-315;
        goto L_0x0134;
    L_0x012f:
        r3 = 1138229248; // 0x43d80000 float:432.0 double:5.623599685E-315;
    ...
    public static void prepareSendingVideo(String str, long j, long j2, int i, int i2, VideoEditedInfo videoEditedInfo, long j3, MessageObject messageObject, CharSequence charSequence, ArrayList<MessageEntity> arrayList, int i3, MessageObject messageObject2) {
        if (str != null && str.length() != 0) {
            C0989-$$Lambda$SendMessagesHelper$ZxDs0vXJa1NnG2Mq0H0o0iqTbfM c0989-$$Lambda$SendMessagesHelper$ZxDs0vXJa1NnG2Mq0H0o0iqTbfM = r0;
            C0989-$$Lambda$SendMessagesHelper$ZxDs0vXJa1NnG2Mq0H0o0iqTbfM c0989-$$Lambda$SendMessagesHelper$ZxDs0vXJa1NnG2Mq0H0o0iqTbfM2 = new C0989-$$Lambda$SendMessagesHelper$ZxDs0vXJa1NnG2Mq0H0o0iqTbfM(videoEditedInfo, str, j3, j2, i3, UserConfig.selectedAccount, i2, i, j, charSequence, messageObject2, messageObject, arrayList);
            new Thread(c0989-$$Lambda$SendMessagesHelper$ZxDs0vXJa1NnG2Mq0H0o0iqTbfM).start();
        }
    }
    ...
    static /* synthetic */ void lambda$prepareSendingVideo$65(org.telegram.messenger.VideoEditedInfo r26, java.lang.String r27, long r28, long r30, int r32, int r33, int r34, int r35, long r36, java.lang.CharSequence r38, org.telegram.messenger.MessageObject r39, org.telegram.messenger.MessageObject r40, java.util.ArrayList r41) {
        /*
        r7 = r27;
        r10 = r28;
        r8 = r30;
    ...
    L_0x0314:
        ...
        r8.put(r3, r0);
    L_0x0319:
        r16 = new org.telegram.messenger.-$$Lambda$SendMessagesHelper$bp8HVomUFdAeb6cvfbrX2jU2GRM;
        r0 = r16;
        r3 = r39;
        r4 = r33;
        r5 = r14;
    ...
    L_0x0332:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.SendMessagesHelper.lambda$prepareSendingVideo$65(org.telegram.messenger.VideoEditedInfo, java.lang.String, long, long, int, int, int, int, long, java.lang.CharSequence, org.telegram.messenger.MessageObject, org.telegram.messenger.MessageObject, java.util.ArrayList):void");
    }

    static /* synthetic */ void lambda$null$64(Bitmap bitmap, String str, MessageObject messageObject, int i, VideoEditedInfo videoEditedInfo, TL_document tL_document, String str2, HashMap hashMap, String str3, long j, MessageObject messageObject2, String str4, ArrayList arrayList, int i2) {
        Bitmap bitmap2 = bitmap;
        String str5 = str;
