...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    /* renamed from: org.telegram.ui.DataAutoDownloadActivity$PresetChooseView */
    private class PresetChooseView extends View {
        ...
        public PresetChooseView(Context context) {
            ...
            this.low = LocaleController.getString("AutoDownloadLow", C1067R.string.AutoDownloadLow);
            this.lowSize = (int) Math.ceil((double) this.textPaint.measureText(this.low));
            this.medium = LocaleController.getString("AutoDownloadMedium", C1067R.string.AutoDownloadMedium);
            this.mediumSize = (int) Math.ceil((double) this.textPaint.measureText(this.medium));
            this.high = LocaleController.getString("AutoDownloadHigh", C1067R.string.AutoDownloadHigh);
            this.highSize = (int) Math.ceil((double) this.textPaint.measureText(this.high));
            this.custom = LocaleController.getString("AutoDownloadCustom", C1067R.string.AutoDownloadCustom);
        ...
        public void onMeasure(int i, int i2) {
            super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(74.0f), 1073741824));
            MeasureSpec.getSize(i);
            this.circleSize = AndroidUtilities.m26dp(6.0f);
            this.gapSize = AndroidUtilities.m26dp(2.0f);
            this.sideSide = AndroidUtilities.m26dp(22.0f);
        ...
        public void onDraw(Canvas canvas) {
            ...
            int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m26dp(11.0f);
            int i = 0;
            while (i < DataAutoDownloadActivity.this.presets.size()) {
                String str;
                ...
                canvas.drawCircle((float) i2, (float) measuredHeight, (float) (i == DataAutoDownloadActivity.this.selectedPreset ? AndroidUtilities.m26dp(6.0f) : this.circleSize / 2), this.paint);
                if (i != 0) {
                    ...
                    if (i == DataAutoDownloadActivity.this.selectedPreset || i == DataAutoDownloadActivity.this.selectedPreset + 1) {
                        i4 -= AndroidUtilities.m26dp(3.0f);
                    }
                    if (i == DataAutoDownloadActivity.this.selectedPreset + 1) {
                        i3 += AndroidUtilities.m26dp(3.0f);
                    }
                    canvas.drawRect((float) i3, (float) (measuredHeight - AndroidUtilities.m26dp(1.0f)), (float) (i3 + i4), (float) (AndroidUtilities.m26dp(1.0f) + measuredHeight), this.paint);
                }
                ...
                if (i == 0) {
                    canvas.drawText(str, (float) AndroidUtilities.m26dp(22.0f), (float) AndroidUtilities.m26dp(28.0f), this.textPaint);
                } else if (i == DataAutoDownloadActivity.this.presets.size() - 1) {
                    canvas.drawText(str, (float) ((getMeasuredWidth() - i4) - AndroidUtilities.m26dp(22.0f)), (float) AndroidUtilities.m26dp(28.0f), this.textPaint);
                } else {
                    canvas.drawText(str, (float) (i2 - (i4 / 2)), (float) AndroidUtilities.m26dp(28.0f), this.textPaint);
                }
                i++;
            }
        }
    ...
    class C41631 extends ActionBarMenuOnItemClick {
        C41631() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        L_0x0013:
            r14 = r14.itemView;
            r14 = (org.telegram.p004ui.Cells.TextInfoPrivacyCell) r14;
            r0 = org.telegram.p004ui.DataAutoDownloadActivity.this;
        ...
        L_0x0024:
            r15 = 2131558740; // 0x7f0d0154 float:1.8742804E38 double:1.0531299455E-314;
            r0 = "AutoDownloadAudioInfo";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            r15 = r13.mContext;
            r15 = org.telegram.p004ui.ActionBar.Theme.getThemedDrawable(r15, r4, r5);
        ...
        L_0x0046:
            r15 = org.telegram.p004ui.DataAutoDownloadActivity.this;
        ...
        L_0x004f:
            ...
            r15 = org.telegram.p004ui.ActionBar.Theme.getThemedDrawable(r15, r0, r5);
            r14.setBackgroundDrawable(r15);
            r15 = org.telegram.p004ui.DataAutoDownloadActivity.this;
            r15 = r15.currentType;
            if (r15 != 0) goto L_0x0071;
        L_0x0063:
            r15 = 2131558759; // 0x7f0d0167 float:1.8742843E38 double:1.053129955E-314;
        ...
        L_0x0079:
            r15 = 2131558764; // 0x7f0d016c float:1.8742853E38 double:1.0531299574E-314;
        ...
        L_0x008f:
            r15 = 2131558761; // 0x7f0d0169 float:1.8742847E38 double:1.053129956E-314;
        ...
        L_0x00b1:
            r14 = r14.itemView;
            r5 = r14;
            r5 = (org.telegram.p004ui.Cells.NotificationsCheckCell) r5;
            r14 = org.telegram.p004ui.DataAutoDownloadActivity.this;
            r14 = r14.photosRow;
            if (r15 != r14) goto L_0x00ca;
        L_0x00be:
            r14 = 2131558765; // 0x7f0d016d float:1.8742855E38 double:1.053129958E-314;
        ...
        L_0x00d2:
            r14 = 2131558775; // 0x7f0d0177 float:1.8742875E38 double:1.053129963E-314;
            ...
            goto L_0x00ea;
        L_0x00de:
            r14 = 2131558745; // 0x7f0d0159 float:1.8742814E38 double:1.053129948E-314;
        ...
        L_0x0153:
            goto L_0x0187;
        L_0x0154:
            r11 = 2131558741; // 0x7f0d0155 float:1.8742806E38 double:1.053129946E-314;
            r12 = "AutoDownloadChannels";
            r11 = org.telegram.messenger.LocaleController.getString(r12, r11);
            r8.append(r11);
            goto L_0x0187;
        L_0x0161:
            r11 = 2131558748; // 0x7f0d015c float:1.874282E38 double:1.0531299495E-314;
            r12 = "AutoDownloadGroups";
            r11 = org.telegram.messenger.LocaleController.getString(r12, r11);
            r8.append(r11);
            goto L_0x0187;
        L_0x016e:
            r11 = 2131558768; // 0x7f0d0170 float:1.8742861E38 double:1.0531299594E-314;
            r12 = "AutoDownloadPm";
            r11 = org.telegram.messenger.LocaleController.getString(r12, r11);
            r8.append(r11);
            goto L_0x0187;
        L_0x017b:
            r11 = 2131558742; // 0x7f0d0156 float:1.8742808E38 double:1.0531299465E-314;
        ...
        L_0x0199:
            r14 = 2131558756; // 0x7f0d0164 float:1.8742837E38 double:1.0531299534E-314;
            r0 = "AutoDownloadOnAllChats";
            r14 = org.telegram.messenger.LocaleController.getString(r0, r14);
            r8.append(r14);
            goto L_0x01ca;
        L_0x01a6:
            r14 = 2131558774; // 0x7f0d0176 float:1.8742873E38 double:1.0531299623E-314;
        ...
        L_0x01be:
            r14 = 2131558755; // 0x7f0d0163 float:1.8742835E38 double:1.053129953E-314;
            r0 = "AutoDownloadOff";
            r14 = org.telegram.messenger.LocaleController.getString(r0, r14);
            r8.append(r14);
        L_0x01ca:
        ...
        L_0x01d4:
            ...
            r0 = 2131558757; // 0x7f0d0165 float:1.8742839E38 double:1.053129954E-314;
        ...
        L_0x01eb:
            r14 = new java.lang.StringBuilder;
            r0 = 2131558762; // 0x7f0d016a float:1.8742849E38 double:1.0531299564E-314;
        ...
        L_0x0230:
            r14 = r14.itemView;
            r14 = (org.telegram.p004ui.Cells.HeaderCell) r14;
            r0 = org.telegram.p004ui.DataAutoDownloadActivity.this;
            r0 = r0.usageHeaderRow;
            if (r15 != r0) goto L_0x0249;
        L_0x023c:
            r15 = 2131558744; // 0x7f0d0158 float:1.8742812E38 double:1.0531299475E-314;
        ...
        L_0x0249:
            ...
            if (r15 != r0) goto L_0x02a8;
        L_0x0251:
            r15 = 2131558773; // 0x7f0d0175 float:1.8742871E38 double:1.053129962E-314;
        ...
        L_0x025e:
            r14 = r14.itemView;
            r14 = (org.telegram.p004ui.Cells.TextCheckCell) r14;
            r0 = org.telegram.p004ui.DataAutoDownloadActivity.this;
            r0 = r0.autoDownloadRow;
            if (r15 != r0) goto L_0x02a8;
        L_0x026a:
            r14.setDrawCheckRipple(r2);
            r15 = 2131558753; // 0x7f0d0161 float:1.874283E38 double:1.053129952E-314;
        ...
        L_0x02a0:
            r0 = r1;
        L_0x02a1:
            r15 = org.telegram.p004ui.ActionBar.Theme.getColor(r0);
            r14.setBackgroundColor(r15);
        L_0x02a8:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.DataAutoDownloadActivity$ListAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                if (i == 2) {
                    ...
                    textCheckCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                }
            } else {
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnMobileData", C1067R.string.AutoDownloadOnMobileData));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnWiFiData", C1067R.string.AutoDownloadOnWiFiData));
        } else if (i == 2) {
            this.actionBar.setTitle(LocaleController.getString("AutoDownloadOnRoamingData", C1067R.string.AutoDownloadOnRoamingData));
        }
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setActionBarMenuOnItemClick(new C41631());
        ...
        this.listView.setOnItemClickListener(new C3677-$$Lambda$DataAutoDownloadActivity$z-MZui0AcXTnHUC_YO0Sopv_aSo(this));
    ...
    L_0x0032:
        r0 = r11;
        r0 = (org.telegram.p004ui.Cells.TextCheckCell) r0;
        r2 = r0.isChecked();
    ...
    L_0x0148:
        r0 = r11;
        r0 = (org.telegram.p004ui.Cells.NotificationsCheckCell) r0;
        r1 = r0.isChecked();
        r2 = org.telegram.messenger.LocaleController.isRTL;
        r3 = 1117257728; // 0x42980000 float:76.0 double:5.51998661E-315;
    ...
    L_0x0261:
        r1 = 2131558767; // 0x7f0d016f float:1.874286E38 double:1.053129959E-314;
    ...
    L_0x0272:
        r1 = 2131558777; // 0x7f0d0179 float:1.874288E38 double:1.053129964E-314;
        r2 = "AutoDownloadVideosTitle";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setText(r1);
        goto L_0x028b;
    L_0x027f:
        r1 = 2131558747; // 0x7f0d015b float:1.8742819E38 double:1.053129949E-314;
    ...
    L_0x028b:
        ...
        r2 = -1;
        r1 = org.telegram.p004ui.Components.LayoutHelper.createFrame(r2, r1);
        r3.addView(r0, r1);
        r1 = new org.telegram.p004ui.Cells.MaxFileSizeCell[r15];
        r0 = new org.telegram.p004ui.Cells.TextCheckCell[r15];
        r13 = new android.animation.AnimatorSet[r15];
        r9 = new org.telegram.p004ui.Cells.TextCheckBoxCell[r10];
    L_0x029d:
    ...
    L_0x02ac:
        r10 = r9[r14];
        r15 = 2131558797; // 0x7f0d018d float:1.874292E38 double:1.0531299737E-314;
        r22 = r0;
    ...
    L_0x02d7:
        r0 = r9[r14];
        r10 = 2131558799; // 0x7f0d018f float:1.8742924E38 double:1.0531299747E-314;
    ...
    L_0x02f4:
        r0 = r9[r14];
        r1 = 2131558798; // 0x7f0d018e float:1.8742922E38 double:1.053129974E-314;
    ...
    L_0x0313:
        r0 = r9[r14];
        r1 = 2131558796; // 0x7f0d018c float:1.8742918E38 double:1.053129973E-314;
    ...
    L_0x0333:
        r0 = r9[r14];
        r1 = 0;
        r10 = org.telegram.p004ui.ActionBar.Theme.getSelectorDrawable(r1);
        ...
        r1 = org.telegram.p004ui.Components.LayoutHelper.createFrame(r11, r1);
        r7 = r24;
        r7.addView(r0, r1);
        r14 = r14 + 1;
        r11 = r30;
    ...
    L_0x039a:
        ...
        r1 = r22[r0];
        r3 = 50;
        r3 = org.telegram.p004ui.Components.LayoutHelper.createLinear(r11, r3);
        r7.addView(r1, r3);
        ...
        r0 = org.telegram.p004ui.ActionBar.Theme.getThemedDrawable(r0, r1, r3);
        ...
        r0 = org.telegram.p004ui.Components.LayoutHelper.createLinear(r11, r10);
        r7.addView(r15, r0);
        r0 = r12.videosRow;
    ...
    L_0x0424:
        r0 = 0;
        r1 = r22[r0];
        r3 = 2131558752; // 0x7f0d0160 float:1.8742829E38 double:1.0531299515E-314;
        r4 = "AutoDownloadMaxVideoSize";
        r3 = org.telegram.messenger.LocaleController.getString(r4, r3);
        r1.setText(r3);
        r1 = r6[r0];
        r3 = 2131558771; // 0x7f0d0173 float:1.8742867E38 double:1.053129961E-314;
        r4 = "AutoDownloadPreloadVideo";
        r3 = org.telegram.messenger.LocaleController.getString(r4, r3);
        r4 = r2.preloadVideo;
        r1.setTextAndCheck(r3, r4, r0);
        r1 = 2131558772; // 0x7f0d0174 float:1.874287E38 double:1.0531299613E-314;
        r3 = 1;
    ...
    L_0x045e:
        r0 = 0;
        r1 = r22[r0];
        r3 = 2131558751; // 0x7f0d015f float:1.8742827E38 double:1.053129951E-314;
        r4 = "AutoDownloadMaxFileSize";
        r3 = org.telegram.messenger.LocaleController.getString(r4, r3);
        r1.setText(r3);
        r1 = r6[r0];
        r3 = 2131558769; // 0x7f0d0171 float:1.8742863E38 double:1.05312996E-314;
        r4 = "AutoDownloadPreloadMusic";
        r3 = org.telegram.messenger.LocaleController.getString(r4, r3);
        r4 = r2.preloadMusic;
        r1.setTextAndCheck(r3, r4, r0);
        r1 = 2131558770; // 0x7f0d0172 float:1.8742865E38 double:1.0531299603E-314;
    ...
    L_0x04e1:
        ...
        r1 = 52;
        r2 = -1;
        r1 = org.telegram.p004ui.Components.LayoutHelper.createLinear(r2, r1);
        r7.addView(r0, r1);
        ...
        r1.setTypeface(r3);
        r3 = 2131558891; // 0x7f0d01eb float:1.874311E38 double:1.05313002E-314;
        r4 = "Cancel";
        r3 = org.telegram.messenger.LocaleController.getString(r4, r3);
        r3 = r3.toUpperCase();
        r1.setText(r3);
        ...
        r5 = 51;
        r7 = -2;
        r4 = org.telegram.p004ui.Components.LayoutHelper.createFrame(r7, r4, r5);
        r0.addView(r1, r4);
        ...
        r14.setTypeface(r1);
        r1 = 2131560626; // 0x7f0d08b2 float:1.874663E38 double:1.0531308773E-314;
        r2 = "Save";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r1 = r1.toUpperCase();
        r14.setText(r1);
        r1 = org.telegram.messenger.AndroidUtilities.m26dp(r3);
        r2 = org.telegram.messenger.AndroidUtilities.m26dp(r3);
        r3 = 0;
    ...
    L_0x05d1:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.DataAutoDownloadActivity.lambda$createView$4$DataAutoDownloadActivity(android.view.View, int, float, float):void");
    }
    ...
    private void fillPresets() {
        ...
        Collections.sort(this.presets, C1482-$$Lambda$DataAutoDownloadActivity$E0PVxdOLHPC3ZjO_nDkt8nGBYVw.INSTANCE);
        RecyclerListView recyclerListView = this.listView;
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        themeDescriptionArr[0] = new ThemeDescription(this.listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{HeaderCell.class, NotificationsCheckCell.class, PresetChooseView.class}, null, null, null, Theme.key_windowBackgroundWhite);
        ...
        themeDescriptionArr[11] = new ThemeDescription(this.listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR | ThemeDescription.FLAG_CHECKTAG, new Class[]{TextCheckCell.class}, null, null, null, Theme.key_windowBackgroundChecked);
        themeDescriptionArr[12] = new ThemeDescription(this.listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR | ThemeDescription.FLAG_CHECKTAG, new Class[]{TextCheckCell.class}, null, null, null, Theme.key_windowBackgroundUnchecked);
        themeDescriptionArr[13] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundCheckText);
        view = this.listView;
        clsArr = new Class[]{TextCheckCell.class};
        strArr = new String[1];
        strArr[0] = "checkBox";
        themeDescriptionArr[14] = new ThemeDescription(view, 0, clsArr, strArr, null, null, null, Theme.key_switchTrackBlue);
        themeDescriptionArr[15] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackBlueChecked);
        themeDescriptionArr[16] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackBlueThumb);
        themeDescriptionArr[17] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackBlueThumbChecked);
        themeDescriptionArr[18] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackBlueSelector);
        themeDescriptionArr[19] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackBlueSelectorChecked);
        themeDescriptionArr[20] = new ThemeDescription(this.listView, 0, new Class[]{NotificationsCheckCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        themeDescriptionArr[21] = new ThemeDescription(this.listView, 0, new Class[]{NotificationsCheckCell.class}, new String[]{"valueTextView"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText2);
        themeDescriptionArr[22] = new ThemeDescription(this.listView, 0, new Class[]{NotificationsCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrack);
        themeDescriptionArr[23] = new ThemeDescription(this.listView, 0, new Class[]{NotificationsCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackChecked);
        ...
        themeDescriptionArr[26] = new ThemeDescription(this.listView, 0, new Class[]{PresetChooseView.class}, null, null, null, Theme.key_switchTrack);
        themeDescriptionArr[27] = new ThemeDescription(this.listView, 0, new Class[]{PresetChooseView.class}, null, null, null, Theme.key_switchTrackChecked);
        themeDescriptionArr[28] = new ThemeDescription(this.listView, 0, new Class[]{PresetChooseView.class}, null, null, null, Theme.key_windowBackgroundWhiteGrayText);
