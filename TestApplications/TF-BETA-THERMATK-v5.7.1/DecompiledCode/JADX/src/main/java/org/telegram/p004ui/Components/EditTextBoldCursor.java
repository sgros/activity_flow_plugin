...
public class EditTextBoldCursor extends EditText {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x0054 A:{Catch:{ Throwable -> 0x00c2 }} */
    /* JADX WARNING: Removed duplicated region for block: B:26:0x00e4 A:{Catch:{ Throwable -> 0x00f0 }} */
    ...
    L_0x004f:
        r2 = 0;
        r5 = editorClass;	 Catch:{ Throwable -> 0x00c2 }
        if (r5 != 0) goto L_0x00c6;
    L_0x0054:
        r5 = android.widget.TextView.class;
        r6 = "mEditor";
        r5 = r5.getDeclaredField(r6);	 Catch:{ Throwable -> 0x00c2 }
        mEditor = r5;	 Catch:{ Throwable -> 0x00c2 }
        r5 = mEditor;	 Catch:{ Throwable -> 0x00c2 }
        r5.setAccessible(r3);	 Catch:{ Throwable -> 0x00c2 }
        r5 = "android.widget.Editor";
        r5 = java.lang.Class.forName(r5);	 Catch:{ Throwable -> 0x00c2 }
        editorClass = r5;	 Catch:{ Throwable -> 0x00c2 }
        r5 = editorClass;	 Catch:{ Throwable -> 0x00c2 }
        r5 = r5.getDeclaredField(r1);	 Catch:{ Throwable -> 0x00c2 }
        mShowCursorField = r5;	 Catch:{ Throwable -> 0x00c2 }
        r5 = mShowCursorField;	 Catch:{ Throwable -> 0x00c2 }
        r5.setAccessible(r3);	 Catch:{ Throwable -> 0x00c2 }
        r5 = android.os.Build.VERSION.SDK_INT;	 Catch:{ Throwable -> 0x00c2 }
        r6 = 28;
    ...
    L_0x007f:
        ...
        r6 = "mCursorDrawable";
        r5 = r5.getDeclaredField(r6);	 Catch:{ Throwable -> 0x00c2 }
        mCursorDrawableField = r5;	 Catch:{ Throwable -> 0x00c2 }
        r5 = mCursorDrawableField;	 Catch:{ Throwable -> 0x00c2 }
        r5.setAccessible(r3);	 Catch:{ Throwable -> 0x00c2 }
    L_0x008e:
        r5 = android.widget.TextView.class;
        r6 = new java.lang.Class[r3];	 Catch:{ Throwable -> 0x00c2 }
        r7 = java.lang.Boolean.TYPE;	 Catch:{ Throwable -> 0x00c2 }
        r6[r2] = r7;	 Catch:{ Throwable -> 0x00c2 }
        r5 = r5.getDeclaredMethod(r0, r6);	 Catch:{ Throwable -> 0x00c2 }
        getVerticalOffsetMethod = r5;	 Catch:{ Throwable -> 0x00c2 }
        r5 = getVerticalOffsetMethod;	 Catch:{ Throwable -> 0x00c2 }
        r5.setAccessible(r3);	 Catch:{ Throwable -> 0x00c2 }
        r5 = editorClass;	 Catch:{ Throwable -> 0x00c2 }
        r1 = r5.getDeclaredField(r1);	 Catch:{ Throwable -> 0x00c2 }
        mShowCursorField = r1;	 Catch:{ Throwable -> 0x00c2 }
        r1 = mShowCursorField;	 Catch:{ Throwable -> 0x00c2 }
        r1.setAccessible(r3);	 Catch:{ Throwable -> 0x00c2 }
        r1 = android.widget.TextView.class;
        r5 = new java.lang.Class[r3];	 Catch:{ Throwable -> 0x00c2 }
        r6 = java.lang.Boolean.TYPE;	 Catch:{ Throwable -> 0x00c2 }
        r5[r2] = r6;	 Catch:{ Throwable -> 0x00c2 }
        r0 = r1.getDeclaredMethod(r0, r5);	 Catch:{ Throwable -> 0x00c2 }
        getVerticalOffsetMethod = r0;	 Catch:{ Throwable -> 0x00c2 }
        r0 = getVerticalOffsetMethod;	 Catch:{ Throwable -> 0x00c2 }
    ...
    L_0x00c6:
        r0 = new android.graphics.drawable.GradientDrawable;	 Catch:{ Throwable -> 0x00f0 }
        r1 = android.graphics.drawable.GradientDrawable.Orientation.TOP_BOTTOM;	 Catch:{ Throwable -> 0x00f0 }
        r4 = new int[r4];	 Catch:{ Throwable -> 0x00f0 }
        r5 = -11230757; // 0xffffffffff54a1db float:-2.8263674E38 double:NaN;
        r4[r2] = r5;	 Catch:{ Throwable -> 0x00f0 }
        r4[r3] = r5;	 Catch:{ Throwable -> 0x00f0 }
        r0.<init>(r1, r4);	 Catch:{ Throwable -> 0x00f0 }
        r8.gradientDrawable = r0;	 Catch:{ Throwable -> 0x00f0 }
        r0 = mEditor;	 Catch:{ Throwable -> 0x00f0 }
        r0 = r0.get(r8);	 Catch:{ Throwable -> 0x00f0 }
        r8.editor = r0;	 Catch:{ Throwable -> 0x00f0 }
        r0 = mCursorDrawableField;	 Catch:{ Throwable -> 0x00f0 }
        if (r0 == 0) goto L_0x00f0;
    L_0x00e4:
        r0 = mCursorDrawableResField;	 Catch:{ Throwable -> 0x00f0 }
        r1 = 2131165378; // 0x7f0700c2 float:1.7944971E38 double:1.052935599E-314;
        r1 = java.lang.Integer.valueOf(r1);	 Catch:{ Throwable -> 0x00f0 }
        r0.set(r8, r1);	 Catch:{ Throwable -> 0x00f0 }
    L_0x00f0:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.EditTextBoldCursor.init():void");
    }
    ...
    public void fixHandleView(boolean z) {
        if (z) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new C2722-$$Lambda$qzh_QoBZ7K2XdUWK2VAJcGTe1OY(onPreDrawListener), 500);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.hintLayout != null) {
            this.lineY = ((((float) (getMeasuredHeight() - this.hintLayout.getHeight())) / 2.0f) + ((float) this.hintLayout.getHeight())) + ((float) AndroidUtilities.m26dp(6.0f));
        }
    }

    public void setHintText(String str) {
        this.hintLayout = new StaticLayout(str, getPaint(), AndroidUtilities.m26dp(1000.0f), Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if ((length() == 0 || this.transformHintToHeader) && this.hintLayout != null && (this.hintVisible || this.hintAlpha != 0.0f)) {
            ...
            if (this.supportRtlHint && LocaleController.isRTL) {
                canvas2.translate(((float) (i + getScrollX())) + (((float) getMeasuredWidth()) - lineWidth), (this.lineY - ((float) this.hintLayout.getHeight())) - ((float) AndroidUtilities.m26dp(6.0f)));
            } else {
                canvas2.translate((float) (i + getScrollX()), (this.lineY - ((float) this.hintLayout.getHeight())) - ((float) AndroidUtilities.m26dp(6.0f)));
            }
            if (this.transformHintToHeader) {
                float f;
                float f2 = 1.0f - (this.headerAnimationProgress * 0.3f);
                float f3 = ((float) (-AndroidUtilities.m26dp(22.0f))) * this.headerAnimationProgress;
            ...
            if (this.allowDrawCursor && mShowCursorField != null) {
                ...
                if (this.mCursorDrawable != null) {
                    ...
                    if (obj != null) {
                        ...
                        this.rect.right = bounds.left + AndroidUtilities.m26dp(this.cursorWidth);
        ...
        if (!(this.lineColor == 0 || this.hintLayout == null)) {
            if (!TextUtils.isEmpty(this.errorText)) {
                ...
                extendedPaddingTop = AndroidUtilities.m26dp(2.0f);
            } else if (isFocused()) {
                this.linePaint.setColor(this.activeLineColor);
                extendedPaddingTop = AndroidUtilities.m26dp(2.0f);
            } else {
                this.linePaint.setColor(this.lineColor);
                extendedPaddingTop = AndroidUtilities.m26dp(1.0f);
            }
