...
import org.telegram.p004ui.Cells.BotHelpCell;
import org.telegram.p004ui.Cells.ChatActionCell;
import org.telegram.p004ui.Cells.ChatActionCell.ChatActionCellDelegate;
import org.telegram.p004ui.Cells.ChatLoadingCell;
...
import org.telegram.p004ui.Cells.ChatUnreadCell;
import org.telegram.p004ui.Components.AdminLogFilterAlert;
import org.telegram.p004ui.Components.ChatAvatarContainer;
...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    private PhotoViewerProvider provider = new C39541();
    ...
    class C239411 extends ViewOutlineProvider {
        C239411() {
        }
    ...
    class C239613 extends AnimatorListenerAdapter {
        C239613() {
        }
    ...
    class C239714 implements OnPreDrawListener {
        C239714() {
        }
    ...
    class C39482 extends ActionBarMenuOnItemClick {
        C39482() {
        }
    ...
    class C39493 extends ActionBarMenuItemSearchListener {
        C39493() {
        }
    ...
    class C39517 extends OnScrollListener {
        private final int scrollValue = AndroidUtilities.m26dp(100.0f);
        private float totalDy = 0.0f;

        /* renamed from: org.telegram.ui.ChannelAdminLogActivity$7$1 */
        class C23981 extends AnimatorListenerAdapter {
            C23981() {
            }
        ...
        public void onScrolled(RecyclerView recyclerView, int i, int i2) {
            ...
            if (i2 != 0 && ChannelAdminLogActivity.this.scrollingFloatingDate && !ChannelAdminLogActivity.this.currentFloatingTopIsNotMessage && ChannelAdminLogActivity.this.floatingDateView.getTag() == null) {
                ...
                ChannelAdminLogActivity.this.floatingDateAnimation.addListener(new C23981());
    ...
    public class ChatActivityAdapter extends Adapter {
        ...
        class C39521 implements ChatMessageCellDelegate {
            ...
            public void didPressUserAvatar(ChatMessageCell chatMessageCell, User user, float f, float f2) {
                if (user != null && user.f534id != UserConfig.getInstance(ChannelAdminLogActivity.this.currentAccount).getClientUserId()) {
                    Bundle bundle = new Bundle();
                    bundle.putInt("user_id", user.f534id);
                    ChannelAdminLogActivity.this.addCanBanUser(bundle, user.f534id);
            ...
            public void didPressUrl(MessageObject messageObject, CharacterStyle characterStyle, boolean z) {
                if (characterStyle != null) {
                    if (characterStyle instanceof URLSpanMono) {
                        ...
                        Toast.makeText(ChannelAdminLogActivity.this.getParentActivity(), LocaleController.getString("TextCopied", C1067R.string.TextCopied), 0).show();
                        ...
                        if (z) {
                            ...
                            builder.setItems(new CharSequence[]{LocaleController.getString("Open", C1067R.string.Open), LocaleController.getString("Copy", C1067R.string.Copy)}, new C1266x313c0559(this, url2));
            ...
            public /* synthetic */ void mo15652xec69434e(String str, DialogInterface dialogInterface, int i) {
                if (i == 0) {
     ...
     */
            public void didPressImage(org.telegram.p004ui.Cells.ChatMessageCell r9, float r10, float r11) {
                /*
                r8 = this;
            ...
            L_0x000a:
                r9 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;
                r9 = org.telegram.p004ui.ChannelAdminLogActivity.this;
                r10 = new org.telegram.ui.Components.StickersAlert;
                r3 = r9.getParentActivity();
                r11 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;
                r4 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            ...
            L_0x007e:
                ...
                r10 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;	 Catch:{ Exception -> 0x00a9 }
                r10 = org.telegram.p004ui.ChannelAdminLogActivity.this;	 Catch:{ Exception -> 0x00a9 }
            ...
            L_0x00c0:
                ...
                r10 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;
                r10 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            ...
            L_0x0114:
                r11 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;
                r11 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            ...
            L_0x011f:
                ...
                r2 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;
                r2 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            ...
            L_0x013a:
                ...
                r11 = (org.telegram.p004ui.Components.RecyclerListView.Holder) r11;
            ...
            L_0x017e:
                ...
                r10 = org.telegram.p004ui.ActionBar.Theme.applyThemeFile(r9, r11, r10);
            ...
            L_0x019c:
                r9 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;	 Catch:{ Exception -> 0x01a8 }
                r9 = org.telegram.p004ui.ChannelAdminLogActivity.this;	 Catch:{ Exception -> 0x01a8 }
            ...
            L_0x01a8:
                ...
                goto L_0x01d2;
            L_0x01b0:
                r9 = org.telegram.p004ui.PhotoViewer.getInstance();
                r10 = org.telegram.p004ui.ChannelAdminLogActivity.ChatActivityAdapter.this;
                r10 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            ...
            L_0x01d2:
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChannelAdminLogActivity$ChatActivityAdapter$C39521.didPressImage(org.telegram.ui.Cells.ChatMessageCell, float, float):void");
            }
        ...
        class C39532 implements ChatActionCellDelegate {
        ...
        public /* synthetic */ void mo15653xd4cdd41c(String str) {
            if (str.startsWith("@")) {
     ...
     */
        ...
        L_0x0006:
            r11 = r11.itemView;
            r11 = (org.telegram.p004ui.Cells.ChatLoadingCell) r11;
            r12 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            r12 = r12.loadsCount;
        ...
        L_0x001c:
            ...
            if (r12 >= r0) goto L_0x00e9;
        L_0x0020:
            r0 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            r0 = r0.messages;
            r3 = r0.size();
            ...
            r3 = r11.itemView;
            r4 = r3 instanceof org.telegram.p004ui.Cells.ChatMessageCell;
            if (r4 == 0) goto L_0x00db;
        L_0x003a:
            r3 = (org.telegram.p004ui.Cells.ChatMessageCell) r3;
            r3.isChat = r2;
            r4 = r12 + 1;
        ...
        L_0x005a:
            r5 = org.telegram.p004ui.ChannelAdminLogActivity.this;
            r5 = r5.messages;
            r7 = r5.size();
        ...
        L_0x00d0:
            ...
            goto L_0x00e9;
        L_0x00db:
            r11 = r3 instanceof org.telegram.p004ui.Cells.ChatActionCell;
            if (r11 == 0) goto L_0x00e9;
        L_0x00df:
            r3 = (org.telegram.p004ui.Cells.ChatActionCell) r3;
        ...
        L_0x00e9:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChannelAdminLogActivity$ChatActivityAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    class C39541 extends EmptyPhotoViewerProvider {
        C39541() {
        }
    ...
    private void updateEmptyPlaceholder() {
        if (this.emptyView != null) {
            if (!TextUtils.isEmpty(this.searchQuery)) {
                this.emptyView.setPadding(AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(5.0f), AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(5.0f));
                this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("EventLogEmptyTextSearch", C1067R.string.EventLogEmptyTextSearch, this.searchQuery)));
            } else if (this.selectedAdmins == null && this.currentFilter == null) {
                this.emptyView.setPadding(AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(16.0f));
                if (this.currentChat.megagroup) {
                    this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmpty", C1067R.string.EventLogEmpty)));
                } else {
                    this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmptyChannel", C1067R.string.EventLogEmptyChannel)));
                }
            } else {
                this.emptyView.setPadding(AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(5.0f), AndroidUtilities.m26dp(8.0f), AndroidUtilities.m26dp(5.0f));
                this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString("EventLogEmptySearch", C1067R.string.EventLogEmptySearch)));
            }
        }
    }
    ...
    private void loadMessages(boolean z) {
        if (!this.loading) {
            int i = 0;
            if (z) {
                this.minEventId = TimestampAdjuster.DO_NOT_OFFSET;
            ...
            tL_channels_getAdminLog.f473q = this.searchQuery;
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getAdminLog, new C3607-$$Lambda$ChannelAdminLogActivity$eETtXTeGU9y5fKwho2AV8a_Izoc(this));
            if (z) {
    ...
    public /* synthetic */ void lambda$loadMessages$1$ChannelAdminLogActivity(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C1268-$$Lambda$ChannelAdminLogActivity$K07rFS3bEoWzk9x_xNaPo7WXWaQ(this, (TL_channels_adminLogResults) tLObject));
        }
    }
    ...
    public /* synthetic */ void lambda$null$0$ChannelAdminLogActivity(TL_channels_adminLogResults tL_channels_adminLogResults) {
        ...
        for (i = 0; i < tL_channels_adminLogResults.events.size(); i++) {
            ...
            if (this.messagesDict.indexOfKey(tL_channelAdminLogEvent.f470id) < 0) {
                this.minEventId = Math.min(this.minEventId, tL_channelAdminLogEvent.f470id);
                ...
                if (messageObject.contentType >= 0) {
                    this.messagesDict.put(tL_channelAdminLogEvent.f470id, messageObject);
                }
                obj = 1;
            }
        }
    ...
    public View createView(Context context) {
        ...
        c2190ActionBar.setOccupyStatusBar(z);
        this.actionBar.setBackButtonDrawable(new BackDrawable(false));
        this.actionBar.setActionBarMenuOnItemClick(new C39482());
        ...
        this.searchItem = this.actionBar.createMenu().addItem(0, (int) C1067R.C1065drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C39493());
        this.searchItem.setSearchFieldHint(LocaleController.getString("Search", C1067R.string.Search));
        this.avatarContainer.setEnabled(false);
        this.avatarContainer.setTitle(this.currentChat.title);
        this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C1067R.string.EventLogAllEvents));
        ...
        this.fragmentView = new SizeNotifierFrameLayout(context2) {
            ...
            public void onAttachedToWindow() {
                ...
                MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                if (playingMessageObject != null && playingMessageObject.isRoundVideo() && playingMessageObject.eventId != 0 && playingMessageObject.getDialogId() == ((long) (-ChannelAdminLogActivity.this.currentChat.f434id))) {
                ...
                for (int i3 = 0; i3 < measuredHeight; i3++) {
                    ...
                    if (!(childAt == null || childAt.getVisibility() == 8 || childAt == ChannelAdminLogActivity.this.actionBar)) {
                        if (childAt == ChannelAdminLogActivity.this.chatListView || childAt == ChannelAdminLogActivity.this.progressView) {
                            childAt.measure(MeasureSpec.makeMeasureSpec(size, 1073741824), MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m26dp(10.0f), size2 - AndroidUtilities.m26dp(50.0f)), 1073741824));
                        } else if (childAt == ChannelAdminLogActivity.this.emptyViewContainer) {
                            childAt.measure(MeasureSpec.makeMeasureSpec(size, 1073741824), MeasureSpec.makeMeasureSpec(size2, 1073741824));
                        } else {
            ...
            L_0x005f:
                ...
                r6 = r9.getPaddingTop();
                r3 = r3 + r6;
                r6 = org.telegram.p004ui.ChannelAdminLogActivity.this;
                r6 = r6.actionBar;
            ...
            L_0x009a:
                ...
                r8 = org.telegram.p004ui.ChannelAdminLogActivity.this;
                r8 = r8.actionBar;
                r8 = r8.getVisibility();
            ...
            L_0x00d2:
                ...
                return;
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChannelAdminLogActivity$C39504.onLayout(boolean, int, int, int, int):void");
            }
        };
        ...
        this.emptyViewContainer.setOnTouchListener(C1271-$$Lambda$ChannelAdminLogActivity$Xh6zBvXYfqVbautwsQ1g7PDF8js.INSTANCE);
        ...
        this.emptyView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m26dp(10.0f), Theme.getServiceMessageColor()));
        this.emptyView.setPadding(AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(16.0f));
                    ...
                    if (avatarImage != null) {
                        ...
                        if (chatMessageCell.isPinnedBottom()) {
                            ...
                            if (!(childViewHolder == null || ChannelAdminLogActivity.this.chatListView.findViewHolderForAdapterPosition(childViewHolder.getAdapterPosition() + 1) == null)) {
                                avatarImage.setImageY(-AndroidUtilities.m26dp(1000.0f));
                        ...
                        if (top2 - AndroidUtilities.m26dp(48.0f) < top) {
                            top2 = AndroidUtilities.m26dp(48.0f) + top;
                        }
                        avatarImage.setImageY(top2 - AndroidUtilities.m26dp(44.0f));
                        avatarImage.draw(canvas);
                    }
                }
                return drawChild;
        ...
        this.chatListView.setOnItemClickListener(new C3606-$$Lambda$ChannelAdminLogActivity$Th_a2zOFfCYw_f0pzM6kJHBXd6E(this));
        ...
        this.chatListView.setPadding(0, AndroidUtilities.m26dp(4.0f), 0, AndroidUtilities.m26dp(3.0f));
        ...
        this.chatListView.setOnScrollListener(new C39517());
        ...
        this.progressView2.setBackgroundResource(C1067R.C1065drawable.system_loader);
        this.progressView2.getBackground().setColorFilter(Theme.colorFilter);
        ...
        this.bottomOverlayChat.setPadding(0, AndroidUtilities.m26dp(3.0f), 0, 0);
        this.contentView.addView(this.bottomOverlayChat, LayoutHelper.createFrame(-1, 51, 80));
        this.bottomOverlayChat.setOnClickListener(new C1269-$$Lambda$ChannelAdminLogActivity$PzYgcbyw3IRYlthKzfCR6dwSeeo(this));
        ...
        this.bottomOverlayChatText.setText(LocaleController.getString("SETTINGS", C1067R.string.SETTINGS).toUpperCase());
        ...
        this.bottomOverlayImage.setImageResource(C1067R.C1065drawable.log_info);
        ...
        this.bottomOverlayImage.setContentDescription(LocaleController.getString("BotHelp", C1067R.string.BotHelp));
        this.bottomOverlayImage.setOnClickListener(new C1267-$$Lambda$ChannelAdminLogActivity$Hkc6JExHTyVzGS38RTThrIB1hTM(this));
        ...
        this.searchContainer.setPadding(0, AndroidUtilities.m26dp(3.0f), 0, 0);
        ...
        this.searchCalendarButton.setImageResource(C1067R.C1065drawable.msg_calendar);
        ...
        this.searchCalendarButton.setOnClickListener(new C1274-$$Lambda$ChannelAdminLogActivity$qxESsL3-0yZHIVgE4y2ybeWozac(this));
    ...
    public /* synthetic */ void lambda$createView$5$ChannelAdminLogActivity(View view) {
        if (getParentActivity() != null) {
            ...
            adminLogFilterAlert.setAdminLogFilterAlertDelegate(new C3608-$$Lambda$ChannelAdminLogActivity$np-QiCzzUhW5eVeXU_cFYpLVjKA(this));
    ...
    public /* synthetic */ void lambda$null$4$ChannelAdminLogActivity(TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter, SparseArray sparseArray) {
        ...
        if (this.currentFilter == null && this.selectedAdmins == null) {
            ...
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogSelectedEvents", C1067R.string.EventLogSelectedEvents));
        }
        loadMessages(true);
    }
    ...
    public /* synthetic */ void lambda$createView$6$ChannelAdminLogActivity(View view) {
        ...
        if (this.currentChat.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetail", C1067R.string.EventLogInfoDetail)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetailChannel", C1067R.string.EventLogInfoDetailChannel)));
        }
        builder.setPositiveButton(LocaleController.getString("OK", C1067R.string.f61OK), null);
        builder.setTitle(LocaleController.getString("EventLogInfoTitle", C1067R.string.EventLogInfoTitle));
    ...
    public /* synthetic */ void lambda$createView$10$ChannelAdminLogActivity(View view) {
        if (getParentActivity() != null) {
            ...
            try {
                DatePickerDialog datePickerDialog = new DatePickerDialog(getParentActivity(), new C1264-$$Lambda$ChannelAdminLogActivity$0sxG9Ul5ZEHgnzFmOGlWQbHqyvo(this), instance.get(1), instance.get(2), instance.get(5));
                DatePicker datePicker = datePickerDialog.getDatePicker();
                datePicker.setMinDate(1375315200000L);
                datePicker.setMaxDate(System.currentTimeMillis());
                datePickerDialog.setButton(-1, LocaleController.getString("JumpToDate", C1067R.string.JumpToDate), datePickerDialog);
                datePickerDialog.setButton(-2, LocaleController.getString("Cancel", C1067R.string.Cancel), C1275-$$Lambda$ChannelAdminLogActivity$v157pu_gWSgDQsCgD-IoOuRIDsE.INSTANCE);
                if (VERSION.SDK_INT >= 21) {
                    datePickerDialog.setOnShowListener(new C1270-$$Lambda$ChannelAdminLogActivity$TCvk3Rm-FmQeaZ3KZrjzNCt3Urw(datePicker));
                }
        ...
        if (messageObject != null) {
            ...
            if (getParentActivity() != null) {
                ...
                if (messageObject2.type == 0 || messageObject2.caption != null) {
                    arrayList.add(LocaleController.getString(str, C1067R.string.Copy));
                ...
                if (messageType == 3) {
                    ...
                    if ((messageMedia instanceof TL_messageMediaWebPage) && MessageObject.isNewGifDocument(messageMedia.webpage.document)) {
                        arrayList.add(LocaleController.getString(str2, C1067R.string.SaveToGIFs));
                    ...
                    if (messageType == 4) {
                        if (this.selectedObject.isVideo()) {
                            arrayList.add(LocaleController.getString(str3, C1067R.string.SaveToGallery));
                            arrayList2.add(Integer.valueOf(4));
                            arrayList.add(LocaleController.getString(str5, C1067R.string.ShareFile));
                            arrayList2.add(Integer.valueOf(6));
                        } else if (this.selectedObject.isMusic()) {
                            arrayList.add(LocaleController.getString("SaveToMusic", C1067R.string.SaveToMusic));
                            ...
                            arrayList.add(LocaleController.getString(str4, C1067R.string.SaveToDownloads));
                            arrayList2.add(Integer.valueOf(10));
                            arrayList.add(LocaleController.getString(str5, C1067R.string.ShareFile));
                            arrayList2.add(Integer.valueOf(6));
                        } else {
                        ...
                        arrayList.add(LocaleController.getString("ApplyLocalizationFile", C1067R.string.ApplyLocalizationFile));
                        ...
                        arrayList.add(LocaleController.getString("ApplyThemeFile", C1067R.string.ApplyThemeFile));
                        arrayList2.add(Integer.valueOf(5));
                        arrayList.add(LocaleController.getString(str4, C1067R.string.SaveToDownloads));
                        arrayList2.add(Integer.valueOf(10));
                        arrayList.add(LocaleController.getString(str5, C1067R.string.ShareFile));
                        ...
                        if (this.selectedObject.isMask()) {
                            arrayList.add(LocaleController.getString("AddToMasks", C1067R.string.AddToMasks));
                        } else {
                            arrayList.add(LocaleController.getString("AddToStickers", C1067R.string.AddToStickers));
                        }
                        ...
                        if (!(user == null || user.f534id == UserConfig.getInstance(this.currentAccount).getClientUserId() || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(user.f534id)) != null)) {
                            arrayList.add(LocaleController.getString("AddContactTitle", C1067R.string.AddContactTitle));
                        ...
                        if (!(str6 == null && str6.length() == 0)) {
                            ...
                            arrayList.add(LocaleController.getString("Call", C1067R.string.Call));
                            arrayList2.add(Integer.valueOf(17));
                        }
                    }
                }
                if (!arrayList2.isEmpty()) {
                    builder.setItems((CharSequence[]) arrayList.toArray(new CharSequence[0]), new C1265-$$Lambda$ChannelAdminLogActivity$BZ9YJjVsQ77SD-mlnHBXJsrpGqE(this, arrayList2));
                    builder.setTitle(LocaleController.getString("Message", C1067R.string.Message));
                    showDialog(builder.create());
                }
            }
        }
    ...
    private TextureView createTextureView(boolean z) {
        ...
        if (this.roundVideoContainer == null) {
            if (VERSION.SDK_INT >= 21) {
                ...
                this.roundVideoContainer.setOutlineProvider(new C239411());
    ...
    L_0x0243:
        ...
        r3 = "OK";
        r4 = 2131558635; // 0x7f0d00eb float:1.8742591E38 double:1.0531298936E-314;
        r5 = "AppName";
    ...
    L_0x026f:
        ...
        r1 = (org.telegram.p004ui.Components.RecyclerListView.Holder) r1;
    ...
    L_0x0291:
        ...
        r1 = org.telegram.p004ui.ActionBar.Theme.applyThemeFile(r0, r1, r7);
    ...
    L_0x02b2:
        ...
        r0.setTitle(r1);
        r1 = 2131559664; // 0x7f0d04f0 float:1.8744678E38 double:1.053130402E-314;
        r4 = "IncorrectTheme";
    ...
    L_0x02fd:
        ...
        r1 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r0.setTitle(r1);
        r1 = 2131559663; // 0x7f0d04ef float:1.8744676E38 double:1.0531304015E-314;
    ...
    L_0x038e:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChannelAdminLogActivity.processSelectedOption(int):void");
    }
        ...
        if (i == 10 || i == 11 || i == 16) {
            ...
            if (messageObject.isSticker()) {
                ...
                if (inputStickerSet instanceof TL_inputStickerSetID) {
                    if (!DataQuery.getInstance(this.currentAccount).isStickerPackInstalled(inputStickerSet.f460id)) {
                        return 7;
                    }
    ...
    private void loadAdmins() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getParticipants, new C3609-$$Lambda$ChannelAdminLogActivity$v_o39r5RzWtyA17rINStweDzJAI(this)), this.classGuid);
    }

    public /* synthetic */ void lambda$loadAdmins$13$ChannelAdminLogActivity(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1273-$$Lambda$ChannelAdminLogActivity$nOrNBbemB40UwQEfR8VXtwD17_w(this, tL_error, tLObject));
    }
        ...
        if (this.floatingDateView.getTag() != null && !this.currentFloatingDateOnScreen) {
            if (!this.scrollingFloatingDate || this.currentFloatingTopIsNotMessage) {
                ...
                if (z) {
                    ...
                    this.floatingDateAnimation.addListener(new C239613());
    ...
    private void fixLayout() {
        ...
        if (chatAvatarContainer != null) {
            chatAvatarContainer.getViewTreeObserver().addOnPreDrawListener(new C239714());
        }
    }
    ...
    private void alertUserOpenError(MessageObject messageObject) {
        if (getParentActivity() != null) {
            ...
            if (messageObject.type == 3) {
                builder.setMessage(LocaleController.getString("NoPlayerInstalled", C1067R.string.NoPlayerInstalled));
            } else {
                builder.setMessage(LocaleController.formatString("NoHandleAppInstalled", C1067R.string.NoHandleAppInstalled, messageObject.getDocument().mime_type));
            }
            showDialog(builder.create());
        }
    }
        ...
        if (chat.megagroup && this.admins != null && ChatObject.canBlockUsers(chat)) {
            ...
            while (i2 < this.admins.size()) {
                ...
                if (channelParticipant.user_id == i) {
                    ...
                    bundle.putInt("ban_chat_id", this.currentChat.f434id);
                } else {
                    i2++;
                }
            }
    ...
    public void showOpenUrlAlert(String str, boolean z) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("OpenUrlTitle", C1067R.string.OpenUrlTitle));
        builder.setMessage(LocaleController.formatString("OpenUrlAlert2", C1067R.string.OpenUrlAlert2, str));
        builder.setPositiveButton(LocaleController.getString("Open", C1067R.string.Open), new C1272-$$Lambda$ChannelAdminLogActivity$iAIppxrAcTSiaPaqrhtDiQvqAXs(this, str));
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        themeDescriptionArr[12] = new ThemeDescription(this.avatarContainer.getSubtitleTextView(), ThemeDescription.FLAG_TEXTCOLOR, null, new Paint[]{Theme.chat_statusPaint, Theme.chat_statusRecordPaint}, null, null, Theme.key_actionBarDefaultSubtitle, null);
        ...
        themeDescriptionArr[14] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.avatar_broadcastDrawable, Theme.avatar_savedDrawable}, null, Theme.key_avatar_text);
        ...
        themeDescriptionArr[42] = new ThemeDescription(this.chatListView, ThemeDescription.FLAG_LINKCOLOR, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_messageLinkIn, null);
        themeDescriptionArr[43] = new ThemeDescription(this.chatListView, ThemeDescription.FLAG_LINKCOLOR, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_messageLinkOut, null);
        themeDescriptionArr[44] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutCheckDrawable, Theme.chat_msgOutHalfCheckDrawable}, null, Theme.key_chat_outSentCheck);
        themeDescriptionArr[45] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutCheckSelectedDrawable, Theme.chat_msgOutHalfCheckSelectedDrawable}, null, Theme.key_chat_outSentCheckSelected);
        themeDescriptionArr[46] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutClockDrawable}, null, Theme.key_chat_outSentClock);
        themeDescriptionArr[47] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutSelectedClockDrawable}, null, Theme.key_chat_outSentClockSelected);
        themeDescriptionArr[48] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInClockDrawable}, null, Theme.key_chat_inSentClock);
        themeDescriptionArr[49] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInSelectedClockDrawable}, null, Theme.key_chat_inSentClockSelected);
        themeDescriptionArr[50] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgMediaCheckDrawable, Theme.chat_msgMediaHalfCheckDrawable}, null, Theme.key_chat_mediaSentCheck);
        themeDescriptionArr[51] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgStickerHalfCheckDrawable, Theme.chat_msgStickerCheckDrawable, Theme.chat_msgStickerClockDrawable, Theme.chat_msgStickerViewsDrawable}, null, Theme.key_chat_serviceText);
        themeDescriptionArr[52] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgMediaClockDrawable}, null, Theme.key_chat_mediaSentClock);
        themeDescriptionArr[53] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutViewsDrawable}, null, Theme.key_chat_outViews);
        themeDescriptionArr[54] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutViewsSelectedDrawable}, null, Theme.key_chat_outViewsSelected);
        themeDescriptionArr[55] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInViewsDrawable}, null, Theme.key_chat_inViews);
        themeDescriptionArr[56] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInViewsSelectedDrawable}, null, Theme.key_chat_inViewsSelected);
        themeDescriptionArr[57] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgMediaViewsDrawable}, null, Theme.key_chat_mediaViews);
        themeDescriptionArr[58] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutMenuDrawable}, null, Theme.key_chat_outMenu);
        themeDescriptionArr[59] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutMenuSelectedDrawable}, null, Theme.key_chat_outMenuSelected);
        themeDescriptionArr[60] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInMenuDrawable}, null, Theme.key_chat_inMenu);
        themeDescriptionArr[61] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInMenuSelectedDrawable}, null, Theme.key_chat_inMenuSelected);
        themeDescriptionArr[62] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgMediaMenuDrawable}, null, Theme.key_chat_mediaMenu);
        themeDescriptionArr[63] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutInstantDrawable, Theme.chat_msgOutCallDrawable}, null, Theme.key_chat_outInstant);
        themeDescriptionArr[64] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgOutCallSelectedDrawable}, null, Theme.key_chat_outInstantSelected);
        themeDescriptionArr[65] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInInstantDrawable, Theme.chat_msgInCallDrawable}, null, Theme.key_chat_inInstant);
        themeDescriptionArr[66] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgInCallSelectedDrawable}, null, Theme.key_chat_inInstantSelected);
        themeDescriptionArr[67] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgCallUpGreenDrawable}, null, Theme.key_chat_outGreenCall);
        themeDescriptionArr[68] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgCallDownRedDrawable}, null, Theme.key_chat_inRedCall);
        themeDescriptionArr[69] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgCallDownGreenDrawable}, null, Theme.key_chat_inGreenCall);
        themeDescriptionArr[70] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, Theme.chat_msgErrorPaint, null, null, Theme.key_chat_sentError);
        themeDescriptionArr[71] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_msgErrorDrawable}, null, Theme.key_chat_sentErrorIcon);
        themeDescriptionArr[72] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, Theme.chat_durationPaint, null, null, Theme.key_chat_previewDurationText);
        themeDescriptionArr[73] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, Theme.chat_gamePaint, null, null, Theme.key_chat_previewGameText);
        themeDescriptionArr[74] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inPreviewInstantText);
        themeDescriptionArr[75] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outPreviewInstantText);
        themeDescriptionArr[76] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inPreviewInstantSelectedText);
        themeDescriptionArr[77] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outPreviewInstantSelectedText);
        themeDescriptionArr[78] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, Theme.chat_deleteProgressPaint, null, null, Theme.key_chat_secretTimeText);
        themeDescriptionArr[79] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_stickerNameText);
        themeDescriptionArr[80] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, Theme.chat_botButtonPaint, null, null, Theme.key_chat_botButtonText);
        themeDescriptionArr[81] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, Theme.chat_botProgressPaint, null, null, Theme.key_chat_botProgress);
        themeDescriptionArr[82] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inForwardedNameText);
        themeDescriptionArr[83] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outForwardedNameText);
        themeDescriptionArr[84] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inViaBotNameText);
        themeDescriptionArr[85] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outViaBotNameText);
        themeDescriptionArr[86] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_stickerViaBotNameText);
        themeDescriptionArr[87] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inReplyLine);
        themeDescriptionArr[88] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outReplyLine);
        themeDescriptionArr[89] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_stickerReplyLine);
        themeDescriptionArr[90] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inReplyNameText);
        themeDescriptionArr[91] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outReplyNameText);
        themeDescriptionArr[92] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_stickerReplyNameText);
        themeDescriptionArr[93] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inReplyMessageText);
        themeDescriptionArr[94] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outReplyMessageText);
        themeDescriptionArr[95] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inReplyMediaMessageText);
        themeDescriptionArr[96] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outReplyMediaMessageText);
        themeDescriptionArr[97] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inReplyMediaMessageSelectedText);
        themeDescriptionArr[98] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outReplyMediaMessageSelectedText);
        themeDescriptionArr[99] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_stickerReplyMessageText);
        themeDescriptionArr[100] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inPreviewLine);
        themeDescriptionArr[101] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outPreviewLine);
        themeDescriptionArr[102] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inSiteNameText);
        themeDescriptionArr[103] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outSiteNameText);
        themeDescriptionArr[104] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inContactNameText);
        themeDescriptionArr[105] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outContactNameText);
        themeDescriptionArr[106] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inContactPhoneText);
        themeDescriptionArr[107] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outContactPhoneText);
        themeDescriptionArr[108] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_mediaProgress);
        themeDescriptionArr[109] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioProgress);
        themeDescriptionArr[110] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioProgress);
        themeDescriptionArr[111] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioSelectedProgress);
        themeDescriptionArr[112] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioSelectedProgress);
        themeDescriptionArr[113] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_mediaTimeText);
        themeDescriptionArr[114] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inTimeText);
        themeDescriptionArr[115] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outTimeText);
        themeDescriptionArr[116] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inTimeSelectedText);
        themeDescriptionArr[117] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outTimeSelectedText);
        themeDescriptionArr[118] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioPerformerText);
        themeDescriptionArr[119] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioPerformerText);
        themeDescriptionArr[120] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioTitleText);
        themeDescriptionArr[121] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioTitleText);
        themeDescriptionArr[122] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioDurationText);
        themeDescriptionArr[123] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioDurationText);
        themeDescriptionArr[124] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioDurationSelectedText);
        themeDescriptionArr[125] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioDurationSelectedText);
        themeDescriptionArr[126] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioSeekbar);
        themeDescriptionArr[127] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioSeekbar);
        themeDescriptionArr[128] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioSeekbarSelected);
        themeDescriptionArr[129] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioSeekbarSelected);
        themeDescriptionArr[130] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioSeekbarFill);
        themeDescriptionArr[131] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inAudioCacheSeekbar);
        themeDescriptionArr[132] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioSeekbarFill);
        themeDescriptionArr[133] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outAudioCacheSeekbar);
        themeDescriptionArr[134] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inVoiceSeekbar);
        themeDescriptionArr[135] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outVoiceSeekbar);
        themeDescriptionArr[136] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inVoiceSeekbarSelected);
        themeDescriptionArr[137] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outVoiceSeekbarSelected);
        themeDescriptionArr[138] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inVoiceSeekbarFill);
        themeDescriptionArr[139] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outVoiceSeekbarFill);
        themeDescriptionArr[140] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileProgress);
        themeDescriptionArr[141] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileProgress);
        themeDescriptionArr[142] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileProgressSelected);
        themeDescriptionArr[143] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileProgressSelected);
        themeDescriptionArr[144] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileNameText);
        themeDescriptionArr[145] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileNameText);
        themeDescriptionArr[146] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileInfoText);
        themeDescriptionArr[147] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileInfoText);
        themeDescriptionArr[148] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileInfoSelectedText);
        themeDescriptionArr[149] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileInfoSelectedText);
        themeDescriptionArr[150] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileBackground);
        themeDescriptionArr[151] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileBackground);
        themeDescriptionArr[152] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inFileBackgroundSelected);
        themeDescriptionArr[153] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outFileBackgroundSelected);
        ...
        themeDescriptionArr[161] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outLoader);
        themeDescriptionArr[162] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outMediaIcon);
        themeDescriptionArr[163] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outLoaderSelected);
        themeDescriptionArr[164] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_outMediaIconSelected);
        themeDescriptionArr[165] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inLoader);
        themeDescriptionArr[166] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inMediaIcon);
        themeDescriptionArr[167] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inLoaderSelected);
        themeDescriptionArr[168] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, null, null, Theme.key_chat_inMediaIconSelected);
        RecyclerListView recyclerListView = this.chatListView;
        ...
        themeDescriptionArr[169] = new ThemeDescription(recyclerListView, i, clsArr, null, r14, null, Theme.key_chat_mediaLoaderPhoto);
        recyclerListView = this.chatListView;
        ...
        themeDescriptionArr[170] = new ThemeDescription(recyclerListView, 0, clsArr, null, r14, null, Theme.key_chat_mediaLoaderPhotoIcon);
        recyclerListView = this.chatListView;
        ...
        themeDescriptionArr[171] = new ThemeDescription(recyclerListView, i, clsArr, null, r14, null, Theme.key_chat_mediaLoaderPhotoSelected);
        recyclerListView = this.chatListView;
        clsArr = new Class[]{ChatMessageCell.class};
        r7 = new Drawable[4];
        ...
        themeDescriptionArr[172] = new ThemeDescription(recyclerListView, 0, clsArr, null, r7, null, Theme.key_chat_mediaLoaderPhotoIconSelected);
        RecyclerListView recyclerListView2 = this.chatListView;
        ...
        themeDescriptionArr[173] = new ThemeDescription(recyclerListView2, i2, clsArr2, null, r7, null, Theme.key_chat_outLoaderPhoto);
        ...
        r7[0] = drawableArr4[7][0];
        r7[1] = drawableArr4[8][0];
        themeDescriptionArr[174] = new ThemeDescription(recyclerListView2, 0, clsArr2, null, r7, null, Theme.key_chat_outLoaderPhotoIcon);
        recyclerListView2 = this.chatListView;
        ...
        themeDescriptionArr[175] = new ThemeDescription(recyclerListView2, i2, clsArr2, null, r7, null, Theme.key_chat_outLoaderPhotoSelected);
        recyclerListView2 = this.chatListView;
        clsArr2 = new Class[]{ChatMessageCell.class};
        r7 = new Drawable[2];
        drawableArr4 = Theme.chat_photoStatesDrawables;
        r7[0] = drawableArr4[7][1];
        r7[1] = drawableArr4[8][1];
        themeDescriptionArr[176] = new ThemeDescription(recyclerListView2, 0, clsArr2, null, r7, null, Theme.key_chat_outLoaderPhotoIconSelected);
        recyclerListView2 = this.chatListView;
        i2 = ThemeDescription.FLAG_BACKGROUNDFILTER;
        clsArr2 = new Class[]{ChatMessageCell.class};
        r7 = new Drawable[2];
        ...
        themeDescriptionArr[177] = new ThemeDescription(recyclerListView2, i2, clsArr2, null, r7, null, Theme.key_chat_inLoaderPhoto);
        recyclerListView2 = this.chatListView;
        clsArr2 = new Class[]{ChatMessageCell.class};
        r7 = new Drawable[2];
        ...
        r7[0] = drawableArr5[10][0];
        r7[1] = drawableArr5[11][0];
        themeDescriptionArr[178] = new ThemeDescription(recyclerListView2, 0, clsArr2, null, r7, null, Theme.key_chat_inLoaderPhotoIcon);
        recyclerListView2 = this.chatListView;
        i2 = ThemeDescription.FLAG_BACKGROUNDFILTER;
        clsArr2 = new Class[]{ChatMessageCell.class};
        r7 = new Drawable[2];
        ...
        themeDescriptionArr[179] = new ThemeDescription(recyclerListView2, i2, clsArr2, null, r7, null, Theme.key_chat_inLoaderPhotoSelected);
        recyclerListView2 = this.chatListView;
        clsArr2 = new Class[]{ChatMessageCell.class};
        r5 = new Drawable[2];
        ...
        themeDescriptionArr[180] = new ThemeDescription(recyclerListView2, 0, clsArr2, null, r5, null, Theme.key_chat_inLoaderPhotoIconSelected);
        ...
        themeDescriptionArr[189] = new ThemeDescription(this.chatListView, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_locationDrawable[0]}, null, Theme.key_chat_inLocationBackground);
        ...
        themeDescriptionArr[192] = new ThemeDescription(this.chatListView, 0, new Class[]{ChatMessageCell.class}, null, new Drawable[]{Theme.chat_locationDrawable[1]}, null, Theme.key_chat_outLocationIcon);
        ...
        strArr[0] = "textView";
        themeDescriptionArr[Callback.DEFAULT_DRAG_ANIMATION_DURATION] = new ThemeDescription(view, i3, clsArr3, strArr, null, null, null, Theme.key_chat_unreadMessagesStartText);
        ...
        ChatAvatarContainer chatAvatarContainer = this.avatarContainer;
        themeDescriptionArr[205] = new ThemeDescription(chatAvatarContainer != null ? chatAvatarContainer.getTimeItem() : null, 0, null, null, null, null, Theme.key_chat_secretTimerBackground);
        chatAvatarContainer = this.avatarContainer;
        if (chatAvatarContainer != null) {
            themeDescriptionDelegate = chatAvatarContainer.getTimeItem();
        }
        themeDescriptionArr[206] = new ThemeDescription(themeDescriptionDelegate, 0, null, null, null, null, Theme.key_chat_secretTimerText);
