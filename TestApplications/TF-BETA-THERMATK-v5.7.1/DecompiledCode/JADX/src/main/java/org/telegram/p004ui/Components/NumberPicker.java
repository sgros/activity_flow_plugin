...
public class NumberPicker extends LinearLayout {
    ...
    L_0x0060:
        ...
        return r6;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.NumberPicker.dispatchKeyEvent(android.view.KeyEvent):boolean");
    }
    ...
    private void tryComputeMaxWidth() {
        if (this.mComputeMaxWidth) {
            ...
            if (strArr == null) {
                float f = 0.0f;
                for (i = 0; i <= 9; i++) {
                    float measureText = this.mSelectorWheelPaint.measureText(NumberPicker.formatNumberWithLocale(i));
                    if (measureText > f) {
                        f = measureText;
                    }
                }
    ...
    private int resolveSizeAndStateRespectingMinSize(int i, int i2, int i3) {
        return i != -1 ? NumberPicker.resolveSizeAndState(Math.max(i, i2), i3, 0) : i2;
    }
    ...
    public static int resolveSizeAndState(int i, int i2, int i3) {
        ...
        if (mode != Integer.MIN_VALUE) {
            ...
            i = ConnectionsManager.FileTypePhoto | i2;
        }
    ...
    private String formatNumber(int i) {
        ...
        return formatter != null ? formatter.format(i) : NumberPicker.formatNumberWithLocale(i);
    }
