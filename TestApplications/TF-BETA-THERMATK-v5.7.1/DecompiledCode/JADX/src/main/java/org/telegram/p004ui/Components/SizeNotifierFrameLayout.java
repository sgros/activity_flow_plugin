...
public class SizeNotifierFrameLayout extends FrameLayout {
    ...
    public void setBackgroundImage(Drawable drawable, boolean z) {
        ...
        if (z) {
            if (this.parallaxEffect == null) {
                ...
                this.parallaxEffect.setCallback(new C4057-$$Lambda$SizeNotifierFrameLayout$9xVW1u9E8sqKGYKEgYUca0gqvJA(this));
    ...
    public void notifyHeightChanged() {
        if (this.delegate != null) {
            ...
            post(new C2673-$$Lambda$SizeNotifierFrameLayout$k4g_DFX6SvnMtnN4qrfdhEQSo18(this, point.x > point.y));
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (drawable == null) {
            ...
            int currentActionBarHeight = isActionBarVisible() ? C2190ActionBar.getCurrentActionBarHeight() : 0;
