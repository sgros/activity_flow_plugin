...
public class VideoEncodingService extends Service implements NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("destroy video service");
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("start video service");
        }
        if (this.builder == null) {
            ...
            if (booleanExtra) {
                str = "SendingGif";
                this.builder.setTicker(LocaleController.getString(str, C1067R.string.SendingGif));
                this.builder.setContentText(LocaleController.getString(str, C1067R.string.SendingGif));
            } else {
                str = "SendingVideo";
                this.builder.setTicker(LocaleController.getString(str, C1067R.string.SendingVideo));
                this.builder.setContentText(LocaleController.getString(str, C1067R.string.SendingVideo));
            }
        }
