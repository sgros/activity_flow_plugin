...
public class AboutLinkCell extends FrameLayout {
    ...
    public void setTextAndValue(String str, String str2, boolean z) {
        if (!TextUtils.isEmpty(str)) {
            ...
            Emoji.replaceEmoji(this.stringBuilder, Theme.profile_aboutTextPaint.getFontMetricsInt(), AndroidUtilities.m26dp(20.0f), false);
    ...
    L_0x0096:
        r0 = move-exception;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ Exception -> 0x009b }
        goto L_0x00f9;
    L_0x009b:
        r0 = move-exception;
        r1 = 1;
    ...
    L_0x00b4:
        r1 = r0 instanceof org.telegram.p004ui.Components.URLSpanNoUnderline;	 Catch:{ Exception -> 0x00f2 }
        if (r1 == 0) goto L_0x00da;
    L_0x00b8:
        r0 = (org.telegram.p004ui.Components.URLSpanNoUnderline) r0;	 Catch:{ Exception -> 0x00f2 }
    ...
    L_0x0105:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.AboutLinkCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onMeasure(int i, int i2) {
        if (this.stringBuilder != null) {
            int size = MeasureSpec.getSize(i) - AndroidUtilities.m26dp(46.0f);
        ...
        i2 = (staticLayout != null ? staticLayout.getHeight() : AndroidUtilities.m26dp(20.0f)) + AndroidUtilities.m26dp(16.0f);
        if (this.valueTextView.getVisibility() == 0) {
            i2 += AndroidUtilities.m26dp(23.0f);
        }
    ...
    public void onDraw(Canvas canvas) {
        canvas.save();
        int dp = AndroidUtilities.m26dp(23.0f);
        this.textX = dp;
        float f = (float) dp;
        int dp2 = AndroidUtilities.m26dp(8.0f);
        this.textY = dp2;
