...
public class IntroActivity extends Activity implements NotificationCenterDelegate {
    ...
    class C30521 implements SurfaceTextureListener {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            if (IntroActivity.this.eglThread == null && surfaceTexture != null) {
                ...
                IntroActivity.this.eglThread.postRunnable(new C1547-$$Lambda$IntroActivity$1$ziO_g9IlcqOuWLJOlD4I6EuEo50(this));
            }
        }
    ...
    class C42022 implements OnPageChangeListener {
        C42022() {
        }
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C30531();
        private EGL10 egl10;
        ...
        class C30531 implements Runnable {
            C30531() {
            }
            ...
            public void run() {
                ...
                if ((EGLThread.this.eglContext.equals(EGLThread.this.egl10.eglGetCurrentContext()) && EGLThread.this.eglSurface.equals(EGLThread.this.egl10.eglGetCurrentSurface(12377))) || EGLThread.this.egl10.eglMakeCurrent(EGLThread.this.eglDisplay, EGLThread.this.eglSurface, EGLThread.this.eglSurface, EGLThread.this.eglContext)) {
                    ...
                    EGLThread.this.postRunnable(new C1549-$$Lambda$IntroActivity$EGLThread$1$t5CDZ7wR8GgPufsAxg7RJ2ghGUs(this), 16);
                    return;
                }
                ...
                if (!this.egl10.eglChooseConfig(this.eglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 24, 12326, 0, 12338, 1, 12337, 2, 12344}, eGLConfigArr, 1, iArr)) {
                    ...
                    if (surfaceTexture instanceof SurfaceTexture) {
                        ...
                        if (eGLSurface == null || eGLSurface == EGL10.EGL_NO_SURFACE) {
                            ...
                            this.f634gl = this.eglContext.getGL();
                            GLES20.glGenTextures(23, this.textures, 0);
                            loadTexture(C1067R.C1065drawable.intro_fast_arrow_shadow, 0);
                            loadTexture(C1067R.C1065drawable.intro_fast_arrow, 1);
                            loadTexture(C1067R.C1065drawable.intro_fast_body, 2);
                            loadTexture(C1067R.C1065drawable.intro_fast_spiral, 3);
                            loadTexture(C1067R.C1065drawable.intro_ic_bubble_dot, 4);
                            loadTexture(C1067R.C1065drawable.intro_ic_bubble, 5);
                            loadTexture(C1067R.C1065drawable.intro_ic_cam_lens, 6);
                            loadTexture(C1067R.C1065drawable.intro_ic_cam, 7);
                            loadTexture(C1067R.C1065drawable.intro_ic_pencil, 8);
                            loadTexture(C1067R.C1065drawable.intro_ic_pin, 9);
                            loadTexture(C1067R.C1065drawable.intro_ic_smile_eye, 10);
                            loadTexture(C1067R.C1065drawable.intro_ic_smile, 11);
                            loadTexture(C1067R.C1065drawable.intro_ic_videocam, 12);
                            loadTexture(C1067R.C1065drawable.intro_knot_down, 13);
                            loadTexture(C1067R.C1065drawable.intro_knot_up, 14);
                            loadTexture(C1067R.C1065drawable.intro_powerful_infinity_white, 15);
                            loadTexture(C1067R.C1065drawable.intro_powerful_infinity, 16);
                            loadTexture(C1067R.C1065drawable.intro_powerful_mask, 17);
                            loadTexture(C1067R.C1065drawable.intro_powerful_star, 18);
                            loadTexture(C1067R.C1065drawable.intro_private_door, 19);
                            loadTexture(C1067R.C1065drawable.intro_private_screw, 20);
                            loadTexture(C1067R.C1065drawable.intro_tg_plane, 21);
                            loadTexture(C1067R.C1065drawable.intro_tg_sphere, 22);
        ...
        public void shutdown() {
            postRunnable(new C1550-$$Lambda$IntroActivity$EGLThread$AriDXNPGmTpsZXAD4AD83qoD230(this));
        }
    ...
    private class IntroAdapter extends PagerAdapter {
        ...
        /* synthetic */ IntroAdapter(IntroActivity introActivity, C30521 c30521) {
            this();
        }
    ...
    public void onCreate(Bundle bundle) {
        setTheme(C1067R.style.f908Theme.TMessages);
        super.onCreate(bundle);
        requestWindowFeature(1);
        MessagesController.getGlobalMainSettings().edit().putLong("intro_crashed_time", System.currentTimeMillis()).commit();
        this.titles = new String[]{LocaleController.getString("Page1Title", C1067R.string.Page1Title), LocaleController.getString("Page2Title", C1067R.string.Page2Title), LocaleController.getString("Page3Title", C1067R.string.Page3Title), LocaleController.getString("Page5Title", C1067R.string.Page5Title), LocaleController.getString("Page4Title", C1067R.string.Page4Title), LocaleController.getString("Page6Title", C1067R.string.Page6Title)};
        this.messages = new String[]{LocaleController.getString("Page1Message", C1067R.string.Page1Message), LocaleController.getString("Page2Message", C1067R.string.Page2Message), LocaleController.getString("Page3Message", C1067R.string.Page3Message), LocaleController.getString("Page5Message", C1067R.string.Page5Message), LocaleController.getString("Page4Message", C1067R.string.Page4Message), LocaleController.getString("Page6Message", C1067R.string.Page6Message)};
        ...
        frameLayout2.addView(textureView, LayoutHelper.createFrame((int) Callback.DEFAULT_DRAG_ANIMATION_DURATION, 150, 17));
        textureView.setSurfaceTextureListener(new C30521());
        ...
        this.viewPager.addOnPageChangeListener(new C42022());
        TextView textView = new TextView(this);
        textView.setText(LocaleController.getString("StartMessaging", C1067R.string.StartMessaging).toUpperCase());
        textView.setGravity(17);
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            stateListAnimator.addState(new int[]{16842919}, ObjectAnimator.ofFloat(textView, str, new float[]{(float) AndroidUtilities.m26dp(2.0f), (float) AndroidUtilities.m26dp(4.0f)}).setDuration(200));
            stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(textView, str, new float[]{(float) AndroidUtilities.m26dp(4.0f), (float) AndroidUtilities.m26dp(2.0f)}).setDuration(200));
        ...
        textView.setOnClickListener(new C1551-$$Lambda$IntroActivity$Kg_leHKna32gZHR3CZT09b4whCI(this));
        if (BuildVars.DEBUG_VERSION) {
            textView.setOnLongClickListener(new C1552-$$Lambda$IntroActivity$iyZ2QRC4zfDIPF0e6T1a3cQJl5Y(this));
        }
        ...
        this.textView.setOnClickListener(new C1548-$$Lambda$IntroActivity$3V-J2Y1xEuzoe0ERCQjOPYz9JM8(this));
        if (AndroidUtilities.isTablet()) {
            FrameLayout frameLayout3 = new FrameLayout(this);
            setContentView(frameLayout3);
            ImageView imageView = new ImageView(this);
            BitmapDrawable bitmapDrawable = (BitmapDrawable) getResources().getDrawable(C1067R.C1065drawable.catstile);
            TileMode tileMode = TileMode.REPEAT;
            bitmapDrawable.setTileModeXY(tileMode, tileMode);
            imageView.setBackgroundDrawable(bitmapDrawable);
            frameLayout3.addView(imageView, LayoutHelper.createFrame(-1, -1.0f));
            frameLayout = new FrameLayout(this);
            frameLayout.setBackgroundResource(C1067R.C1065drawable.btnshadow);
    ...
    private void checkContinueText() {
        ...
        if (localeInfo != null && localeInfo2 != null && localeInfo != localeInfo2) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_langpack_getStrings, new C3700-$$Lambda$IntroActivity$v08WUA33DIz9dwdLeC-Z0gtPf-4(this, str), 8);
        }
    }
        ...
        if (tLObject != null) {
            ...
            if (!vector.objects.isEmpty()) {
                ...
                if (langPackString instanceof TL_langPackString) {
                    AndroidUtilities.runOnUIThread(new C1553-$$Lambda$IntroActivity$xVDraVC71XqfCcnZOtPiiDOx4JQ(this, langPackString, str));
                }
            }
        }
    }
