...
import org.telegram.p004ui.VoIPPermissionActivity;
...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    protected Runnable afterSoundRunnable = new C11151();
    ...
    protected BroadcastReceiver receiver = new C11162();
    ...
    class C11151 implements Runnable {
        ...
        public void run() {
            ...
            if (!VoIPBaseService.USE_CONNECTION_SERVICE) {
                boolean z = VoIPBaseService.this.isBtHeadsetConnected;
    ...
    class C11162 extends BroadcastReceiver {
        C11162() {
        }
                    ...
                    if ("android.bluetooth.headset.profile.action.CONNECTION_STATE_CHANGED".equals(intent.getAction())) {
                        ...
                        if ("android.media.ACTION_SCO_AUDIO_STATE_UPDATED".equals(intent.getAction())) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                ...
                                FileLog.m28e(stringBuilder2.toString());
                            }
                            if (intExtra == 0) {
                            ...
                            if (voIPBaseService.bluetoothScoActive && voIPBaseService.needSwitchToBluetoothAfterScoActivates) {
                                ...
                                AudioManager audioManager = (AudioManager) voIPBaseService.getSystemService(MimeTypes.BASE_TYPE_AUDIO);
    ...
    class C11173 implements OnClickListener {
        C11173() {
        }

        /* JADX WARNING: Removed duplicated region for block: B:45:0x009c A:{LOOP_END, LOOP:0: B:43:0x0096->B:45:0x009c} */
        /* JADX WARNING: Removed duplicated region for block: B:45:0x009c A:{LOOP_END, LOOP:0: B:43:0x0096->B:45:0x009c} */
        public void onClick(android.content.DialogInterface r6, int r7) {
            /*
            r5 = this;
            r6 = org.telegram.messenger.voip.VoIPBaseService.this;
            r0 = "audio";
            r6 = r6.getSystemService(r0);
            r6 = (android.media.AudioManager) r6;
            r0 = org.telegram.messenger.voip.VoIPBaseService.getSharedInstance();
            if (r0 != 0) goto L_0x0011;
        L_0x0010:
            return;
        L_0x0011:
            r0 = org.telegram.messenger.voip.VoIPBaseService.USE_CONNECTION_SERVICE;
            r1 = 2;
            r2 = 1;
            if (r0 == 0) goto L_0x0035;
        L_0x0017:
            r0 = org.telegram.messenger.voip.VoIPBaseService.this;
            r0 = r0.systemCallConnection;
            if (r0 == 0) goto L_0x0035;
        L_0x001d:
        ...
        L_0x0035:
            r0 = org.telegram.messenger.voip.VoIPBaseService.this;
            r3 = r0.audioConfigured;
            r4 = 0;
            if (r3 == 0) goto L_0x0079;
        L_0x003c:
            r3 = org.telegram.messenger.voip.VoIPBaseService.USE_CONNECTION_SERVICE;
            if (r3 != 0) goto L_0x0079;
        L_0x0040:
        ...
        L_0x0046:
            goto L_0x0073;
        L_0x0047:
            r7 = r0.bluetoothScoActive;
            if (r7 == 0) goto L_0x004e;
        L_0x004b:
            r6.stopBluetoothSco();
        L_0x004e:
            r6.setBluetoothScoOn(r4);
        ...
        L_0x0067:
            r0.needSwitchToBluetoothAfterScoActivates = r2;
            r6.startBluetoothSco();	 Catch:{ Throwable -> 0x0073 }
            goto L_0x0073;
        L_0x006d:
        ...
        L_0x0073:
            r6 = org.telegram.messenger.voip.VoIPBaseService.this;
            r6.updateOutputGainControlState();
            goto L_0x008e;
        L_0x0079:
        ...
        L_0x0080:
            r6 = org.telegram.messenger.voip.VoIPBaseService.this;
            r6.audioRouteToSet = r2;
            goto L_0x008e;
        L_0x0085:
            r6 = org.telegram.messenger.voip.VoIPBaseService.this;
            r6.audioRouteToSet = r4;
            goto L_0x008e;
        L_0x008a:
            r6 = org.telegram.messenger.voip.VoIPBaseService.this;
            r6.audioRouteToSet = r1;
        L_0x008e:
            r6 = org.telegram.messenger.voip.VoIPBaseService.this;
            r6 = r6.stateListeners;
            r6 = r6.iterator();
        L_0x0096:
            r7 = r6.hasNext();
        ...
        L_0x009c:
            r7 = r6.next();
            r7 = (org.telegram.messenger.voip.VoIPBaseService.StateListener) r7;
            r7.onAudioSettingsChanged();
            goto L_0x0096;
        L_0x00a6:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.voip.VoIPBaseService$C11173.onClick(android.content.DialogInterface, int):void");
        }
    }

    /* renamed from: org.telegram.messenger.voip.VoIPBaseService$4 */
    class C11184 implements OnPreparedListener {
        C11184() {
        }
    ...
    class C11195 implements Runnable {
        C11195() {
        }
    ...
    class C11217 implements Runnable {
        C11217() {
        }
    ...
    class C11228 implements Runnable {
        C11228() {
        }
    ...
    public class CallConnection extends Connection {
        ...
        public void onDisconnect() {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("ConnectionService onDisconnect");
            }
    ...
    public boolean hasEarpiece() {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m29e("Error while checking earpiece! ", th);
            }
            this.mHasEarpiece = Boolean.TRUE;
        }
    ...
    L_0x000e:
        ...
        r4 = 2131561058; // 0x7f0d0a62 float:1.8747506E38 double:1.053131091E-314;
        r5 = "VoipAudioRoutingBluetooth";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = 0;
        r3[r5] = r4;
        r4 = 2131561059; // 0x7f0d0a63 float:1.8747508E38 double:1.0531310913E-314;
        r6 = "VoipAudioRoutingEarpiece";
        r4 = org.telegram.messenger.LocaleController.getString(r6, r4);
        r3[r2] = r4;
        r2 = 2131561060; // 0x7f0d0a64 float:1.874751E38 double:1.053131092E-314;
        r4 = "VoipAudioRoutingSpeaker";
        r2 = org.telegram.messenger.LocaleController.getString(r4, r2);
        r3[r1] = r2;
        r8 = new int[r8];
        r8 = {2131165428, 2131165461, 2131165476};
    ...
    L_0x005d:
        r0 = r8.getChildAt(r5);
        r0 = (org.telegram.p004ui.ActionBar.BottomSheet.BottomSheetCell) r0;
        r1 = -1;
        r0.setTextColor(r1);
        r5 = r5 + 1;
        goto L_0x0057;
    ...
    public void showNotification(String str, FileLocation fileLocation, Class<? extends Activity> cls) {
        ...
        Builder contentIntent = new Builder(this).setContentTitle(LocaleController.getString("VoipOutgoingCall", C1067R.string.VoipOutgoingCall)).setContentText(str).setSmallIcon(C1067R.C1065drawable.notification).setContentIntent(PendingIntent.getActivity(this, 0, intent, 0));
        if (VERSION.SDK_INT >= 16) {
            ...
            contentIntent.addAction(C1067R.C1065drawable.ic_call_end_white_24dp, LocaleController.getString("VoipEndCall", C1067R.string.VoipEndCall), PendingIntent.getBroadcast(this, 0, intent, 134217728));
        ...
        if (fileLocation != null) {
            ...
            if (imageFromMemory != null) {
                ...
                try {
                    float dp = 160.0f / ((float) AndroidUtilities.m26dp(50.0f));
    ...
    public void startRingtoneAndVibration(int i) {
        ...
        if ((audioManager.getRingerMode() != 0 ? 1 : null) != null) {
            ...
            this.ringtonePlayer.setOnPreparedListener(new C11184());
    ...
    public void onDestroy() {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("=============== VoIPService STOPPING ===============");
        }
        stopForeground(true);
        stopRinging();
        ...
        super.onDestroy();
        sharedInstance = null;
        AndroidUtilities.runOnUIThread(new C11195());
        VoIPController voIPController = this.controller;
        ...
        if (!USE_CONNECTION_SERVICE) {
            ...
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m29e("Error setting audio more to normal", e);
                }
            }
    ...
    L_0x0085:
        ...
        r5 = 2131492875; // 0x7f0c000b float:1.8609214E38 double:1.053097404E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spConnectingId = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = 2131492878; // 0x7f0c000e float:1.860922E38 double:1.0530974054E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spRingbackID = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = 2131492877; // 0x7f0c000d float:1.8609218E38 double:1.053097405E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spFailedID = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = 2131492876; // 0x7f0c000c float:1.8609216E38 double:1.0530974044E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spEndId = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = 2131492874; // 0x7f0c000a float:1.8609212E38 double:1.0530974034E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
    ...
    L_0x010a:
        ...
        org.telegram.messenger.FileLog.m29e(r1, r0);
    L_0x010f:
        r6.callFailed();
    L_0x0112:
        return;
    ...
    public void configureDeviceForCall() {
        ...
        if (defaultSensor != null) {
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m29e("Error initializing proximity sensor", e);
                }
            }
        }
    }
    ...
    public void updateBluetoothHeadsetState(boolean z) {
        if (z != this.isBtHeadsetConnected) {
            ...
            if (!z || isRinging() || this.currentState == 0) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("SCO already active, setting audio routing");
                }
                audioManager.setSpeakerphoneOn(false);
                audioManager.setBluetoothScoOn(true);
            } else {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("startBluetoothSco");
                }
                this.needSwitchToBluetoothAfterScoActivates = true;
    ...
    public Bitmap getRoundAvatarBitmap(TLObject tLObject) {
        ...
        if (bitmap == null) {
            ...
            bitmap = Bitmap.createBitmap(AndroidUtilities.m26dp(42.0f), AndroidUtilities.m26dp(42.0f), Config.ARGB_8888);
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5 = r22;
        r4.<init>(r0, r5);
        r5 = 805306368; // 0x30000000 float:4.656613E-10 double:3.97874211E-315;
        r4.addFlags(r5);
        r5 = new android.app.Notification$Builder;
        r5.<init>(r0);
        r6 = 2131561071; // 0x7f0d0a6f float:1.8747532E38 double:1.053131097E-314;
        ...
        r8 = 2131165698; // 0x7f070202 float:1.794562E38 double:1.052935757E-314;
    ...
    L_0x00b5:
        ...
        org.telegram.messenger.FileLog.m27d(r8);
    L_0x00ba:
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = 2131559662; // 0x7f0d04ee float:1.8744674E38 double:1.053130401E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = 2131561064; // 0x7f0d0a68 float:1.8747518E38 double:1.0531310937E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x0167:
        ...
        r14 = -769226; // 0xfffffffffff44336 float:NaN double:NaN;
        r11.<init>(r14);
        r14 = r12.length();
        r15 = 0;
    ...
    L_0x017f:
        ...
        r14 = 2131165430; // 0x7f0700f6 float:1.7945077E38 double:1.0529356246E-314;
        ...
        r10 = 2131561056; // 0x7f0d0a60 float:1.8747502E38 double:1.05313109E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x01be:
        ...
        r14 = -16733696; // 0xffffffffff00aa00 float:-1.7102387E38 double:NaN;
        r10.<init>(r14);
        r14 = r13.length();
        r15 = 0;
    ...
    L_0x01d6:
        ...
        r12 = 2131165429; // 0x7f0700f5 float:1.7945075E38 double:1.052935624E-314;
    ...
    L_0x0244:
        r13 = 2131361822; // 0x7f0a001e float:1.8343407E38 double:1.053032655E-314;
        goto L_0x024b;
    L_0x0248:
        r13 = 2131361821; // 0x7f0a001d float:1.8343405E38 double:1.0530326546E-314;
    L_0x024b:
        r10.<init>(r12, r13);
        r12 = 2131230851; // 0x7f080083 float:1.8077766E38 double:1.052967947E-314;
        r10.setTextViewText(r12, r1);
        r1 = android.text.TextUtils.isEmpty(r18);
        r12 = 2131230935; // 0x7f0800d7 float:1.8077937E38 double:1.0529679883E-314;
        r13 = 2131230919; // 0x7f0800c7 float:1.8077904E38 double:1.0529679804E-314;
    ...
    L_0x026c:
        ...
        r7 = 2131561072; // 0x7f0d0a70 float:1.8747534E38 double:1.0531310977E-314;
        ...
        goto L_0x02ce;
    L_0x0290:
        r1 = 2131561071; // 0x7f0d0a6f float:1.8747532E38 double:1.053131097E-314;
    ...
    L_0x02a2:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = 2131561057; // 0x7f0d0a61 float:1.8747504E38 double:1.0531310903E-314;
    ...
    L_0x02ce:
        ...
        r2 = 2131230786; // 0x7f080042 float:1.8077635E38 double:1.0529679147E-314;
        r3 = 2131561056; // 0x7f0d0a60 float:1.8747502E38 double:1.05313109E-314;
        r7 = "VoipAnswerCall";
        r3 = org.telegram.messenger.LocaleController.getString(r7, r3);
        r10.setTextViewText(r2, r3);
        r2 = 2131230813; // 0x7f08005d float:1.807769E38 double:1.052967928E-314;
        r3 = org.telegram.messenger.LocaleController.getString(r9, r8);
        r10.setTextViewText(r2, r3);
        r2 = 2131230872; // 0x7f080098 float:1.807781E38 double:1.052967957E-314;
        ...
        r2 = 2131230812; // 0x7f08005c float:1.8077687E38 double:1.0529679276E-314;
    ...
    public void onConnectionStateChanged(int i) {
        ...
        if (i == 3) {
            ...
            if (!this.wasEstablished) {
                ...
                AndroidUtilities.runOnUIThread(new C11217(), 5000);
                if (this.isOutgoing) {
    ...
    public void endConnectionServiceCall(long j) {
        if (USE_CONNECTION_SERVICE) {
            C11228 c11228 = new C11228();
            if (j > 0) {
                AndroidUtilities.runOnUIThread(c11228, j);
            } else {
                c11228.run();
            }
        }
    ...
    private void acceptIncomingCallFromNotification() {
        ...
        if (VERSION.SDK_INT < 23 || checkSelfPermission("android.permission.RECORD_AUDIO") == 0) {
            ...
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m29e("Error starting incall activity", e);
                }
            }
            return;
        }
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m29e("Error starting permission activity", e2);
            }
        }
    }
