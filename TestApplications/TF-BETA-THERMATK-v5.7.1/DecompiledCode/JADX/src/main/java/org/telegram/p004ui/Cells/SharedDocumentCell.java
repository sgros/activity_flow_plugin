...
public class SharedDocumentCell extends FrameLayout implements FileDownloadProgressListener {
    ...
    public SharedDocumentCell(Context context) {
        ...
        this.thumbImageView.setRoundRadius(AndroidUtilities.m26dp(4.0f));
        ...
        String str2 = Theme.key_sharedMedia_startStopLoadIcon;
    ...
    public void setTextAndValueAndTypeAndThumb(String str, String str2, String str3, String str4, int i) {
        ...
        if (str4 != null) {
            ...
            CombinedDrawable createCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m26dp(40.0f), i);
    ...
    public void setDocument(MessageObject messageObject, boolean z) {
        ...
        if (messageObject2 == null || document == null) {
            ...
            objArr[1] = LocaleController.formatString("formatDateAtTime", C1067R.string.formatDateAtTime, LocaleController.getInstance().formatterYear.format(new Date(j)), LocaleController.getInstance().formatterDay.format(new Date(j)));
    ...
    public void updateFileExistIcon() {
        ...
        this.statusImageView.setImageResource(this.loading ? C1067R.C1065drawable.media_doc_pause : C1067R.C1065drawable.media_doc_load);
        this.dateTextView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m26dp(14.0f), 0, LocaleController.isRTL ? AndroidUtilities.m26dp(14.0f) : 0, 0);
        if (this.loading) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(getMeasuredWidth(), (AndroidUtilities.m26dp(34.0f) + this.nameTextView.getMeasuredHeight()) + this.needDivider);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.nameTextView.getLineCount() > 1) {
            int measuredHeight = this.nameTextView.getMeasuredHeight() - AndroidUtilities.m26dp(22.0f);
