...
import org.telegram.p004ui.ArticleViewer.DrawingText;
...
public class TableLayout extends View {
    ...
    public static final Alignment BASELINE = new C29606();
    public static final Alignment BOTTOM;
    private static final int CAN_STRETCH = 2;
    public static final Alignment CENTER = new C29595();
    ...
    public static final Alignment FILL = new C29627();
    public static final int HORIZONTAL = 0;
    private static final int INFLEXIBLE = 0;
    private static final Alignment LEADING = new C29562();
    ...
    private static final Alignment TRAILING = new C29573();
    public static final int UNDEFINED = Integer.MIN_VALUE;
    static final Alignment UNDEFINED_ALIGNMENT = new C29551();
    ...
    private int itemPaddingLeft = AndroidUtilities.m26dp(8.0f);
    private int itemPaddingTop = AndroidUtilities.m26dp(7.0f);
    private Path linePath = new Path();
    private int mAlignmentMode = 1;
    private int mDefaultGap;
    private final Axis mHorizontalAxis = new Axis(this, DEFAULT_ORDER_PRESERVED, null);
    ...
    static final class Arc {
        ...
        public boolean valid = TableLayout.DEFAULT_ORDER_PRESERVED;
    ...
    static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m48of(Class<K> cls, Class<V> cls2) {
    ...
    final class Axis {
        ...
        /* synthetic */ Axis(TableLayout tableLayout, boolean z, C29551 c29551) {
            this(z);
        }
        ...
        private Axis(boolean z) {
            ...
            this.orderPreserved = TableLayout.DEFAULT_ORDER_PRESERVED;
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc of = Assoc.m48of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
        ...
        public PackedMap<Spec, Bounds> getGroupBounds() {
            ...
            if (!this.groupBoundsValid) {
                computeGroupBounds();
                this.groupBoundsValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
            return this.groupBounds;
        }

        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc of = Assoc.m48of(Interval.class, MutableInt.class);
        ...
        private PackedMap<Interval, MutableInt> getForwardLinks() {
            if (this.forwardLinks == null) {
                this.forwardLinks = createLinks(TableLayout.DEFAULT_ORDER_PRESERVED);
            }
            if (!this.forwardLinksValid) {
                computeLinks(this.forwardLinks, TableLayout.DEFAULT_ORDER_PRESERVED);
                this.forwardLinksValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
        ...
        private PackedMap<Interval, MutableInt> getBackwardLinks() {
            ...
            if (!this.backwardLinksValid) {
                ...
                this.backwardLinksValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
        ...
        private void include(List<Arc> list, Interval interval, MutableInt mutableInt) {
            include(list, interval, mutableInt, TableLayout.DEFAULT_ORDER_PRESERVED);
        }
        ...
        public Arc[] getArcs() {
            ...
            if (!this.arcsValid) {
                computeArcs();
                this.arcsValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
            return this.arcs;
        }
        ...
        private boolean relax(int[] iArr, Arc arc) {
            ...
            iArr[i2] = i;
            return TableLayout.DEFAULT_ORDER_PRESERVED;
        }
        ...
        private boolean solve(Arc[] arcArr, int[] iArr) {
            return solve(arcArr, iArr, TableLayout.DEFAULT_ORDER_PRESERVED);
        }
        ...
        public int[] getLeadingMargins() {
            ...
            if (!this.leadingMarginsValid) {
                computeMargins(TableLayout.DEFAULT_ORDER_PRESERVED);
                this.leadingMarginsValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
        ...
        public int[] getTrailingMargins() {
            ...
            if (!this.trailingMarginsValid) {
                ...
                this.trailingMarginsValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
        ...
        private boolean hasWeights() {
            if (!this.hasWeightsValid) {
                ...
                this.hasWeightsValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
        ...
        private void solveAndDistributeSpace(int[] iArr) {
            ...
            if (childCount >= 2) {
                ...
                int i2 = childCount;
                childCount = 0;
                boolean z = TableLayout.DEFAULT_ORDER_PRESERVED;
                while (childCount < i2) {
        ...
        public int[] getLocations() {
            ...
            if (!this.locationsValid) {
                ...
                this.locationsValid = TableLayout.DEFAULT_ORDER_PRESERVED;
            }
    ...
    static class Bounds {
        ...
        /* synthetic */ Bounds(C29551 c29551) {
            this();
        }
     ...
     */
        ...
        L_0x0020:
            ...
            r3 = r1.textHeight;
            r2 = r2 - r3;
            r3 = org.telegram.p004ui.Components.TableLayout.this;
            r3 = r3.itemPaddingTop;
            r2 = r2 - r3;
            r1.textY = r2;
            goto L_0x0037;
        L_0x002f:
            r2 = org.telegram.p004ui.Components.TableLayout.this;
        ...
        L_0x0050:
            ...
            r3 = r1.cell;
            r4 = r1.measuredWidth;
            r0 = org.telegram.p004ui.Components.TableLayout.this;
        ...
        L_0x0084:
            ...
            r4 = r1.textWidth;
            r3 = r3 - r4;
            r4 = org.telegram.p004ui.Components.TableLayout.this;
        ...
        L_0x00c0:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.TableLayout$Child.measure(int, int, boolean):void");
        }
        ...
        public int getTextX() {
            return this.f608x + this.textX;
        }

        public int getTextY() {
            return this.f609y + this.textY;
        }
        ...
        public void draw(Canvas canvas) {
            if (this.cell != null) {
                ...
                float f5;
                int i3 = 0;
                Object obj = this.f608x + this.measuredWidth == TableLayout.this.getMeasuredWidth() ? 1 : null;
                Object obj2 = this.f609y + this.measuredHeight == TableLayout.this.getMeasuredHeight() ? 1 : null;
                int dp = AndroidUtilities.m26dp(3.0f);
                if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                    float[] access$500;
                    float[] access$5002;
                    if (this.f608x == 0 && this.f609y == 0) {
                ...
                if (TableLayout.this.drawLines) {
                    ...
                    if (obj != null) {
                        ...
                        if (i == 0) {
                            ...
                            f = f7;
                            if (obj != null || obj2 == null) {
                                f7 = ((float) (this.f609y + this.measuredHeight)) - f4;
                            } else {
                                f7 = (float) ((this.f609y + this.measuredHeight) - dp);
                            }
                            f6 = f7;
                            i = this.f608x;
                            ...
                            i = this.f608x;
                            if (i == 0 || obj2 == null) {
                                f7 = ((float) this.f608x) - f4;
                            } else {
                                f7 = (float) (i + dp);
                            }
                            f5 = f7;
                            if (obj != null || obj2 == null) {
                                f7 = ((float) (this.f608x + this.measuredWidth)) - f4;
                            } else {
                                f7 = (float) ((this.f608x + this.measuredWidth) - dp);
                            }
                            f2 = f7;
                            i = this.f609y;
    ...
    static final class Interval {
        ...
        public boolean equals(Object obj) {
            ...
            return (this.max == interval.max && this.min == interval.min) ? TableLayout.DEFAULT_ORDER_PRESERVED : false;
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public void setGravity(int i) {
            ...
            this.columnSpec = this.columnSpec.copyWriteAlignment(TableLayout.getAlignment(i, TableLayout.DEFAULT_ORDER_PRESERVED));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (this.columnSpec.equals(layoutParams.columnSpec) && this.rowSpec.equals(layoutParams.rowSpec)) ? TableLayout.DEFAULT_ORDER_PRESERVED : false;
        }
    ...
    static final class PackedMap<K, V> {
        ...
        /* synthetic */ PackedMap(Object[] objArr, Object[] objArr2, C29551 c29551) {
            this(objArr, objArr2);
        }

        private PackedMap(K[] kArr, V[] vArr) {
            this.index = PackedMap.createIndex(kArr);
            this.keys = PackedMap.compact(kArr, this.index);
            this.values = PackedMap.compact(vArr, this.index);
        }
    ...
    public static class Spec {
        ...
        /* synthetic */ Spec(boolean z, int i, int i2, Alignment alignment, float f, C29551 c29551) {
        ...
        public boolean equals(Object obj) {
            ...
            Spec spec = (Spec) obj;
            return (this.alignment.equals(spec.alignment) && this.span.equals(spec.span)) ? TableLayout.DEFAULT_ORDER_PRESERVED : false;
        }
    ...
    static class C29551 extends Alignment {
    ...
    static class C29562 extends Alignment {
        public int getAlignmentValue(Child child, int i) {
            return 0;
        }
    ...
    static class C29573 extends Alignment {
        public int getAlignmentValue(Child child, int i) {
            return i;
        }
    ...
    static class C29595 extends Alignment {
        public int getAlignmentValue(Child child, int i) {
            return i >> 1;
        }
    ...
    static class C29606 extends Alignment {

        /* renamed from: org.telegram.ui.Components.TableLayout$6$1 */
        class C29611 extends Bounds {
            private int size;
    ...
    static class C29627 extends Alignment {
        public int getAlignmentValue(Child child, int i) {
            return Integer.MIN_VALUE;
        }
    ...
    static /* synthetic */ void access$1700(String str) {
        TableLayout.handleInvalidParams(str);
        throw null;
    }
    ...
    private int getDefaultMargin(Child child, LayoutParams layoutParams, boolean z, boolean z2) {
        ...
        boolean z4 = (z && this.isRtl) ? DEFAULT_ORDER_PRESERVED : false;
    ...
    private int getTotalMargin(Child child, boolean z) {
        return getMargin(child, z, DEFAULT_ORDER_PRESERVED) + getMargin(child, z, false);
    }
    ...
    private void validateLayoutParams() {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            int clip = TableLayout.clip(interval2, z2, i);
            if (z2) {
                i3 = interval2.min;
            }
            if (i != 0) {
                if (!z || !z2) {
                    while (true) {
                        int i5 = i3 + clip;
                        if (TableLayout.fits(iArr, i2, i3, i5)) {
                            break;
                        } else if (z2) {
                            i2++;
                        } else if (i5 <= i) {
                ...
                TableLayout.procrusteanFill(iArr, i3, i3 + clip, i2 + size);
            }
            if (obj != null) {
                TableLayout.setCellGroup(layoutParams, i2, size, i3, clip);
            } else {
                TableLayout.setCellGroup(layoutParams, i3, clip, i2, size);
            }
            i3 += clip;
        }
    }
    ...
    private void measureChildWithMargins2(Child child, int i, int i2, int i3, int i4, boolean z) {
        child.measure(getTotalMargin(child, DEFAULT_ORDER_PRESERVED) + i3, getTotalMargin(child, false) + i4, z);
    }
    ...
    private void measureChildrenWithMargins(int i, int i2, boolean z) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (z) {
                ...
                measureChildWithMargins2(childAt, i, i2, layoutParams.width, layoutParams.height, DEFAULT_ORDER_PRESERVED);
            } else {
    ...
    public void onMeasure(int i, int i2) {
        ...
        measureChildrenWithMargins(i5, i6, DEFAULT_ORDER_PRESERVED);
        ...
        while (i9 < childCount2) {
            ...
            i4 = max;
            max = measurement;
            int offset = bounds.getOffset(this, child, access$1200, measurement + i14, DEFAULT_ORDER_PRESERVED);
            ...
            if (childAt.cell != null) {
                ...
                if (!(childAt.fixedHeight == 0 || childAt.fixedHeight == childCount || childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min > 1)) {
                    ...
                    for (gravityOffset = 0; gravityOffset < measurement; gravityOffset++) {
                        ...
                        if (point.f600x <= ((float) childAt.layoutParams.rowSpec.span.min) && point.f601y > ((float) childAt.layoutParams.rowSpec.span.min)) {
                            obj = 1;
                            break;
                        }
                    }
                ...
                for (i5 = 0; i5 < measurement; i5++) {
                    ...
                    if (child3 != child2) {
                        if (child3.layoutParams.rowSpec.span.min == child2.layoutParams.rowSpec.span.min) {
                            ...
                            child2.measure(child2.measuredWidth, child2.measuredHeight, DEFAULT_ORDER_PRESERVED);
                        } else if (child3.layoutParams.rowSpec.span.min < child2.layoutParams.rowSpec.span.min) {
                            child2.f609y -= measurement2;
                        }
                    }
                }
                i5 = i6;
    ...
    public static Spec spec(int i, Alignment alignment, float f) {
        return TableLayout.spec(i, 1, alignment, f);
    }

    public static Spec spec(int i, int i2, float f) {
        return TableLayout.spec(i, i2, UNDEFINED_ALIGNMENT, f);
    }

    public static Spec spec(int i, float f) {
        return TableLayout.spec(i, 1, f);
    }

    public static Spec spec(int i, int i2, Alignment alignment) {
        return TableLayout.spec(i, i2, alignment, 0.0f);
    }

    public static Spec spec(int i, Alignment alignment) {
        return TableLayout.spec(i, 1, alignment);
    }

    public static Spec spec(int i, int i2) {
        return TableLayout.spec(i, i2, UNDEFINED_ALIGNMENT);
    }

    public static Spec spec(int i) {
        return TableLayout.spec(i, 1);
    }
