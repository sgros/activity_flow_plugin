...
public class LocationController implements NotificationCenterDelegate {
    ...
    public LocationController(int i) {
        ...
        AndroidUtilities.runOnUIThread(new C0527-$$Lambda$LocationController$jwDhs2Wxth9unque4gfUrSG9YJ8(this));
    ...
    private void broadcastLastKnownLocation() {
        if (this.lastKnownLocation != null) {
            ...
            for (int i2 = 0; i2 < this.sharingLocations.size(); i2++) {
                ...
                tL_messages_editMessage.f498id = sharingLocationInfo.mid;
                ...
                this.requests.put(new int[]{ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editMessage, new C3430-$$Lambda$LocationController$GgGvUosGIle_dcnPqBDWFGDVM7A(this, sharingLocationInfo, r5))}[0], 0);
            }
    ...
    public /* synthetic */ void lambda$broadcastLastKnownLocation$2$LocationController(SharingLocationInfo sharingLocationInfo, int[] iArr, TLObject tLObject, TL_error tL_error) {
        if (tL_error != null) {
            if (tL_error.text.equals("MESSAGE_ID_INVALID")) {
                ...
                AndroidUtilities.runOnUIThread(new C0531-$$Lambda$LocationController$xabGRpaKBh9IgfIoS-aqNvjHcyM(this, sharingLocationInfo));
            }
            return;
        }
        ...
        if (!this.sharingLocations.isEmpty()) {
            ...
            while (i < this.sharingLocations.size()) {
                ...
                if (sharingLocationInfo.stopTime <= ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) {
                    ...
                    this.sharingLocationsMap.remove(sharingLocationInfo.did);
                    saveSharingLocation(sharingLocationInfo, 1);
                    AndroidUtilities.runOnUIThread(new C0526-$$Lambda$LocationController$PRv-6ObbwXmRgZBGVbIVGOjYQD8(this, sharingLocationInfo));
                    i--;
                }
                i++;
            }
    ...
    public void cleanup() {
        ...
        stopService();
        Utilities.stageQueue.postRunnable(new C0522-$$Lambda$LocationController$CqwMtWkVqaOCz-mvGUr_tzsuYCI(this));
    }
    ...
    public void addSharingLocation(long j, int i, int i2, Message message) {
        ...
        AndroidUtilities.runOnUIThread(new C0533-$$Lambda$LocationController$zAJ9cmnQja1jAmGuw23-E99HA_0(this, sharingLocationInfo2, sharingLocationInfo));
    }
    ...
    private void loadSharingLocations() {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0521-$$Lambda$LocationController$CedxaXVEsRh3MfbiwLY0cCEiBNY(this));
    }
    ...
    public /* synthetic */ void lambda$loadSharingLocations$9$LocationController() {
        ...
        if (!arrayList.isEmpty()) {
            AndroidUtilities.runOnUIThread(new C0520-$$Lambda$LocationController$0L0Myfw-8A7gbZ9tpB4LMVz7Qgw(this, arrayList2, arrayList3, arrayList));
        }
    }
    ...
    public /* synthetic */ void lambda$null$8$LocationController(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        Utilities.stageQueue.postRunnable(new C0524-$$Lambda$LocationController$KzQNHV5exKVTMUhNM3DuUpb5ALk(this, arrayList3));
    }
    ...
    public /* synthetic */ void lambda$null$7$LocationController(ArrayList arrayList) {
        ...
        AndroidUtilities.runOnUIThread(new C0528-$$Lambda$LocationController$n806eE82hDy_EKjzj-moV7XdY8A(this, arrayList));
    }
    ...
    private void saveSharingLocation(SharingLocationInfo sharingLocationInfo, int i) {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C0532-$$Lambda$LocationController$yQY9F3qag_AziWeeanO81WIpkbw(this, i, sharingLocationInfo));
    }
    ...
    public void removeSharingLocation(long j) {
        Utilities.stageQueue.postRunnable(new C0519-$$Lambda$LocationController$--2b05V3C269L8B6e6NaqY7nkE0(this, j));
    }
    ...
    public /* synthetic */ void lambda$removeSharingLocation$13$LocationController(long j) {
        ...
        if (sharingLocationInfo != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editMessage, new C3428-$$Lambda$LocationController$8lTryql87YvYEN2OCsICR_gOP3g(this));
            this.sharingLocations.remove(sharingLocationInfo);
            saveSharingLocation(sharingLocationInfo, 1);
            AndroidUtilities.runOnUIThread(new C0525-$$Lambda$LocationController$N9sfOku6NSx_Uin6Q7qXme__lGo(this, sharingLocationInfo));
            if (this.sharingLocations.isEmpty()) {
                stop(true);
            }
        }
    ...
    public void removeAllLocationSharings() {
        Utilities.stageQueue.postRunnable(new C0529-$$Lambda$LocationController$unkueEB9icgZn5pQTky3flbGZuo(this));
    }
    ...
    public /* synthetic */ void lambda$removeAllLocationSharings$16$LocationController() {
        for (int i = 0; i < this.sharingLocations.size(); i++) {
            ...
            inputMedia.stopped = true;
            inputMedia.geo_point = new TL_inputGeoPointEmpty();
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_editMessage, new C3431-$$Lambda$LocationController$o4AyynaxXNLOklLrLCjAeV7nwjM(this));
        }
        this.sharingLocations.clear();
        this.sharingLocationsMap.clear();
        saveSharingLocation(null, 2);
        stop(true);
        AndroidUtilities.runOnUIThread(new C0523-$$Lambda$LocationController$Kp3u6_UIa9KXJzaDwAYVrLB6ovM(this));
    }
    ...
    public void loadLiveLocations(long j) {
        if (this.cacheRequests.indexOfKey(j) < 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_getRecentLocations, new C3429-$$Lambda$LocationController$9e6Jr8NCwhd7x0jAE3itGEDvCZ8(this, j));
        }
    }

    public /* synthetic */ void lambda$loadLiveLocations$18$LocationController(long j, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            AndroidUtilities.runOnUIThread(new C0530-$$Lambda$LocationController$w0C2adFKR_FSdQ3YkLyieoe840U(this, j, tLObject));
        }
    }
