...
public class ContactsController {
    ...
    private class MyContentObserver extends ContentObserver {
        private Runnable checkRunnable = C0312xfc86462b.INSTANCE;
    ...
    private void performWriteContactsToPhoneBookInternal(java.util.ArrayList<org.telegram.tgnet.TLRPC.TL_contact> r11) {
        ...
        goto L_0x009d;
        r11 = move-exception;
        org.telegram.messenger.FileLog.m30e(r11);	 Catch:{ all -> 0x0091 }
        if (r0 == 0) goto L_0x009c;
        r0.close();
        return;
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:228:0x0367 in {4, 6, 11, 13, 28, 31, 32, 35, 38, 43, 45, 47, 48, 57, 58, 63, 70, 71, 76, 81, 82, 83, 84, 92, 93, 94, 97, 100, 103, 106, 107, 109, 110, 111, 114, 116, 117, 118, 119, 121, 122, 124, 125, 144, 145, 147, 148, 153, 154, 160, 166, 168, 169, 174, 175, 177, 178, 180, 182, 183, 184, 186, 187, 191, 193, 195, 197, 199, 200, 202, 203, 205, 207, 211, 214, 216, 217, 218, 220, 224, 226, 227} preds:[]
        	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:242)
        	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:52)
        	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:42)
        	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:27)
    ...
    private java.util.HashMap<java.lang.String, org.telegram.messenger.ContactsController.Contact> readContactsFromPhoneBook() {
        ...
        r0.<init>();
        return r0;
        r0 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r0.<init>();	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r3 = org.telegram.messenger.ApplicationLoader.applicationContext;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r3 = r3.getContentResolver();	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r10 = new java.util.HashMap;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r10.<init>();	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r11 = new java.util.ArrayList;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r11.<init>();	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r5 = android.provider.ContactsContract.CommonDataKinds.Phone.CONTENT_URI;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r6 = r1.projectionPhones;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r7 = 0;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r8 = 0;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r9 = 0;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r4 = r3;	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r4 = r4.query(r5, r6, r7, r8, r9);	 Catch:{ Throwable -> 0x033e, all -> 0x0339 }
        r14 = 0;
        r15 = "";
        r9 = 1;
        if (r4 == 0) goto L_0x0208;
        r5 = r4.getCount();	 Catch:{ Throwable -> 0x0201, all -> 0x01fb }
        if (r5 <= 0) goto L_0x01e9;	 Catch:{ Throwable -> 0x0201, all -> 0x01fb }
        ...
        if (r7 == 0) goto L_0x01e5;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r7 = r4.getString(r9);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r8 = 5;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r8 = r4.getString(r8);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r8 != 0) goto L_0x0075;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r8 = r15;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r2 = ".sim";	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r2 = r8.indexOf(r2);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r2 == 0) goto L_0x007f;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r2 = 1;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x0080;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r2 = 0;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r17 = android.text.TextUtils.isEmpty(r7);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r17 == 0) goto L_0x0087;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x00e5;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r7 = org.telegram.PhoneFormat.C0278PhoneFormat.stripExceptNumbers(r7, r9);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r17 = android.text.TextUtils.isEmpty(r7);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r17 == 0) goto L_0x0092;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x00e5;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r12 = "+";	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r14 = r18;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        if (r13 != 0) goto L_0x0156;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r18 = r0;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = 4;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = r4.getString(r0);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r0 != 0) goto L_0x010f;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = r15;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x0113;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r1 = -1;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r3 == r1) goto L_0x0143;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = 0;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r0 = r5 + 1;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r13.contact_id = r5;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r6.put(r9, r13);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r5 = r0;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x015a;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r18 = r0;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r19 = r3;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r0 = 2131560427; // 0x7f0d07eb float:1.8746226E38 double:1.053130779E-314;
        r1 = "PhoneMobile";
        ...
        if (r3 == 0) goto L_0x017f;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x0183;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r2 = 1;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x01da;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r2 = 1;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r14 != r2) goto L_0x019a;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = r13.phoneTypes;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = "PhoneHome";	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r3 = 2131560425; // 0x7f0d07e9 float:1.8746222E38 double:1.053130778E-314;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        goto L_0x01da;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r3 = 2;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r14 != r3) goto L_0x01a7;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        goto L_0x01da;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = 3;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r14 != r0) goto L_0x01b9;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = r13.phoneTypes;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = "PhoneWork";	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r3 = 2131560433; // 0x7f0d07f1 float:1.8746238E38 double:1.053130782E-314;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = org.telegram.messenger.LocaleController.getString(r1, r3);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0.add(r1);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x01da;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = 12;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        if (r14 != r0) goto L_0x01cc;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = r13.phoneTypes;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = "PhoneMain";	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r3 = 2131560426; // 0x7f0d07ea float:1.8746224E38 double:1.0531307785E-314;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = org.telegram.messenger.LocaleController.getString(r1, r3);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0.add(r1);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        goto L_0x01da;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0 = r13.phoneTypes;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = "PhoneOther";	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r3 = 2131560432; // 0x7f0d07f0 float:1.8746236E38 double:1.0531307815E-314;	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r1 = org.telegram.messenger.LocaleController.getString(r1, r3);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        r0.add(r1);	 Catch:{ Throwable -> 0x01f1, all -> 0x01fb }
        ...
        r3 = r4;
        r1 = 0;
        r0 = ",";	 Catch:{ Throwable -> 0x0334, all -> 0x032e }
        r0 = android.text.TextUtils.join(r0, r11);	 Catch:{ Throwable -> 0x0334, all -> 0x032e }
        r5 = android.provider.ContactsContract.Data.CONTENT_URI;	 Catch:{ Throwable -> 0x0334, all -> 0x032e }
        r10 = r21;
        r6 = r10.projectionNames;	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.<init>();	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r7 = "lookup IN (";	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r7);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r0);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r0 = ") AND ";	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r0);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r0 = "mimetype";	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r0);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r0 = " = '";	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r0);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r0 = "vnd.android.cursor.item/name";	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r0);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r0 = "'";	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4.append(r0);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r7 = r4.toString();	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r8 = 0;	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r9 = 0;	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r4 = r19;	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r0 = 1;	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        r2 = r4.query(r5, r6, r7, r8, r9);	 Catch:{ Throwable -> 0x032c, all -> 0x032a }
        if (r2 == 0) goto L_0x031c;
        r3 = r2.moveToNext();	 Catch:{ Throwable -> 0x031a }
        if (r3 == 0) goto L_0x0314;	 Catch:{ Throwable -> 0x031a }
        r3 = 0;	 Catch:{ Throwable -> 0x031a }
        r4 = r2.getString(r3);	 Catch:{ Throwable -> 0x031a }
        r5 = r2.getString(r0);	 Catch:{ Throwable -> 0x031a }
        r6 = 2;	 Catch:{ Throwable -> 0x031a }
        r7 = r2.getString(r6);	 Catch:{ Throwable -> 0x031a }
        r8 = 3;	 Catch:{ Throwable -> 0x031a }
        r9 = r2.getString(r8);	 Catch:{ Throwable -> 0x031a }
        r4 = r1.get(r4);	 Catch:{ Throwable -> 0x031a }
        r4 = (org.telegram.messenger.ContactsController.Contact) r4;	 Catch:{ Throwable -> 0x031a }
        if (r4 == 0) goto L_0x024e;	 Catch:{ Throwable -> 0x031a }
        r11 = r4.namesFilled;	 Catch:{ Throwable -> 0x031a }
        if (r11 != 0) goto L_0x024e;	 Catch:{ Throwable -> 0x031a }
        r11 = r4.isGoodProvider;	 Catch:{ Throwable -> 0x031a }
        r12 = " ";
        if (r11 == 0) goto L_0x02af;
        if (r5 == 0) goto L_0x027e;
        r4.first_name = r5;	 Catch:{ Throwable -> 0x031a }
        goto L_0x0280;	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r15;	 Catch:{ Throwable -> 0x031a }
        if (r7 == 0) goto L_0x0285;	 Catch:{ Throwable -> 0x031a }
        r4.last_name = r7;	 Catch:{ Throwable -> 0x031a }
        goto L_0x0287;	 Catch:{ Throwable -> 0x031a }
        r4.last_name = r15;	 Catch:{ Throwable -> 0x031a }
        r5 = android.text.TextUtils.isEmpty(r9);	 Catch:{ Throwable -> 0x031a }
        if (r5 != 0) goto L_0x0310;	 Catch:{ Throwable -> 0x031a }
        r5 = r4.first_name;	 Catch:{ Throwable -> 0x031a }
        r5 = android.text.TextUtils.isEmpty(r5);	 Catch:{ Throwable -> 0x031a }
        if (r5 != 0) goto L_0x02ac;	 Catch:{ Throwable -> 0x031a }
        r5 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x031a }
        r5.<init>();	 Catch:{ Throwable -> 0x031a }
        r7 = r4.first_name;	 Catch:{ Throwable -> 0x031a }
        r5.append(r7);	 Catch:{ Throwable -> 0x031a }
        r5.append(r12);	 Catch:{ Throwable -> 0x031a }
        r5.append(r9);	 Catch:{ Throwable -> 0x031a }
        r5 = r5.toString();	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r5;	 Catch:{ Throwable -> 0x031a }
        goto L_0x0310;	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r9;	 Catch:{ Throwable -> 0x031a }
        goto L_0x0310;	 Catch:{ Throwable -> 0x031a }
        r11 = r10.isNotValidNameString(r5);	 Catch:{ Throwable -> 0x031a }
        if (r11 != 0) goto L_0x02c5;	 Catch:{ Throwable -> 0x031a }
        r11 = r4.first_name;	 Catch:{ Throwable -> 0x031a }
        r11 = r11.contains(r5);	 Catch:{ Throwable -> 0x031a }
        if (r11 != 0) goto L_0x02db;	 Catch:{ Throwable -> 0x031a }
        r11 = r4.first_name;	 Catch:{ Throwable -> 0x031a }
        r11 = r5.contains(r11);	 Catch:{ Throwable -> 0x031a }
        if (r11 != 0) goto L_0x02db;	 Catch:{ Throwable -> 0x031a }
        r11 = r10.isNotValidNameString(r7);	 Catch:{ Throwable -> 0x031a }
        if (r11 != 0) goto L_0x0310;	 Catch:{ Throwable -> 0x031a }
        r11 = r4.last_name;	 Catch:{ Throwable -> 0x031a }
        r11 = r11.contains(r7);	 Catch:{ Throwable -> 0x031a }
        if (r11 != 0) goto L_0x02db;	 Catch:{ Throwable -> 0x031a }
        r11 = r4.last_name;	 Catch:{ Throwable -> 0x031a }
        r11 = r5.contains(r11);	 Catch:{ Throwable -> 0x031a }
        if (r11 == 0) goto L_0x0310;	 Catch:{ Throwable -> 0x031a }
        if (r5 == 0) goto L_0x02e0;	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r5;	 Catch:{ Throwable -> 0x031a }
        goto L_0x02e2;	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r15;	 Catch:{ Throwable -> 0x031a }
        r5 = android.text.TextUtils.isEmpty(r9);	 Catch:{ Throwable -> 0x031a }
        if (r5 != 0) goto L_0x0309;	 Catch:{ Throwable -> 0x031a }
        r5 = r4.first_name;	 Catch:{ Throwable -> 0x031a }
        r5 = android.text.TextUtils.isEmpty(r5);	 Catch:{ Throwable -> 0x031a }
        if (r5 != 0) goto L_0x0307;	 Catch:{ Throwable -> 0x031a }
        r5 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x031a }
        r5.<init>();	 Catch:{ Throwable -> 0x031a }
        r11 = r4.first_name;	 Catch:{ Throwable -> 0x031a }
        r5.append(r11);	 Catch:{ Throwable -> 0x031a }
        r5.append(r12);	 Catch:{ Throwable -> 0x031a }
        r5.append(r9);	 Catch:{ Throwable -> 0x031a }
        r5 = r5.toString();	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r5;	 Catch:{ Throwable -> 0x031a }
        goto L_0x0309;	 Catch:{ Throwable -> 0x031a }
        r4.first_name = r9;	 Catch:{ Throwable -> 0x031a }
        if (r7 == 0) goto L_0x030e;	 Catch:{ Throwable -> 0x031a }
        r4.last_name = r7;	 Catch:{ Throwable -> 0x031a }
        goto L_0x0310;	 Catch:{ Throwable -> 0x031a }
        r4.last_name = r15;	 Catch:{ Throwable -> 0x031a }
        r4.namesFilled = r0;	 Catch:{ Throwable -> 0x031a }
        goto L_0x024e;
        ...
        r16.close();	 Catch:{ Exception -> 0x0324 }
        goto L_0x034f;
        r0 = move-exception;
        r2 = r0;
        ...
        r1 = 0;
        r2 = 0;
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ all -> 0x0358 }
        if (r1 == 0) goto L_0x034a;	 Catch:{ all -> 0x0358 }
        r1.clear();	 Catch:{ all -> 0x0358 }
        if (r2 == 0) goto L_0x034f;
        r2.close();	 Catch:{ Exception -> 0x0324 }
        ...
        r4.close();	 Catch:{ Exception -> 0x0361 }
        goto L_0x0366;
        r0 = move-exception;
        r2 = r0;
        org.telegram.messenger.FileLog.m30e(r2);
    ...
    public ContactsController(int i) {
        ...
        if (i == 0) {
            Utilities.globalQueue.postRunnable(new C0310-$$Lambda$ContactsController$IIQVqTpQCvnIY8-p91gfnj3he0s(this));
        }
    }
    ...
    public void cleanup() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                Utilities.globalQueue.postRunnable(new C0294-$$Lambda$ContactsController$6JQLrbPbpNJhoOI_5BGOSFa9lbo(this));
                return;
            }
        }
    }
    ...
    public void checkInviteText() {
        ...
        if (!this.updatingInviteLink) {
            if (this.inviteLink == null || Math.abs((System.currentTimeMillis() / 1000) - ((long) i)) >= 86400) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_help_getInviteText(), new C3361-$$Lambda$ContactsController$kcKNthDEzlD6nPSHQklW5Vw14V8(this), 2);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$checkInviteText$3$ContactsController(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            if (tL_help_inviteText.message.length() != 0) {
                AndroidUtilities.runOnUIThread(new C0297-$$Lambda$ContactsController$A4-cT-_oXrEc9OYs6FogIzF6avE(this, tL_help_inviteText));
            }
        }
    }
    ...
    public String getInviteText(int i) {
        ...
        if (str == null) {
            str = "https://f-droid.org/packages/org.telegram.messenger";
        }
        String str2 = "InviteText2";
        if (i <= 1) {
            return LocaleController.formatString(str2, C1067R.string.InviteText2, str);
        }
        try {
    ...
    L_0x0026:
        ...
        r9 = r9.f534id;	 Catch:{ Throwable -> 0x0055 }
            ...
            for (int i = 0; i < accountsByType.length; i++) {
                ...
                for (int i2 = 0; i2 < 3; i2++) {
                    ...
                    if (currentUser != null) {
                        ...
                        stringBuilder.append(currentUser.f534id);
    ...
    public void checkContacts() {
        Utilities.globalQueue.postRunnable(new C0326-$$Lambda$ContactsController$gch7bRXld1l_k0g1GAfFCoMhjIs(this));
    }

    public /* synthetic */ void lambda$checkContacts$4$ContactsController() {
        if (checkContactsInternal()) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("detected contacts change");
            }
    ...
    public void forceImportContacts() {
        Utilities.globalQueue.postRunnable(new C0315-$$Lambda$ContactsController$PHwuGsXHnbafxq3b4_SbXpvFUkE(this));
    }

    public /* synthetic */ void lambda$forceImportContacts$5$ContactsController() {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("force import contacts");
        }
    ...
    public void syncPhoneBookByAlert(HashMap<String, Contact> hashMap, boolean z, boolean z2, boolean z3) {
        Utilities.globalQueue.postRunnable(new C0333-$$Lambda$ContactsController$zqe6opQgPyDWpCXT4MV8TEtpNRg(this, hashMap, z, z2, z3));
    }

    public /* synthetic */ void lambda$syncPhoneBookByAlert$6$ContactsController(HashMap hashMap, boolean z, boolean z2, boolean z3) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("sync contacts by alert");
        }
    ...
    public void deleteAllContacts(Runnable runnable) {
        ...
        for (int i = 0; i < size; i++) {
            tL_contacts_deleteContacts.f481id.add(MessagesController.getInstance(this.currentAccount).getInputUser(((TL_contact) this.contacts.get(i)).user_id));
        }
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_deleteContacts, new C3358-$$Lambda$ContactsController$Ok5Vywi0AIsSfLPeC7ZAX0Eg0KM(this, runnable));
    }
    ...
    public /* synthetic */ void lambda$deleteAllContacts$8$ContactsController(Runnable runnable, TLObject tLObject, TL_error tL_error) {
        if (tLObject instanceof TL_boolTrue) {
            ...
            this.contactsBookLoaded = false;
            this.lastContactsVersions = "";
            AndroidUtilities.runOnUIThread(new C0313-$$Lambda$ContactsController$Oyly5yQ4u-Oj_ZJTW79_45tDILE(this, runnable));
        }
    }
    ...
    L_0x0026:
        ...
        r9 = r9.f534id;	 Catch:{ Throwable -> 0x0049 }
    ...
    public void resetImportedContacts() {
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_contacts_resetSaved(), C3363-$$Lambda$ContactsController$rEtEE7WzBCVDghotOSTBjLdLnsM.INSTANCE);
    }
    ...
    public void readContacts() {
        synchronized (this.loadContactsSync) {
            ...
            Utilities.stageQueue.postRunnable(new C0300-$$Lambda$ContactsController$DgnS7Gvt4et5oNJCSlLnfIbm4Ag(this));
        }
    }
    ...
    public void migratePhoneBookToV7(SparseArray<Contact> sparseArray) {
        Utilities.globalQueue.postRunnable(new C0298-$$Lambda$ContactsController$BUiF7Jzba7DA47bmyOp4BvMiTjQ(this, sparseArray));
    }
    ...
    public void performSyncPhoneBook(HashMap<String, Contact> hashMap, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6) {
        ...
        Utilities.globalQueue.postRunnable(new C0321-$$Lambda$ContactsController$bP_Wp_ENz0cZTKPV19hn5HbOllw(this, hashMap, z3, z, z2, z4, z5, z6));
    }
    ...
    L_0x05c6:
        ...
        r21 = r25;
        r8 = org.telegram.messenger.Utilities.stageQueue;
        r9 = new org.telegram.messenger.-$$Lambda$ContactsController$-jMNdC01NspFJ8mldMYkB_XJE88;
        r0 = r9;
        r1 = r26;
        r2 = r19;
        r3 = r14;
    ...
    public /* synthetic */ void lambda$null$15$ContactsController(HashMap hashMap, HashMap hashMap2, boolean z, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4) {
        ...
        AndroidUtilities.runOnUIThread(new C0308-$$Lambda$ContactsController$HLpbAIiF9PYZwFaig6jCvfwgV6A(this, hashMap3, arrayList, hashMap4));
    }
    ...
    public /* synthetic */ void lambda$null$19$ContactsController(HashMap hashMap, SparseArray sparseArray, boolean[] zArr, HashMap hashMap2, TL_contacts_importContacts tL_contacts_importContacts, int i, HashMap hashMap3, boolean z, HashMap hashMap4, ArrayList arrayList, HashMap hashMap5, TLObject tLObject, TL_error tL_error) {
        ...
        if (tL_error2 == null) {
            int i2;
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("contacts imported");
            }
            ...
            if (!tL_contacts_importedContacts.retry_contacts.isEmpty()) {
                ...
                zArr[0] = true;
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("result has retry contacts");
                }
            }
        ...
        if (this.completedRequestsCount == i) {
            ...
            Utilities.stageQueue.postRunnable(new C0293-$$Lambda$ContactsController$5_qynEMvCO-Vcwp4tn_AnSTIGhc(this, hashMap3, hashMap2, z, hashMap4, arrayList, hashMap5, zArr));
        }
    }
    ...
    public /* synthetic */ void lambda$null$18$ContactsController(HashMap hashMap, HashMap hashMap2, boolean z, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4, boolean[] zArr) {
        ...
        AndroidUtilities.runOnUIThread(new C0316-$$Lambda$ContactsController$QCec17nQJOhdVmTlR71H9gJSWro(this, hashMap3, arrayList, hashMap4));
        if (zArr[0]) {
            Utilities.globalQueue.postRunnable(new C0328-$$Lambda$ContactsController$jDhNdq7M1sl26gLErTQhOHpc1l4(this), 300000);
        }
    }
    ...
    public /* synthetic */ void lambda$null$21$ContactsController(HashMap hashMap, HashMap hashMap2, boolean z, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4) {
        ...
        AndroidUtilities.runOnUIThread(new C0314-$$Lambda$ContactsController$P0Dtr3FaFqbEIj7kQUrR_yvUd8o(this, hashMap3, arrayList, hashMap4));
    }
    ...
    public /* synthetic */ void lambda$null$23$ContactsController(HashMap hashMap, HashMap hashMap2, boolean z, HashMap hashMap3, ArrayList arrayList, HashMap hashMap4) {
        ...
        AndroidUtilities.runOnUIThread(new C0287-$$Lambda$ContactsController$3JHpI-WMQtsFtzkjJ3kfvTUf7ro(this, hashMap3, arrayList, hashMap4));
    }
    ...
    private int getContactsHash(ArrayList<TL_contact> arrayList) {
        ...
        Collections.sort(arrayList2, C0317-$$Lambda$ContactsController$TrjXA3zXxBZ5H4pd0ZldkUjIm4Y.INSTANCE);
    ...
    public void loadContacts(boolean z, int i) {
        ...
        if (z) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("load contacts from cache");
            }
            MessagesStorage.getInstance(this.currentAccount).getContacts();
            return;
        }
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("load contacts from server");
        }
        TL_contacts_getContacts tL_contacts_getContacts = new TL_contacts_getContacts();
        tL_contacts_getContacts.hash = i;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_getContacts, new C3357-$$Lambda$ContactsController$LgaPvpXbmtv6_BmnTvc8qVOudt4(this, i));
    }
    ...
    public /* synthetic */ void lambda$loadContacts$27$ContactsController(int i, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            if (i == 0 || !(contacts_contacts instanceof TL_contacts_contactsNotModified)) {
                ...
                UserConfig.getInstance(this.currentAccount).saveConfig(false);
                AndroidUtilities.runOnUIThread(new C0324-$$Lambda$ContactsController$gXCq3FitJ9fiYzIr_FTcMY_P3T0(this));
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("load contacts don't change");
                }
            }
        }
    }
    ...
    public void processLoadedContacts(ArrayList<TL_contact> arrayList, ArrayList<User> arrayList2, int i) {
        AndroidUtilities.runOnUIThread(new C0304-$$Lambda$ContactsController$EZvJWephnINCisVyT9aioUlUdEQ(this, arrayList2, i, arrayList));
    }
    ...
    public /* synthetic */ void lambda$processLoadedContacts$35$ContactsController(ArrayList arrayList, int i, ArrayList arrayList2) {
        ...
        Utilities.stageQueue.postRunnable(new C0306-$$Lambda$ContactsController$FhL_9umLAIuYNOniVSTFnjIHfVA(this, i, arrayList2, sparseArray, arrayList, isEmpty));
    }
    ...
    public /* synthetic */ void lambda$null$34$ContactsController(int i, ArrayList arrayList, SparseArray sparseArray, ArrayList arrayList2, boolean z) {
        ...
        SparseArray sparseArray2 = sparseArray;
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m27d("done loading contacts");
        }
        ...
        while (i3 < arrayList.size()) {
            ...
            if (sparseArray2.get(tL_contact.user_id) != null || tL_contact.user_id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m27d("contacts are broken, load from server");
                }
                return;
            }
        }
        ...
        Collections.sort(arrayList3, new C0327-$$Lambda$ContactsController$hjm8gMZUsX8pFMsciXhWnMP28rs(sparseArray2));
        ...
        Collections.sort(arrayList4, C0311-$$Lambda$ContactsController$Io20DZyV84DSau97gyyKYypoUA8.INSTANCE);
        Collections.sort(arrayList5, C0299-$$Lambda$ContactsController$DcIoZeDGqSMeB8gKr5g3ew0Ok2Y.INSTANCE);
        AndroidUtilities.runOnUIThread(new C0285-$$Lambda$ContactsController$1CJ23H1PXk1UitBXEZ5w9tuujVY(this, arrayList, concurrentHashMap, hashMap3, hashMap4, arrayList4, arrayList5, i, z));
        if (!this.delayedContactsUpdate.isEmpty() && this.contactsLoaded && this.contactsBookLoaded) {
            applyContactsUpdates(this.delayedContactsUpdate, null, null, null);
            this.delayedContactsUpdate.clear();
        }
        if (hashMap != null) {
            AndroidUtilities.runOnUIThread(new C0318-$$Lambda$ContactsController$VBtQ6OXrlCuEUdHYI1TREe5kYV4(this, hashMap, hashMap2));
        } else {
            this.contactsLoaded = true;
        }
    }
    ...
    public /* synthetic */ void lambda$null$33$ContactsController(HashMap hashMap, HashMap hashMap2) {
        Utilities.globalQueue.postRunnable(new C0302-$$Lambda$ContactsController$EHQlX5PriiljkxmdW3HZOsijhuY(this, hashMap, hashMap2));
    ...
    private void mergePhonebookAndTelegramContacts(HashMap<String, ArrayList<Object>> hashMap, ArrayList<String> arrayList, HashMap<String, Contact> hashMap2) {
        Utilities.globalQueue.postRunnable(new C0325-$$Lambda$ContactsController$gajOA1_r5XMonBIZ6Lf97P0bD9I(this, new ArrayList(this.contacts), hashMap2, hashMap, arrayList));
    }
    ...
    public /* synthetic */ void lambda$mergePhonebookAndTelegramContacts$39$ContactsController(ArrayList arrayList, HashMap hashMap, HashMap hashMap2, ArrayList arrayList2) {
        ...
        for (ArrayList sort : hashMap2.values()) {
            Collections.sort(sort, C0290-$$Lambda$ContactsController$433Sx76_-fODvK-PjR-GANTzejU.INSTANCE);
        }
        Collections.sort(arrayList2, C0296-$$Lambda$ContactsController$8txvpYjs0528CTiynLTYRW8aKog.INSTANCE);
        AndroidUtilities.runOnUIThread(new C0303-$$Lambda$ContactsController$EJa18fQNfNOetnYr7I8VZ_MtAgo(this, arrayList2, hashMap2));
    }
    ...
    private void updateUnregisteredContacts() {
        ...
        Collections.sort(arrayList, C0330-$$Lambda$ContactsController$mHBJOOEPuO6QrX7ZbJrnWuc_NBQ.INSTANCE);
    ...
    private void buildContactsSectionsArrays(boolean z) {
        if (z) {
            Collections.sort(this.contacts, new C0329-$$Lambda$ContactsController$l3XEyiXk02DazId-mQdpRpST3Co(this));
        }
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        ...
        Collections.sort(arrayList, C0292-$$Lambda$ContactsController$4fSnP4tj8Rx2FPjE7t10auDnEhg.INSTANCE);
        this.usersSectionsDict = hashMap;
    ...
    private void performWriteContactsToPhoneBook() {
        Utilities.phoneBookQueue.postRunnable(new C0301-$$Lambda$ContactsController$E0GDxDm4XOysG7SHcvpj5BVOSkQ(this, new ArrayList(this.contacts)));
    }
    ...
    private void applyContactsUpdates(ArrayList<Integer> arrayList, ConcurrentHashMap<Integer, User> concurrentHashMap, ArrayList<TL_contact> arrayList2, ArrayList<Integer> arrayList3) {
        ...
        while (i < arrayList32.size()) {
            ...
            Utilities.phoneBookQueue.postRunnable(new C0309-$$Lambda$ContactsController$HjkvfPeYk7Ow3aL58FFYm929xXw(this, num));
        ...
        if (obj != null) {
            Utilities.stageQueue.postRunnable(new C0332-$$Lambda$ContactsController$zT0R4MDQT-YLqu-ka0J-Safa99M(this));
        } else {
            AndroidUtilities.runOnUIThread(new C0295-$$Lambda$ContactsController$8jHuChSQV9WMksUcSKrM56MxPqE(this, arrayList22, arrayList32));
        }
    }
    ...
    L_0x0028:
        ...
        r4 = r8.f534id;	 Catch:{ Exception -> 0x0065 }
        r3.append(r4);	 Catch:{ Exception -> 0x0065 }
    ...
    public void markAsContacted(String str) {
        if (str != null) {
            Utilities.phoneBookQueue.postRunnable(new C0320-$$Lambda$ContactsController$ZSZ9C_4-dtPH1zqggEDwmuwv69A(str));
        }
    }
    ...
    public void addContact(User user) {
        if (user != null && !TextUtils.isEmpty(user.phone)) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_importContacts, new C3354-$$Lambda$ContactsController$-Vi-J8-93cHW3trChoxTwI17XeA(this), 6);
        }
    }
    ...
    public /* synthetic */ void lambda$addContact$50$ContactsController(TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            for (int i = 0; i < tL_contacts_importedContacts.users.size(); i++) {
                ...
                Utilities.phoneBookQueue.postRunnable(new C0331-$$Lambda$ContactsController$tvZs_rDgKy4-ldDTgpQkKllXL0E(this, user));
                TL_contact tL_contact = new TL_contact();
                tL_contact.user_id = user.f534id;
                ArrayList arrayList = new ArrayList();
            ...
            AndroidUtilities.runOnUIThread(new C0288-$$Lambda$ContactsController$3Lppzk_aX70-Q6C3adV0V2TBG9k(this, tL_contacts_importedContacts));
        }
    }
    ...
    public /* synthetic */ void lambda$null$49$ContactsController(TL_contacts_importedContacts tL_contacts_importedContacts) {
        ...
        while (it.hasNext()) {
            ...
            if (this.contactsDict.get(Integer.valueOf(user.f534id)) == null) {
                TL_contact tL_contact = new TL_contact();
                tL_contact.user_id = user.f534id;
                this.contacts.add(tL_contact);
                this.contactsDict.put(Integer.valueOf(tL_contact.user_id), tL_contact);
    ...
    public void deleteContact(ArrayList<User> arrayList) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (inputUser != null) {
                    arrayList2.add(Integer.valueOf(user.f534id));
                    tL_contacts_deleteContacts.f481id.add(inputUser);
                }
            }
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_deleteContacts, new C3356-$$Lambda$ContactsController$AcnaGQSIUUZcaRV7Rm4-aExKG2o(this, arrayList2, arrayList));
        }
    }
    ...
    public /* synthetic */ void lambda$deleteContact$53$ContactsController(ArrayList arrayList, ArrayList arrayList2, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            ...
            Utilities.phoneBookQueue.postRunnable(new C0291-$$Lambda$ContactsController$4aPOKb9vaAxgXYIv3F96-1I3WZs(this, arrayList2));
            ...
            AndroidUtilities.runOnUIThread(new C0322-$$Lambda$ContactsController$c7nr2gq-mBuBJyCFVFUiq4lubio(this, arrayList2));
        }
    }
    ...
    public /* synthetic */ void lambda$null$51$ContactsController(ArrayList arrayList) {
        Iterator it = arrayList.iterator();
        while (it.hasNext()) {
            deleteContactFromPhoneBook(((User) it.next()).f534id);
        }
    }
    ...
    public /* synthetic */ void lambda$null$52$ContactsController(ArrayList arrayList) {
        ...
        while (it.hasNext()) {
            User user = (User) it.next();
            TL_contact tL_contact = (TL_contact) this.contactsDict.get(Integer.valueOf(user.f534id));
            if (tL_contact != null) {
                this.contacts.remove(tL_contact);
                this.contactsDict.remove(Integer.valueOf(user.f534id));
                obj = 1;
            }
        }
        if (obj != null) {
    ...
    public void reloadContactsStatuses() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_contacts_getStatuses(), new C3360-$$Lambda$ContactsController$h5vCC-HpjKgEFkNX9o79KFdTfVk(this, edit));
    }
    ...
    public /* synthetic */ void lambda$reloadContactsStatuses$55$ContactsController(Editor editor, TLObject tLObject, TL_error tL_error) {
        if (tL_error == null) {
            AndroidUtilities.runOnUIThread(new C0323-$$Lambda$ContactsController$gWEMQfmNPp3nFPxuDjbs9cZtdo4(this, editor, tLObject));
        }
    }
    ...
    public void loadPrivacySettings() {
        if (this.loadingDeleteInfo == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getAccountTTL(), new C3359-$$Lambda$ContactsController$UpZcB_L92bZrGJkH0CSwUF9nhJQ(this));
        }
        int i = 0;
        while (true) {
            int[] iArr = this.loadingPrivacyInfo;
            if (i < iArr.length) {
                if (iArr[i] == 0) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_getPrivacy, new C3355-$$Lambda$ContactsController$AbTZFLT5AeZ8Xev0g7z_25zx9YM(this, i));
                }
                i++;
            } else {
    ...
    public /* synthetic */ void lambda$loadPrivacySettings$57$ContactsController(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0289-$$Lambda$ContactsController$3k8Ydvk8Rxka6E1rBHMnjl6kFrM(this, tL_error, tLObject));
    }
    ...
    public /* synthetic */ void lambda$loadPrivacySettings$59$ContactsController(int i, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C0305-$$Lambda$ContactsController$EuAKug4zrNU4o4RK27r3kMVoC7I(this, tL_error, tLObject, i));
    }
