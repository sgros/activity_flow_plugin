...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    class C23551 extends AnimatorListenerAdapter {
        C23551() {
        }
    ...
    public PhotoAttachPhotoCell(Context context) {
        ...
        this.videoInfoContainer.setBackgroundResource(C1067R.C1065drawable.phototime);
        this.videoInfoContainer.setPadding(AndroidUtilities.m26dp(3.0f), 0, AndroidUtilities.m26dp(3.0f), 0);
        addView(this.videoInfoContainer, LayoutHelper.createFrame(80, 16, 83));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C1067R.C1065drawable.ic_video);
        ...
        this.checkBox = new CheckBox(context, C1067R.C1065drawable.checkbig);
        this.checkBox.setSize(30);
        this.checkBox.setCheckOffset(AndroidUtilities.m26dp(1.0f));
    ...
    public void onMeasure(int i, int i2) {
        i2 = 0;
        if (this.isVertical) {
            i = MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(80.0f), 1073741824);
            if (!this.isLast) {
                i2 = 6;
            }
            super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp((float) (i2 + 80)), 1073741824));
            return;
        }
        if (!this.isLast) {
            i2 = 6;
        }
        super.onMeasure(MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp((float) (i2 + 80)), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(80.0f), 1073741824));
    }
    ...
    public void setPhotoEntry(PhotoEntry photoEntry, boolean z, boolean z2) {
        ...
        if (str != null) {
            this.imageView.setImage(str, null, getResources().getDrawable(C1067R.C1065drawable.nophotos));
            ...
            if (photoEntry.isVideo) {
                ...
                backupImageView.setImage(stringBuilder.toString(), null, getResources().getDrawable(C1067R.C1065drawable.nophotos));
            } else {
            ...
            this.imageView.setImageResource(C1067R.C1065drawable.nophotos);
        }
    ...
    public void showCheck(boolean z) {
        ...
        if (!(z && this.checkBox.getAlpha() == 1.0f) && (z || this.checkBox.getAlpha() != 0.0f)) {
            ...
            this.animatorSet.addListener(new C23551());
    ...
    L_0x007b:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.PhotoAttachPhotoCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (VERSION.SDK_INT >= 21) {
            accessibilityNodeInfo.addAction(new AccessibilityAction(C1067R.C1066id.acc_action_open_photo, LocaleController.getString("Open", C1067R.string.Open)));
        }
    }

    public boolean performAccessibilityAction(int i, Bundle bundle) {
        if (i == C1067R.C1066id.acc_action_open_photo) {
