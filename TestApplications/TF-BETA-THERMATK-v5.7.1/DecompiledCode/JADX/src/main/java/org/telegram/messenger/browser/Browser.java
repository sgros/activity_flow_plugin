...
public class Browser {
    ...
    static class C10781 implements ServiceConnectionCallback {
        C10781() {
        }
    ...
    private static class NavigationCallback extends CustomTabsCallback {
        ...
        /* synthetic */ NavigationCallback(C10781 c10781) {
            this();
        }
    }
    ...
    public static void bindCustomTabsService(Activity activity) {
        ...
        if (customTabsClient == null) {
            ...
            try {
                ...
                customTabsServiceConnection = new ServiceConnection(new C10781());
    ...
    L_0x003a:
        r0 = new org.telegram.p004ui.ActionBar.AlertDialog[r10];	 Catch:{ Exception -> 0x0072 }
    ...
    L_0x009a:
        r0 = move-exception;
        r2 = r0;
        org.telegram.messenger.FileLog.m30e(r2);	 Catch:{ Exception -> 0x0222 }
    L_0x009f:
    ...
    L_0x00e8:
        ...
        org.telegram.messenger.FileLog.m27d(r4);	 Catch:{ Exception -> 0x0102 }
    L_0x00fe:
        r3 = r3 + 1;
        goto L_0x00d2;
    L_0x0101:
    ...
    L_0x0180:
        ...
        org.telegram.messenger.FileLog.m27d(r2);	 Catch:{ Exception -> 0x01ad }
        r1 = r1 + 1;
        goto L_0x017a;
    L_0x01ad:
    ...
    L_0x01b9:
        ...
        r3 = "CopyLink";
        r4 = 2131559164; // 0x7f0d02fc float:1.8743664E38 double:1.053130155E-314;
        ...
        r1 = "actionBarDefault";
        r1 = org.telegram.p004ui.ActionBar.Theme.getColor(r1);	 Catch:{ Exception -> 0x0222 }
        ...
        r3 = 2131165214; // 0x7f07001e float:1.7944639E38 double:1.052935518E-314;
        r1 = android.graphics.BitmapFactory.decodeResource(r1, r3);	 Catch:{ Exception -> 0x0222 }
        r3 = "ShareFile";
        r4 = 2131560748; // 0x7f0d092c float:1.8746877E38 double:1.0531309376E-314;
        r3 = org.telegram.messenger.LocaleController.getString(r3, r4);	 Catch:{ Exception -> 0x0222 }
    ...
    L_0x022d:
        ...
        r3 = org.telegram.p004ui.LaunchActivity.class;
    ...
    static /* synthetic */ void lambda$null$0(org.telegram.p004ui.ActionBar.AlertDialog[] r3, org.telegram.tgnet.TLObject r4, int r5, android.net.Uri r6, android.content.Context r7, boolean r8) {
        /*
        r0 = 0;
    ...
    static /* synthetic */ void lambda$openUrl$3(AlertDialog[] alertDialogArr, int i) {
        if (alertDialogArr[0] != null) {
            try {
                alertDialogArr[0].setOnCancelListener(new C1076-$$Lambda$Browser$gkq8pxwFDBSthMGmf2aFQ3i1KTE(i));
