...
public class Scroller {
    ...
    L_0x0057:
        ...
        r4 = (float) r4;
        r0.mVelocity = r4;
        r5 = 1145569280; // 0x44480000 float:800.0 double:5.65986426E-315;
        r6 = START_TENSION;
        r6 = r6 * r4;
        r6 = r6 / r5;
        r8 = (double) r6;
    ...
    L_0x00ac:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.Scroller.fling(int, int, int, int, int, int, int, int):void");
    }
