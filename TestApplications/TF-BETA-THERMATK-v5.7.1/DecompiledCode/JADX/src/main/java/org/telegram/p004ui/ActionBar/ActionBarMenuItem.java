...
import org.telegram.p004ui.Components.CloseProgressDrawable2;
...
public class ActionBarMenuItem extends FrameLayout {
    ...
    class C22013 implements Callback {
    ...
    class C22024 implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ...
            if (ActionBarMenuItem.this.clearButton != null) {
                if (!TextUtils.isEmpty(charSequence) || ((ActionBarMenuItem.this.listener != null && ActionBarMenuItem.this.listener.forceShowClear()) || (ActionBarMenuItem.this.searchFieldCaption != null && ActionBarMenuItem.this.searchFieldCaption.getVisibility() == 0))) {
                    ...
                    ActionBarMenuItem.this.clearButton.clearAnimation();
                    if (ActionBarMenuItem.this.animateClear) {
                        ActionBarMenuItem.this.clearButton.animate().setInterpolator(new DecelerateInterpolator()).alpha(0.0f).setDuration(180).scaleY(0.0f).scaleX(0.0f).rotation(45.0f).withEndAction(new C2158-$$Lambda$ActionBarMenuItem$4$WTfAvwLi4l2rOq09wt3w9zvbBZY(this)).start();
                    } else {
        ...
        if (motionEvent.getActionMasked() == 0) {
            if (this.longClickEnabled && hasSubMenu()) {
                ...
                if (actionBarPopupWindow == null || !(actionBarPopupWindow == null || actionBarPopupWindow.isShowing())) {
                    this.showMenuRunnable = new C2163-$$Lambda$ActionBarMenuItem$Y4Ro71_Kozj7zLr98hi2EHrr4-A(this);
    ...
    private void createPopupLayout() {
        if (this.popupLayout == null) {
            ...
            this.popupLayout.setOnTouchListener(new C2162-$$Lambda$ActionBarMenuItem$NEgOkBBuNcW0duabIaP5FYMgH5w(this));
            this.popupLayout.setDispatchKeyEventListener(new C3903-$$Lambda$ActionBarMenuItem$yNUlqFN00bPmohrcR1AdkblquoQ(this));
        }
    }
    ...
    public void addSubItem(int i, View view, int i2, int i3) {
        ...
        view.setOnClickListener(new C2160-$$Lambda$ActionBarMenuItem$9Z-bd6EyKyDSvICVkiunmSXpJnY(this));
    ...
    public TextView addSubItem(int i, CharSequence charSequence) {
        ...
        textView.setMinWidth(AndroidUtilities.m26dp(196.0f));
        ...
        textView.setOnClickListener(new C2156-$$Lambda$ActionBarMenuItem$2OXLLOK5tdU8k_iUBLX7uda6XhM(this));
        return textView;
    }
    ...
    public ActionBarMenuSubItem addSubItem(int i, int i2, CharSequence charSequence) {
        ...
        actionBarMenuSubItem.setMinimumWidth(AndroidUtilities.m26dp(196.0f));
        ...
        actionBarMenuSubItem.setOnClickListener(new C2157-$$Lambda$ActionBarMenuItem$37smKkAzmohk63TzSJQopQof02I(this));
    ...
    L_0x0052:
        r0 = r6.popupWindow;
        r3 = 2131624110; // 0x7f0e00ae float:1.887539E38 double:1.0531622426E-314;
    ...
    L_0x00cc:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ActionBar.ActionBarMenuItem.toggleSubMenu():void");
    }
    ...
    public ActionBarMenuItem setIsSearchField(boolean z) {
        ...
        if (z && this.searchContainer == null) {
            this.searchContainer = new FrameLayout(getContext()) {
                ...
                public void onMeasure(int i, int i2) {
                    ...
                    if (ActionBarMenuItem.this.searchFieldCaption.getVisibility() == 0) {
                        ...
                        measuredWidth = ActionBarMenuItem.this.searchFieldCaption.getMeasuredWidth() + AndroidUtilities.m26dp(4.0f);
                    } else {
                        measuredWidth = 0;
                    }
                ...
                public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                    ...
                    if (!LocaleController.isRTL && ActionBarMenuItem.this.searchFieldCaption.getVisibility() == 0) {
                        i = AndroidUtilities.m26dp(4.0f) + ActionBarMenuItem.this.searchFieldCaption.getMeasuredWidth();
                    }
            ...
            String str = Theme.key_actionBarDefaultSearch;
            ...
            if (VERSION.SDK_INT < 23) {
                this.searchField.setCustomSelectionActionModeCallback(new C22013());
            }
            this.searchField.setOnEditorActionListener(new C2161-$$Lambda$ActionBarMenuItem$DSACM5xoXBBb-9TAnJG5eS-F3HQ(this));
            this.searchField.addTextChangedListener(new C22024());
            ...
            this.clearButton.setOnClickListener(new C2164-$$Lambda$ActionBarMenuItem$_MHVU-Pdp5nAX3_6TiPCB165nO8(this));
            this.clearButton.setContentDescription(LocaleController.getString("ClearButton", C1067R.string.ClearButton));
    ...
    private void updateOrShowPopup(boolean z, boolean z2) {
        ...
        if (actionBarMenu != null) {
            C2190ActionBar c2190ActionBar = actionBarMenu.parentActionBar;
            if (this.subMenuOpenSide == 0) {
                if (z) {
                    this.popupWindow.showAsDropDown(c2190ActionBar, (((getLeft() + this.parentMenu.getLeft()) + getMeasuredWidth()) - this.popupLayout.getMeasuredWidth()) + ((int) getTranslationX()), i);
                }
                if (z2) {
                    this.popupWindow.update(c2190ActionBar, (((getLeft() + this.parentMenu.getLeft()) + getMeasuredWidth()) - this.popupLayout.getMeasuredWidth()) + ((int) getTranslationX()), i, -1, -1);
                    return;
                }
                return;
            }
            if (z) {
                this.popupWindow.showAsDropDown(c2190ActionBar, (getLeft() - AndroidUtilities.m26dp(8.0f)) + ((int) getTranslationX()), i);
            }
            if (z2) {
                this.popupWindow.update(c2190ActionBar, (getLeft() - AndroidUtilities.m26dp(8.0f)) + ((int) getTranslationX()), i, -1, -1);
                return;
            }
            return;
        }
        ...
        if (top == 0) {
            ...
            if (z) {
                this.popupWindow.showAsDropDown(this, -AndroidUtilities.m26dp(8.0f), i);
            }
            if (z2) {
                this.popupWindow.update(this, -AndroidUtilities.m26dp(8.0f), i, -1, -1);
            }
        } else {
            if (z) {
