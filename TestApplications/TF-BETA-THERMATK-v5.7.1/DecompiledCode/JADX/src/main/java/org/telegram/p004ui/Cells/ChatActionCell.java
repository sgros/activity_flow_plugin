...
public class ChatActionCell extends BaseCell {
    ...
    public interface ChatActionCellDelegate {
        ...
        public final /* synthetic */ class C2344-CC {
    ...
    public ChatActionCell(Context context) {
        super(context);
        this.imageReceiver.setRoundRadius(AndroidUtilities.m26dp(32.0f));
        ...
        if (this.customDate != i) {
            ...
            if (charSequence == null || !TextUtils.equals(formatDateChat, charSequence)) {
                ...
                if (this.wasLayout) {
                    ...
                    AndroidUtilities.runOnUIThread(new C2337-$$Lambda$W3vgGEA8PP4iykiyHwC5GJEFtAc(this));
                }
            }
        }
    }
        ...
        if (this.currentMessageObject != messageObject || (!this.hasReplyMessage && messageObject.replyMessageObject != null)) {
            ...
            if (this.currentMessageObject.type == 11) {
                ...
                if (messageObject2.messageOwner.action instanceof TL_messageActionUserUpdatedPhoto) {
                    ...
                    PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(messageObject2.photoThumbs, AndroidUtilities.m26dp(64.0f));
    ...
    L_0x013f:
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ChatActionCell.onTouchEvent(android.view.MotionEvent):boolean");
    }

    private void createLayout(CharSequence charSequence, int i) {
        int dp = i - AndroidUtilities.m26dp(30.0f);
        ...
        this.textY = AndroidUtilities.m26dp(7.0f);
    ...
    public void onMeasure(int i, int i2) {
        if (this.currentMessageObject == null && this.customText == null) {
            setMeasuredDimension(MeasureSpec.getSize(i), this.textHeight + AndroidUtilities.m26dp(14.0f));
            return;
        }
        i = Math.max(AndroidUtilities.m26dp(30.0f), MeasureSpec.getSize(i));
        ...
        setMeasuredDimension(i, i2 + AndroidUtilities.m26dp((float) (14 + i3)));
    }
    ...
    private void buildLayout() {
            ...
            if (message != null) {
                ...
                if (!(messageMedia == null || messageMedia.ttl_seconds == 0)) {
                    if (messageMedia.photo instanceof TL_photoEmpty) {
                        string = LocaleController.getString("AttachPhotoExpired", C1067R.string.AttachPhotoExpired);
                    } else if (messageMedia.document instanceof TL_documentEmpty) {
                        string = LocaleController.getString("AttachVideoExpired", C1067R.string.AttachVideoExpired);
                    } else {
        ...
        if (messageObject != null && messageObject.type == 11) {
            this.imageReceiver.setImageCoords((this.previousWidth - AndroidUtilities.m26dp(64.0f)) / 2, this.textHeight + AndroidUtilities.m26dp(15.0f), AndroidUtilities.m26dp(64.0f), AndroidUtilities.m26dp(64.0f));
        }
    }
    ...
    private int findMaxWidthAroundLine(int i) {
        ...
        for (int i2 = i + 1; i2 < lineCount; i2++) {
            ...
            if (Math.abs(ceil2 - ceil) >= AndroidUtilities.m26dp(10.0f)) {
                break;
            }
        ...
        for (i--; i >= 0; i--) {
            ...
            if (Math.abs(lineCount - ceil) >= AndroidUtilities.m26dp(10.0f)) {
                break;
            }
    ...
    L_0x0017:
        ...
        r14 = org.telegram.messenger.AndroidUtilities.m26dp(r0);
    ...
    L_0x0062:
        r21 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r1 = r1 - r21;
        r21 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r0 = r0 + r21;
    L_0x006e:
    ...
    L_0x00cf:
        ...
        r18 = 2;
        r0 = r0 / 2;
        r25 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r26 = r5 + 1;
        r27 = r11;
        r6 = 3;
        r11 = r0;
    ...
    L_0x00fb:
        ...
        r0 = r11 - r13;
        r3 = (float) r0;
        r0 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r0 = r0 + r5;
        r2 = (float) r0;
        r30 = org.telegram.p004ui.ActionBar.Theme.chat_actionBackgroundPaint;
        r0 = r34;
        r31 = r2;
        r2 = r4;
        r32 = r4;
    ...
    L_0x0187:
        r15 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r1 = r6 + r21;
    ...
    L_0x01a7:
        ...
        r0 = r11 + r28;
        r4 = (float) r0;
        r25 = org.telegram.p004ui.ActionBar.Theme.chat_actionBackgroundPaint;
        r0 = r34;
        r30 = r7;
        r7 = r5;
        r5 = r25;
        r0.drawRect(r1, r2, r3, r4, r5);
    L_0x01c2:
        r0 = org.telegram.p004ui.ActionBar.Theme.chat_cornerInner;
        r1 = 2;
        r0 = r0[r1];
        r5 = r7 + r14;
        r4 = r11 + r14;
    ...
    L_0x022b:
        ...
        r10 = r7;
        r7 = r34;
        r15 = org.telegram.messenger.AndroidUtilities.m26dp(r0);
        goto L_0x024b;
    L_0x0239:
        r31 = r3;
        r29 = r4;
    ...
    L_0x02d3:
        ...
        r8 = r11;
        r11 = r25;
        r17 = 1093664768; // 0x41300000 float:11.0 double:5.4034219E-315;
        goto L_0x03ba;
    L_0x02de:
        r0 = 2;
        if (r10 != r0) goto L_0x0395;
    L_0x02e1:
        r1 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r9 = r6 - r1;
        r1 = org.telegram.messenger.AndroidUtilities.m26dp(r20);
        r11 = r21 + r1;
        r3 = r31 - r14;
    ...
    L_0x0304:
        ...
        r23 = org.telegram.messenger.AndroidUtilities.m26dp(r0);
        r0 = r9 + r23;
        r0 = (float) r0;
        r23 = org.telegram.p004ui.ActionBar.Theme.chat_actionBackgroundPaint;
        r25 = r0;
        r0 = r34;
        r30 = r8;
        r8 = r4;
    ...
    L_0x0359:
        ...
        r0 = r0 + r9;
        r0 = (float) r0;
        r20 = org.telegram.p004ui.ActionBar.Theme.chat_actionBackgroundPaint;
        r23 = r0;
        r0 = r34;
        r29 = r9;
        r9 = r3;
    ...
    L_0x0489:
        r0 = org.telegram.p004ui.ActionBar.Theme.chat_cornerOuter;
        r1 = 0;
        r0 = r0[r1];
        r10 = r6 + r28;
        r2 = r8 + r28;
    ...
    L_0x04b1:
        ...
        r0 = r0 + r15;
        r0 = r0 - r28;
        r2 = org.telegram.p004ui.ActionBar.Theme.chat_cornerOuter;
        r3 = 2;
        r2 = r2[r3];
        r10 = r9 + r28;
        r4 = r0 + r28;
    ...
    L_0x0507:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.ChatActionCell.onDraw(android.graphics.Canvas):void");
    }
