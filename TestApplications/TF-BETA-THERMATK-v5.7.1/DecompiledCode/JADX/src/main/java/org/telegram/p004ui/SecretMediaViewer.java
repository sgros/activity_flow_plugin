...
public class SecretMediaViewer implements NotificationCenterDelegate, OnGestureListener, OnDoubleTapListener {
    ...
    class C32155 extends AnimatorListenerAdapter {
        C32155() {
        }
    ...
    class C32166 extends AnimatorListenerAdapter {
        C32166() {
        }
    ...
    class C32188 extends AnimatorListenerAdapter {
        C32188() {
        }
    ...
    class C32199 extends AnimatorListenerAdapter {
        C32199() {
        }
    ...
    private class PhotoBackgroundDrawable extends ColorDrawable {
        ...
        public void setAlpha(int i) {
            if (SecretMediaViewer.this.parentActivity instanceof LaunchActivity) {
                ...
                boolean z = (SecretMediaViewer.this.isPhotoVisible && i == NalUnitUtil.EXTENDED_SAR) ? false : true;
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        private class Particle {
            ...
            /* synthetic */ Particle(SecretDeleteTimer secretDeleteTimer, C43221 c43221) {
                this();
            }
        }
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.afterDeleteProgressPaint.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
            this.circlePaint = new Paint(1);
            this.circlePaint.setColor(Theme.ACTION_BAR_PHOTO_VIEWER_COLOR);
            this.drawable = context.getResources().getDrawable(C1067R.C1065drawable.flame_small);
            while (i < 40) {
        ...
        private void updateParticles(long j) {
            ...
            while (i < size) {
                ...
                if (f >= f2) {
                    ...
                    float f4 = (float) j;
                    particle.f614x = f + (((f2 * f3) * f4) / 500.0f);
                    particle.f615y += ((particle.f613vy * f3) * f4) / 500.0f;
        ...
        public void onMeasure(int i, int i2) {
            ...
            i = (getMeasuredHeight() / 2) - (AndroidUtilities.m26dp(28.0f) / 2);
            this.deleteProgressRect.set((float) (getMeasuredWidth() - AndroidUtilities.m26dp(49.0f)), (float) i, (float) (getMeasuredWidth() - AndroidUtilities.m26dp(21.0f)), (float) (i + AndroidUtilities.m26dp(28.0f)));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (SecretMediaViewer.this.currentMessageObject != null && SecretMediaViewer.this.currentMessageObject.messageOwner.destroyTime != 0) {
                long duration;
                float f;
                canvas2.drawCircle((float) (getMeasuredWidth() - AndroidUtilities.m26dp(35.0f)), (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.m26dp(16.0f), this.circlePaint);
                ...
                int measuredWidth = getMeasuredWidth() - AndroidUtilities.m26dp(40.0f);
                int measuredHeight = ((getMeasuredHeight() - AndroidUtilities.m26dp(14.0f)) / 2) - AndroidUtilities.m26dp(0.5f);
                this.drawable.setBounds(measuredWidth, measuredHeight, AndroidUtilities.m26dp(10.0f) + measuredWidth, AndroidUtilities.m26dp(14.0f) + measuredHeight);
                ...
                for (measuredHeight = 0; measuredHeight < size; measuredHeight++) {
                    ...
                    canvas2.drawPoint(particle.f614x, particle.f615y, this.particlePaint);
                }
                ...
                d = -Math.cos(d);
                double d3 = -d;
                double dp = (double) AndroidUtilities.m26dp(14.0f);
                Double.isNaN(dp);
                d3 *= dp;
                ...
                while (i < 1) {
                    ...
                    particle2.f612vx = (float) ((Math.cos(nextInt) * sin) - (Math.sin(nextInt) * d));
                    particle2.f613vy = (float) ((Math.sin(nextInt) * sin) + (Math.cos(nextInt) * d));
    ...
    class C43244 extends ActionBarMenuOnItemClick {
        C43244() {
        }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.messagesDeleted) {
            ...
            if (this.currentMessageObject.getId() == ((Message) objArr[0]).f461id) {
                if (!this.isVideo || this.videoWatchedOneTime) {
                    closePhoto(true, true);
                } else {
                    this.closeVideoAfterWatch = true;
                ...
                this.videoPlayer.setDelegate(new VideoPlayerDelegate() {
                    ...
                    public void onError(Exception exception) {
                        if (SecretMediaViewer.this.playerRetryPlayCount > 0) {
                            ...
                            AndroidUtilities.runOnUIThread(new C1964-$$Lambda$SecretMediaViewer$1$dToY1BP1yRZuDyMam95X6X8QLzo(this, file), 100);
                            return;
                        }
        ...
        if (this.parentActivity != activity) {
            ...
            this.windowView = new FrameLayout(activity) {
                ...
                public void onMeasure(int i, int i2) {
                    ...
                    SecretMediaViewer.this.containerView.measure(MeasureSpec.makeMeasureSpec(i, 1073741824), MeasureSpec.makeMeasureSpec(i2, 1073741824));
                }
            ...
            this.containerView = new FrameLayoutDrawer(activity) {
                ...
                public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                    ...
                    if (SecretMediaViewer.this.secretDeleteTimer != null) {
                        int currentActionBarHeight = ((C2190ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.containerView.setOnApplyWindowInsetsListener(new C1968-$$Lambda$SecretMediaViewer$NFiT5K5Ywrc0uS0Pq28kGtaBHeE(this));
            ...
            this.actionBar = new C2190ActionBar(activity);
            ...
            this.actionBar.setTitleRightMargin(AndroidUtilities.m26dp(70.0f));
            this.containerView.addView(this.actionBar, LayoutHelper.createFrame(-1, -2.0f));
            this.actionBar.setActionBarMenuOnItemClick(new C43244());
    ...
    public void openMedia(MessageObject messageObject, PhotoViewerProvider photoViewerProvider) {
        ...
        if (!(this.parentActivity == null || messageObject2 == null || !messageObject.needDrawBluredPreview() || photoViewerProvider2 == null)) {
            ...
            if (placeForPhoto != null) {
                ...
                if (document == null) {
                    i = 2;
                    this.actionBar.setTitle(LocaleController.getString("DisappearingPhoto", C1067R.string.DisappearingPhoto));
                    ...
                    this.actionBar.setTitle(LocaleController.getString("DisappearingGif", C1067R.string.DisappearingGif));
                    imageReceiver = this.centerImage;
                    ...
                    this.actionBar.setTitle(LocaleController.getString("DisappearingVideo", C1067R.string.DisappearingVideo));
                ...
                r2[i] = ObjectAnimator.ofInt(this.photoBackgroundDrawable, str2, new int[]{0, NalUnitUtil.EXTENDED_SAR});
                ...
                this.photoAnimationEndRunnable = new C1967-$$Lambda$SecretMediaViewer$KK7Q-lwTroM_vlzg7v5qjBIm368(this);
                this.imageMoveAnimation.setDuration(250);
                this.imageMoveAnimation.addListener(new C32155());
                ...
                this.photoBackgroundDrawable.drawRunnable = new C1963-$$Lambda$SecretMediaViewer$-WXiS-iPl6V2WQvBv2qBotC4RRs(this, placeForPhoto);
    ...
    private void toggleActionBar(boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            fArr[0] = f;
            arrayList.add(ObjectAnimator.ofFloat(c2190ActionBar, "alpha", fArr));
            this.currentActionBarAnimation = new AnimatorSet();
            this.currentActionBarAnimation.playTogether(arrayList);
            if (!z) {
                this.currentActionBarAnimation.addListener(new C32166());
            }
    ...
    L_0x002d:
        ...
        r9 = 1065520988; // 0x3f828f5c float:1.02 double:5.26437315E-315;
        r8 = r8 * r9;
        r8 = r8 - r7;
        r8 = r8 * r2;
        r7 = r7 + r8;
    ...
    L_0x003c:
        r8 = r0.animateToScale;
        r9 = 1017370368; // 0x3ca3d700 float:0.01999998 double:5.02647748E-315;
        r9 = r9 * r8;
        r2 = r2 - r7;
        r7 = 1036831952; // 0x3dccccd0 float:0.100000024 double:5.12263048E-315;
        r2 = r2 / r7;
        r2 = r6 - r2;
        r9 = r9 * r2;
        r7 = r8 + r9;
    ...
    L_0x017f:
        ...
        r14 = 1123942400; // 0x42fe0000 float:127.0 double:5.553013277E-315;
        r15 = 1132396544; // 0x437f0000 float:255.0 double:5.5947823E-315;
    ...
    L_0x0203:
        ...
        r13 = 1008981770; // 0x3c23d70a float:0.01 double:4.9850323E-315;
    ...
    L_0x02d4:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.SecretMediaViewer.onDraw(android.graphics.Canvas):void");
    }
    ...
    L_0x02be:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.SecretMediaViewer.closePhoto(boolean, boolean):void");
    }
    ...
    private void onPhotoClosed(PlaceProviderObject placeProviderObject) {
        ...
        releasePlayer();
        ArrayList arrayList = new ArrayList();
        AndroidUtilities.runOnUIThread(new C1970-$$Lambda$SecretMediaViewer$WZXZJ3O2MqtXJfvuP6KrDf_oyHw(this), 50);
    }
    ...
    L_0x037f:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.SecretMediaViewer.processTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void animateTo(float f, float f2, float f3, boolean z, int i) {
        if (this.scale != f || this.translationX != f2 || this.translationY != f3) {
            ...
            this.imageMoveAnimation.addListener(new C32199());
            this.imageMoveAnimation.start();
        }
    }
