...
public class SharedLinkCell extends FrameLayout {
    ...
    private int description2Y = AndroidUtilities.m26dp(30.0f);
    private StaticLayout descriptionLayout;
    private StaticLayout descriptionLayout2;
    private TextPaint descriptionTextPaint;
    private int descriptionY = AndroidUtilities.m26dp(30.0f);
    ...
    private int titleY = AndroidUtilities.m26dp(10.0f);
    ...
    public SharedLinkCell(Context context) {
        ...
        this.titleTextPaint.setTextSize((float) AndroidUtilities.m26dp(14.0f));
        this.descriptionTextPaint.setTextSize((float) AndroidUtilities.m26dp(14.0f));
        setWillNotDraw(false);
        this.linkImageView = new ImageReceiver(this);
        this.linkImageView.setRoundRadius(AndroidUtilities.m26dp(4.0f));
    ...
    L_0x0236:
        ...
        r7 = r4;
        r8 = r4;
        r0 = org.telegram.p004ui.Cells.ChatMessageCell.generateStaticLayout(r5, r6, r7, r8, r9, r10);	 Catch:{ Exception -> 0x0263 }
    ...
    L_0x024b:
        ...
        r0 = r0 + r5;
        r5 = org.telegram.messenger.AndroidUtilities.m26dp(r15);	 Catch:{ Exception -> 0x0263 }
        r0 = r0 + r5;
    ...
    L_0x027a:
        ...
        r16 = 1084227584; // 0x40a00000 float:5.0 double:5.356796015E-315;
    ...
    L_0x0284:
        ...
        r8 = r4;
        r10 = r3;
        r0 = org.telegram.p004ui.Cells.ChatMessageCell.generateStaticLayout(r5, r6, r7, r8, r9, r10);	 Catch:{ Exception -> 0x02b1 }
    ...
    L_0x0299:
        ...
        r0 = r0 + r5;
        r5 = org.telegram.messenger.AndroidUtilities.m26dp(r16);	 Catch:{ Exception -> 0x02b1 }
        r0 = r0 + r5;
    ...
    L_0x02b9:
        ...
        r8 = r4;
        r10 = r3;
        r0 = org.telegram.p004ui.Cells.ChatMessageCell.generateStaticLayout(r5, r6, r7, r8, r9, r10);	 Catch:{ Exception -> 0x02d4 }
    ...
    L_0x02ca:
        ...
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r17);	 Catch:{ Exception -> 0x02d4 }
        r0 = r0 + r3;
    ...
    L_0x0331:
        ...
        r7 = org.telegram.messenger.AndroidUtilities.m26dp(r16);	 Catch:{ Exception -> 0x034e }
        r6 = r6 + r7;
        r5 = r5 + r6;
        r1.linkY = r5;	 Catch:{ Exception -> 0x034e }
    L_0x0348:
    ...
    L_0x035f:
        ...
        goto L_0x036e;
    L_0x036a:
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r17);
    L_0x036e:
        ...
        r7 = r3 + r0;
        r8 = 1115422720; // 0x427c0000 float:63.0 double:5.510920465E-315;
    ...
    L_0x0405:
        ...
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r15);
        r0 = r0 + r3;
        r0 = r0 + r2;
        goto L_0x0418;
    L_0x0417:
    ...
    L_0x047a:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.SharedLinkCell.onMeasure(int, int):void");
    }
    ...
    L_0x011c:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.SharedLinkCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.descriptionLayout2 != null) {
            this.descriptionTextPaint.setColor(Theme.getColor(str));
            canvas.save();
            canvas.translate((float) AndroidUtilities.m26dp(LocaleController.isRTL ? 8.0f : (float) AndroidUtilities.leftBaseline), (float) this.description2Y);
        ...
        if (!this.linkLayout.isEmpty()) {
            ...
            for (int i2 = 0; i2 < this.linkLayout.size(); i2++) {
                ...
                if (staticLayout2.getLineCount() > 0) {
                    canvas.save();
                    canvas.translate((float) AndroidUtilities.m26dp(LocaleController.isRTL ? 8.0f : (float) AndroidUtilities.leftBaseline), (float) (this.linkY + i));
