...
public class ProxySettingsActivity extends BaseFragment {
    ...
    class C32122 implements TextWatcher {
    ...
    class C32133 implements TextWatcher {
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        }
    ...
    class C43191 extends ActionBarMenuOnItemClick {
        C43191() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("ProxyDetails", C1067R.string.ProxyDetails));
        this.actionBar.setBackButtonImage(C1067R.C1065drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(false);
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setActionBarMenuOnItemClick(new C43191());
        ...
        while (i < 2) {
            ...
            if (i == 0) {
                this.typeCell[i].setValue(LocaleController.getString("UseProxySocks5", C1067R.string.UseProxySocks5), i == this.currentType, true);
            } else if (i == 1) {
                this.typeCell[i].setValue(LocaleController.getString("UseProxyTelegram", C1067R.string.UseProxyTelegram), i == this.currentType, false);
            }
            this.linearLayout2.addView(this.typeCell[i], LayoutHelper.createLinear(-1, 50));
            this.typeCell[i].setOnClickListener(new C1959-$$Lambda$ProxySettingsActivity$m9BkTAI6IqJctow06HtssG_kLaQ(this));
            i++;
        }
        ...
        for (int i2 = 0; i2 < 5; i2++) {
            ...
            this.inputFields[i2].setLineColors(Theme.getColor(Theme.key_windowBackgroundWhiteInputField), Theme.getColor(Theme.key_windowBackgroundWhiteInputFieldActivated), Theme.getColor(Theme.key_windowBackgroundWhiteRedText3));
            if (i2 == 0) {
                this.inputFields[i2].setInputType(524305);
                this.inputFields[i2].addTextChangedListener(new C32122());
            } else if (i2 == 1) {
                this.inputFields[i2].setInputType(2);
                this.inputFields[i2].addTextChangedListener(new C32133());
            } else if (i2 == 3) {
            ...
            if (i2 == 0) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyAddress", C1067R.string.UseProxyAddress));
                this.inputFields[i2].setText(this.currentProxyInfo.address);
            } else if (i2 == 1) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyPort", C1067R.string.UseProxyPort));
                ...
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyUsername", C1067R.string.UseProxyUsername));
                this.inputFields[i2].setText(this.currentProxyInfo.username);
            } else if (i2 == 3) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxyPassword", C1067R.string.UseProxyPassword));
                this.inputFields[i2].setText(this.currentProxyInfo.password);
            } else if (i2 == 4) {
                this.inputFields[i2].setHintText(LocaleController.getString("UseProxySecret", C1067R.string.UseProxySecret));
            ...
            this.inputFields[i2].setOnEditorActionListener(new C1958-$$Lambda$ProxySettingsActivity$6uZhE0rYQm5lNBN7Lia6YJLxnRo(this));
        }
        ...
        this.bottomCell.setText(LocaleController.getString("UseProxyInfo", C1067R.string.UseProxyInfo));
        ...
        this.shareCell.setText(LocaleController.getString("ShareFile", C1067R.string.ShareFile), false);
        ...
        this.shareCell.setOnClickListener(new C1957-$$Lambda$ProxySettingsActivity$4RcOr5eJR76wYO-TQE9eb5ryku8(this));
        this.sectionCell[1] = new ShadowSectionCell(context2);
        this.sectionCell[1].setBackgroundDrawable(Theme.getThemedDrawable(context2, (int) C1067R.C1065drawable.greydivider_bottom, str2));
    ...
    public /* synthetic */ void lambda$createView$2$ProxySettingsActivity(View view) {
        ...
        try {
            ...
            if (stringBuilder.length() != 0) {
                ...
                Intent createChooser = Intent.createChooser(intent, LocaleController.getString("ShareLink", C1067R.string.ShareLink));
    ...
    private void updateUiForType() {
        ...
        if (i == 0) {
            ...
            TextInfoPrivacyCell textInfoPrivacyCell = this.bottomCell;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(LocaleController.getString("UseProxyTelegramInfo", C1067R.string.UseProxyTelegramInfo));
            stringBuilder.append("\n\n");
            stringBuilder.append(LocaleController.getString("UseProxyTelegramInfo2", C1067R.string.UseProxyTelegramInfo2));
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        strArr[0] = "textView";
        arrayList.add(new ThemeDescription(view, 0, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteBlueText4));
        ...
        while (true) {
            ...
            arrayList.add(new ThemeDescription(typeCellArr[i], ThemeDescription.FLAG_BACKGROUND, null, null, null, null, Theme.key_windowBackgroundWhite));
            arrayList.add(new ThemeDescription(this.typeCell[i], 0, new Class[]{TypeCell.class}, new String[]{r6}, null, null, null, Theme.key_windowBackgroundWhiteBlackText));
            arrayList.add(new ThemeDescription(this.typeCell[i], ThemeDescription.FLAG_IMAGECOLOR, new Class[]{TypeCell.class}, new String[]{"checkImage"}, null, null, null, Theme.key_featuredStickers_addedIcon));
            i++;
        }
        ...
        arrayList.add(new ThemeDescription(this.headerCell, 0, new Class[]{HeaderCell.class}, new String[]{r6}, null, null, null, Theme.key_windowBackgroundWhiteBlueHeader));
        for (i = 0; i < 2; i++) {
            arrayList.add(new ThemeDescription(this.sectionCell[i], ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{ShadowSectionCell.class}, null, null, null, Theme.key_windowBackgroundGrayShadow));
        }
        ...
        arrayList.add(new ThemeDescription(this.bottomCell, 0, new Class[]{TextInfoPrivacyCell.class}, new String[]{r6}, null, null, null, Theme.key_windowBackgroundWhiteGrayText4));
        arrayList.add(new ThemeDescription(this.bottomCell, ThemeDescription.FLAG_LINKCOLOR, new Class[]{TextInfoPrivacyCell.class}, new String[]{r6}, null, null, null, Theme.key_windowBackgroundWhiteLinkText));
