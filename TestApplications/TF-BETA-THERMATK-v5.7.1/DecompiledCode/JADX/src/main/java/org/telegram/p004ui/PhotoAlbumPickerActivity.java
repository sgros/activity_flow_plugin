...
import org.telegram.p004ui.Cells.PhotoPickerAlbumsCell;
import org.telegram.p004ui.Cells.PhotoPickerSearchCell;
...
public class PhotoAlbumPickerActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C31532 implements OnPreDrawListener {
        C31532() {
        }
    ...
    class C42711 extends ActionBarMenuOnItemClick {
        C42711() {
        }
    ...
    class C42723 implements PhotoPickerActivityDelegate {
        C42723() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                photoPickerSearchCell.setDelegate(new C3810x5cc9691c(this));
            } else {
                photoPickerSearchCell = new PhotoPickerAlbumsCell(this.mContext);
                photoPickerSearchCell.setDelegate(new C3811x7e4d1f69(this));
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C42711());
        this.actionBar.createMenu().addItem(1, (int) C1067R.C1065drawable.ic_ab_other).setContentDescription(LocaleController.getString("AccDescrMoreOptions", C1067R.string.AccDescrMoreOptions));
        this.fragmentView = new FrameLayout(context);
        FrameLayout frameLayout = (FrameLayout) this.fragmentView;
        frameLayout.setBackgroundColor(Theme.ACTION_BAR_VIDEO_EDIT_COLOR);
        this.actionBar.setTitle(LocaleController.getString("Gallery", C1067R.string.Gallery));
        this.listView = new RecyclerListView(context);
        this.listView.setPadding(AndroidUtilities.m26dp(4.0f), 0, AndroidUtilities.m26dp(4.0f), AndroidUtilities.m26dp(4.0f));
        ...
        layoutParams2.bottomMargin = AndroidUtilities.m26dp(48.0f);
        this.emptyView.setLayoutParams(layoutParams2);
        this.emptyView.setOnTouchListener(C1831-$$Lambda$PhotoAlbumPickerActivity$2ZdkXHoPXptp2wpUszGZ5G4bMiQ.INSTANCE);
        ...
        layoutParams3.height = AndroidUtilities.m26dp(48.0f);
        layoutParams3.gravity = 80;
        this.pickerBottomLayout.setLayoutParams(layoutParams3);
        this.pickerBottomLayout.cancelButton.setOnClickListener(new C1832-$$Lambda$PhotoAlbumPickerActivity$jb2cegQfO3FSxtdYFSya79907zs(this));
        this.pickerBottomLayout.doneButton.setOnClickListener(new C1833-$$Lambda$PhotoAlbumPickerActivity$vKBIYwKpMugrhprvLvaDbPzl8M0(this));
        if (this.loading) {
        ...
        if (i == NotificationCenter.albumsDidLoad) {
            ...
            if (i == 0) {
                ...
                while (it.hasNext()) {
                    ...
                    this.recentImagesWebKeys.put(searchImage.f55id, searchImage);
                }
            } else if (i == 1) {
                ...
                while (it.hasNext()) {
                    searchImage = (SearchImage) it.next();
                    this.recentImagesGifKeys.put(searchImage.f55id, searchImage);
                }
            }
        }
    }
        ...
        if (!hashMap.isEmpty() && this.delegate != null && !this.sendPressed) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj3 instanceof PhotoEntry) {
                    ...
                    if (i2 == 0) {
                        SearchImage searchImage2 = (SearchImage) this.recentImagesWebKeys.get(searchImage.f55id);
                        ...
                        SearchImage searchImage3 = (SearchImage) this.recentImagesGifKeys.get(searchImage.f55id);
    ...
    private void fixLayout() {
        ...
        if (recyclerListView != null) {
            recyclerListView.getViewTreeObserver().addOnPreDrawListener(new C31532());
        }
    }
    ...
    L_0x004f:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.PhotoAlbumPickerActivity.openPhotoPicker(org.telegram.messenger.MediaController$AlbumEntry, int):void");
    }
}
