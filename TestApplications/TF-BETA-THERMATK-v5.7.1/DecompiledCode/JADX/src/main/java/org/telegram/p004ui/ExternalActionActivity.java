...
public class ExternalActionActivity extends Activity implements ActionBarLayoutDelegate {
    ...
    class C30261 implements OnGlobalLayoutListener {
        C30261() {
        }
    ...
    class C30272 implements Runnable {
        C30272() {
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        getWindow().setBackgroundDrawableResource(C1067R.C1065drawable.transparent);
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            bitmapDrawable = (BitmapDrawable) getResources().getDrawable(C1067R.C1065drawable.catstile);
            ...
            frameLayout.setOnTouchListener(new C1522-$$Lambda$ExternalActionActivity$uCjV_BmhLs5mtl2FVWuHvttAbEQ(this));
            frameLayout.setOnClickListener(C1521-$$Lambda$ExternalActionActivity$u8HNxR8AzNk3ipgQhpw5QlDqvFw.INSTANCE);
            ...
            this.layersActionBarLayout.setBackgroundResource(C1067R.C1065drawable.boxshadow);
    ...
    private void showPasscodeActivity() {
        if (this.passcodeView != null) {
            ...
            this.drawerLayoutContainer.setAllowOpenDrawer(false, false);
            this.passcodeView.setDelegate(new C3690-$$Lambda$ExternalActionActivity$gW5CjfzBu63uWJgg9FkpT1P0Byc(this));
        }
    }
            ...
            if ("org.telegram.passport.AUTHORIZE".equals(intent.getAction())) {
                if (i4 == 0) {
                    ...
                    if (activatedAccountsCount == 0) {
                        ...
                        builder.setMessage(LocaleController.getString("PleaseLoginPassport", C1067R.string.PleaseLoginPassport));
                        builder.setPositiveButton(LocaleController.getString("OK", C1067R.string.f61OK), null);
                        builder.show();
                        return true;
                    } else if (activatedAccountsCount >= 2) {
                        AlertDialog createAccountSelectDialog = AlertsCreator.createAccountSelectDialog(this, new C3688-$$Lambda$ExternalActionActivity$7MenW-e7ZVDhaPYTW6k7H5-jjBA(this, i, intent, z, z2, z3));
                        createAccountSelectDialog.show();
                        createAccountSelectDialog.setCanceledOnTouchOutside(false);
                        createAccountSelectDialog.setOnDismissListener(new C1517-$$Lambda$ExternalActionActivity$HPinU7ZiWQ3pid8nvHDiLL5fIOA(this));
                        return true;
                    }
                }
                ...
                alertDialog.setOnCancelListener(new C1518-$$Lambda$ExternalActionActivity$JSGDZffGA-C8G3znC_C8fmn13dg(i3, iArr));
                alertDialog.show();
                iArr[0] = ConnectionsManager.getInstance(i).sendRequest(tL_account_getAuthorizationForm, new C3687-$$Lambda$ExternalActionActivity$7IhkCSknxlX6e3UV6VR8IaZyD4g(this, iArr, i, alertDialog, tL_account_getAuthorizationForm, stringExtra2, stringExtra), 10);
            } else {
                if (AndroidUtilities.isTablet()) {
                    if (this.layersActionBarLayout.fragmentsStack.isEmpty()) {
    ...
    public /* synthetic */ void lambda$handleIntent$10$ExternalActionActivity(int[] iArr, int i, AlertDialog alertDialog, TL_account_getAuthorizationForm tL_account_getAuthorizationForm, String str, String str2, TLObject tLObject, TL_error tL_error) {
        ...
        if (tL_account_authorizationForm != null) {
            iArr[0] = ConnectionsManager.getInstance(i).sendRequest(new TL_account_getPassword(), new C3689-$$Lambda$ExternalActionActivity$JR-1IB3pX75b9s0gpd--Ar_xSw8(this, alertDialog, i, tL_account_authorizationForm, tL_account_getAuthorizationForm, str, str2));
            return;
        }
        AlertDialog alertDialog2 = alertDialog;
        AndroidUtilities.runOnUIThread(new C1516-$$Lambda$ExternalActionActivity$-9fe3mEaNJ9F6qOli_eauMz3QBw(this, alertDialog, tL_error));
    }
    ...
    public /* synthetic */ void lambda$null$7$ExternalActionActivity(AlertDialog alertDialog, int i, TL_account_authorizationForm tL_account_authorizationForm, TL_account_getAuthorizationForm tL_account_getAuthorizationForm, String str, String str2, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1519-$$Lambda$ExternalActionActivity$Okpye-XNIzLiHpMbfSsCYU0NOVg(this, alertDialog, tLObject, i, tL_account_authorizationForm, tL_account_getAuthorizationForm, str, str2));
    }
    ...
    public /* synthetic */ void lambda$null$9$ExternalActionActivity(AlertDialog alertDialog, TL_error tL_error) {
        try {
            ...
            if ("APP_VERSION_OUTDATED".equals(tL_error.text)) {
                alertDialog = AlertsCreator.showUpdateAppAlert(this, LocaleController.getString("UpdateAppAlert", C1067R.string.UpdateAppAlert), true);
                if (alertDialog != null) {
                    alertDialog.setOnDismissListener(new C1520-$$Lambda$ExternalActionActivity$tLYtJXpiU7Sr8cawZGmHGmD9I2k(this, tL_error));
                    return;
                }
    ...
    public void needLayout() {
        if (AndroidUtilities.isTablet()) {
            ...
            if (!AndroidUtilities.isSmallTablet() || getResources().getConfiguration().orientation == 2) {
                ...
                if (i2 < AndroidUtilities.m26dp(320.0f)) {
                    i2 = AndroidUtilities.m26dp(320.0f);
                }
    ...
    public void fixLayout() {
        if (AndroidUtilities.isTablet()) {
            ...
            if (actionBarLayout != null) {
                actionBarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new C30261());
            }
        }
    }
