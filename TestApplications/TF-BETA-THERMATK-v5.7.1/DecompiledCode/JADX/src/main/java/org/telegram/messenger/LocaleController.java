...
public class LocaleController {
    ...
    private class TimeZoneChangedReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ApplicationLoader.applicationHandler.post(new C0512xc20c151e(this));
        }
    ...
    private java.util.HashMap<java.lang.String, java.lang.String> getLocaleFileStrings(java.io.File r13, boolean r14) {
        ...
        goto L_0x00e8;
        r13 = move-exception;
        org.telegram.messenger.FileLog.m30e(r13);	 Catch:{ all -> 0x00cf }
    ...
    public LocaleController() {
        ...
        if (this.remoteLanguages.isEmpty()) {
            AndroidUtilities.runOnUIThread(new C0510-$$Lambda$LocaleController$NNZIDoHieDUSrd9BgBq36GRonDE(this));
        }
        ...
        AndroidUtilities.runOnUIThread(new C0513-$$Lambda$LocaleController$U712xrnt9cCu1iJYrRj7Tc-xRYo(this));
    }
    ...
    L_0x0042:
        r4 = 3856; // 0xf10 float:5.403E-42 double:1.905E-320;
        if (r3 == r4) goto L_0x0070;
    L_0x0046:
        r4 = 101385; // 0x18c09 float:1.4207E-40 double:5.0091E-319;
    ...
    public void applyLanguage(LocaleInfo localeInfo, boolean z, boolean z2, boolean z3, boolean z4, int i) {
        if (localeInfo != null) {
            ...
            if ((localeInfo.isRemote() || localeInfo.isUnofficial()) && (z4 || !pathToFile.exists() || (hasBaseLang && !pathToBaseFile.exists()))) {
                ...
                if (z2) {
                    AndroidUtilities.runOnUIThread(new C0517-$$Lambda$LocaleController$rPqRyQsgkE1_kSvpx5ngOlMyIY4(this, localeInfo, i));
                } else {
            ...
            try {
                ...
                if (this.reloadLastFile) {
                    if (z2) {
                        AndroidUtilities.runOnUIThread(new C0511-$$Lambda$LocaleController$TG7Fd9ju6kk9LWo1RB9e1CZ_6mk(this, i));
                    } else {
    ...
    public static String getCurrentLanguageName() {
        ...
        return (localeInfo == null || TextUtils.isEmpty(localeInfo.name)) ? getString("LanguageName", C1067R.string.LanguageName) : localeInfo.name;
    }
    ...
    L_0x01a5:
        r10 = (double) r10;
        r3 = 4666723172467343360; // 0x40c3880000000000 float:0.0 double:10000.0;
        java.lang.Double.isNaN(r10);
        r10 = r10 / r3;
        r3 = " %.4f";
    L_0x01b1:
    ...
    public static String formatDate(long j) {
        ...
        try {
            ...
            if (i3 + 1 == i && i2 == i4) {
                return getString("Yesterday", C1067R.string.Yesterday);
            }
            if (Math.abs(System.currentTimeMillis() - j) < 31536000000L) {
    ...
    public static String formatDateAudio(long j) {
        ...
        try {
            ...
            int i4 = instance.get(1);
            if (i3 == i && i2 == i4) {
                return formatString("TodayAtFormatted", C1067R.string.TodayAtFormatted, getInstance().formatterDay.format(new Date(j)));
            } else if (i3 + 1 == i && i2 == i4) {
                return formatString("YesterdayAtFormatted", C1067R.string.YesterdayAtFormatted, getInstance().formatterDay.format(new Date(j)));
            } else {
                String str = "formatDateAtTime";
                if (Math.abs(System.currentTimeMillis() - j) < 31536000000L) {
                    return formatString(str, C1067R.string.formatDateAtTime, getInstance().formatterDayMonth.format(new Date(j)), getInstance().formatterDay.format(new Date(j)));
                }
                return formatString(str, C1067R.string.formatDateAtTime, getInstance().formatterYear.format(new Date(j)), getInstance().formatterDay.format(new Date(j)));
            }
        } catch (Exception e) {
            FileLog.m30e(e);
            return "LOC_ERR";
    ...
    public static String formatDateCallLog(long j) {
        ...
        try {
            ...
            String str = "formatDateAtTime";
            if (Math.abs(System.currentTimeMillis() - j) < 31536000000L) {
                return formatString(str, C1067R.string.formatDateAtTime, getInstance().chatDate.format(new Date(j)), getInstance().formatterDay.format(new Date(j)));
            }
            return formatString(str, C1067R.string.formatDateAtTime, getInstance().chatFullDate.format(new Date(j)), getInstance().formatterDay.format(new Date(j)));
        } catch (Exception e) {
            FileLog.m30e(e);
            return "LOC_ERR";
        }
    ...
    public static String formatLocationUpdateDate(long j) {
        ...
        try {
            ...
            if (i3 == i && i2 == i4) {
                ...
                if (currentTime < 1) {
                    return getString("LocationUpdatedJustNow", C1067R.string.LocationUpdatedJustNow);
                }
                if (currentTime < 60) {
                    return formatPluralString("UpdatedMinutes", currentTime);
                }
                objArr = new Object[1];
                objArr[0] = formatString("TodayAtFormatted", C1067R.string.TodayAtFormatted, getInstance().formatterDay.format(new Date(j)));
                return formatString(str, C1067R.string.LocationUpdatedFormatted, objArr);
            } else if (i3 + 1 == i && i2 == i4) {
                objArr = new Object[1];
                objArr[0] = formatString("YesterdayAtFormatted", C1067R.string.YesterdayAtFormatted, getInstance().formatterDay.format(new Date(j)));
                return formatString(str, C1067R.string.LocationUpdatedFormatted, objArr);
            } else {
                ...
                if (Math.abs(System.currentTimeMillis() - j) < 31536000000L) {
                    ...
                    return formatString(str, C1067R.string.LocationUpdatedFormatted, formatString(str2, C1067R.string.formatDateAtTime, objArr));
                }
    ...
    public static String formatDateOnline(long j) {
        ...
        try {
            ...
            if (i3 == i && i2 == i4) {
                objArr = new Object[1];
                objArr[0] = formatString("TodayAtFormatted", C1067R.string.TodayAtFormatted, getInstance().formatterDay.format(new Date(j)));
                return formatString(str, C1067R.string.LastSeenFormatted, objArr);
            } else if (i3 + 1 == i && i2 == i4) {
                objArr = new Object[1];
                objArr[0] = formatString("YesterdayAtFormatted", C1067R.string.YesterdayAtFormatted, getInstance().formatterDay.format(new Date(j)));
                return formatString(str, C1067R.string.LastSeenFormatted, objArr);
                ...
                if (Math.abs(System.currentTimeMillis() - j) < 31536000000L) {
                    objArr = new Object[]{getInstance().formatterDayMonth.format(new Date(j)), getInstance().formatterDay.format(new Date(j))};
                    return formatString(str, C1067R.string.LastSeenDateFormatted, formatString(str2, C1067R.string.formatDateAtTime, objArr));
                }
                objArr = new Object[]{getInstance().formatterYear.format(new Date(j)), getInstance().formatterDay.format(new Date(j))};
                return formatString(str, C1067R.string.LastSeenDateFormatted, formatString(str2, C1067R.string.formatDateAtTime, objArr));
            }
    ...
    L_0x0073:
        nameDisplayOrder = r3;
        r3 = 2131561223; // 0x7f0d0b07 float:1.874784E38 double:1.0531311723E-314;
        r5 = "formatterMonth";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd MMM";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterDayMonth = r3;
        r3 = 2131561229; // 0x7f0d0b0d float:1.8747853E38 double:1.0531311753E-314;
        r5 = "formatterYear";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd.MM.yy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterYear = r3;
        r3 = 2131561230; // 0x7f0d0b0e float:1.8747855E38 double:1.0531311758E-314;
        r5 = "formatterYearMax";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd.MM.yyyy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterYearMax = r3;
        r3 = 2131561204; // 0x7f0d0af4 float:1.8747802E38 double:1.053131163E-314;
        r5 = "chatDate";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "d MMMM";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.chatDate = r3;
        r3 = 2131561205; // 0x7f0d0af5 float:1.8747804E38 double:1.0531311634E-314;
        r5 = "chatFullDate";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "d MMMM yyyy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.chatFullDate = r3;
        r3 = 2131561228; // 0x7f0d0b0c float:1.874785E38 double:1.053131175E-314;
        r5 = "formatterWeek";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "EEE";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterWeek = r3;
        r3 = 2131561211; // 0x7f0d0afb float:1.8747816E38 double:1.0531311664E-314;
    ...
    L_0x0109:
        r2 = 2131561222; // 0x7f0d0b06 float:1.8747838E38 double:1.053131172E-314;
        r3 = "formatterDay24H";
        goto L_0x0114;
    L_0x010f:
        r2 = 2131561221; // 0x7f0d0b05 float:1.8747836E38 double:1.0531311713E-314;
        r3 = "formatterDay12H";
    L_0x0114:
    ...
    L_0x012b:
        r1 = 2131561227; // 0x7f0d0b0b float:1.8747849E38 double:1.0531311743E-314;
        r2 = "formatterStats24H";
        goto L_0x0136;
    L_0x0131:
        r1 = 2131561226; // 0x7f0d0b0a float:1.8747847E38 double:1.053131174E-314;
    ...
    L_0x014f:
        r1 = 2131561218; // 0x7f0d0b02 float:1.874783E38 double:1.05313117E-314;
        r2 = "formatterBannedUntil24H";
        goto L_0x015a;
    L_0x0155:
        r1 = 2131561217; // 0x7f0d0b01 float:1.8747828E38 double:1.0531311693E-314;
    ...
    L_0x016e:
        r1 = 2131561220; // 0x7f0d0b04 float:1.8747834E38 double:1.053131171E-314;
        r2 = "formatterBannedUntilThisYear24H";
        goto L_0x0179;
    L_0x0174:
        r1 = 2131561219; // 0x7f0d0b03 float:1.8747832E38 double:1.0531311703E-314;
    ...
    public static String formatSectionDate(long j) {
        ...
        try {
            ...
            String[] strArr = new String[]{getString("January", C1067R.string.January), getString("February", C1067R.string.February), getString("March", C1067R.string.March), getString("April", C1067R.string.April), getString("May", C1067R.string.May), getString("June", C1067R.string.June), getString("July", C1067R.string.July), getString("August", C1067R.string.August), getString("September", C1067R.string.September), getString("October", C1067R.string.October), getString("November", C1067R.string.November), getString("December", C1067R.string.December)};
            if (i == i2) {
                return strArr[i3];
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    public static String formatUserStatus(int i, User user, boolean[] zArr) {
        ...
        if (user != null) {
            ...
            if (userStatus != null && userStatus.expires <= 0 && MessagesController.getInstance(i).onlinePrivacy.containsKey(Integer.valueOf(user.f534id))) {
                if (zArr != null) {
                    zArr[0] = true;
                }
                return getString(str, C1067R.string.Online);
            }
        }
        if (user != null) {
            userStatus = user.status;
            if (!(userStatus == null || userStatus.expires == 0 || UserObject.isDeleted(user) || (user instanceof TL_userEmpty))) {
                ...
                if (i2 > i) {
                    ...
                    return getString("Invisible", C1067R.string.Invisible);
                } else {
                    if (i2 == -100) {
                        return getString("Lately", C1067R.string.Lately);
                    }
                    if (i2 == -101) {
                        return getString("WithinAWeek", C1067R.string.WithinAWeek);
                    }
                    if (i2 == -102) {
                        return getString("WithinAMonth", C1067R.string.WithinAMonth);
                    }
                    return formatDateOnline((long) i2);
                }
            }
        }
        return getString("ALongTimeAgo", C1067R.string.ALongTimeAgo);
    }
        ...
        if (!(tL_langPackDifference == null || tL_langPackDifference.strings.isEmpty() || localeInfo == null || localeInfo.isLocal())) {
            ...
            if (i2 != -1) {
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new C0515-$$Lambda$LocaleController$byYfLkXSOjQxKwpHcMJU1BFCcao(this, localeInfo, i2, tL_langPackDifference, localeFileStrings));
                } catch (Exception unused) {
                }
            }
        }
    ...
    public void loadRemoteLanguages(int i) {
        if (!this.loadingRemoteLanguages) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(new TL_langpack_getLanguages(), new C3425-$$Lambda$LocaleController$OO-St8W4lBDCp1N4EzTA2EggA1M(this, i), 8);
        }
    }

    public /* synthetic */ void lambda$loadRemoteLanguages$6$LocaleController(int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0514-$$Lambda$LocaleController$Y6efM2co6N3bq4nUuZDi5VasNV4(this, tLObject, i));
        }
    }
        ...
        if (localeInfo == null || localeInfo.isRemote() || localeInfo.isUnofficial()) {
            ...
            if (localeInfo.hasBaseLang() && (str == null || str.equals(localeInfo.baseLangCode))) {
                if (localeInfo.baseVersion == 0 || z) {
                    ...
                    ConnectionsManager.getInstance(i).sendRequest(tL_langpack_getLangPack, new C3423-$$Lambda$LocaleController$C7GeSsDILXp-14TJUT5eNNANB6o(this, localeInfo, i), 8);
                    ...
                    ConnectionsManager.getInstance(i).sendRequest(tL_langpack_getDifference, new C3427-$$Lambda$LocaleController$s_X_ikLryDU_N2xVuPEFJJqkOk0(this, localeInfo, i), 8);
                }
            }
            ...
            if (localeInfo.version == 0 || z) {
                ...
                ConnectionsManager.getInstance(i).sendRequest(tL_langpack_getLangPack2, new C3426-$$Lambda$LocaleController$h0eSozyCLW0Mpog1omLBJ_00K-I(this, localeInfo, i), 8);
                return;
            }
            ...
            ConnectionsManager.getInstance(i).sendRequest(tL_langpack_getDifference2, new C3424-$$Lambda$LocaleController$JT38tfE7-oOUNrZDivXXSv-b-vg(this, localeInfo, i), 8);
        }
    }
    ...
    public /* synthetic */ void lambda$applyRemoteLanguage$8$LocaleController(LocaleInfo localeInfo, int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0518-$$Lambda$LocaleController$sjCg-VQEumFUYAgaZUDI3dk-dz4(this, localeInfo, tLObject, i));
        }
    }
    ...
    public /* synthetic */ void lambda$applyRemoteLanguage$10$LocaleController(LocaleInfo localeInfo, int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0516-$$Lambda$LocaleController$e6CsiR21q6PI2LDNrAzXcAWuMTk(this, localeInfo, tLObject, i));
        }
    }
    ...
    public /* synthetic */ void lambda$applyRemoteLanguage$12$LocaleController(LocaleInfo localeInfo, int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0509-$$Lambda$LocaleController$BieyCwrY21__jPaUyC1vcjWcFcw(this, localeInfo, tLObject, i));
        }
    }
    ...
    public /* synthetic */ void lambda$applyRemoteLanguage$14$LocaleController(LocaleInfo localeInfo, int i, TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            AndroidUtilities.runOnUIThread(new C0508-$$Lambda$LocaleController$9Gyg-n_UT33Nf2VkVVHA1KrlD90(this, localeInfo, tLObject, i));
        }
    }
    ...
    public String getTranslitString(String str, boolean z, boolean z2) {
        ...
        String str3;
        Object obj;
        HashMap hashMap = this.ruTranslitChars;
        String str4 = "h";
        String str5 = "z";
        String str6 = ImageLoader.AUTOPLAY_FILTER;
        String str7 = "d";
        String str8 = "n";
        String str9 = "t";
        String str10 = "s";
