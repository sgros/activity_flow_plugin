...
public class DialogMeUrlCell extends BaseCell {
    ...
    private int avatarTop = AndroidUtilities.m26dp(10.0f);
    ...
    private int messageTop = AndroidUtilities.m26dp(40.0f);
    ...
    public DialogMeUrlCell(Context context) {
        ...
        this.avatarImage.setRoundRadius(AndroidUtilities.m26dp(26.0f));
    }
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(MeasureSpec.getSize(i), AndroidUtilities.m26dp(72.0f) + this.useSeparator);
    }
    ...
    public void buildLayout() {
        ...
        r21 = this;
        r1 = r21;
        r4 = org.telegram.p004ui.ActionBar.Theme.dialogs_namePaint;
        r10 = org.telegram.p004ui.ActionBar.Theme.dialogs_messagePaint;
        r13 = 0;
    ...
    L_0x00f9:
        ...
        r2 = (float) r2;
        r2 = org.telegram.messenger.AndroidUtilities.m26dp(r2);
        r3 = org.telegram.p004ui.ActionBar.Theme.dialogs_botDrawable;
        r3 = r3.getIntrinsicWidth();
        r2 = r2 + r3;
        r1.nameLeft = r2;
        goto L_0x0130;
    ...
    L_0x0160:
        ...
        goto L_0x0170;
    L_0x016a:
        r0 = org.telegram.messenger.AndroidUtilities.m26dp(r7);
        r1.nameLeft = r0;
    L_0x0170:
        r0 = r1.recentMeUrl;
        r0 = r0.set;
    ...
    L_0x01e7:
        r1.drawNameBroadcast = r6;
        r0 = org.telegram.messenger.AndroidUtilities.m26dp(r5);
        r1.nameLockTop = r0;
    L_0x01ef:
        r0 = r1.recentMeUrl;
        r0 = r0.chat_invite;
    ...
    L_0x0372:
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r5);
        r5 = org.telegram.p004ui.ActionBar.Theme.dialogs_botDrawable;
        r5 = r5.getIntrinsicWidth();
        goto L_0x034d;
    L_0x037d:
        r3 = r1.drawVerified;
    ...
    L_0x0383:
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r14);
        r5 = org.telegram.p004ui.ActionBar.Theme.dialogs_verifiedDrawable;
        r5 = r5.getIntrinsicWidth();
        r3 = r3 + r5;
        r0 = r0 - r3;
    ...
    L_0x0398:
        ...
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r12);
        r15 = java.lang.Math.max(r3, r0);
        r0 = 10;
        r3 = 32;
        r0 = r2.replace(r0, r3);	 Catch:{ Exception -> 0x03c7 }
        r2 = org.telegram.messenger.AndroidUtilities.m26dp(r12);	 Catch:{ Exception -> 0x03c7 }
        r2 = r15 - r2;
    ...
    L_0x0408:
        r3 = 1115815936; // 0x42820000 float:65.0 double:5.51286321E-315;
        goto L_0x040d;
    L_0x040b:
        r3 = 1114898432; // 0x42740000 float:61.0 double:5.50833014E-315;
    L_0x040d:
        r3 = org.telegram.messenger.AndroidUtilities.m26dp(r3);
        r2 = r2 - r3;
    L_0x0412:
    ...
    L_0x0472:
        ...
        r6 = r6 + r8;
        r8 = org.telegram.messenger.AndroidUtilities.m26dp(r14);
        r8 = (double) r8;
        java.lang.Double.isNaN(r8);
        r6 = r6 - r8;
        r8 = org.telegram.p004ui.ActionBar.Theme.dialogs_verifiedDrawable;
    ...
    L_0x0557:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.DialogMeUrlCell.buildLayout():void");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.nameLayout != null) {
            canvas.save();
            canvas.translate((float) this.nameLeft, (float) AndroidUtilities.m26dp(13.0f));
        ...
        if (this.drawVerified) {
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedDrawable, this.nameMuteLeft, AndroidUtilities.m26dp(16.5f));
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedCheckDrawable, this.nameMuteLeft, AndroidUtilities.m26dp(16.5f));
