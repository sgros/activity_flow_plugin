...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C24046 implements TextWatcher {
    ...
    class C24057 implements TextWatcher {
        public void afterTextChanged(Editable editable) {
        }
    ...
    class C39571 extends ActionBarMenuOnItemClick {
        C39571() {
        }
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                    if (!ChannelCreateActivity.this.donePressed && ChannelCreateActivity.this.getParentActivity() != null) {
                        ...
                        if (ChannelCreateActivity.this.imageUpdater.uploadingImage != null) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setOnCancelListener(new C1277-$$Lambda$ChannelCreateActivity$1$b7xFRmQZDJGprfBGkWoRomCKvDQ(this));
                        ...
                        ChannelCreateActivity.this.progressDialog.setOnCancelListener(new C1278-$$Lambda$ChannelCreateActivity$1$q1TLoAihH5rBozhaNhmW5QGac-s(this, i));
                        ChannelCreateActivity.this.progressDialog.show();
                    }
                    ...
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.descriptionTextView.length() == 0) {
                            ...
                            builder.setMessage(LocaleController.getString("ChannelPublicEmptyUsername", C1067R.string.ChannelPublicEmptyUsername));
                            builder.setPositiveButton(LocaleController.getString("Close", C1067R.string.Close), null);
    ...
    public ChannelCreateActivity(Bundle bundle) {
        ...
        if (i == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_checkUsername, new C3611-$$Lambda$ChannelCreateActivity$Dgmh8FVFPsTpRB5V7O64UrcVHdE(this));
            return;
        }
        if (i == 1) {
    ...
    public /* synthetic */ void lambda$new$1$ChannelCreateActivity(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1279-$$Lambda$ChannelCreateActivity$3ctYbjqxEmY29fuS63ZiDPUydpA(this, tL_error));
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C39571());
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString("NewChannel", C1067R.string.NewChannel));
            C39582 c39582 = new SizeNotifierFrameLayout(context2) {
                ...
                L_0x0015:
                    ...
                    if (r0 != 0) goto L_0x0026;
                L_0x001b:
                    r0 = org.telegram.p004ui.ChannelCreateActivity.this;
                    r0 = r0.nameTextView;
                ...
                L_0x0097:
                    r3 = r6 - r3;
                L_0x0099:
                    r6 = org.telegram.p004ui.ChannelCreateActivity.this;
                    r6 = r6.nameTextView;
                ...
                L_0x00d3:
                    ...
                    return;
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChannelCreateActivity$C39582.onLayout(boolean, int, int, int, int):void");
                }
            ...
            c39582.setOnTouchListener(C1289-$$Lambda$ChannelCreateActivity$lIiXta2UxN2m1Vi-R2Lzg4Rdjg4.INSTANCE);
            this.fragmentView = c39582;
            ...
            c39582.addView(this.linearLayout, new LayoutParams(-1, -2));
            ...
            this.avatarOverlay.setOnClickListener(new C1292-$$Lambda$ChannelCreateActivity$s4ZwNFyULCtdH_y7TaKdhDy0a3c(this));
            ...
            this.nameTextView = new EditTextEmoji(context2, c39582, this, 0);
            ...
            this.descriptionTextView.setHint(LocaleController.getString("DescriptionPlaceholder", C1067R.string.DescriptionPlaceholder));
            ...
            this.descriptionTextView.setOnEditorActionListener(new C1286-$$Lambda$ChannelCreateActivity$MiQ4URkqTYXvUua86XByJz6HPDg(this));
            this.descriptionTextView.addTextChangedListener(new C24046());
            ...
            this.helpTextView.setText(LocaleController.getString("DescriptionInfo", C1067R.string.DescriptionInfo));
            ...
            this.actionBar.setTitle(LocaleController.getString("ChannelSettings", C1067R.string.ChannelSettings));
            ...
            this.radioButtonCell1.setOnClickListener(new C1283-$$Lambda$ChannelCreateActivity$ERDUGoRSlmYfCpWGH5A0thCtafY(this));
            ...
            this.radioButtonCell2.setOnClickListener(new C1280-$$Lambda$ChannelCreateActivity$4I7Y-V5uH9YemI181a2NrRWSAsc(this));
            ...
            this.descriptionTextView.setImeOptions(6);
            this.descriptionTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C1067R.string.ChannelUsernamePlaceholder));
            this.descriptionTextView.setCursorColor(Theme.getColor(str2));
            this.descriptionTextView.setCursorSize(AndroidUtilities.m26dp(20.0f));
            this.descriptionTextView.setCursorWidth(1.5f);
            this.publicContainer.addView(this.descriptionTextView, LayoutHelper.createLinear(-1, 36));
            this.descriptionTextView.addTextChangedListener(new C24057());
            ...
            this.privateContainer.setOnClickListener(new C1281-$$Lambda$ChannelCreateActivity$9kLD_6LVZi1jry2jmUaAGbUgTCw(this));
            ...
            this.typeInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context2, (int) C1067R.C1065drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            ...
            this.adminedInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context2, (int) C1067R.C1065drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    public /* synthetic */ void lambda$createView$4$ChannelCreateActivity(View view) {
        this.imageUpdater.openMenu(this.avatar != null, new C1282-$$Lambda$ChannelCreateActivity$B1GdgGV1tK78Cjzb4rWLcAqpV0M(this));
    }
    ...
    private void generateLink() {
        if (!this.loadingInvite && this.invite == null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_exportChatInvite, new C3610-$$Lambda$ChannelCreateActivity$B1f5C5wPqlSBUACduCE1syb6pss(this));
        }
    }

    public /* synthetic */ void lambda$generateLink$10$ChannelCreateActivity(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1276-$$Lambda$ChannelCreateActivity$02OCxzLG_caeGKZbAxcXnBPRtU4(this, tL_error, tLObject));
    }
    ...
    public /* synthetic */ void lambda$null$9$ChannelCreateActivity(TL_error tL_error, TLObject tLObject) {
        ...
        textBlockCell.setText(exportedChatInvite != null ? exportedChatInvite.link : LocaleController.getString("Loading", C1067R.string.Loading), false);
    }
    ...
    private void updatePrivatePublic() {
        if (this.sectionCell != null) {
            ...
            if (z || this.canCreatePublic) {
                ...
                if (this.isPrivate) {
                    i2 = C1067R.string.ChannelInviteLinkTitle;
                    str = "ChannelInviteLinkTitle";
                } else {
                    i2 = C1067R.string.ChannelLinkTitle;
                ...
                if (this.loadingAdminedChannels) {
                    ...
                    textInfoPrivacyCell = this.typeInfoCell;
                    textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(textInfoPrivacyCell.getContext(), (int) C1067R.C1065drawable.greydivider, str));
                    this.loadingAdminedCell.setVisibility(8);
    ...
    public void didUploadPhoto(InputFile inputFile, PhotoSize photoSize, PhotoSize photoSize2) {
        AndroidUtilities.runOnUIThread(new C1290-$$Lambda$ChannelCreateActivity$m0E-xD_NIIwbm9llzALGLpdnpvI(this, inputFile, photoSize2, photoSize));
    }
    ...
    private void loadAdminedChannels() {
        if (!this.loadingAdminedChannels) {
            ...
            updatePrivatePublic();
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_channels_getAdminedPublicChannels(), new C3615-$$Lambda$ChannelCreateActivity$sX4Ap2SwpMlriw_rHlFC0Efiffk(this));
        }
    }

    public /* synthetic */ void lambda$loadAdminedChannels$17$ChannelCreateActivity(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1284-$$Lambda$ChannelCreateActivity$HGsozgXd5QuUD9PHWrJWhWbHHQs(this, tLObject));
    }
    ...
    public /* synthetic */ void lambda$null$16$ChannelCreateActivity(TLObject tLObject) {
        ...
        if (tLObject != null && getParentActivity() != null) {
            ...
            for (i = 0; i < tL_messages_chats.chats.size(); i++) {
                AdminedChannelCell adminedChannelCell = new AdminedChannelCell(getParentActivity(), new C1293-$$Lambda$ChannelCreateActivity$v16kHitJ-P9-5lDgeOrLxNNrfqc(this));
    ...
    public /* synthetic */ void lambda$null$15$ChannelCreateActivity(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C1067R.string.RevokeButton), new C1288-$$Lambda$ChannelCreateActivity$XKw5YNSkvJyf-2lbcB8fcZcxM-I(this, currentChannel));
    ...
    public /* synthetic */ void lambda$null$14$ChannelCreateActivity(Chat chat, DialogInterface dialogInterface, int i) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_updateUsername, new C3614-$$Lambda$ChannelCreateActivity$itNfNKVGl3ReRwzmbqq8toziSoA(this), 64);
    }
    ...
    public /* synthetic */ void lambda$null$13$ChannelCreateActivity(TLObject tLObject, TL_error tL_error) {
        if (tLObject instanceof TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new C1285-$$Lambda$ChannelCreateActivity$L_G3GfO7KOkNy_wD7C5sV0zstvg(this));
        }
    }
    ...
    private boolean checkUserName(String str) {
        ...
        if (str == null || str.length() < 5) {
            ...
            TextView textView = this.checkTextView;
            str2 = Theme.key_windowBackgroundWhiteGrayText8;
            textView.setTag(str2);
            this.checkTextView.setTextColor(Theme.getColor(str2));
            this.lastCheckName = str;
            this.checkRunnable = new C1291-$$Lambda$ChannelCreateActivity$mDP7DqCeyyygG_tNsF0680xfQvY(this, str);
    ...
    public /* synthetic */ void lambda$checkUserName$20$ChannelCreateActivity(String str) {
        ...
        this.checkReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_checkUsername, new C3612-$$Lambda$ChannelCreateActivity$btlKiyTzqeUa7MaXnitfG9ByjcI(this, str), 2);
    }

    public /* synthetic */ void lambda$null$19$ChannelCreateActivity(String str, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1287-$$Lambda$ChannelCreateActivity$ONcbh_gtesiOrY2PbEXECoYX8sk(this, str, tL_error, tLObject));
    }
    ...
    private void showErrorAlert(String str) {
        if (getParentActivity() != null) {
            ...
            if (i == 0) {
                builder.setMessage(LocaleController.getString("LinkInvalid", C1067R.string.LinkInvalid));
            } else if (i != 1) {
                builder.setMessage(LocaleController.getString("ErrorOccurred", C1067R.string.ErrorOccurred));
            } else {
                builder.setMessage(LocaleController.getString("LinkInUse", C1067R.string.LinkInUse));
            }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        C3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c = new C3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c(this);
        ThemeDescription[] themeDescriptionArr = new ThemeDescription[54];
        themeDescriptionArr[0] = new ThemeDescription(this.fragmentView, ThemeDescription.FLAG_CHECKTAG | ThemeDescription.FLAG_BACKGROUND, null, null, null, null, Theme.key_windowBackgroundWhite);
        ...
        themeDescriptionArr[30] = new ThemeDescription(this.privateContainer, 0, new Class[]{TextBlockCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        themeDescriptionArr[31] = new ThemeDescription(this.loadingAdminedCell, 0, new Class[]{LoadingCell.class}, new String[]{"progressBar"}, null, null, null, Theme.key_progressCircle);
        themeDescriptionArr[32] = new ThemeDescription(this.radioButtonCell1, ThemeDescription.FLAG_SELECTOR, null, null, null, null, Theme.key_listSelector);
        view = this.radioButtonCell1;
        int i = ThemeDescription.FLAG_CHECKBOX;
        clsArr = new Class[]{RadioButtonCell.class};
        strArr = new String[1];
        strArr[0] = "radioButton";
        themeDescriptionArr[33] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_radioBackground);
        themeDescriptionArr[34] = new ThemeDescription(this.radioButtonCell1, ThemeDescription.FLAG_CHECKBOXCHECK, new Class[]{RadioButtonCell.class}, new String[]{"radioButton"}, null, null, null, Theme.key_radioBackgroundChecked);
        themeDescriptionArr[35] = new ThemeDescription(this.radioButtonCell1, ThemeDescription.FLAG_TEXTCOLOR, new Class[]{RadioButtonCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        view = this.radioButtonCell1;
        i = ThemeDescription.FLAG_TEXTCOLOR;
        clsArr = new Class[]{RadioButtonCell.class};
        strArr = new String[1];
        strArr[0] = "valueTextView";
        themeDescriptionArr[36] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteGrayText2);
        ...
        themeDescriptionArr[38] = new ThemeDescription(this.radioButtonCell2, ThemeDescription.FLAG_CHECKBOX, new Class[]{RadioButtonCell.class}, new String[]{"radioButton"}, null, null, null, Theme.key_radioBackground);
        themeDescriptionArr[39] = new ThemeDescription(this.radioButtonCell2, ThemeDescription.FLAG_CHECKBOXCHECK, new Class[]{RadioButtonCell.class}, new String[]{"radioButton"}, null, null, null, Theme.key_radioBackgroundChecked);
        themeDescriptionArr[40] = new ThemeDescription(this.radioButtonCell2, ThemeDescription.FLAG_TEXTCOLOR, new Class[]{RadioButtonCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        themeDescriptionArr[41] = new ThemeDescription(this.radioButtonCell2, ThemeDescription.FLAG_TEXTCOLOR, new Class[]{RadioButtonCell.class}, new String[]{"valueTextView"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText2);
        themeDescriptionArr[42] = new ThemeDescription(this.adminnedChannelsLayout, ThemeDescription.FLAG_TEXTCOLOR, new Class[]{AdminedChannelCell.class}, new String[]{"nameTextView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        view = this.adminnedChannelsLayout;
        i = ThemeDescription.FLAG_TEXTCOLOR;
        clsArr = new Class[]{AdminedChannelCell.class};
        strArr = new String[1];
        strArr[0] = "statusTextView";
        themeDescriptionArr[43] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteGrayText);
        themeDescriptionArr[44] = new ThemeDescription(this.adminnedChannelsLayout, ThemeDescription.FLAG_LINKCOLOR, new Class[]{AdminedChannelCell.class}, new String[]{"statusTextView"}, null, null, null, Theme.key_windowBackgroundWhiteLinkText);
        themeDescriptionArr[45] = new ThemeDescription(this.adminnedChannelsLayout, ThemeDescription.FLAG_IMAGECOLOR, new Class[]{AdminedChannelCell.class}, new String[]{"deleteButton"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText);
        C3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2 = c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c;
        themeDescriptionArr[46] = new ThemeDescription(null, 0, null, null, new Drawable[]{Theme.avatar_broadcastDrawable, Theme.avatar_savedDrawable}, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_text);
        themeDescriptionArr[47] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundRed);
        themeDescriptionArr[48] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundOrange);
        themeDescriptionArr[49] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundViolet);
        themeDescriptionArr[50] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundGreen);
        themeDescriptionArr[51] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundCyan);
        themeDescriptionArr[52] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundBlue);
        themeDescriptionArr[53] = new ThemeDescription(null, 0, null, null, null, c3613-$$Lambda$ChannelCreateActivity$ieYbFS24yeOuvItbU135YWldd4c2, Theme.key_avatar_backgroundPink);
