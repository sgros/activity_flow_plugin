...
public class EditTextSettingsCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.textView.measure(MeasureSpec.makeMeasureSpec(((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m26dp(42.0f), 1073741824), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    }
