...
public class BottomSheet extends Dialog {
    ...
    private Runnable dismissRunnable = new C2187-$$Lambda$wKJSb77Iz9CSKJu9VMkyxGvOd-c(this);
    ...
    class C22164 extends AnimatorListenerAdapter {
        C22164() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                if (bottomSheet.isFullscreen) {
                    LayoutParams attributes = bottomSheet.getWindow().getAttributes();
    ...
    class C22186 extends AnimatorListenerAdapter {
        C22186() {
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                BottomSheet.this.currentSheetAnimation = null;
                AndroidUtilities.runOnUIThread(new C2176-$$Lambda$BottomSheet$6$VTgE-oeIT2bQ5t-sdXAKcokhgP8(this));
            }
        }
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public void setTextAndIcon(CharSequence charSequence, int i) {
            ...
            if (i != 0) {
                ...
                TextView textView = this.textView;
                int dp = AndroidUtilities.m26dp(LocaleController.isRTL ? 16.0f : 72.0f);
                if (LocaleController.isRTL) {
                    f = 72.0f;
                }
                textView.setPadding(dp, 0, AndroidUtilities.m26dp(f), 0);
                return;
            }
            this.imageView.setVisibility(4);
            this.textView.setPadding(AndroidUtilities.m26dp(16.0f), 0, AndroidUtilities.m26dp(16.0f), 0);
        }
    }
    ...
    protected class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        class C22191 extends AnimatorListenerAdapter {
            C22191() {
            }
        ...
        private void checkDismiss(float f, float f2) {
            ...
            this.currentAnimation.addListener(new C22191());
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (viewGroup != null) {
                if (bottomSheet.fullWidth) {
                    viewGroup.measure(MeasureSpec.makeMeasureSpec((bottomSheet.backgroundPaddingLeft * 2) + i, 1073741824), MeasureSpec.makeMeasureSpec(i2, Integer.MIN_VALUE));
                } else {
                    if (AndroidUtilities.isTablet()) {
                        Point point = AndroidUtilities.displaySize;
                        makeMeasureSpec = MeasureSpec.makeMeasureSpec(((int) (((float) Math.min(point.x, point.y)) * 0.8f)) + (BottomSheet.this.backgroundPaddingLeft * 2), 1073741824);
                    } else {
                        makeMeasureSpec = MeasureSpec.makeMeasureSpec(obj != null ? (BottomSheet.this.backgroundPaddingLeft * 2) + i : ((int) Math.max(((float) i) * 0.8f, (float) Math.min(AndroidUtilities.m26dp(480.0f), i))) + (BottomSheet.this.backgroundPaddingLeft * 2), 1073741824);
                    }
            ...
            for (int i3 = 0; i3 < makeMeasureSpec; i3++) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (!(childAt == bottomSheet.containerView || bottomSheet.onCustomMeasure(childAt, i, i2))) {
                        measureChildWithMargins(childAt, MeasureSpec.makeMeasureSpec(i, 1073741824), 0, MeasureSpec.makeMeasureSpec(i2, 1073741824), 0);
                    }
                }
            }
        }
        ...
        public void onLayout(boolean r14, int r15, int r16, int r17, int r18) {
            ...
            r13 = this;
            r0 = r13;
            r1 = org.telegram.p004ui.ActionBar.BottomSheet.this;
        ...
        L_0x0018:
            ...
            r1 = r1 + r15;
            r2 = org.telegram.p004ui.ActionBar.BottomSheet.this;
            r2 = r2.lastInsets;
        ...
        L_0x0033:
            r3 = r18 - r16;
            r4 = org.telegram.p004ui.ActionBar.BottomSheet.this;
            r4 = r4.containerView;
            r4 = r4.getMeasuredHeight();
            r3 = r3 - r4;
            r4 = r2 - r1;
            r5 = org.telegram.p004ui.ActionBar.BottomSheet.this;
            r5 = r5.containerView;
        ...
        L_0x0062:
            ...
            r6 = r6 + r4;
            r8 = org.telegram.p004ui.ActionBar.BottomSheet.this;
            r8 = r8.containerView;
        ...
        L_0x0146:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ActionBar.BottomSheet$ContainerView.onLayout(boolean, int, int, int, int):void");
        }
    ...
    public BottomSheet(Context context, boolean z, int i) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.container.setOnApplyWindowInsetsListener(new C2178-$$Lambda$BottomSheet$IjDyKTRWpdCwBFc4MNcspRHUp7w(this));
    ...
    public void onCreate(Bundle bundle) {
        ...
        window.setWindowAnimations(C1067R.style.DialogNoAnimation);
        ...
        if (this.containerView == null) {
            ...
            this.containerView.setPadding(this.backgroundPaddingLeft, ((this.applyTopPadding ? AndroidUtilities.m26dp(8.0f) : 0) + this.backgroundPaddingTop) - 1, this.backgroundPaddingLeft, this.applyBottomPadding ? AndroidUtilities.m26dp(8.0f) : 0);
        }
        ...
        if (this.title != null) {
            ...
            this.titleView.setPadding(AndroidUtilities.m26dp(16.0f), 0, AndroidUtilities.m26dp(16.0f), AndroidUtilities.m26dp(8.0f));
            this.titleView.setGravity(16);
            this.containerView.addView(this.titleView, LayoutHelper.createFrame(-1, 48.0f));
            this.titleView.setOnTouchListener(C2179-$$Lambda$BottomSheet$bysjO3P7kPXgYfq-9zd4-H2r0_8.INSTANCE);
            i = 48;
        } else {
            i = 0;
        }
        ...
        if (view != null) {
            ...
            while (true) {
                ...
                if (charSequenceArr[i] != null) {
                    ...
                    bottomSheetCell.setOnClickListener(new C2177-$$Lambda$BottomSheet$6IWrsZfWA7fvlM9-8brqhUJi-uM(this));
    ...
    public void show() {
        ...
        if (VERSION.SDK_INT >= 18) {
            ...
            C22153 c22153 = new C22153();
            this.startAnimationRunnable = c22153;
            AndroidUtilities.runOnUIThread(c22153, 150);
        } else {
            startOpenAnimation();
        }
    }
    ...
    private void startOpenAnimation() {
        if (!this.dismissed) {
            ...
            if (!onCustomOpenAnimation()) {
                ...
                animatorSet.addListener(new C22164());
                animatorSet.start();
    ...
    public void dismissWithButtonClick(final int i) {
        if (!this.dismissed) {
            ...
            AnimatorSet animatorSet = new AnimatorSet();
            Animator[] animatorArr = new Animator[2];
            animatorArr[0] = ObjectAnimator.ofFloat(this.containerView, "translationY", new float[]{(float) (this.containerView.getMeasuredHeight() + AndroidUtilities.m26dp(10.0f))});
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (animatorSet != null && animatorSet.equals(animator)) {
                        ...
                        AndroidUtilities.runOnUIThread(new C2175-$$Lambda$BottomSheet$5$CikgvDyZEWn0favL4ZqbmH9PuGE(this));
                    }
                }
    ...
    public void dismiss() {
        ...
        if ((bottomSheetDelegateInterface == null || bottomSheetDelegateInterface.canDismiss()) && !this.dismissed) {
            ...
            if (!(this.allowCustomAnimation && onCustomCloseAnimation())) {
                ...
                animatorSet.setInterpolator(CubicBezierInterpolator.EASE_OUT);
                animatorSet.addListener(new C22186());
                animatorSet.start();
                this.currentSheetAnimation = animatorSet;
            }
        }
