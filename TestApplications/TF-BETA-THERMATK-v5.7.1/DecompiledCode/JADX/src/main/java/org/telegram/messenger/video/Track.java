...
public class Track {
    ...
    public Track(int i, MediaFormat mediaFormat, boolean z) {
        ...
        if (str.equals("video/avc")) {
            ...
            if (mediaFormat.containsKey(str3)) {
                ...
                } else if (integer == MessagesController.UPDATE_MASK_CHAT) {
                ...
                } else if (integer == MessagesController.UPDATE_MASK_CHECK) {
    ...
    public void prepare() {
        ...
        Collections.sort(this.samplePresentationTimes, C1111-$$Lambda$Track$WwpAJwhUb2DZllFb8kOYdyyS8pU.INSTANCE);
        ...
        while (i < arrayList.size()) {
            ((SamplePresentationTime) arrayList.get(i)).f428dt = this.sampleDurations[i] + ((SamplePresentationTime) arrayList.get(i - 1)).f428dt;
            i++;
        }
        if (obj != null) {
            ...
            while (i2 < this.samplePresentationTimes.size()) {
                ...
                this.sampleCompositions[samplePresentationTime2.index] = (int) (samplePresentationTime2.presentationTime - samplePresentationTime2.f428dt);
                i2++;
            }
        }
    }
