...
public class StickerView extends EntityView {
    ...
    public class StickerViewSelectionView extends SelectionView {
        ...
        public StickerViewSelectionView(Context context) {
            ...
            this.arcPaint.setStrokeWidth((float) AndroidUtilities.m26dp(1.0f));
        ...
        public void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            float dp = (float) AndroidUtilities.m26dp(4.5f);
            float dp2 = (((float) AndroidUtilities.m26dp(1.0f)) + dp) + ((float) AndroidUtilities.m26dp(15.0f));
        ...
        while (i < document.attributes.size()) {
            ...
            if (documentAttribute instanceof TL_documentAttributeSticker) {
                ...
                if (tL_maskCoords != null) {
                    this.anchor = tL_maskCoords.f494n;
                }
    ...
    public void updatePosition() {
        ...
        setX(this.position.f600x - f);
        setY(this.position.f601y - f2);
        updateSelectionView();
    }
    ...
    public Rect getSelectionBounds() {
        ...
        float f = width / 2.0f;
        width *= scaleX;
        return new Rect((point.f600x - f) * scaleX, (point.f601y - f) * scaleX, width, width);
    }
