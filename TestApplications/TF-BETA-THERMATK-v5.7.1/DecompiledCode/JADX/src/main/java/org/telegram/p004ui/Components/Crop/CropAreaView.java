...
public class CropAreaView extends View {
    ...
    private float minWidth = ((float) AndroidUtilities.m26dp(32.0f));
    private GridType previousGridType;
    private int previousX;
    private int previousY;
    private RectF rightEdge = new RectF();
    Paint shadowPaint;
    private float sidePadding = ((float) AndroidUtilities.m26dp(16.0f));
    ...
    class C27911 extends AnimatorListenerAdapter {
        C27911() {
        }
    ...
    static /* synthetic */ class C27933 {
        ...
        static {
            /*
            r0 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.values();
            r0 = r0.length;
            r0 = new int[r0];
            ...
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.TOP_LEFT;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = 1;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r0 = $SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.TOP_RIGHT;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x001f }
            r2 = 2;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x001f }
        L_0x001f:
            r0 = $SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control;	 Catch:{ NoSuchFieldError -> 0x002a }
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.BOTTOM_LEFT;	 Catch:{ NoSuchFieldError -> 0x002a }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x002a }
            r2 = 3;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x002a }
        L_0x002a:
            r0 = $SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control;	 Catch:{ NoSuchFieldError -> 0x0035 }
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.BOTTOM_RIGHT;	 Catch:{ NoSuchFieldError -> 0x0035 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0035 }
            r2 = 4;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0035 }
        L_0x0035:
            r0 = $SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control;	 Catch:{ NoSuchFieldError -> 0x0040 }
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.TOP;	 Catch:{ NoSuchFieldError -> 0x0040 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0040 }
            r2 = 5;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0040 }
        L_0x0040:
            r0 = $SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control;	 Catch:{ NoSuchFieldError -> 0x004b }
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.LEFT;	 Catch:{ NoSuchFieldError -> 0x004b }
        ...
        L_0x004b:
            ...
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.RIGHT;	 Catch:{ NoSuchFieldError -> 0x0056 }
        ...
        L_0x0056:
            ...
            r1 = org.telegram.p004ui.Components.Crop.CropAreaView.Control.BOTTOM;	 Catch:{ NoSuchFieldError -> 0x0062 }
        ...
        L_0x0062:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.Crop.CropAreaView$C27933.<clinit>():void");
        }
    }
    ...
    public CropAreaView(Context context) {
        ...
        this.shadowPaint.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
    ...
    public void onDraw(Canvas canvas) {
        if (this.freeform) {
            ...
            int dp2 = AndroidUtilities.m26dp(16.0f);
            int dp3 = AndroidUtilities.m26dp(3.0f);
            ...
            if (this.frameVisible) {
                    ...
                    if (gridType == GridType.MINOR) {
                        ...
                        while (i6 < 4) {
                            if (i14 == 2 && i6 == i15) {
                                ...
                                f7 = (float) dp2;
                                f8 = f5;
                                float f12 = (float) (dp2 + i3);
                                canvas4.drawLine(f6, f7, f8, f12, this.shadowPaint);
                                canvas4.drawLine(f6, f7, f8, f12, this.linePaint);
                                i5 = i3 / 3;
                                f11 = (float) ((dp2 + ((i5 / 3) * i6)) + (i5 * i14));
                                f6 = (float) i11;
                                f7 = f11;
                                f8 = (float) (i11 + i13);
                                f12 = f11;
                ...
                f5 = f10;
                i5 = i6;
                canvas2.drawRect(f13, f14, f15, f5, this.framePaint);
                f15 = (float) (dp + i7);
                dp = i2 + i9;
                i12 = dp - i12;
                float f16 = (float) i12;
                float f17 = f16;
                canvas2.drawRect(f13, f14, f15, f16, this.framePaint);
                f15 = f9;
                f5 = f17;
                canvas2.drawRect(f13, (float) (i12 - i7), f15, f5, this.framePaint);
                canvas2.drawRect((float) (i5 - i7), f2, f15, f5, this.framePaint);
                f10 = (float) i2;
                f2 = (float) (i + i8);
                f5 = (float) (i2 + dp3);
                ...
                float f18 = (float) (i + dp3);
                f3 = (float) (i2 + i8);
                canvas6.drawRect(f7, f8, f18, f3, this.handlePaint);
                float f19 = (float) (i11 - i8);
                f16 = (float) i11;
                f14 = f10;
                float f20 = f16;
                canvas2.drawRect(f19, f14, f16, f5, this.handlePaint);
                f = (float) (i11 - dp3);
                canvas2.drawRect(f, f14, f20, f3, this.handlePaint);
                float f21 = (float) (dp - dp3);
                f10 = (float) dp;
                float f22 = f10;
                canvas6.drawRect(f7, f21, f2, f22, this.handlePaint);
                float f23 = (float) (dp - i8);
                canvas6.drawRect(f7, f23, f18, f22, this.handlePaint);
                Canvas canvas7 = canvas;
                f6 = f20;
                f7 = f10;
                canvas7.drawRect(f19, f21, f6, f7, this.handlePaint);
                canvas7.drawRect(f, f23, f6, f7, this.handlePaint);
            } else {
                return;
            }
        }
    ...
    public void setGridType(GridType gridType, boolean z) {
        ...
        if (gridType2 != gridType) {
            ...
            if (z) {
                ...
                this.gridAnimator.addListener(new C27911());
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            this.previousY = y;
            RectF rectF2;
            switch (C27933.$SwitchMap$org$telegram$ui$Components$Crop$CropAreaView$Control[this.activeControl.ordinal()]) {
                case 1:
