...
import org.telegram.p004ui.Components.Crop.CropRotationWheel;
import org.telegram.p004ui.Components.Crop.CropRotationWheel.RotationWheelListener;
import org.telegram.p004ui.Components.Crop.CropView;
import org.telegram.p004ui.Components.Crop.CropView.CropViewListener;
...
public class PhotoCropView extends FrameLayout {
    ...
    class C29091 implements CropViewListener {
        C29091() {
        }
    ...
    class C29102 implements RotationWheelListener {
        C29102() {
        }
    ...
    public PhotoCropView(Context context) {
        super(context);
        this.cropView.setListener(new C29091());
        this.cropView.setBottomPadding((float) AndroidUtilities.m26dp(64.0f));
        addView(this.cropView);
        this.wheelView = new CropRotationWheel(getContext());
        this.wheelView.setListener(new C29102());
    ...
    public float getRectX() {
        return this.cropView.getCropLeft() - ((float) AndroidUtilities.m26dp(14.0f));
    }

    public float getRectY() {
        return (this.cropView.getCropTop() - ((float) AndroidUtilities.m26dp(14.0f))) - ((float) (VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0));
    }
