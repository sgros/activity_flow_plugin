...
public class PaymentInfoCell extends FrameLayout {
    ...
    public PaymentInfoCell(Context context) {
        ...
        addView(textView2, LayoutHelper.createFrame(-1, -2.0f, i | 48, LocaleController.isRTL ? 10.0f : 123.0f, 90.0f, LocaleController.isRTL ? 123.0f : 10.0f, 0.0f));
    }

    /* Access modifiers changed, original: protected */
    public void onMeasure(int i, int i2) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(120.0f), 1073741824));
    }

    /* Access modifiers changed, original: protected */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        super.onLayout(z, i, i2, i3, i4);
        int bottom = this.detailTextView.getBottom() + AndroidUtilities.m26dp(3.0f);
    ...
    public void setInvoice(TL_messageMediaInvoice tL_messageMediaInvoice, String str) {
        ...
        float f = (float) 640;
        float dp = f / ((float) (((int) (((float) minTabletSide) * 0.7f)) - AndroidUtilities.m26dp(2.0f)));
        int i = (int) (f / dp);
