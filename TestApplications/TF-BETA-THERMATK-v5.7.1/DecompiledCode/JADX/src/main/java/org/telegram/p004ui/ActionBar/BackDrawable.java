...
public class BackDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawLine(((float) (-AndroidUtilities.m26dp(7.0f))) - (((float) AndroidUtilities.m26dp(1.0f)) * f2), 0.0f, (float) AndroidUtilities.m26dp(8.0f), 0.0f, this.paint);
        float f5 = (float) (-AndroidUtilities.m26dp(0.5f));
        float dp = ((float) AndroidUtilities.m26dp(7.0f)) + (((float) AndroidUtilities.m26dp(1.0f)) * f2);
        Canvas canvas2 = canvas;
        f = ((float) (-AndroidUtilities.m26dp(7.0f))) + (((float) AndroidUtilities.m26dp(7.0f)) * f2);
        float dp2 = ((float) AndroidUtilities.m26dp(0.5f)) - (((float) AndroidUtilities.m26dp(0.5f)) * f2);
