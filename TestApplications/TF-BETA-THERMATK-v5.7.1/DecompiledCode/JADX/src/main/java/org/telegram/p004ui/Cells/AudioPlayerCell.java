...
public class AudioPlayerCell extends View implements FileDownloadProgressListener {
    ...
    L_0x0081:
        return r4;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Cells.AudioPlayerCell.checkAudioMotionEvent(android.view.MotionEvent):boolean");
    }
