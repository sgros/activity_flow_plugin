...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    class C23611 implements OnClickListener {
        C23611() {
        }
    ...
    public PhotoPickerAlbumsCell(Context context) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            this.albumViews[i].setOnClickListener(new C23611());
        }
    }
    ...
    public void setAlbum(int i, AlbumEntry albumEntry) {
        ...
        if (albumEntry != null) {
            ...
            if (photoEntry == null || photoEntry.path == null) {
                albumView.imageView.setImageResource(C1067R.C1065drawable.nophotos);
            } else {
                ...
                if (albumEntry.coverPhoto.isVideo) {
                    ...
                    access$200.setImage(stringBuilder.toString(), null, getContext().getResources().getDrawable(C1067R.C1065drawable.nophotos));
                } else {
                    access$200 = albumView.imageView;
                    stringBuilder = new StringBuilder();
    ...
    public void onMeasure(int i, int i2) {
        if (AndroidUtilities.isTablet()) {
            i2 = (AndroidUtilities.m26dp(490.0f) - ((this.albumsCount + 1) * AndroidUtilities.m26dp(4.0f))) / this.albumsCount;
        } else {
            i2 = (AndroidUtilities.displaySize.x - ((this.albumsCount + 1) * AndroidUtilities.m26dp(4.0f))) / this.albumsCount;
        }
        for (int i3 = 0; i3 < this.albumsCount; i3++) {
            ...
            layoutParams.leftMargin = (AndroidUtilities.m26dp(4.0f) + i2) * i3;
            layoutParams.width = i2;
            layoutParams.height = i2;
            layoutParams.gravity = 51;
            this.albumViews[i3].setLayoutParams(layoutParams);
        }
        super.onMeasure(i, MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(4.0f) + i2, 1073741824));
    }
}
