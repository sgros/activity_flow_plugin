...
/* renamed from: org.telegram.messenger.-$$Lambda$FileLoader$QveLJ1Gqcvj_9l-dGSaDY1G3t6s */
public final /* synthetic */ class C0449-$$Lambda$FileLoader$QveLJ1Gqcvj_9l-dGSaDY1G3t6s implements Runnable {
    ...
    public /* synthetic */ C0449-$$Lambda$FileLoader$QveLJ1Gqcvj_9l-dGSaDY1G3t6s(FileLoader fileLoader, Document document, SecureDocument secureDocument, WebFile webFile, TL_fileLocationToBeDeprecated tL_fileLocationToBeDeprecated, ImageLocation imageLocation, Object obj, String str, int i, int i2, int i3) {
        this.f$0 = fileLoader;
        this.f$1 = document;
