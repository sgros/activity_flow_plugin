...
public class TextColorCell extends FrameLayout {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle((float) (LocaleController.isRTL ? AndroidUtilities.m26dp(33.0f) : getMeasuredWidth() - AndroidUtilities.m26dp(33.0f)), (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.m26dp(10.0f), colorPaint);
        }
    }
}
