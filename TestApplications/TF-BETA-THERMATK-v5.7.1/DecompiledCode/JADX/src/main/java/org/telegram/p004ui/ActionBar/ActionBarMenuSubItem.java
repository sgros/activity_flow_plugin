...
public class ActionBarMenuSubItem extends FrameLayout {
    ...
    public ActionBarMenuSubItem(Context context) {
        ...
        setPadding(AndroidUtilities.m26dp(18.0f), 0, AndroidUtilities.m26dp(18.0f), 0);
        this.imageView = new ImageView(context);
        this.imageView.setScaleType(ScaleType.CENTER);
        this.imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_actionBarDefaultSubmenuItemIcon), Mode.MULTIPLY));
        int i = 5;
    ...
    public void setTextAndIcon(CharSequence charSequence, int i) {
        ...
        if (i != 0) {
            ...
            this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m26dp(43.0f), 0, LocaleController.isRTL ? AndroidUtilities.m26dp(43.0f) : 0, 0);
            return;
        }
