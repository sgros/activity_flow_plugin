...
public class NotificationsSettingsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C42451 extends ActionBarMenuOnItemClick {
        C42451() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                if (i == 4) {
                    ...
                    shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                } else {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (itemViewType == 1) {
                    ...
                    if (i == NotificationsSettingsActivity.this.inappSoundRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("InAppSounds", C1067R.string.InAppSounds), notificationsSettings.getBoolean("EnableInAppSounds", true), true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.inappVibrateRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("InAppVibrate", C1067R.string.InAppVibrate), notificationsSettings.getBoolean("EnableInAppVibrate", true), true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.inappPreviewRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("InAppPreview", C1067R.string.InAppPreview), notificationsSettings.getBoolean("EnableInAppPreview", true), true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.inappPriorityRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("NotificationsImportance", C1067R.string.NotificationsImportance), notificationsSettings.getBoolean("EnableInAppPriority", false), false);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.contactJoinedRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("ContactJoined", C1067R.string.ContactJoined), notificationsSettings.getBoolean("EnableContactJoined", true), true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.pinnedMessageRow) {
                        str2 = "PinnedMessages";
                        textCheckCell.setTextAndCheck(LocaleController.getString(str2, C1067R.string.PinnedMessages), notificationsSettings.getBoolean(str2, true), false);
                        return;
                        ...
                        textCheckCell.setTextAndValueAndCheck(LocaleController.getString("NotificationsServiceConnection", C1067R.string.NotificationsServiceConnection), "You won't be notified of new messages, if you disable this", notificationsSettings.getBoolean("pushConnection", true), true, true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.badgeNumberShowRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("BadgeNumberShow", C1067R.string.BadgeNumberShow), NotificationsController.getInstance(NotificationsSettingsActivity.this.currentAccount).showBadgeNumber, true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.badgeNumberMutedRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("BadgeNumberMutedChats", C1067R.string.BadgeNumberMutedChats), NotificationsController.getInstance(NotificationsSettingsActivity.this.currentAccount).showBadgeMuted, true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.badgeNumberMessagesRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("BadgeNumberUnread", C1067R.string.BadgeNumberUnread), NotificationsController.getInstance(NotificationsSettingsActivity.this.currentAccount).showBadgeMessages, false);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.inchatSoundRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("InChatSound", C1067R.string.InChatSound), notificationsSettings.getBoolean("EnableInChatSound", true), true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.callsVibrateRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(str, C1067R.string.Vibrate), notificationsSettings.getBoolean("EnableCallVibrate", true), true);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.accountsAllRow) {
                        str3 = "AllAccounts";
                        textCheckCell.setTextAndCheck(LocaleController.getString(str3, C1067R.string.AllAccounts), MessagesController.getGlobalNotificationsSettings().getBoolean(str3, true), false);
                        return;
                    } else {
                        return;
                    }
                    ...
                    if (i == NotificationsSettingsActivity.this.resetNotificationsRow) {
                        textDetailSettingsCell.setTextAndValue(LocaleController.getString("ResetAllNotifications", C1067R.string.ResetAllNotifications), LocaleController.getString("UndoAllCustom", C1067R.string.UndoAllCustom), false);
                        return;
                    }
                    return;
                } else if (itemViewType == 3) {
                    String string;
                    ArrayList access$3700;
                    int i2;
                    ...
                    if (i == NotificationsSettingsActivity.this.privateRow) {
                        string = LocaleController.getString("NotificationsPrivateChats", C1067R.string.NotificationsPrivateChats);
                        access$3700 = NotificationsSettingsActivity.this.exceptionUsers;
                        i2 = notificationsSettings.getInt("EnableAll2", 0);
                    } else if (i == NotificationsSettingsActivity.this.groupRow) {
                        string = LocaleController.getString("NotificationsGroups", C1067R.string.NotificationsGroups);
                        access$3700 = NotificationsSettingsActivity.this.exceptionChats;
                        i2 = notificationsSettings.getInt("EnableGroup2", 0);
                    } else {
                        string = LocaleController.getString("NotificationsChannels", C1067R.string.NotificationsChannels);
                        access$3700 = NotificationsSettingsActivity.this.exceptionChannels;
                    ...
                    if (access$3700 == null || access$3700.isEmpty()) {
                        stringBuilder.append(LocaleController.getString("TapToChange", C1067R.string.TapToChange));
                    } else {
                        z2 = i2 < itemViewType;
                        if (z2) {
                            ...
                            stringBuilder.append(LocaleController.formatString("NotificationsOffUntil", C1067R.string.NotificationsOffUntil, LocaleController.stringForMessageListDate((long) i2)));
                        }
                        if (stringBuilder.length() != 0) {
                            stringBuilder.append(", ");
                        }
                        stringBuilder.append(LocaleController.formatPluralString("Exception", access$3700.size()));
                    }
                    ...
                    if (i == NotificationsSettingsActivity.this.callsRingtoneRow) {
                        str3 = notificationsSettings2.getString("CallsRingtone", LocaleController.getString("DefaultRingtone", C1067R.string.DefaultRingtone));
                        str2 = "NoSound";
                        if (str3.equals(str2)) {
                            str3 = LocaleController.getString(str2, C1067R.string.NoSound);
                        }
                        textSettingsCell.setTextAndValue(LocaleController.getString("VoipSettingsRingtone", C1067R.string.VoipSettingsRingtone), str3, false);
                        return;
                    } else if (i == NotificationsSettingsActivity.this.callsVibrateRow) {
                        ...
                        if (!z) {
                            textSettingsCell.setTextAndValue(LocaleController.getString(str, C1067R.string.Vibrate), LocaleController.getString("VibrationDefault", C1067R.string.VibrationDefault), true);
                            return;
                        } else if (z) {
                            textSettingsCell.setTextAndValue(LocaleController.getString(str, C1067R.string.Vibrate), LocaleController.getString("Short", C1067R.string.Short), true);
                            return;
                        } else if (z) {
                            textSettingsCell.setTextAndValue(LocaleController.getString(str, C1067R.string.Vibrate), LocaleController.getString("VibrationDisabled", C1067R.string.VibrationDisabled), true);
                            return;
                        } else if (z) {
                            textSettingsCell.setTextAndValue(LocaleController.getString(str, C1067R.string.Vibrate), LocaleController.getString("Long", C1067R.string.Long), true);
                            return;
                        } else if (z) {
                            textSettingsCell.setTextAndValue(LocaleController.getString(str, C1067R.string.Vibrate), LocaleController.getString("OnlyIfSilent", C1067R.string.OnlyIfSilent), true);
                            return;
                        } else {
                            return;
                        }
                        ...
                        if (itemViewType == 0) {
                            str3 = LocaleController.getString("RepeatNotificationsNever", C1067R.string.RepeatNotificationsNever);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("RepeatNotifications", C1067R.string.RepeatNotifications), str3, false);
                        return;
                    } else {
                        return;
                    }
                    ...
                    if (i == NotificationsSettingsActivity.this.accountsInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString("ShowNotificationsForInfo", C1067R.string.ShowNotificationsForInfo));
                        return;
                    }
                    return;
                } else {
            ...
            if (i == NotificationsSettingsActivity.this.notificationsSectionRow) {
                headerCell.setText(LocaleController.getString("NotificationsForChats", C1067R.string.NotificationsForChats));
            } else if (i == NotificationsSettingsActivity.this.inappSectionRow) {
                headerCell.setText(LocaleController.getString("InAppNotifications", C1067R.string.InAppNotifications));
            } else if (i == NotificationsSettingsActivity.this.eventsSectionRow) {
                headerCell.setText(LocaleController.getString("Events", C1067R.string.Events));
            } else if (i == NotificationsSettingsActivity.this.otherSectionRow) {
                headerCell.setText(LocaleController.getString("NotificationsOther", C1067R.string.NotificationsOther));
            } else if (i == NotificationsSettingsActivity.this.resetSectionRow) {
                headerCell.setText(LocaleController.getString("Reset", C1067R.string.Reset));
                ...
                headerCell.setText(LocaleController.getString("BadgeNumber", C1067R.string.BadgeNumber));
            } else if (i == NotificationsSettingsActivity.this.accountsSectionRow) {
                headerCell.setText(LocaleController.getString("ShowNotificationsFor", C1067R.string.ShowNotificationsFor));
            }
        }
    ...
    private void loadExceptions() {
        MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new C1695x44e15c8(this));
    }
    ...
    L_0x02d9:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.NotificationsSettingsActivity.lambda$loadExceptions$1$NotificationsSettingsActivity():void");
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("NotificationsAndSounds", C1067R.string.NotificationsAndSounds));
        this.actionBar.setActionBarMenuOnItemClick(new C42451());
        ...
        C42462 c42462 = new LinearLayoutManager(context, 1, false) {
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }
        };
        this.layoutManager = c42462;
        recyclerListView.setLayoutManager(c42462);
        ...
        this.listView.setOnItemClickListener(new C3763x7475809e(this));
            ...
            if (i == this.privateRow || i == this.groupRow || i == this.channelsRow) {
                ...
                if (i == this.callsRingtoneRow) {
                    ...
                    if (i == this.resetNotificationsRow) {
                        ...
                        builder.setMessage(LocaleController.getString("ResetNotificationsAlert", C1067R.string.ResetNotificationsAlert));
                        builder.setTitle(LocaleController.getString("AppName", C1067R.string.AppName));
                        builder.setPositiveButton(LocaleController.getString("Reset", C1067R.string.Reset), new C1696x19384d6(this));
                        builder.setNegativeButton(LocaleController.getString(path, C1067R.string.Cancel), null);
                        ...
                        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_setContactSignUpNotification, C3764x8c67cfc1.INSTANCE);
                        ...
                        if (i == this.badgeNumberShowRow) {
                            ...
                            Editor edit3 = notificationsSettings2.edit();
                            edit3.putBoolean("pushConnection", z3 ^ 1);
                            z = notificationsSettings2.getBoolean("pushService", true);
                            edit3.putBoolean("pushService", z ^ 1);
                            edit3.commit();
                            if (z) {
                            ...
                            if (getParentActivity() != null) {
                                ...
                                showDialog(AlertsCreator.createVibrationSelectDialog(getParentActivity(), 0, str, new C1690xbe9abe00(this, i)));
                            } else {
                                return;
                            }
                        } else if (i == this.repeatRow) {
                            Builder builder2 = new Builder(getParentActivity());
                            builder2.setTitle(LocaleController.getString("RepeatNotifications", C1067R.string.RepeatNotifications));
                            ...
                            builder2.setItems(r5, new C1693x819d63f4(this, i));
                            builder2.setNegativeButton(LocaleController.getString(path, C1067R.string.Cancel), null);
    ...
    public /* synthetic */ void lambda$null$4$NotificationsSettingsActivity(DialogInterface dialogInterface, int i) {
        if (!this.reseting) {
            this.reseting = true;
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_resetNotifySettings(), new C3762xbb8986c7(this));
        }
    }

    public /* synthetic */ void lambda$null$3$NotificationsSettingsActivity(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1692x6e63e7f0(this));
    }
    ...
    public /* synthetic */ void lambda$null$2$NotificationsSettingsActivity() {
        ...
        if (getParentActivity() != null) {
            Toast.makeText(getParentActivity(), LocaleController.getString("ResetNotificationsText", C1067R.string.ResetNotificationsText), 0).show();
        }
    }
    ...
    L_0x005d:
        r3 = 2131560066; // 0x7f0d0682 float:1.8745494E38 double:1.0531306007E-314;
        ...
        goto L_0x0086;
    L_0x0072:
        r3 = 2131560065; // 0x7f0d0681 float:1.8745492E38 double:1.0531306E-314;
        r5 = new java.lang.Object[r5];
        r5[r4] = r0;
        ...
        r2.setMessage(r0);
    L_0x0086:
        r0 = 2131560064; // 0x7f0d0680 float:1.874549E38 double:1.0531305997E-314;
        r3 = "NotificationsExceptions";
        r0 = org.telegram.messenger.LocaleController.getString(r3, r0);
        r2.setTitle(r0);
        r0 = 2131561053; // 0x7f0d0a5d float:1.8747496E38 double:1.0531310883E-314;
        r3 = "ViewExceptions";
        r0 = org.telegram.messenger.LocaleController.getString(r3, r0);
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.NotificationsSettingsActivity.showExceptionsAlert(int):void");
    }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        themeDescriptionArr[0] = new ThemeDescription(this.listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{HeaderCell.class, TextCheckCell.class, TextDetailSettingsCell.class, TextSettingsCell.class, NotificationsCheckCell.class}, null, null, null, Theme.key_windowBackgroundWhite);
        ...
        themeDescriptionArr[10] = new ThemeDescription(this.listView, 0, new Class[]{NotificationsCheckCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        view = this.listView;
        ...
        themeDescriptionArr[13] = new ThemeDescription(this.listView, 0, new Class[]{NotificationsCheckCell.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switchTrackChecked);
        ...
        themeDescriptionArr[25] = new ThemeDescription(this.listView, ThemeDescription.FLAG_LINKCOLOR, new Class[]{TextInfoPrivacyCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteLinkText);
