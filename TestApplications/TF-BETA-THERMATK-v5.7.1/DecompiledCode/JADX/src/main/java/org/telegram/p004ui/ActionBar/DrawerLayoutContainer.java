...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    class C22211 extends AnimatorListenerAdapter {
        C22211() {
        }
    ...
    class C22222 extends AnimatorListenerAdapter {
        C22222() {
        }
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            setOnApplyWindowInsetsListener(new C2180-$$Lambda$DrawerLayoutContainer$dOsUXLZuN_il_QGSmGuPct7OsoA(this));
            setSystemUiVisibility(1280);
        }
        this.shadowLeft = getResources().getDrawable(C1067R.C1065drawable.menu_shadow);
    }
    ...
    public void openDrawer(boolean z) {
        if (this.allowOpenDrawer) {
            ...
            animatorSet.addListener(new C22211());
            animatorSet.start();
    ...
    public void closeDrawer(boolean z) {
        ...
        animatorSet.addListener(new C22222());
        animatorSet.start();
    }
    ...
    L_0x0187:
        ...
        r5 = r5 / r6;
        r6 = 1163575296; // 0x455ac000 float:3500.0 double:5.7488258E-315;
        r4 = (r4 > r5 ? 1 : (r4 == r5 ? 0 : -1));
    ...
    L_0x01fb:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ActionBar.DrawerLayoutContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.scrimOpacity <= 0.0f || obj == null) {
            if (this.shadowLeft != null) {
                float max = Math.max(0.0f, Math.min(this.drawerPosition / ((float) AndroidUtilities.m26dp(20.0f)), 1.0f));
                if (max != 0.0f) {
