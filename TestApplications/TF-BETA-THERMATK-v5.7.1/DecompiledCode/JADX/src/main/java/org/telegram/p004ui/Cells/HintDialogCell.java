...
public class HintDialogCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i), 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.m26dp(86.0f), 1073741824));
    }

    public void update(int i) {
        if (!((i & 4) == 0 || this.currentUser == null)) {
            this.currentUser = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(this.currentUser.f534id));
            ...
            if (dialog != null) {
                ...
                if (i2 != 0) {
                    if (this.lastUnreadCount != i2) {
                        ...
                        this.countWidth = Math.max(AndroidUtilities.m26dp(12.0f), (int) Math.ceil((double) Theme.dialogs_countTextPaint.measureText(format)));
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.imageView) {
            ...
            int dp2;
            if (this.countLayout != null) {
                dp = AndroidUtilities.m26dp(6.0f);
                dp2 = AndroidUtilities.m26dp(54.0f);
                int dp3 = dp2 - AndroidUtilities.m26dp(5.5f);
                this.rect.set((float) dp3, (float) dp, (float) ((dp3 + this.countWidth) + AndroidUtilities.m26dp(11.0f)), (float) (AndroidUtilities.m26dp(23.0f) + dp));
                ...
                canvas.save();
                canvas.translate((float) dp2, (float) (dp + AndroidUtilities.m26dp(4.0f)));
            ...
            if (!(user == null || user.bot)) {
                ...
                if ((userStatus != null && userStatus.expires > ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) || MessagesController.getInstance(this.currentAccount).onlinePrivacy.containsKey(Integer.valueOf(this.currentUser.f534id))) {
                    dp = AndroidUtilities.m26dp(53.0f);
                    dp2 = AndroidUtilities.m26dp(59.0f);
                    Theme.dialogs_onlineCirclePaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                    float f2 = (float) dp2;
                    float f3 = (float) dp;
                    canvas.drawCircle(f2, f3, (float) AndroidUtilities.m26dp(7.0f), Theme.dialogs_onlineCirclePaint);
                    Theme.dialogs_onlineCirclePaint.setColor(Theme.getColor(Theme.key_chats_onlineCircle));
                    canvas.drawCircle(f2, f3, (float) AndroidUtilities.m26dp(5.0f), Theme.dialogs_onlineCirclePaint);
                }
            }
        }
        return drawChild;
