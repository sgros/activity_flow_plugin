...
import org.telegram.p004ui.Cells.AudioCell;
...
public class AudioSelectActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C39331 extends ActionBarMenuOnItemClick {
        C39331() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            audioCell.setDelegate(new C3584x73491598(this));
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (AudioSelectActivity.this.selectedAudios.indexOfKey(audioEntry.f54id) < 0) {
                z = false;
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("AttachMusic", C1067R.string.AttachMusic));
        this.actionBar.setActionBarMenuOnItemClick(new C39331());
        this.fragmentView = new FrameLayout(context);
        FrameLayout frameLayout = (FrameLayout) this.fragmentView;
        this.progressView = new EmptyTextProgressView(context);
        this.progressView.setText(LocaleController.getString("NoAudio", C1067R.string.NoAudio));
        ...
        this.listView.setOnItemClickListener(new C3585-$$Lambda$AudioSelectActivity$t7_oOYYhOZXWc6t1x4gHrcrcMM0(this));
        ...
        this.bottomLayout.cancelButton.setOnClickListener(new C1204-$$Lambda$AudioSelectActivity$1kNFEVrMBVP4AVP1qEJ7AqtPUlc(this));
        this.bottomLayout.doneButton.setOnClickListener(new C1205-$$Lambda$AudioSelectActivity$B7w290PyNFItb-f7pzlG0yYvSco(this));
    ...
    public /* synthetic */ void lambda$createView$0$AudioSelectActivity(View view, int i) {
        ...
        if (this.selectedAudios.indexOfKey(audioEntry.f54id) >= 0) {
            this.selectedAudios.remove(audioEntry.f54id);
            audioCell.setChecked(false);
        } else {
            this.selectedAudios.put(audioEntry.f54id, audioEntry);
    ...
    private void loadAudio() {
        ...
        Utilities.globalQueue.postRunnable(new C1206-$$Lambda$AudioSelectActivity$GEv7u1xk_gK3KYDecS-JYS1z0Do(this));
    }
    ...
    public /* synthetic */ void lambda$loadAudio$4$AudioSelectActivity() {
        ...
        try {
            ...
            while (query.moveToNext()) {
                try {
                    ...
                    audioEntry.f54id = (long) query.getInt(0);
                    ...
                    tL_message.media.document.f441id = 0;
        ...
        AndroidUtilities.runOnUIThread(new C1207-$$Lambda$AudioSelectActivity$QzekR4OrJV2j13f_JDzwyvvM314(this, arrayList));
        return;
        throw th22;
        if (query != null) {
            if (th3 != null) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        strArr[0] = "checkBox";
        r1[14] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_musicPicker_checkbox);
        ...
        strArr = new String[1];
        strArr[0] = "playButton";
        r1[16] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_musicPicker_buttonIcon);
        ...
        r1[20] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_picker_enabledButton);
        ...
        r1[22] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_picker_badgeText);
