...
public class IdenticonActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C30503 extends AnimatorListenerAdapter {
        C30503() {
        }
    ...
    class C30514 implements OnPreDrawListener {
        C30514() {
        }
    ...
    private static class LinkMovementMethodMy extends LinkMovementMethod {
        ...
        /* synthetic */ LinkMovementMethodMy(C42011 c42011) {
            this();
        }
    ...
    class C42011 extends ActionBarMenuOnItemClick {
        C42011() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("EncryptionKey", C1067R.string.EncryptionKey));
        this.actionBar.setActionBarMenuOnItemClick(new C42011());
        this.fragmentView = new FrameLayout(context);
        View view = this.fragmentView;
        FrameLayout frameLayout = (FrameLayout) view;
        view.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        this.fragmentView.setOnTouchListener(C1546-$$Lambda$IdenticonActivity$Yvzzx489TCib4oTluPwFgAoS_54.INSTANCE);
        ...
        frameLayout2.setPadding(AndroidUtilities.m26dp(20.0f), AndroidUtilities.m26dp(20.0f), AndroidUtilities.m26dp(20.0f), AndroidUtilities.m26dp(20.0f));
        ...
        this.container = new FrameLayout(context) {
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    i = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m26dp(16.0f);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m26dp(10.0f), 0, AndroidUtilities.m26dp(10.0f), 0);
        ...
        String str = Theme.key_windowBackgroundWhiteGrayText4;
        ...
        if (encryptedChat != null) {
            ...
            if (bArr.length > 16) {
                ...
                for (int i3 = 0; i3 < 5; i3++) {
                    ...
                    int i4 = (i3 * 4) + 16;
                    i = (bArr2[i4 + 3] & NalUnitUtil.EXTENDED_SAR) | ((((bArr2[i4] & 127) << 24) | ((bArr2[i4 + 1] & NalUnitUtil.EXTENDED_SAR) << 16)) | ((bArr2[i4 + 2] & NalUnitUtil.EXTENDED_SAR) << 8));
                    if (i3 != 0) {
            ...
            r3[0] = str2;
            r3[1] = str2;
            spannableStringBuilder.append(AndroidUtilities.replaceTags(LocaleController.formatString("EncryptionKeyDescription", C1067R.string.EncryptionKeyDescription, r3)));
            int indexOf = spannableStringBuilder.toString().indexOf("telegram.org");
            if (indexOf != -1) {
                spannableStringBuilder.setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", C1067R.string.EncryptionKeyLink)), indexOf, indexOf + 12, 33);
            }
    ...
    private void updateEmojiButton(boolean z) {
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C30503());
    ...
    private void fixLayout() {
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C30514());
    }
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        if (z && !z2) {
            ...
            if (str != null) {
                TextView textView = this.emojiTextView;
                textView.setText(Emoji.replaceEmoji(str, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m26dp(32.0f), false));
            }
        }
    }
