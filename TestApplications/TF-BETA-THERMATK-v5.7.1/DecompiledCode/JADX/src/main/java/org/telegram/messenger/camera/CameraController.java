...
public class CameraController implements OnInfoListener {
    ...
    public void initCamera(Runnable runnable) {
        ...
        if (!this.loadingCameras && !this.cameraInitied) {
            ...
            this.threadPool.execute(new C1084-$$Lambda$CameraController$MTo6g4R2dOVhEmQ7AM4dYTP1p5w(this));
        }
    }
    ...
    L_0x0008:
        ...
        r4 = org.telegram.messenger.camera.C1089-$$Lambda$CameraController$dwxNXb3SuNA_od-SPUyypaONvgM.INSTANCE;	 Catch:{ Exception -> 0x0255 }
    ...
    L_0x00fc:
        ...
        org.telegram.messenger.FileLog.m27d(r0);	 Catch:{ Exception -> 0x0249 }
        goto L_0x011d;
    L_0x011b:
        r18 = r1;
    L_0x011d:
    ...
    L_0x0175:
        ...
        org.telegram.messenger.FileLog.m27d(r7);	 Catch:{ Exception -> 0x0249 }
    L_0x0193:
        r1 = r1 + 1;
        r7 = 1280; // 0x500 float:1.794E-42 double:6.324E-321;
        goto L_0x0130;
    ...
    public void close(CameraSession cameraSession, CountDownLatch countDownLatch, Runnable runnable) {
        ...
        this.threadPool.execute(new C1085-$$Lambda$CameraController$Mku2q5OGwNan-h4puDdyST57U90(runnable, cameraSession, countDownLatch));
    ...
    private static int getOrientation(byte[] bArr) {
        ...
        while (i3 + 3 < bArr.length) {
            ...
            if ((bArr[i3] & NalUnitUtil.EXTENDED_SAR) == NalUnitUtil.EXTENDED_SAR) {
                i3 = bArr[i] & NalUnitUtil.EXTENDED_SAR;
    ...
    private static int pack(byte[] bArr, int i, int i2, boolean z) {
        ...
        while (true) {
            ...
            i4 = (bArr[i] & NalUnitUtil.EXTENDED_SAR) | (i4 << 8);
            i += i3;
            i2 = i5;
        }
    }
    ...
    public boolean takePicture(File file, CameraSession cameraSession, Runnable runnable) {
        ...
        try {
            cameraInfo.camera.takePicture(null, null, new C1086-$$Lambda$CameraController$Qbnmyb8uDsRl802IZhTfJAoPBlE(file, cameraInfo, isFlipFront, runnable));
            return true;
        } catch (Exception e) {
            FileLog.m30e(e);
            return false;
    ...
    public void startPreview(CameraSession cameraSession) {
        if (cameraSession != null) {
            this.threadPool.execute(new C1080-$$Lambda$CameraController$95vC3mtJ5YICFX1HGPyBSecWQH0(cameraSession));
        }
    }
    ...
    public void stopPreview(CameraSession cameraSession) {
        if (cameraSession != null) {
            this.threadPool.execute(new C1088-$$Lambda$CameraController$TvlSt-eAGck2RVWXRxqaBNBbvno(cameraSession));
        }
    }
    ...
    public void openRound(CameraSession cameraSession, SurfaceTexture surfaceTexture, Runnable runnable, Runnable runnable2) {
        ...
        this.threadPool.execute(new C1082-$$Lambda$CameraController$ANuBkffO3J8bla21iFygwDfs5Ss(cameraSession, runnable2, surfaceTexture, runnable));
    }
    ...
    static /* synthetic */ void lambda$openRound$8(CameraSession cameraSession, Runnable runnable, SurfaceTexture surfaceTexture, Runnable runnable2) {
        ...
        try {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("start creating round camera session");
            }
            if (camera == null) {
                CameraInfo cameraInfo = cameraSession.cameraInfo;
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m27d("round camera session created");
            }
        } catch (Exception e) {
            cameraSession.cameraInfo.camera = null;
            if (camera != null) {
    ...
    public void open(CameraSession cameraSession, SurfaceTexture surfaceTexture, Runnable runnable, Runnable runnable2) {
        if (cameraSession != null && surfaceTexture != null) {
            this.threadPool.execute(new C1091-$$Lambda$CameraController$nOnW1F7MY4Qrw4m6mXmkWXIiXBI(this, cameraSession, runnable2, surfaceTexture, runnable));
        }
    }
    ...
    public void recordVideo(CameraSession cameraSession, File file, VideoTakeCallback videoTakeCallback, Runnable runnable) {
        if (cameraSession != null) {
            CameraInfo cameraInfo = cameraSession.cameraInfo;
            this.threadPool.execute(new C1087-$$Lambda$CameraController$QhtYQbsLLWOPmfR7G2eDSElrRiU(this, cameraInfo.camera, cameraSession, file, cameraInfo, videoTakeCallback, runnable));
        }
    }
    ...
    L_0x0030:
        ...
        r0 = r9;
    L_0x0034:
        org.telegram.messenger.FileLog.m30e(r0);	 Catch:{ all -> 0x008c }
    ...
    L_0x007e:
        ...
        r0 = new org.telegram.messenger.camera.-$$Lambda$CameraController$5HicrJ12U2c73GyHfU8XHEFg--A;
        r3 = r0;
        r4 = r10;
        r3.<init>(r4, r5, r6, r7);
    ...
    public void stopVideoRecording(CameraSession cameraSession, boolean z) {
        this.threadPool.execute(new C1083-$$Lambda$CameraController$L4S5_dxkHAFS7LzqMIp7eixEAXY(this, cameraSession, z));
    }
    ...
    public /* synthetic */ void lambda$stopVideoRecording$13$CameraController(CameraSession cameraSession, boolean z) {
        try {
            ...
            this.threadPool.execute(new C1081-$$Lambda$CameraController$9retvXsm_Oz3JB3x45Buo-LxHfU(camera, cameraSession));
