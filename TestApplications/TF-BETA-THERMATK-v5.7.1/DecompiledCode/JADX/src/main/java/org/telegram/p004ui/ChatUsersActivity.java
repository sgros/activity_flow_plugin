...
import org.telegram.p004ui.Cells.TextCheckCell2;
...
public class ChatUsersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C40021 extends ActionBarMenuOnItemClick {
        C40021() {
        }
    ...
    class C40032 extends ActionBarMenuItemSearchListener {
        C40032() {
        }
    ...
    class C40043 implements ContactsAddActivityDelegate {
        C40043() {
        }

        public void didSelectUsers(ArrayList<User> arrayList, int i) {
            int size = arrayList.size();
            for (int i2 = 0; i2 < size; i2++) {
                MessagesController.getInstance(ChatUsersActivity.this.currentAccount).addUserToChat(ChatUsersActivity.this.chatId, (User) arrayList.get(i2), null, i, null, ChatUsersActivity.this, null);
            }
        }

        public void needAddBot(User user) {
            ChatUsersActivity.this.openRightsEdit(user.f534id, null, null, null, true, 0, false);
        }
    }

    /* renamed from: org.telegram.ui.ChatUsersActivity$4 */
    class C40054 extends OnScrollListener {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                case 0:
                    ...
                    manageChatUserCell.setDelegate(new C3659xde0325c0(this));
                    break;
                case 1:
                ...
                case 4:
                    manageChatUserCell = new FrameLayout(this.mContext) {
                        ...
                        public void onMeasure(int i, int i2) {
                            super.onMeasure(i, MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(i2) - AndroidUtilities.m26dp(56.0f), 1073741824));
                        }
                    };
                    manageChatUserCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    ...
                    imageView.setImageResource(C1067R.C1065drawable.group_ban_empty);
                    imageView.setScaleType(ScaleType.CENTER);
                    String str2 = Theme.key_emptyListPlaceholder;
                    ...
                    textView.setText(LocaleController.getString("NoBlockedUsers", C1067R.string.NoBlockedUsers));
                    ...
                    if (ChatUsersActivity.this.isChannel) {
                        textView.setText(LocaleController.getString("NoBlockedChannel2", C1067R.string.NoBlockedChannel2));
                    } else {
                        textView.setText(LocaleController.getString("NoBlockedGroup2", C1067R.string.NoBlockedGroup2));
                    }
                    textView.setTextColor(Theme.getColor(str2));
            ...
            switch (itemViewType) {
                case 0:
                    ...
                    if (ChatUsersActivity.this.type == 3) {
                        ...
                        formatString = z4 ? LocaleController.getString("ChannelCreator", C1067R.string.ChannelCreator) : (!z2 || MessagesController.getInstance(ChatUsersActivity.this.currentAccount).getUser(Integer.valueOf(i5)) == null) ? null : LocaleController.formatString("EditAdminPromotedBy", C1067R.string.EditAdminPromotedBy, ContactsController.formatName(MessagesController.getInstance(ChatUsersActivity.this.currentAccount).getUser(Integer.valueOf(i5)).first_name, MessagesController.getInstance(ChatUsersActivity.this.currentAccount).getUser(Integer.valueOf(i5)).last_name));
                        if (i2 != access$2700 - 1) {
                            z = true;
                        }
                        manageChatUserCell.setData(user, null, formatString, z);
                ...
                case 1:
                    ...
                    if (ChatUsersActivity.this.type == 0 || ChatUsersActivity.this.type == 3) {
                        ...
                        if (ChatObject.canBlockUsers(ChatUsersActivity.this.currentChat)) {
                            if (ChatUsersActivity.this.isChannel) {
                                textInfoPrivacyCell.setText(LocaleController.getString(str2, C1067R.string.NoBlockedChannel2));
                            } else {
                                textInfoPrivacyCell.setText(LocaleController.getString(str3, C1067R.string.NoBlockedGroup2));
                            }
                        ...
                        if (ChatUsersActivity.this.addNewRow != -1) {
                            if (ChatUsersActivity.this.isChannel) {
                                textInfoPrivacyCell.setText(LocaleController.getString("ChannelAdminsInfo", C1067R.string.ChannelAdminsInfo));
                            } else {
                                textInfoPrivacyCell.setText(LocaleController.getString("MegaAdminsInfo", C1067R.string.MegaAdminsInfo));
                            }
                            textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider_bottom, str));
                            return;
                        }
                        ...
                        if (ChatUsersActivity.this.isChannel && ChatUsersActivity.this.selectType == 0) {
                            textInfoPrivacyCell.setText(LocaleController.getString("ChannelMembersInfo", C1067R.string.ChannelMembersInfo));
                        } else {
                            textInfoPrivacyCell.setText("");
                        }
                        textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider_bottom, str));
                ...
                case 2:
                    ...
                    if (i2 == ChatUsersActivity.this.addNewRow) {
                        i2 = ChatUsersActivity.this.type;
                        String str4 = Theme.key_windowBackgroundWhiteBlueButton;
                        str = Theme.key_windowBackgroundWhiteBlueIcon;
                        if (i2 == 3) {
                            manageChatTextCell.setColors(str, str4);
                            string = LocaleController.getString("ChannelAddException", C1067R.string.ChannelAddException);
                            if (ChatUsersActivity.this.participantsStartRow != -1) {
                                z = true;
                            }
                            manageChatTextCell.setText(string, null, C1067R.C1065drawable.actions_removed, z);
                            return;
                        } else if (ChatUsersActivity.this.type == 0) {
                            manageChatTextCell.setText(LocaleController.getString("ChannelBlockUser", C1067R.string.ChannelBlockUser), null, C1067R.C1065drawable.actions_removed, false);
                            return;
                        } else if (ChatUsersActivity.this.type == 1) {
                            manageChatTextCell.setColors(str, str4);
                            manageChatTextCell.setText(LocaleController.getString("ChannelAddAdmin", C1067R.string.ChannelAddAdmin), null, C1067R.C1065drawable.add_admin, true);
                            return;
                        } else if (ChatUsersActivity.this.type == 2) {
                            manageChatTextCell.setColors(str, str4);
                            if (ChatUsersActivity.this.isChannel) {
                                string = LocaleController.getString("AddSubscriber", C1067R.string.AddSubscriber);
                                if (ChatUsersActivity.this.membersHeaderRow == -1 && !ChatUsersActivity.this.participants.isEmpty()) {
                                    z = true;
                                }
                                manageChatTextCell.setText(string, null, C1067R.C1065drawable.actions_addmember2, z);
                                return;
                            }
                            string = LocaleController.getString("AddMember", C1067R.string.AddMember);
                            if (ChatUsersActivity.this.membersHeaderRow == -1 && !ChatUsersActivity.this.participants.isEmpty()) {
                                z = true;
                            }
                            manageChatTextCell.setText(string, null, C1067R.C1065drawable.actions_addmember2, z);
                        ...
                        manageChatTextCell.setText(LocaleController.getString("EventLog", C1067R.string.EventLog), null, C1067R.C1065drawable.group_log, false);
                        return;
                    } else if (i2 == ChatUsersActivity.this.addNew2Row) {
                        manageChatTextCell.setText(LocaleController.getString("ChannelInviteViaLink", C1067R.string.ChannelInviteViaLink), null, C1067R.C1065drawable.profile_link, true);
                        return;
                    } else {
                        return;
                    }
                case 3:
                    if (i2 == ChatUsersActivity.this.addNewSectionRow || (ChatUsersActivity.this.type == 3 && i2 == ChatUsersActivity.this.participantsDividerRow && ChatUsersActivity.this.addNewRow == -1 && ChatUsersActivity.this.participantsStartRow == -1)) {
                        viewHolder2.itemView.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider_bottom, str));
                        return;
                    } else {
                        viewHolder2.itemView.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) C1067R.C1065drawable.greydivider, str));
                        return;
                    }
                case 5:
                    ...
                    if (i2 == ChatUsersActivity.this.restricted1SectionRow) {
                        if (ChatUsersActivity.this.type == 0) {
                            ...
                            if (i2 != 0) {
                                ...
                                headerCell.setText(LocaleController.getString("ChannelBlockedUsers", C1067R.string.ChannelBlockedUsers));
                                return;
                            }
                        }
                        headerCell.setText(LocaleController.getString("ChannelRestrictedUsers", C1067R.string.ChannelRestrictedUsers));
                        return;
                    } else if (i2 == ChatUsersActivity.this.permissionsSectionRow) {
                        headerCell.setText(LocaleController.getString("ChannelPermissionsHeader", C1067R.string.ChannelPermissionsHeader));
                        return;
                    } else {
                        return;
                    }
                case 6:
                    ...
                    string = LocaleController.getString("ChannelBlacklist", C1067R.string.ChannelBlacklist);
                ...
                case 7:
                    ...
                    if (i2 == ChatUsersActivity.this.changeInfoRow) {
                        access$3200 = LocaleController.getString("UserRestrictionsChangeInfo", C1067R.string.UserRestrictionsChangeInfo);
                        ...
                        textCheckCell2.setTextAndCheck(LocaleController.getString("UserRestrictionsInviteUsers", C1067R.string.UserRestrictionsInviteUsers), ChatUsersActivity.this.defaultBannedRights.invite_users ^ 1, true);
                    } else if (i2 == ChatUsersActivity.this.pinMessagesRow) {
                        access$3200 = LocaleController.getString("UserRestrictionsPinMessages", C1067R.string.UserRestrictionsPinMessages);
                        ...
                        textCheckCell2.setTextAndCheck(LocaleController.getString("UserRestrictionsSend", C1067R.string.UserRestrictionsSend), ChatUsersActivity.this.defaultBannedRights.send_messages ^ 1, true);
                    } else if (i2 == ChatUsersActivity.this.sendMediaRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString("UserRestrictionsSendMedia", C1067R.string.UserRestrictionsSendMedia), ChatUsersActivity.this.defaultBannedRights.send_media ^ 1, true);
                    } else if (i2 == ChatUsersActivity.this.sendStickersRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString("UserRestrictionsSendStickers", C1067R.string.UserRestrictionsSendStickers), ChatUsersActivity.this.defaultBannedRights.send_stickers ^ 1, true);
                    } else if (i2 == ChatUsersActivity.this.embedLinksRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString("UserRestrictionsEmbedLinks", C1067R.string.UserRestrictionsEmbedLinks), ChatUsersActivity.this.defaultBannedRights.embed_links ^ 1, true);
                    } else if (i2 == ChatUsersActivity.this.sendPollsRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString("UserRestrictionsSendPolls", C1067R.string.UserRestrictionsSendPolls), ChatUsersActivity.this.defaultBannedRights.send_polls ^ 1, true);
                    }
                    ...
                    if (!ChatObject.canBlockUsers(ChatUsersActivity.this.currentChat)) {
                        ...
                        textCheckCell2.setIcon(C1067R.C1065drawable.permission_locked);
                        return;
                    }
                case 8:
                    ...
                    if (i2 == ChatUsersActivity.this.membersHeaderRow) {
                        if (!ChatObject.isChannel(ChatUsersActivity.this.currentChat) || ChatUsersActivity.this.currentChat.megagroup) {
                            graySectionCell.setText(LocaleController.getString("ChannelOtherMembers", C1067R.string.ChannelOtherMembers));
                            return;
                        } else {
                            graySectionCell.setText(LocaleController.getString("ChannelOtherSubscribers", C1067R.string.ChannelOtherSubscribers));
                            return;
                        }
                    } else if (i2 == ChatUsersActivity.this.botHeaderRow) {
                        graySectionCell.setText(LocaleController.getString("ChannelBots", C1067R.string.ChannelBots));
                        return;
                    } else if (i2 != ChatUsersActivity.this.contactsHeaderRow) {
                        return;
                    } else {
                        if (!ChatObject.isChannel(ChatUsersActivity.this.currentChat) || ChatUsersActivity.this.currentChat.megagroup) {
                            graySectionCell.setText(LocaleController.getString("GroupContacts", C1067R.string.GroupContacts));
                            return;
                        } else {
                            graySectionCell.setText(LocaleController.getString("ChannelContacts", C1067R.string.ChannelContacts));
                            return;
                        }
                    }
                default:
    ...
    private class SearchAdapter extends SelectionAdapter {
        ...
        public void searchDialogs(String str) {
            ...
            C1452xf8b3d7f6 c1452xf8b3d7f6 = new C1452xf8b3d7f6(this, str);
            this.searchRunnable = c1452xf8b3d7f6;
            dispatchQueue.postRunnable(c1452xf8b3d7f6, 300);
        }
        ...
        private void processSearch(String str) {
            AndroidUtilities.runOnUIThread(new C1455x4cd4fa7a(this, str));
        }
        ...
        public /* synthetic */ void lambda$processSearch$2$ChatUsersActivity$SearchAdapter(String str) {
            ...
            if (arrayList2 != null || arrayList != null) {
                Utilities.searchQueue.postRunnable(new C1454x8f071ea7(this, str, arrayList2, arrayList));
            }
        }
     ...
     */
        ...
        L_0x0068:
            ...
            r15 = org.telegram.p004ui.ChatUsersActivity.this;
            ...
            r5 = r15.getUser(r5);
            r15 = r5.f534id;
            r10 = org.telegram.p004ui.ChatUsersActivity.this;
        ...
        L_0x0160:
            ...
            r6 = org.telegram.p004ui.ChatUsersActivity.this;
            ...
            r5 = r6.getUser(r5);
            r6 = r5.f534id;
            r7 = org.telegram.p004ui.ChatUsersActivity.this;
        ...
        L_0x0244:
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity$SearchAdapter.lambda$null$1$ChatUsersActivity$SearchAdapter(java.lang.String, java.util.ArrayList, java.util.ArrayList):void");
        }
        ...
        private void updateSearchResults(ArrayList<TLObject> arrayList, ArrayList<CharSequence> arrayList2, ArrayList<TLObject> arrayList3) {
            AndroidUtilities.runOnUIThread(new C1453xd139ca9(this, arrayList, arrayList2, arrayList3));
        }
     ...
     */
        ...
        L_0x0061:
            return r1;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity$SearchAdapter.getItem(int):org.telegram.tgnet.TLObject");
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                graySectionCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                graySectionCell.setDelegate(new C3661x9739b102(this));
            }
        ...
        L_0x000b:
            r14 = r14.itemView;
            r14 = (org.telegram.p004ui.Cells.GraySectionCell) r14;
        ...
        L_0x001b:
            r15 = 2131558934; // 0x7f0d0216 float:1.8743198E38 double:1.0531300414E-314;
        ...
        L_0x0032:
            r15 = 2131558996; // 0x7f0d0254 float:1.8743324E38 double:1.053130072E-314;
        ...
        L_0x0048:
            r15 = 2131559004; // 0x7f0d025c float:1.874334E38 double:1.053130076E-314;
            r0 = "ChannelSubscribers";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01bc;
        L_0x0056:
            r15 = 2131558962; // 0x7f0d0232 float:1.8743255E38 double:1.053130055E-314;
            r0 = "ChannelMembers";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01bc;
        ...
        L_0x0068:
            r15 = 2131559594; // 0x7f0d04aa float:1.8744536E38 double:1.0531303675E-314;
            r0 = "GlobalSearch";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01bc;
        ...
        L_0x007a:
            r15 = 2131559149; // 0x7f0d02ed float:1.8743634E38 double:1.0531301476E-314;
            r0 = "Contacts";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01bc;
        ...
        L_0x0097:
            r2 = org.telegram.p004ui.ChatUsersActivity.this;
        ...
        L_0x0173:
            ...
            r12 = org.telegram.p004ui.ActionBar.Theme.getColor(r10);	 Catch:{ Exception -> 0x0181 }
        ...
        L_0x019d:
            ...
            r5 = org.telegram.p004ui.ActionBar.Theme.getColor(r10);
            r2.<init>(r5);
            r5 = r6.length();
            r5 = r5 + r15;
        ...
        L_0x01ae:
            r14 = r14.itemView;
            r14 = (org.telegram.p004ui.Cells.ManageChatUserCell) r14;
        ...
        L_0x01bc:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity$SearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    public boolean onFragmentCreate() {
        ...
        loadChatParticipants(0, Callback.DEFAULT_DRAG_ANIMATION_DURATION);
        return true;
    }
    ...
    public android.view.View createView(android.content.Context r10) {
        ...
        r9.searchWas = r0;
        r1 = r9.actionBar;
        r2 = 2131165409; // 0x7f0700e1 float:1.7945034E38 double:1.052935614E-314;
    ...
    L_0x002b:
        r1 = r9.actionBar;
        r5 = 2131558932; // 0x7f0d0214 float:1.8743194E38 double:1.0531300404E-314;
        r6 = "ChannelBlacklist";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a5;
    ...
    L_0x003c:
        r1 = r9.actionBar;
        r5 = 2131558927; // 0x7f0d020f float:1.8743184E38 double:1.053130038E-314;
    ...
    L_0x0055:
        r1 = r9.actionBar;
        r5 = 2131559004; // 0x7f0d025c float:1.874334E38 double:1.053130076E-314;
    ...
    L_0x0075:
        r1 = r9.actionBar;
        r5 = 2131558918; // 0x7f0d0206 float:1.8743165E38 double:1.0531300335E-314;
        r6 = "ChannelAddAdmin";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a5;
    ...
    L_0x0086:
        r1 = r9.actionBar;
        r5 = 2131558933; // 0x7f0d0215 float:1.8743196E38 double:1.053130041E-314;
        r6 = "ChannelBlockUser";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a5;
    ...
    L_0x0097:
        r1 = r9.actionBar;
        r5 = 2131558919; // 0x7f0d0207 float:1.8743167E38 double:1.053130034E-314;
    ...
    L_0x00bb:
        ...
        r1 = r9.actionBar;
        r1 = r1.createMenu();
        r5 = 2131165419; // 0x7f0700eb float:1.7945055E38 double:1.052935619E-314;
        r5 = r1.addItem(r0, r5);
    ...
    L_0x00e2:
        r5 = r9.searchItem;
        r6 = 2131558997; // 0x7f0d0255 float:1.8743326E38 double:1.0531300725E-314;
    ...
    L_0x00f1:
        r5 = r9.searchItem;
        r6 = 2131560640; // 0x7f0d08c0 float:1.8746658E38 double:1.0531308843E-314;
        r7 = "Search";
        r6 = org.telegram.messenger.LocaleController.getString(r7, r6);
        r5.setSearchFieldHint(r6);
    L_0x00ff:
    ...
    L_0x0103:
        r5 = 2131165439; // 0x7f0700ff float:1.7945095E38 double:1.052935629E-314;
        r6 = 1113587712; // 0x42600000 float:56.0 double:5.50185432E-315;
        r6 = org.telegram.messenger.AndroidUtilities.m26dp(r6);
        r7 = 2131559299; // 0x7f0d0383 float:1.8743938E38 double:1.0531302217E-314;
        r8 = "Done";
    ...
    L_0x0140:
        r4 = r9.emptyView;
        r5 = 2131559943; // 0x7f0d0607 float:1.8745244E38 double:1.05313054E-314;
        r6 = "NoResult";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r4.setText(r5);
    L_0x014e:
        ...
        r6 = -1;
        r7 = org.telegram.p004ui.Components.LayoutHelper.createFrame(r6, r5);
        r1.addView(r4, r7);
    ...
    L_0x018b:
        ...
        r10 = r9.listView;
        r0 = org.telegram.p004ui.Components.LayoutHelper.createFrame(r6, r5);
        r1.addView(r10, r0);
        r10 = r9.listView;
    ...
    L_0x01c8:
        ...
        return r10;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity.createView(android.content.Context):android.view.View");
    }
    ...
    L_0x00f7:
        r1 = r20;
        r1 = (org.telegram.p004ui.Cells.TextCheckCell2) r1;
        r2 = r1.isEnabled();
    ...
    L_0x011a:
        ...
        r1 = 2131559320; // 0x7f0d0398 float:1.874398E38 double:1.053130232E-314;
    ...
    L_0x012f:
        r0 = r19.getParentActivity();
        r1 = 2131559319; // 0x7f0d0397 float:1.8743979E38 double:1.0531302316E-314;
    ...
    L_0x01d1:
        r0 = r0.itemView;
        r0 = (org.telegram.p004ui.Cells.TextCheckCell2) r0;
        r0.setChecked(r3);
    L_0x01d8:
        r0 = r8.defaultBannedRights;
        r1 = r0.view_messages;
    ...
    L_0x03a8:
        ...
        r10.setTitle(r0);
        r0 = 2131558598; // 0x7f0d00c6 float:1.8742516E38 double:1.0531298754E-314;
        ...
        r0 = 2131558891; // 0x7f0d01eb float:1.874311E38 double:1.05313002E-314;
        r1 = "Cancel";
        r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
    ...
    L_0x04cf:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity.lambda$createView$4$ChatUsersActivity(android.view.View, int):void");
    }
    ...
    public /* synthetic */ void lambda$null$1$ChatUsersActivity(int i, TLObject tLObject) {
        if (tLObject != null && this.participantsMap.get(i) == null) {
            ...
            Collections.sort(this.participants, new C1450-$$Lambda$ChatUsersActivity$M5Fh2EarJwZERsobLDwzO3z4iPk(this));
            updateRows();
    ...
    public /* synthetic */ void lambda$null$2$ChatUsersActivity(User user, TLObject tLObject, TL_chatAdminRights tL_chatAdminRights, TL_chatBannedRights tL_chatBannedRights, boolean z, DialogInterface dialogInterface, int i) {
        openRightsEdit(user.f534id, tLObject, tL_chatAdminRights, tL_chatBannedRights, z, this.selectType == 1 ? 0 : 1, false);
    }
    ...
    private void openRightsEdit2(int i, int i2, TLObject tLObject, TL_chatAdminRights tL_chatAdminRights, TL_chatBannedRights tL_chatBannedRights, boolean z, int i3, boolean z2) {
        ...
        int i4 = i2;
        chatRightsEditActivity.setDelegate(new C3656-$$Lambda$ChatUsersActivity$0nOnj72e_Go4w-fy56ow2OoyZ5U(this, i3, i, i2));
    ...
    private void openRightsEdit(int i, TLObject tLObject, TL_chatAdminRights tL_chatAdminRights, TL_chatBannedRights tL_chatBannedRights, boolean z, int i2, boolean z2) {
        ...
        chatRightsEditActivity.setDelegate(new C3667-$$Lambda$ChatUsersActivity$s-tj1rO5rel9STPZNYUOQpZ18CQ(this, tLObject, z3));
    ...
    L_0x004e:
        r3 = r10.type;
        r5 = 2131559317; // 0x7f0d0395 float:1.8743975E38 double:1.0531302306E-314;
        r11 = "EditAdminRights";
        r12 = "dialogRedIcon";
        r13 = "dialogTextRed2";
        r15 = 2;
    ...
    L_0x00c7:
        ...
        goto L_0x00d5;
    L_0x00cc:
        r0 = 2131560731; // 0x7f0d091b float:1.8746843E38 double:1.053130929E-314;
        r2 = "SetAsAdmin";
        r0 = org.telegram.messenger.LocaleController.getString(r2, r0);
    L_0x00d5:
        r15.add(r0);
        r0 = 2131165271; // 0x7f070057 float:1.7944754E38 double:1.052935546E-314;
        r0 = java.lang.Integer.valueOf(r0);
        r1.add(r0);
        r0 = 0;
    ...
    L_0x0108:
        r0 = 2131558910; // 0x7f0d01fe float:1.874315E38 double:1.0531300295E-314;
        ...
        r5.add(r0);
    L_0x0125:
        r0 = 2131559714; // 0x7f0d0522 float:1.874478E38 double:1.0531304267E-314;
        r2 = "KickFromGroup";
        r0 = org.telegram.messenger.LocaleController.getString(r2, r0);
        r15.add(r0);
        r0 = 2131165274; // 0x7f07005a float:1.794476E38 double:1.0529355475E-314;
        r0 = java.lang.Integer.valueOf(r0);
        r1.add(r0);
        r2 = 2;
    ...
    L_0x0144:
        r0 = 2131165274; // 0x7f07005a float:1.794476E38 double:1.0529355475E-314;
        r2 = 2;
        r11 = 2131558994; // 0x7f0d0252 float:1.874332E38 double:1.053130071E-314;
    ...
    L_0x01a8:
        ...
        r2 = 1;
        r1 = r1 - r2;
        r2 = org.telegram.p004ui.ActionBar.Theme.getColor(r20);
        r3 = org.telegram.p004ui.ActionBar.Theme.getColor(r19);
    ...
    L_0x01be:
        ...
        r20 = r13;
        r0 = 3;
        r2 = 2131558945; // 0x7f0d0221 float:1.874322E38 double:1.053130047E-314;
    ...
    L_0x01d6:
        ...
        r5 = 2131558951; // 0x7f0d0227 float:1.8743232E38 double:1.05313005E-314;
    ...
    L_0x0215:
        r0 = 2131558922; // 0x7f0d020a float:1.8743173E38 double:1.0531300354E-314;
        r3 = "ChannelAddToChannel";
        goto L_0x0220;
    L_0x021b:
        r0 = 2131558923; // 0x7f0d020b float:1.8743176E38 double:1.053130036E-314;
    ...
    L_0x024b:
        r0 = r10.currentChat;
        r0 = r0.creator;
        r2 = 2131558995; // 0x7f0d0253 float:1.8743322E38 double:1.0531300715E-314;
    ...
    L_0x0260:
        ...
        r1[r7] = r2;
        r2 = new int[r0];
        r3 = 2131165274; // 0x7f07005a float:1.794476E38 double:1.0529355475E-314;
        r2[r7] = r3;
        r12 = r1;
        goto L_0x0289;
    L_0x0273:
    ...
    L_0x02b7:
        r1 = r12.length;
        r1 = r1 - r2;
        r3 = org.telegram.p004ui.ActionBar.Theme.getColor(r20);
        r4 = org.telegram.p004ui.ActionBar.Theme.getColor(r19);
    ...
    L_0x02c7:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity.createMenuForParticipant(org.telegram.tgnet.TLObject, boolean):boolean");
    }
    ...
    public /* synthetic */ void lambda$createMenuForParticipant$9$ChatUsersActivity(ArrayList arrayList, User user, int i, boolean z, TLObject tLObject, int i2, TL_chatAdminRights tL_chatAdminRights, TL_chatBannedRights tL_chatBannedRights, DialogInterface dialogInterface, int i3) {
        ...
        if (z && ((tLObject2 instanceof TL_channelParticipantAdmin) || (tLObject2 instanceof TL_chatParticipantAdmin))) {
            ...
            builder.setMessage(LocaleController.formatString("AdminWillBeRemoved", C1067R.string.AdminWillBeRemoved, ContactsController.formatName(user2.first_name, user2.last_name)));
            builder.setPositiveButton(LocaleController.getString("OK", C1067R.string.f61OK), new C1460-$$Lambda$ChatUsersActivity$qfOJbwP_In4NBZQ0LodUcQ4-E5A(this, i, i2, tLObject, tL_chatAdminRights, tL_chatBannedRights, z, arrayList, i3));
    ...
    public /* synthetic */ void lambda$createMenuForParticipant$14$ChatUsersActivity(CharSequence[] charSequenceArr, int i, TL_chatAdminRights tL_chatAdminRights, TLObject tLObject, TL_chatBannedRights tL_chatBannedRights, DialogInterface dialogInterface, int i2) {
        ...
        if (i5 == 1) {
            if (i4 == 0 && charSequenceArr.length == 2) {
                ...
                chatRightsEditActivity.setDelegate(new C3663-$$Lambda$ChatUsersActivity$VvBPc6EKF-AvBHC8o_spJJmYy1w(this, tLObject2));
                presentFragment(chatRightsEditActivity);
                return;
            }
            ...
            if (i4 == 0) {
                ...
                if (i5 == 3) {
                    ...
                    chatRightsEditActivity.setDelegate(new C3658-$$Lambda$ChatUsersActivity$Kj7_HFBJQnmhoJfYSpDZ4Apo2QA(this, tLObject2));
                    presentFragment(chatRightsEditActivity);
                } else if (i5 == 0) {
                    i7 = 1;
                    i6 = i4;
                ...
                if (i6 == 1) {
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_editBanned, new C3665-$$Lambda$ChatUsersActivity$YPa3vUbbr6vXSVmrX-ZenS-Yswk(this));
                    if (this.searchItem != null && this.actionBar.isSearchFieldVisible()) {
                        this.actionBar.closeSearchField();
                    }
                }
    ...
    public /* synthetic */ void lambda$null$13$ChatUsersActivity(TLObject tLObject, TL_error tL_error) {
        if (tLObject != null) {
            ...
            if (!updates.chats.isEmpty()) {
                AndroidUtilities.runOnUIThread(new C1447-$$Lambda$ChatUsersActivity$4z_sufq32stWQmeljAxBuSXODwQ(this, updates), 1000);
            }
        }
    }

    public /* synthetic */ void lambda$null$12$ChatUsersActivity(Updates updates) {
        MessagesController.getInstance(this.currentAccount).loadFullChat(((Chat) updates.chats.get(0)).f434id, 0, true);
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            if (!booleanValue || !ChatObject.isChannel(this.currentChat)) {
                this.info = chatFull;
                AndroidUtilities.runOnUIThread(new C1457-$$Lambda$ChatUsersActivity$i3MUTxy-8Wq7Kw42VYgYl8VfzuQ(this));
            }
        }
    }
    ...
    private boolean checkDiscard() {
        ...
        if (this.isChannel) {
            builder.setMessage(LocaleController.getString("ChannelSettingsChangedAlert", C1067R.string.ChannelSettingsChangedAlert));
        } else {
            builder.setMessage(LocaleController.getString("GroupSettingsChangedAlert", C1067R.string.GroupSettingsChangedAlert));
        }
        builder.setPositiveButton(LocaleController.getString("ApplyTheme", C1067R.string.ApplyTheme), new C1456-$$Lambda$ChatUsersActivity$Yqu9jp4YK_ycF-M_XeitW5mibTI(this));
        builder.setNegativeButton(LocaleController.getString("PassportDiscard", C1067R.string.PassportDiscard), new C1446-$$Lambda$ChatUsersActivity$236mIhGiuKn_O04cfPssFb-GqQI(this));
        showDialog(builder.create());
        return false;
    }
    ...
    private String formatUserPermissions(TL_chatBannedRights tL_chatBannedRights) {
        ...
        if (z && this.defaultBannedRights.view_messages != z) {
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoRead", C1067R.string.UserRestrictionsNoRead));
        }
        ...
        if (z && this.defaultBannedRights.send_messages != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoSend", C1067R.string.UserRestrictionsNoSend));
        }
        ...
        if (z && this.defaultBannedRights.send_media != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoSendMedia", C1067R.string.UserRestrictionsNoSendMedia));
        }
        ...
        if (z && this.defaultBannedRights.send_stickers != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoSendStickers", C1067R.string.UserRestrictionsNoSendStickers));
        }
        ...
        if (z && this.defaultBannedRights.send_polls != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoSendPolls", C1067R.string.UserRestrictionsNoSendPolls));
        }
        ...
        if (z && this.defaultBannedRights.embed_links != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoEmbedLinks", C1067R.string.UserRestrictionsNoEmbedLinks));
        }
        ...
        if (z && this.defaultBannedRights.invite_users != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoInviteUsers", C1067R.string.UserRestrictionsNoInviteUsers));
        }
        ...
        if (z && this.defaultBannedRights.pin_messages != z) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoPinMessages", C1067R.string.UserRestrictionsNoPinMessages));
        }
        ...
        if (z2 && this.defaultBannedRights.change_info != z2) {
            ...
            stringBuilder.append(LocaleController.getString("UserRestrictionsNoChangeInfo", C1067R.string.UserRestrictionsNoChangeInfo));
        }
        if (stringBuilder.length() != 0) {
    ...
    private void loadChatParticipants(int i, int i2, boolean z) {
        ...
        if (ChatObject.isChannel(this.currentChat)) {
            ...
            if (i4 == 0) {
                ...
                if (this.selectType == 1) {
                    if (this.contactsEndReached) {
                        ...
                        loadChatParticipants(0, Callback.DEFAULT_DRAG_ANIMATION_DURATION, false);
                    }
            ...
            tL_channels_getParticipants.filter.f433q = "";
            tL_channels_getParticipants.offset = i;
            tL_channels_getParticipants.limit = i2;
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getParticipants, new C3662-$$Lambda$ChatUsersActivity$VPgAUAFJXqsKcGEM9EFJ9hJ7L7M(this, tL_channels_getParticipants)), this.classGuid);
            return;
        }
    ...
    public /* synthetic */ void lambda$loadChatParticipants$21$ChatUsersActivity(TL_channels_getParticipants tL_channels_getParticipants, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new C1448-$$Lambda$ChatUsersActivity$IhBMaAxofZIxg2fr49it1UefZbE(this, tL_error, tLObject, tL_channels_getParticipants));
    }
    ...
    public /* synthetic */ void lambda$null$20$ChatUsersActivity(TL_error tL_error, TLObject tLObject, TL_channels_getParticipants tL_channels_getParticipants) {
        if (tL_error == null) {
            ...
            try {
                if ((this.type == 0 || this.type == 3 || this.type == 2) && this.currentChat != null && this.currentChat.megagroup && (this.info instanceof TL_channelFull) && this.info.participants_count <= Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                    Collections.sort(arrayList, new C1449-$$Lambda$ChatUsersActivity$JfDHhpbwPgHf9ZtKvhAah5Ozjtk(this, ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()));
                } else if (this.type == 1) {
                    Collections.sort(this.participants, new C1458-$$Lambda$ChatUsersActivity$kCXpt6NAhotHD9nHkOp2DvagI6I(this));
                }
            } catch (Exception e) {
                FileLog.m30e(e);
            }
    ...
    L_0x0073:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.ChatUsersActivity.lambda$null$18$ChatUsersActivity(int, org.telegram.tgnet.TLObject, org.telegram.tgnet.TLObject):int");
    }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        C3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo = new C3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo(this);
        r11 = new ThemeDescription[36];
        r11[0] = new ThemeDescription(this.listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{HeaderCell.class, ManageChatUserCell.class, ManageChatTextCell.class, TextCheckCell2.class, TextSettingsCell.class}, null, null, null, Theme.key_windowBackgroundWhite);
        ...
        r11[7] = new ThemeDescription(this.listView, ThemeDescription.FLAG_SELECTOR, null, null, null, null, Theme.key_listSelector);
        r11[8] = new ThemeDescription(this.listView, 0, new Class[]{View.class}, Theme.dividerPaint, null, null, Theme.key_divider);
        View view = this.listView;
        View view2 = view;
        r11[9] = new ThemeDescription(view2, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{TextInfoPrivacyCell.class}, null, null, null, Theme.key_windowBackgroundGrayShadow);
        view = this.listView;
        Class[] clsArr = new Class[]{TextInfoPrivacyCell.class};
        String[] strArr = new String[1];
        strArr[0] = "textView";
        r11[10] = new ThemeDescription(view, 0, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteGrayText4);
        view = this.listView;
        view2 = view;
        r11[11] = new ThemeDescription(view2, ThemeDescription.FLAG_BACKGROUNDFILTER, new Class[]{ShadowSectionCell.class}, null, null, null, Theme.key_windowBackgroundGrayShadow);
        r11[12] = new ThemeDescription(this.listView, 0, new Class[]{HeaderCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlueHeader);
        r11[13] = new ThemeDescription(this.listView, 0, new Class[]{GraySectionCell.class}, new String[]{"textView"}, null, null, null, Theme.key_graySectionText);
        view = this.listView;
        view2 = view;
        r11[14] = new ThemeDescription(view2, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{GraySectionCell.class}, null, null, null, Theme.key_graySection);
        r11[15] = new ThemeDescription(this.listView, 0, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        view = this.listView;
        clsArr = new Class[]{TextSettingsCell.class};
        strArr = new String[1];
        strArr[0] = "valueTextView";
        r11[16] = new ThemeDescription(view, 0, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteValueText);
        r11[17] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell2.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        r11[18] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell2.class}, new String[]{"valueTextView"}, null, null, null, Theme.key_windowBackgroundWhiteGrayText2);
        view = this.listView;
        clsArr = new Class[]{TextCheckCell2.class};
        strArr = new String[1];
        strArr[0] = "checkBox";
        r11[19] = new ThemeDescription(view, 0, clsArr, strArr, null, null, null, Theme.key_switch2Track);
        r11[20] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell2.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switch2TrackChecked);
        r11[21] = new ThemeDescription(this.listView, 0, new Class[]{ManageChatUserCell.class}, new String[]{"nameTextView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        ThemeDescriptionDelegate themeDescriptionDelegate = c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo;
        r11[22] = new ThemeDescription(this.listView, 0, new Class[]{ManageChatUserCell.class}, new String[]{"statusColor"}, null, null, themeDescriptionDelegate, Theme.key_windowBackgroundWhiteGrayText);
        r11[23] = new ThemeDescription(this.listView, 0, new Class[]{ManageChatUserCell.class}, new String[]{"statusOnlineColor"}, null, null, themeDescriptionDelegate, Theme.key_windowBackgroundWhiteBlueText);
        r11[24] = new ThemeDescription(this.listView, 0, new Class[]{ManageChatUserCell.class}, null, new Drawable[]{Theme.avatar_broadcastDrawable, Theme.avatar_savedDrawable}, null, Theme.key_avatar_text);
        C3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2 = c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo;
        r11[25] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundRed);
        r11[26] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundOrange);
        r11[27] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundViolet);
        r11[28] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundGreen);
        r11[29] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundCyan);
        r11[30] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundBlue);
        r11[31] = new ThemeDescription(null, 0, null, null, null, c3666-$$Lambda$ChatUsersActivity$dJZ4uYLUeYD83G4_LKo6mt8S4mo2, Theme.key_avatar_backgroundPink);
        view = this.listView;
        View view3 = view;
        r11[32] = new ThemeDescription(view3, ThemeDescription.FLAG_CHECKTAG, new Class[]{ManageChatTextCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        view = this.listView;
        int i = ThemeDescription.FLAG_CHECKTAG;
        clsArr = new Class[]{ManageChatTextCell.class};
        strArr = new String[1];
        strArr[0] = "imageView";
        r11[33] = new ThemeDescription(view, i, clsArr, strArr, null, null, null, Theme.key_windowBackgroundWhiteGrayIcon);
        view = this.listView;
        view3 = view;
        r11[34] = new ThemeDescription(view3, ThemeDescription.FLAG_CHECKTAG, new Class[]{ManageChatTextCell.class}, new String[]{"imageView"}, null, null, null, Theme.key_windowBackgroundWhiteBlueButton);
        view = this.listView;
        view3 = view;
        r11[35] = new ThemeDescription(view3, ThemeDescription.FLAG_CHECKTAG, new Class[]{ManageChatTextCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlueIcon);
        return r11;
    }
