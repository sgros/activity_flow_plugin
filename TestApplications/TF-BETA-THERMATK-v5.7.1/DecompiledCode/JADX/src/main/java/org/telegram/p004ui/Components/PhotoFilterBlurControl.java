...
public class PhotoFilterBlurControl extends FrameLayout {
    private static final float BlurInsetProximity = ((float) AndroidUtilities.m26dp(20.0f));
    private static final float BlurMinimumDifference = 0.02f;
    private static final float BlurMinimumFalloff = 0.1f;
    private static final float BlurViewCenterInset = ((float) AndroidUtilities.m26dp(30.0f));
    private static final float BlurViewRadiusInset = ((float) AndroidUtilities.m26dp(30.0f));
    ...
    static /* synthetic */ class C29111 {
        ...
        static final /* synthetic */ int[] f598xcde84254 = new int[BlurViewActiveControl.values().length];
        ...
        static {
            /*
            r0 = org.telegram.p004ui.Components.PhotoFilterBlurControl.BlurViewActiveControl.values();
            r0 = r0.length;
            r0 = new int[r0];
            f598xcde84254 = r0;
            r0 = f598xcde84254;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = org.telegram.p004ui.Components.PhotoFilterBlurControl.BlurViewActiveControl.BlurViewActiveControlCenter;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = 1;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r0 = f598xcde84254;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = org.telegram.p004ui.Components.PhotoFilterBlurControl.BlurViewActiveControl.BlurViewActiveControlInnerRadius;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x001f }
            r2 = 2;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x001f }
        L_0x001f:
            r0 = f598xcde84254;	 Catch:{ NoSuchFieldError -> 0x002a }
            r1 = org.telegram.p004ui.Components.PhotoFilterBlurControl.BlurViewActiveControl.BlurViewActiveControlOuterRadius;	 Catch:{ NoSuchFieldError -> 0x002a }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x002a }
            r2 = 3;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x002a }
        L_0x002a:
            r0 = f598xcde84254;	 Catch:{ NoSuchFieldError -> 0x0035 }
            r1 = org.telegram.p004ui.Components.PhotoFilterBlurControl.BlurViewActiveControl.BlurViewActiveControlRotation;	 Catch:{ NoSuchFieldError -> 0x0035 }
        ...
        L_0x0035:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.PhotoFilterBlurControl$C29111.<clinit>():void");
        }
    }
    ...
    public PhotoFilterBlurControl(Context context) {
        ...
        this.arcPaint.setStrokeWidth((float) AndroidUtilities.m26dp(2.0f));
    ...
    L_0x00a2:
        ...
        r13 = (double) r8;
        r15 = 4609753056924675352; // 0x3ff921fb54442d18 float:3.37028055E12 double:1.5707963267948966;
    ...
    L_0x016d:
        return r6;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p004ui.Components.PhotoFilterBlurControl.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void handlePan(int i, MotionEvent motionEvent) {
        ...
        Point point = new Point(x - actualCenterPoint.f600x, y - actualCenterPoint.f601y);
        float f = point.f600x;
        f *= f;
        float f2 = point.f601y;
        ...
        Double.isNaN(d);
        d *= degreesToRadians;
        degreesToRadians = (double) point.f601y;
        float f5 = f3;
        float f6 = f4;
        ...
        if (i2 == 1) {
            ...
            Size size3;
            if (i2 == 0) {
                i2 = C29111.f598xcde84254[this.activeControl.ordinal()];
                if (i2 == 1) {
                    ...
                    abs = rect.f602x;
                    x = Math.max(abs, Math.min(rect.width + abs, this.startCenterPoint.f600x + x));
                    abs = rect.f603y;
                    actualCenterPoint = new Point(x, Math.max(abs, Math.min(rect.height + abs, this.startCenterPoint.f601y + y)));
                    y = actualCenterPoint.f600x - rect.f602x;
                    size3 = this.actualAreaSize;
                    f = size3.width;
                    this.centerPoint = new Point(y / f, ((actualCenterPoint.f601y - rect.f603y) + ((f - size3.height) / 2.0f)) / f);
                } else if (i2 == 2) {
                    this.falloff = Math.min(Math.max(BlurMinimumFalloff, (this.startRadius + (abs - this.startDistance)) / f2), this.size - BlurMinimumDifference);
                } else if (i2 == 3) {
                    this.size = Math.max(this.falloff + BlurMinimumDifference, (this.startRadius + (abs - this.startDistance)) / f2);
                } else if (i2 == 4) {
                    int i4;
                    f7 = x - this.pointerStartX;
                    abs = y - this.pointerStartY;
                    Object obj = x > actualCenterPoint.f600x ? 1 : null;
                    Object obj2 = y > actualCenterPoint.f601y ? 1 : null;
                    if (obj == null && obj2 == null ? Math.abs(abs) <= Math.abs(f7) ? f7 <= BlurInsetProximity : abs >= BlurInsetProximity : obj == null || obj2 != null ? obj == null || obj2 == null ? Math.abs(abs) <= Math.abs(f7) ? f7 >= BlurInsetProximity : abs >= BlurInsetProximity : Math.abs(abs) <= Math.abs(f7) ? f7 >= BlurInsetProximity : abs <= BlurInsetProximity : Math.abs(abs) <= Math.abs(f7) ? f7 <= BlurInsetProximity : abs <= BlurInsetProximity) {
                        i4 = 1;
                    }
                ...
                if (i2 == 1) {
                    ...
                    this.falloff = Math.min(Math.max(BlurMinimumFalloff, (this.startRadius + (f - this.startDistance)) / f2), this.size - BlurMinimumDifference);
                } else if (i2 == 3) {
                    this.size = Math.max(this.falloff + BlurMinimumDifference, (this.startRadius + (f - this.startDistance)) / f2);
                }
            }
            invalidate();
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas2.translate(actualCenterPoint.f600x, actualCenterPoint.f601y);
        int i = this.type;
        if (i == 0) {
            float f;
            float f2;
            ...
            float dp = (float) AndroidUtilities.m26dp(6.0f);
            float dp2 = (float) AndroidUtilities.m26dp(12.0f);
            float dp3 = (float) AndroidUtilities.m26dp(1.5f);
            int i3 = 0;
            while (i3 < 30) {
                f = dp2 + dp;
                f2 = ((float) i3) * f;
            ...
            actualInnerRadius = (float) AndroidUtilities.m26dp(6.0f);
            for (i2 = 0; i2 < 64; i2++) {
                ...
                f3 = f2;
                f5 = f10;
                canvas.drawRect(dp2, f10, f, f3, this.paint);
                f9 = (((float) (-i2)) * f9) - dp;
            ...
            this.arcRect.set(f11, f11, actualInnerRadius, actualInnerRadius);
            for (i4 = 0; i4 < 22; i4++) {
                canvas.drawArc(this.arcRect, 16.35f * ((float) i4), 10.2f, false, this.arcPaint);
            }
            f11 = -actualOuterRadius;
            this.arcRect.set(f11, f11, actualOuterRadius, actualOuterRadius);
            for (i4 = 0; i4 < 64; i4++) {
                canvas.drawArc(this.arcRect, 5.62f * ((float) i4), 3.6f, false, this.arcPaint);
            }
        }
        canvas2.drawCircle(BlurInsetProximity, BlurInsetProximity, (float) AndroidUtilities.m26dp(8.0f), this.paint);
    }

    private Point getActualCenterPoint() {
        float width = (float) getWidth();
        float f = this.actualAreaSize.width;
        width = ((width - f) / 2.0f) + (this.centerPoint.f600x * f);
        ...
        f += (height - f2) / 2.0f;
        height = size.width;
        return new Point(width, (f - ((height - f2) / 2.0f)) + (this.centerPoint.f601y * height));
    }
