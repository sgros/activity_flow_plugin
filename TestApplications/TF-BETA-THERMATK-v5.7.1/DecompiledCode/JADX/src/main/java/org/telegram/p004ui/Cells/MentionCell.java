...
public class MentionCell extends LinearLayout {
    ...
    public MentionCell(Context context) {
        ...
        this.imageView.setRoundRadius(AndroidUtilities.m26dp(14.0f));
    ...
    public void setEmojiSuggestion(KeywordResult keywordResult) {
        ...
        textView.setText(Emoji.replaceEmoji(stringBuilder, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m26dp(20.0f), false));
    }
    ...
    public void setBotCommand(String str, String str2, User user) {
        ...
        this.nameTextView.setText(str);
        TextView textView = this.usernameTextView;
        textView.setText(Emoji.replaceEmoji(str2, textView.getPaint().getFontMetricsInt(), AndroidUtilities.m26dp(20.0f), false));
    }
