...
abstract class Atom {
   ...
   public Atom(int var1) {
      this.type = var1;
   }

   public static String getAtomTypeString(int var0) {
      StringBuilder var1 = new StringBuilder();
      var1.append("");
      var1.append((char)(var0 >> 24 & 255));
      var1.append((char)(var0 >> 16 & 255));
      var1.append((char)(var0 >> 8 & 255));
      var1.append((char)(var0 & 255));
      return var1.toString();
   }

   public static int parseFullAtomFlags(int var0) {
      return var0 & 16777215;
   }

   public static int parseFullAtomVersion(int var0) {
      return var0 >> 24 & 255;
   }
   ...
   static final class ContainerAtom extends Atom {
      ...
      public ContainerAtom(int var1, long var2) {
         super(var1);
         this.endPosition = var2;
         this.leafChildren = new ArrayList();
         this.containerChildren = new ArrayList();
      }

      public void add(Atom.ContainerAtom var1) {
         this.containerChildren.add(var1);
      }

      public void add(Atom.LeafAtom var1) {
         this.leafChildren.add(var1);
      }

      public Atom.ContainerAtom getContainerAtomOfType(int var1) {
         int var2 = this.containerChildren.size();

         for(int var3 = 0; var3 < var2; ++var3) {
            Atom.ContainerAtom var4 = (Atom.ContainerAtom)this.containerChildren.get(var3);
            if (var4.type == var1) {
               return var4;
            }
         }
      ...
      public Atom.LeafAtom getLeafAtomOfType(int var1) {
         int var2 = this.leafChildren.size();

         for(int var3 = 0; var3 < var2; ++var3) {
            Atom.LeafAtom var4 = (Atom.LeafAtom)this.leafChildren.get(var3);
            if (var4.type == var1) {
               return var4;
            }
         }
      ...
      public String toString() {
         StringBuilder var1 = new StringBuilder();
         var1.append(Atom.getAtomTypeString(super.type));
         var1.append(" leaves: ");
         var1.append(Arrays.toString(this.leafChildren.toArray()));
         var1.append(" containers: ");
         var1.append(Arrays.toString(this.containerChildren.toArray()));
         return var1.toString();
      }
   }
   ...
   static final class LeafAtom extends Atom {
      ...
      public LeafAtom(int var1, ParsableByteArray var2) {
         super(var1);
         this.data = var2;
      }
   }
