...
public class CompositionLayer extends BaseLayer {
      ...
      while(true) {
         ...
         if (var9 != null) {
            ...
            if (var12 != null) {
               ...
               var7 = null.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[var8.getMatteType().ordinal()];
               if (var7 == 1 || var7 == 2) {
                  var12 = var9;
               }
            }
   ...
   public void getBounds(RectF var1, Matrix var2, boolean var3) {
      ...
      for(int var4 = this.layers.size() - 1; var4 >= 0; --var4) {
         ...
         ((BaseLayer)this.layers.get(var4)).getBounds(this.rect, super.boundsMatrix, true);
   ...
   public void setProgress(float var1) {
      ...
      if (this.timeRemapping != null) {
         var1 = super.lottieDrawable.getComposition().getDuration();
         var1 = (float)((long)((Float)this.timeRemapping.getValue() * 1000.0F)) / var1;
      }

      float var2 = var1;
      if (super.layerModel.getTimeStretch() != 0.0F) {
         var2 = var1 / super.layerModel.getTimeStretch();
      }

      var1 = super.layerModel.getStartProgress();
