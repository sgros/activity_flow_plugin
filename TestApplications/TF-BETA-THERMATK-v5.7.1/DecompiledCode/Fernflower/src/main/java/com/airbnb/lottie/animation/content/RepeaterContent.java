...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
   ...
   public void absorbContent(ListIterator var1) {
      if (this.contentGroup == null) {
         ...
         this.contentGroup = new ContentGroup(this.lottieDrawable, this.layer, "Repeater", this.hidden, var2, (AnimatableTransform)null);
      }
   }
   ...
   public void getBounds(RectF var1, Matrix var2, boolean var3) {
      this.contentGroup.getBounds(var1, var2, var3);
   }
