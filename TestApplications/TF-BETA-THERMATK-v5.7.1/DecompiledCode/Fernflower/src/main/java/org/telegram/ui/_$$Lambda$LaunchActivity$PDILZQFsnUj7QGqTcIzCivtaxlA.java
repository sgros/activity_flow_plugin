...
// $FF: synthetic class
public final class _$$Lambda$LaunchActivity$PDILZQFsnUj7QGqTcIzCivtaxlA implements Runnable {
   // $FF: synthetic field
   ...
   // $FF: synthetic method
   public _$$Lambda$LaunchActivity$PDILZQFsnUj7QGqTcIzCivtaxlA(LaunchActivity var1, AlertDialog var2, TLObject var3, int var4, TLRPC.TL_account_authorizationForm var5, TLRPC.TL_account_getAuthorizationForm var6, String var7, String var8, String var9) {
      this.f$0 = var1;
      this.f$1 = var2;
      this.f$2 = var3;
      this.f$3 = var4;
