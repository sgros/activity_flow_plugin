...
class AppCompatTextViewAutoSizeHelper {
   ...
   private Method getTextViewMethod(String var1) {
      Exception var10000;
      label43: {
         boolean var10001;
         Method var2;
   ...
   private Object invokeAndReturnWithDefault(Object var1, String var2, Object var3) {
      try {
   ...
   private boolean suggestedSizeFitsInSpace(int var1, RectF var2) {
      ...
      if (var4 != null) {
         CharSequence var10 = var4.getTransformation(var3, this.mTextView);
         var5 = var3;
         if (var10 != null) {
            var5 = var10;
         }
      ...
      TextPaint var7 = this.mTempTextPaint;
      if (var7 == null) {
      ...
      Alignment var8 = (Alignment)this.invokeAndReturnWithDefault(this.mTextView, "getLayoutAlignment", Alignment.ALIGN_NORMAL);
      StaticLayout var9;
      if (VERSION.SDK_INT >= 23) {
         var9 = this.createStaticLayoutForMeasuring(var5, var8, Math.round(var2.right), var6);
      } else {
         var9 = this.createStaticLayoutForMeasuringPre23(var5, var8, Math.round(var2.right));
      }

      if (var6 == -1 || var9.getLineCount() <= var6 && var9.getLineEnd(var9.getLineCount() - 1) == var5.length()) {
         return (float)var9.getHeight() <= var2.bottom;
      } else {
         return false;
      }
   }
