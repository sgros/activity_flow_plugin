...
public class TypedArrayUtils {
   ...
   public static ComplexColorCompat getNamedComplexColor(TypedArray var0, XmlPullParser var1, Theme var2, String var3, int var4, int var5) {
      if (hasAttribute(var1, var3)) {
         ...
         var0.getValue(var4, var8);
         int var6 = var8.type;
         if (var6 >= 28 && var6 <= 31) {
            return ComplexColorCompat.from(var8.data);
         }

         ComplexColorCompat var7 = ComplexColorCompat.inflate(var0.getResources(), var0.getResourceId(var4, 0), var2);
         if (var7 != null) {
            return var7;
         }
      }
