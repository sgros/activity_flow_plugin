...
public class DefaultItemAnimator extends SimpleItemAnimator {
   ...
   public void endAnimations() {
      ...
      for(var1 = this.mPendingMoves.size() - 1; var1 >= 0; --var1) {
         ...
         View var3 = var2.holder.itemView;
         var3.setTranslationY(0.0F);
         var3.setTranslationX(0.0F);
      ...
      if (this.isRunning()) {
         ...
         for(var1 = this.mMovesList.size() - 1; var1 >= 0; --var1) {
            ...
            for(var4 = var7.size() - 1; var4 >= 0; --var4) {
               DefaultItemAnimator.MoveInfo var8 = (DefaultItemAnimator.MoveInfo)var7.get(var4);
         ...
         for(var1 = this.mAdditionsList.size() - 1; var1 >= 0; --var1) {
            ...
            for(var4 = var7.size() - 1; var4 >= 0; --var4) {
               RecyclerView.ViewHolder var9 = (RecyclerView.ViewHolder)var7.get(var4);
         ...
         for(var1 = this.mChangesList.size() - 1; var1 >= 0; --var1) {
            ...
            for(var4 = var7.size() - 1; var4 >= 0; --var4) {
               this.endChangeAnimationIfNecessary((DefaultItemAnimator.ChangeInfo)var7.get(var4));
               if (var7.isEmpty()) {
   ...
   public void runPendingAnimations() {
      ...
      if (var1 || var2 || var4 || var3) {
         ...
         Runnable var14;
         final ArrayList var15;
         if (var3) {
            var15 = new ArrayList();
            var15.addAll(this.mPendingChanges);
            this.mChangesList.add(var15);
            this.mPendingChanges.clear();
            var14 = new Runnable() {
               public void run() {
                  Iterator var1 = var15.iterator();
                  ...
                  var15.clear();
                  DefaultItemAnimator.this.mChangesList.remove(var15);
               }
            };
            if (this.delayAnimations && var1) {
               ViewCompat.postOnAnimationDelayed(((DefaultItemAnimator.ChangeInfo)var15.get(0)).oldHolder.itemView, var14, this.getRemoveDuration());
            } else {
               var14.run();
            }
         }
         ...
         if (var4) {
            var15 = new ArrayList();
            var15.addAll(this.mPendingAdditions);
            this.mAdditionsList.add(var15);
            ...
            var14 = new Runnable() {
               public void run() {
                  ...
                  var15.clear();
                  DefaultItemAnimator.this.mAdditionsList.remove(var15);
               }
            };
            if (this.delayAnimations && (var1 || var2 || var3)) {
               long var7 = 0L;
               long var9;
               if (var1) {
               ...
               ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder)var15.get(0)).itemView, var14, var9 + var11);
            } else {
               var14.run();
            }
         }
   ...
   public void setDelayAnimations(boolean var1) {
      this.delayAnimations = var1;
   }
