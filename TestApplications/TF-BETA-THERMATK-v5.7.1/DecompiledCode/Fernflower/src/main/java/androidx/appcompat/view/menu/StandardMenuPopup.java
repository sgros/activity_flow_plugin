...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
   ...
   private final OnAttachStateChangeListener mAttachStateChangeListener = new OnAttachStateChangeListener() {
      ...
      public void onViewDetachedFromWindow(View var1) {
         ViewTreeObserver var2 = StandardMenuPopup.this.mTreeObserver;
         if (var2 != null) {
            if (!var2.isAlive()) {
               StandardMenuPopup.this.mTreeObserver = var1.getViewTreeObserver();
            }

            StandardMenuPopup var3 = StandardMenuPopup.this;
      ...
      if (this.isShowing()) {
         ...
         if (!this.mWasDismissed) {
            ...
            if (var1 != null) {
               ...
               this.mPopup.show();
               ListView var3 = this.mPopup.getListView();
               var3.setOnKeyListener(this);
               if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                  FrameLayout var4 = (FrameLayout)LayoutInflater.from(this.mContext).inflate(R$layout.abc_popup_menu_header_item_layout, var3, false);
                  TextView var5 = (TextView)var4.findViewById(16908310);
                  if (var5 != null) {
                     var5.setText(this.mMenu.getHeaderTitle());
                  }

                  var4.setEnabled(false);
                  var3.addHeaderView(var4, (Object)null, false);
               }
