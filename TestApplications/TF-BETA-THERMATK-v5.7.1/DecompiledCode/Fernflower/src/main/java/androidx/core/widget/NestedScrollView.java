...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
      ...
      if (var2 != null && this.isWithinDeltaOfScreen(var2, var4, this.getHeight())) {
         ...
         if (var1 == 33 && this.getScrollY() < var4) {
            ...
            if (var1 == 130) {
               var5 = var4;
               if (this.getChildCount() > 0) {
                  var2 = this.getChildAt(0);
                  LayoutParams var6 = (LayoutParams)var2.getLayoutParams();
                  var5 = Math.min(var2.getBottom() + var6.bottomMargin - (this.getScrollY() + this.getHeight() - this.getPaddingBottom()), var4);
               }
            }
         }
   ...
   public boolean fullScroll(int var1) {
      ...
      if (var2) {
         ...
         if (var6 > 0) {
            View var7 = this.getChildAt(var6 - 1);
            LayoutParams var5 = (LayoutParams)var7.getLayoutParams();
            this.mTempRect.bottom = var7.getBottom() + var5.bottomMargin + this.getPaddingBottom();
            var4 = this.mTempRect;
   ...
   protected float getBottomFadingEdgeStrength() {
      if (this.getChildCount() == 0) {
         ...
         var5 = var1.getBottom() + var2.bottomMargin - this.getScrollY() - (var4 - var5);
         return var5 < var3 ? (float)var5 / (float)var3 : 1.0F;
      }
   }
   ...
   protected void measureChild(View var1, int var2, int var3) {
      ...
      var1.measure(FrameLayout.getChildMeasureSpec(var2, this.getPaddingLeft() + this.getPaddingRight(), var4.width), MeasureSpec.makeMeasureSpec(0, 0));
   }
      ...
      if (this.mFillViewport) {
         if (MeasureSpec.getMode(var2) != 0) {
            if (this.getChildCount() > 0) {
               ...
               if (var2 < var5) {
                  var3.measure(FrameLayout.getChildMeasureSpec(var1, this.getPaddingLeft() + this.getPaddingRight() + var4.leftMargin + var4.rightMargin, var4.width), MeasureSpec.makeMeasureSpec(var5, 1073741824));
               }
            }
