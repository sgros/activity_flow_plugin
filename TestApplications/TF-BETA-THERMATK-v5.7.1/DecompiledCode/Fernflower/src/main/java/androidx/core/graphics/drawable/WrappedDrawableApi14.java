...
class WrappedDrawableApi14 extends Drawable implements Callback, WrappedDrawable, TintAwareDrawable {
   ...
   private void updateLocalState(Resources var1) {
      ...
      if (var2 != null) {
         ConstantState var3 = var2.mDrawableState;
         if (var3 != null) {
            this.setWrappedDrawable(var3.newDrawable(var1));
         }
      }
   ...
   private boolean updateTint(int[] var1) {
      if (!this.isCompatTintEnabled()) {
         ...
         WrappedDrawableState var2 = this.mState;
         ColorStateList var3 = var2.mTint;
         Mode var5 = var2.mTintMode;
         if (var3 != null && var5 != null) {
            int var4 = var3.getColorForState(var1, var3.getDefaultColor());
            if (!this.mColorFilterSet || var4 != this.mCurrentColor || var5 != this.mCurrentMode) {
               this.setColorFilter(var4, var5);
