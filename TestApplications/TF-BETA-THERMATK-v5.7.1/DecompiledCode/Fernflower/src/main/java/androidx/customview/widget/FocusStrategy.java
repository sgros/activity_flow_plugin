...
class FocusStrategy {
   private static boolean beamBeats(int var0, Rect var1, Rect var2, Rect var3) {
      ...
      if (!beamsOverlap(var0, var1, var3) && var4) {
         var4 = isToDirectionOf(var0, var1, var3);
         boolean var5 = true;
         if (!var4) {
            return true;
         } else {
            ...
            if (var0 != 17) {
               if (var0 == 66) {
                  var4 = var5;
               } else if (majorAxisDistance(var0, var1, var2) < majorAxisDistanceToFarEdge(var0, var1, var3)) {
                  var4 = var5;
               } else {
                  var4 = false;
               }
   ...
   private static boolean isCandidate(Rect var0, Rect var1, int var2) {
      ...
      if (var2 != 17) {
         if (var2 != 33) {
            if (var2 != 66) {
               if (var2 != 130) {
                  ...
                  var2 = var0.top;
                  var7 = var1.top;
                  if (var2 >= var7 && var0.bottom > var7 || var0.bottom >= var1.bottom) {
                     var6 = false;
                  }
               ...
               var2 = var0.left;
               var7 = var1.left;
               if ((var2 < var7 || var0.right <= var7) && var0.right < var1.right) {
                  var6 = var3;
               } else {
                  var6 = false;
               }
            ...
            var2 = var0.bottom;
            var7 = var1.bottom;
            if ((var2 > var7 || var0.top >= var7) && var0.top > var1.top) {
               var6 = var4;
            } else {
               var6 = false;
            }
         ...
         var7 = var0.right;
         var2 = var1.right;
         if ((var7 > var2 || var0.left >= var2) && var0.left > var1.left) {
            var6 = var5;
         } else {
            var6 = false;
         }
