...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
   ...
   public SearchView(Context var1, AttributeSet var2, int var3) {
      ...
      this.mReleaseCursorRunnable = new Runnable() {
         public void run() {
            CursorAdapter var1 = SearchView.this.mSuggestionsAdapter;
            if (var1 != null && var1 instanceof SuggestionsAdapter) {
               var1.changeCursor((Cursor)null);
            }
      ...
      this.mOnClickListener = new OnClickListener() {
         public void onClick(View var1) {
            SearchView var2 = SearchView.this;
            if (var1 == var2.mSearchButton) {
               var2.onSearchClicked();
            } else if (var1 == var2.mCloseButton) {
               var2.onCloseClicked();
            } else if (var1 == var2.mGoButton) {
               var2.onSubmitQuery();
            } else if (var1 == var2.mVoiceButton) {
               var2.onVoiceClicked();
            } else if (var1 == var2.mSearchSrcTextView) {
               var2.forceSuggestionQuery();
            }
      ...
      this.mTextKeyListener = new OnKeyListener() {
         public boolean onKey(View var1, int var2, KeyEvent var3) {
            ...
            if (var4.mSearchable == null) {
               return false;
            } else if (var4.mSearchSrcTextView.isPopupShowing() && SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
               ...
               SearchView var5 = SearchView.this;
               var5.launchQuerySearch(0, (String)null, var5.mSearchSrcTextView.getText().toString());
               return true;
            } else {
               return false;
            }
      ...
      this.mSearchSrcTextView.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            SearchView var3 = SearchView.this;
            OnFocusChangeListener var4 = var3.mOnQueryTextFocusChangeListener;
            if (var4 != null) {
               var4.onFocusChange(var3, var2);
            }
   ...
   private void updateCloseButton() {
      ...
      if (var7 != null) {
         int[] var9;
         if (var3) {
            var9 = ViewGroup.ENABLED_STATE_SET;
         } else {
            var9 = ViewGroup.EMPTY_STATE_SET;
         }
   ...
   private void updateSearchAutoComplete() {
      ...
      if (this.mSearchable.getSuggestAuthority() != null) {
         ...
         SuggestionsAdapter var5 = (SuggestionsAdapter)this.mSuggestionsAdapter;
         byte var6 = var2;
   ...
   private void updateViewsVisibility(boolean var1) {
      ...
      this.mCollapsedIcon.setVisibility(var4);
   ...
   protected void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
      ...
      if (var1) {
         ...
         Rect var6 = this.mSearchSrtTextViewBoundsExpanded;
         Rect var7 = this.mSearchSrcTextViewBounds;
         var6.set(var7.left, 0, var7.right, var5 - var3);
         SearchView.UpdatableTouchDelegate var8 = this.mTouchDelegate;
         if (var8 == null) {
            ...
            var8.setBounds(this.mSearchSrtTextViewBoundsExpanded, this.mSearchSrcTextViewBounds);
         }
      }
   ...
   void updateFocusedState() {
      int[] var1;
      if (this.mSearchSrcTextView.hasFocus()) {
         var1 = ViewGroup.FOCUSED_STATE_SET;
      } else {
         var1 = ViewGroup.EMPTY_STATE_SET;
      }
   ...
   private static class UpdatableTouchDelegate extends TouchDelegate {
      ...
      public boolean onTouchEvent(MotionEvent var1) {
         ...
         if (var7) {
            if (var10 && !this.mActualBounds.contains(var2, var3)) {
               var1.setLocation((float)(this.mDelegateView.getWidth() / 2), (float)(this.mDelegateView.getHeight() / 2));
            } else {
               Rect var9 = this.mActualBounds;
               var1.setLocation((float)(var2 - var9.left), (float)(var3 - var9.top));
            }
