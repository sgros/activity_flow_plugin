...
final class GapWorker implements Runnable {
   ...
   static Comparator sTaskComparator = new Comparator() {
      public int compare(GapWorker.Task var1, GapWorker.Task var2) {
         ...
         if (var6 != var7) {
            ...
            boolean var8 = var1.immediate;
            if (var8 != var2.immediate) {
               var10 = var4;
               if (var8) {
                  var10 = -1;
               }
               ...
               int var9 = var2.viewVelocity - var1.viewVelocity;
               if (var9 != 0) {
                  return var9;
               } else {
                  var9 = var1.distanceToItem - var2.distanceToItem;
   ...
   private void buildTaskList() {
      ...
      for(var3 = 0; var2 < var1; ++var2) {
         RecyclerView var6 = (RecyclerView)this.mRecyclerViews.get(var2);
         if (var6.getWindowVisibility() == 0) {
            ...
            for(var5 = 0; var5 < var7.mCount * 2; var5 += 2) {
               GapWorker.Task var11;
               if (var3 >= this.mTasks.size()) {
                  var11 = new GapWorker.Task();
                  this.mTasks.add(var11);
               } else {
                  var11 = (GapWorker.Task)this.mTasks.get(var3);
               }

               int var9 = var7.mPrefetchArray[var5 + 1];
               boolean var10;
               if (var9 <= var8) {
                  var10 = true;
               } else {
               ...
               var11.view = var6;
               var11.position = var7.mPrefetchArray[var5];
               ++var3;
            }
         }
      }
   ...
   static class LayoutPrefetchRegistryImpl implements RecyclerView.LayoutManager.LayoutPrefetchRegistry {
      ...
      void collectPrefetchPositionsFromView(RecyclerView var1, boolean var2) {
         ...
         RecyclerView.LayoutManager var5 = var1.mLayout;
         if (var1.mAdapter != null && var5 != null && var5.isItemPrefetchEnabled()) {
            if (var2) {
               if (!var1.mAdapterHelper.hasPendingUpdates()) {
                  var5.collectInitialPrefetchPositions(var1.mAdapter.getItemCount(), this);
               }
            } else if (!var1.hasPendingAdapterUpdates()) {
               var5.collectAdjacentPrefetchPositions(this.mPrefetchDx, this.mPrefetchDy, var1.mState, this);
            }

            int var4 = this.mCount;
            if (var4 > var5.mPrefetchMaxCountObserved) {
               var5.mPrefetchMaxCountObserved = var4;
               var5.mPrefetchMaxObservedInInitialPrefetch = var2;
