...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
   ...
   private boolean applyInsets(View var1, Rect var2, boolean var3, boolean var4, boolean var5, boolean var6) {
      ...
      int var8;
      boolean var9;
      ActionBarOverlayLayout.LayoutParams var10;
      label30: {
         var10 = (ActionBarOverlayLayout.LayoutParams)var1.getLayoutParams();
         if (var3) {
            var7 = var10.leftMargin;
            var8 = var2.left;
            if (var7 != var8) {
               var10.leftMargin = var8;
               var9 = true;
               break label30;
            }
         }
      ...
      var3 = var9;
      if (var4) {
         var7 = var10.topMargin;
         var8 = var2.top;
         var3 = var9;
         if (var7 != var8) {
            var10.topMargin = var8;
            var3 = true;
         }
      }
      ...
      var4 = var3;
      if (var6) {
         var8 = var10.rightMargin;
         var7 = var2.right;
         var4 = var3;
         if (var8 != var7) {
            var10.rightMargin = var7;
            var4 = true;
         }
      }
      ...
      var3 = var4;
      if (var5) {
         var7 = var10.bottomMargin;
         var8 = var2.bottom;
         var3 = var4;
         if (var7 != var8) {
            var10.bottomMargin = var8;
            var3 = true;
         }
      }
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      var5 = Math.max(var5, this.mContent.getMeasuredHeight() + var3.topMargin + var3.bottomMargin);
      int var11 = View.combineMeasuredStates(var6, this.mContent.getMeasuredState());
      ...
      this.setMeasuredDimension(View.resolveSizeAndState(Math.max(var9 + var6 + var8, this.getSuggestedMinimumWidth()), var1, var11), View.resolveSizeAndState(var5, var2, var11 << 16));
   }
