...
public class LinearSmoothScrollerEnd extends RecyclerView.SmoothScroller {
   ...
   public LinearSmoothScrollerEnd(Context var1) {
   ...
   public int calculateDxToMakeVisible(View var1) {
      RecyclerView.LayoutManager var2 = this.getLayoutManager();
      if (var2 != null && var2.canScrollHorizontally()) {
         RecyclerView.LayoutParams var3 = (RecyclerView.LayoutParams)var1.getLayoutParams();
         int var4 = var2.getDecoratedLeft(var1) - var3.leftMargin;
         int var5 = var2.getDecoratedRight(var1) + var3.rightMargin;
         int var6 = var2.getPaddingLeft();
         int var7 = var2.getWidth() - var2.getPaddingRight();
   ...
   protected void onTargetFound(View var1, RecyclerView.State var2, RecyclerView.SmoothScroller.Action var3) {
      int var4 = this.calculateDxToMakeVisible(var1);
      int var5 = this.calculateTimeForDeceleration(var4);
      if (var5 > 0) {
         var3.update(-var4, 0, Math.max(400, var5), this.mDecelerateInterpolator);
      }
