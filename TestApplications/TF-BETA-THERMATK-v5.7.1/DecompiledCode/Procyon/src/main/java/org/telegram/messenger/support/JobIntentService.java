...
public abstract class JobIntentService extends Service
{
    ...
    static final class CompatWorkEnqueuer extends WorkEnqueuer
    {
        ...
        void enqueueWork(Intent intent) {
            ...
            intent.setComponent(super.mComponentName);
    ...
    static final class JobWorkEnqueuer extends WorkEnqueuer
    {
        ...
        JobWorkEnqueuer(final Context context, final ComponentName componentName, final int n) {
            ...
            this.mJobInfo = new JobInfo$Builder(n, super.mComponentName).setOverrideDeadline(0L).setRequiredNetworkType(1).build();
