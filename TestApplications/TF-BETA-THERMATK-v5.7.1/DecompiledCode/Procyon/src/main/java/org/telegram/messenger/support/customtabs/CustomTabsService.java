            ...
            public boolean newSession(final ICustomTabsCallback customTabsCallback) {
                ...
                try {
                    ...
                    synchronized (CustomTabsService.this.mDeathRecipientMap) {
                        ((IInterface)customTabsCallback).asBinder().linkToDeath((IBinder$DeathRecipient)binder$DeathRecipient, 0);
                        CustomTabsService.this.mDeathRecipientMap.put(((IInterface)customTabsCallback).asBinder(), binder$DeathRecipient);
