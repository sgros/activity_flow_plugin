...
class DrawableContainer extends Drawable implements Drawable$Callback
{
    ...
    protected void setConstantState(final DrawableContainerState mDrawableContainerState) {
        ...
        if (mCurIndex >= 0) {
            this.mCurrDrawable = mDrawableContainerState.getChild(mCurIndex);
            final Drawable mCurrDrawable = this.mCurrDrawable;
            if (mCurrDrawable != null) {
                this.initializeDrawableForDisplay(mCurrDrawable);
            }
        }
        this.mLastIndex = -1;
        this.mLastDrawable = null;
    ...
    public void setDither(final boolean mDither) {
        final DrawableContainerState mDrawableContainerState = this.mDrawableContainerState;
        if (mDrawableContainerState.mDither != mDither) {
            mDrawableContainerState.mDither = mDither;
            final Drawable mCurrDrawable = this.mCurrDrawable;
            if (mCurrDrawable != null) {
