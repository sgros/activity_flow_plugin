...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3
{
    ...
    void applyEdgeEffectColor(final EdgeEffect edgeEffect) {
        if (edgeEffect != null && Build$VERSION.SDK_INT >= 21) {
            final int glowColor = this.glowColor;
            if (glowColor != 0) {
    ...
    public void draw(final Canvas canvas) {
        ...
        if (mLeftGlow != null && !mLeftGlow.isFinished()) {
            ...
            n2 = ((mLeftGlow2 != null && mLeftGlow2.draw(canvas)) ? 1 : 0);
        ...
        if (mTopGlow != null) {
            ...
            if (!mTopGlow.isFinished()) {
                ...
                n3 = (n2 | ((mTopGlow2 != null && mTopGlow2.draw(canvas)) ? 1 : 0));
        ...
        if (mRightGlow != null) {
            ...
            if (!mRightGlow.isFinished()) {
                ...
                boolean b;
                if (mRightGlow2 != null && mRightGlow2.draw(canvas)) {
                    b = true;
                }
                else {
                    b = false;
        ...
        if (mBottomGlow != null && !mBottomGlow.isFinished()) {
            ...
            if (this.mClipToPadding) {
                ...
                canvas.translate((float)(-this.getWidth()), (float)(-this.getHeight() + this.bottomGlowOffset));
            }
    ...
    public View focusSearch(final View view, int n) {
        ...
        final boolean b = this.mAdapter != null && this.mLayout != null && !this.isComputingLayout() && !this.mLayoutSuppressed;
    ...
    public View getAttachedScrapChildAt(final int n) {
        if (n >= 0 && n < this.mRecycler.mAttachedScrap.size()) {
            return this.mRecycler.getScrapViewAt(n);
        }
        return null;
    }
    ...
    public View getCachedChildAt(final int index) {
    ...
    public View getHiddenChildAt(final int n) {
        return this.mChildHelper.getHiddenChildAt(n);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
            ...
            if (this.mGapWorker == null) {
                ...
                mGapWorker.mFrameIntervalNs = (long)(1.0E9f / refreshRate);
    ...
    protected void onRestoreInstanceState(Parcelable mLayoutState) {
        if (!(mLayoutState instanceof SavedState)) {
            super.onRestoreInstanceState(mLayoutState);
            return;
        }
        this.mPendingSavedState = (SavedState)mLayoutState;
        super.onRestoreInstanceState(this.mPendingSavedState.getSuperState());
        final LayoutManager mLayout = this.mLayout;
        if (mLayout != null) {
            mLayoutState = this.mPendingSavedState.mLayoutState;
            if (mLayoutState != null) {
                mLayout.onRestoreInstanceState(mLayoutState);
            }
        }
    }
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        int a = n6;
                        int a2 = n7;
                        if (this.dispatchNestedPreScroll(n6, n7, mReusableIntPair, this.mScrollOffset, 0)) {
                            final int[] mReusableIntPair2 = this.mReusableIntPair;
                            a = n6 - mReusableIntPair2[0];
                            a2 = n7 - mReusableIntPair2[1];
                        ...
                        if (this.mScrollState == 1) {
                            ...
                            if (this.scrollByInternal(n12, n13, obtain)) {
                                this.getParent().requestDisallowInterceptTouchEvent(true);
                            }
                            n = (b ? 1 : 0);
                            if (this.mGapWorker != null) {
                                ...
                                this.mGapWorker.postFromTraversal(this, n9, n10);
                                n = (b ? 1 : 0);
                            }
                        }
                    }
                ...
                int n19;
                final int n18 = n19 = canScrollHorizontally;
                if (canScrollVertically) {
                    n19 = (n18 | 0x2);
                }
                this.startNestedScroll(n19, 0);
                n = (b ? 1 : 0);
            }
        }
        if (n == 0) {
    ...
    boolean scrollByInternal(final int n, final int n2, final MotionEvent motionEvent) {
        ...
        final int n9 = mReusableIntPair4[0];
        final int n10 = mReusableIntPair4[1];
        ...
        final int[] mNestedOffsets = this.mNestedOffsets;
        final int n11 = mNestedOffsets[0];
        final int[] mScrollOffset2 = this.mScrollOffset;
        mNestedOffsets[0] = n11 + mScrollOffset2[0];
        mNestedOffsets[1] += mScrollOffset2[1];
        if (this.getOverScrollMode() != 2) {
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                this.pullGlows(motionEvent.getX(), (float)(n7 - n9), motionEvent.getY(), (float)(n8 - n10));
            }
    ...
    public void setBottomGlowOffset(final int bottomGlowOffset) {
        this.bottomGlowOffset = bottomGlowOffset;
    }
    ...
    public void setGlowColor(final int glowColor) {
    ...
    public void setTopGlowOffset(final int topGlowOffset) {
        this.topGlowOffset = topGlowOffset;
    }
    ...
    public void smoothScrollBy(int n, int n2, final Interpolator interpolator) {
        ...
        if (n != 0 || n2 != 0) {
            this.mViewFlinger.smoothScrollBy(n, n2, Integer.MIN_VALUE, interpolator);
        }
    }
    ...
    public abstract static class LayoutManager
    {
        ...
        public int getPaddingEnd() {
            ...
            int paddingEnd;
            if (mRecyclerView != null) {
                paddingEnd = ViewCompat.getPaddingEnd((View)mRecyclerView);
            }
            else {
                paddingEnd = 0;
            }
        ...
        public int getPaddingStart() {
            ...
            int paddingStart;
            if (mRecyclerView != null) {
                paddingStart = ViewCompat.getPaddingStart((View)mRecyclerView);
            }
            else {
                paddingStart = 0;
            }
    ...
    public final class Recycler
    {
        ...
        private void attachAccessibilityDelegateOnBind(final ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                final AccessibilityDelegateCompat accessibilityDelegate = ViewCompat.getAccessibilityDelegate(itemView);
        ...
        void recycleViewHolderInternal(final ViewHolder viewHolder) {
            ...
            if (!viewHolder.shouldIgnore()) {
                ...
                if (n == 0 && !b2 && doesTransientStatePreventRecycling) {
                    viewHolder.mOwnerRecyclerView = null;
                }
                return;
            }
            ...
            if (n >= 0 && n < RecyclerView.this.mState.getItemCount()) {
                ...
                Label_0751: {
                    if (viewHolder2 == null) {
                        ...
                        if (o == null) {
                            ...
                            final RecyclerView this$0 = RecyclerView.this;
                            viewHolder4 = this$0.mAdapter.createViewHolder(this$0, itemViewType);
                            if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                ...
                if (n6 != 0 && !RecyclerView.this.mState.isPreLayout() && ((ViewHolder)viewHolder4).hasAnyOfTheFlags(8192)) {
                    ...
                    if (RecyclerView.this.mState.mRunSimpleAnimations) {
                        final int buildAdapterChangeFlagsForAnimations = ItemAnimator.buildAdapterChangeFlagsForAnimations((ViewHolder)viewHolder4);
                        final RecyclerView this$2 = RecyclerView.this;
                        RecyclerView.this.recordAnimationInfoIfBouncedHiddenView((ViewHolder)viewHolder4, this$2.mItemAnimator.recordPreLayoutInformation(this$2.mState, (ViewHolder)viewHolder4, buildAdapterChangeFlagsForAnimations | 0x1000, ((ViewHolder)viewHolder4).getUnmodifiedPayloads()));
                    }
                }
    ...
    public abstract static class SmoothScroller
    {
        ...
        void start(final RecyclerView mRecyclerView, final LayoutManager mLayoutManager) {
            ...
            if (mTargetPosition != -1) {
                this.mRecyclerView.mState.mTargetPosition = mTargetPosition;
                this.mRunning = true;
                this.mPendingInitialRun = true;
    ...
    class ViewFlinger implements Runnable
    {
        ...
        public void run() {
            ...
            if (mOverScroller.computeScrollOffset()) {
                ...
                this$5.dispatchNestedScroll(n10, n9, n3, n4, null, 1, mReusableIntPair5);
                final int[] mReusableIntPair6 = RecyclerView.this.mReusableIntPair;
                final int n11 = n3 - mReusableIntPair6[0];
                final int n12 = n4 - mReusableIntPair6[1];
                if (n10 != 0 || n9 != 0) {
                ...
                if ((mSmoothScroller2 == null || !mSmoothScroller2.isPendingInitialRun()) && b3) {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
                        int n13 = (int)mOverScroller.getCurrVelocity();
                        int n14;
                        if (n11 < 0) {
                            n14 = -n13;
                        }
                    ...
                    if (mGapWorker != null) {
                        mGapWorker.postFromTraversal(this$6, n11, n12);
                    }
                }
            }
    ...
    public abstract static class ViewHolder
    {
        ...
        public final void setIsRecyclable(final boolean b) {
            ...
            else if (!b && mIsRecyclableCount2 == 1) {
                this.mFlags |= 0x10;
            }
