...
class SuggestionsAdapter extends ResourceCursorAdapter implements View$OnClickListener
{
    ...
    private CharSequence formatUrl(final CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            super.mContext.getTheme().resolveAttribute(R$attr.textColorSearchUrl, typedValue, true);
            this.mUrlColor = super.mContext.getResources().getColorStateList(typedValue.resourceId);
        }
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        if (childViewCache.mText2 != null) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                final TextView mText1 = childViewCache.mText1;
                if (mText1 != null) {
                ...
                final TextView mText2 = childViewCache.mText1;
                if (mText2 != null) {
                    mText2.setSingleLine(true);
                    childViewCache.mText1.setMaxLines(1);
                }
            }
            this.setViewText(childViewCache.mText2, charSequence);
        }
        final ImageView mIcon1 = childViewCache.mIcon1;
        if (mIcon1 != null) {
            this.setViewDrawable(mIcon1, this.getIcon1(cursor), 4);
        }
        final ImageView mIcon2 = childViewCache.mIcon2;
        if (mIcon2 != null) {
            this.setViewDrawable(mIcon2, this.getIcon2(cursor), 8);
        }
    ...
    Drawable getDrawableFromResourceUri(final Uri uri) throws FileNotFoundException {
        ...
        if (!TextUtils.isEmpty((CharSequence)authority)) {
            try {
                final Resources resourcesForApplication = super.mContext.getPackageManager().getResourcesForApplication(authority);
    ...
    public View getDropDownView(final int n, View dropDownView, final ViewGroup viewGroup) {
        try {
            ...
            final View dropDownView2 = this.newDropDownView(super.mContext, super.mCursor, viewGroup);
    ...
    Cursor getSearchManagerSuggestions(final SearchableInfo searchableInfo, final String s, final int i) {
        ...
        return super.mContext.getContentResolver().query(fragment.build(), (String[])null, suggestSelection, array2, (String)null);
    }
    ...
    public View getView(final int n, View view, final ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", (Throwable)ex);
            final View view2 = this.newView(super.mContext, super.mCursor, viewGroup);
            if (view2 != null) {
