    ...
    public E removeAt(final int n) {
        ...
        if (mSize <= 1) {
            ...
            if (length > 8 && mSize < mHashes.length / 3) {
                ...
                if (n < mSize2) {
                    final int n3 = n + 1;
                    System.arraycopy(mHashes2, n3, this.mHashes, n, mSize2 - n);
                    System.arraycopy(mArray2, n3, this.mArray, n, this.mSize - n);
                }
            }
            else {
                --this.mSize;
                ...
                if (n < mSize3) {
                    final int[] mHashes3 = this.mHashes;
                    final int n4 = n + 1;
                    System.arraycopy(mHashes3, n4, mHashes3, n, mSize3 - n);
                    final Object[] mArray3 = this.mArray;
                    System.arraycopy(mArray3, n4, mArray3, n, this.mSize - n);
                }
