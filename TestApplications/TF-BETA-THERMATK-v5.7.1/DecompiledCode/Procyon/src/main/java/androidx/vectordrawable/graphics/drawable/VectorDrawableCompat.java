    ...
    private static class VectorDrawableCompatState extends Drawable$ConstantState
    {
        ...
        public VectorDrawableCompatState(final VectorDrawableCompatState vectorDrawableCompatState) {
            ...
            if (vectorDrawableCompatState != null) {
                ...
                final Paint mFillPaint = vectorDrawableCompatState.mVPathRenderer.mFillPaint;
                if (mFillPaint != null) {
                    this.mVPathRenderer.mFillPaint = new Paint(mFillPaint);
                }
                final Paint mStrokePaint = vectorDrawableCompatState.mVPathRenderer.mStrokePaint;
                if (mStrokePaint != null) {
                    this.mVPathRenderer.mStrokePaint = new Paint(mStrokePaint);
                }
