...
public class GradientFill implements ContentModel
{
    ...
    public GradientFill(final String name, final GradientType gradientType, final Path$FillType fillType, final AnimatableGradientColorValue gradientColor, final AnimatableIntegerValue opacity, final AnimatablePointValue startPoint, final AnimatablePointValue endPoint, final AnimatableFloatValue highlightLength, final AnimatableFloatValue highlightAngle, final boolean hidden) {
