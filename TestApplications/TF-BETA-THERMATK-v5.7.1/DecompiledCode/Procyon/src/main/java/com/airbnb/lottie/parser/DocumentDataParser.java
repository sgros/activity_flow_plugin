    ...
    public DocumentData parse(final JsonReader jsonReader, final float n) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (n2) {
                ...
                case 3: {
                    final int nextInt2 = jsonReader.nextInt();
                    if (nextInt2 <= DocumentData.Justification.CENTER.ordinal() && nextInt2 >= 0) {
                        enum1 = DocumentData.Justification.values()[nextInt2];
                    }
                    else {
                        enum1 = DocumentData.Justification.CENTER;
                    }
                    continue;
                }
                case 2: {
        ...
        return new DocumentData(nextString, nextString2, nextDouble, (DocumentData.Justification)enum1, nextInt, nextDouble2, nextDouble3, jsonToColor, jsonToColor2, nextDouble4, nextBoolean);
    }
}
