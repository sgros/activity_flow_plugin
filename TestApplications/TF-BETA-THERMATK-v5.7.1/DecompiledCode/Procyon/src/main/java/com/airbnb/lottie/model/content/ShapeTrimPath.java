...
public class ShapeTrimPath implements ContentModel
{
    ...
    public ShapeTrimPath(final String name, final Type type, final AnimatableFloatValue start, final AnimatableFloatValue end, final AnimatableFloatValue offset, final boolean hidden) {
        this.name = name;
        this.type = type;
        this.start = start;
        this.end = end;
