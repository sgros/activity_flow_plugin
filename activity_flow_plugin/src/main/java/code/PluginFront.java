...
public class PluginFront extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        if(projectChooserDialog.showAndGet()) {
            ...
            switch (returnCode) {
                case 0:
                    Messages.showMessageDialog(project, "Operation successful.", "Message", Messages.getInformationIcon());
                    break;
                case 1:
                    ...
                    break;
                case 2:
                    Messages.showMessageDialog(project, "Irregular AndroidManifest.xml file.\nMain activity wasn't found.", "Message", Messages.getInformationIcon());
                    //Parsing of AndroidManifest.xml failed.\nProbable reason: main activity wasn't found.
                    break;
                case 3:
